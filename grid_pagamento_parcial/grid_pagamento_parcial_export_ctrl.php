<?php
@session_start() ;
$_SESSION['scriptcase']['grid_pagamento_parcial']['sc_process_barr'] = true;
require_once('../grid_pagamento_parcial/index.php');
unset($_SESSION['scriptcase']['grid_pagamento_parcial']['sc_process_barr']);
$ExportCtrl = new grid_pagamento_parcial_export_control;
$ExportCtrl->Export_barr();

class grid_pagamento_parcial_export_control
{
