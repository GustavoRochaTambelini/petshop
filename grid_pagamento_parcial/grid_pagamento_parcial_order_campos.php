...
<?php
   ...
   $Ord_Cmp = new grid_pagamento_parcial_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_pagamento_parcial_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idforma_pagamento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['labels']["idforma_pagamento"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['labels']["idforma_pagamento"] : "PAGAMENTO";
   $tab_ger_campos['data'] = "on";
   $tab_def_campos['data'] = "data";
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['labels']["data"] : "DATA";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['labels']["valor"] : "VALOR";
   $tab_ger_campos['juros'] = "on";
   $tab_def_campos['juros'] = "juros";
   $tab_labels["juros"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['labels']["juros"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['labels']["juros"] : "JUROS";
   $tab_ger_campos['observacao'] = "on";
   $tab_def_campos['observacao'] = "observacao";
   $tab_labels["observacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['labels']["observacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['labels']["observacao"] : "OBSERVAÇÃO";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_pagamento_parcial_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_pagamento_parcial']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
