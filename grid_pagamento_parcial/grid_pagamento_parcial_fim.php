...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_pagamento_parcial"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_pagamento_parcial"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pagamento_parcial']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_pagamento_parcial']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pagamento_parcial']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_pagamento_parcial']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_pagamento_parcial']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_pagamento_parcial</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_pagamento_parcial']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_pagamento_parcial']['embutida_filho'] as $ind => $sc_init)
          {
