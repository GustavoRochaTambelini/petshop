<?php
@session_start() ;
$_SESSION['scriptcase']['grid_bandeira_cartao']['sc_process_barr'] = true;
require_once('../grid_bandeira_cartao/index.php');
unset($_SESSION['scriptcase']['grid_bandeira_cartao']['sc_process_barr']);
$ExportCtrl = new grid_bandeira_cartao_export_control;
$ExportCtrl->Export_barr();

class grid_bandeira_cartao_export_control
{
