...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_bandeira_cartao"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_bandeira_cartao"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_bandeira_cartao'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_bandeira_cartao']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_bandeira_cartao']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_bandeira_cartao']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_bandeira_cartao']['sc_modal'])
       {
...
<HTML>
<HEAD>
 <TITLE>grid_bandeira_cartao</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_bandeira_cartao']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_bandeira_cartao']['embutida_filho'] as $ind => $sc_init)
          {
