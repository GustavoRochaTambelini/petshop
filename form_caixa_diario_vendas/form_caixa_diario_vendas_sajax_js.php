  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_caixa_diario_vendas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_caixa_diario_vendas_form();
	}
...
?>
  ...
  // ---------- Validate saldo
  function do_ajax_form_caixa_diario_vendas_validate_saldo()
  {
    var nomeCampo_saldo = "saldo";
    var var_saldo = scAjaxGetFieldText(nomeCampo_saldo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caixa_diario_vendas_validate_saldo(var_saldo, var_script_case_init, do_ajax_form_caixa_diario_vendas_validate_saldo_cb);
  } // do_ajax_form_caixa_diario_vendas_validate_saldo

  function do_ajax_form_caixa_diario_vendas_validate_saldo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caixa_diario_vendas_validate_saldo_cb

  // ---------- Validate movimentacao_caixa_diario
  function do_ajax_form_caixa_diario_vendas_validate_movimentacao_caixa_diario()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caixa_diario_vendas_validate_movimentacao_caixa_diario(var_movimentacao_caixa_diario, var_script_case_init, do_ajax_form_caixa_diario_vendas_validate_movimentacao_caixa_diario_cb);
  } // do_ajax_form_caixa_diario_vendas_validate_movimentacao_caixa_diario

  function do_ajax_form_caixa_diario_vendas_validate_movimentacao_caixa_diario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caixa_diario_vendas_validate_movimentacao_caixa_diario_cb

  // ---------- Validate resumo_por_tipo
  function do_ajax_form_caixa_diario_vendas_validate_resumo_por_tipo()
  {
    var nomeCampo_resumo_por_tipo = "resumo_por_tipo";
    var var_resumo_por_tipo = scAjaxGetFieldText(nomeCampo_resumo_por_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caixa_diario_vendas_validate_resumo_por_tipo(var_resumo_por_tipo, var_script_case_init, do_ajax_form_caixa_diario_vendas_validate_resumo_por_tipo_cb);
  } // do_ajax_form_caixa_diario_vendas_validate_resumo_por_tipo

  function do_ajax_form_caixa_diario_vendas_validate_resumo_por_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caixa_diario_vendas_validate_resumo_por_tipo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_caixa_diario_vendas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_caixa_diario_vendas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_caixa_diario_vendas_submit_form(var_saldo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_caixa_diario_vendas_submit_form_cb);
  } // do_ajax_form_caixa_diario_vendas_submit_form

  function do_ajax_form_caixa_diario_vendas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_caixa_diario_vendas_submit_form_cb_after_alert);
  } // do_ajax_form_caixa_diario_vendas_submit_form_cb
  function do_ajax_form_caixa_diario_vendas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_caixa_diario_vendas_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_caixa_diario_vendas"] = "off";
  scStatusDetail["grid_caixa_diario_totalizador"] = "off";

  function do_ajax_form_caixa_diario_vendas_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_caixa_diario_vendas_navigate_form, function() {});
    } else {
      perform_ajax_form_caixa_diario_vendas_navigate_form();
    }
  }

  function perform_ajax_form_caixa_diario_vendas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_caixa_diario_vendas_navigate_form(var_idcaixa_diario, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_caixa_diario_vendas_navigate_form_cb);
  } // do_ajax_form_caixa_diario_vendas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_caixa_diario_vendas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_caixa_diario_vendas_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_caixa_diario_vendas_navigate_form_cb_after_alert);
  } // do_ajax_form_caixa_diario_vendas_navigate_form_cb
  function do_ajax_form_caixa_diario_vendas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_caixa_diario_vendas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_caixa_diario_vendas_navigate_form_cb_after_alert

  function sc_hide_form_caixa_diario_vendas_form()
  {
