  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_caixa_diario_vendas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_caixa_diario_vendas_mob_form();
	}
...
?>
  ...
  // ---------- Validate saldo
  function do_ajax_form_caixa_diario_vendas_mob_validate_saldo()
  {
    var nomeCampo_saldo = "saldo";
    var var_saldo = scAjaxGetFieldText(nomeCampo_saldo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caixa_diario_vendas_mob_validate_saldo(var_saldo, var_script_case_init, do_ajax_form_caixa_diario_vendas_mob_validate_saldo_cb);
  } // do_ajax_form_caixa_diario_vendas_mob_validate_saldo

  function do_ajax_form_caixa_diario_vendas_mob_validate_saldo_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caixa_diario_vendas_mob_validate_saldo_cb

  // ---------- Validate movimentacao_caixa_diario
  function do_ajax_form_caixa_diario_vendas_mob_validate_movimentacao_caixa_diario()
  {
    var nomeCampo_movimentacao_caixa_diario = "movimentacao_caixa_diario";
    var var_movimentacao_caixa_diario = scAjaxGetFieldText(nomeCampo_movimentacao_caixa_diario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caixa_diario_vendas_mob_validate_movimentacao_caixa_diario(var_movimentacao_caixa_diario, var_script_case_init, do_ajax_form_caixa_diario_vendas_mob_validate_movimentacao_caixa_diario_cb);
  } // do_ajax_form_caixa_diario_vendas_mob_validate_movimentacao_caixa_diario

  function do_ajax_form_caixa_diario_vendas_mob_validate_movimentacao_caixa_diario_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "movimentacao_caixa_diario";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caixa_diario_vendas_mob_validate_movimentacao_caixa_diario_cb

  // ---------- Validate resumo_por_tipo
  function do_ajax_form_caixa_diario_vendas_mob_validate_resumo_por_tipo()
  {
    var nomeCampo_resumo_por_tipo = "resumo_por_tipo";
    var var_resumo_por_tipo = scAjaxGetFieldText(nomeCampo_resumo_por_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_caixa_diario_vendas_mob_validate_resumo_por_tipo(var_resumo_por_tipo, var_script_case_init, do_ajax_form_caixa_diario_vendas_mob_validate_resumo_por_tipo_cb);
  } // do_ajax_form_caixa_diario_vendas_mob_validate_resumo_por_tipo

  function do_ajax_form_caixa_diario_vendas_mob_validate_resumo_por_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "resumo_por_tipo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_caixa_diario_vendas_mob_validate_resumo_por_tipo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_caixa_diario_vendas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_caixa_diario_vendas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_saldo = scAjaxGetFieldText("saldo");
    var var_idcaixa_diario = scAjaxGetFieldText("idcaixa_diario");
    ...
    scAjaxProcOn();
    x_ajax_form_caixa_diario_vendas_mob_submit_form(var_saldo, var_idcaixa_diario, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_caixa_diario_vendas_mob_submit_form_cb);
  } // do_ajax_form_caixa_diario_vendas_mob_submit_form

  function do_ajax_form_caixa_diario_vendas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("movimentacao_caixa_diario");
      scAjaxHideErrorDisplay("resumo_por_tipo");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_caixa_diario_vendas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_caixa_diario_vendas_mob_submit_form_cb
  function do_ajax_form_caixa_diario_vendas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_caixa_diario_vendas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_caixa_diario_vendas"] = "off";
  scStatusDetail["grid_caixa_diario_totalizador"] = "off";

  function do_ajax_form_caixa_diario_vendas_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_caixa_diario_vendas_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_caixa_diario_vendas_mob_navigate_form();
    }
  }

  function perform_ajax_form_caixa_diario_vendas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("movimentacao_caixa_diario");
    scAjaxHideErrorDisplay("resumo_por_tipo");
    var var_idcaixa_diario = document.F2.idcaixa_diario.value;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_caixa_diario_vendas"] = "on";
    scStatusDetail["grid_caixa_diario_totalizador"] = "on";
    x_ajax_form_caixa_diario_vendas_mob_navigate_form(var_idcaixa_diario, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_caixa_diario_vendas_mob_navigate_form_cb);
  } // do_ajax_form_caixa_diario_vendas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_caixa_diario_vendas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_caixa_diario_vendas_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcaixa_diario.value = scAjaxGetKeyValue("idcaixa_diario");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_caixa_diario_vendas"] && "nmsc_iframe_liga_grid_caixa_diario_vendas" != scMasterDetailIframe["nmsc_iframe_liga_grid_caixa_diario_vendas"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_caixa_diario_vendas"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_caixa_diario_vendas').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_caixa_diario_totalizador"] && "nmsc_iframe_liga_grid_caixa_diario_totalizador" != scMasterDetailIframe["nmsc_iframe_liga_grid_caixa_diario_totalizador"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_caixa_diario_totalizador"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_caixa_diario_totalizador').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_caixa_diario_vendas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_caixa_diario_vendas_mob_navigate_form_cb
  function do_ajax_form_caixa_diario_vendas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_caixa_diario_vendas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_caixa_diario_vendas_mob_navigate_form_cb_after_alert

  function sc_hide_form_caixa_diario_vendas_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_caixa_diario_vendas"] && "off" == scStatusDetail["grid_caixa_diario_totalizador"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "saldo";
  ajax_field_list[1] = "movimentacao_caixa_diario";
  ajax_field_list[2] = "resumo_por_tipo";
  ...
  var ajax_error_list = {
    "saldo": {"label": "SALDO ANTERIOR", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "movimentacao_caixa_diario": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "resumo_por_tipo": {"label": "resumo_por_tipo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "saldo": new Array(),
    "movimentacao_caixa_diario": new Array(),
    "resumo_por_tipo": new Array()
  };
  ajax_field_mult["saldo"][1] = "saldo";
  ajax_field_mult["movimentacao_caixa_diario"][1] = "movimentacao_caixa_diario";
  ajax_field_mult["resumo_por_tipo"][1] = "resumo_por_tipo";

  var ajax_field_id = {
    "saldo": new Array("hidden_field_label_saldo", "hidden_field_data_saldo"),
    "movimentacao_caixa_diario": new Array("hidden_field_label_movimentacao_caixa_diario", "hidden_field_data_movimentacao_caixa_diario"),
    "resumo_por_tipo": new Array("hidden_field_label_resumo_por_tipo", "hidden_field_data_resumo_por_tipo")
  };

  var ajax_read_only = {
    "saldo": "off",
    "movimentacao_caixa_diario": "off",
    "resumo_por_tipo": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("movimentacao_caixa_diario" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
