...
$old_error_handler = set_error_handler("nfce_detalhe_scriptcase_error_handler");

function nfce_detalhe_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['nfce_detalhe']['contr_erro']) && $_SESSION['scriptcase']['nfce_detalhe']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_nfce_detalhe->contr_nfce_detalhe->Apl_com_erro = true;
            if ($inicial_nfce_detalhe->contr_nfce_detalhe->NM_ajax_flag)
            {
                $inicial_nfce_detalhe->contr_nfce_detalhe->NM_ajax_info['errList']['geral_nfce_detalhe'][] = $msg;
                return;
            }
            nfce_detalhe_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function nfce_detalhe_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['nfce_detalhe'])  && '' != $_SESSION['scriptcase']['error_icon']['nfce_detalhe'])  ? $_SESSION['scriptcase']['error_icon']['nfce_detalhe']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['nfce_detalhe']) && '' != $_SESSION['scriptcase']['error_close']['nfce_detalhe']) ? $_SESSION['scriptcase']['error_close']['nfce_detalhe'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['nfce_detalhe']) && '' != $_SESSION['scriptcase']['error_span_title']['nfce_detalhe']) ? $_SESSION['scriptcase']['error_span_title']['nfce_detalhe'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['nfce_detalhe']) && '' != $_SESSION['scriptcase']['error_icon_title']['nfce_detalhe']) ? $_SESSION['scriptcase']['error_icon_title']['nfce_detalhe'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['nfce_detalhe']['error_buffer'] .= ob_get_flush();
}
