  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_nfce_detalhe" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idproduto_
  function do_ajax_nfce_detalhe_validate_idproduto_(iNumLinha)
  {
    var nomeCampo_idproduto_ = "idproduto_" + iNumLinha;
    var var_idproduto_ = scAjaxGetFieldText(nomeCampo_idproduto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_detalhe_validate_idproduto_(var_idproduto_, iNumLinha, var_script_case_init, do_ajax_nfce_detalhe_validate_idproduto__cb);
  } // do_ajax_nfce_detalhe_validate_idproduto_

  function do_ajax_nfce_detalhe_validate_idproduto__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idproduto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idproduto_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idproduto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idproduto_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_detalhe_validate_idproduto__cb

  // ---------- Validate quantidade_
  function do_ajax_nfce_detalhe_validate_quantidade_(iNumLinha)
  {
    var nomeCampo_quantidade_ = "quantidade_" + iNumLinha;
    var var_quantidade_ = scAjaxGetFieldText(nomeCampo_quantidade_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_detalhe_validate_quantidade_(var_quantidade_, iNumLinha, var_script_case_init, do_ajax_nfce_detalhe_validate_quantidade__cb);
  } // do_ajax_nfce_detalhe_validate_quantidade_

  function do_ajax_nfce_detalhe_validate_quantidade__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_detalhe_validate_quantidade__cb

  // ---------- Validate descricao_
  function do_ajax_nfce_detalhe_validate_descricao_(iNumLinha)
  {
    var nomeCampo_descricao_ = "descricao_" + iNumLinha;
    var var_descricao_ = scAjaxGetFieldText(nomeCampo_descricao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_detalhe_validate_descricao_(var_descricao_, iNumLinha, var_script_case_init, do_ajax_nfce_detalhe_validate_descricao__cb);
  } // do_ajax_nfce_detalhe_validate_descricao_

  function do_ajax_nfce_detalhe_validate_descricao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_detalhe_validate_descricao__cb

  // ---------- Validate qtde_
  function do_ajax_nfce_detalhe_validate_qtde_(iNumLinha)
  {
    var nomeCampo_qtde_ = "qtde_" + iNumLinha;
    var var_qtde_ = scAjaxGetFieldText(nomeCampo_qtde_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_detalhe_validate_qtde_(var_qtde_, iNumLinha, var_script_case_init, do_ajax_nfce_detalhe_validate_qtde__cb);
  } // do_ajax_nfce_detalhe_validate_qtde_

  function do_ajax_nfce_detalhe_validate_qtde__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "qtde_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "qtde_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_detalhe_validate_qtde__cb

  // ---------- Validate valor_unitario_
  function do_ajax_nfce_detalhe_validate_valor_unitario_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_detalhe_validate_valor_unitario_(var_valor_unitario_, iNumLinha, var_script_case_init, do_ajax_nfce_detalhe_validate_valor_unitario__cb);
  } // do_ajax_nfce_detalhe_validate_valor_unitario_

  function do_ajax_nfce_detalhe_validate_valor_unitario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_detalhe_validate_valor_unitario__cb

  // ---------- Validate valor_total_
  function do_ajax_nfce_detalhe_validate_valor_total_(iNumLinha)
  {
    var nomeCampo_valor_total_ = "valor_total_" + iNumLinha;
    var var_valor_total_ = scAjaxGetFieldText(nomeCampo_valor_total_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_detalhe_validate_valor_total_(var_valor_total_, iNumLinha, var_script_case_init, do_ajax_nfce_detalhe_validate_valor_total__cb);
  } // do_ajax_nfce_detalhe_validate_valor_total_

  function do_ajax_nfce_detalhe_validate_valor_total__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "valor_total_" + iLineNumber;
    }
    else
    {
      sFieldValid = "valor_total_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "valor_total_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "valor_total_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_detalhe_validate_valor_total__cb

  // ---------- Validate unidade_
  function do_ajax_nfce_detalhe_validate_unidade_(iNumLinha)
  {
    var nomeCampo_unidade_ = "unidade_" + iNumLinha;
    var var_unidade_ = scAjaxGetFieldHidden(nomeCampo_unidade_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_detalhe_validate_unidade_(var_unidade_, iNumLinha, var_script_case_init, do_ajax_nfce_detalhe_validate_unidade__cb);
  } // do_ajax_nfce_detalhe_validate_unidade_

  function do_ajax_nfce_detalhe_validate_unidade__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "unidade_" + iLineNumber;
    }
    else
    {
      sFieldValid = "unidade_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "unidade_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "unidade_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_detalhe_validate_unidade__cb

  // ---------- Validate iditens_orcamento_
  function do_ajax_nfce_detalhe_validate_iditens_orcamento_(iNumLinha)
  {
    var nomeCampo_iditens_orcamento_ = "iditens_orcamento_" + iNumLinha;
    var var_iditens_orcamento_ = scAjaxGetFieldText(nomeCampo_iditens_orcamento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_detalhe_validate_iditens_orcamento_(var_iditens_orcamento_, iNumLinha, var_script_case_init, do_ajax_nfce_detalhe_validate_iditens_orcamento__cb);
  } // do_ajax_nfce_detalhe_validate_iditens_orcamento_

  function do_ajax_nfce_detalhe_validate_iditens_orcamento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "iditens_orcamento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "iditens_orcamento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "iditens_orcamento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "iditens_orcamento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_detalhe_validate_iditens_orcamento__cb

  // ---------- Event onchange quantidade_
  function do_ajax_nfce_detalhe_event_quantidade__onchange(iSeqForm)
  {
    var var_quantidade_ = scAjaxGetFieldText("quantidade_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_nfce_detalhe_event_quantidade__onchange(var_quantidade_, var_script_case_init, var_nmgp_refresh_row, do_ajax_nfce_detalhe_event_quantidade__onchange_cb);
  } // do_ajax_nfce_detalhe_event_quantidade__onchange

  function do_ajax_nfce_detalhe_event_quantidade__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_nfce_detalhe_event_quantidade__onchange_cb_after_alert);
  } // do_ajax_nfce_detalhe_event_quantidade__onchange_cb
  function do_ajax_nfce_detalhe_event_quantidade__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_nfce_detalhe_event_quantidade__onchange_cb_after_alert

  // ---------- Event onchange valor
  function do_ajax_nfce_detalhe_event_valor_onchange(iSeqForm)
  {
    var var_quantidade_ = scAjaxGetFieldText("quantidade_" + iSeqForm);
    var var_script_case_init = document.F2.script_case_init.value;
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_nfce_detalhe_event_valor_onchange(var_quantidade_, var_script_case_init, var_nmgp_refresh_row, do_ajax_nfce_detalhe_event_valor_onchange_cb);
  } // do_ajax_nfce_detalhe_event_valor_onchange

  function do_ajax_nfce_detalhe_event_valor_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    {
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "valor");
    }
    else
    {
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "valor");
    }
    if (!scAjaxHasError())
    {
      scAjaxSetFields();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_nfce_detalhe_event_valor_onchange_cb_after_alert);
  } // do_ajax_nfce_detalhe_event_valor_onchange_cb
  function do_ajax_nfce_detalhe_event_valor_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_nfce_detalhe_event_valor_onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_nfce_detalhe_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_nfce_detalhe_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_nfce_detalhe_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_nfce_detalhe_add_new_line_cb);
  } // do_ajax_nfce_detalhe_add_new_line

  function do_ajax_nfce_detalhe_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_nfce_detalhe_add_new_line_cb

  // ---------- backup_line
  function do_ajax_nfce_detalhe_backup_line(iNumLinha)
  {
    var var_iditens_orcamento_ = scAjaxGetFieldText("iditens_orcamento_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_detalhe_backup_line(var_iditens_orcamento_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_nfce_detalhe_backup_line_cb);
  } // do_ajax_nfce_detalhe_backup_line

  function do_ajax_nfce_detalhe_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_nfce_detalhe_backup_line_cb

  function do_ajax_nfce_detalhe_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_nfce_detalhe_cancel_insert

  function do_ajax_nfce_detalhe_cancel_update(iSeqVert)
  {
    do_ajax_nfce_detalhe_backup_line(iSeqVert);
...
?>
  } // do_ajax_nfce_detalhe_cancel_update

  function do_ajax_nfce_detalhe_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_nfce_detalhe_restore_buttons

  // ---------- table_refresh
  function do_ajax_nfce_detalhe_table_refresh()
  {
    var var_iditens_orcamento_ = document.F2.iditens_orcamento_.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_nfce_detalhe_table_refresh(var_iditens_orcamento_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_nfce_detalhe_table_refresh_cb);
  } //  do_ajax_nfce_detalhe_table_refresh

  function do_ajax_nfce_detalhe_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.iditens_orcamento_.value = scAjaxGetKeyValue("iditens_orcamento_");
    ...
    scAjaxAlert(do_ajax_nfce_detalhe_table_refresh_cb_after_alert);
  } // do_ajax_nfce_detalhe_table_refresh_cb
  function do_ajax_nfce_detalhe_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_nfce_detalhe_table_refresh_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_nfce_detalhe_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_nfce_detalhe_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_idproduto_ = scAjaxGetFieldText("idproduto_" + iNumLinha);
    var var_quantidade_ = scAjaxGetFieldText("quantidade_" + iNumLinha);
    var var_descricao_ = scAjaxGetFieldText("descricao_" + iNumLinha);
    var var_qtde_ = scAjaxGetFieldText("qtde_" + iNumLinha);
    var var_valor_unitario_ = scAjaxGetFieldText("valor_unitario_" + iNumLinha);
    var var_valor_total_ = scAjaxGetFieldText("valor_total_" + iNumLinha);
    var var_unidade_ = scAjaxGetFieldHidden("unidade_" + iNumLinha);
    var var_iditens_orcamento_ = scAjaxGetFieldText("iditens_orcamento_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_nfce_detalhe_submit_form(var_idproduto_, var_quantidade_, var_descricao_, var_qtde_, var_valor_unitario_, var_valor_total_, var_unidade_, var_iditens_orcamento_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_nfce_detalhe_submit_form_cb);
  } // do_ajax_nfce_detalhe_submit_form

  function do_ajax_nfce_detalhe_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idproduto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("quantidade_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("descricao_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("qtde_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("valor_unitario_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("valor_total_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("unidade_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("iditens_orcamento_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_nfce_detalhe_submit_form_cb_after_alert);
  } // do_ajax_nfce_detalhe_submit_form_cb
  function do_ajax_nfce_detalhe_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_nfce_detalhe_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_nfce_detalhe_navigate_form()
  {
    perform_ajax_nfce_detalhe_navigate_form();
  }

  function perform_ajax_nfce_detalhe_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_nfce_detalhe_cancel_insert(sc_nfce_detalhe_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idproduto_" + iNavForm);
      scAjaxHideErrorDisplay("quantidade_" + iNavForm);
      scAjaxHideErrorDisplay("descricao_" + iNavForm);
      scAjaxHideErrorDisplay("qtde_" + iNavForm);
      scAjaxHideErrorDisplay("valor_unitario_" + iNavForm);
      scAjaxHideErrorDisplay("valor_total_" + iNavForm);
      scAjaxHideErrorDisplay("unidade_" + iNavForm);
      scAjaxHideErrorDisplay("iditens_orcamento_" + iNavForm);
    }
    var var_iditens_orcamento_ = document.F2.iditens_orcamento_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_nfce_detalhe_navigate_form(var_iditens_orcamento_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_nfce_detalhe_navigate_form_cb);
  } // do_ajax_nfce_detalhe_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_detalhe']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_nfce_detalhe_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.iditens_orcamento_.value = scAjaxGetKeyValue("iditens_orcamento_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_nfce_detalhe_navigate_form_cb_after_alert);
  } // do_ajax_nfce_detalhe_navigate_form_cb
  function do_ajax_nfce_detalhe_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_nfce_detalhe_navigate_form_cb_after_alert

    function sc_nfce_detalhe_get_last_line_number()
    {
    ...
    } //sc_nfce_detalhe_get_last_line_number

  function sc_hide_nfce_detalhe_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idproduto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "quantidade_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "descricao_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "qtde_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valor_unitario_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "valor_total_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "unidade_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "iditens_orcamento_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idproduto_" + iNumLinha] = {"label": "Idproduto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["quantidade_" + iNumLinha] = {"label": "Qtde<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["qtde_" + iNumLinha] = {"label": "Quantidade<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["valor_unitario_" + iNumLinha] = {"label": "Valor Unitario<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["valor_total_" + iNumLinha] = {"label": "Valor Total<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["unidade_" + iNumLinha] = {"label": "Und<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["iditens_orcamento_" + iNumLinha] = {"label": "Iditens Orcamento<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idproduto_"][iNumLinha] = "idproduto_" + iNumLinha;
    ajax_field_mult["quantidade_"][iNumLinha] = "quantidade_" + iNumLinha;
    ajax_field_mult["descricao_"][iNumLinha] = "descricao_" + iNumLinha;
    ajax_field_mult["qtde_"][iNumLinha] = "qtde_" + iNumLinha;
    ajax_field_mult["valor_unitario_"][iNumLinha] = "valor_unitario_" + iNumLinha;
    ajax_field_mult["valor_total_"][iNumLinha] = "valor_total_" + iNumLinha;
    ajax_field_mult["unidade_"][iNumLinha] = "unidade_" + iNumLinha;
    ajax_field_mult["iditens_orcamento_"][iNumLinha] = "iditens_orcamento_" + iNumLinha;
    ajax_field_id["idproduto_" + iNumLinha] = new Array("hidden_field_label_idproduto_", "hidden_field_data_idproduto_" + iNumLinha);
    ...
    ajax_field_id["qtde_" + iNumLinha] = new Array("hidden_field_label_qtde_", "hidden_field_data_qtde_" + iNumLinha);
    ...
    ajax_field_id["valor_total_" + iNumLinha] = new Array("hidden_field_label_valor_total_", "hidden_field_data_valor_total_" + iNumLinha);
    ajax_field_id["unidade_" + iNumLinha] = new Array("hidden_field_label_unidade_", "hidden_field_data_unidade_" + iNumLinha);
    ajax_error_count["idproduto_" + iNumLinha] = "off";
    ajax_error_count["quantidade_" + iNumLinha] = "off";
    ajax_error_count["descricao_" + iNumLinha] = "off";
    ajax_error_count["qtde_" + iNumLinha] = "off";
    ajax_error_count["valor_unitario_" + iNumLinha] = "off";
    ajax_error_count["valor_total_" + iNumLinha] = "off";
    ajax_error_count["unidade_" + iNumLinha] = "off";
    ajax_error_count["iditens_orcamento_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idproduto_" + iNumLinha] = "off";
    ajax_read_only["quantidade_" + iNumLinha] = "off";
    ajax_read_only["descricao_" + iNumLinha] = "off";
    ajax_read_only["qtde_" + iNumLinha] = "off";
    ajax_read_only["valor_unitario_" + iNumLinha] = "off";
    ajax_read_only["valor_total_" + iNumLinha] = "off";
    ajax_read_only["unidade_" + iNumLinha] = "off";
    ajax_read_only["iditens_orcamento_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["idproduto_" + iNumLinha] = "on";
    ajax_read_only["quantidade_" + iNumLinha] = "on";
    ajax_read_only["descricao_" + iNumLinha] = "on";
    ajax_read_only["qtde_" + iNumLinha] = "on";
    ajax_read_only["valor_unitario_" + iNumLinha] = "on";
    ajax_read_only["valor_total_" + iNumLinha] = "on";
    ajax_read_only["unidade_" + iNumLinha] = "on";
    ajax_read_only["iditens_orcamento_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["idproduto_" + iNumLinha] = null;
    ajax_error_list["quantidade_" + iNumLinha] = null;
    ajax_error_list["descricao_" + iNumLinha] = null;
    ajax_error_list["qtde_" + iNumLinha] = null;
    ajax_error_list["valor_unitario_" + iNumLinha] = null;
    ajax_error_list["valor_total_" + iNumLinha] = null;
    ajax_error_list["unidade_" + iNumLinha] = null;
    ajax_error_list["iditens_orcamento_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idproduto_": new Array(),
    "quantidade_": new Array(),
    "descricao_": new Array(),
    "qtde_": new Array(),
    "valor_unitario_": new Array(),
    "valor_total_": new Array(),
    "unidade_": new Array(),
    "iditens_orcamento_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idproduto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idproduto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idproduto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idproduto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idproduto_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["qtde_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["qtde_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["qtde_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["qtde_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["qtde_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["valor_total_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["valor_total_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["valor_total_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["valor_total_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["valor_total_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["unidade_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["unidade_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["unidade_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["unidade_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["unidade_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["iditens_orcamento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["iditens_orcamento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["iditens_orcamento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["iditens_orcamento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["iditens_orcamento_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
    ...
    mdOpenObjects(iSeq);
    Obj_Focus = eval("document.getElementById('id_sc_field_quantidade_" + iSeq + "')");
    if (Obj_Focus)
    {
        Obj_Focus.focus();
    }
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idproduto_'])) ? $this->nmgp_cmp_readonly['idproduto_'] : 'off';
?>
    scAjaxFieldRead("idproduto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['qtde_'])) ? $this->nmgp_cmp_readonly['qtde_'] : 'off';
?>
    scAjaxFieldRead("qtde_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['valor_total_'])) ? $this->nmgp_cmp_readonly['valor_total_'] : 'off';
?>
    scAjaxFieldRead("valor_total_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['unidade_'])) ? $this->nmgp_cmp_readonly['unidade_'] : 'off';
?>
    scAjaxFieldRead("unidade_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['iditens_orcamento_'])) ? $this->nmgp_cmp_readonly['iditens_orcamento_'] : 'on';
?>
    scAjaxFieldRead("iditens_orcamento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idproduto_" + iSeq, "on");
    scAjaxFieldRead("quantidade_" + iSeq, "on");
    scAjaxFieldRead("descricao_" + iSeq, "on");
    scAjaxFieldRead("qtde_" + iSeq, "on");
    scAjaxFieldRead("valor_unitario_" + iSeq, "on");
    scAjaxFieldRead("valor_total_" + iSeq, "on");
    scAjaxFieldRead("unidade_" + iSeq, "on");
    scAjaxFieldRead("iditens_orcamento_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idproduto_" + iRow] || "on" == ajax_error_count["quantidade_" + iRow] || "on" == ajax_error_count["descricao_" + iRow] || "on" == ajax_error_count["qtde_" + iRow] || "on" == ajax_error_count["valor_unitario_" + iRow] || "on" == ajax_error_count["valor_total_" + iRow] || "on" == ajax_error_count["unidade_" + iRow] || "on" == ajax_error_count["iditens_orcamento_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idproduto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_quantidade_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_descricao_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_qtde_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_valor_unitario_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_valor_total_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_unidade_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_iditens_orcamento_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idproduto_" + iRow] && "off" == ajax_error_count["quantidade_" + iRow] && "off" == ajax_error_count["descricao_" + iRow] && "off" == ajax_error_count["qtde_" + iRow] && "off" == ajax_error_count["valor_unitario_" + iRow] && "off" == ajax_error_count["valor_total_" + iRow] && "off" == ajax_error_count["unidade_" + iRow] && "off" == ajax_error_count["iditens_orcamento_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idproduto_" + iRow] = "off";
        ajax_error_count["quantidade_" + iRow] = "off";
        ajax_error_count["descricao_" + iRow] = "off";
        ajax_error_count["qtde_" + iRow] = "off";
        ajax_error_count["valor_unitario_" + iRow] = "off";
        ajax_error_count["valor_total_" + iRow] = "off";
        ajax_error_count["unidade_" + iRow] = "off";
        ajax_error_count["iditens_orcamento_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idproduto_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_qtde_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_valor_unitario_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_valor_total_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_unidade_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_iditens_orcamento_" + iRow).removeClass("scFormErrorLine");
    }
  }
