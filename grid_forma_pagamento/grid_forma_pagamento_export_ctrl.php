<?php
@session_start() ;
$_SESSION['scriptcase']['grid_forma_pagamento']['sc_process_barr'] = true;
require_once('../grid_forma_pagamento/index.php');
unset($_SESSION['scriptcase']['grid_forma_pagamento']['sc_process_barr']);
$ExportCtrl = new grid_forma_pagamento_export_control;
$ExportCtrl->Export_barr();

class grid_forma_pagamento_export_control
{
