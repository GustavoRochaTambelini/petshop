...
<?php
   ...
   $Ord_Cmp = new grid_forma_pagamento_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_forma_pagamento_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idforma_pagamento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['labels']["idforma_pagamento"])) ? $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['labels']["idforma_pagamento"] : "ID";
   $tab_ger_campos['descricao'] = "on";
   $tab_def_campos['descricao'] = "descricao";
   $tab_labels["descricao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['labels']["descricao"])) ? $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['labels']["descricao"] : "DESCRIÇÃO";
   $tab_ger_campos['idconta_corrente'] = "on";
   $tab_def_campos['idconta_corrente'] = "idconta_corrente";
   $tab_labels["idconta_corrente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['labels']["idconta_corrente"])) ? $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['labels']["idconta_corrente"] : "CONTA CORRENTE";
   $tab_ger_campos['idtipo_cartao'] = "on";
   $tab_def_campos['idtipo_cartao'] = "idtipo_cartao";
   $tab_labels["idtipo_cartao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['labels']["idtipo_cartao"])) ? $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['labels']["idtipo_cartao"] : "TIPO CARTÃO";
   $tab_ger_campos['ativo'] = "on";
   $tab_def_campos['ativo'] = "ativo";
   $tab_labels["ativo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['labels']["ativo"])) ? $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['labels']["ativo"] : "ATIVO";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_forma_pagamento_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_forma_pagamento']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
