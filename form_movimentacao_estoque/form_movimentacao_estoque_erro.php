...
$old_error_handler = set_error_handler("form_movimentacao_estoque_scriptcase_error_handler");

function form_movimentacao_estoque_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['form_movimentacao_estoque']['contr_erro']) && $_SESSION['scriptcase']['form_movimentacao_estoque']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_movimentacao_estoque->contr_form_movimentacao_estoque->Apl_com_erro = true;
            if ($inicial_form_movimentacao_estoque->contr_form_movimentacao_estoque->NM_ajax_flag)
            {
                $inicial_form_movimentacao_estoque->contr_form_movimentacao_estoque->NM_ajax_info['errList']['geral_form_movimentacao_estoque'][] = $msg;
                return;
            }
            form_movimentacao_estoque_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_movimentacao_estoque_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_movimentacao_estoque'])  && '' != $_SESSION['scriptcase']['error_icon']['form_movimentacao_estoque'])  ? $_SESSION['scriptcase']['error_icon']['form_movimentacao_estoque']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_movimentacao_estoque']) && '' != $_SESSION['scriptcase']['error_close']['form_movimentacao_estoque']) ? $_SESSION['scriptcase']['error_close']['form_movimentacao_estoque'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_movimentacao_estoque']) && '' != $_SESSION['scriptcase']['error_span_title']['form_movimentacao_estoque']) ? $_SESSION['scriptcase']['error_span_title']['form_movimentacao_estoque'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_movimentacao_estoque']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_movimentacao_estoque']) ? $_SESSION['scriptcase']['error_icon_title']['form_movimentacao_estoque'] : '';
?>
