  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_movimentacao_estoque_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_movimentacao_estoque_mob_form();
	}
...
?>
  ...
  // ---------- Validate idmovimentacao_estoque
  function do_ajax_form_movimentacao_estoque_mob_validate_idmovimentacao_estoque()
  {
    var nomeCampo_idmovimentacao_estoque = "idmovimentacao_estoque";
    var var_idmovimentacao_estoque = scAjaxGetFieldHidden(nomeCampo_idmovimentacao_estoque);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimentacao_estoque_mob_validate_idmovimentacao_estoque(var_idmovimentacao_estoque, var_script_case_init, do_ajax_form_movimentacao_estoque_mob_validate_idmovimentacao_estoque_cb);
  } // do_ajax_form_movimentacao_estoque_mob_validate_idmovimentacao_estoque

  function do_ajax_form_movimentacao_estoque_mob_validate_idmovimentacao_estoque_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idmovimentacao_estoque";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimentacao_estoque_mob_validate_idmovimentacao_estoque_cb

  // ---------- Validate idproduto
  function do_ajax_form_movimentacao_estoque_mob_validate_idproduto()
  {
    var nomeCampo_idproduto = "idproduto";
    var var_idproduto = scAjaxGetFieldSelect(nomeCampo_idproduto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimentacao_estoque_mob_validate_idproduto(var_idproduto, var_script_case_init, do_ajax_form_movimentacao_estoque_mob_validate_idproduto_cb);
  } // do_ajax_form_movimentacao_estoque_mob_validate_idproduto

  function do_ajax_form_movimentacao_estoque_mob_validate_idproduto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimentacao_estoque_mob_validate_idproduto_cb

  // ---------- Validate movimentacao
  function do_ajax_form_movimentacao_estoque_mob_validate_movimentacao()
  {
    var nomeCampo_movimentacao = "movimentacao";
    var var_movimentacao = scAjaxGetFieldText(nomeCampo_movimentacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimentacao_estoque_mob_validate_movimentacao(var_movimentacao, var_script_case_init, do_ajax_form_movimentacao_estoque_mob_validate_movimentacao_cb);
  } // do_ajax_form_movimentacao_estoque_mob_validate_movimentacao

  function do_ajax_form_movimentacao_estoque_mob_validate_movimentacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "movimentacao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimentacao_estoque_mob_validate_movimentacao_cb

  // ---------- Validate tipo
  function do_ajax_form_movimentacao_estoque_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimentacao_estoque_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_movimentacao_estoque_mob_validate_tipo_cb);
  } // do_ajax_form_movimentacao_estoque_mob_validate_tipo

  function do_ajax_form_movimentacao_estoque_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimentacao_estoque_mob_validate_tipo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_movimentacao_estoque_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_movimentacao_estoque_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idmovimentacao_estoque = scAjaxGetFieldHidden("idmovimentacao_estoque");
    var var_idproduto = scAjaxGetFieldSelect("idproduto");
    var var_movimentacao = scAjaxGetFieldText("movimentacao");
    ...
    scAjaxProcOn();
    x_ajax_form_movimentacao_estoque_mob_submit_form(var_idmovimentacao_estoque, var_idproduto, var_movimentacao, var_tipo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_movimentacao_estoque_mob_submit_form_cb);
  } // do_ajax_form_movimentacao_estoque_mob_submit_form

  function do_ajax_form_movimentacao_estoque_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idmovimentacao_estoque");
      scAjaxHideErrorDisplay("idproduto");
      scAjaxHideErrorDisplay("movimentacao");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_movimentacao_estoque_mob_submit_form_cb_after_alert);
  } // do_ajax_form_movimentacao_estoque_mob_submit_form_cb
  function do_ajax_form_movimentacao_estoque_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_movimentacao_estoque_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_movimentacao_estoque_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_movimentacao_estoque_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_movimentacao_estoque_mob_navigate_form();
    }
  }

  function perform_ajax_form_movimentacao_estoque_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("movimentacao");
    scAjaxHideErrorDisplay("tipo");
    var var_idmovimentacao_estoque = document.F2.idmovimentacao_estoque.value;
    ...
    scAjaxProcOn();
    x_ajax_form_movimentacao_estoque_mob_navigate_form(var_idmovimentacao_estoque, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_movimentacao_estoque_mob_navigate_form_cb);
  } // do_ajax_form_movimentacao_estoque_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movimentacao_estoque_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_movimentacao_estoque_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idmovimentacao_estoque.value = scAjaxGetKeyValue("idmovimentacao_estoque");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_movimentacao_estoque_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_movimentacao_estoque_mob_navigate_form_cb
  function do_ajax_form_movimentacao_estoque_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_movimentacao_estoque_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_movimentacao_estoque_mob_navigate_form_cb_after_alert

  function sc_hide_form_movimentacao_estoque_mob_form()
  {
  ...
  ajax_field_list[0] = "idmovimentacao_estoque";
  ajax_field_list[1] = "idproduto";
  ajax_field_list[2] = "movimentacao";
  ...
  var ajax_error_list = {
    "idmovimentacao_estoque": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idproduto": {"label": "PRODUTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "movimentacao": {"label": "QTDE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo": {"label": "TIPO MOVIMENTAÇÃO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idmovimentacao_estoque": new Array(),
    "idproduto": new Array(),
    "movimentacao": new Array(),
    "tipo": new Array()
  };
  ajax_field_mult["idmovimentacao_estoque"][1] = "idmovimentacao_estoque";
  ajax_field_mult["idproduto"][1] = "idproduto";
  ajax_field_mult["movimentacao"][1] = "movimentacao";
  ajax_field_mult["tipo"][1] = "tipo";

  var ajax_field_id = {
    "idmovimentacao_estoque": new Array("hidden_field_label_idmovimentacao_estoque", "hidden_field_data_idmovimentacao_estoque"),
    "idproduto": new Array("hidden_field_label_idproduto", "hidden_field_data_idproduto"),
    "movimentacao": new Array("hidden_field_label_movimentacao", "hidden_field_data_movimentacao"),
    "tipo": new Array("hidden_field_label_tipo", "hidden_field_data_tipo")
  };

  var ajax_read_only = {
    "idmovimentacao_estoque": "on",
    "idproduto": "off",
    "movimentacao": "off",
    "tipo": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idmovimentacao_estoque" == sIndex)
    {
