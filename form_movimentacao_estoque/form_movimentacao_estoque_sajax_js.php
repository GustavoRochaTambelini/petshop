  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_movimentacao_estoque" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_movimentacao_estoque_form();
	}
...
?>
  ...
  function do_ajax_form_movimentacao_estoque_validate_idmovimentacao_estoque()
  {
    ...
    x_ajax_form_movimentacao_estoque_validate_idmovimentacao_estoque(var_idmovimentacao_estoque, var_script_case_init, do_ajax_form_movimentacao_estoque_validate_idmovimentacao_estoque_cb);
  } // do_ajax_form_movimentacao_estoque_validate_idmovimentacao_estoque

  function do_ajax_form_movimentacao_estoque_validate_idmovimentacao_estoque_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimentacao_estoque_validate_idmovimentacao_estoque_cb

  // ---------- Validate idproduto
  function do_ajax_form_movimentacao_estoque_validate_idproduto()
  {
    var nomeCampo_idproduto = "idproduto";
    var var_idproduto = scAjaxGetFieldSelect(nomeCampo_idproduto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimentacao_estoque_validate_idproduto(var_idproduto, var_script_case_init, do_ajax_form_movimentacao_estoque_validate_idproduto_cb);
  } // do_ajax_form_movimentacao_estoque_validate_idproduto

  function do_ajax_form_movimentacao_estoque_validate_idproduto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimentacao_estoque_validate_idproduto_cb

  // ---------- Validate movimentacao
  function do_ajax_form_movimentacao_estoque_validate_movimentacao()
  {
    var nomeCampo_movimentacao = "movimentacao";
    var var_movimentacao = scAjaxGetFieldText(nomeCampo_movimentacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimentacao_estoque_validate_movimentacao(var_movimentacao, var_script_case_init, do_ajax_form_movimentacao_estoque_validate_movimentacao_cb);
  } // do_ajax_form_movimentacao_estoque_validate_movimentacao

  function do_ajax_form_movimentacao_estoque_validate_movimentacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimentacao_estoque_validate_movimentacao_cb

  // ---------- Validate tipo
  function do_ajax_form_movimentacao_estoque_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldSelect(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_movimentacao_estoque_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_movimentacao_estoque_validate_tipo_cb);
  } // do_ajax_form_movimentacao_estoque_validate_tipo

  function do_ajax_form_movimentacao_estoque_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_movimentacao_estoque_validate_tipo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_movimentacao_estoque_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_movimentacao_estoque_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_movimentacao_estoque_submit_form(var_idmovimentacao_estoque, var_idproduto, var_movimentacao, var_tipo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_movimentacao_estoque_submit_form_cb);
  } // do_ajax_form_movimentacao_estoque_submit_form

  function do_ajax_form_movimentacao_estoque_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_movimentacao_estoque_submit_form_cb_after_alert);
  } // do_ajax_form_movimentacao_estoque_submit_form_cb
  function do_ajax_form_movimentacao_estoque_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_movimentacao_estoque_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_movimentacao_estoque_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_movimentacao_estoque_navigate_form, function() {});
    } else {
      perform_ajax_form_movimentacao_estoque_navigate_form();
    }
  }

  function perform_ajax_form_movimentacao_estoque_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_movimentacao_estoque_navigate_form(var_idmovimentacao_estoque, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_movimentacao_estoque_navigate_form_cb);
  } // do_ajax_form_movimentacao_estoque_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_movimentacao_estoque']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_movimentacao_estoque_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_movimentacao_estoque_navigate_form_cb_after_alert);
  } // do_ajax_form_movimentacao_estoque_navigate_form_cb
  function do_ajax_form_movimentacao_estoque_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_movimentacao_estoque_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_movimentacao_estoque_navigate_form_cb_after_alert

  function sc_hide_form_movimentacao_estoque_form()
  {
