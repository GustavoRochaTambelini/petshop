  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pet_cliente" == sTestField)
        {
...
?>
  ...
  // ---------- Validate foto_pet_
  function do_ajax_form_pet_cliente_validate_foto_pet_(iNumLinha)
  {
    var nomeCampo_foto_pet_ = "foto_pet_" + iNumLinha;
    var var_foto_pet_ = scAjaxGetFieldText(nomeCampo_foto_pet_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_cliente_validate_foto_pet_(var_foto_pet_, iNumLinha, var_script_case_init, do_ajax_form_pet_cliente_validate_foto_pet__cb);
  } // do_ajax_form_pet_cliente_validate_foto_pet_

  function do_ajax_form_pet_cliente_validate_foto_pet__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "foto_pet_" + iLineNumber;
    }
    else
    {
      sFieldValid = "foto_pet_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "foto_pet_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "foto_pet_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_cliente_validate_foto_pet__cb

  // ---------- Validate nome_
  function do_ajax_form_pet_cliente_validate_nome_(iNumLinha)
  {
    var nomeCampo_nome_ = "nome_" + iNumLinha;
    var var_nome_ = scAjaxGetFieldText(nomeCampo_nome_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_cliente_validate_nome_(var_nome_, iNumLinha, var_script_case_init, do_ajax_form_pet_cliente_validate_nome__cb);
  } // do_ajax_form_pet_cliente_validate_nome_

  function do_ajax_form_pet_cliente_validate_nome__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_cliente_validate_nome__cb

  // ---------- Validate idpet_raca_
  function do_ajax_form_pet_cliente_validate_idpet_raca_(iNumLinha)
  {
    var nomeCampo_idpet_raca_ = "idpet_raca_" + iNumLinha;
    var var_idpet_raca_ = scAjaxGetFieldSelect(nomeCampo_idpet_raca_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_cliente_validate_idpet_raca_(var_idpet_raca_, iNumLinha, var_script_case_init, do_ajax_form_pet_cliente_validate_idpet_raca__cb);
  } // do_ajax_form_pet_cliente_validate_idpet_raca_

  function do_ajax_form_pet_cliente_validate_idpet_raca__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idpet_raca_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idpet_raca_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idpet_raca_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idpet_raca_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_cliente_validate_idpet_raca__cb

  // ---------- Validate data_nascimento_
  function do_ajax_form_pet_cliente_validate_data_nascimento_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_cliente_validate_data_nascimento_(var_data_nascimento_, iNumLinha, var_script_case_init, do_ajax_form_pet_cliente_validate_data_nascimento__cb);
  } // do_ajax_form_pet_cliente_validate_data_nascimento_

  function do_ajax_form_pet_cliente_validate_data_nascimento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_cliente_validate_data_nascimento__cb

  // ---------- Validate sexo_
  function do_ajax_form_pet_cliente_validate_sexo_(iNumLinha)
  {
    var nomeCampo_sexo_ = "sexo_" + iNumLinha;
    var var_sexo_ = scAjaxGetFieldSelect(nomeCampo_sexo_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_cliente_validate_sexo_(var_sexo_, iNumLinha, var_script_case_init, do_ajax_form_pet_cliente_validate_sexo__cb);
  } // do_ajax_form_pet_cliente_validate_sexo_

  function do_ajax_form_pet_cliente_validate_sexo__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_cliente_validate_sexo__cb

  // ---------- Validate idpet_especie_
  function do_ajax_form_pet_cliente_validate_idpet_especie_(iNumLinha)
  {
    var nomeCampo_idpet_especie_ = "idpet_especie_" + iNumLinha;
    var var_idpet_especie_ = scAjaxGetFieldSelect(nomeCampo_idpet_especie_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_cliente_validate_idpet_especie_(var_idpet_especie_, iNumLinha, var_script_case_init, do_ajax_form_pet_cliente_validate_idpet_especie__cb);
  } // do_ajax_form_pet_cliente_validate_idpet_especie_

  function do_ajax_form_pet_cliente_validate_idpet_especie__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idpet_especie_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idpet_especie_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idpet_especie_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idpet_especie_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_cliente_validate_idpet_especie__cb

  // ---------- Validate idpet_pelagem_
  function do_ajax_form_pet_cliente_validate_idpet_pelagem_(iNumLinha)
  {
    var nomeCampo_idpet_pelagem_ = "idpet_pelagem_" + iNumLinha;
    var var_idpet_pelagem_ = scAjaxGetFieldSelect(nomeCampo_idpet_pelagem_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_cliente_validate_idpet_pelagem_(var_idpet_pelagem_, iNumLinha, var_script_case_init, do_ajax_form_pet_cliente_validate_idpet_pelagem__cb);
  } // do_ajax_form_pet_cliente_validate_idpet_pelagem_

  function do_ajax_form_pet_cliente_validate_idpet_pelagem__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idpet_pelagem_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idpet_pelagem_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idpet_pelagem_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idpet_pelagem_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_cliente_validate_idpet_pelagem__cb

  // ---------- Validate idpet_
  function do_ajax_form_pet_cliente_validate_idpet_(iNumLinha)
  {
    var nomeCampo_idpet_ = "idpet_" + iNumLinha;
    var var_idpet_ = scAjaxGetFieldHidden(nomeCampo_idpet_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_cliente_validate_idpet_(var_idpet_, iNumLinha, var_script_case_init, do_ajax_form_pet_cliente_validate_idpet__cb);
  } // do_ajax_form_pet_cliente_validate_idpet_

  function do_ajax_form_pet_cliente_validate_idpet__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idpet_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idpet_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idpet_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idpet_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_cliente_validate_idpet__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_pet_cliente_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_pet_cliente_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pet_cliente_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_pet_cliente_add_new_line_cb);
  } // do_ajax_form_pet_cliente_add_new_line

  function do_ajax_form_pet_cliente_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    eval("var_ajax_img_foto_pet_" + iAjaxNewLine + " = '';");
  } // do_ajax_form_pet_cliente_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_pet_cliente_backup_line(iNumLinha)
  {
    var var_idpet_ = scAjaxGetFieldHidden("idpet_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_cliente_backup_line(var_idpet_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_pet_cliente_backup_line_cb);
  } // do_ajax_form_pet_cliente_backup_line

  function do_ajax_form_pet_cliente_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_pet_cliente_backup_line_cb

  function do_ajax_form_pet_cliente_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_pet_cliente_cancel_insert

  function do_ajax_form_pet_cliente_cancel_update(iSeqVert)
  {
    do_ajax_form_pet_cliente_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_pet_cliente_cancel_update

  function do_ajax_form_pet_cliente_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_pet_cliente_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_pet_cliente_table_refresh()
  {
    var var_idpet_ = document.F2.idpet_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_pet_cliente_table_refresh(var_idpet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pet_cliente_table_refresh_cb);
  } //  do_ajax_form_pet_cliente_table_refresh

  function do_ajax_form_pet_cliente_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idpet_.value = scAjaxGetKeyValue("idpet_");
    ...
    scAjaxAlert(do_ajax_form_pet_cliente_table_refresh_cb_after_alert);
  } // do_ajax_form_pet_cliente_table_refresh_cb
  function do_ajax_form_pet_cliente_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_pet_cliente_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_pet_cliente_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_pet_cliente_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_foto_pet_ = scAjaxGetFieldText("foto_pet_" + iNumLinha);
    var var_nome_ = scAjaxGetFieldText("nome_" + iNumLinha);
    var var_idpet_raca_ = scAjaxGetFieldSelect("idpet_raca_" + iNumLinha);
    var var_data_nascimento_ = scAjaxGetFieldText("data_nascimento_" + iNumLinha);
    var var_sexo_ = scAjaxGetFieldSelect("sexo_" + iNumLinha);
    var var_idpet_especie_ = scAjaxGetFieldSelect("idpet_especie_" + iNumLinha);
    var var_idpet_pelagem_ = scAjaxGetFieldSelect("idpet_pelagem_" + iNumLinha);
    var var_idpet_ = scAjaxGetFieldHidden("idpet_" + iNumLinha);
    var var_foto_pet__ul_name = scAjaxSpecCharProtect(eval('document.F1.foto_pet__ul_name' + iNumLinha + '.value'));
    var var_foto_pet__ul_type = eval('document.F1.foto_pet__ul_type' + iNumLinha + '.value');
    var var_foto_pet__limpa = eval('document.F1.foto_pet__limpa' + iNumLinha + '.checked') ? "S" : "N";
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_pet_cliente_submit_form(var_foto_pet_, var_nome_, var_idpet_raca_, var_data_nascimento_, var_sexo_, var_idpet_especie_, var_idpet_pelagem_, var_idpet_, var_foto_pet__ul_name, var_foto_pet__ul_type, var_foto_pet__limpa, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pet_cliente_submit_form_cb);
  } // do_ajax_form_pet_cliente_submit_form

  function do_ajax_form_pet_cliente_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("foto_pet_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("nome_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idpet_raca_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("data_nascimento_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("sexo_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idpet_especie_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idpet_pelagem_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idpet_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
<?php
        ...
        {
?>
          if (document.F1.elements["foto_pet__limpa" + sc_num_ult_line] && document.F1.elements["foto_pet__limpa" + sc_num_ult_line].checked)
          {
            var oImgTemp = {0: {"value" : ""}};
            scAjaxSetFieldImage("foto_pet_" + sc_num_ult_line, oImgTemp, "", "", "", "N");
            document.F1.elements["foto_pet__limpa" + sc_num_ult_line].checked = false;
          }
<?php
        }
?>
      }
      eval("if (document.F1.foto_pet__ul_name" + sc_num_ult_line + ") document.F1.foto_pet__ul_name" + sc_num_ult_line + ".value = ''");
      eval("if (document.F1.foto_pet__ul_type" + sc_num_ult_line + ") document.F1.foto_pet__ul_type" + sc_num_ult_line + ".value = ''");
    }
    scAjaxShowDebug();
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pet_cliente_submit_form_cb_after_alert);
  } // do_ajax_form_pet_cliente_submit_form_cb
  function do_ajax_form_pet_cliente_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pet_cliente_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_pet_cliente_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_pet_cliente_navigate_form, function() {});
    } else {
      perform_ajax_form_pet_cliente_navigate_form();
    }
  }

  function perform_ajax_form_pet_cliente_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_pet_cliente_cancel_insert(sc_form_pet_cliente_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("foto_pet_" + iNavForm);
      scAjaxHideErrorDisplay("nome_" + iNavForm);
      scAjaxHideErrorDisplay("idpet_raca_" + iNavForm);
      scAjaxHideErrorDisplay("data_nascimento_" + iNavForm);
      scAjaxHideErrorDisplay("sexo_" + iNavForm);
      scAjaxHideErrorDisplay("idpet_especie_" + iNavForm);
      scAjaxHideErrorDisplay("idpet_pelagem_" + iNavForm);
      scAjaxHideErrorDisplay("idpet_" + iNavForm);
    }
    var var_idpet_ = document.F2.idpet_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_pet_cliente_navigate_form(var_idpet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pet_cliente_navigate_form_cb);
  } // do_ajax_form_pet_cliente_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pet_cliente']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pet_cliente_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idpet_.value = scAjaxGetKeyValue("idpet_" + var_last_index);
    ...
    {
      eval("if (document.F1.foto_pet__ul_name" + iImg + ") document.F1.foto_pet__ul_name" + iImg + ".value = ''");
      eval("if (document.F1.foto_pet__ul_type" + iImg + ") document.F1.foto_pet__ul_type" + iImg + ".value = ''");
    }
    scAjaxSetBtnVars();
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pet_cliente_navigate_form_cb_after_alert);
  } // do_ajax_form_pet_cliente_navigate_form_cb
  function do_ajax_form_pet_cliente_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_pet_cliente_navigate_form_cb_after_alert

    function sc_form_pet_cliente_get_last_line_number()
    {
    ...
    } //sc_form_pet_cliente_get_last_line_number

  function sc_hide_form_pet_cliente_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "foto_pet_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "nome_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idpet_raca_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "data_nascimento_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "sexo_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idpet_especie_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idpet_pelagem_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idpet_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["foto_pet_" + iNumLinha] = {"label": "FOTO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["idpet_raca_" + iNumLinha] = {"label": "RAÇA<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["idpet_especie_" + iNumLinha] = {"label": "ESPECIE<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idpet_pelagem_" + iNumLinha] = {"label": "PELAGEM<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idpet_" + iNumLinha] = {"label": "ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["foto_pet_"][iNumLinha] = "foto_pet_" + iNumLinha;
    ajax_field_mult["nome_"][iNumLinha] = "nome_" + iNumLinha;
    ajax_field_mult["idpet_raca_"][iNumLinha] = "idpet_raca_" + iNumLinha;
    ajax_field_mult["data_nascimento_"][iNumLinha] = "data_nascimento_" + iNumLinha;
    ajax_field_mult["sexo_"][iNumLinha] = "sexo_" + iNumLinha;
    ajax_field_mult["idpet_especie_"][iNumLinha] = "idpet_especie_" + iNumLinha;
    ajax_field_mult["idpet_pelagem_"][iNumLinha] = "idpet_pelagem_" + iNumLinha;
    ajax_field_mult["idpet_"][iNumLinha] = "idpet_" + iNumLinha;
    ajax_field_id["foto_pet_" + iNumLinha] = new Array("hidden_field_label_foto_pet_", "hidden_field_data_foto_pet_" + iNumLinha);
    ajax_field_id["nome_" + iNumLinha] = new Array("hidden_field_label_nome_", "hidden_field_data_nome_" + iNumLinha);
    ajax_field_id["idpet_raca_" + iNumLinha] = new Array("hidden_field_label_idpet_raca_", "hidden_field_data_idpet_raca_" + iNumLinha);
    ...
    ajax_field_id["idpet_especie_" + iNumLinha] = new Array("hidden_field_label_idpet_especie_", "hidden_field_data_idpet_especie_" + iNumLinha);
    ajax_field_id["idpet_pelagem_" + iNumLinha] = new Array("hidden_field_label_idpet_pelagem_", "hidden_field_data_idpet_pelagem_" + iNumLinha);
    ajax_error_count["foto_pet_" + iNumLinha] = "off";
    ajax_error_count["nome_" + iNumLinha] = "off";
    ajax_error_count["idpet_raca_" + iNumLinha] = "off";
    ajax_error_count["data_nascimento_" + iNumLinha] = "off";
    ajax_error_count["sexo_" + iNumLinha] = "off";
    ajax_error_count["idpet_especie_" + iNumLinha] = "off";
    ajax_error_count["idpet_pelagem_" + iNumLinha] = "off";
    ajax_error_count["idpet_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["foto_pet_" + iNumLinha] = "off";
    ajax_read_only["nome_" + iNumLinha] = "off";
    ajax_read_only["idpet_raca_" + iNumLinha] = "off";
    ajax_read_only["data_nascimento_" + iNumLinha] = "off";
    ajax_read_only["sexo_" + iNumLinha] = "off";
    ajax_read_only["idpet_especie_" + iNumLinha] = "off";
    ajax_read_only["idpet_pelagem_" + iNumLinha] = "off";
    ajax_read_only["idpet_" + iNumLinha] = "on";
<?php
}
else
{
?>
    ajax_read_only["foto_pet_" + iNumLinha] = "on";
    ajax_read_only["nome_" + iNumLinha] = "on";
    ajax_read_only["idpet_raca_" + iNumLinha] = "on";
    ajax_read_only["data_nascimento_" + iNumLinha] = "on";
    ajax_read_only["sexo_" + iNumLinha] = "on";
    ajax_read_only["idpet_especie_" + iNumLinha] = "on";
    ajax_read_only["idpet_pelagem_" + iNumLinha] = "on";
    ajax_read_only["idpet_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["foto_pet_" + iNumLinha] = null;
    ajax_error_list["nome_" + iNumLinha] = null;
    ajax_error_list["idpet_raca_" + iNumLinha] = null;
    ajax_error_list["data_nascimento_" + iNumLinha] = null;
    ajax_error_list["sexo_" + iNumLinha] = null;
    ajax_error_list["idpet_especie_" + iNumLinha] = null;
    ajax_error_list["idpet_pelagem_" + iNumLinha] = null;
    ajax_error_list["idpet_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "foto_pet_": new Array(),
    "nome_": new Array(),
    "idpet_raca_": new Array(),
    "data_nascimento_": new Array(),
    "sexo_": new Array(),
    "idpet_especie_": new Array(),
    "idpet_pelagem_": new Array(),
    "idpet_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["foto_pet_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["foto_pet_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["foto_pet_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["foto_pet_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["foto_pet_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["idpet_raca_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idpet_raca_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idpet_raca_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idpet_raca_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idpet_raca_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["idpet_especie_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idpet_especie_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idpet_especie_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idpet_especie_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idpet_especie_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idpet_pelagem_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idpet_pelagem_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idpet_pelagem_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idpet_pelagem_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idpet_pelagem_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idpet_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idpet_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idpet_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idpet_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idpet_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['foto_pet_'])) ? $this->nmgp_cmp_readonly['foto_pet_'] : 'off';
?>
    scAjaxFieldRead("foto_pet_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idpet_raca_'])) ? $this->nmgp_cmp_readonly['idpet_raca_'] : 'off';
?>
    scAjaxFieldRead("idpet_raca_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['data_nascimento_'])) ? $this->nmgp_cmp_readonly['data_nascimento_'] : 'off';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idpet_especie_'])) ? $this->nmgp_cmp_readonly['idpet_especie_'] : 'off';
?>
    scAjaxFieldRead("idpet_especie_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idpet_pelagem_'])) ? $this->nmgp_cmp_readonly['idpet_pelagem_'] : 'off';
?>
    scAjaxFieldRead("idpet_pelagem_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idpet_'])) ? $this->nmgp_cmp_readonly['idpet_'] : 'on';
?>
    scAjaxFieldRead("idpet_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("foto_pet_" + iSeq, "on");
    scAjaxFieldRead("nome_" + iSeq, "on");
    scAjaxFieldRead("idpet_raca_" + iSeq, "on");
    scAjaxFieldRead("data_nascimento_" + iSeq, "on");
    scAjaxFieldRead("sexo_" + iSeq, "on");
    scAjaxFieldRead("idpet_especie_" + iSeq, "on");
    scAjaxFieldRead("idpet_pelagem_" + iSeq, "on");
    scAjaxFieldRead("idpet_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["foto_pet_" + iRow] || "on" == ajax_error_count["nome_" + iRow] || "on" == ajax_error_count["idpet_raca_" + iRow] || "on" == ajax_error_count["data_nascimento_" + iRow] || "on" == ajax_error_count["sexo_" + iRow] || "on" == ajax_error_count["idpet_especie_" + iRow] || "on" == ajax_error_count["idpet_pelagem_" + iRow] || "on" == ajax_error_count["idpet_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_foto_pet_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_nome_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idpet_raca_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_data_nascimento_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sexo_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idpet_especie_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idpet_pelagem_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idpet_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["foto_pet_" + iRow] && "off" == ajax_error_count["nome_" + iRow] && "off" == ajax_error_count["idpet_raca_" + iRow] && "off" == ajax_error_count["data_nascimento_" + iRow] && "off" == ajax_error_count["sexo_" + iRow] && "off" == ajax_error_count["idpet_especie_" + iRow] && "off" == ajax_error_count["idpet_pelagem_" + iRow] && "off" == ajax_error_count["idpet_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["foto_pet_" + iRow] = "off";
        ajax_error_count["nome_" + iRow] = "off";
        ajax_error_count["idpet_raca_" + iRow] = "off";
        ajax_error_count["data_nascimento_" + iRow] = "off";
        ajax_error_count["sexo_" + iRow] = "off";
        ajax_error_count["idpet_especie_" + iRow] = "off";
        ajax_error_count["idpet_pelagem_" + iRow] = "off";
        ajax_error_count["idpet_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_foto_pet_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_nome_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idpet_raca_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_idpet_especie_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idpet_pelagem_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idpet_" + iRow).removeClass("scFormErrorLine");
    }
  }
