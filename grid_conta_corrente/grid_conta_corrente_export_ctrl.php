<?php
@session_start() ;
$_SESSION['scriptcase']['grid_conta_corrente']['sc_process_barr'] = true;
require_once('../grid_conta_corrente/index.php');
unset($_SESSION['scriptcase']['grid_conta_corrente']['sc_process_barr']);
$ExportCtrl = new grid_conta_corrente_export_control;
$ExportCtrl->Export_barr();

class grid_conta_corrente_export_control
{
