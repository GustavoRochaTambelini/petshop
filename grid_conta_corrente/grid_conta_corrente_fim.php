...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_conta_corrente"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_conta_corrente"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_conta_corrente'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_conta_corrente']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_conta_corrente']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_conta_corrente']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_conta_corrente']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_conta_corrente']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_conta_corrente</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_conta_corrente']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_conta_corrente']['embutida_filho'] as $ind => $sc_init)
          {
