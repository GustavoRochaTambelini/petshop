<?php
@session_start() ;
$_SESSION['scriptcase']['grid_contas_pagar']['sc_process_barr'] = true;
require_once('../grid_contas_pagar/index.php');
unset($_SESSION['scriptcase']['grid_contas_pagar']['sc_process_barr']);
$ExportCtrl = new grid_contas_pagar_export_control;
$ExportCtrl->Export_barr();

class grid_contas_pagar_export_control
{
