...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_contas_pagar"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_contas_pagar"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_cliente_contas_pagar'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contas_pagar']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_contas_pagar']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contas_pagar']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_contas_pagar']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_contas_pagar']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_contas_pagar']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_contas_pagar']['embutida_filho'] as $ind => $sc_init)
          {
