  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_tipos_receitas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_tipos_receitas_mob_form();
	}
...
?>
  ...
  function do_ajax_form_tipos_receitas_mob_validate_idtipos_receitas()
  {
    var nomeCampo_idtipos_receitas = "idtipos_receitas";
    var var_idtipos_receitas = scAjaxGetFieldHidden(nomeCampo_idtipos_receitas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_receitas_mob_validate_idtipos_receitas(var_idtipos_receitas, var_script_case_init, do_ajax_form_tipos_receitas_mob_validate_idtipos_receitas_cb);
  } // do_ajax_form_tipos_receitas_mob_validate_idtipos_receitas

  function do_ajax_form_tipos_receitas_mob_validate_idtipos_receitas_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_receitas_mob_validate_idtipos_receitas_cb

  // ---------- Validate descricao
  function do_ajax_form_tipos_receitas_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_receitas_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_tipos_receitas_mob_validate_descricao_cb);
  } // do_ajax_form_tipos_receitas_mob_validate_descricao

  function do_ajax_form_tipos_receitas_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_receitas_mob_validate_descricao_cb

  // ---------- Validate idgrupos_receita
  function do_ajax_form_tipos_receitas_mob_validate_idgrupos_receita()
  {
    var nomeCampo_idgrupos_receita = "idgrupos_receita";
    var var_idgrupos_receita = scAjaxGetFieldSelect(nomeCampo_idgrupos_receita);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_receitas_mob_validate_idgrupos_receita(var_idgrupos_receita, var_script_case_init, do_ajax_form_tipos_receitas_mob_validate_idgrupos_receita_cb);
  } // do_ajax_form_tipos_receitas_mob_validate_idgrupos_receita

  function do_ajax_form_tipos_receitas_mob_validate_idgrupos_receita_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idgrupos_receita";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_receitas_mob_validate_idgrupos_receita_cb

  // ---------- Validate ativo
  function do_ajax_form_tipos_receitas_mob_validate_ativo()
  {
    var nomeCampo_ativo = "ativo";
    var var_ativo = scAjaxGetFieldSelect(nomeCampo_ativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_tipos_receitas_mob_validate_ativo(var_ativo, var_script_case_init, do_ajax_form_tipos_receitas_mob_validate_ativo_cb);
  } // do_ajax_form_tipos_receitas_mob_validate_ativo

  function do_ajax_form_tipos_receitas_mob_validate_ativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ativo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_tipos_receitas_mob_validate_ativo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_tipos_receitas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_tipos_receitas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idtipos_receitas = scAjaxGetFieldHidden("idtipos_receitas");
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_idgrupos_receita = scAjaxGetFieldSelect("idgrupos_receita");
    ...
    scAjaxProcOn();
    x_ajax_form_tipos_receitas_mob_submit_form(var_idtipos_receitas, var_descricao, var_idgrupos_receita, var_ativo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_tipos_receitas_mob_submit_form_cb);
  } // do_ajax_form_tipos_receitas_mob_submit_form

  function do_ajax_form_tipos_receitas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("idgrupos_receita");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_tipos_receitas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_tipos_receitas_mob_submit_form_cb
  function do_ajax_form_tipos_receitas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_tipos_receitas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_tipos_receitas_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_tipos_receitas_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_tipos_receitas_mob_navigate_form();
    }
  }

  function perform_ajax_form_tipos_receitas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("idgrupos_receita");
    scAjaxHideErrorDisplay("ativo");
    var var_idtipos_receitas = document.F2.idtipos_receitas.value;
    ...
    scAjaxProcOn();
    x_ajax_form_tipos_receitas_mob_navigate_form(var_idtipos_receitas, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_tipos_receitas_mob_navigate_form_cb);
  } // do_ajax_form_tipos_receitas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_tipos_receitas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_tipos_receitas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idtipos_receitas.value = scAjaxGetKeyValue("idtipos_receitas");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_tipos_receitas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_tipos_receitas_mob_navigate_form_cb
  function do_ajax_form_tipos_receitas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_tipos_receitas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_tipos_receitas_mob_navigate_form_cb_after_alert

  function sc_hide_form_tipos_receitas_mob_form()
  {
  ...
  ajax_field_list[0] = "idtipos_receitas";
  ajax_field_list[1] = "descricao";
  ajax_field_list[2] = "idgrupos_receita";
  ...
  var ajax_error_list = {
    "idtipos_receitas": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "idgrupos_receita": {"label": "GRUPO DE RECEITAS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "ativo": {"label": "SITUAÇÃO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_id = {
    ...
    "idgrupos_receita": new Array("hidden_field_label_idgrupos_receita", "hidden_field_data_idgrupos_receita"),
