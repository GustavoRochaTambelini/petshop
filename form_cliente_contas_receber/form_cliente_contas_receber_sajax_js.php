  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cliente_contas_receber" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cliente_contas_receber_form();
	}
...
?>
  ...
  // ---------- Validate cpf_cnpj
  function do_ajax_form_cliente_contas_receber_validate_cpf_cnpj()
  {
    var nomeCampo_cpf_cnpj = "cpf_cnpj";
    var var_cpf_cnpj = scAjaxGetFieldText(nomeCampo_cpf_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_contas_receber_validate_cpf_cnpj(var_cpf_cnpj, var_script_case_init, do_ajax_form_cliente_contas_receber_validate_cpf_cnpj_cb);
  } // do_ajax_form_cliente_contas_receber_validate_cpf_cnpj

  function do_ajax_form_cliente_contas_receber_validate_cpf_cnpj_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_contas_receber_validate_cpf_cnpj_cb

  // ---------- Validate nome_fantasia
  function do_ajax_form_cliente_contas_receber_validate_nome_fantasia()
  {
    var nomeCampo_nome_fantasia = "nome_fantasia";
    var var_nome_fantasia = scAjaxGetFieldText(nomeCampo_nome_fantasia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_contas_receber_validate_nome_fantasia(var_nome_fantasia, var_script_case_init, do_ajax_form_cliente_contas_receber_validate_nome_fantasia_cb);
  } // do_ajax_form_cliente_contas_receber_validate_nome_fantasia

  function do_ajax_form_cliente_contas_receber_validate_nome_fantasia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_contas_receber_validate_nome_fantasia_cb

  // ---------- Validate razao_social
  function do_ajax_form_cliente_contas_receber_validate_razao_social()
  {
    var nomeCampo_razao_social = "razao_social";
    var var_razao_social = scAjaxGetFieldText(nomeCampo_razao_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_contas_receber_validate_razao_social(var_razao_social, var_script_case_init, do_ajax_form_cliente_contas_receber_validate_razao_social_cb);
  } // do_ajax_form_cliente_contas_receber_validate_razao_social

  function do_ajax_form_cliente_contas_receber_validate_razao_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_contas_receber_validate_razao_social_cb

  // ---------- Validate contas_receber_detalhes
  function do_ajax_form_cliente_contas_receber_validate_contas_receber_detalhes()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_contas_receber_validate_contas_receber_detalhes(var_contas_receber_detalhes, var_script_case_init, do_ajax_form_cliente_contas_receber_validate_contas_receber_detalhes_cb);
  } // do_ajax_form_cliente_contas_receber_validate_contas_receber_detalhes

  function do_ajax_form_cliente_contas_receber_validate_contas_receber_detalhes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_contas_receber_validate_contas_receber_detalhes_cb

  // ---------- Validate contas_recebido_detalhes
  function do_ajax_form_cliente_contas_receber_validate_contas_recebido_detalhes()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_contas_receber_validate_contas_recebido_detalhes(var_contas_recebido_detalhes, var_script_case_init, do_ajax_form_cliente_contas_receber_validate_contas_recebido_detalhes_cb);
  } // do_ajax_form_cliente_contas_receber_validate_contas_recebido_detalhes

  function do_ajax_form_cliente_contas_receber_validate_contas_recebido_detalhes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_contas_receber_validate_contas_recebido_detalhes_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cliente_contas_receber_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cliente_contas_receber_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cliente_contas_receber_submit_form(var_cpf_cnpj, var_nome_fantasia, var_razao_social, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cliente_contas_receber_submit_form_cb);
  } // do_ajax_form_cliente_contas_receber_submit_form

  function do_ajax_form_cliente_contas_receber_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cliente_contas_receber_submit_form_cb_after_alert);
  } // do_ajax_form_cliente_contas_receber_submit_form_cb
  function do_ajax_form_cliente_contas_receber_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cliente_contas_receber_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_contas_receber_nao_recebido_cliente"] = "off";
  scStatusDetail["grid_contas_receber_recebidos_cliente"] = "off";

  function do_ajax_form_cliente_contas_receber_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_cliente_contas_receber_navigate_form, function() {});
    } else {
      perform_ajax_form_cliente_contas_receber_navigate_form();
    }
  }

  function perform_ajax_form_cliente_contas_receber_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["grid_contas_receber_nao_recebido_cliente"] = "on";
    scStatusDetail["grid_contas_receber_recebidos_cliente"] = "on";
    x_ajax_form_cliente_contas_receber_navigate_form(var_idcliente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cliente_contas_receber_navigate_form_cb);
  } // do_ajax_form_cliente_contas_receber_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cliente_contas_receber_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_contas_receber_nao_recebido_cliente"] && "nmsc_iframe_liga_grid_contas_receber_nao_recebido_cliente" != scMasterDetailIframe["nmsc_iframe_liga_grid_contas_receber_nao_recebido_cliente"]) {
        ...
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_contas_receber_nao_recebido_cliente').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_contas_receber_recebidos_cliente"] && "nmsc_iframe_liga_grid_contas_receber_recebidos_cliente" != scMasterDetailIframe["nmsc_iframe_liga_grid_contas_receber_recebidos_cliente"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_contas_receber_recebidos_cliente"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_contas_receber_recebidos_cliente').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cliente_contas_receber_navigate_form_cb_after_alert);
  } // do_ajax_form_cliente_contas_receber_navigate_form_cb
  function do_ajax_form_cliente_contas_receber_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cliente_contas_receber_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_cliente_contas_receber_navigate_form_cb_after_alert

  function sc_hide_form_cliente_contas_receber_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_contas_receber_nao_recebido_cliente"] && "off" == scStatusDetail["grid_contas_receber_recebidos_cliente"])
    {
      return true;
    }
    return false;
  ...
  var ajax_error_list = {
    ...
    "contas_receber_detalhes": {"label": "contas_receber_detalhes", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "contas_recebido_detalhes": {"label": "contas_recebido_detalhes", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
