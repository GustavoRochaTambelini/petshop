...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_cliente_contas_receber/form_cliente_contas_receber_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_cliente_contas_receber_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_cliente_contas_receber_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['link_info']['remove_border']) {
...
<?php
 include_once("form_cliente_contas_receber_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cliente_contas_receber'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cliente_contas_receber'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-1';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_contas_receber_detalhes'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_contas_receber_detalhes'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['grid_contas_receber_nao_recebido_cliente_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_contas_receber_detalhes'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['grid_contas_receber_nao_recebido_cliente_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_contas_receber_nao_recebido_cliente"]) && $this->Ini->sc_lig_md5["grid_contas_receber_nao_recebido_cliente"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_cliente_contas_receber@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
     $Md5_Lig  = "idcliente*scin" . $this->nmgp_dados_form['idcliente'] . "*scoutpago*scinF*scout";
 }
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_cliente_contas_receber_empty.htm' : $this->Ini->link_grid_contas_receber_nao_recebido_cliente_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_contas_receber_detalhes']) && 'nmsc_iframe_liga_grid_contas_receber_nao_recebido_cliente' != $this->Ini->sc_lig_target['C_@scinf_contas_receber_detalhes'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_contas_receber_detalhes'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['grid_contas_receber_nao_recebido_cliente_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_contas_recebido_detalhes'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_contas_recebido_detalhes'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['grid_contas_receber_recebidos_cliente_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_contas_recebido_detalhes'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['grid_contas_receber_recebidos_cliente_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_cliente_contas_receber_empty.htm' : $this->Ini->link_grid_contas_receber_recebidos_cliente_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_contas_recebido_detalhes']) && 'nmsc_iframe_liga_grid_contas_receber_recebidos_cliente' != $this->Ini->sc_lig_target['C_@scinf_contas_recebido_detalhes'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_contas_recebido_detalhes'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['grid_contas_receber_recebidos_cliente_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_cliente_contas_receber");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_cliente_contas_receber");
 parent.scAjaxDetailHeight("form_cliente_contas_receber", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_contas_receber']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
