<?php
@session_start() ;
$_SESSION['scriptcase']['grid_itens_orcamento_detalhe']['sc_process_barr'] = true;
require_once('../grid_itens_orcamento_detalhe/index.php');
unset($_SESSION['scriptcase']['grid_itens_orcamento_detalhe']['sc_process_barr']);
$ExportCtrl = new grid_itens_orcamento_detalhe_export_control;
$ExportCtrl->Export_barr();

class grid_itens_orcamento_detalhe_export_control
{
