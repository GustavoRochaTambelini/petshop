...
<?php
   ...
   $Ord_Cmp = new grid_itens_orcamento_detalhe_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_itens_orcamento_detalhe_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idproduto'] = "idproduto";
   $tab_labels["idproduto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['labels']["idproduto"])) ? $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['labels']["idproduto"] : "ID PRODUTO";
   $tab_ger_campos['descricao'] = "on";
   $tab_def_campos['descricao'] = "descricao";
   $tab_labels["descricao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['labels']["descricao"])) ? $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['labels']["descricao"] : "DESCRIÇÃO";
   $tab_ger_campos['unidade'] = "on";
   $tab_def_campos['unidade'] = "unidade";
   $tab_labels["unidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['labels']["unidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['labels']["unidade"] : "UNIDADE";
   $tab_ger_campos['valor_unitario'] = "on";
   $tab_def_campos['valor_unitario'] = "valor_unitario";
   $tab_labels["valor_unitario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['labels']["valor_unitario"])) ? $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['labels']["valor_unitario"] : "VALOR UNITARIO";
   $tab_ger_campos['quantidade'] = "on";
   $tab_def_campos['quantidade'] = "quantidade";
   $tab_labels["quantidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['labels']["quantidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['labels']["quantidade"] : "QUANTIDADE";
   $tab_ger_campos['valor_total'] = "on";
   $tab_def_campos['valor_total'] = "valor_total";
   $tab_labels["valor_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['labels']["valor_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['labels']["valor_total"] : "VALOR TOTAL";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_itens_orcamento_detalhe_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_itens_orcamento_detalhe']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
