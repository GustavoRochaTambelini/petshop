...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_itens_orcamento_detalhe"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_itens_orcamento_detalhe"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_itens_orcamento_detalhe']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_itens_orcamento_detalhe']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_itens_orcamento_detalhe']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_itens_orcamento_detalhe']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_itens_orcamento_detalhe']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_itens_orcamento_detalhe</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_itens_orcamento_detalhe']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_itens_orcamento_detalhe']['embutida_filho'] as $ind => $sc_init)
          {
