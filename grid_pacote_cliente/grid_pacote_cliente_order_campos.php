...
<?php
   ...
   $Ord_Cmp = new grid_pacote_cliente_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_pacote_cliente_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idpacote_cliente'] = "idpacote_cliente";
   $tab_labels["idpacote_cliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['labels']["idpacote_cliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['labels']["idpacote_cliente"] : "ID";
   $tab_ger_campos['idcliente'] = "on";
   $tab_def_campos['idcliente'] = "idcliente";
   $tab_labels["idcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['labels']["idcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['labels']["idcliente"] : "CLIENTE";
   $tab_ger_campos['idpacote'] = "on";
   $tab_def_campos['idpacote'] = "idpacote";
   $tab_labels["idpacote"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['labels']["idpacote"])) ? $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['labels']["idpacote"] : "PACOTE";
   ...
   {
       $tab_def_campos['situacao'] = "SELECT
CASE
...
WHERE idpacote_cliente = '{idpacote_cliente}'";
   ...
   $tab_labels["situacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['labels']["situacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['labels']["situacao"] : "SITUAÇÃO";
   $tab_ger_campos['qunatidade_realizada'] = "on";
   $tab_def_campos['qunatidade_realizada'] = "qunatidade_realizada";
   $tab_labels["qunatidade_realizada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['labels']["qunatidade_realizada"])) ? $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['labels']["qunatidade_realizada"] : "QUANTIDADE REALIZADA";
   $tab_ger_campos['valor_total'] = "on";
   $tab_def_campos['valor_total'] = "valor_total";
   $tab_labels["valor_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['labels']["valor_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['labels']["valor_total"] : "VALOR TOTAL";
   $tab_ger_campos['pago'] = "on";
   $tab_def_campos['pago'] = "pago";
   $tab_labels["pago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['labels']["pago"])) ? $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['labels']["pago"] : "PAGO";
   $tab_ger_campos['situacao'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_pacote_cliente_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_pacote_cliente']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
