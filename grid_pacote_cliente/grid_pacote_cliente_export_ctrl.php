<?php
@session_start() ;
$_SESSION['scriptcase']['grid_pacote_cliente']['sc_process_barr'] = true;
require_once('../grid_pacote_cliente/index.php');
unset($_SESSION['scriptcase']['grid_pacote_cliente']['sc_process_barr']);
$ExportCtrl = new grid_pacote_cliente_export_control;
$ExportCtrl->Export_barr();

class grid_pacote_cliente_export_control
{
