<?php
@session_start() ;
$_SESSION['scriptcase']['grid_pet']['sc_process_barr'] = true;
require_once('../grid_pet/index.php');
unset($_SESSION['scriptcase']['grid_pet']['sc_process_barr']);
$ExportCtrl = new grid_pet_export_control;
$ExportCtrl->Export_barr();

class grid_pet_export_control
{
