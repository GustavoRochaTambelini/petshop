...
<?php
   ...
   $Ord_Cmp = new grid_pet_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_pet_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idpet'] = "idpet";
   $tab_labels["idpet"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["idpet"])) ? $_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["idpet"] : "ID";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["nome"] : "NOME";
   $tab_ger_campos['idpet_especie'] = "on";
   $tab_def_campos['idpet_especie'] = "idpet_especie";
   $tab_labels["idpet_especie"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["idpet_especie"])) ? $_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["idpet_especie"] : "ESPECIE";
   $tab_ger_campos['idpet_pelagem'] = "on";
   $tab_def_campos['idpet_pelagem'] = "idpet_pelagem";
   $tab_labels["idpet_pelagem"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["idpet_pelagem"])) ? $_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["idpet_pelagem"] : "PELAGEM";
   $tab_ger_campos['idpet_raca'] = "on";
   $tab_def_campos['idpet_raca'] = "idpet_raca";
   $tab_labels["idpet_raca"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["idpet_raca"])) ? $_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["idpet_raca"] : "RAÇA";
   $tab_ger_campos['sexo'] = "on";
   $tab_def_campos['sexo'] = "sexo";
   $tab_labels["sexo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["sexo"])) ? $_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["sexo"] : "SEXO";
   $tab_ger_campos['idcliente'] = "on";
   $tab_def_campos['idcliente'] = "idcliente";
   $tab_labels["idcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["idcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["idcliente"] : "CLIENTE";
   $tab_ger_campos['data_nascimento'] = "on";
   $tab_def_campos['data_nascimento'] = "data_nascimento";
   $tab_labels["data_nascimento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["data_nascimento"])) ? $_SESSION['sc_session'][$sc_init]['grid_pet']['labels']["data_nascimento"] : "DATA NASCIMENTO";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_pet']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_pet']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_pet']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_pet']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
