...
//======= =========================
   ...
   if (isset($_SESSION['scriptcase']['grid_pet']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['grid_pet']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc8_BlueWood/Sc8_BlueWood";
...
// 
       ...
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['grid_pet'] = "on";
       } 
       if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
       { 
           $_SESSION['scriptcase']['sc_apl_seg']['grid_pet'] = "on";
       } 
       if (!$_SESSION['sc_session'][$script_case_init]['grid_pet']['opc_psq'] && !isset($_SESSION['scriptcase']['grid_pet']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_pet']) || $_SESSION['scriptcase']['sc_apl_seg']['grid_pet'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['grid_pet']['iframe_menu']) ? false : true;
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['grid_pet']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_pet']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['grid_pet']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_pet']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
?>
