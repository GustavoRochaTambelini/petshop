<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tipo_contas']['sc_process_barr'] = true;
require_once('../grid_tipo_contas/index.php');
unset($_SESSION['scriptcase']['grid_tipo_contas']['sc_process_barr']);
$ExportCtrl = new grid_tipo_contas_export_control;
$ExportCtrl->Export_barr();

class grid_tipo_contas_export_control
{
