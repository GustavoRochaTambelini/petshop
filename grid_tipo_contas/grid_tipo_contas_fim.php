...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_tipo_contas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_tipo_contas"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_tipo_contas'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tipo_contas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_tipo_contas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_tipo_contas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_tipo_contas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_tipo_contas']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_tipo_contas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_tipo_contas']['embutida_filho'] as $ind => $sc_init)
          {
