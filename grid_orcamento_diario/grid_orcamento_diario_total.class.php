...
class grid_orcamento_diario_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_orcamento_diario']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_orcamento_diario']['campos_busca']))
      { 
   ...
   {
      global $nada, $nm_lang , $itens_orcamento_idproduto, $orcamento_idcliente;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['contr_total_geral'] == "OK") 
      { 
          return; 
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['tot_geral'] = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(itens_orcamento.quantidade), sum(itens_orcamento.valor_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['where_pesq']; 
      } 
      else 
      { 
          $nm_comando = "select count(*), sum(itens_orcamento.quantidade), sum(itens_orcamento.valor_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['where_pesq']; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['tot_geral'][0] = "" . $this->Ini->Nm_lang['lang_msgs_totl'] . ""; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['tot_geral'][1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $rt->fields[1] = (string)$rt->fields[1]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['tot_geral'][2] = $rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $rt->fields[2] = (string)$rt->fields[2]; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['tot_geral'][3] = $rt->fields[2]; 
      $rt->Close(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['contr_total_geral'] = "OK";
   } 

   //-----  orcamento_data_venda
   function quebra_orcamento_data_venda_sc_free_group_by($orcamento_data_venda, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $itens_orcamento_idproduto, $orcamento_idcliente;
      $tot_orcamento_data_venda = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(itens_orcamento.quantidade), sum(itens_orcamento.valor_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['where_pesq']; 
      } 
      ...
      $tot_orcamento_data_venda[0] = NM_encode_input(sc_strip_script($orcamento_data_venda)) ; 
      $tot_orcamento_data_venda[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_orcamento_data_venda[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_orcamento_data_venda[3] = (string)$rt->fields[2]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_orcamento_data_venda;
   } 

   //-----  orcamento_idcliente
   function quebra_orcamento_idcliente_sc_free_group_by($orcamento_idcliente, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $itens_orcamento_idproduto, $orcamento_idcliente;
      $tot_orcamento_idcliente = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(itens_orcamento.quantidade), sum(itens_orcamento.valor_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['where_pesq']; 
      } 
      ...
      $tot_orcamento_idcliente[0] = NM_encode_input(sc_strip_script($orcamento_idcliente)) ; 
      $tot_orcamento_idcliente[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_orcamento_idcliente[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_orcamento_idcliente[3] = (string)$rt->fields[2]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_orcamento_idcliente;
   } 

   //-----  orcamento_idorcamento
   function quebra_orcamento_idorcamento_sc_free_group_by($orcamento_idorcamento, $Where_qb, $Cmp_Name) 
   {
      $Var_name_gb = "SC_tot_" . $Cmp_Name;
      global $$Var_name_gb, $itens_orcamento_idproduto, $orcamento_idcliente;
      $tot_orcamento_idorcamento = array() ;  
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
      { 
          $nm_comando = "select count(*), sum(itens_orcamento.quantidade), sum(itens_orcamento.valor_total) from " . $this->Ini->nm_tabela . " " . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['where_pesq']; 
      } 
      ...
      $tot_orcamento_idorcamento[0] = NM_encode_input(sc_strip_script($orcamento_idorcamento)) ; 
      $tot_orcamento_idorcamento[1] = $rt->fields[0] ; 
      $rt->fields[1] = str_replace(",", ".", $rt->fields[1]);
      $tot_orcamento_idorcamento[2] = (string)$rt->fields[1]; 
      $rt->fields[2] = str_replace(",", ".", $rt->fields[2]);
      $tot_orcamento_idorcamento[3] = (string)$rt->fields[2]; 
      $rt->Close(); 
      $$Var_name_gb = $tot_orcamento_idorcamento;
   } 
