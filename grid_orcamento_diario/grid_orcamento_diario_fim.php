...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_orcamento_diario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_orcamento_diario"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_orcamento_diario']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_orcamento_diario']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_orcamento_diario']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_orcamento_diario']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_orcamento_diario']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_orcamento_diario</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_orcamento_diario']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_orcamento_diario']['embutida_filho'] as $ind => $sc_init)
          {
