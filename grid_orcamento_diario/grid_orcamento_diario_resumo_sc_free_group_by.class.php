...
class grid_orcamento_diario_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_orcamento_data_venda;
   var $array_total_orcamento_idcliente;
   var $array_total_orcamento_idorcamento;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_orcamento_data_venda  = array();
      $this->array_total_orcamento_idcliente   = array();
      $this->array_total_orcamento_idorcamento = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_orcamento_diario']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_orcamento_diario']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
...
$_SESSION['scriptcase']['grid_orcamento_diario']['contr_erro'] = 'off'; 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pesq_tab_label']))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pesq_tab_label'] .= "orcamento_idorcamento?#?" . "ORÇAMENTO" . "?@?";
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['tot_geral'][2];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['tot_geral'][3];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['arr_total']['orcamento_data_venda'] = $this->array_total_orcamento_data_venda;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['arr_total']['orcamento_idcliente'] = $this->array_total_orcamento_idcliente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['arr_total']['orcamento_idorcamento'] = $this->array_total_orcamento_idorcamento;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['json_use_label'])
       {
          $Lab_orcamento_data_venda = "orcamento.data_venda";
          $Lab_orcamento_idcliente = "orcamento.idcliente";
          $Lab_orcamento_idorcamento = "orcamento.idorcamento";
       }
       else
       {
       $Lab_orcamento_data_venda = "DATA DA VENDA";
       $Lab_orcamento_idcliente = "CLIENTE";
       $Lab_orcamento_idorcamento = "ORÇAMENTO";
       }
       $prep_field = array();
       $prep_field['orcamento_data_venda'] = $Lab_orcamento_data_venda;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_data_venda'] = $Lab_orcamento_data_venda; 
       $prep_field['orcamento_idcliente'] = $Lab_orcamento_idcliente;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_idcliente'] = $Lab_orcamento_idcliente; 
       $prep_field['orcamento_idorcamento'] = $Lab_orcamento_idorcamento;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_idorcamento'] = $Lab_orcamento_idorcamento; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_idproduto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_idproduto'] = "PRODUTO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_quantidade']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_quantidade'] = "QUANTIDADE"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_valor_unitario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_valor_unitario'] = "VALOR TOTAL"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_valor_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_valor_total'] = "VALOR TOTAL"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_idorcamento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_idorcamento'] = "ORÇAMENTO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_idcliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_idcliente'] = "CLIENTE"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_data_venda']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_data_venda'] = "DATA DA VENDA"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_observacao']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_observacao'] = "Observacao"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_status']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_status'] = "Status"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_valor']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_valor'] = "Valor"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_desconto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_desconto'] = "Desconto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_valor_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['orcamento_valor_total'] = "Valor Total"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_iditens_orcamento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_iditens_orcamento'] = "Iditens Orcamento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_idorcamento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_idorcamento'] = "Idorcamento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_descricao']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_descricao'] = "Descricao"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_unidade']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_unidade'] = "Unidade"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_desconto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['labels']['itens_orcamento_desconto'] = "Desconto"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       //-----
       $this->comp_sum = array(
           2 => "Quantidade (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "itens_orcamento_quantidade", 'show' => true),
           3 => array('field' => "itens_orcamento_valor_total", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_itens_orcamento_quantidade_sum",
           3 => "css_itens_orcamento_valor_total_sum",
       );

       //-----
       $this->comp_sum_nm = array(
           2 => "itens_orcamento_quantidade_sum",
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['orcamento_data_venda']['alin'] = "''";
       $Arr_parms['orcamento_data_venda']['link'] = "S";
       $Arr_parms['orcamento_idcliente']['alin'] = "''";
       $Arr_parms['orcamento_idcliente']['link'] = "S";
       $Arr_parms['orcamento_idorcamento']['alin'] = "''";
       $Arr_parms['orcamento_idorcamento']['link'] = "S";
       $Arr_parms['orcamento_data_venda']['fill'] = "true";
       $Arr_parms['orcamento_data_venda']['order'] = "value";
       $Arr_parms['orcamento_data_venda']['order_start'] = 'desc';
       $Arr_parms['orcamento_data_venda']['order_invert'] = 'true';
       $Arr_parms['orcamento_data_venda']['order_enabled'] = 'true';
       $Arr_parms['orcamento_data_venda']['order_datatype'] = 'datetime';
       $Arr_parms['orcamento_idcliente']['fill'] = "true";
       $Arr_parms['orcamento_idcliente']['order'] = "label";
       $Arr_parms['orcamento_idcliente']['order_start'] = 'asc';
       $Arr_parms['orcamento_idcliente']['order_invert'] = 'false';
       $Arr_parms['orcamento_idcliente']['order_enabled'] = 'true';
       $Arr_parms['orcamento_idcliente']['order_datatype'] = 'int';
       $Arr_parms['orcamento_idorcamento']['fill'] = "true";
       $Arr_parms['orcamento_idorcamento']['order'] = "label";
       $Arr_parms['orcamento_idorcamento']['order_start'] = 'asc';
       $Arr_parms['orcamento_idorcamento']['order_invert'] = 'false';
       $Arr_parms['orcamento_idorcamento']['order_enabled'] = 'true';
       $Arr_parms['orcamento_idorcamento']['order_datatype'] = 'int';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['orcamento_data_venda'] = array(0 => 'orcamento_data_venda', 1 => '@aspass@');
       $prep_links_fl['orcamento_idcliente'] = array(0 => 'orcamento_idcliente', 1 => '');
       $prep_links_fl['orcamento_idorcamento'] = array(0 => 'orcamento_idorcamento', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_tabular_label'];
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
           if ($cmp_gb == "orcamento_data_venda")
           {
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_orcamento_diario@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_orcamento_diario_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['arr_total'][$cmp_gb];
      }
      $Cmps_ord_desc = array('orcamento_data_venda');
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          ...
          if (is_array($this->$Arr_tot_name) && in_array($Cmp_orig, $Cmps_ord_desc))
          {
              krsort($this->$Arr_tot_name);
          }
          elseif (is_array($this->$Arr_tot_name))
          {
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['dashboard_refresh_after_chart'] = 'resumo';
      $nm_saida->saida("<HTML" . $_SESSION['scriptcase']['reg_conf']['html_dir'] . ">\r\n");
      $nm_saida->saida("<HEAD>\r\n");
      $nm_saida->saida(" <TITLE>RELATÓRIO DE VENDAS POR DATA</TITLE>\r\n");
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['ajax_nav']) {  
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_orcamento_diario/grid_orcamento_diario_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_orcamento_diario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_orcamento_diario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_orcamento_diario_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['num_css'] . '.css');
     ...
     if (!$this->Ini->Export_html_zip)     {
      ...
      $nm_saida->saida(" </style>\r\n");
           ...
           $nm_saida->saida("     }\r\n");
           $nm_saida->saida("   </script>\r\n");
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['ajax_nav'] && !$this->Ini->sc_export_ajax && !$this->Ini->Export_html_zip && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['doc_word'])
      {
           $nm_saida->saida("   <script type=\"text/javascript\"> \r\n");
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['grid_pesq']))
          { 
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xls'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bexcel", "", "", "Rxls_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + X)", "thickbox", "" . $this->Ini->path_link . "grid_orcamento_diario/grid_orcamento_diario_config_xls.php?script_case_init=" . $this->Ini->sc_page . "&app_name=grid_orcamento_diario&nm_tp_xls=xlsx&nm_tot_xls=S&nm_tot_xls=S&nm_res_cons=s&nm_ini_xls_res=grid&nm_all_modules=grid&password=n&summary_export_columns=S&origem=res&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_orcamento_diario/grid_orcamento_diario_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=pt_br&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_orcamento_diario/grid_orcamento_diario_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=pt_br&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['print'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bprint", "", "", "Rprint_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + P)", "thickbox", "" . $this->Ini->path_link . "grid_orcamento_diario/grid_orcamento_diario_config_print.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_opc=resumo&nm_cor=CO&nm_res_cons=s&nm_ini_prt_res=grid&nm_all_modules=grid&password=n&origem=res&language=pt_br&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_orcamento_diario_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + M)", "thickbox", "" . $this->Ini->path_link . "grid_orcamento_diario/grid_orcamento_diario_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=pt_br&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "__NM_HINT__ (Alt + C)", "thickbox", "" . $this->Ini->path_link . "grid_orcamento_diario/grid_orcamento_diario_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=pt_br&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_orcamento_diario']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_orcamento_diario']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_orcamento_diario_config_pivot.php?nome_apl=grid_orcamento_diario&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_orcamento_diario_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_orcamento_diario/grid_orcamento_diario_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $orcamento_idorcamento = (isset($Busca_temp['orcamento_idorcamento'])) ? $Busca_temp['orcamento_idorcamento'] : ""; 
          $tmp_pos = (is_string($orcamento_idorcamento)) ? strpos($orcamento_idorcamento, "##@@") : false;
          if ($tmp_pos !== false && !is_array($orcamento_idorcamento))
          {
              $orcamento_idorcamento = substr($orcamento_idorcamento, 0, $tmp_pos);
          }
          $orcamento_idcliente = (isset($Busca_temp['orcamento_idcliente'])) ? $Busca_temp['orcamento_idcliente'] : ""; 
          $tmp_pos = (is_string($orcamento_idcliente)) ? strpos($orcamento_idcliente, "##@@") : false;
          if ($tmp_pos !== false && !is_array($orcamento_idcliente))
          {
              $orcamento_idcliente = substr($orcamento_idcliente, 0, $tmp_pos);
          }
          $orcamento_data_venda = (isset($Busca_temp['orcamento_data_venda'])) ? $Busca_temp['orcamento_data_venda'] : ""; 
          $tmp_pos = (is_string($orcamento_data_venda)) ? strpos($orcamento_data_venda, "##@@") : false;
          if ($tmp_pos !== false && !is_array($orcamento_data_venda))
          {
     ...
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['proc_pdf_vert']) {
      ...
      $nm_saida->saida("    <div class=\"" . $this->css_scGridHeaderFont . "\" style=\"float: left; text-transform: uppercase;\">RELATÓRIO DE VENDAS POR DATA</div>\r\n");
   ...
   //---- 
   function adiciona_registro($sum_itens_orcamento_quantidade, $sum_itens_orcamento_valor_total, $quebra_orcamento_data_venda, $quebra_orcamento_idcliente, $quebra_orcamento_idorcamento, $quebra_orcamento_data_venda_orig, $quebra_orcamento_idcliente_orig, $quebra_orcamento_idorcamento_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_orcamento_diario']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_itens_orcamento_quantidade)) {$sum_itens_orcamento_quantidade = '0';}
          if (empty($sum_itens_orcamento_valor_total)) {$sum_itens_orcamento_valor_total = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_itens_orcamento_quantidade . ';
              $this->' . $arr_name . '[2] = ' . $sum_itens_orcamento_valor_total . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_itens_orcamento_quantidade . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_itens_orcamento_valor_total . ', 10);
          }
          ');
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->orcamento_idorcamento = $Busca_temp['orcamento_idorcamento']; 
       $this->orcamento_idorcamento = (isset($Busca_temp['orcamento_idorcamento'])) ? $Busca_temp['orcamento_idorcamento'] : ""; 
       $tmp_pos = (is_string($this->orcamento_idorcamento)) ? strpos($this->orcamento_idorcamento, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->orcamento_idorcamento))
       {
       ...
       $this->orcamento_idcliente = $Busca_temp['orcamento_idcliente']; 
       $this->orcamento_idcliente = (isset($Busca_temp['orcamento_idcliente'])) ? $Busca_temp['orcamento_idcliente'] : ""; 
       $tmp_pos = (is_string($this->orcamento_idcliente)) ? strpos($this->orcamento_idcliente, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->orcamento_idcliente))
       {
       ...
       $this->orcamento_data_venda = $Busca_temp['orcamento_data_venda']; 
       $this->orcamento_data_venda = (isset($Busca_temp['orcamento_data_venda'])) ? $Busca_temp['orcamento_data_venda'] : ""; 
       $tmp_pos = (is_string($this->orcamento_data_venda)) ? strpos($this->orcamento_data_venda, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->orcamento_data_venda))
       {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->itens_orcamento_quantidade = $rs_res->fields[1] ;  
            $this->itens_orcamento_quantidade =  str_replace(",", ".", $this->itens_orcamento_quantidade);
            $this->itens_orcamento_valor_unitario = $rs_res->fields[2] ;  
            ...
            $this->orcamento_idorcamento = $rs_res->fields[4] ;  
            $this->orcamento_idcliente = $rs_res->fields[5] ;  
            $this->orcamento_data_venda = $rs_res->fields[6] ;  
            $this->orcamento_observacao = $rs_res->fields[7] ;  
            $this->orcamento_status = $rs_res->fields[8] ;  
            $this->orcamento_valor = $rs_res->fields[9] ;  
            $this->orcamento_valor =  str_replace(",", ".", $this->orcamento_valor);
            $this->orcamento_data_venda_orig = $this->orcamento_data_venda;
            $this->orcamento_idcliente_orig = $this->orcamento_idcliente;
            $this->orcamento_idorcamento_orig = $this->orcamento_idorcamento;
            ...
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->itens_orcamento_quantidade, $this->itens_orcamento_valor_total, $this->orcamento_data_venda, $this->orcamento_idcliente, $this->orcamento_idorcamento, $this->orcamento_data_venda_orig,  $this->orcamento_idcliente_orig,  $this->orcamento_idorcamento_orig);
            }
   }
//
