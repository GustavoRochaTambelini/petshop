...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "orcamento.data_venda";$Nm_datas[] = "orcamento_data_venda";$Nm_numeric[] = "orcamento_idorcamento";$Nm_numeric[] = "orcamento_idcliente";$Nm_numeric[] = "orcamento_valor";$Nm_numeric[] = "orcamento_desconto";$Nm_numeric[] = "orcamento_valor_total";$Nm_numeric[] = "itens_orcamento_iditens_orcamento";$Nm_numeric[] = "itens_orcamento_idorcamento";$Nm_numeric[] = "itens_orcamento_idproduto";$Nm_numeric[] = "itens_orcamento_valor_unitario";$Nm_numeric[] = "itens_orcamento_quantidade";$Nm_numeric[] = "itens_orcamento_valor_total";$Nm_numeric[] = "itens_orcamento_desconto";
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">RELATÓRIO DE VENDAS POR DATA</div>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_orcamento_idorcamento_cond" name="orcamento_idorcamento_cond" onChange="nm_campos_between(document.getElementById('id_vis_orcamento_idorcamento'), this, 'orcamento_idorcamento')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_orcamento_idcliente_cond" name="orcamento_idcliente_cond" onChange="nm_campos_between(document.getElementById('id_vis_orcamento_idcliente'), this, 'orcamento_idcliente')">
       <OPTION value="eq" <?php if ("eq" == $orcamento_idcliente_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_orcamento_idcliente"  <?php echo $str_hide_orcamento_idcliente?>>
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_orcamento_data_venda_cond" name="orcamento_data_venda_cond" onChange="nm_campos_between(document.getElementById('id_vis_orcamento_data_venda'), this, 'orcamento_data_venda')">
      ...
      <br><span id="id_hide_orcamento_data_venda"  <?php echo $str_hide_orcamento_data_venda?>>
<SPAN id="Nm_bi_dados_orcamento_data_venda" style="display:none"></SPAN>
<SPAN id="opc_bi_TP_orcamento_data_venda"  style="display:''">
...
?>
 ...
 <br><?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_orcamento_data_venda"  <?php echo $str_display_orcamento_data_venda; ?> class="scFilterFieldFontOdd">
