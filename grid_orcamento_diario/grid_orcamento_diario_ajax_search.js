...
Table_sv_fil[0] = "orcamento_idorcamento";
Table_sv_fil[1] = "orcamento_idcliente";
Table_sv_fil[2] = "orcamento_data_venda";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_orcamento_data_venda_cond") && search_get_sel_txt("SC_orcamento_data_venda_cond").substring(0, 3) == "bi_") {
            formata_bi_orcamento_data_venda(search_get_sel_txt("SC_orcamento_data_venda_cond"), SC_orcamento_data_venda_bi_opc, SC_orcamento_data_venda_bi_dt);
        }
