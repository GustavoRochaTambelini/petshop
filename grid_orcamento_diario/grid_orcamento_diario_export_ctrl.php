<?php
@session_start() ;
$_SESSION['scriptcase']['grid_orcamento_diario']['sc_process_barr'] = true;
require_once('../grid_orcamento_diario/index.php');
unset($_SESSION['scriptcase']['grid_orcamento_diario']['sc_process_barr']);
$ExportCtrl = new grid_orcamento_diario_export_control;
$ExportCtrl->Export_barr();

class grid_orcamento_diario_export_control
{
