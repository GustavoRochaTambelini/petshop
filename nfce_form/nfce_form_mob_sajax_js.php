  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_nfce_form_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate qtde_item
  function do_ajax_nfce_form_mob_validate_qtde_item()
  {
    var nomeCampo_qtde_item = "qtde_item";
    var var_qtde_item = scAjaxGetFieldText(nomeCampo_qtde_item);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_form_mob_validate_qtde_item(var_qtde_item, var_script_case_init, do_ajax_nfce_form_mob_validate_qtde_item_cb);
  } // do_ajax_nfce_form_mob_validate_qtde_item

  function do_ajax_nfce_form_mob_validate_qtde_item_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_form_mob_validate_qtde_item_cb

  // ---------- Validate nfce_detalhe
  function do_ajax_nfce_form_mob_validate_nfce_detalhe()
  {
    var nomeCampo_nfce_detalhe = "nfce_detalhe";
    var var_nfce_detalhe = scAjaxGetFieldText(nomeCampo_nfce_detalhe);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_form_mob_validate_nfce_detalhe(var_nfce_detalhe, var_script_case_init, do_ajax_nfce_form_mob_validate_nfce_detalhe_cb);
  } // do_ajax_nfce_form_mob_validate_nfce_detalhe

  function do_ajax_nfce_form_mob_validate_nfce_detalhe_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_form_mob_validate_nfce_detalhe_cb

  // ---------- Validate imagem
  function do_ajax_nfce_form_mob_validate_imagem()
  {
  } // do_ajax_nfce_form_mob_validate_imagem

  function do_ajax_nfce_form_mob_validate_imagem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "imagem";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_form_mob_validate_imagem_cb

  // ---------- Validate cod_barra
  function do_ajax_nfce_form_mob_validate_cod_barra()
  {
    var nomeCampo_cod_barra = "cod_barra";
    var var_cod_barra = scAjaxGetFieldText(nomeCampo_cod_barra);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_form_mob_validate_cod_barra(var_cod_barra, var_script_case_init, do_ajax_nfce_form_mob_validate_cod_barra_cb);
  } // do_ajax_nfce_form_mob_validate_cod_barra

  function do_ajax_nfce_form_mob_validate_cod_barra_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_form_mob_validate_cod_barra_cb

  // ---------- Validate tecla
  function do_ajax_nfce_form_mob_validate_tecla()
  {
    var nomeCampo_tecla = "tecla";
    var var_tecla = scAjaxGetFieldText(nomeCampo_tecla);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_form_mob_validate_tecla(var_tecla, var_script_case_init, do_ajax_nfce_form_mob_validate_tecla_cb);
  } // do_ajax_nfce_form_mob_validate_tecla

  function do_ajax_nfce_form_mob_validate_tecla_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tecla";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_form_mob_validate_tecla_cb

  // ---------- Validate f2
  function do_ajax_nfce_form_mob_validate_f2()
  {
    var nomeCampo_f2 = "f2";
    var var_f2 = scAjaxGetFieldCheckbox(nomeCampo_f2, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_form_mob_validate_f2(var_f2, var_script_case_init, do_ajax_nfce_form_mob_validate_f2_cb);
  } // do_ajax_nfce_form_mob_validate_f2

  function do_ajax_nfce_form_mob_validate_f2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "f2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_form_mob_validate_f2_cb

  // ---------- Validate f4
  function do_ajax_nfce_form_mob_validate_f4()
  {
    var nomeCampo_f4 = "f4";
    var var_f4 = scAjaxGetFieldCheckbox(nomeCampo_f4, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_form_mob_validate_f4(var_f4, var_script_case_init, do_ajax_nfce_form_mob_validate_f4_cb);
  } // do_ajax_nfce_form_mob_validate_f4

  function do_ajax_nfce_form_mob_validate_f4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "f4";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_form_mob_validate_f4_cb

  // ---------- Validate f7
  function do_ajax_nfce_form_mob_validate_f7()
  {
    var nomeCampo_f7 = "f7";
    var var_f7 = scAjaxGetFieldCheckbox(nomeCampo_f7, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_form_mob_validate_f7(var_f7, var_script_case_init, do_ajax_nfce_form_mob_validate_f7_cb);
  } // do_ajax_nfce_form_mob_validate_f7

  function do_ajax_nfce_form_mob_validate_f7_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "f7";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_form_mob_validate_f7_cb

  // ---------- Validate f9
  function do_ajax_nfce_form_mob_validate_f9()
  {
    var nomeCampo_f9 = "f9";
    var var_f9 = scAjaxGetFieldCheckbox(nomeCampo_f9, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_form_mob_validate_f9(var_f9, var_script_case_init, do_ajax_nfce_form_mob_validate_f9_cb);
  } // do_ajax_nfce_form_mob_validate_f9

  function do_ajax_nfce_form_mob_validate_f9_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "f9";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_form_mob_validate_f9_cb

  // ---------- Validate chk_f2
  function do_ajax_nfce_form_mob_validate_chk_f2()
  {
    var nomeCampo_chk_f2 = "chk_f2";
    var var_chk_f2 = scAjaxGetFieldCheckbox(nomeCampo_chk_f2, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_form_mob_validate_chk_f2(var_chk_f2, var_script_case_init, do_ajax_nfce_form_mob_validate_chk_f2_cb);
  } // do_ajax_nfce_form_mob_validate_chk_f2

  function do_ajax_nfce_form_mob_validate_chk_f2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "chk_f2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_form_mob_validate_chk_f2_cb

  // ---------- Validate quantidade
  function do_ajax_nfce_form_mob_validate_quantidade()
  {
    var nomeCampo_quantidade = "quantidade";
    var var_quantidade = scAjaxGetFieldText(nomeCampo_quantidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_form_mob_validate_quantidade(var_quantidade, var_script_case_init, do_ajax_nfce_form_mob_validate_quantidade_cb);
  } // do_ajax_nfce_form_mob_validate_quantidade

  function do_ajax_nfce_form_mob_validate_quantidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_form_mob_validate_quantidade_cb

  // ---------- Validate sc_field_0
  function do_ajax_nfce_form_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_form_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_nfce_form_mob_validate_sc_field_0_cb);
  } // do_ajax_nfce_form_mob_validate_sc_field_0

  function do_ajax_nfce_form_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_form_mob_validate_sc_field_0_cb

  // ---------- Validate valor_total
  function do_ajax_nfce_form_mob_validate_valor_total()
  {
    var nomeCampo_valor_total = "valor_total";
    var var_valor_total = scAjaxGetFieldText(nomeCampo_valor_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_form_mob_validate_valor_total(var_valor_total, var_script_case_init, do_ajax_nfce_form_mob_validate_valor_total_cb);
  } // do_ajax_nfce_form_mob_validate_valor_total

  function do_ajax_nfce_form_mob_validate_valor_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_form_mob_validate_valor_total_cb

  // ---------- Validate pra_pular
  function do_ajax_nfce_form_mob_validate_pra_pular()
  {
    var nomeCampo_pra_pular = "pra_pular";
    var var_pra_pular = scAjaxGetFieldText(nomeCampo_pra_pular);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_form_mob_validate_pra_pular(var_pra_pular, var_script_case_init, do_ajax_nfce_form_mob_validate_pra_pular_cb);
  } // do_ajax_nfce_form_mob_validate_pra_pular

  function do_ajax_nfce_form_mob_validate_pra_pular_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_form_mob_validate_pra_pular_cb

  // ---------- Event onblur qtde_item
  function do_ajax_nfce_form_mob_event_qtde_item_onblur()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_nfce_form_mob_event_qtde_item_onblur(var_qtde_item, var_sc_field_0, var_quantidade, var_imagem, var_script_case_init, do_ajax_nfce_form_mob_event_qtde_item_onblur_cb);
  } // do_ajax_nfce_form_mob_event_qtde_item_onblur

  function do_ajax_nfce_form_mob_event_qtde_item_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "qtde_item";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_nfce_form_mob_event_qtde_item_onblur_cb_after_alert);
  } // do_ajax_nfce_form_mob_event_qtde_item_onblur_cb
  function do_ajax_nfce_form_mob_event_qtde_item_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_nfce_form_mob_event_qtde_item_onblur_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_nfce_form_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_nfce_form_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_qtde_item = scAjaxGetFieldText("qtde_item");
    ...
    var var_idorcamento = scAjaxGetFieldText("idorcamento");
    ...
    scAjaxProcOn();
    x_ajax_nfce_form_mob_submit_form(var_qtde_item, var_imagem, var_cod_barra, var_tecla, var_f2, var_f4, var_f7, var_f9, var_chk_f2, var_quantidade, var_sc_field_0, var_valor_total, var_pra_pular, var_idorcamento, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_nfce_form_mob_submit_form_cb);
  } // do_ajax_nfce_form_mob_submit_form

  function do_ajax_nfce_form_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_nfce_form_mob_submit_form_cb_after_alert);
  } // do_ajax_nfce_form_mob_submit_form_cb
  function do_ajax_nfce_form_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_nfce_form_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["nfce_detalhe_mob"] = "off";

  function do_ajax_nfce_form_mob_navigate_form()
  {
    perform_ajax_nfce_form_mob_navigate_form();
  }

  function perform_ajax_nfce_form_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["nfce_detalhe_mob"] = "on";
    x_ajax_nfce_form_mob_navigate_form(var_idorcamento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_nfce_form_mob_navigate_form_cb);
  } // do_ajax_nfce_form_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_nfce_form_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_nfce_detalhe_mob"] && "nmsc_iframe_liga_nfce_detalhe_mob" != scMasterDetailIframe["nmsc_iframe_liga_nfce_detalhe_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_nfce_detalhe_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_nfce_detalhe_mob').contentWindow.nm_move('apl_detalhe', true, '320');
        document.getElementById('nmsc_iframe_liga_nfce_detalhe_mob').style.height = "320";
        document.getElementById('nmsc_iframe_liga_nfce_detalhe_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_nfce_form_mob_navigate_form_cb_after_alert);
  } // do_ajax_nfce_form_mob_navigate_form_cb
  function do_ajax_nfce_form_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_nfce_form_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_nfce_form_mob_navigate_form_cb_after_alert

  function sc_hide_nfce_form_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["nfce_detalhe_mob"])
    {
      return true;
    }
    return false;
