...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="nfce_form_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_btn_F7_ok()
{
    ...
    document.F1.action = "nfce_form_mob.php";
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form_mob']['where_detal']))
  {
?>  
