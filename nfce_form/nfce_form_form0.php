...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>nfce_form/nfce_form_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('nfce_form_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['link_info']['remove_border']) {
...
<?php
 include_once("nfce_form_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['nfce_form'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['nfce_form'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-1';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['btn_f9']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['btn_f9']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label']['btn_f9']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label']['btn_f9']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label']['btn_f9'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label']['']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label']['']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label'][''];
        }
?>
<?php
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['btn_f7']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_disabled']['btn_f7']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label']['btn_f7']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label']['btn_f7']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['btn_label']['btn_f7'];
        }
?>
...
<span id="id_read_on_qtde_item" class="sc-ui-readonly-qtde_item css_qtde_item_line" style="<?php echo $sStyleReadLab_qtde_item; ?>"><?php echo $this->form_format_readonly("qtde_item", $this->form_encode_input($this->qtde_item)); ?></span><span id="id_read_off_qtde_item" class="css_read_off_qtde_item<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_qtde_item; ?>">
 ...
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=30"; } ?> maxlength=30 alt="{datatype: 'text', maxLength: 30, allowedChars: '<?php echo $this->allowedCharsCharset("0123456789,*$") ?>', lettersCase: '', enterTab: true, enterSubmit: false, autoTab: true, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_nfce_form*scout' : '';
   if (isset($this->Ini->sc_lig_md5["itens_captura"]) && $this->Ini->sc_lig_md5["itens_captura"] == "S") {
       $Parms_Lig  = "SC_glo_par_vg_empresa_id*scinvg_empresa_id*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutnmgp_parms_ret*scinF1,qtde_item,codigo_barras*scoutnm_evt_ret_busca*scinsc_nfce_form_qtde_item_onchange(this)*scoutnmgp_perm_edit*scinN*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@nfce_form@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "SC_glo_par_vg_empresa_id*scinvg_empresa_id*scoutnmgp_url_saida*scinmodal*scoutnmgp_outra_jan*scintrue*scoutnmgp_parms_ret*scinF1,qtde_item,codigo_barras*scoutnm_evt_ret_busca*scinsc_nfce_form_qtde_item_onchange(this)*scoutnmgp_perm_edit*scinN*scout" . $Sc_iframe_master;
   }
?>

<?php if (!$this->Ini->Export_img_zip) { ?><?php echo nmButtonOutput($this->arr_buttons, "bform_captura", "scModalCapture('" . $this->Ini->link_itens_captura_cons_psq . "?script_case_init=" . $this->Ini->sc_page . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=nfce_form&KeepThis=true&TB_iframe=true&height=600&width=700&modal=true')", "scModalCapture('" . $this->Ini->link_itens_captura_cons_psq . "?script_case_init=" . $this->Ini->sc_page . "&nmgp_parms=" . $Md5_Lig . "&SC_lig_apl_orig=nfce_form&KeepThis=true&TB_iframe=true&height=600&width=700&modal=true')", "cap_qtde_item", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php } ?>
<?php } ?>
   ...
   <?php }?>
    ...
    <TD class="scFormDataOdd" colspan="9" >&nbsp;</TD>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_nfce_detalhe'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_nfce_detalhe'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_nfce_detalhe'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_liga_form_delete'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_liga_qtd_reg'] = '11';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_liga_tp_pag'] = 'total';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_parms'] = "idorcamento*scin" . $this->nmgp_dados_form['idorcamento'] . "*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_form']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'nfce_form_empty.htm' : $this->Ini->link_nfce_detalhe_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=320';
if (isset($this->Ini->sc_lig_target['C_@scinf_nfce_detalhe']) && 'nmsc_iframe_liga_nfce_detalhe' != $this->Ini->sc_lig_target['C_@scinf_nfce_detalhe'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_nfce_detalhe'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_nfce_detalhe"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="320" width="770" name="nmsc_iframe_liga_nfce_detalhe"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<span id="id_read_on_f2" class="css_f2_line" style="<?php echo $sStyleReadLab_f2; ?>"><?php echo $this->form_format_readonly("f2", $this->form_encode_input($f2_look)); ?></span><span id="id_read_off_f2" class="css_read_off_f2 css_f2_line" style="<?php echo $sStyleReadInp_f2; ?>"><?php echo "<div id=\"idAjaxCheckbox_f2\" style=\"display: inline-block\" class=\"css_f2_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['Lookup_f2'][] = 'a'; ?>
...
<span id="id_read_on_f4" class="css_f4_line" style="<?php echo $sStyleReadLab_f4; ?>"><?php echo $this->form_format_readonly("f4", $this->form_encode_input($f4_look)); ?></span><span id="id_read_off_f4" class="css_read_off_f4 css_f4_line" style="<?php echo $sStyleReadInp_f4; ?>"><?php echo "<div id=\"idAjaxCheckbox_f4\" style=\"display: inline-block\" class=\"css_f4_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['Lookup_f4'][] = 'a'; ?>
...
<span id="id_read_on_f7" class="css_f7_line" style="<?php echo $sStyleReadLab_f7; ?>"><?php echo $this->form_format_readonly("f7", $this->form_encode_input($f7_look)); ?></span><span id="id_read_off_f7" class="css_read_off_f7 css_f7_line" style="<?php echo $sStyleReadInp_f7; ?>"><?php echo "<div id=\"idAjaxCheckbox_f7\" style=\"display: inline-block\" class=\"css_f7_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['Lookup_f7'][] = 'a'; ?>
...
<span id="id_read_on_f9" class="css_f9_line" style="<?php echo $sStyleReadLab_f9; ?>"><?php echo $this->form_format_readonly("f9", $this->form_encode_input($f9_look)); ?></span><span id="id_read_off_f9" class="css_read_off_f9 css_f9_line" style="<?php echo $sStyleReadInp_f9; ?>"><?php echo "<div id=\"idAjaxCheckbox_f9\" style=\"display: inline-block\" class=\"css_f9_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['Lookup_f9'][] = 'a'; ?>
...
<span id="id_read_on_chk_f2" class="css_chk_f2_line" style="<?php echo $sStyleReadLab_chk_f2; ?>"><?php echo $this->form_format_readonly("chk_f2", $this->form_encode_input($chk_f2_look)); ?></span><span id="id_read_off_chk_f2" class="css_read_off_chk_f2 css_chk_f2_line" style="<?php echo $sStyleReadInp_chk_f2; ?>"><?php echo "<div id=\"idAjaxCheckbox_chk_f2\" style=\"display: inline-block\" class=\"css_chk_f2_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['Lookup_chk_f2'][] = 'a'; ?>
...
?>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("nfce_form");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("nfce_form");
 parent.scAjaxDetailHeight("nfce_form", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
