...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idorcamento' + iSeqRow).bind('change', function() { sc_nfce_form_idorcamento_onchange(this, iSeqRow) });
  $('#id_sc_field_idcliente' + iSeqRow).bind('change', function() { sc_nfce_form_idcliente_onchange(this, iSeqRow) });
  $('#id_sc_field_data_venda' + iSeqRow).bind('change', function() { sc_nfce_form_data_venda_onchange(this, iSeqRow) });
  $('#id_sc_field_data_venda_hora' + iSeqRow).bind('change', function() { sc_nfce_form_data_venda_hora_onchange(this, iSeqRow) });
  $('#id_sc_field_observacao' + iSeqRow).bind('change', function() { sc_nfce_form_observacao_onchange(this, iSeqRow) });
  $('#id_sc_field_status' + iSeqRow).bind('change', function() { sc_nfce_form_status_onchange(this, iSeqRow) });
  $('#id_sc_field_valor' + iSeqRow).bind('change', function() { sc_nfce_form_valor_onchange(this, iSeqRow) });
  $('#id_sc_field_desconto' + iSeqRow).bind('change', function() { sc_nfce_form_desconto_onchange(this, iSeqRow) });
  $('#id_sc_field_valor_total' + iSeqRow).bind('blur', function() { sc_nfce_form_valor_total_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_nfce_form_valor_total_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_f2' + iSeqRow).bind('blur', function() { sc_nfce_form_f2_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_nfce_form_f2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_f4' + iSeqRow).bind('blur', function() { sc_nfce_form_f4_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_nfce_form_f4_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_f7' + iSeqRow).bind('blur', function() { sc_nfce_form_f7_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_nfce_form_f7_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_f9' + iSeqRow).bind('blur', function() { sc_nfce_form_f9_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_nfce_form_f9_onchange(this, iSeqRow) })
                                .bind('focus', function() { sc_nfce_form_f9_onfocus(this, iSeqRow) });
  $('#id_sc_field_barra' + iSeqRow).bind('change', function() { sc_nfce_form_barra_onchange(this, iSeqRow) });
  $('#id_sc_field_bt_cancelar' + iSeqRow).bind('change', function() { sc_nfce_form_bt_cancelar_onchange(this, iSeqRow) });
  $('#id_sc_field_bt_clientes' + iSeqRow).bind('change', function() { sc_nfce_form_bt_clientes_onchange(this, iSeqRow) });
  $('#id_sc_field_bt_desconto' + iSeqRow).bind('change', function() { sc_nfce_form_bt_desconto_onchange(this, iSeqRow) });
  $('#id_sc_field_bt_finalizar' + iSeqRow).bind('change', function() { sc_nfce_form_bt_finalizar_onchange(this, iSeqRow) });
  $('#id_sc_field_bt_menu' + iSeqRow).bind('change', function() { sc_nfce_form_bt_menu_onchange(this, iSeqRow) });
  $('#id_sc_field_bt_quantidade' + iSeqRow).bind('change', function() { sc_nfce_form_bt_quantidade_onchange(this, iSeqRow) });
  $('#id_sc_field_chk_f2' + iSeqRow).bind('blur', function() { sc_nfce_form_chk_f2_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_nfce_form_chk_f2_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_nfce_form_chk_f2_onfocus(this, iSeqRow) });
  $('#id_sc_field_chk_fecha' + iSeqRow).bind('change', function() { sc_nfce_form_chk_fecha_onchange(this, iSeqRow) });
  $('#id_sc_field_chk_nfce' + iSeqRow).bind('change', function() { sc_nfce_form_chk_nfce_onchange(this, iSeqRow) });
  $('#id_sc_field_chk_orcamento' + iSeqRow).bind('change', function() { sc_nfce_form_chk_orcamento_onchange(this, iSeqRow) });
  $('#id_sc_field_chk_tecla' + iSeqRow).bind('change', function() { sc_nfce_form_chk_tecla_onchange(this, iSeqRow) });
  $('#id_sc_field_cod_barra' + iSeqRow).bind('blur', function() { sc_nfce_form_cod_barra_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_nfce_form_cod_barra_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_nfce_form_cod_barra_onfocus(this, iSeqRow) });
  $('#id_sc_field_fechamento' + iSeqRow).bind('change', function() { sc_nfce_form_fechamento_onchange(this, iSeqRow) });
  $('#id_sc_field_imagem' + iSeqRow).bind('blur', function() { sc_nfce_form_imagem_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_nfce_form_imagem_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_nfce_form_imagem_onfocus(this, iSeqRow) });
  $('#id_sc_field_inclui' + iSeqRow).bind('change', function() { sc_nfce_form_inclui_onchange(this, iSeqRow) });
  $('#id_sc_field_sc_field_0' + iSeqRow).bind('blur', function() { sc_nfce_form_sc_field_0_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_nfce_form_sc_field_0_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_nfce_form_sc_field_0_onfocus(this, iSeqRow) });
  $('#id_sc_field_lbl_nfce' + iSeqRow).bind('change', function() { sc_nfce_form_lbl_nfce_onchange(this, iSeqRow) });
  $('#id_sc_field_lbl_orcamento' + iSeqRow).bind('change', function() { sc_nfce_form_lbl_orcamento_onchange(this, iSeqRow) });
  $('#id_sc_field_num_itens' + iSeqRow).bind('change', function() { sc_nfce_form_num_itens_onchange(this, iSeqRow) });
  $('#id_sc_field_pra_pular' + iSeqRow).bind('blur', function() { sc_nfce_form_pra_pular_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_nfce_form_pra_pular_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_nfce_form_pra_pular_onfocus(this, iSeqRow) });
  $('#id_sc_field_pra_pular1' + iSeqRow).bind('change', function() { sc_nfce_form_pra_pular1_onchange(this, iSeqRow) });
  $('#id_sc_field_qtde_item' + iSeqRow).bind('blur', function() { sc_nfce_form_qtde_item_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_nfce_form_qtde_item_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_quantidade' + iSeqRow).bind('blur', function() { sc_nfce_form_quantidade_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_nfce_form_quantidade_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_nfce_form_quantidade_onfocus(this, iSeqRow) });
  $('#id_sc_field_receb_total' + iSeqRow).bind('change', function() { sc_nfce_form_receb_total_onchange(this, iSeqRow) });
  $('#id_sc_field_rotina' + iSeqRow).bind('change', function() { sc_nfce_form_rotina_onchange(this, iSeqRow) });
  $('#id_sc_field_tecla' + iSeqRow).bind('blur', function() { sc_nfce_form_tecla_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_nfce_form_tecla_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nfce_detalhe' + iSeqRow).bind('blur', function() { sc_nfce_form_nfce_detalhe_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_nfce_form_nfce_detalhe_onchange(this, iSeqRow) })
...
function sc_nfce_form_idorcamento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_idcliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_data_venda_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_data_venda_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_observacao_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_status_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_valor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_desconto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_valor_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_f2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_f4_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_f7_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_f9_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_barra_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_bt_cancelar_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_bt_clientes_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_bt_desconto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_bt_finalizar_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_bt_menu_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_bt_quantidade_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_chk_f2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_chk_fecha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_chk_nfce_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_chk_orcamento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_chk_tecla_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_cod_barra_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_fechamento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_imagem_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_inclui_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_sc_field_0_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_lbl_nfce_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_lbl_orcamento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_num_itens_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_pra_pular_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_pra_pular1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_qtde_item_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_quantidade_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_receb_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_nfce_form_rotina_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_tecla_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_form_nfce_detalhe_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_field_nfce_detalhe(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_nfce_detalhe")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_nfce_detalhe")[0].contentWindow.scRecreateSelect2();
	}
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'nfce_form')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
