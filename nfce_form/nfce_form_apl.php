...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['nfce_form']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['nfce_form']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['nfce_form']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['nfce_form']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['nfce_form']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['nfce_form']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['nfce_form']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['nfce_form']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['nfce_form']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->vg_tipo_ambiente)) 
          {
              $_SESSION['vg_tipo_ambiente'] = $this->vg_tipo_ambiente;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['nfce_form']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['nfce_form']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['nfce_form']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['nfce_form']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['nfce_form']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['nfce_form']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['nfce_form']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['nfce_form']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['nfce_form']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new nfce_form_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$script_case_init]['nfce_form']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['nfce_form']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['nfce_form'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['nfce_form']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['nfce_form']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('nfce_form') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['nfce_form']['label'] = "Emissão de Documento Fiscal de Venda";
      ...
      $_SESSION['scriptcase']['error_icon']['nfce_form']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['nfce_form'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['nfce_form']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['nfce_form'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['nfce_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'nfce_form_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'nfce_form_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'nfce_form/nfce_form_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "nfce_form_erro.class.php"); 
      }
      $this->Erro      = new nfce_form_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao']))
         { 
             if ($this->idorcamento != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['nfce_form']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['btn_F9'] = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['botoes']['btn_F9'];
          $this->nmgp_botoes['btn_F7'] = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['botoes']['btn_F7'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('nfce_detalhe') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('nfce_detalhe') . "/nfce_detalhe_apl.php");
          $this->nfce_detalhe = new nfce_detalhe_apl;
      }
      $this->NM_case_insensitive = false;
      $this->sc_evento = $this->nmgp_opcao;
      if (!isset($this->NM_ajax_flag) || ('validate_' != substr($this->NM_ajax_opcao, 0, 9) && 'add_new_line' != $this->NM_ajax_opcao && 'autocomp_' != substr($this->NM_ajax_opcao, 0, 9)))
      {
      $_SESSION['scriptcase']['nfce_form']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['nfce_form']['contr_erro'] = 'off'; 
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_select']['qtde_item']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->qtde_item = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_select']['qtde_item'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_select']['sc_field_0']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->sc_field_0 = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_select']['sc_field_0'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_select']['pra_pular']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->pra_pular = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_select']['pra_pular'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "nfce_form.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="nfce_form_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="nfce_form"> 
...
<?php
include_once("nfce_form_sajax_js.php");
?>
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opc_ant'] == "novo" || $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opc_ant'] == "incluir")
      {
      ...
      {
          if (!isset($this->total_mercadorias) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_form']['total_mercadorias']))
          {
              $varloc_btn_php['total_mercadorias'] = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_form']['total_mercadorias'];
          }
          if (!isset($this->total_mercadorias) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_form']['total_mercadorias']))
          {
              $varloc_btn_php['total_mercadorias'] = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_form']['total_mercadorias'];
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_nfce_form']) || !is_array($this->NM_ajax_info['errList']['geral_nfce_form']))
              {
                  $this->NM_ajax_info['errList']['geral_nfce_form'] = array();
              }
              $this->NM_ajax_info['errList']['geral_nfce_form'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_tecla(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->tecla, 20, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "tecla; " ; 
                  if (!isset($Campos_Erros['tecla']))
    ...
    function ValidateField_quantidade(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->quantidade, 3, 3, 0, 0, "N") == false)  
              { 
                  $hasError = true;
...
;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idorcamento']['keyVal'] = nfce_form_pack_protect_string($this->nmgp_dados_form['idorcamento']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['foreign_key']['idorcamento'] = $this->nmgp_dados_form['idorcamento'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['where_filter'] = "idorcamento = " . $this->nmgp_dados_form['idorcamento'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['where_detal']  = "idorcamento = " . $this->nmgp_dados_form['idorcamento'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nfce_detalhe_script_case_init'] ]['nfce_detalhe']['total']);
          }
...
$aLookup[] = array(nfce_form_pack_protect_string('a') => str_replace('<', '&lt;',nfce_form_pack_protect_string("a")));
$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['Lookup_f2'][] = 'a';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['f2']['valList'][$i] = nfce_form_pack_protect_string($v);
          }
...
$aLookup[] = array(nfce_form_pack_protect_string('a') => str_replace('<', '&lt;',nfce_form_pack_protect_string("a")));
$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['Lookup_f4'][] = 'a';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['f4']['valList'][$i] = nfce_form_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(nfce_form_pack_protect_string('a') => str_replace('<', '&lt;',nfce_form_pack_protect_string("a")));
$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['Lookup_f7'][] = 'a';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['f7']['valList'][$i] = nfce_form_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(nfce_form_pack_protect_string('a') => str_replace('<', '&lt;',nfce_form_pack_protect_string("a")));
$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['Lookup_f9'][] = 'a';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['f9']['valList'][$i] = nfce_form_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(nfce_form_pack_protect_string('a') => str_replace('<', '&lt;',nfce_form_pack_protect_string("a")));
$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['Lookup_chk_f2'][] = 'a';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['chk_f2']['valList'][$i] = nfce_form_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_pra_pular($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idorcamento)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao'] = '';
   ...
   { 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->nfce_detalhe->ini_controle();
              if ($this->nfce_detalhe->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['parms'] = "idorcamento?#?$this->idorcamento?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['parms'] = ""; 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['select'] = ""; 
              } 
          } 
          ...
          { 
              ...
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_detalhe']['embutida_parms'] = "idorcamento*scin" . $this->nmgp_dados_form['idorcamento'] . "*scoutNM_btn_insert*scinN*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
  }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("nfce_form_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['csrf_token'];
    }
...
function sc_file_size($file, $format = false)
{
 ...
 function new_date_format($type, $field)
 {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_nfce_form = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['total'] = $qt_geral_reg_nfce_form;
      $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          nfce_form_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "nfce_form_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['nm_run_menu'] = 2;
       $nmgp_saida_form = "nfce_form_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_form']['ordem_ord'] == " desc") {
