...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_pet_pelagem"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_pet_pelagem"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_pet_pelagem'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pet_pelagem']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_pet_pelagem']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pet_pelagem']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_pet_pelagem']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_pet_pelagem']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_pet_pelagem']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_pet_pelagem']['embutida_filho'] as $ind => $sc_init)
          {
