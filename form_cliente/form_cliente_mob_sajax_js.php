...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_cliente_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_cliente_mob_submit_form(var_idcliente, var_cpf_cnpj, var_nome_fantasia, var_razao_social, var_data_nascimento, var_email, var_indicacao, var_cep, var_logradouro, var_numero, var_bairro, var_cidade_idcidade, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cliente_mob_submit_form_cb);
