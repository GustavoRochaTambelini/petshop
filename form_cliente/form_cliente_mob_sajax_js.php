...
?>
  ...
  // ---------- Validate cpf_cnpj
  function do_ajax_form_cliente_mob_validate_cpf_cnpj()
  {
    var nomeCampo_cpf_cnpj = "cpf_cnpj";
    var var_cpf_cnpj = scAjaxGetFieldText(nomeCampo_cpf_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_cpf_cnpj(var_cpf_cnpj, var_script_case_init, do_ajax_form_cliente_mob_validate_cpf_cnpj_cb);
  } // do_ajax_form_cliente_mob_validate_cpf_cnpj

  function do_ajax_form_cliente_mob_validate_cpf_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_cpf_cnpj_cb

  // ---------- Validate nome_fantasia
  function do_ajax_form_cliente_mob_validate_nome_fantasia()
  {
    var nomeCampo_nome_fantasia = "nome_fantasia";
    var var_nome_fantasia = scAjaxGetFieldText(nomeCampo_nome_fantasia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_nome_fantasia(var_nome_fantasia, var_script_case_init, do_ajax_form_cliente_mob_validate_nome_fantasia_cb);
  } // do_ajax_form_cliente_mob_validate_nome_fantasia

  function do_ajax_form_cliente_mob_validate_nome_fantasia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_nome_fantasia_cb

  // ---------- Validate razao_social
  function do_ajax_form_cliente_mob_validate_razao_social()
  {
    var nomeCampo_razao_social = "razao_social";
    var var_razao_social = scAjaxGetFieldText(nomeCampo_razao_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_razao_social(var_razao_social, var_script_case_init, do_ajax_form_cliente_mob_validate_razao_social_cb);
  } // do_ajax_form_cliente_mob_validate_razao_social

  function do_ajax_form_cliente_mob_validate_razao_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_razao_social_cb

  // ---------- Validate data_nascimento
  function do_ajax_form_cliente_mob_validate_data_nascimento()
  {
    var nomeCampo_data_nascimento = "data_nascimento";
    var var_data_nascimento = scAjaxGetFieldText(nomeCampo_data_nascimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_data_nascimento(var_data_nascimento, var_script_case_init, do_ajax_form_cliente_mob_validate_data_nascimento_cb);
  } // do_ajax_form_cliente_mob_validate_data_nascimento

  function do_ajax_form_cliente_mob_validate_data_nascimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_data_nascimento_cb

  // ---------- Validate email
  function do_ajax_form_cliente_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_email(var_email, var_script_case_init, do_ajax_form_cliente_mob_validate_email_cb);
  } // do_ajax_form_cliente_mob_validate_email

  function do_ajax_form_cliente_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_email_cb

  // ---------- Validate indicacao
  function do_ajax_form_cliente_mob_validate_indicacao()
  {
    var nomeCampo_indicacao = "indicacao";
    var var_indicacao = scAjaxGetFieldText(nomeCampo_indicacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_indicacao(var_indicacao, var_script_case_init, do_ajax_form_cliente_mob_validate_indicacao_cb);
  } // do_ajax_form_cliente_mob_validate_indicacao

  function do_ajax_form_cliente_mob_validate_indicacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_indicacao_cb

  // ---------- Validate cep
  function do_ajax_form_cliente_mob_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_cep(var_cep, var_script_case_init, do_ajax_form_cliente_mob_validate_cep_cb);
  } // do_ajax_form_cliente_mob_validate_cep

  function do_ajax_form_cliente_mob_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_cep_cb

  // ---------- Validate logradouro
  function do_ajax_form_cliente_mob_validate_logradouro()
  {
    var nomeCampo_logradouro = "logradouro";
    var var_logradouro = scAjaxGetFieldText(nomeCampo_logradouro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_logradouro(var_logradouro, var_script_case_init, do_ajax_form_cliente_mob_validate_logradouro_cb);
  } // do_ajax_form_cliente_mob_validate_logradouro

  function do_ajax_form_cliente_mob_validate_logradouro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_logradouro_cb

  // ---------- Validate numero
  function do_ajax_form_cliente_mob_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_numero(var_numero, var_script_case_init, do_ajax_form_cliente_mob_validate_numero_cb);
  } // do_ajax_form_cliente_mob_validate_numero

  function do_ajax_form_cliente_mob_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_numero_cb

  // ---------- Validate bairro
  function do_ajax_form_cliente_mob_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_bairro(var_bairro, var_script_case_init, do_ajax_form_cliente_mob_validate_bairro_cb);
  } // do_ajax_form_cliente_mob_validate_bairro

  function do_ajax_form_cliente_mob_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bairro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_bairro_cb

  // ---------- Validate cidade_idcidade
  function do_ajax_form_cliente_mob_validate_cidade_idcidade()
  {
    var nomeCampo_cidade_idcidade = "cidade_idcidade";
    var var_cidade_idcidade = scAjaxGetFieldSelect(nomeCampo_cidade_idcidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_cidade_idcidade(var_cidade_idcidade, var_script_case_init, do_ajax_form_cliente_mob_validate_cidade_idcidade_cb);
  } // do_ajax_form_cliente_mob_validate_cidade_idcidade

  function do_ajax_form_cliente_mob_validate_cidade_idcidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_cidade_idcidade_cb

  // ---------- Validate uf
  function do_ajax_form_cliente_mob_validate_uf()
  {
    var nomeCampo_uf = "uf";
    var var_uf = scAjaxGetFieldSelect(nomeCampo_uf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_uf(var_uf, var_script_case_init, do_ajax_form_cliente_mob_validate_uf_cb);
  } // do_ajax_form_cliente_mob_validate_uf

  function do_ajax_form_cliente_mob_validate_uf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uf";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_uf_cb

  // ---------- Validate cliente_telefone
  function do_ajax_form_cliente_mob_validate_cliente_telefone()
  {
    var nomeCampo_cliente_telefone = "cliente_telefone";
    var var_cliente_telefone = scAjaxGetFieldText(nomeCampo_cliente_telefone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_cliente_telefone(var_cliente_telefone, var_script_case_init, do_ajax_form_cliente_mob_validate_cliente_telefone_cb);
  } // do_ajax_form_cliente_mob_validate_cliente_telefone

  function do_ajax_form_cliente_mob_validate_cliente_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente_telefone";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_cliente_telefone_cb

  // ---------- Validate cliente_dependente
  function do_ajax_form_cliente_mob_validate_cliente_dependente()
  {
    var nomeCampo_cliente_dependente = "cliente_dependente";
    var var_cliente_dependente = scAjaxGetFieldText(nomeCampo_cliente_dependente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_cliente_dependente(var_cliente_dependente, var_script_case_init, do_ajax_form_cliente_mob_validate_cliente_dependente_cb);
  } // do_ajax_form_cliente_mob_validate_cliente_dependente

  function do_ajax_form_cliente_mob_validate_cliente_dependente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente_dependente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_cliente_dependente_cb

  // ---------- Validate cliente_pet
  function do_ajax_form_cliente_mob_validate_cliente_pet()
  {
    var nomeCampo_cliente_pet = "cliente_pet";
    var var_cliente_pet = scAjaxGetFieldText(nomeCampo_cliente_pet);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_mob_validate_cliente_pet(var_cliente_pet, var_script_case_init, do_ajax_form_cliente_mob_validate_cliente_pet_cb);
  } // do_ajax_form_cliente_mob_validate_cliente_pet

  function do_ajax_form_cliente_mob_validate_cliente_pet_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cliente_pet";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_mob_validate_cliente_pet_cb

  // ---------- Event onchange cep
  function do_ajax_form_cliente_mob_event_cep_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_cliente_mob_event_cep_onchange(var_cep, var_logradouro, var_bairro, var_cidade_idcidade, var_uf, var_script_case_init, do_ajax_form_cliente_mob_event_cep_onchange_cb);
  } // do_ajax_form_cliente_mob_event_cep_onchange

  function do_ajax_form_cliente_mob_event_cep_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "cep";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cliente_mob_event_cep_onchange_cb_after_alert);
  } // do_ajax_form_cliente_mob_event_cep_onchange_cb
  function do_ajax_form_cliente_mob_event_cep_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cliente_mob_event_cep_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_btn_voltar
  function do_ajax_form_cliente_mob_event_scajaxbutton_btn_voltar_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cliente_mob_event_scajaxbutton_btn_voltar_onclick(var_script_case_init, do_ajax_form_cliente_mob_event_scajaxbutton_btn_voltar_onclick_cb);
  } // do_ajax_form_cliente_mob_event_scajaxbutton_btn_voltar_onclick

  function do_ajax_form_cliente_mob_event_scajaxbutton_btn_voltar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "scajaxbutton_btn_voltar";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cliente_mob_event_scajaxbutton_btn_voltar_onclick_cb_after_alert);
  } // do_ajax_form_cliente_mob_event_scajaxbutton_btn_voltar_onclick_cb
  function do_ajax_form_cliente_mob_event_scajaxbutton_btn_voltar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_cliente_mob_event_scajaxbutton_btn_voltar_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_cliente_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_cliente_mob_submit_form(var_idcliente, var_cpf_cnpj, var_nome_fantasia, var_razao_social, var_data_nascimento, var_email, var_indicacao, var_cep, var_logradouro, var_numero, var_bairro, var_cidade_idcidade, var_uf, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cliente_mob_submit_form_cb);
...
?>
  ...
  var scStatusDetail = {};
  scStatusDetail["form_telefone_mob"] = "off";
  scStatusDetail["form_outros_respensaveis_mob"] = "off";
  scStatusDetail["form_pet_cliente_mob"] = "off";
  ...
  function perform_ajax_form_cliente_mob_navigate_form()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_telefone_mob"] = "on";
    scStatusDetail["form_outros_respensaveis_mob"] = "on";
    scStatusDetail["form_pet_cliente_mob"] = "on";
...
?>
  function do_ajax_form_cliente_mob_navigate_form_cb(sResp)
  {
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_telefone_mob"] && "nmsc_iframe_liga_form_telefone_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_telefone_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_telefone_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_telefone_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_telefone_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_telefone_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_outros_respensaveis_mob"] && "nmsc_iframe_liga_form_outros_respensaveis_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_outros_respensaveis_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_outros_respensaveis_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_outros_respensaveis_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_outros_respensaveis_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_outros_respensaveis_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_pet_cliente_mob"] && "nmsc_iframe_liga_form_pet_cliente_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_pet_cliente_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_pet_cliente_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_pet_cliente_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_pet_cliente_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_pet_cliente_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
...
?>
  ...
  {
    if ("off" == scStatusDetail["form_telefone_mob"] && "off" == scStatusDetail["form_outros_respensaveis_mob"] && "off" == scStatusDetail["form_pet_cliente_mob"])
    {
      return true;
    }
    return false;
  ...
  var ajax_error_list = {
    ...
    "indicacao": {"label": "INDICAÇÃO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
