...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'uf':
        sc_exib_ocult_pag('form_cliente_mob_form0');
        break;
      case 'cliente_telefone':
        sc_exib_ocult_pag('form_cliente_mob_form1');
        break;
      case 'cliente_dependente':
        sc_exib_ocult_pag('form_cliente_mob_form2');
        break;
      case 'cliente_pet':
        sc_exib_ocult_pag('form_cliente_mob_form3');
        break;
    }
  }
...
function displayChange_field_cliente_telefone(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_telefone_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_telefone_mob")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_cliente_dependente(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_outros_respensaveis_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_outros_respensaveis_mob")[0].contentWindow.scRecreateSelect2();
	}
}

function displayChange_field_cliente_pet(row, status) {
    var fieldId;
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_pet_cliente_mob")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_pet_cliente_mob")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_data_nascimento" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_cliente_mob_validate_data_nascimento(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
