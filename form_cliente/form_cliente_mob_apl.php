...
//----- 
   function ini_controle()
   {
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_cliente_mob']['form_telefone_mob_script_case_init'] ]['form_telefone_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_cliente_mob']['form_telefone_mob_script_case_init'] ]['form_telefone_mob']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_cliente_mob']['form_outros_respensaveis_mob_script_case_init'] ]['form_outros_respensaveis_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_cliente_mob']['form_outros_respensaveis_mob_script_case_init'] ]['form_outros_respensaveis_mob']['total']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob']['total']);
          }
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cliente_mob']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_cliente_mob']['label'] = "ATUALIZAÇÃO DE CLIENTE";
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_cliente/form_cliente_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_cliente_mob_calendar.php');
          }
          exit;
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['btn_voltar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['botoes']['btn_voltar'];
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_telefone_mob_script_case_init'] ]['form_telefone_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_telefone_mob_script_case_init'] ]['form_telefone_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_telefone_mob_script_case_init'] ]['form_telefone_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_telefone_mob_script_case_init'] ]['form_telefone_mob']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_telefone_mob') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_telefone_mob') . "/form_telefone_mob_apl.php");
          $this->form_telefone_mob = new form_telefone_mob_apl;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_outros_respensaveis_mob_script_case_init'] ]['form_outros_respensaveis_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_outros_respensaveis_mob_script_case_init'] ]['form_outros_respensaveis_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_outros_respensaveis_mob_script_case_init'] ]['form_outros_respensaveis_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_outros_respensaveis_mob_script_case_init'] ]['form_outros_respensaveis_mob']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_outros_respensaveis_mob') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_outros_respensaveis_mob') . "/form_outros_respensaveis_mob_apl.php");
          $this->form_outros_respensaveis_mob = new form_outros_respensaveis_mob_apl;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_pet_cliente_mob') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_pet_cliente_mob') . "/form_pet_cliente_mob_apl.php");
          $this->form_pet_cliente_mob = new form_pet_cliente_mob_apl;
      }
...
//---
    ...
    function ValidateField_cpf_cnpj(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['cpf_cnpj']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['cpf_cnpj'] == "on") 
          { 
              $hasError = true;
    ...
    function ValidateField_nome_fantasia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['nome_fantasia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['nome_fantasia'] == "on")) 
      { 
    ...
    function ValidateField_logradouro(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['logradouro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['logradouro'] == "on")) 
      { 
          if ($this->logradouro == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_numero(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['numero']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['numero'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "NUMERO" ; 
              if (!isset($Campos_Erros['numero']))
    ...
    function ValidateField_bairro(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['bairro']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['bairro'] == "on")) 
      { 
          if ($this->bairro == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_cidade_idcidade(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->cidade_idcidade == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['cidade_idcidade']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['php_cmp_required']['cidade_idcidade'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "CIDADE" ; 
          ...
          if (!empty($this->cidade_idcidade) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['Lookup_cidade_idcidade']) && !in_array($this->cidade_idcidade, $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['Lookup_cidade_idcidade']))
          {
              $hasError = true;
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_outros_respensaveis_mob_script_case_init'] ]['form_outros_respensaveis_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_outros_respensaveis_mob_script_case_init'] ]['form_outros_respensaveis_mob']['total']);
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob']['foreign_key']['idcliente'] = $this->nmgp_dados_form['idcliente'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob']['where_filter'] = "idcliente = " . $this->nmgp_dados_form['idcliente'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob']['where_detal']  = "idcliente = " . $this->nmgp_dados_form['idcliente'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_pet_cliente_mob_script_case_init'] ]['form_pet_cliente_mob']['total']);
              }
              ...
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_telefone_mob_script_case_init'] ]['form_telefone_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['form_telefone_mob_script_case_init'] ]['form_telefone_mob']['total']);
              }
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['Lookup_cidade_idcidade']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['Lookup_cidade_idcidade'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['Lookup_cidade_idcidade']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['Lookup_cidade_idcidade'] = array(); 
}
$aLookup[] = array(form_cliente_mob_pack_protect_string('') => str_replace('<', '&lt;',form_cliente_mob_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['Lookup_cidade_idcidade'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['cidade_idcidade']['valList'][$i] = form_cliente_mob_pack_protect_string($v);
          }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idcliente)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['opcao'] = '';
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->idcliente)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "cidade_idcidade = $this->cidade_idcidade, cpf_cnpj = '$this->cpf_cnpj', nome_fantasia = '$this->nome_fantasia', razao_social = '$this->razao_social', data_nascimento = EXTEND('$this->data_nascimento', YEAR TO DAY), logradouro = '$this->logradouro', numero = $this->numero, bairro = '$this->bairro', email = '$this->email', indicacao = '$this->indicacao', cep = '$this->cep'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_outros_respensaveis_mob->ini_controle();
              if ($this->form_outros_respensaveis_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_pet_cliente_mob->ini_controle();
              if ($this->form_pet_cliente_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
                  $sMsgErro   = $this->Ini->Nm_lang['lang_errm_fkvi'];
              }
          ...
          {
              $sDetailWhere = "idcliente = " . $this->idcliente . "";
              $this->form_telefone_mob->ini_controle();
              if ($this->form_telefone_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
                  $sMsgErro   = $this->Ini->Nm_lang['lang_errm_fkvi'];
              }
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_telefone_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_outros_respensaveis_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_pet_cliente_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinN*scoutNM_btn_navega*scinN*scout";
  }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_telefone_mob']['reg_start'] = "";
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_telefone_mob']['total']);
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_outros_respensaveis_mob']['reg_start'] = "";
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_outros_respensaveis_mob']['total']);
   $_SESSION['sc_session'][$this->Ini->sc_page]['form_pet_cliente_mob']['reg_start'] = "";
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pet_cliente_mob']['total']);
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['link_info']['compact_mode']) {
            return;
        }
?>
