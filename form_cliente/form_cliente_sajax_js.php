...
?>
  ...
  // ---------- Validate cpf_cnpj
  function do_ajax_form_cliente_validate_cpf_cnpj()
  {
    var nomeCampo_cpf_cnpj = "cpf_cnpj";
    var var_cpf_cnpj = scAjaxGetFieldText(nomeCampo_cpf_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_cpf_cnpj(var_cpf_cnpj, var_script_case_init, do_ajax_form_cliente_validate_cpf_cnpj_cb);
  } // do_ajax_form_cliente_validate_cpf_cnpj

  function do_ajax_form_cliente_validate_cpf_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_cpf_cnpj_cb

  // ---------- Validate nome_fantasia
  function do_ajax_form_cliente_validate_nome_fantasia()
  {
    var nomeCampo_nome_fantasia = "nome_fantasia";
    var var_nome_fantasia = scAjaxGetFieldText(nomeCampo_nome_fantasia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_nome_fantasia(var_nome_fantasia, var_script_case_init, do_ajax_form_cliente_validate_nome_fantasia_cb);
  } // do_ajax_form_cliente_validate_nome_fantasia

  function do_ajax_form_cliente_validate_nome_fantasia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_nome_fantasia_cb

  // ---------- Validate razao_social
  function do_ajax_form_cliente_validate_razao_social()
  {
    var nomeCampo_razao_social = "razao_social";
    var var_razao_social = scAjaxGetFieldText(nomeCampo_razao_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_razao_social(var_razao_social, var_script_case_init, do_ajax_form_cliente_validate_razao_social_cb);
  } // do_ajax_form_cliente_validate_razao_social

  function do_ajax_form_cliente_validate_razao_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_razao_social_cb

  // ---------- Validate data_nascimento
  function do_ajax_form_cliente_validate_data_nascimento()
  {
    var nomeCampo_data_nascimento = "data_nascimento";
    var var_data_nascimento = scAjaxGetFieldText(nomeCampo_data_nascimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_data_nascimento(var_data_nascimento, var_script_case_init, do_ajax_form_cliente_validate_data_nascimento_cb);
  } // do_ajax_form_cliente_validate_data_nascimento

  function do_ajax_form_cliente_validate_data_nascimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_data_nascimento_cb

  // ---------- Validate email
  function do_ajax_form_cliente_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_email(var_email, var_script_case_init, do_ajax_form_cliente_validate_email_cb);
  } // do_ajax_form_cliente_validate_email

  function do_ajax_form_cliente_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_email_cb

  // ---------- Validate indicacao
  function do_ajax_form_cliente_validate_indicacao()
  {
    var nomeCampo_indicacao = "indicacao";
    var var_indicacao = scAjaxGetFieldText(nomeCampo_indicacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_indicacao(var_indicacao, var_script_case_init, do_ajax_form_cliente_validate_indicacao_cb);
  } // do_ajax_form_cliente_validate_indicacao

  function do_ajax_form_cliente_validate_indicacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_indicacao_cb

  // ---------- Validate cep
  function do_ajax_form_cliente_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_cep(var_cep, var_script_case_init, do_ajax_form_cliente_validate_cep_cb);
  } // do_ajax_form_cliente_validate_cep

  function do_ajax_form_cliente_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_cep_cb

  // ---------- Validate logradouro
  function do_ajax_form_cliente_validate_logradouro()
  {
    var nomeCampo_logradouro = "logradouro";
    var var_logradouro = scAjaxGetFieldText(nomeCampo_logradouro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_logradouro(var_logradouro, var_script_case_init, do_ajax_form_cliente_validate_logradouro_cb);
  } // do_ajax_form_cliente_validate_logradouro

  function do_ajax_form_cliente_validate_logradouro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_logradouro_cb

  // ---------- Validate numero
  function do_ajax_form_cliente_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_numero(var_numero, var_script_case_init, do_ajax_form_cliente_validate_numero_cb);
  } // do_ajax_form_cliente_validate_numero

  function do_ajax_form_cliente_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_numero_cb

  // ---------- Validate bairro
  function do_ajax_form_cliente_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_bairro(var_bairro, var_script_case_init, do_ajax_form_cliente_validate_bairro_cb);
  } // do_ajax_form_cliente_validate_bairro

  function do_ajax_form_cliente_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bairro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_bairro_cb

  // ---------- Validate cidade_idcidade
  function do_ajax_form_cliente_validate_cidade_idcidade()
  {
    var nomeCampo_cidade_idcidade = "cidade_idcidade";
    var var_cidade_idcidade = scAjaxGetFieldSelect(nomeCampo_cidade_idcidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_cidade_idcidade(var_cidade_idcidade, var_script_case_init, do_ajax_form_cliente_validate_cidade_idcidade_cb);
  } // do_ajax_form_cliente_validate_cidade_idcidade

  function do_ajax_form_cliente_validate_cidade_idcidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_form_cliente_validate_cliente_telefone()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_cliente_telefone(var_cliente_telefone, var_script_case_init, do_ajax_form_cliente_validate_cliente_telefone_cb);
  } // do_ajax_form_cliente_validate_cliente_telefone

  function do_ajax_form_cliente_validate_cliente_telefone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_cliente_telefone_cb

  // ---------- Validate cliente_dependente
  function do_ajax_form_cliente_validate_cliente_dependente()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_cliente_dependente(var_cliente_dependente, var_script_case_init, do_ajax_form_cliente_validate_cliente_dependente_cb);
  } // do_ajax_form_cliente_validate_cliente_dependente

  function do_ajax_form_cliente_validate_cliente_dependente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_validate_cliente_dependente_cb

  // ---------- Validate cliente_pet
  function do_ajax_form_cliente_validate_cliente_pet()
  {
    var nomeCampo_cliente_pet = "cliente_pet";
    var var_cliente_pet = scAjaxGetFieldText(nomeCampo_cliente_pet);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_validate_cliente_pet(var_cliente_pet, var_script_case_init, do_ajax_form_cliente_validate_cliente_pet_cb);
  } // do_ajax_form_cliente_validate_cliente_pet

  function do_ajax_form_cliente_validate_cliente_pet_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
  ...
  function do_ajax_form_cliente_event_scajaxbutton_btn_voltar_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_cliente_event_scajaxbutton_btn_voltar_onclick(var_script_case_init, do_ajax_form_cliente_event_scajaxbutton_btn_voltar_onclick_cb);
  } // do_ajax_form_cliente_event_scajaxbutton_btn_voltar_onclick

  function do_ajax_form_cliente_event_scajaxbutton_btn_voltar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_cliente_event_scajaxbutton_btn_voltar_onclick_cb_after_alert);
  } // do_ajax_form_cliente_event_scajaxbutton_btn_voltar_onclick_cb
  function do_ajax_form_cliente_event_scajaxbutton_btn_voltar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
...
?>
  ...
  var scStatusDetail = {};
  scStatusDetail["form_telefone"] = "off";
  scStatusDetail["form_outros_respensaveis"] = "off";
  scStatusDetail["form_pet_cliente"] = "off";
  ...
  function perform_ajax_form_cliente_navigate_form()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_telefone"] = "on";
    scStatusDetail["form_outros_respensaveis"] = "on";
    scStatusDetail["form_pet_cliente"] = "on";
    x_ajax_form_cliente_navigate_form(var_idcliente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cliente_navigate_form_cb);
...
?>
  function do_ajax_form_cliente_navigate_form_cb(sResp)
  {
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_telefone"] && "nmsc_iframe_liga_form_telefone" != scMasterDetailIframe["nmsc_iframe_liga_form_telefone"]) {
        ...
        document.getElementById('nmsc_iframe_liga_form_telefone').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_telefone').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_telefone').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_outros_respensaveis"] && "nmsc_iframe_liga_form_outros_respensaveis" != scMasterDetailIframe["nmsc_iframe_liga_form_outros_respensaveis"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_outros_respensaveis"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_outros_respensaveis').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_outros_respensaveis').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_outros_respensaveis').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_pet_cliente"] && "nmsc_iframe_liga_form_pet_cliente" != scMasterDetailIframe["nmsc_iframe_liga_form_pet_cliente"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_pet_cliente"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_pet_cliente').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_pet_cliente').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_pet_cliente').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
...
?>
  ...
  {
    if ("off" == scStatusDetail["form_telefone"] && "off" == scStatusDetail["form_outros_respensaveis"] && "off" == scStatusDetail["form_pet_cliente"])
    {
      return true;
    }
    return false;
