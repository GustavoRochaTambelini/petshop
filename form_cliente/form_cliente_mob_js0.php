...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
function sc_btn_btn_voltar()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_btn_voltar(); }, 500);
      return;
    }
    sc_btn_btn_voltar_ok();
}
function sc_btn_btn_voltar_cancel()
{
}
function sc_btn_btn_voltar_ok()
{
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_cliente_mob_form0').style.width='1px';
    document.getElementById('form_cliente_mob_form0').style.height='0px';
    document.getElementById('form_cliente_mob_form0').style.display='none';
    document.getElementById('form_cliente_mob_form0').style.overflow='scroll';
    document.getElementById('form_cliente_mob_form1').style.width='1px';
    document.getElementById('form_cliente_mob_form1').style.height='0px';
    document.getElementById('form_cliente_mob_form1').style.display='none';
    document.getElementById('form_cliente_mob_form1').style.overflow='scroll';
    document.getElementById('form_cliente_mob_form2').style.width='1px';
    document.getElementById('form_cliente_mob_form2').style.height='0px';
    document.getElementById('form_cliente_mob_form2').style.display='none';
    document.getElementById('form_cliente_mob_form2').style.overflow='scroll';
    document.getElementById('form_cliente_mob_form3').style.width='1px';
    document.getElementById('form_cliente_mob_form3').style.height='0px';
    document.getElementById('form_cliente_mob_form3').style.display='none';
    document.getElementById('form_cliente_mob_form3').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_mob']['pdf_view']) {
?>
...
?>
   ...
   if ("form_cliente_mob_form3" == N_pagina) {
