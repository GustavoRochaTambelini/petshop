...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
{
    document.getElementById('form_cliente_form0').style.width='1px';
    document.getElementById('form_cliente_form0').style.height='0px';
    document.getElementById('form_cliente_form0').style.display='none';
    document.getElementById('form_cliente_form0').style.overflow='scroll';
    document.getElementById('form_cliente_form1').style.width='1px';
