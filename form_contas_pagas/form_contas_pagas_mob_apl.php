...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idcontas_pagar)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagas_mob']['opcao'] = '';
