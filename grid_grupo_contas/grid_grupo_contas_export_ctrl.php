<?php
@session_start() ;
$_SESSION['scriptcase']['grid_grupo_contas']['sc_process_barr'] = true;
require_once('../grid_grupo_contas/index.php');
unset($_SESSION['scriptcase']['grid_grupo_contas']['sc_process_barr']);
$ExportCtrl = new grid_grupo_contas_export_control;
$ExportCtrl->Export_barr();

class grid_grupo_contas_export_control
{
