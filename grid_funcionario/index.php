<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_funcionario']['glo_nm_perfil']          = "conn_amazonrds_mysql";
...
<?php
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['grid_funcionario']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_funcionario']['link_info'])) {
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_funcionario']['glo_nm_conexao'], $this->root . $this->path_prod, 'petshop', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle($linhas = 0)
   {
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_funcionario']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_funcionario']['label'] = "FUNCIONARIO";
      ...
      { 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['field_order'][] = "data_admissao";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_funcionario']['field_order'][] = "data_demissao";
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      foreach ($fields as $field) {
          ...
          {
              $this->SC_monta_condicao($comando, "idfuncionario", $arg_search, str_replace(",", ".", $data_search));
          }
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_petshop'])) {
               $_SESSION['scriptcase']['grid_funcionario']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_petshop'];
           }
       }
   }
