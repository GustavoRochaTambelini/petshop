<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_funcionario']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["idfuncionario"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["idfuncionario"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["idfuncionario"] : "ID";
   ...
   $tab_ger_campos['data_admissao'] = "on";
   $tab_def_campos['data_admissao'] = "data_admissao";
   $tab_labels["data_admissao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["data_admissao"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["data_admissao"] : "DATA ADMISSÃO";
   $tab_ger_campos['data_demissao'] = "on";
   $tab_def_campos['data_demissao'] = "data_demissao";
   $tab_labels["data_demissao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["data_demissao"])) ? $_SESSION['sc_session'][$sc_init]['grid_funcionario']['labels']["data_demissao"] : "DATA DEMISSÃO";
