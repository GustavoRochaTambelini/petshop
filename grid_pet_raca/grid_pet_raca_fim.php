...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_pet_raca"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_pet_raca"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_pet_raca'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pet_raca']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_pet_raca']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pet_raca']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_pet_raca']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_pet_raca']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_pet_raca']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_pet_raca']['embutida_filho'] as $ind => $sc_init)
          {
