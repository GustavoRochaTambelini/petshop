...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_grupos_receitas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_grupos_receitas"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_grupos_receitas'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_grupos_receitas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_grupos_receitas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_grupos_receitas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_grupos_receitas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_grupos_receitas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_grupos_receitas</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_grupos_receitas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_grupos_receitas']['embutida_filho'] as $ind => $sc_init)
          {
