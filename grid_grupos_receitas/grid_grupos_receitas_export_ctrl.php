<?php
@session_start() ;
$_SESSION['scriptcase']['grid_grupos_receitas']['sc_process_barr'] = true;
require_once('../grid_grupos_receitas/index.php');
unset($_SESSION['scriptcase']['grid_grupos_receitas']['sc_process_barr']);
$ExportCtrl = new grid_grupos_receitas_export_control;
$ExportCtrl->Export_barr();

class grid_grupos_receitas_export_control
{
