...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_contas_receber"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_contas_receber"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_cliente_contas_receber'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contas_receber']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_contas_receber']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contas_receber']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_contas_receber']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_contas_receber']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_contas_receber</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_contas_receber']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_contas_receber']['embutida_filho'] as $ind => $sc_init)
          {
