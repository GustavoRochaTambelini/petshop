...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["idmarca"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_marca']['labels']["idmarca"])) ? $_SESSION['sc_session'][$sc_init]['grid_marca']['labels']["idmarca"] : "ID";
   $tab_ger_campos['descricao'] = "on";
   $tab_def_campos['descricao'] = "descricao";
   $tab_labels["descricao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_marca']['labels']["descricao"])) ? $_SESSION['sc_session'][$sc_init]['grid_marca']['labels']["descricao"] : "DESCRIÇÃO";
