<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_marca']['glo_nm_perfil']          = "conn_amazonrds_mysql";
...
<?php
      ...
      $this->sc_lig_target["A_@scinf__@scinf_form_marca"] = '';
      if ($_SESSION['sc_session'][$this->sc_page]['grid_marca']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_marca']['link_info'])) {
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_marca']['glo_nm_conexao'], $this->root . $this->path_prod, 'petshop', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_marca']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_marca_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['embutida_ibase'] = true;
      }
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_marca']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_marca']['label'] = "MARCA";
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['field_order'][] = "idmarca";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['field_order'][] = "descricao";
...
//----------------------------------->
      ...
      { 
          ...
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['dashboard_refresh_after_chart'])) {
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['embutida'])
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['ajax_nav'])
         {
             ...
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      if (empty($data_search)) 
      {
          ...
          if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['where_pesq_filtro'])) 
          {
              if (!empty($tmp_cmd)) 
              {
                  $tmp_cmd .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['where_pesq_filtro'] . ")"; 
              }
              else
              {
                  $tmp_cmd = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_marca']['where_pesq_filtro'] . ")"; 
              }
          }
      ...
      foreach ($fields as $field) {
          ...
          {
              $this->SC_monta_condicao($comando, "idmarca", $arg_search, str_replace(",", ".", $data_search));
          }
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_marca']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_marca']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_petshop'])) {
               $_SESSION['scriptcase']['grid_marca']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_petshop'];
           }
       }
   }
   ...
   {
       $_SESSION['sc_session'][$script_case_init]['grid_marca']['orig_pesq'] = $nmgp_orig_pesq;
   }
