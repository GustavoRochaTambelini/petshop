...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_produto_captura"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_produto_captura"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_produto_captura']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_produto_captura']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_produto_captura']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_produto_captura']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_produto_captura']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_produto_captura</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_produto_captura']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_produto_captura']['embutida_filho'] as $ind => $sc_init)
          {
