...
<?php
   ...
   $Ord_Cmp = new grid_produto_captura_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_produto_captura_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["referencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto_captura']['labels']["referencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['labels']["referencia"] : "REFERENCIA";
   $tab_ger_campos['descricao'] = "on";
   $tab_def_campos['descricao'] = "descricao";
   $tab_labels["descricao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto_captura']['labels']["descricao"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['labels']["descricao"] : "DESCRIÇÃO";
   $tab_ger_campos['idgrupo'] = "on";
   $tab_def_campos['idgrupo'] = "idgrupo";
   $tab_labels["idgrupo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto_captura']['labels']["idgrupo"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['labels']["idgrupo"] : "GRUPO";
   $tab_ger_campos['idmarca'] = "on";
   $tab_def_campos['idmarca'] = "idmarca";
   $tab_labels["idmarca"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto_captura']['labels']["idmarca"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['labels']["idmarca"] : "MARCA";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto_captura']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['labels']["valor"] : "VALOR R$";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_produto_captura']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_produto_captura']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_produto_captura']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_produto_captura_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_produto_captura']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
