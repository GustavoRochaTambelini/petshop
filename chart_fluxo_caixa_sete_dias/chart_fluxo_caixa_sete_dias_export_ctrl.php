<?php
@session_start() ;
$_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['sc_process_barr'] = true;
require_once('../chart_fluxo_caixa_sete_dias/index.php');
unset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['sc_process_barr']);
$ExportCtrl = new chart_fluxo_caixa_sete_dias_export_control;
$ExportCtrl->Export_barr();

class chart_fluxo_caixa_sete_dias_export_control
{
