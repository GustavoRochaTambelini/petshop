...
*/
    ...
    $SC_cod_proj = "petshop";
    $SC_apl_proc = "chart_fluxo_caixa_sete_dias";
    $SC_ver_93   = true;
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['chart_fluxo_caixa_sete_dias']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['chart_fluxo_caixa_sete_dias']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
...
<?php
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['chart_fluxo_caixa_sete_dias']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['chart_fluxo_caixa_sete_dias']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
