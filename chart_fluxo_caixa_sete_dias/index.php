<?php
   include_once('chart_fluxo_caixa_sete_dias_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_perfil']          = "conn_amazonrds_mysql";
   $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_doc']        = "";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class chart_fluxo_caixa_sete_dias_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
...
//
   function init($Tp_init = "")
   {
      ...
      $this->nm_cod_apl      = "chart_fluxo_caixa_sete_dias"; 
      $this->nm_nome_apl     = ""; 
      $this->nm_seguranca    = ""; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/chart_fluxo_caixa_sete_dias';
      ...
      $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['actual_lang']) || $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("chart_fluxo_caixa_sete_dias_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if (!$_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = $_POST['origem'];
          $nmgp_opcao = $_POST['origem'];
      }
    }
      if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_save_ancor")
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      if ($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["chart_fluxo_caixa_sete_dias"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["chart_fluxo_caixa_sete_dias"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['responsive_chart'] = array(
              'enabled' => true,
              'active'  => true,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "chart_fluxo_caixa_sete_dias_erro.class.php"); 
      $this->Erro = new chart_fluxo_caixa_sete_dias_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('chart_fluxo_caixa_sete_dias'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
      ...
      {
          $this->nm_tabela = "fluxo_caixa_sete_dias"; 
      }
   }
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_conexao']) && $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_perfil']) && $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_conexao'], $this->root . $this->path_prod, 'petshop', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
      {
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class chart_fluxo_caixa_sete_dias_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['chart_fluxo_caixa_sete_dias']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['chart_fluxo_caixa_sete_dias'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class chart_fluxo_caixa_sete_dias_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['chart_fluxo_caixa_sete_dias']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['chart_fluxo_caixa_sete_dias'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_chart_fluxo_caixa_sete_dias($cadapar[1]);
                       nm_protect_num_chart_fluxo_caixa_sete_dias($cadapar[0], $cadapar[1]);
                       if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                       $Tmp_par   = $cadapar[0];
                       $$Tmp_par = $cadapar[1];
                       if ($Tmp_par == "nmgp_opcao")
                       {
                           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
      ...
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form'] = true;
      ...
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if (!isset($nmgp_opcao)) {
         $nmgp_opcao = "";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'])) {
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "";
      }
       if ($nmgp_opcao == "link_res")  
       { 
           $nmgp_opcao = "inicio";  
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "inicio";  
           $Temp_parms = "";  
           ...
           {
                $cadapar  = explode("?#?", $param);
                if ($cadapar[0] == "entradas")  
                { 
                    $cadapar[0] = str_replace("entradas", "Entradas", $cadapar[0]);
                } 
                if ($cadapar[0] == "saidas")  
                { 
                    $cadapar[0] = str_replace("saidas", "Saidas", $cadapar[0]);
                } 
                if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Ind_Groupby'] == "sc_free_group_by")
                { 
                    ...
                    elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_Free_orig'][$cadapar[0]]))
                    {
                        list ($Sql_orig, $Sql_order) = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_Free_sql'][$cadapar[0]];
                        $cadapar[1]  = str_replace("@aspass@", "", $cadapar[1]);
           ...
           $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_resumo'] = $Temp_parms;
       } 
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['chart_fluxo_caixa_sete_dias']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['chart_fluxo_caixa_sete_dias'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['chart_fluxo_caixa_sete_dias']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['chart_fluxo_caixa_sete_dias']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('chart_fluxo_caixa_sete_dias') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['chart_fluxo_caixa_sete_dias']['label'] = "Fluxo de caixa dos últimos 7 dias.";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "chart_fluxo_caixa_sete_dias")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
      {
          $this->Change_Menu = false;
      }
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("pt_br");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "chart_fluxo_caixa_sete_dias/chart_fluxo_caixa_sete_dias_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "chart_fluxo_caixa_sete_dias_erro.class.php"); 
      } 
      $this->Erro      = new chart_fluxo_caixa_sete_dias_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "chart_fluxo_caixa_sete_dias/chart_fluxo_caixa_sete_dias_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "chart_fluxo_caixa_sete_dias_lookup.class.php"); 
      } 
      $this->Lookup       = new chart_fluxo_caixa_sete_dias_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_chart_fluxo_caixa_sete_dias_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['arr_total']);
              }
              if ($nmgp_opcao == "ordem")
              {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_prefix_date_format']['sc_free_group_by']['data'] = "" . $this->Ini->Nm_lang['lang_othr_valueDD'] . "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_date_format']['sc_free_group_by']['data'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_date_format']['sc_free_group_by']['data'] = 'DD';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_All_Groupby'] = array('sc_free_group_by' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if ($Tp == "grid")
              {
                  continue;
              }
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Ind_Groupby'] = $Ind;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_Free_cmp'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_Free_cmp']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_Free_sql']  = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_Free_orig'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_Free_cmp']['data'] = "data";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_Free_sql']['data']["data"] = 'asc';
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Ind_Groupby'] == "sc_free_group_by")
      {
          $Arr_free_labels = array();
          $Arr_free_labels['data'] = "" . sprintf("Dia do mês", "Data") . "";
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_Free_cmp'] as $Field => $Label)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['Labels_GB'][] = $Arr_free_labels[$Field];
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['summarizing_fields_display']['sc_free_group_by'][2]['display'] = true;
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['summarizing_fields_control']['sc_free_group_by']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['summarizing_fields_control']['sc_free_group_by'] = array(
               array(
                   'cmp_res' => "media",
                   'label' => "Média do dia",
                   'label_field' => "Media",
                   ...
                   'select' => "<select class=\"sc-ui-select-media\" onChange=\"scSummChange($(this))\"><option value=\"2\" class=\"sc-ui-select-option-S\">" . $this->Ini->Nm_lang['lang_btns_smry_msge_sumt'] . "</option></select>",
               ),
           );
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "chart_fluxo_caixa_sete_dias_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "chart_fluxo_caixa_sete_dias_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_chart_fluxo_caixa_sete_dias_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_chart_fluxo_caixa_sete_dias_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_det'] = false;
      if ($nmgp_opcao == 'pdf')
      { 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
          }
          else
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['graf_disp']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['graf_disp']        = array('Bar');
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_tipo']        = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_larg']        = '800';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_alt']         = '600';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['graf_opc_atual']   = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['graf_mod_allowed'] = array(1, 2);
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['graf_order']       = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_font'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['graf_subtitle_val'] = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['chartpallet']       = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['graf_exibe_val']    = '1';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['paletteColors']     = '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_barra_orien'] = 'Vertical';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_barra_forma'] = 'Bar';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_barra_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_barra_sobre'] = 'No';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_barra_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_barra_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_barra_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_barra_funil'] = 'N';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_pizza_forma'] = 'Pie';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_pizza_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_pizza_orden'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_pizza_explo'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_pizza_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_linha_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_linha_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_linha_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_area_forma']  = 'Area';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_area_empil']  = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_area_inver']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_area_agrup']  = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_marca_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_marca_agrup'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_gauge_forma'] = 'Circular';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_radar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_radar_empil'] = 'Off';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_polar_forma'] = 'Line';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_funil_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_funil_inver'] = 'Normal';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_pyram_dimen'] = '3d';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_pyram_valor'] = 'Valor';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cfg_graf']['graf_pyram_forma'] = 'S';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida_treeview'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['proc_pdf_vert'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['field_order'][] = "data";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['field_order'][] = "entradas";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['field_order'][] = "saidas";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['field_order'][] = "media";
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['usr_cmp_sel']['data'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['usr_cmp_sel']['entradas'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['usr_cmp_sel']['saidas'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['usr_cmp_sel']['media'] = "off";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_fluxo_caixa_sete_dias']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['chart_fluxo_caixa_sete_dias']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['chart_fluxo_caixa_sete_dias']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['chart_fluxo_caixa_sete_dias']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['chart_fluxo_caixa_sete_dias']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opc_liga'] = $NMSC_conf_apl;  
          }   
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "pdf")
      { 
          $this->Ini->path_img_modelo = $this->Ini->path_img_modelo;
      } 
      $this->Ini->grid_search_change_fil = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "grid_search_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['orig_pesq'] = 'res';
          } 
          $this->SC_proc_grid_search($_POST['parm']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_pesq'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['contr_array_resumo'] = "NAO";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['contr_total_geral']  = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['tot_geral']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = 'pesq';
          ob_end_clean();
          $this->Ini->Arr_result = array();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['orig_pesq'] = 'res';
          } 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "chart_fluxo_caixa_sete_dias_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "chart_fluxo_caixa_sete_dias_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new chart_fluxo_caixa_sete_dias_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = 'inicio';
          } 
      } 
//
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['prim_cons'] = false;  
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['prim_cons'] = true;  
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_orig'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_pesq']        = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_pesq_ant']    = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_orig'];  
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['cond_pesq']         = ""; 
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_pesq_filtro'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_pesq_lookup'] = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['campos_busca']      = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['grid_pesq']         = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['Grid_search']       = array();
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['contr_total_geral'] = "NAO";
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['sc_total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['tot_geral']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['contr_array_resumo'] = "NAO";
      } 
      if (!in_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'], array('config_print', 'word_res', 'xls_res', 'xml_res', 'json_res', 'csv_res', 'rtf_res', 'image_res', 'ajax_comb_table', 'ajax_comb_save', 'ajax_comb_file_view', 'ajax_comb_file_download'))) {
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_pesq'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['where_pesq_ant'];  
      }
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_chart_fluxo_caixa_sete_dias_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_chart_fluxo_caixa_sete_dias.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_chart_fluxo_caixa_sete_dias_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_chart_fluxo_caixa_sete_dias_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "word_res" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "doc_word_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_fluxo_caixa_sete_dias/" . $this->Ini->Apl_resumo);
          }
          else 
          {
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo);
          }
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao']);
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['comb_field_display_type'][ $_POST['sumcfg_field'] ] = $_POST['sumcfg_value'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['chart_display_values'][ $_POST['sumcfg_field'] ]    = 1 == $_POST['sumcfg_display'];
          echo 'ok';
          exit;
      }
      else
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['chart_combination_order_rule']   = 'asc' == $_POST['sort_option'] || 'desc' == $_POST['sort_option'] ? $_POST['sort_option'] : '';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['chart_combination_order_field']  = $_POST['sort_field'];
          if ('orig' == $_POST['sort_option'])
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['chart_combination_order_forced'] = false;
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['chart_combination_order_forced'] = true;
          }
          echo 'ok';
          exit;
      }
      ...
      {
          if (!isset($_SESSION['scriptcase']['chart_export_file']['chart_fluxo_caixa_sete_dias']) || !isset($_SESSION['scriptcase']['chart_export_file']['chart_fluxo_caixa_sete_dias'][ $_REQUEST['chart_file_md5'] ]))
          {
              echo 'error_file_not_found';
          }
          else
          {
              echo $this->Ini->path_imag_temp . '/' . $_SESSION['scriptcase']['chart_export_file']['chart_fluxo_caixa_sete_dias'][ $_REQUEST['chart_file_md5'] ]['name'];
          }
          exit;
      }
      else
      if ($nmgp_opcao == "ajax_comb_file_download")
      {
          ...
          {
              $filename = $_SESSION['scriptcase']['chart_export_file']['chart_fluxo_caixa_sete_dias'][ $_REQUEST['chart_file_md5'] ]['name'];
              $path     = $_SESSION['scriptcase']['chart_export_file']['chart_fluxo_caixa_sete_dias'][ $_REQUEST['chart_file_md5'] ]['dir'] . $filename;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "print_res" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "res_print")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_fluxo_caixa_sete_dias/" . $this->Ini->Apl_resumo);
          ...
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao']);
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_progress_file']  = $_POST['export_progress_file'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_progress_step']  = 'init';
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_progress_count'] = 0;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_progress_total'] = 0;
          $this->outputCombinationPrint();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "config_print")
      { 
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao']);
          $this->outputCombinationPrintConfig();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "xls_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_fluxo_caixa_sete_dias/" . $this->Ini->Apl_resumo);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "xml_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_fluxo_caixa_sete_dias/" . $this->Ini->Apl_resumo);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "json_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_fluxo_caixa_sete_dias/" . $this->Ini->Apl_resumo);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "csv_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_fluxo_caixa_sete_dias/" . $this->Ini->Apl_resumo);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "rtf_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_fluxo_caixa_sete_dias/" . $this->Ini->Apl_resumo);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "image_res" || $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "img_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
          {
              require_once($this->Ini->path_embutida . "chart_fluxo_caixa_sete_dias/" . $this->Ini->Apl_resumo);
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "config_image")
      { 
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao']);
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . chart_fluxo_caixa_sete_dias . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new chart_fluxo_caixa_sete_dias_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "chart_fluxo_caixa_sete_dias_pesq.class.php"); 
      ...
      { 
          ...
          $this->Res = new chart_fluxo_caixa_sete_dias_resumo();
...
<?php
      ...
      {
         $nm_saida->finaliza();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['ajax_nav'])
         {
             $Temp = ob_get_clean();
             ...
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['opcao'] != "ajax_detalhe")  
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
             echo $oJson->encode($this->Ini->Arr_result);
            ...
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_sel_columns']['field_order']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_sel_columns']['field_order'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_sel_columns']['field_order']);
            }
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_sel_columns']['usr_cmp_sel']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_sel_columns']['usr_cmp_sel'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_sel_columns']['usr_cmp_sel']);
            }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    chart_fluxo_caixa_sete_dias_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                    fwrite($this->grid->progress_fp, ($this->grid->progress_tot) . "_#NM#_" . $lang_protect . "...\n");
                    fclose($this->grid->progress_fp);
                }
            }
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['contr_total_geral']  = '';
            // ----- PDF log
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        chart_fluxo_caixa_sete_dias_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        chart_fluxo_caixa_sete_dias_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_file'] = $nm_arquivo_pdf_serv;
}
if ($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opcao'] == "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pdf_det'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<HEAD>
 <TITLE>Fluxo de caixa dos últimos 7 dias. :: PDF</TITLE>
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "chart_fluxo_caixa_sete_dias.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
...
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['label'] as $series_name)
        {
...
<?php
        $this->outputCombinationTableRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableData], 0, $tableDef);
?>
</table>
<?php
        exit;
...
<?php
            ...
            {
?>
  <td class="scGridFieldOdd scGridFieldOddFont" style="text-align: right"><?php echo chart_fluxo_caixa_sete_dias_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['summ'][$index], $value); ?></td>
<?php
            }
?>
 </tr>
<?php
	...
	function outputCombinationZipPassword($type, $fileName, $password) {
		$zipCommand  = "";
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imag_temp'] . '/';
	...
	function outputCombinationData() {
		if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['anlt_table_def']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['anlt_table_def'])) {
	...
	function outputCombinationExport($type, $content, $password) {
		...
		$fileName = "sc_{$type}_{$dateTime}_{$fileSeq}_chart_fluxo_caixa_sete_dias.{$type}";
		...
		if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$testFilename . '_name'])) {
			$fileName = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$testFilename . '_name'];
		}
		...
		if (!isset($_SESSION['scriptcase']['chart_export_file']['chart_fluxo_caixa_sete_dias'])) {
			$_SESSION['scriptcase']['chart_export_file']['chart_fluxo_caixa_sete_dias'] = array();
		}
		$_SESSION['scriptcase']['chart_export_file']['chart_fluxo_caixa_sete_dias'][$fileMd5] = array(
			'dir'  => $fileDir,
			'name' => $fileName
		);
		...
		switch ($type) {
			...
			case 'html':
				if ($this->Ini->sc_export_ajax) {
					$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_print_files'][] = $fileName;

					$this->outputCombinationEmail($this->Res->zipFileList($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_print_files']));
				}
				else {
...
SCEOT;
	...
	function outputCombinationPrintConfig() {
		...
		$hasOneGroupByLevel = 1 >= count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['Labels_GB']);
		$isMultiSeriesChart = !isset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['summarizing_drill_down']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['summarizing_drill_down'];
...
SCEOT;
		...
		$lastGroupby = count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['Labels_GB']) - 1;
		foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['Labels_GB'] as $groupbyIndex => $groupbyLabel) {
...
SCEOT;
	...
	function outputCombinationPrintCss() {
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['chart_export_print_css'] = 'color';

		if ('bw' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['chart_export_print_css']) {
	...
	function outputCombinationPrintCharts() {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_print_bw'] = isset($_POST['export_chart_bw']) && 'Y' == $_POST['export_chart_bw'];

		$chartImages = $this->Res->generateChartImages();

		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_print_bw'] = false;
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['export_print_files'] = $chartImages;
    ...
    {
        $jsonData = $this->outputCombinationJsonRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableData], 0, $tableDef);
...
/* mantis 0019720  */
            ...
            foreach ($data['values'] as $index => $value) {
                $thisMetric = array(
                    'field' => $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['field'][$index],
                    'value' => $this->outputCombinationJsonProtectNumber($value)
                );

                if ($this->jsonShowFormatted) {
                	$thisMetric['formatted'] = $this->outputCombinationJsonProtectNumber(chart_fluxo_caixa_sete_dias_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['summ'][$index], $value));
                }
                if ($this->jsonShowLabel) {
                	$thisMetric['label'] = $this->outputCombinationJsonProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['label'][$index]);
                }
	...
	function outputCombinationXmlContent($tableDef, $tableData) {
		return "<?xml version=\"1.0\" encoding=\"{$_SESSION['scriptcase']['charset']}\" ?>\r\n" .
		       "<chart_fluxo_caixa_sete_dias>\r\n" .
		       $this->outputCombinationXmlRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableData], 0, $tableDef) .
		       "</chart_fluxo_caixa_sete_dias>";
	...
	function outputCombinationXmlRow($rows, $level, $tableDef) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$aggregateLabelTag = $this->xmlLabel ? $this->outputCombinationXmlProtectTag($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['label'][$index]) : $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['field'][$index];

				if ($this->xmlDisplayAsAttributes) {
					$outputData .= "<aggregate_{$aggregateLabelTag} label=\"" . $this->outputCombinationXmlProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['label'][$index]) . "\" value=\"" . $this->outputCombinationXmlProtectNumber(chart_fluxo_caixa_sete_dias_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['summ'][$index], $value)) . "\" />\r\n";
				} else {
					$outputData .= "<aggregate_{$aggregateLabelTag}>\r\n";
					$outputData .= "<label>" . $this->outputCombinationXmlProtectText($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['label'][$index]) . "</label>\r\n";
					$outputData .= "<value>" . $this->outputCombinationXmlProtectNumber(chart_fluxo_caixa_sete_dias_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['summ'][$index], $value)) . "</value>\r\n";
					$outputData .= "</aggregate_{$aggregateLabelTag}>\r\n";
				}
			}
	...
	function outputCombinationCsvContent($tableDef, $tableData) {
        $hasChildren = $this->outputCombinationHasChildren($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableData]);

		if ($this->csvHeader) {
			return $this->outputCombinationCsvHeader($tableDef, $hasChildren) .
			       $this->outputCombinationCsvRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pivot_y_axys']), $hasChildren);
		} else {
			return $this->outputCombinationCsvRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pivot_y_axys']), $hasChildren);
		}
	...
	function outputCombinationCsvHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pivot_group_by'] as $groupByName) {
				$headers[] = $groupByName;
			}
		}
		else {
			$headers[] = current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pivot_group_by']);
		}

		foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['label'] as $summName) {
			$headers[] = $summName;
		}
	...
	function outputCombinationCsvRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$thisRow[] = $this->outputCombinationCsvProtectNumber(chart_fluxo_caixa_sete_dias_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['summ'][$index], $value));
			}
	...
	function outputCombinationRtfContent($tableDef, $tableData) {
		...
		return "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>\r\n" .
		       ...
		       $this->outputCombinationRtfRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pivot_y_axys']), $hasChildren) .
			   "</table>\r\n" .
		       "</DOC>\r\n";
	...
	function outputCombinationRtfHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$headers .= "<td>" . current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pivot_group_by']) . "</td>\r\n";
		}
	...
	function outputCombinationRtfRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$outputData .= "<td>" . $this->outputCombinationRtfProtectNumber(chart_fluxo_caixa_sete_dias_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['summ'][$index], $value)) . "</td>\r\n";
			}
	...
	function outputCombinationXlsContent($tableDef, $tableData) {
		...
		$this->outputCombinationXlsRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pivot_y_axys']), $hasChildren);
	...
	function outputCombinationXlsHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$this->addXlsCell(array(
				'col'     => $column++,
				'row'     => $this->thisRow,
				'content' => current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pivot_group_by']),
				'size'    => 'auto',
				'bold'    => true,
				'align'   => 'left'
			));
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$this->addXlsCell(array(
					'col'     => $column++,
					'row'     => $this->thisRow,
					'content' => $this->outputCombinationXlsProtectNumber(chart_fluxo_caixa_sete_dias_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['summ'][$index], $value)),
					'align'   => 'right'
				));
			}
    ...
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['chart_export_word_css'] = 'color';

        if (isset($_REQUEST['nmgp_cor_word'])) {
            if ('pb' == $_REQUEST['nmgp_cor_word']) {
                $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['chart_export_word_css'] = 'bw';
	...
	function outputCombinationWordContent($tableDef, $tableData) {
		...
		return "<html xmlns:o=\"urn:schemas-microsoft-com:office:office\" xmlns:x=\"urn:schemas-microsoft-com:office:word\" xmlns=\"http://www.w3.org/TR/REC-html40\"{$_SESSION['scriptcase']['reg_conf']['html_dir']}>\r\n" .
		       ...
		       $this->outputCombinationWordRow($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableData], 0, array(), $tableDef, count($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pivot_y_axys']), $hasChildren) .
		       "</table>\r\n" .
		       "</body>\r\n" .
		       "</html>\r\n";
	...
	function outputCombinationWordCss() {
		if ('bw' == $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['chart_export_word_css']) {
			$cssFile    = "{$this->Ini->str_schema_all}_grid_bw.css";
			$cssDirFile = "{$this->Ini->str_schema_all}_grid_bw{$_SESSION['scriptcase']['reg_conf']['css_dir']}.css";
		}
		else {
	...
	function outputCombinationWordHeader($tableDef, $hasChildren) {
		...
		if ($hasChildren) {
			...
			$headers .= "<td class=\"scGridLabelFont\">" . current($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['pivot_group_by']) . "</td>\r\n";
		}
	...
	function outputCombinationWordRow($rows, $level, $parameters, $tableDef, $totalDepth, $hasChildren) {
		...
		foreach ($rows as $data) {
			...
			foreach ($data['values'] as $index => $value) {
				$outputData .= "<td class=\"scGridFieldOdd scGridFieldOddFont\">" . $this->outputCombinationWordProtectNumber(chart_fluxo_caixa_sete_dias_resumo::formatValue($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$tableDef]['summ'][$index], $value)) . "</td>\r\n";
			}
...
SCEOT;
  ...
  function close_emb()
  {
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[1] == "del_grid_search_all")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['grid_pesq']);
               continue;
           }
           ...
           {
               $busca[$dats[0]] = $dats[1];
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
               if (isset($fields[$ix]['vls'][1]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
      }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['campos_busca'][$ind] = $dados;
      }
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "chart_fluxo_caixa_sete_dias_pesq.class.php"); 
   ...
   {
      if (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['grid_pesq'][$cmp_del]);
   }
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false || strpos(" " . $this->Ini->SC_module_export, "resume") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imag_temp'] . "/");
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE>Fluxo de caixa dos últimos 7 dias. :: Doc</TITLE>
...
<form name="Fdown" method="get" action="chart_fluxo_caixa_sete_dias_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="chart_fluxo_caixa_sete_dias"> 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['chart_fluxo_caixa_sete_dias'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['sc_process_barr'])) {
       return;
   }
   ...
   $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['contr_erro'] = 'off';
   $sc_conv_var = array();
   $Sc_lig_md5 = false;
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_chart_fluxo_caixa_sete_dias($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_chart_fluxo_caixa_sete_dias($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "chart_fluxo_caixa_sete_dias") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_petshop'])) {
               $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_petshop'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['chart_fluxo_caixa_sete_dias']['master_pai']) && $_SESSION['sc_session'][$init_filho]['chart_fluxo_caixa_sete_dias']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['chart_fluxo_caixa_sete_dias']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['chart_fluxo_caixa_sete_dias']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['chart_fluxo_caixa_sete_dias']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['chart_fluxo_caixa_sete_dias']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['chart_fluxo_caixa_sete_dias']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['chart_fluxo_caixa_sete_dias']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['chart_fluxo_caixa_sete_dias']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['chart_fluxo_caixa_sete_dias']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['chart_fluxo_caixa_sete_dias']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']);
               $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['b_sair'] = false;
           }   
       } 
   } 
   if (!isset($nmgp_opcao)) {
   ...
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida']) && $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['chart_fluxo_caixa_sete_dias']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['chart_fluxo_caixa_sete_dias']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['chart_fluxo_caixa_sete_dias']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['protect_modal']) && !empty($_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['chart_fluxo_caixa_sete_dias']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   if (isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "chart_fluxo_caixa_sete_dias";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'chart_fluxo_caixa_sete_dias' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['initialize'] = false;
   }
   elseif (false === strpos($_SERVER['HTTP_REFERER'], '/chart_fluxo_caixa_sete_dias/'))
   {
       $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['initialize'] = true;
   }
   else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['contr_total_geral'] = "NAO";
   }
   ...
   {
       $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['b_sair'])))
   {
   ...
   $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/chart_fluxo_caixa_sete_dias_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opcao'] = $nmgp_opcao ;  
       }   
       if (!isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['mostra_edit'] = "S";
       }
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (!isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['sc_modal'] = false;
       }
       if (isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['volta_redirect_tp'] = "";
           $nm_url_saida = "chart_fluxo_caixa_sete_dias_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['sc_outra_jan'])
           {
               ...
               {
                   $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['sc_modal'] = true;
               }
               $nm_url_saida = "chart_fluxo_caixa_sete_dias_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) {
               $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opc_psq']  = false;   
           $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['psq_edit'] = 'N';   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['mostra_edit'] = "N";   
           } 
...
<?php
       ...
       $contr_chart_fluxo_caixa_sete_dias = new chart_fluxo_caixa_sete_dias_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opcao'] = "busca";
          $contr_chart_fluxo_caixa_sete_dias->NM_ajax_flag = true;
          $contr_chart_fluxo_caixa_sete_dias->NM_ajax_opcao = $NM_ajax_opcao;
      }
      if ('ajax_filter_save' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opcao'] = "busca";
          $contr_chart_fluxo_caixa_sete_dias->NM_ajax_flag = true;
          $contr_chart_fluxo_caixa_sete_dias->NM_ajax_opcao = "ajax_filter_save";
      }
      if ('ajax_filter_delete' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opcao'] = "busca";
          $contr_chart_fluxo_caixa_sete_dias->NM_ajax_flag = true;
          $contr_chart_fluxo_caixa_sete_dias->NM_ajax_opcao = "ajax_filter_delete";
      }
      if ('ajax_filter_select' == $nmgp_opcao)
      {
          ...
          $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opcao'] = "busca";
          $contr_chart_fluxo_caixa_sete_dias->NM_ajax_flag = true;
          $contr_chart_fluxo_caixa_sete_dias->NM_ajax_opcao = "ajax_filter_select";
      }
      if ('ajax_comb_table' == $nmgp_opcao)
      {
          $contr_chart_fluxo_caixa_sete_dias->NM_ajax_flag = true;
          $contr_chart_fluxo_caixa_sete_dias->NM_ajax_opcao = "ajax_comb_table";
      }
      if ('ajax_comb_save' == $nmgp_opcao)
      {
          $contr_chart_fluxo_caixa_sete_dias->NM_ajax_flag = true;
          $contr_chart_fluxo_caixa_sete_dias->NM_ajax_opcao = "ajax_comb_save";
      }
      if ('ajax_comb_sort' == $nmgp_opcao)
      {
          $contr_chart_fluxo_caixa_sete_dias->NM_ajax_flag = true;
          $contr_chart_fluxo_caixa_sete_dias->NM_ajax_opcao = "ajax_comb_sort";
      }
       $contr_chart_fluxo_caixa_sete_dias->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_chart_fluxo_caixa_sete_dias(&$str)
   {
   }
   function nm_protect_num_chart_fluxo_caixa_sete_dias($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function chart_fluxo_caixa_sete_dias_pack_protect_string($sString)
   {
    ...
    function chart_fluxo_caixa_sete_dias_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
