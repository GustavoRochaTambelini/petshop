...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____chart_fluxo_caixa_sete_dias"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____chart_fluxo_caixa_sete_dias"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['sc_modal'])
       {
...
<HTML>
<HEAD>
 <TITLE>chart_fluxo_caixa_sete_dias</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_fluxo_caixa_sete_dias']['embutida_filho'] as $ind => $sc_init)
          {
