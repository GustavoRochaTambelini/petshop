...
<?php
   ...
   $Ord_Cmp = new grid_contas_pagar_pagos_fornecedor_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_contas_pagar_pagos_fornecedor_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idcontas_pagar'] = "idcontas_pagar";
   $tab_labels["idcontas_pagar"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["idcontas_pagar"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["idcontas_pagar"] : "ID";
   $tab_ger_campos['data_emissao'] = "on";
   $tab_def_campos['data_emissao'] = "data_emissao";
   $tab_labels["data_emissao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["data_emissao"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["data_emissao"] : "DATA EMISSÃO";
   $tab_ger_campos['data_vencimanto'] = "on";
   $tab_def_campos['data_vencimanto'] = "data_vencimanto";
   $tab_labels["data_vencimanto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["data_vencimanto"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["data_vencimanto"] : "DATA VENCIMENTO";
   $tab_ger_campos['valor_pago'] = "on";
   $tab_def_campos['valor_pago'] = "valor_pago";
   $tab_labels["valor_pago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["valor_pago"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["valor_pago"] : "VALOR PAGO";
   $tab_ger_campos['juros'] = "on";
   $tab_def_campos['juros'] = "juros";
   $tab_labels["juros"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["juros"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["juros"] : "JUROS";
   $tab_ger_campos['idforma_pagamento'] = "on";
   $tab_def_campos['idforma_pagamento'] = "idforma_pagamento";
   $tab_labels["idforma_pagamento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["idforma_pagamento"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["idforma_pagamento"] : "FORMA PAGAMENTO";
   $tab_ger_campos['nota_fiscal'] = "on";
   $tab_def_campos['nota_fiscal'] = "nota_fiscal";
   $tab_labels["nota_fiscal"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["nota_fiscal"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["nota_fiscal"] : "NOTA FISCAL";
   $tab_ger_campos['observacao'] = "on";
   $tab_def_campos['observacao'] = "observacao";
   $tab_labels["observacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["observacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['labels']["observacao"] : "OBSERVAÇÕES";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_contas_pagar_pagos_fornecedor_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_contas_pagar_pagos_fornecedor']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
