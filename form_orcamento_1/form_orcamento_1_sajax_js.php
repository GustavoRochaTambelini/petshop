  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_orcamento_1" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_orcamento_1_validate_idorcamento()
  {
    var nomeCampo_idorcamento = "idorcamento";
    var var_idorcamento = scAjaxGetFieldHidden(nomeCampo_idorcamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_1_validate_idorcamento(var_idorcamento, var_script_case_init, do_ajax_form_orcamento_1_validate_idorcamento_cb);
  } // do_ajax_form_orcamento_1_validate_idorcamento

  function do_ajax_form_orcamento_1_validate_idorcamento_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_1_validate_idorcamento_cb

  // ---------- Validate idcliente
  function do_ajax_form_orcamento_1_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_1_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_orcamento_1_validate_idcliente_cb);
  } // do_ajax_form_orcamento_1_validate_idcliente

  function do_ajax_form_orcamento_1_validate_idcliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_1_validate_idcliente_cb

  // ---------- Validate data_venda
  function do_ajax_form_orcamento_1_validate_data_venda()
  {
    var nomeCampo_data_venda = "data_venda";
    var var_data_venda = scAjaxGetFieldText(nomeCampo_data_venda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_1_validate_data_venda(var_data_venda, var_script_case_init, do_ajax_form_orcamento_1_validate_data_venda_cb);
  } // do_ajax_form_orcamento_1_validate_data_venda

  function do_ajax_form_orcamento_1_validate_data_venda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_1_validate_data_venda_cb

  // ---------- Validate status
  function do_ajax_form_orcamento_1_validate_status()
  {
    var nomeCampo_status = "status";
    var var_status = scAjaxGetFieldSelect(nomeCampo_status);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_1_validate_status(var_status, var_script_case_init, do_ajax_form_orcamento_1_validate_status_cb);
  } // do_ajax_form_orcamento_1_validate_status

  function do_ajax_form_orcamento_1_validate_status_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "status";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_1_validate_status_cb

  // ---------- Validate valor_total
  function do_ajax_form_orcamento_1_validate_valor_total()
  {
    var nomeCampo_valor_total = "valor_total";
    var var_valor_total = scAjaxGetFieldText(nomeCampo_valor_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_1_validate_valor_total(var_valor_total, var_script_case_init, do_ajax_form_orcamento_1_validate_valor_total_cb);
  } // do_ajax_form_orcamento_1_validate_valor_total

  function do_ajax_form_orcamento_1_validate_valor_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_1_validate_valor_total_cb

  // ---------- Validate observacao
  function do_ajax_form_orcamento_1_validate_observacao()
  {
    var nomeCampo_observacao = "observacao";
    var var_observacao = scAjaxGetFieldText(nomeCampo_observacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_1_validate_observacao(var_observacao, var_script_case_init, do_ajax_form_orcamento_1_validate_observacao_cb);
  } // do_ajax_form_orcamento_1_validate_observacao

  function do_ajax_form_orcamento_1_validate_observacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_1_validate_observacao_cb

  // ---------- Validate itens_orcamento
  function do_ajax_form_orcamento_1_validate_itens_orcamento()
  {
    var nomeCampo_itens_orcamento = "itens_orcamento";
    var var_itens_orcamento = scAjaxGetFieldText(nomeCampo_itens_orcamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_1_validate_itens_orcamento(var_itens_orcamento, var_script_case_init, do_ajax_form_orcamento_1_validate_itens_orcamento_cb);
  } // do_ajax_form_orcamento_1_validate_itens_orcamento

  function do_ajax_form_orcamento_1_validate_itens_orcamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_1_validate_itens_orcamento_cb

  // ---------- Validate contas_receber
  function do_ajax_form_orcamento_1_validate_contas_receber()
  {
    var nomeCampo_contas_receber = "contas_receber";
    var var_contas_receber = scAjaxGetFieldText(nomeCampo_contas_receber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_1_validate_contas_receber(var_contas_receber, var_script_case_init, do_ajax_form_orcamento_1_validate_contas_receber_cb);
  } // do_ajax_form_orcamento_1_validate_contas_receber

  function do_ajax_form_orcamento_1_validate_contas_receber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_1_validate_contas_receber_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_orcamento_1_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_orcamento_1_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_orcamento_1_submit_form(var_idorcamento, var_idcliente, var_data_venda, var_status, var_valor_total, var_observacao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_orcamento_1_submit_form_cb);
  } // do_ajax_form_orcamento_1_submit_form

  function do_ajax_form_orcamento_1_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_orcamento_1_submit_form_cb_after_alert);
  } // do_ajax_form_orcamento_1_submit_form_cb
  function do_ajax_form_orcamento_1_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_orcamento_1_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_itens_orcamento_detalhe"] = "off";
  scStatusDetail["grid_contas_receber_1"] = "off";

  function do_ajax_form_orcamento_1_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_orcamento_1_navigate_form, function() {});
    } else {
      perform_ajax_form_orcamento_1_navigate_form();
    }
  }

  function perform_ajax_form_orcamento_1_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_orcamento_1_navigate_form(var_idorcamento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_orcamento_1_navigate_form_cb);
  } // do_ajax_form_orcamento_1_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_orcamento_1_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_orcamento_1_navigate_form_cb_after_alert);
  } // do_ajax_form_orcamento_1_navigate_form_cb
  function do_ajax_form_orcamento_1_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_orcamento_1_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_orcamento_1_navigate_form_cb_after_alert

  function sc_hide_form_orcamento_1_form()
  {
