...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_orcamento_1/form_orcamento_1_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_orcamento_1_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_orcamento_1_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['link_info']['remove_border']) {
...
<?php
 include_once("form_orcamento_1_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_orcamento_1'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_orcamento_1'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['link_contas_receber']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['link_contas_receber']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_label']['link_contas_receber']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_label']['link_contas_receber']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_label']['link_contas_receber'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-2';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idorcamento_line" id="hidden_field_data_idorcamento" style="<?php echo $sStyleHidden_idorcamento; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idorcamento_line" style="padding: 0px">
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { 
 ?>
<span id="id_read_on_idorcamento" css_idorcamento_line" style="<?php echo $sStyleReadLab_idorcamento; ?>"><?php echo $this->form_format_readonly("idorcamento", $this->form_encode_input($this->idorcamento)); ?></span><span id="id_read_off_idorcamento" class="css_read_off_idorcamento" style="<?php echo $sStyleReadInp_idorcamento; ?>"><input type="hidden" name="idorcamento" value="<?php echo $this->form_encode_input($idorcamento) . "\">"?><span id="id_ajax_label_idorcamento"><?php echo nl2br($idorcamento); ?></span>
</span><?php } else { ?>
&nbsp;
<?php } ?>
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_idorcamento_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_idorcamento_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['Lookup_status'][] = 'T'; ?>
 <option  value="F" <?php  if ($this->status == "F") { echo " selected" ;} ?>>CANCELADO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['Lookup_status'][] = 'F'; ?>
 </select></span>
</span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_idorcamento_dumb = ('' == $sStyleHidden_idorcamento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_idorcamento_dumb" style="<?php echo $sStyleHidden_idorcamento_dumb; ?>"></TD>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_itens_orcamento'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_itens_orcamento'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['grid_itens_orcamento_detalhe_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_itens_orcamento'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['grid_itens_orcamento_detalhe_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 if (isset($this->Ini->sc_lig_md5["grid_itens_orcamento_detalhe"]) && $this->Ini->sc_lig_md5["grid_itens_orcamento_detalhe"] == "S") {
     ...
     $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_orcamento_1@SC_par@" . md5($Parms_Lig);
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
 } else {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_orcamento_1_empty.htm' : $this->Ini->link_grid_itens_orcamento_detalhe_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_itens_orcamento']) && 'nmsc_iframe_liga_grid_itens_orcamento_detalhe' != $this->Ini->sc_lig_target['C_@scinf_itens_orcamento'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_itens_orcamento'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['grid_itens_orcamento_detalhe_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_contas_receber'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_contas_receber'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['grid_contas_receber_1_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_contas_receber'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['grid_contas_receber_1_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $parms_lig_cons = "&nmgp_parms=" . $Md5_Lig;
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_orcamento_1_empty.htm' : $this->Ini->link_grid_contas_receber_1_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_contas_receber']) && 'nmsc_iframe_liga_grid_contas_receber_1' != $this->Ini->sc_lig_target['C_@scinf_contas_receber'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_contas_receber'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['grid_contas_receber_1_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_orcamento_1");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_orcamento_1");
 parent.scAjaxDetailHeight("form_orcamento_1", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_1']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
