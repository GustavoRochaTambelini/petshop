<?php
@session_start() ;
$_SESSION['scriptcase']['grid_gurpo']['sc_process_barr'] = true;
require_once('../grid_gurpo/index.php');
unset($_SESSION['scriptcase']['grid_gurpo']['sc_process_barr']);
$ExportCtrl = new grid_gurpo_export_control;
$ExportCtrl->Export_barr();

class grid_gurpo_export_control
{
