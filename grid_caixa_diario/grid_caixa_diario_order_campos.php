...
<?php
   ...
   $Ord_Cmp = new grid_caixa_diario_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_caixa_diario_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['labels']["data"] : "DATA";
   $tab_ger_campos['idcliente'] = "on";
   $tab_def_campos['idcliente'] = "idcliente";
   $tab_labels["idcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['labels']["idcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['labels']["idcliente"] : "CLIENTE";
   $tab_ger_campos['observacao'] = "on";
   $tab_def_campos['observacao'] = "observacao";
   $tab_labels["observacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['labels']["observacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['labels']["observacao"] : "OBSERVAÇÃO";
   $tab_ger_campos['entrada'] = "on";
   $tab_def_campos['entrada'] = "entrada";
   $tab_labels["entrada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['labels']["entrada"])) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['labels']["entrada"] : "ENTRADA";
   $tab_ger_campos['saida'] = "on";
   $tab_def_campos['saida'] = "saida";
   $tab_labels["saida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['labels']["saida"])) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['labels']["saida"] : "SAIDA";
   ...
   {
       $tab_def_campos['valor_total'] = "";
   }
   $tab_labels["valor_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['labels']["valor_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['labels']["valor_total"] : "SALDO";
   $tab_ger_campos['idforma_pagamento'] = "on";
   $tab_def_campos['idforma_pagamento'] = "idforma_pagamento";
   $tab_labels["idforma_pagamento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['labels']["idforma_pagamento"])) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['labels']["idforma_pagamento"] : "FORMA DE PAGAMENTO";
   $tab_ger_campos['observacao'] = "none";
   $tab_ger_campos['valor_total'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_caixa_diario_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_caixa_diario']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
