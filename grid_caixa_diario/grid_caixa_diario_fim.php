...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_caixa_diario"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_caixa_diario"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_caixa_diario']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_caixa_diario']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario']['embutida_filho'] as $ind => $sc_init)
          {
