  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_outros_respensaveis" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_outros_respensaveis_form();
	}
...
?>
  ...
  // ---------- Validate idoutros_respensaveis_
  function do_ajax_form_outros_respensaveis_validate_idoutros_respensaveis_(iNumLinha)
  {
    var nomeCampo_idoutros_respensaveis_ = "idoutros_respensaveis_" + iNumLinha;
    var var_idoutros_respensaveis_ = scAjaxGetFieldHidden(nomeCampo_idoutros_respensaveis_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outros_respensaveis_validate_idoutros_respensaveis_(var_idoutros_respensaveis_, iNumLinha, var_script_case_init, do_ajax_form_outros_respensaveis_validate_idoutros_respensaveis__cb);
  } // do_ajax_form_outros_respensaveis_validate_idoutros_respensaveis_

  function do_ajax_form_outros_respensaveis_validate_idoutros_respensaveis__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idoutros_respensaveis_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idoutros_respensaveis_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idoutros_respensaveis_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idoutros_respensaveis_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outros_respensaveis_validate_idoutros_respensaveis__cb

  // ---------- Validate nome_
  function do_ajax_form_outros_respensaveis_validate_nome_(iNumLinha)
  {
    var nomeCampo_nome_ = "nome_" + iNumLinha;
    var var_nome_ = scAjaxGetFieldText(nomeCampo_nome_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outros_respensaveis_validate_nome_(var_nome_, iNumLinha, var_script_case_init, do_ajax_form_outros_respensaveis_validate_nome__cb);
  } // do_ajax_form_outros_respensaveis_validate_nome_

  function do_ajax_form_outros_respensaveis_validate_nome__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outros_respensaveis_validate_nome__cb

  // ---------- Validate cpf_
  function do_ajax_form_outros_respensaveis_validate_cpf_(iNumLinha)
  {
    var nomeCampo_cpf_ = "cpf_" + iNumLinha;
    var var_cpf_ = scAjaxGetFieldText(nomeCampo_cpf_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outros_respensaveis_validate_cpf_(var_cpf_, iNumLinha, var_script_case_init, do_ajax_form_outros_respensaveis_validate_cpf__cb);
  } // do_ajax_form_outros_respensaveis_validate_cpf_

  function do_ajax_form_outros_respensaveis_validate_cpf__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outros_respensaveis_validate_cpf__cb

  // ---------- Validate telefone_
  function do_ajax_form_outros_respensaveis_validate_telefone_(iNumLinha)
  {
    var nomeCampo_telefone_ = "telefone_" + iNumLinha;
    var var_telefone_ = scAjaxGetFieldText(nomeCampo_telefone_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outros_respensaveis_validate_telefone_(var_telefone_, iNumLinha, var_script_case_init, do_ajax_form_outros_respensaveis_validate_telefone__cb);
  } // do_ajax_form_outros_respensaveis_validate_telefone_

  function do_ajax_form_outros_respensaveis_validate_telefone__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outros_respensaveis_validate_telefone__cb

  // ---------- Validate tipo_telefone_
  function do_ajax_form_outros_respensaveis_validate_tipo_telefone_(iNumLinha)
  {
    var nomeCampo_tipo_telefone_ = "tipo_telefone_" + iNumLinha;
    var var_tipo_telefone_ = scAjaxGetFieldSelect(nomeCampo_tipo_telefone_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outros_respensaveis_validate_tipo_telefone_(var_tipo_telefone_, iNumLinha, var_script_case_init, do_ajax_form_outros_respensaveis_validate_tipo_telefone__cb);
  } // do_ajax_form_outros_respensaveis_validate_tipo_telefone_

  function do_ajax_form_outros_respensaveis_validate_tipo_telefone__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tipo_telefone_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tipo_telefone_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tipo_telefone_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tipo_telefone_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outros_respensaveis_validate_tipo_telefone__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_outros_respensaveis_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_outros_respensaveis_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_outros_respensaveis_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_outros_respensaveis_add_new_line_cb);
  } // do_ajax_form_outros_respensaveis_add_new_line

  function do_ajax_form_outros_respensaveis_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_outros_respensaveis_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_outros_respensaveis_backup_line(iNumLinha)
  {
    var var_idoutros_respensaveis_ = scAjaxGetFieldHidden("idoutros_respensaveis_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outros_respensaveis_backup_line(var_idoutros_respensaveis_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_outros_respensaveis_backup_line_cb);
  } // do_ajax_form_outros_respensaveis_backup_line

  function do_ajax_form_outros_respensaveis_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_outros_respensaveis_backup_line_cb

  function do_ajax_form_outros_respensaveis_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_outros_respensaveis_cancel_insert

  function do_ajax_form_outros_respensaveis_cancel_update(iSeqVert)
  {
    do_ajax_form_outros_respensaveis_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_outros_respensaveis_cancel_update

  function do_ajax_form_outros_respensaveis_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_outros_respensaveis_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_outros_respensaveis_table_refresh()
  {
    var var_idoutros_respensaveis_ = document.F2.idoutros_respensaveis_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_outros_respensaveis_table_refresh(var_idoutros_respensaveis_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_outros_respensaveis_table_refresh_cb);
  } //  do_ajax_form_outros_respensaveis_table_refresh

  function do_ajax_form_outros_respensaveis_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idoutros_respensaveis_.value = scAjaxGetKeyValue("idoutros_respensaveis_");
    ...
    scAjaxAlert(do_ajax_form_outros_respensaveis_table_refresh_cb_after_alert);
  } // do_ajax_form_outros_respensaveis_table_refresh_cb
  function do_ajax_form_outros_respensaveis_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_outros_respensaveis_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_outros_respensaveis_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_outros_respensaveis_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_tipo_telefone_ = scAjaxGetFieldSelect("tipo_telefone_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_outros_respensaveis_submit_form(var_idoutros_respensaveis_, var_nome_, var_cpf_, var_telefone_, var_tipo_telefone_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_outros_respensaveis_submit_form_cb);
  } // do_ajax_form_outros_respensaveis_submit_form

  function do_ajax_form_outros_respensaveis_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idoutros_respensaveis_" + sc_num_ult_line);
      ...
      scAjaxHideErrorDisplay("tipo_telefone_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_outros_respensaveis_submit_form_cb_after_alert);
  } // do_ajax_form_outros_respensaveis_submit_form_cb
  function do_ajax_form_outros_respensaveis_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_outros_respensaveis_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_outros_respensaveis_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_outros_respensaveis_navigate_form, function() {});
    } else {
      perform_ajax_form_outros_respensaveis_navigate_form();
    }
  }

  function perform_ajax_form_outros_respensaveis_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_outros_respensaveis_cancel_insert(sc_form_outros_respensaveis_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_outros_respensaveis_navigate_form(var_idoutros_respensaveis_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_outros_respensaveis_navigate_form_cb);
  } // do_ajax_form_outros_respensaveis_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_outros_respensaveis']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_outros_respensaveis_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idoutros_respensaveis_.value = scAjaxGetKeyValue("idoutros_respensaveis_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_outros_respensaveis_navigate_form_cb_after_alert);
  } // do_ajax_form_outros_respensaveis_navigate_form_cb
  function do_ajax_form_outros_respensaveis_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_outros_respensaveis_navigate_form_cb_after_alert

    function sc_form_outros_respensaveis_get_last_line_number()
    {
    ...
    } //sc_form_outros_respensaveis_get_last_line_number

  function sc_hide_form_outros_respensaveis_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idoutros_respensaveis_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tipo_telefone_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idoutros_respensaveis_" + iNumLinha] = {"label": "ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["tipo_telefone_" + iNumLinha] = {"label": "TIPO CONTATO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idoutros_respensaveis_"][iNumLinha] = "idoutros_respensaveis_" + iNumLinha;
    ...
    ajax_field_mult["tipo_telefone_"][iNumLinha] = "tipo_telefone_" + iNumLinha;
    ajax_field_id["idoutros_respensaveis_" + iNumLinha] = new Array("hidden_field_label_idoutros_respensaveis_", "hidden_field_data_idoutros_respensaveis_" + iNumLinha);
    ...
    ajax_field_id["tipo_telefone_" + iNumLinha] = new Array("hidden_field_label_tipo_telefone_", "hidden_field_data_tipo_telefone_" + iNumLinha);
    ajax_error_count["idoutros_respensaveis_" + iNumLinha] = "off";
    ajax_error_count["nome_" + iNumLinha] = "off";
    ajax_error_count["cpf_" + iNumLinha] = "off";
    ajax_error_count["telefone_" + iNumLinha] = "off";
    ajax_error_count["tipo_telefone_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idoutros_respensaveis_" + iNumLinha] = "on";
    ajax_read_only["nome_" + iNumLinha] = "off";
    ajax_read_only["cpf_" + iNumLinha] = "off";
    ajax_read_only["telefone_" + iNumLinha] = "off";
    ajax_read_only["tipo_telefone_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["tipo_telefone_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  var ajax_field_mult = {
    "idoutros_respensaveis_": new Array(),
    "nome_": new Array(),
    "cpf_": new Array(),
    "telefone_": new Array(),
    "tipo_telefone_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idoutros_respensaveis_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idoutros_respensaveis_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idoutros_respensaveis_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idoutros_respensaveis_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idoutros_respensaveis_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["tipo_telefone_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tipo_telefone_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tipo_telefone_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tipo_telefone_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tipo_telefone_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idoutros_respensaveis_'])) ? $this->nmgp_cmp_readonly['idoutros_respensaveis_'] : 'on';
?>
    scAjaxFieldRead("idoutros_respensaveis_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['cpf_'])) ? $this->nmgp_cmp_readonly['cpf_'] : 'off';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipo_telefone_'])) ? $this->nmgp_cmp_readonly['tipo_telefone_'] : 'off';
?>
    scAjaxFieldRead("tipo_telefone_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idoutros_respensaveis_" + iSeq, "on");
    scAjaxFieldRead("nome_" + iSeq, "on");
    scAjaxFieldRead("cpf_" + iSeq, "on");
    scAjaxFieldRead("telefone_" + iSeq, "on");
    scAjaxFieldRead("tipo_telefone_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idoutros_respensaveis_" + iRow] || "on" == ajax_error_count["nome_" + iRow] || "on" == ajax_error_count["cpf_" + iRow] || "on" == ajax_error_count["telefone_" + iRow] || "on" == ajax_error_count["tipo_telefone_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idoutros_respensaveis_" + iRow).addClass("scFormErrorLine");
      ...
      $("#hidden_field_data_tipo_telefone_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idoutros_respensaveis_" + iRow] && "off" == ajax_error_count["nome_" + iRow] && "off" == ajax_error_count["cpf_" + iRow] && "off" == ajax_error_count["telefone_" + iRow] && "off" == ajax_error_count["tipo_telefone_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idoutros_respensaveis_" + iRow] = "off";
        ajax_error_count["nome_" + iRow] = "off";
        ajax_error_count["cpf_" + iRow] = "off";
        ajax_error_count["telefone_" + iRow] = "off";
        ajax_error_count["tipo_telefone_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idoutros_respensaveis_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_tipo_telefone_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idoutros_respensaveis_" == sIndex)
    {
