<?php
@session_start() ;
$_SESSION['scriptcase']['grid_unidade']['sc_process_barr'] = true;
require_once('../grid_unidade/index.php');
unset($_SESSION['scriptcase']['grid_unidade']['sc_process_barr']);
$ExportCtrl = new grid_unidade_export_control;
$ExportCtrl->Export_barr();

class grid_unidade_export_control
{
