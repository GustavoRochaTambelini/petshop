...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_unidade"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_unidade"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_unidade'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_unidade']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_unidade']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_unidade']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_unidade']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_unidade']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_unidade']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_unidade']['embutida_filho'] as $ind => $sc_init)
          {
