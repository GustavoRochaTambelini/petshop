<?php
@session_start() ;
$_SESSION['scriptcase']['grid_tipos_receitas_selecionar_inclusao']['sc_process_barr'] = true;
require_once('../grid_tipos_receitas_selecionar_inclusao/index.php');
unset($_SESSION['scriptcase']['grid_tipos_receitas_selecionar_inclusao']['sc_process_barr']);
$ExportCtrl = new grid_tipos_receitas_selecionar_inclusao_export_control;
$ExportCtrl->Export_barr();

class grid_tipos_receitas_selecionar_inclusao_export_control
{
