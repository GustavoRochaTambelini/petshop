<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="iditens_orcamento_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['iditens_orcamento_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_itens_orcamento"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_itens_orcamento_submit_form(y, z);
...
{
   nm_field_disabled("descricao_=disabled;valor_unitario_=disabled", "");
