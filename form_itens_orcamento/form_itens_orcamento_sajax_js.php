  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_itens_orcamento" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_itens_orcamento_form();
	}
...
?>
  ...
  // ---------- Validate idproduto_
  function do_ajax_form_itens_orcamento_validate_idproduto_(iNumLinha)
  {
    var nomeCampo_idproduto_ = "idproduto_" + iNumLinha;
    var var_idproduto_ = scAjaxGetFieldSelect(nomeCampo_idproduto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_itens_orcamento_validate_idproduto_(var_idproduto_, iNumLinha, var_script_case_init, do_ajax_form_itens_orcamento_validate_idproduto__cb);
  } // do_ajax_form_itens_orcamento_validate_idproduto_

  function do_ajax_form_itens_orcamento_validate_idproduto__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_itens_orcamento_validate_idproduto__cb

  // ---------- Validate descricao_
  function do_ajax_form_itens_orcamento_validate_descricao_(iNumLinha)
  {
    var nomeCampo_descricao_ = "descricao_" + iNumLinha;
    var var_descricao_ = scAjaxGetFieldText(nomeCampo_descricao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_itens_orcamento_validate_descricao_(var_descricao_, iNumLinha, var_script_case_init, do_ajax_form_itens_orcamento_validate_descricao__cb);
  } // do_ajax_form_itens_orcamento_validate_descricao_

  function do_ajax_form_itens_orcamento_validate_descricao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_itens_orcamento_validate_descricao__cb

  // ---------- Validate valor_unitario_
  function do_ajax_form_itens_orcamento_validate_valor_unitario_(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_itens_orcamento_validate_valor_unitario_(var_valor_unitario_, iNumLinha, var_script_case_init, do_ajax_form_itens_orcamento_validate_valor_unitario__cb);
  } // do_ajax_form_itens_orcamento_validate_valor_unitario_

  function do_ajax_form_itens_orcamento_validate_valor_unitario__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_itens_orcamento_validate_valor_unitario__cb

  // ---------- Validate quantidade_
  function do_ajax_form_itens_orcamento_validate_quantidade_(iNumLinha)
  {
    var nomeCampo_quantidade_ = "quantidade_" + iNumLinha;
    var var_quantidade_ = scAjaxGetFieldText(nomeCampo_quantidade_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_itens_orcamento_validate_quantidade_(var_quantidade_, iNumLinha, var_script_case_init, do_ajax_form_itens_orcamento_validate_quantidade__cb);
  } // do_ajax_form_itens_orcamento_validate_quantidade_

  function do_ajax_form_itens_orcamento_validate_quantidade__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_itens_orcamento_validate_quantidade__cb

  // ---------- Validate valor_total_
  function do_ajax_form_itens_orcamento_validate_valor_total_(iNumLinha)
  {
    var nomeCampo_valor_total_ = "valor_total_" + iNumLinha;
    var var_valor_total_ = scAjaxGetFieldText(nomeCampo_valor_total_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_itens_orcamento_validate_valor_total_(var_valor_total_, iNumLinha, var_script_case_init, do_ajax_form_itens_orcamento_validate_valor_total__cb);
  } // do_ajax_form_itens_orcamento_validate_valor_total_

  function do_ajax_form_itens_orcamento_validate_valor_total__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_itens_orcamento_validate_valor_total__cb

  // ---------- Validate iditens_orcamento_
  function do_ajax_form_itens_orcamento_validate_iditens_orcamento_(iNumLinha)
  {
    var nomeCampo_iditens_orcamento_ = "iditens_orcamento_" + iNumLinha;
    var var_iditens_orcamento_ = scAjaxGetFieldHidden(nomeCampo_iditens_orcamento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_itens_orcamento_validate_iditens_orcamento_(var_iditens_orcamento_, iNumLinha, var_script_case_init, do_ajax_form_itens_orcamento_validate_iditens_orcamento__cb);
  } // do_ajax_form_itens_orcamento_validate_iditens_orcamento_

  function do_ajax_form_itens_orcamento_validate_iditens_orcamento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_itens_orcamento_validate_iditens_orcamento__cb

  // ---------- Event onblur quantidade_
  function do_ajax_form_itens_orcamento_event_quantidade__onblur(iSeqForm)
  {
    var var_valor_total_ = scAjaxGetFieldText("valor_total_" + iSeqForm);
    ...
    scAjaxProcOn(true);
    x_ajax_form_itens_orcamento_event_quantidade__onblur(var_valor_total_, var_valor_unitario_, var_quantidade_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_itens_orcamento_event_quantidade__onblur_cb);
  } // do_ajax_form_itens_orcamento_event_quantidade__onblur

  function do_ajax_form_itens_orcamento_event_quantidade__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_itens_orcamento_event_quantidade__onblur_cb_after_alert);
  } // do_ajax_form_itens_orcamento_event_quantidade__onblur_cb
  function do_ajax_form_itens_orcamento_event_quantidade__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_itens_orcamento_event_quantidade__onblur_cb_after_alert

  // ---------- Event onblur valor_unitario_
  function do_ajax_form_itens_orcamento_event_valor_unitario__onblur(iSeqForm)
  {
    var var_valor_total_ = scAjaxGetFieldText("valor_total_" + iSeqForm);
    var var_valor_unitario_ = scAjaxGetFieldText("valor_unitario_" + iSeqForm);
    var var_quantidade_ = scAjaxGetFieldText("quantidade_" + iSeqForm);
    ...
    var var_nmgp_refresh_row = iSeqForm;
    scAjaxProcOn(true);
    x_ajax_form_itens_orcamento_event_valor_unitario__onblur(var_valor_total_, var_valor_unitario_, var_quantidade_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_itens_orcamento_event_valor_unitario__onblur_cb);
  } // do_ajax_form_itens_orcamento_event_valor_unitario__onblur

  function do_ajax_form_itens_orcamento_event_valor_unitario__onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_itens_orcamento_event_valor_unitario__onblur_cb_after_alert);
  } // do_ajax_form_itens_orcamento_event_valor_unitario__onblur_cb
  function do_ajax_form_itens_orcamento_event_valor_unitario__onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_itens_orcamento_event_valor_unitario__onblur_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_itens_orcamento_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_itens_orcamento_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_itens_orcamento_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_itens_orcamento_add_new_line_cb);
  } // do_ajax_form_itens_orcamento_add_new_line

  function do_ajax_form_itens_orcamento_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("descricao_=disabled;valor_unitario_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_itens_orcamento_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_itens_orcamento_backup_line(iNumLinha)
  {
    var var_iditens_orcamento_ = scAjaxGetFieldHidden("iditens_orcamento_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_itens_orcamento_backup_line(var_iditens_orcamento_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_itens_orcamento_backup_line_cb);
  } // do_ajax_form_itens_orcamento_backup_line

  function do_ajax_form_itens_orcamento_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_itens_orcamento_backup_line_cb

  function do_ajax_form_itens_orcamento_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_itens_orcamento_cancel_insert

  function do_ajax_form_itens_orcamento_cancel_update(iSeqVert)
  {
    do_ajax_form_itens_orcamento_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_itens_orcamento_cancel_update

  function do_ajax_form_itens_orcamento_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_itens_orcamento_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_itens_orcamento_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_itens_orcamento_table_refresh(var_iditens_orcamento_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_itens_orcamento_table_refresh_cb);
  } //  do_ajax_form_itens_orcamento_table_refresh

  function do_ajax_form_itens_orcamento_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_itens_orcamento_table_refresh_cb_after_alert);
  } // do_ajax_form_itens_orcamento_table_refresh_cb
  function do_ajax_form_itens_orcamento_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_itens_orcamento_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_itens_orcamento_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_itens_orcamento_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_idproduto_ = scAjaxGetFieldSelect("idproduto_" + iNumLinha);
...
?>
    x_ajax_form_itens_orcamento_submit_form(var_idproduto_, var_descricao_, var_valor_unitario_, var_quantidade_, var_valor_total_, var_iditens_orcamento_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_itens_orcamento_submit_form_cb);
  } // do_ajax_form_itens_orcamento_submit_form

  function do_ajax_form_itens_orcamento_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_itens_orcamento_submit_form_cb_after_alert);
  } // do_ajax_form_itens_orcamento_submit_form_cb
  function do_ajax_form_itens_orcamento_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_itens_orcamento_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_itens_orcamento_navigate_form()
  {
    perform_ajax_form_itens_orcamento_navigate_form();
  }

  function perform_ajax_form_itens_orcamento_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_itens_orcamento_cancel_insert(sc_form_itens_orcamento_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_itens_orcamento_navigate_form(var_iditens_orcamento_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_itens_orcamento_navigate_form_cb);
  } // do_ajax_form_itens_orcamento_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_itens_orcamento']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_itens_orcamento_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_itens_orcamento_navigate_form_cb_after_alert);
  } // do_ajax_form_itens_orcamento_navigate_form_cb
  function do_ajax_form_itens_orcamento_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_itens_orcamento_navigate_form_cb_after_alert

    function sc_form_itens_orcamento_get_last_line_number()
    {
    ...
    } //sc_form_itens_orcamento_get_last_line_number

  function sc_hide_form_itens_orcamento_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_error_list["idproduto_" + iNumLinha] = {"label": "REFERENCIA<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["descricao_" + iNumLinha] = {"label": "DESCRIÇÃO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["quantidade_" + iNumLinha] = {"label": "QUANTIDADE<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["iditens_orcamento_" + iNumLinha] = {"label": "NUMERO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idproduto_'])) ? $this->nmgp_cmp_readonly['idproduto_'] : 'on';
?>
    scAjaxFieldRead("idproduto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['descricao_'])) ? $this->nmgp_cmp_readonly['descricao_'] : 'on';
?>
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['valor_total_'])) ? $this->nmgp_cmp_readonly['valor_total_'] : 'on';
?>
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idproduto_" + iRow] || "on" == ajax_error_count["descricao_" + iRow] || "on" == ajax_error_count["valor_unitario_" + iRow] || "on" == ajax_error_count["quantidade_" + iRow] || "on" == ajax_error_count["valor_total_" + iRow] || "on" == ajax_error_count["iditens_orcamento_" + iRow]))
    {
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idproduto_" + iRow] && "off" == ajax_error_count["descricao_" + iRow] && "off" == ajax_error_count["valor_unitario_" + iRow] && "off" == ajax_error_count["quantidade_" + iRow] && "off" == ajax_error_count["valor_total_" + iRow] && "off" == ajax_error_count["iditens_orcamento_" + iRow]))
    {
      if (bErrorRow)
      {
