  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_grupo_contas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_grupo_contas_form();
	}
...
?>
  ...
  function do_ajax_form_grupo_contas_validate_idgrupo_contas()
  {
    ...
    x_ajax_form_grupo_contas_validate_idgrupo_contas(var_idgrupo_contas, var_script_case_init, do_ajax_form_grupo_contas_validate_idgrupo_contas_cb);
  } // do_ajax_form_grupo_contas_validate_idgrupo_contas

  function do_ajax_form_grupo_contas_validate_idgrupo_contas_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_contas_validate_idgrupo_contas_cb

  // ---------- Validate descricao
  function do_ajax_form_grupo_contas_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_contas_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_grupo_contas_validate_descricao_cb);
  } // do_ajax_form_grupo_contas_validate_descricao

  function do_ajax_form_grupo_contas_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_contas_validate_descricao_cb

  // ---------- Validate ativo
  function do_ajax_form_grupo_contas_validate_ativo()
  {
    var nomeCampo_ativo = "ativo";
    var var_ativo = scAjaxGetFieldSelect(nomeCampo_ativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_grupo_contas_validate_ativo(var_ativo, var_script_case_init, do_ajax_form_grupo_contas_validate_ativo_cb);
  } // do_ajax_form_grupo_contas_validate_ativo

  function do_ajax_form_grupo_contas_validate_ativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ativo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_grupo_contas_validate_ativo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_grupo_contas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_grupo_contas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_grupo_contas_submit_form(var_idgrupo_contas, var_descricao, var_ativo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_grupo_contas_submit_form_cb);
  } // do_ajax_form_grupo_contas_submit_form

  function do_ajax_form_grupo_contas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_grupo_contas_submit_form_cb_after_alert);
  } // do_ajax_form_grupo_contas_submit_form_cb
  function do_ajax_form_grupo_contas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_grupo_contas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_grupo_contas_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_grupo_contas_navigate_form, function() {});
    } else {
      perform_ajax_form_grupo_contas_navigate_form();
    }
  }

  function perform_ajax_form_grupo_contas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_grupo_contas_navigate_form(var_idgrupo_contas, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_grupo_contas_navigate_form_cb);
  } // do_ajax_form_grupo_contas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_grupo_contas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_grupo_contas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_grupo_contas_navigate_form_cb_after_alert);
  } // do_ajax_form_grupo_contas_navigate_form_cb
  function do_ajax_form_grupo_contas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_grupo_contas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_grupo_contas_navigate_form_cb_after_alert

  function sc_hide_form_grupo_contas_form()
  {
