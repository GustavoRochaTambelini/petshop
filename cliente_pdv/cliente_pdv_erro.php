...
$old_error_handler = set_error_handler("cliente_pdv_scriptcase_error_handler");

function cliente_pdv_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['cliente_pdv']['contr_erro']) && $_SESSION['scriptcase']['cliente_pdv']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_cliente_pdv->contr_cliente_pdv->Apl_com_erro = true;
            if ($inicial_cliente_pdv->contr_cliente_pdv->NM_ajax_flag)
            {
                $inicial_cliente_pdv->contr_cliente_pdv->NM_ajax_info['errList']['geral_cliente_pdv'][] = $msg;
                return;
            }
            cliente_pdv_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function cliente_pdv_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['cliente_pdv'])  && '' != $_SESSION['scriptcase']['error_icon']['cliente_pdv'])  ? $_SESSION['scriptcase']['error_icon']['cliente_pdv']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['cliente_pdv']) && '' != $_SESSION['scriptcase']['error_close']['cliente_pdv']) ? $_SESSION['scriptcase']['error_close']['cliente_pdv'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['cliente_pdv']) && '' != $_SESSION['scriptcase']['error_span_title']['cliente_pdv']) ? $_SESSION['scriptcase']['error_span_title']['cliente_pdv'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['cliente_pdv']) && '' != $_SESSION['scriptcase']['error_icon_title']['cliente_pdv']) ? $_SESSION['scriptcase']['error_icon_title']['cliente_pdv'] : '';
?>
