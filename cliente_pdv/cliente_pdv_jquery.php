...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_cliente' + iSeqRow).bind('blur', function() { sc_cliente_pdv_cliente_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_cliente_pdv_cliente_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_cliente_pdv_cliente_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_cliente_pdv_cliente_onblur(oThis, iSeqRow) {
  do_ajax_cliente_pdv_validate_cliente();
  scCssBlur(oThis);
}

function sc_cliente_pdv_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_cliente_pdv_cliente_onfocus(oThis, iSeqRow) {
...
function scHidePage(pageNo) {
	$("#id_cliente_pdv_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'cliente_pdv')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
