  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_cliente_pdv_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate cliente
  function do_ajax_cliente_pdv_mob_validate_cliente()
  {
    var nomeCampo_cliente = "cliente";
    var var_cliente = scAjaxGetFieldSelect(nomeCampo_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_cliente_pdv_mob_validate_cliente(var_cliente, var_script_case_init, do_ajax_cliente_pdv_mob_validate_cliente_cb);
  } // do_ajax_cliente_pdv_mob_validate_cliente

  function do_ajax_cliente_pdv_mob_validate_cliente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_cliente_pdv_mob_validate_cliente_cb

  // ---------- Event onclick scajaxbutton_avancar
  function do_ajax_cliente_pdv_mob_event_scajaxbutton_avancar_onclick()
  {
    var var_cliente = scAjaxGetFieldSelect("cliente");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_cliente_pdv_mob_event_scajaxbutton_avancar_onclick(var_cliente, var_script_case_init, do_ajax_cliente_pdv_mob_event_scajaxbutton_avancar_onclick_cb);
  } // do_ajax_cliente_pdv_mob_event_scajaxbutton_avancar_onclick

  function do_ajax_cliente_pdv_mob_event_scajaxbutton_avancar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "scajaxbutton_avancar";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_cliente_pdv_mob_event_scajaxbutton_avancar_onclick_cb_after_alert);
  } // do_ajax_cliente_pdv_mob_event_scajaxbutton_avancar_onclick_cb
  function do_ajax_cliente_pdv_mob_event_scajaxbutton_avancar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_cliente_pdv_mob_event_scajaxbutton_avancar_onclick_cb_after_alert

  // ---------- Event onclick scajaxbutton_voltar
  function do_ajax_cliente_pdv_mob_event_scajaxbutton_voltar_onclick()
  {
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_cliente_pdv_mob_event_scajaxbutton_voltar_onclick(var_script_case_init, do_ajax_cliente_pdv_mob_event_scajaxbutton_voltar_onclick_cb);
  } // do_ajax_cliente_pdv_mob_event_scajaxbutton_voltar_onclick

  function do_ajax_cliente_pdv_mob_event_scajaxbutton_voltar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "scajaxbutton_voltar";
    scAjaxUpdateFieldErrors(sFieldValid, "onclick");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    {
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_cliente_pdv_mob_event_scajaxbutton_voltar_onclick_cb_after_alert);
  } // do_ajax_cliente_pdv_mob_event_scajaxbutton_voltar_onclick_cb
  function do_ajax_cliente_pdv_mob_event_scajaxbutton_voltar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_cliente_pdv_mob_event_scajaxbutton_voltar_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_cliente_pdv_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_cliente_pdv_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_cliente = scAjaxGetFieldSelect("cliente");
    ...
    scAjaxProcOn();
    x_ajax_cliente_pdv_mob_submit_form(var_cliente, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_cliente_pdv_mob_submit_form_cb);
  } // do_ajax_cliente_pdv_mob_submit_form

  function do_ajax_cliente_pdv_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_cliente_pdv_mob_submit_form_cb_after_alert);
  } // do_ajax_cliente_pdv_mob_submit_form_cb
  function do_ajax_cliente_pdv_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_cliente_pdv_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_cliente_pdv_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_cliente_pdv_mob_navigate_form, function() {});
    } else {
      perform_ajax_cliente_pdv_mob_navigate_form();
    }
  }

  function perform_ajax_cliente_pdv_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_cliente_pdv_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['cliente_pdv_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_cliente_pdv_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_cliente_pdv_mob_navigate_form_cb_after_alert);
  } // do_ajax_cliente_pdv_mob_navigate_form_cb
  function do_ajax_cliente_pdv_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_cliente_pdv_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_cliente_pdv_mob_navigate_form_cb_after_alert

  function sc_hide_cliente_pdv_mob_form()
  {
