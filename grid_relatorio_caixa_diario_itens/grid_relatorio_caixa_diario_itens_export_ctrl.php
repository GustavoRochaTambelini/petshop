<?php
@session_start() ;
$_SESSION['scriptcase']['grid_relatorio_caixa_diario_itens']['sc_process_barr'] = true;
require_once('../grid_relatorio_caixa_diario_itens/index.php');
unset($_SESSION['scriptcase']['grid_relatorio_caixa_diario_itens']['sc_process_barr']);
$ExportCtrl = new grid_relatorio_caixa_diario_itens_export_control;
$ExportCtrl->Export_barr();

class grid_relatorio_caixa_diario_itens_export_control
{
