...
<?php
   ...
   $Ord_Cmp = new grid_relatorio_caixa_diario_itens_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_relatorio_caixa_diario_itens_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_select_orig'] = array();
   }
   ...
   if ($use_alias == "S")
   {
       $tab_def_campos['itens_orcamento_idproduto'] = "itens_orcamento_idproduto";
   }
   else
   {
       $tab_def_campos['itens_orcamento_idproduto'] = "itens_orcamento.idproduto";
   }
   $tab_labels["itens_orcamento_idproduto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['labels']["itens_orcamento_idproduto"])) ? $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['labels']["itens_orcamento_idproduto"] : "PRODUTO VENDIDO";
   $tab_ger_campos['contas_receber_idforma_pagamento'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['contas_receber_idforma_pagamento'] = "cmp_maior_30_1";
   }
   else
   {
       $tab_def_campos['contas_receber_idforma_pagamento'] = "contas_receber.idforma_pagamento";
   }
   $tab_labels["contas_receber_idforma_pagamento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['labels']["contas_receber_idforma_pagamento"])) ? $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['labels']["contas_receber_idforma_pagamento"] : "FORMA DE RECEBIMENTO";
   $tab_ger_campos['itens_orcamento_quantidade'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['itens_orcamento_quantidade'] = "itens_orcamento_quantidade";
   }
   else
   {
       $tab_def_campos['itens_orcamento_quantidade'] = "itens_orcamento.quantidade";
   }
   $tab_labels["itens_orcamento_quantidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['labels']["itens_orcamento_quantidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['labels']["itens_orcamento_quantidade"] : "QUANTIDADE";
   $tab_ger_campos['itens_orcamento_valor_total'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['itens_orcamento_valor_total'] = "itens_orcamento_valor_total";
   }
   else
   {
       $tab_def_campos['itens_orcamento_valor_total'] = "itens_orcamento.valor_total";
   }
   $tab_labels["itens_orcamento_valor_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['labels']["itens_orcamento_valor_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['labels']["itens_orcamento_valor_total"] : "VALOR TOTAL";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_relatorio_caixa_diario_itens_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_relatorio_caixa_diario_itens']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
