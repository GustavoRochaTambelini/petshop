...
class grid_relatorio_caixa_diario_itens_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $array_total_contas_receber_idcliente;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_contas_receber_idcliente = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['grid_relatorio_caixa_diario_itens']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['grid_relatorio_caixa_diario_itens']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['contr_total_geral'] == "OK")
      {
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
          {
              ...
              $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['arr_total'][$cmp_gb];
          }
      }
      else
      {
      ...
      $this->array_total_geral[0] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['tot_geral'][3];
      $this->array_total_geral[1] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['tot_geral'][2];
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['arr_total']['contas_receber_idcliente'] = $this->array_total_contas_receber_idcliente;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['json_use_label'])
       {
          $Lab_contas_receber_idcliente = "contas_receber.idcliente";
       }
       else
       {
       $Lab_contas_receber_idcliente = "CLIENTE";
       }
       $prep_field = array();
       $prep_field['contas_receber_idcliente'] = $Lab_contas_receber_idcliente;
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idcliente'] = $Lab_contas_receber_idcliente; 
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
          $Str_gb .= ($Str_gb == "") ? "" : ",";
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_idproduto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_idproduto'] = "PRODUTO VENDIDO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idforma_pagamento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idforma_pagamento'] = "FORMA DE RECEBIMENTO"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_quantidade']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_quantidade'] = "QUANTIDADE"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_valor_total']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_valor_total'] = "VALOR TOTAL"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_iditens_orcamento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_iditens_orcamento'] = "Iditens Orcamento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_idorcamento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_idorcamento'] = "Idorcamento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_descricao']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_descricao'] = "Descricao"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_valor_unitario']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_valor_unitario'] = "Valor Unitario"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_unidade']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_unidade'] = "Unidade"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_desconto']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['itens_orcamento_desconto'] = "Desconto"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idcontas_receber']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idcontas_receber'] = "Idcontas Receber"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idcliente']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idcliente'] = "CLIENTE"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idforma_pagamento_prevista']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idforma_pagamento_prevista'] = "Idforma Pagamento Prevista"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idgrupos_receitas']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idgrupos_receitas'] = "Idgrupos Receitas"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idtipos_receitas']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idtipos_receitas'] = "Idtipos Receitas"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idorcamento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idorcamento'] = "Idorcamento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idnota_fiscal']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_idnota_fiscal'] = "Idnota Fiscal"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_numero_conta']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_numero_conta'] = "Numero Conta"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_data_emissao']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_data_emissao'] = "Data Emissao"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_data_vencimento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_data_vencimento'] = "Data Vencimento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_valor_a_receber']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_valor_a_receber'] = "Valor A Receber"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_data_pagamento']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_data_pagamento'] = "Data Pagamento"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_valor_recebido']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_valor_recebido'] = "Valor Recebido"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_pago']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_pago'] = "Pago"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_observacoes']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_observacoes'] = "Observacoes"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_situacao']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_situacao'] = "Situacao"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_juros']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_juros'] = "Juros"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_competencia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_competencia'] = "Competencia"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_data_insercao']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_data_insercao'] = "Data Insercao"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_data_alteracao']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_data_alteracao'] = "Data Alteracao"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_taxa_administrativa']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_taxa_administrativa'] = "Taxa Administrativa"; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_troco']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['labels']['contas_receber_troco'] = "Troco"; 
       }
       //-----
       $ix = 0;
       $this->comp_field_nm = array();
       ...
       //-----
       $this->comp_sum = array(
           2 => "Valor Recebido (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
           3 => "VALOR TOTAL (" .  $this->Ini->Nm_lang['lang_btns_smry_msge_sum'] . ")",
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['summarizing_fields_order']['sc_free_group_by']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['summarizing_fields_order']['sc_free_group_by'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['summarizing_fields_order']['sc_free_group_by'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['summarizing_fields_display']['sc_free_group_by'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['summarizing_fields_display']['sc_free_group_by'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['summarizing_fields_display']['sc_free_group_by'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['summarizing_fields_display']['sc_free_group_by'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $this->comp_sum_lnk = array(
           2 => array('field' => "contas_receber_valor_recebido", 'show' => true),
           3 => array('field' => "itens_orcamento_valor_total", 'show' => true),
       );

       //-----
       $this->comp_sum_css = array(
           2 => "css_contas_receber_valor_recebido_sum",
           3 => "css_itens_orcamento_valor_total_sum",
       );

       //-----
       $this->comp_sum_nm = array(
           2 => "contas_receber_valor_recebido_sum",
           3 => "itens_orcamento_valor_total_sum",
       );
      ...
      eval ($Str_gb);
       ...
       $Arr_parms = array();
       $Arr_parms['contas_receber_idcliente']['alin'] = "''";
       $Arr_parms['contas_receber_idcliente']['link'] = "S";
       $Arr_parms['contas_receber_idcliente']['fill'] = "true";
       $Arr_parms['contas_receber_idcliente']['order'] = "label";
       $Arr_parms['contas_receber_idcliente']['order_start'] = 'asc';
       $Arr_parms['contas_receber_idcliente']['order_invert'] = 'false';
       $Arr_parms['contas_receber_idcliente']['order_enabled'] = 'true';
       $Arr_parms['contas_receber_idcliente']['order_datatype'] = 'int';
       //-----
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
       {
       ...
       //-----
       $prep_links_fl = array();
       $prep_links_fl['contas_receber_idcliente'] = array(0 => 'contas_receber_idcliente', 1 => '');
       $Str_gb = "";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['SC_Gb_Free_cmp'] as $cmp_gb => $col_sql)
       {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_level'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@grid_relatorio_caixa_diario_itens@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new grid_relatorio_caixa_diario_itens_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['dashboard_refresh_after_chart'] = 'resumo';
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['doc_word'])
{
      ...
      { 
           ...
           if ($_SESSION['scriptcase']['proc_mobile'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['ajax_nav']) {  
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "grid_relatorio_caixa_diario_itens/grid_relatorio_caixa_diario_itens_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_relatorio_caixa_diario_itens_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_grid_relatorio_caixa_diario_itens_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_relatorio_caixa_diario_itens_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['doc_word']) 
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['embutida'])
      {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['embutida'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['doc_word'])
      { 
          $nm_saida->saida("      <STYLE>\r\n");
   ...
   function monta_barra_top_normal()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_relatorio_caixa_diario_itens/grid_relatorio_caixa_diario_itens_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=pt_br&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_relatorio_caixa_diario_itens/grid_relatorio_caixa_diario_itens_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=pt_br&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['json'] == "on" && !$this->NM_res_sem_reg)
      {
         ...
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bjson", "", "", "Rjson_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_relatorio_caixa_diario_itens/grid_relatorio_caixa_diario_itens_config_json.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_json_res=grid&nm_all_modules=grid&nm_json_format=N&nm_json_label=S&language=pt_br&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['groupby'] == "on" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['opc_psq'] && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
          $Q_free  = false;
          $Q_count = 0;
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['SC_All_Groupby'] as $QB => $Tp)
          {
              if (!in_array($QB, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['SC_Groupby_hide']) && $Tp == "all")
              {
                  $Q_count++;
          ...
          if ($Q_count > 1 || $Q_free)
          {
             $this->nm_btn_exist['groupby'][] = "sel_groupby_top";
              $Cod_Btn = nmButtonOutput($this->arr_buttons, "bgroupby", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_relatorio_caixa_diario_itens/grid_relatorio_caixa_diario_itens_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "scBtnGroupByShow('" . $this->Ini->path_link . "grid_relatorio_caixa_diario_itens/grid_relatorio_caixa_diario_itens_sel_groupby.php?opc_ret=resumo&path_img=" . $this->Ini->path_img_global . "&path_btn=" . $this->Ini->path_botoes . "&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "&embbed_groupby=Y&toolbar_pos=top', 'top');", "sel_groupby_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "", "only_text", "text_right", "", "", "", "", "", "", "");
              $nm_saida->saida("           $Cod_Btn \r\n");
          }
              $NM_btn = true;
      }
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("grid_relatorio_caixa_diario_itens_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['xml'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rxml_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['xml'][] = "Rxml_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bxml", "", "", "Rxml_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_relatorio_caixa_diario_itens/grid_relatorio_caixa_diario_itens_config_xml.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&password=n&nm_res_cons=s&nm_ini_xml_res=grid&nm_all_modules=grid&nm_xml_tag=tag&nm_xml_label=S&language=pt_br&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['csv'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $nm_saida->saida("            <div id=\"div_Rcsv_top\" class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $this->nm_btn_exist['csv'][] = "Rcsv_top";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bcsv", "", "", "Rcsv_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "grid_relatorio_caixa_diario_itens/grid_relatorio_caixa_diario_itens_config_csv.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=S&nm_res_cons=s&nm_ini_csv_res=grid&nm_all_modules=grid&password=n&nm_delim_line=1&nm_delim_col=1&nm_delim_dados=1&nm_label_csv=N&language=pt_br&origem=res&KeepThis=true&TB_iframe=true&modal=true", "group_3", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      if (!$this->grid_emb_form && $this->nmgp_botoes['rtf'] == "on" && !$this->NM_res_sem_reg)
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_relatorio_caixa_diario_itens']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['grid_relatorio_caixa_diario_itens']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'grid_relatorio_caixa_diario_itens_config_pivot.php?nome_apl=grid_relatorio_caixa_diario_itens&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=pt_br&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
   ...
   $nm_saida->saida("   }\r\n");
      ...
      $nm_saida->saida(" }\r\n");
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['SC_Gb_Free_cmp']))
      {
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_grid_relatorio_caixa_diario_itens_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "grid_relatorio_caixa_diario_itens/grid_relatorio_caixa_diario_itens_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $itens_orcamento_iditens_orcamento = (isset($Busca_temp['itens_orcamento_iditens_orcamento'])) ? $Busca_temp['itens_orcamento_iditens_orcamento'] : ""; 
          $tmp_pos = (is_string($itens_orcamento_iditens_orcamento)) ? strpos($itens_orcamento_iditens_orcamento, "##@@") : false;
          if ($tmp_pos !== false && !is_array($itens_orcamento_iditens_orcamento))
          {
              $itens_orcamento_iditens_orcamento = substr($itens_orcamento_iditens_orcamento, 0, $tmp_pos);
          }
          $itens_orcamento_idorcamento = (isset($Busca_temp['itens_orcamento_idorcamento'])) ? $Busca_temp['itens_orcamento_idorcamento'] : ""; 
          $tmp_pos = (is_string($itens_orcamento_idorcamento)) ? strpos($itens_orcamento_idorcamento, "##@@") : false;
          if ($tmp_pos !== false && !is_array($itens_orcamento_idorcamento))
          {
              $itens_orcamento_idorcamento = substr($itens_orcamento_idorcamento, 0, $tmp_pos);
          }
          $itens_orcamento_idproduto = (isset($Busca_temp['itens_orcamento_idproduto'])) ? $Busca_temp['itens_orcamento_idproduto'] : ""; 
          $tmp_pos = (is_string($itens_orcamento_idproduto)) ? strpos($itens_orcamento_idproduto, "##@@") : false;
          if ($tmp_pos !== false && !is_array($itens_orcamento_idproduto))
          {
              $itens_orcamento_idproduto = substr($itens_orcamento_idproduto, 0, $tmp_pos);
          }
          $itens_orcamento_descricao = (isset($Busca_temp['itens_orcamento_descricao'])) ? $Busca_temp['itens_orcamento_descricao'] : ""; 
          $tmp_pos = (is_string($itens_orcamento_descricao)) ? strpos($itens_orcamento_descricao, "##@@") : false;
          if ($tmp_pos !== false && !is_array($itens_orcamento_descricao))
          {
              $itens_orcamento_descricao = substr($itens_orcamento_descricao, 0, $tmp_pos);
          }
      } 
   ...
   //---- 
   function adiciona_registro($sum_itens_orcamento_valor_total, $sum_contas_receber_valor_recebido, $quebra_contas_receber_idcliente, $quebra_contas_receber_idcliente_orig)
   {
      $contr_arr = "";
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['SC_Gb_Free_cmp'] as $cmp_gb => $resto)
      {
          $Name_orig  = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['SC_Gb_Free_orig'][$cmp_gb])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['SC_Gb_Free_orig'][$cmp_gb] : $cmp_gb;
          ...
          $cmp_look   = "Cmp_formt";
          $cmp_orig   = "Cmp_arg";
          if (empty($sum_itens_orcamento_valor_total)) {$sum_itens_orcamento_valor_total = '0';}
          if (empty($sum_contas_receber_valor_recebido)) {$sum_contas_receber_valor_recebido = '0';}
          eval ('
          if (!isset($this->' . $arr_name . '))
          {
              $this->' . $arr_name . '[0] = 1;
              $this->' . $arr_name . '[1] = ' . $sum_itens_orcamento_valor_total . ';
              $this->' . $arr_name . '[2] = ' . $sum_contas_receber_valor_recebido . ';
          ...
          {
              $this->' . $arr_name . '[0]++;
              $this->' . $arr_name . '[1] = bcadd($this->' . $arr_name . '[1], ' . $sum_itens_orcamento_valor_total . ', 10);
              $this->' . $arr_name . '[2] = bcadd($this->' . $arr_name . '[2], ' . $sum_contas_receber_valor_recebido . ', 10);
          }
          ');
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     { 
       ...
       $this->itens_orcamento_iditens_orcamento = $Busca_temp['itens_orcamento_iditens_orcamento']; 
       $this->itens_orcamento_iditens_orcamento = (isset($Busca_temp['itens_orcamento_iditens_orcamento'])) ? $Busca_temp['itens_orcamento_iditens_orcamento'] : ""; 
       $tmp_pos = (is_string($this->itens_orcamento_iditens_orcamento)) ? strpos($this->itens_orcamento_iditens_orcamento, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->itens_orcamento_iditens_orcamento))
       {
       ...
       $this->itens_orcamento_idorcamento = $Busca_temp['itens_orcamento_idorcamento']; 
       $this->itens_orcamento_idorcamento = (isset($Busca_temp['itens_orcamento_idorcamento'])) ? $Busca_temp['itens_orcamento_idorcamento'] : ""; 
       $tmp_pos = (is_string($this->itens_orcamento_idorcamento)) ? strpos($this->itens_orcamento_idorcamento, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->itens_orcamento_idorcamento))
       {
       ...
       $this->itens_orcamento_idproduto = $Busca_temp['itens_orcamento_idproduto']; 
       $this->itens_orcamento_idproduto = (isset($Busca_temp['itens_orcamento_idproduto'])) ? $Busca_temp['itens_orcamento_idproduto'] : ""; 
       $tmp_pos = (is_string($this->itens_orcamento_idproduto)) ? strpos($this->itens_orcamento_idproduto, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->itens_orcamento_idproduto))
       {
       ...
       $this->itens_orcamento_descricao = $Busca_temp['itens_orcamento_descricao']; 
       $this->itens_orcamento_descricao = (isset($Busca_temp['itens_orcamento_descricao'])) ? $Busca_temp['itens_orcamento_descricao'] : ""; 
       $tmp_pos = (is_string($this->itens_orcamento_descricao)) ? strpos($this->itens_orcamento_descricao, "##@@") : false;
       if ($tmp_pos !== false && !is_array($this->itens_orcamento_descricao))
       {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->itens_orcamento_idproduto = $rs_res->fields[0] ;  
            $this->contas_receber_idforma_pagamento = $rs_res->fields[1] ;  
            $this->itens_orcamento_quantidade = $rs_res->fields[2] ;  
            $this->itens_orcamento_quantidade =  str_replace(",", ".", $this->itens_orcamento_quantidade);
            $this->itens_orcamento_valor_total = $rs_res->fields[3] ;  
            $this->itens_orcamento_valor_total =  str_replace(",", ".", $this->itens_orcamento_valor_total);
            $this->itens_orcamento_iditens_orcamento = $rs_res->fields[4] ;  
            $this->itens_orcamento_idorcamento = $rs_res->fields[5] ;  
            $this->itens_orcamento_descricao = $rs_res->fields[6] ;  
            $this->itens_orcamento_valor_unitario = $rs_res->fields[7] ;  
            $this->itens_orcamento_valor_unitario =  str_replace(",", ".", $this->itens_orcamento_valor_unitario);
            $this->contas_receber_idcliente = $rs_res->fields[8] ;  
            $this->contas_receber_valor_recebido = $rs_res->fields[9] ;  
            $this->contas_receber_valor_recebido =  str_replace(",", ".", $this->contas_receber_valor_recebido);
            $this->contas_receber_idcliente_orig = $this->contas_receber_idcliente;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->itens_orcamento_valor_total, $this->contas_receber_valor_recebido, $this->contas_receber_idcliente, $this->contas_receber_idcliente_orig);
            }
   }
//
