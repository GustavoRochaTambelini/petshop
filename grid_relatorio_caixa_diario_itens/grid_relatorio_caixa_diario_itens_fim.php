...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_relatorio_caixa_diario_itens"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_relatorio_caixa_diario_itens"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_relatorio_caixa_diario_itens']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_relatorio_caixa_diario_itens']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_relatorio_caixa_diario_itens']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_relatorio_caixa_diario_itens']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_relatorio_caixa_diario_itens']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_relatorio_caixa_diario_itens</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_relatorio_caixa_diario_itens']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_relatorio_caixa_diario_itens']['embutida_filho'] as $ind => $sc_init)
          {
