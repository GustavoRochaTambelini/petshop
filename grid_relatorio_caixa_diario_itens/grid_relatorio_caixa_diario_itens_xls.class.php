...
class grid_relatorio_caixa_diario_itens_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_relatorio_caixa_diario_itens/grid_relatorio_caixa_diario_itens_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_relatorio_caixa_diario_itens_res_xls.class.php");
              $this->Res_xls = new grid_relatorio_caixa_diario_itens_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_relatorio_caixa_diario_itens.zip";
          $this->Arquivo   .= "_grid_relatorio_caixa_diario_itens" . $this->Xls_tp;
          $this->Tit_doc    = "grid_relatorio_caixa_diario_itens" . $this->Xls_tp;
          $this->Tit_zip    = "grid_relatorio_caixa_diario_itens.zip";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_contas_receber_idforma_pagamento()
   {
         ...
         if (is_numeric($this->look_contas_receber_idforma_pagamento))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->look_contas_receber_idforma_pagamento);
         $this->Xls_col++;
   }
   ...
   function NM_export_itens_orcamento_iditens_orcamento()
   {
         ...
         if (is_numeric($this->itens_orcamento_iditens_orcamento))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->itens_orcamento_iditens_orcamento);
         $this->Xls_col++;
   }
   ...
   function NM_export_itens_orcamento_idorcamento()
   {
         ...
         if (is_numeric($this->itens_orcamento_idorcamento))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->itens_orcamento_idorcamento);
         $this->Xls_col++;
   }
   ...
   function NM_export_itens_orcamento_descricao()
   {
         ...
         if ($this->Use_phpspreadsheet) {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->itens_orcamento_descricao, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
         }
         else {
             $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->itens_orcamento_descricao, PHPExcel_Cell_DataType::TYPE_STRING);
         }
         $this->Xls_col++;
   }
   ...
   //----- contas_receber_idforma_pagamento
   function NM_sub_cons_contas_receber_idforma_pagamento()
   {
         $this->look_contas_receber_idforma_pagamento = NM_charset_to_utf8($this->look_contas_receber_idforma_pagamento);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->look_contas_receber_idforma_pagamento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- itens_orcamento_iditens_orcamento
   function NM_sub_cons_itens_orcamento_iditens_orcamento()
   {
         $this->itens_orcamento_iditens_orcamento = NM_charset_to_utf8($this->itens_orcamento_iditens_orcamento);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->itens_orcamento_iditens_orcamento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- itens_orcamento_idorcamento
   function NM_sub_cons_itens_orcamento_idorcamento()
   {
         $this->itens_orcamento_idorcamento = NM_charset_to_utf8($this->itens_orcamento_idorcamento);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->itens_orcamento_idorcamento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- itens_orcamento_descricao
   function NM_sub_cons_itens_orcamento_descricao()
   {
         $this->itens_orcamento_descricao = html_entity_decode($this->itens_orcamento_descricao, ENT_COMPAT, $_SESSION['scriptcase']['charset']);
         $this->itens_orcamento_descricao = strip_tags($this->itens_orcamento_descricao);
         $this->itens_orcamento_descricao = NM_charset_to_utf8($this->itens_orcamento_descricao);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->itens_orcamento_descricao;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['nolabel'])
       {
 ...
 function quebra_contas_receber_idcliente_sc_free_group_by($Cmp_qb, $Where_qb, $Cmp_Name) 
 {
   ...
   function quebra_contas_receber_idcliente_sc_free_group_by_top()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       $temp_cmp = "";
       $cont_col = 0;
       foreach ($this->campos_quebra_contas_receber_idcliente as $cada_campo) {
           if ($cont_col == $lim_col) {
   ...
   function quebra_contas_receber_idcliente_sc_free_group_by_bot()
   {
       if ($this->groupby_show != "S") {
           return;
       }
       ...
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['field_order'] as $Cada_cmp)
       {
           ...
           {
               $Format_Num = "#,##0.00";
               $Cmp_Tot    = $this->sum_contas_receber_idcliente_itens_orcamento_valor_total;
               $prim_cmp = false;
           ...
           elseif (!isset($this->NM_cmp_hidden[$Cada_cmp]) || $this->NM_cmp_hidden[$Cada_cmp] != "off")
           {
               ...
               elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['embutida']) {
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = "";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "left";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "char";
                       $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "";
   ...
   function quebra_geral_sc_free_group_by_bot()
   {
       ...
       $prim_cmp = true;
       $mens_tot = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['tot_geral'][0] . "(" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['tot_geral'][1] . ")";
       foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['field_order'] as $Cada_cmp)
       {
           if ($Cada_cmp == "itens_orcamento_valor_total" && (!isset($this->NM_cmp_hidden['itens_orcamento_valor_total']) || $this->NM_cmp_hidden['itens_orcamento_valor_total'] != "off"))
           {
               $Format_Num = "#,##0.00";
               $Vl_Tot     = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['tot_geral'][2];
               $prim_cmp = false;
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_file'] = $this->Xls_f;
      }
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_relatorio_caixa_diario_itens']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
