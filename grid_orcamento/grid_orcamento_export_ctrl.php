<?php
@session_start() ;
$_SESSION['scriptcase']['grid_orcamento']['sc_process_barr'] = true;
require_once('../grid_orcamento/index.php');
unset($_SESSION['scriptcase']['grid_orcamento']['sc_process_barr']);
$ExportCtrl = new grid_orcamento_export_control;
$ExportCtrl->Export_barr();

class grid_orcamento_export_control
{
