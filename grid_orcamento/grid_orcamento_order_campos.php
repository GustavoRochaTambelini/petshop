...
<?php
   ...
   $Ord_Cmp = new grid_orcamento_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_orcamento_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['idorcamento'] = "idorcamento";
   $tab_labels["idorcamento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_orcamento']['labels']["idorcamento"])) ? $_SESSION['sc_session'][$sc_init]['grid_orcamento']['labels']["idorcamento"] : "ID";
   $tab_ger_campos['idcliente'] = "on";
   $tab_def_campos['idcliente'] = "idcliente";
   $tab_labels["idcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_orcamento']['labels']["idcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_orcamento']['labels']["idcliente"] : "CLIENTE";
   $tab_ger_campos['data_venda'] = "on";
   $tab_def_campos['data_venda'] = "data_venda";
   $tab_labels["data_venda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_orcamento']['labels']["data_venda"])) ? $_SESSION['sc_session'][$sc_init]['grid_orcamento']['labels']["data_venda"] : "DATA DA VENDA";
   $tab_ger_campos['desconto'] = "on";
   $tab_def_campos['desconto'] = "desconto";
   $tab_labels["desconto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_orcamento']['labels']["desconto"])) ? $_SESSION['sc_session'][$sc_init]['grid_orcamento']['labels']["desconto"] : "DESCONTO";
   $tab_ger_campos['valor_total'] = "on";
   $tab_def_campos['valor_total'] = "valor_total";
   $tab_labels["valor_total"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_orcamento']['labels']["valor_total"])) ? $_SESSION['sc_session'][$sc_init]['grid_orcamento']['labels']["valor_total"] : "VALOR TOTAL";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_orcamento']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_orcamento']['labels']["status"] : "STATUS";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_orcamento']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_orcamento']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_orcamento']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_orcamento_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_orcamento']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
