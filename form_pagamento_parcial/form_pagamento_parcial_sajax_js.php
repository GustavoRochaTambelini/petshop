  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pagamento_parcial" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pagamento_parcial_form();
	}
...
?>
  ...
  // ---------- Validate idpagamento_parcial_
  function do_ajax_form_pagamento_parcial_validate_idpagamento_parcial_(iNumLinha)
  {
    var nomeCampo_idpagamento_parcial_ = "idpagamento_parcial_" + iNumLinha;
    var var_idpagamento_parcial_ = scAjaxGetFieldHidden(nomeCampo_idpagamento_parcial_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagamento_parcial_validate_idpagamento_parcial_(var_idpagamento_parcial_, iNumLinha, var_script_case_init, do_ajax_form_pagamento_parcial_validate_idpagamento_parcial__cb);
  } // do_ajax_form_pagamento_parcial_validate_idpagamento_parcial_

  function do_ajax_form_pagamento_parcial_validate_idpagamento_parcial__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idpagamento_parcial_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idpagamento_parcial_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idpagamento_parcial_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idpagamento_parcial_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagamento_parcial_validate_idpagamento_parcial__cb

  // ---------- Validate idforma_pagamento_
  function do_ajax_form_pagamento_parcial_validate_idforma_pagamento_(iNumLinha)
  {
    var nomeCampo_idforma_pagamento_ = "idforma_pagamento_" + iNumLinha;
    var var_idforma_pagamento_ = scAjaxGetFieldSelect(nomeCampo_idforma_pagamento_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagamento_parcial_validate_idforma_pagamento_(var_idforma_pagamento_, iNumLinha, var_script_case_init, do_ajax_form_pagamento_parcial_validate_idforma_pagamento__cb);
  } // do_ajax_form_pagamento_parcial_validate_idforma_pagamento_

  function do_ajax_form_pagamento_parcial_validate_idforma_pagamento__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idforma_pagamento_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idforma_pagamento_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idforma_pagamento_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idforma_pagamento_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagamento_parcial_validate_idforma_pagamento__cb

  // ---------- Validate data_
  function do_ajax_form_pagamento_parcial_validate_data_(iNumLinha)
  {
    var nomeCampo_data_ = "data_" + iNumLinha;
    var var_data_ = scAjaxGetFieldText(nomeCampo_data_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagamento_parcial_validate_data_(var_data_, iNumLinha, var_script_case_init, do_ajax_form_pagamento_parcial_validate_data__cb);
  } // do_ajax_form_pagamento_parcial_validate_data_

  function do_ajax_form_pagamento_parcial_validate_data__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagamento_parcial_validate_data__cb

  // ---------- Validate valor_
  function do_ajax_form_pagamento_parcial_validate_valor_(iNumLinha)
  {
    var nomeCampo_valor_ = "valor_" + iNumLinha;
    var var_valor_ = scAjaxGetFieldText(nomeCampo_valor_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagamento_parcial_validate_valor_(var_valor_, iNumLinha, var_script_case_init, do_ajax_form_pagamento_parcial_validate_valor__cb);
  } // do_ajax_form_pagamento_parcial_validate_valor_

  function do_ajax_form_pagamento_parcial_validate_valor__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagamento_parcial_validate_valor__cb

  // ---------- Validate observacao_
  function do_ajax_form_pagamento_parcial_validate_observacao_(iNumLinha)
  {
    var nomeCampo_observacao_ = "observacao_" + iNumLinha;
    var var_observacao_ = scAjaxGetFieldText(nomeCampo_observacao_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagamento_parcial_validate_observacao_(var_observacao_, iNumLinha, var_script_case_init, do_ajax_form_pagamento_parcial_validate_observacao__cb);
  } // do_ajax_form_pagamento_parcial_validate_observacao_

  function do_ajax_form_pagamento_parcial_validate_observacao__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagamento_parcial_validate_observacao__cb

  // ---------- Validate juros_
  function do_ajax_form_pagamento_parcial_validate_juros_(iNumLinha)
  {
    var nomeCampo_juros_ = "juros_" + iNumLinha;
    var var_juros_ = scAjaxGetFieldText(nomeCampo_juros_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagamento_parcial_validate_juros_(var_juros_, iNumLinha, var_script_case_init, do_ajax_form_pagamento_parcial_validate_juros__cb);
  } // do_ajax_form_pagamento_parcial_validate_juros_

  function do_ajax_form_pagamento_parcial_validate_juros__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "juros_" + iLineNumber;
    }
    else
    {
      sFieldValid = "juros_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "juros_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "juros_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagamento_parcial_validate_juros__cb

  // ---------- Validate idcontas_pagar_
  function do_ajax_form_pagamento_parcial_validate_idcontas_pagar_(iNumLinha)
  {
    var nomeCampo_idcontas_pagar_ = "idcontas_pagar_" + iNumLinha;
    var var_idcontas_pagar_ = scAjaxGetFieldText(nomeCampo_idcontas_pagar_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagamento_parcial_validate_idcontas_pagar_(var_idcontas_pagar_, iNumLinha, var_script_case_init, do_ajax_form_pagamento_parcial_validate_idcontas_pagar__cb);
  } // do_ajax_form_pagamento_parcial_validate_idcontas_pagar_

  function do_ajax_form_pagamento_parcial_validate_idcontas_pagar__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idcontas_pagar_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idcontas_pagar_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idcontas_pagar_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idcontas_pagar_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pagamento_parcial_validate_idcontas_pagar__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_pagamento_parcial_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_pagamento_parcial_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pagamento_parcial_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_pagamento_parcial_add_new_line_cb);
  } // do_ajax_form_pagamento_parcial_add_new_line

  function do_ajax_form_pagamento_parcial_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_pagamento_parcial_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_pagamento_parcial_backup_line(iNumLinha)
  {
    var var_idpagamento_parcial_ = scAjaxGetFieldHidden("idpagamento_parcial_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pagamento_parcial_backup_line(var_idpagamento_parcial_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_pagamento_parcial_backup_line_cb);
  } // do_ajax_form_pagamento_parcial_backup_line

  function do_ajax_form_pagamento_parcial_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_pagamento_parcial_backup_line_cb

  function do_ajax_form_pagamento_parcial_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_pagamento_parcial_cancel_insert

  function do_ajax_form_pagamento_parcial_cancel_update(iSeqVert)
  {
    do_ajax_form_pagamento_parcial_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_pagamento_parcial_cancel_update

  function do_ajax_form_pagamento_parcial_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_pagamento_parcial_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_pagamento_parcial_table_refresh()
  {
    var var_idpagamento_parcial_ = document.F2.idpagamento_parcial_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_pagamento_parcial_table_refresh(var_idpagamento_parcial_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pagamento_parcial_table_refresh_cb);
  } //  do_ajax_form_pagamento_parcial_table_refresh

  function do_ajax_form_pagamento_parcial_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idpagamento_parcial_.value = scAjaxGetKeyValue("idpagamento_parcial_");
    ...
    scAjaxAlert(do_ajax_form_pagamento_parcial_table_refresh_cb_after_alert);
  } // do_ajax_form_pagamento_parcial_table_refresh_cb
  function do_ajax_form_pagamento_parcial_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_pagamento_parcial_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_pagamento_parcial_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_pagamento_parcial_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idpagamento_parcial_ = scAjaxGetFieldHidden("idpagamento_parcial_" + iNumLinha);
    var var_idforma_pagamento_ = scAjaxGetFieldSelect("idforma_pagamento_" + iNumLinha);
    ...
    var var_juros_ = scAjaxGetFieldText("juros_" + iNumLinha);
    var var_idcontas_pagar_ = scAjaxGetFieldText("idcontas_pagar_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_pagamento_parcial_submit_form(var_idpagamento_parcial_, var_idforma_pagamento_, var_data_, var_valor_, var_observacao_, var_juros_, var_idcontas_pagar_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pagamento_parcial_submit_form_cb);
  } // do_ajax_form_pagamento_parcial_submit_form

  function do_ajax_form_pagamento_parcial_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idpagamento_parcial_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idforma_pagamento_" + sc_num_ult_line);
      ...
      scAjaxHideErrorDisplay("juros_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idcontas_pagar_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pagamento_parcial_submit_form_cb_after_alert);
  } // do_ajax_form_pagamento_parcial_submit_form_cb
  function do_ajax_form_pagamento_parcial_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pagamento_parcial_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_pagamento_parcial_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_pagamento_parcial_navigate_form, function() {});
    } else {
      perform_ajax_form_pagamento_parcial_navigate_form();
    }
  }

  function perform_ajax_form_pagamento_parcial_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_pagamento_parcial_cancel_insert(sc_form_pagamento_parcial_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idpagamento_parcial_" + iNavForm);
      scAjaxHideErrorDisplay("idforma_pagamento_" + iNavForm);
      scAjaxHideErrorDisplay("data_" + iNavForm);
      scAjaxHideErrorDisplay("valor_" + iNavForm);
      scAjaxHideErrorDisplay("observacao_" + iNavForm);
      scAjaxHideErrorDisplay("juros_" + iNavForm);
      scAjaxHideErrorDisplay("idcontas_pagar_" + iNavForm);
    }
    var var_idpagamento_parcial_ = document.F2.idpagamento_parcial_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_pagamento_parcial_navigate_form(var_idpagamento_parcial_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pagamento_parcial_navigate_form_cb);
  } // do_ajax_form_pagamento_parcial_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pagamento_parcial']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pagamento_parcial_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idpagamento_parcial_.value = scAjaxGetKeyValue("idpagamento_parcial_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pagamento_parcial_navigate_form_cb_after_alert);
  } // do_ajax_form_pagamento_parcial_navigate_form_cb
  function do_ajax_form_pagamento_parcial_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_pagamento_parcial_navigate_form_cb_after_alert

    function sc_form_pagamento_parcial_get_last_line_number()
    {
    ...
    } //sc_form_pagamento_parcial_get_last_line_number

  function sc_hide_form_pagamento_parcial_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idpagamento_parcial_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idforma_pagamento_" + iNumLinha;
    iTotCampos++;
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "juros_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idcontas_pagar_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idpagamento_parcial_" + iNumLinha] = {"label": "Idpagamento Parcial<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idforma_pagamento_" + iNumLinha] = {"label": "FORMA DE PAGAMENTO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["data_" + iNumLinha] = {"label": "DATA RECEBIMENTO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["valor_" + iNumLinha] = {"label": "VALOR RECEBIDO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["observacao_" + iNumLinha] = {"label": "OBSERVAÇÕES<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["juros_" + iNumLinha] = {"label": "JUROS<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idcontas_pagar_" + iNumLinha] = {"label": "Idcontas Pagar<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idpagamento_parcial_"][iNumLinha] = "idpagamento_parcial_" + iNumLinha;
    ajax_field_mult["idforma_pagamento_"][iNumLinha] = "idforma_pagamento_" + iNumLinha;
    ...
    ajax_field_mult["juros_"][iNumLinha] = "juros_" + iNumLinha;
    ajax_field_mult["idcontas_pagar_"][iNumLinha] = "idcontas_pagar_" + iNumLinha;
    ajax_field_id["idpagamento_parcial_" + iNumLinha] = new Array("hidden_field_label_idpagamento_parcial_", "hidden_field_data_idpagamento_parcial_" + iNumLinha);
    ajax_field_id["idforma_pagamento_" + iNumLinha] = new Array("hidden_field_label_idforma_pagamento_", "hidden_field_data_idforma_pagamento_" + iNumLinha);
    ...
    ajax_field_id["juros_" + iNumLinha] = new Array("hidden_field_label_juros_", "hidden_field_data_juros_" + iNumLinha);
    ajax_field_id["idcontas_pagar_" + iNumLinha] = new Array("hidden_field_label_idcontas_pagar_", "hidden_field_data_idcontas_pagar_" + iNumLinha);
    ajax_error_count["idpagamento_parcial_" + iNumLinha] = "off";
    ajax_error_count["idforma_pagamento_" + iNumLinha] = "off";
    ajax_error_count["data_" + iNumLinha] = "off";
    ajax_error_count["valor_" + iNumLinha] = "off";
    ajax_error_count["observacao_" + iNumLinha] = "off";
    ajax_error_count["juros_" + iNumLinha] = "off";
    ajax_error_count["idcontas_pagar_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idpagamento_parcial_" + iNumLinha] = "on";
    ajax_read_only["idforma_pagamento_" + iNumLinha] = "off";
    ajax_read_only["data_" + iNumLinha] = "off";
    ajax_read_only["valor_" + iNumLinha] = "off";
    ajax_read_only["observacao_" + iNumLinha] = "off";
    ajax_read_only["juros_" + iNumLinha] = "off";
    ajax_read_only["idcontas_pagar_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idpagamento_parcial_" + iNumLinha] = "on";
    ajax_read_only["idforma_pagamento_" + iNumLinha] = "on";
    ajax_read_only["data_" + iNumLinha] = "on";
    ajax_read_only["valor_" + iNumLinha] = "on";
    ajax_read_only["observacao_" + iNumLinha] = "on";
    ajax_read_only["juros_" + iNumLinha] = "on";
    ajax_read_only["idcontas_pagar_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idpagamento_parcial_" + iNumLinha] = null;
    ajax_error_list["idforma_pagamento_" + iNumLinha] = null;
    ajax_error_list["data_" + iNumLinha] = null;
    ajax_error_list["valor_" + iNumLinha] = null;
    ajax_error_list["observacao_" + iNumLinha] = null;
    ajax_error_list["juros_" + iNumLinha] = null;
    ajax_error_list["idcontas_pagar_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idpagamento_parcial_": new Array(),
    "idforma_pagamento_": new Array(),
    "data_": new Array(),
    "valor_": new Array(),
    "observacao_": new Array(),
    "juros_": new Array(),
    "idcontas_pagar_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idpagamento_parcial_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idpagamento_parcial_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idpagamento_parcial_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idpagamento_parcial_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idpagamento_parcial_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idforma_pagamento_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idforma_pagamento_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idforma_pagamento_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idforma_pagamento_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idforma_pagamento_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["juros_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["juros_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["juros_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["juros_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["juros_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idcontas_pagar_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idcontas_pagar_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idcontas_pagar_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idcontas_pagar_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idcontas_pagar_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idpagamento_parcial_'])) ? $this->nmgp_cmp_readonly['idpagamento_parcial_'] : 'on';
?>
    scAjaxFieldRead("idpagamento_parcial_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idforma_pagamento_'])) ? $this->nmgp_cmp_readonly['idforma_pagamento_'] : 'off';
?>
    scAjaxFieldRead("idforma_pagamento_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['juros_'])) ? $this->nmgp_cmp_readonly['juros_'] : 'off';
?>
    scAjaxFieldRead("juros_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idcontas_pagar_'])) ? $this->nmgp_cmp_readonly['idcontas_pagar_'] : 'off';
?>
    scAjaxFieldRead("idcontas_pagar_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idpagamento_parcial_" + iSeq, "on");
    scAjaxFieldRead("idforma_pagamento_" + iSeq, "on");
    scAjaxFieldRead("data_" + iSeq, "on");
    scAjaxFieldRead("valor_" + iSeq, "on");
    scAjaxFieldRead("observacao_" + iSeq, "on");
    scAjaxFieldRead("juros_" + iSeq, "on");
    scAjaxFieldRead("idcontas_pagar_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idpagamento_parcial_" + iRow] || "on" == ajax_error_count["idforma_pagamento_" + iRow] || "on" == ajax_error_count["data_" + iRow] || "on" == ajax_error_count["valor_" + iRow] || "on" == ajax_error_count["observacao_" + iRow] || "on" == ajax_error_count["juros_" + iRow] || "on" == ajax_error_count["idcontas_pagar_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idpagamento_parcial_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idforma_pagamento_" + iRow).addClass("scFormErrorLine");
      ...
      $("#hidden_field_data_juros_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idcontas_pagar_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idpagamento_parcial_" + iRow] && "off" == ajax_error_count["idforma_pagamento_" + iRow] && "off" == ajax_error_count["data_" + iRow] && "off" == ajax_error_count["valor_" + iRow] && "off" == ajax_error_count["observacao_" + iRow] && "off" == ajax_error_count["juros_" + iRow] && "off" == ajax_error_count["idcontas_pagar_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idpagamento_parcial_" + iRow] = "off";
        ajax_error_count["idforma_pagamento_" + iRow] = "off";
        ajax_error_count["data_" + iRow] = "off";
        ajax_error_count["valor_" + iRow] = "off";
        ajax_error_count["observacao_" + iRow] = "off";
        ajax_error_count["juros_" + iRow] = "off";
        ajax_error_count["idcontas_pagar_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idpagamento_parcial_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idforma_pagamento_" + iRow).removeClass("scFormErrorLine");
      ...
      $("#hidden_field_data_juros_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idcontas_pagar_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idpagamento_parcial_" == sIndex)
    {
