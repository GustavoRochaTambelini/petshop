...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_referencia_label" id="hidden_field_label_referencia" style="<?php echo $sStyleHidden_referencia; ?>"><span id="id_label_referencia"><?php echo $this->nm_new_label['referencia']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['referencia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['referencia'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
