...
?>
  ...
  // ---------- Validate idproduto
  function do_ajax_form_produto_validate_idproduto()
  {
    var nomeCampo_idproduto = "idproduto";
    var var_idproduto = scAjaxGetFieldHidden(nomeCampo_idproduto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_idproduto(var_idproduto, var_script_case_init, do_ajax_form_produto_validate_idproduto_cb);
  } // do_ajax_form_produto_validate_idproduto

  function do_ajax_form_produto_validate_idproduto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_validate_idproduto_cb

  // ---------- Validate referencia
  function do_ajax_form_produto_validate_referencia()
  {
    var nomeCampo_referencia = "referencia";
    var var_referencia = scAjaxGetFieldText(nomeCampo_referencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_referencia(var_referencia, var_script_case_init, do_ajax_form_produto_validate_referencia_cb);
  } // do_ajax_form_produto_validate_referencia

  function do_ajax_form_produto_validate_referencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_validate_referencia_cb

  // ---------- Validate codigo_de_barras
  function do_ajax_form_produto_validate_codigo_de_barras()
  {
    var nomeCampo_codigo_de_barras = "codigo_de_barras";
    var var_codigo_de_barras = scAjaxGetFieldText(nomeCampo_codigo_de_barras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_codigo_de_barras(var_codigo_de_barras, var_script_case_init, do_ajax_form_produto_validate_codigo_de_barras_cb);
  } // do_ajax_form_produto_validate_codigo_de_barras

  function do_ajax_form_produto_validate_codigo_de_barras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_validate_codigo_de_barras_cb
  ...
  // ---------- Validate valor
  function do_ajax_form_produto_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_valor(var_valor, var_script_case_init, do_ajax_form_produto_validate_valor_cb);
  } // do_ajax_form_produto_validate_valor

  function do_ajax_form_produto_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
  ...
  function do_ajax_form_produto_validate_estoque_minimo()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_estoque_minimo(var_estoque_minimo, var_script_case_init, do_ajax_form_produto_validate_estoque_minimo_cb);
  } // do_ajax_form_produto_validate_estoque_minimo

  function do_ajax_form_produto_validate_estoque_minimo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_validate_estoque_minimo_cb
  ...
  // ---------- Validate idgrupo
  function do_ajax_form_produto_validate_idgrupo()
  {
    var nomeCampo_idgrupo = "idgrupo";
    var var_idgrupo = scAjaxGetFieldSelect(nomeCampo_idgrupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_idgrupo(var_idgrupo, var_script_case_init, do_ajax_form_produto_validate_idgrupo_cb);
  } // do_ajax_form_produto_validate_idgrupo

  function do_ajax_form_produto_validate_idgrupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idgrupo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_validate_idgrupo_cb

  // ---------- Validate idsubgrupo
  function do_ajax_form_produto_validate_idsubgrupo()
  {
    var nomeCampo_idsubgrupo = "idsubgrupo";
    var var_idsubgrupo = scAjaxGetFieldSelect(nomeCampo_idsubgrupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_idsubgrupo(var_idsubgrupo, var_script_case_init, do_ajax_form_produto_validate_idsubgrupo_cb);
  } // do_ajax_form_produto_validate_idsubgrupo

  function do_ajax_form_produto_validate_idsubgrupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_validate_idsubgrupo_cb

  // ---------- Validate idmarca
  function do_ajax_form_produto_validate_idmarca()
  {
    var nomeCampo_idmarca = "idmarca";
    var var_idmarca = scAjaxGetFieldSelect(nomeCampo_idmarca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_idmarca(var_idmarca, var_script_case_init, do_ajax_form_produto_validate_idmarca_cb);
  } // do_ajax_form_produto_validate_idmarca

  function do_ajax_form_produto_validate_idmarca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idmarca";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_validate_idmarca_cb

  // ---------- Validate idunidade
  function do_ajax_form_produto_validate_idunidade()
  {
    var nomeCampo_idunidade = "idunidade";
    var var_idunidade = scAjaxGetFieldSelect(nomeCampo_idunidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_idunidade(var_idunidade, var_script_case_init, do_ajax_form_produto_validate_idunidade_cb);
  } // do_ajax_form_produto_validate_idunidade

  function do_ajax_form_produto_validate_idunidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_validate_idunidade_cb

  // ---------- Validate foto
  function do_ajax_form_produto_validate_foto()
  {
    var nomeCampo_foto = "foto";
    var var_foto = scAjaxGetFieldText(nomeCampo_foto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_validate_foto(var_foto, var_script_case_init, do_ajax_form_produto_validate_foto_cb);
  } // do_ajax_form_produto_validate_foto

  function do_ajax_form_produto_validate_foto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "foto";
...
?>
  ...
  function perform_ajax_form_produto_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_produto_navigate_form(var_idproduto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_produto_navigate_form_cb);
