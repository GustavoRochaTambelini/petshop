...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idproduto' + iSeqRow).bind('blur', function() { sc_form_produto_idproduto_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_produto_idproduto_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_idgrupo' + iSeqRow).bind('blur', function() { sc_form_produto_idgrupo_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_produto_idgrupo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_idsubgrupo' + iSeqRow).bind('blur', function() { sc_form_produto_idsubgrupo_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_produto_idsubgrupo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_idmarca' + iSeqRow).bind('blur', function() { sc_form_produto_idmarca_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_produto_idmarca_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_idunidade' + iSeqRow).bind('blur', function() { sc_form_produto_idunidade_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_produto_idunidade_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_referencia' + iSeqRow).bind('blur', function() { sc_form_produto_referencia_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_produto_referencia_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_codigo_de_barras' + iSeqRow).bind('blur', function() { sc_form_produto_codigo_de_barras_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_produto_codigo_de_barras_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_valor' + iSeqRow).bind('blur', function() { sc_form_produto_valor_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_produto_valor_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_estoque_minimo' + iSeqRow).bind('blur', function() { sc_form_produto_estoque_minimo_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_produto_estoque_minimo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_foto' + iSeqRow).bind('blur', function() { sc_form_produto_foto_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_produto_foto_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_produto_foto_onfocus(this, iSeqRow) });
  $('#id_sc_field_peso_liquido' + iSeqRow).bind('change', function() { sc_form_produto_peso_liquido_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_margem_lucro' + iSeqRow).bind('blur', function() { sc_form_produto_margem_lucro_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_produto_margem_lucro_onchange(this, iSeqRow) })
...
function sc_form_produto_idproduto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_produto_idgrupo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_produto_idsubgrupo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_produto_idmarca_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_produto_idunidade_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_produto_referencia_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_produto_codigo_de_barras_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_produto_valor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_produto_estoque_minimo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_produto_foto_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_produto_peso_liquido_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_produto_margem_lucro_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
