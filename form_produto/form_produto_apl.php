...
//----- 
   function ini_controle()
   {
      ...
      $_SESSION['sc_session'][$script_case_init]['form_produto']['upload_field_info']['foto'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_produto',
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_produto']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_produto']['label'] = "ALTERAR PRODUTO";
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['upload_field_ul_name'][$this->foto_ul_name]))
          {
              $this->NM_ajax_info['param']['foto_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['upload_field_ul_name'][$this->foto_ul_name];
          }
      ...
      elseif (isset($this->foto_ul_name) && '' != $this->foto_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['upload_field_ul_name'][$this->foto_ul_name]))
          {
              $this->foto_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['upload_field_ul_name'][$this->foto_ul_name];
          }
...
//---------------------------------------------------------
    ...
    function ValidateField_referencia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['referencia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['referencia'] == "on")) 
      { 
          if ($this->referencia == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_descricao(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['descricao']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['php_cmp_required']['descricao'] == "on")) 
      { 
          if ($this->descricao == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_custo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->custo, 13, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "CUSTO; " ; 
                  if (!isset($Campos_Erros['custo']))
    ...
    function ValidateField_estoque_minimo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->estoque_minimo, 13, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_idgrupo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idgrupo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Lookup_idgrupo']) && !in_array($this->idgrupo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Lookup_idgrupo']))
               {
                   $hasError = true;
    ...
    function ValidateField_idsubgrupo(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idsubgrupo) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Lookup_idsubgrupo']) && !in_array($this->idsubgrupo, $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Lookup_idsubgrupo']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idmarca(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idmarca) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Lookup_idmarca']) && !in_array($this->idmarca, $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Lookup_idmarca']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idunidade(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idunidade) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Lookup_idunidade']) && !in_array($this->idunidade, $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Lookup_idunidade']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
        ...
        if ($this->nmgp_opcao != "excluir")
        {
            ...
            if (!$hasError && "" != $this->foto && "S" != $this->foto_limpa) {
                if (!function_exists('sc_upload_unprotect_chars')) {
                    include_once 'form_produto_doc_name.php';
                }
   ...
   function upload_img_doc(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros, $filtro = '') 
   {
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['dados_form']['foto']) && $this->foto_limpa != "S")
          {
              $this->foto = $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['dados_form']['foto'];
          }
      } 
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idproduto']['keyVal'] = form_produto_pack_protect_string($this->nmgp_dados_form['idproduto']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_produto_pack_protect_string('PRODUTO') => str_replace('<', '&lt;',form_produto_pack_protect_string("PRODUTO")));
$aLookup[] = array(form_produto_pack_protect_string('SERVIÇO') => str_replace('<', '&lt;',form_produto_pack_protect_string("SERVIÇO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Lookup_tipo'][] = 'PRODUTO';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['Lookup_tipo'][] = 'SERVIÇO';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"tipo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['tipo']['valList'][$i] = form_produto_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idgrupo']['valList'][$i] = form_produto_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idsubgrupo']['valList'][$i] = form_produto_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idmarca']['valList'][$i] = form_produto_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idunidade']['valList'][$i] = form_produto_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
;
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_produto';
...
$_SESSION['scriptcase']['form_produto']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('idproduto', 'referencia', 'codigo_de_barras', 'descricao', 'custo', 'valor', 'estoque_minimo', 'tipo', 'idgrupo', 'idsubgrupo', 'idmarca', 'idunidade'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto']['parms'] = "idproduto?#?$this->idproduto?@?"; 
      }
