    ...
    function ValidateField_margem_lucro(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->margem_lucro, 12, 3, 0, 0, "N") == false)  
              { 
                  $hasError = true;
...
$_SESSION['scriptcase']['form_produto']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          { 
              ...
              $this->nmgp_refresh_fields = array_diff(array('idproduto', 'referencia', 'codigo_de_barras', 'descricao', 'custo', 'valor', 'margem_lucro', 'estoque_minimo', 'tipo', 'idgrupo', 'idsubgrupo', 'idmarca', 'idunidade'), $aDoNotUpdate);
              $this->ajax_return_values();
