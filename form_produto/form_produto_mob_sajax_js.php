...
?>
  ...
  // ---------- Validate idproduto
  function do_ajax_form_produto_mob_validate_idproduto()
  {
    var nomeCampo_idproduto = "idproduto";
    var var_idproduto = scAjaxGetFieldHidden(nomeCampo_idproduto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_idproduto(var_idproduto, var_script_case_init, do_ajax_form_produto_mob_validate_idproduto_cb);
  } // do_ajax_form_produto_mob_validate_idproduto

  function do_ajax_form_produto_mob_validate_idproduto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idproduto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_idproduto_cb

  // ---------- Validate referencia
  function do_ajax_form_produto_mob_validate_referencia()
  {
    var nomeCampo_referencia = "referencia";
    var var_referencia = scAjaxGetFieldText(nomeCampo_referencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_referencia(var_referencia, var_script_case_init, do_ajax_form_produto_mob_validate_referencia_cb);
  } // do_ajax_form_produto_mob_validate_referencia

  function do_ajax_form_produto_mob_validate_referencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_referencia_cb

  // ---------- Validate codigo_de_barras
  function do_ajax_form_produto_mob_validate_codigo_de_barras()
  {
    var nomeCampo_codigo_de_barras = "codigo_de_barras";
    var var_codigo_de_barras = scAjaxGetFieldText(nomeCampo_codigo_de_barras);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_codigo_de_barras(var_codigo_de_barras, var_script_case_init, do_ajax_form_produto_mob_validate_codigo_de_barras_cb);
  } // do_ajax_form_produto_mob_validate_codigo_de_barras

  function do_ajax_form_produto_mob_validate_codigo_de_barras_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "codigo_de_barras";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_codigo_de_barras_cb
  ...
  // ---------- Validate valor
  function do_ajax_form_produto_mob_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_valor(var_valor, var_script_case_init, do_ajax_form_produto_mob_validate_valor_cb);
  } // do_ajax_form_produto_mob_validate_valor

  function do_ajax_form_produto_mob_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_valor_cb

  // ---------- Validate margem_lucro
  function do_ajax_form_produto_mob_validate_margem_lucro()
  {
    var nomeCampo_margem_lucro = "margem_lucro";
    var var_margem_lucro = scAjaxGetFieldText(nomeCampo_margem_lucro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_margem_lucro(var_margem_lucro, var_script_case_init, do_ajax_form_produto_mob_validate_margem_lucro_cb);
  } // do_ajax_form_produto_mob_validate_margem_lucro

  function do_ajax_form_produto_mob_validate_margem_lucro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_margem_lucro_cb

  // ---------- Validate estoque_minimo
  function do_ajax_form_produto_mob_validate_estoque_minimo()
  {
    var nomeCampo_estoque_minimo = "estoque_minimo";
    var var_estoque_minimo = scAjaxGetFieldText(nomeCampo_estoque_minimo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_estoque_minimo(var_estoque_minimo, var_script_case_init, do_ajax_form_produto_mob_validate_estoque_minimo_cb);
  } // do_ajax_form_produto_mob_validate_estoque_minimo

  function do_ajax_form_produto_mob_validate_estoque_minimo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "estoque_minimo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_estoque_minimo_cb
  ...
  // ---------- Validate idgrupo
  function do_ajax_form_produto_mob_validate_idgrupo()
  {
    var nomeCampo_idgrupo = "idgrupo";
    var var_idgrupo = scAjaxGetFieldSelect(nomeCampo_idgrupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_idgrupo(var_idgrupo, var_script_case_init, do_ajax_form_produto_mob_validate_idgrupo_cb);
  } // do_ajax_form_produto_mob_validate_idgrupo

  function do_ajax_form_produto_mob_validate_idgrupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idgrupo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_idgrupo_cb

  // ---------- Validate idsubgrupo
  function do_ajax_form_produto_mob_validate_idsubgrupo()
  {
    var nomeCampo_idsubgrupo = "idsubgrupo";
    var var_idsubgrupo = scAjaxGetFieldSelect(nomeCampo_idsubgrupo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_idsubgrupo(var_idsubgrupo, var_script_case_init, do_ajax_form_produto_mob_validate_idsubgrupo_cb);
  } // do_ajax_form_produto_mob_validate_idsubgrupo

  function do_ajax_form_produto_mob_validate_idsubgrupo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idsubgrupo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_idsubgrupo_cb

  // ---------- Validate idmarca
  function do_ajax_form_produto_mob_validate_idmarca()
  {
    var nomeCampo_idmarca = "idmarca";
    var var_idmarca = scAjaxGetFieldSelect(nomeCampo_idmarca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_idmarca(var_idmarca, var_script_case_init, do_ajax_form_produto_mob_validate_idmarca_cb);
  } // do_ajax_form_produto_mob_validate_idmarca

  function do_ajax_form_produto_mob_validate_idmarca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idmarca";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_idmarca_cb

  // ---------- Validate idunidade
  function do_ajax_form_produto_mob_validate_idunidade()
  {
    var nomeCampo_idunidade = "idunidade";
    var var_idunidade = scAjaxGetFieldSelect(nomeCampo_idunidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_idunidade(var_idunidade, var_script_case_init, do_ajax_form_produto_mob_validate_idunidade_cb);
  } // do_ajax_form_produto_mob_validate_idunidade

  function do_ajax_form_produto_mob_validate_idunidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idunidade";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_idunidade_cb

  // ---------- Validate foto
  function do_ajax_form_produto_mob_validate_foto()
  {
    var nomeCampo_foto = "foto";
    var var_foto = scAjaxGetFieldText(nomeCampo_foto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_produto_mob_validate_foto(var_foto, var_script_case_init, do_ajax_form_produto_mob_validate_foto_cb);
  } // do_ajax_form_produto_mob_validate_foto

  function do_ajax_form_produto_mob_validate_foto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "foto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_produto_mob_validate_foto_cb

  // ---------- Event onblur custo
  function do_ajax_form_produto_mob_event_custo_onblur()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_produto_mob_event_custo_onblur(var_valor, var_custo, var_margem_lucro, var_script_case_init, do_ajax_form_produto_mob_event_custo_onblur_cb);
  } // do_ajax_form_produto_mob_event_custo_onblur

  function do_ajax_form_produto_mob_event_custo_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "custo";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_produto_mob_event_custo_onblur_cb_after_alert);
  } // do_ajax_form_produto_mob_event_custo_onblur_cb
  function do_ajax_form_produto_mob_event_custo_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_produto_mob_event_custo_onblur_cb_after_alert

  // ---------- Event onblur valor
  function do_ajax_form_produto_mob_event_valor_onblur()
  {
    var var_valor = scAjaxGetFieldText("valor");
    var var_custo = scAjaxGetFieldText("custo");
    var var_margem_lucro = scAjaxGetFieldText("margem_lucro");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_produto_mob_event_valor_onblur(var_valor, var_custo, var_margem_lucro, var_script_case_init, do_ajax_form_produto_mob_event_valor_onblur_cb);
  } // do_ajax_form_produto_mob_event_valor_onblur

  function do_ajax_form_produto_mob_event_valor_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "valor";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_produto_mob_event_valor_onblur_cb_after_alert);
  } // do_ajax_form_produto_mob_event_valor_onblur_cb
  function do_ajax_form_produto_mob_event_valor_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_produto_mob_event_valor_onblur_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_produto_mob_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_idproduto = scAjaxGetFieldHidden("idproduto");
    var var_referencia = scAjaxGetFieldText("referencia");
    var var_codigo_de_barras = scAjaxGetFieldText("codigo_de_barras");
    ...
    var var_idsubgrupo = scAjaxGetFieldSelect("idsubgrupo");
    var var_idmarca = scAjaxGetFieldSelect("idmarca");
    var var_idunidade = scAjaxGetFieldSelect("idunidade");
    ...
    scAjaxProcOn();
    x_ajax_form_produto_mob_submit_form(var_idproduto, var_referencia, var_codigo_de_barras, var_descricao, var_custo, var_valor, var_margem_lucro, var_estoque_minimo, var_tipo, var_idgrupo, var_idsubgrupo, var_idmarca, var_idunidade, var_foto, var_foto_ul_name, var_foto_ul_type, var_foto_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_produto_mob_submit_form_cb);
  ...
  function do_ajax_form_produto_mob_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idproduto");
      scAjaxHideErrorDisplay("referencia");
      scAjaxHideErrorDisplay("codigo_de_barras");
      ...
      scAjaxHideErrorDisplay("idsubgrupo");
      scAjaxHideErrorDisplay("idmarca");
      scAjaxHideErrorDisplay("idunidade");
...
?>
  ...
  function perform_ajax_form_produto_mob_navigate_form()
  {
    ...
    scAjaxHideErrorDisplay("idunidade");
    scAjaxHideErrorDisplay("foto");
    var var_idproduto = document.F2.idproduto.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_produto_mob_navigate_form(var_idproduto, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_produto_mob_navigate_form_cb);
...
?>
  ...
  ajax_field_list[0] = "idproduto";
  ajax_field_list[1] = "referencia";
  ajax_field_list[2] = "codigo_de_barras";
  ...
  var ajax_error_list = {
    "idproduto": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "codigo_de_barras": {"label": "CODIGO DE BARRAS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "idsubgrupo": {"label": "SUBGRUPO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idmarca": {"label": "MARCA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idunidade": {"label": "UNIDADE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "tipo": new Array(),
    "idgrupo": new Array(),
    "idsubgrupo": new Array(),
    "idmarca": new Array(),
    "idunidade": new Array(),
    "foto": new Array()
  };
  ajax_field_mult["idproduto"][1] = "idproduto";
  ajax_field_mult["referencia"][1] = "referencia";
  ajax_field_mult["codigo_de_barras"][1] = "codigo_de_barras";
  ...
  ajax_field_mult["idsubgrupo"][1] = "idsubgrupo";
  ajax_field_mult["idmarca"][1] = "idmarca";
  ajax_field_mult["idunidade"][1] = "idunidade";
  ajax_field_mult["foto"][1] = "foto";

  var ajax_field_id = {
    "idproduto": new Array("hidden_field_label_idproduto", "hidden_field_data_idproduto"),
    "referencia": new Array("hidden_field_label_referencia", "hidden_field_data_referencia"),
    "codigo_de_barras": new Array("hidden_field_label_codigo_de_barras", "hidden_field_data_codigo_de_barras"),
    ...
    "idsubgrupo": new Array("hidden_field_label_idsubgrupo", "hidden_field_data_idsubgrupo"),
    "idmarca": new Array("hidden_field_label_idmarca", "hidden_field_data_idmarca"),
    "idunidade": new Array("hidden_field_label_idunidade", "hidden_field_data_idunidade"),
