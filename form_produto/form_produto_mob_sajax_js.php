...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_produto_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_produto_mob_submit_form(var_idproduto, var_referencia, var_codigo_de_barras, var_descricao, var_custo, var_valor, var_estoque_minimo, var_tipo, var_idgrupo, var_idsubgrupo, var_idmarca, var_idunidade, var_foto, var_foto_ul_name, var_foto_ul_type, var_foto_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_produto_mob_submit_form_cb);
