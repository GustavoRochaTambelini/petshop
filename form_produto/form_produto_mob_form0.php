...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_codigo_de_barras_line" id="hidden_field_data_codigo_de_barras" style="<?php echo $sStyleHidden_codigo_de_barras; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_codigo_de_barras_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_codigo_de_barras_label" style=""><span id="id_label_codigo_de_barras"><?php echo $this->nm_new_label['codigo_de_barras']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_custo_line" id="hidden_field_data_custo" style="<?php echo $sStyleHidden_custo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_custo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_custo_label" style=""><span id="id_label_custo"><?php echo $this->nm_new_label['custo']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_estoque_minimo_line" id="hidden_field_data_estoque_minimo" style="<?php echo $sStyleHidden_estoque_minimo; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_estoque_minimo_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_estoque_minimo_label" style=""><span id="id_label_estoque_minimo"><?php echo $this->nm_new_label['estoque_minimo']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['Lookup_tipo'][] = 'PRODUTO'; ?>
 <option  value="SERVIÇO" <?php  if ($this->tipo == "SERVIÇO") { echo " selected" ;} ?>>SERVIÇO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_produto_mob']['Lookup_tipo'][] = 'SERVIÇO'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idmarca_line" id="hidden_field_data_idmarca" style="<?php echo $sStyleHidden_idmarca; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idmarca_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idmarca_label" style=""><span id="id_label_idmarca"><?php echo $this->nm_new_label['idmarca']; ?></span></span><br>
...
<?php $sStyleHidden_idunidade_dumb = ('' == $sStyleHidden_idunidade) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_idunidade_dumb" style="<?php echo $sStyleHidden_idunidade_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_foto_line" id="hidden_field_data_foto" style="<?php echo $sStyleHidden_foto; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_foto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_foto_label" style=""><span id="id_label_foto"><?php echo $this->nm_new_label['foto']; ?></span></span><br>
