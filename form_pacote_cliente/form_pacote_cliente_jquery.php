...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idpacote_cliente' + iSeqRow).bind('blur', function() { sc_form_pacote_cliente_idpacote_cliente_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_pacote_cliente_idpacote_cliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_idcliente' + iSeqRow).bind('blur', function() { sc_form_pacote_cliente_idcliente_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_pacote_cliente_idcliente_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_quantidade_total' + iSeqRow).bind('blur', function() { sc_form_pacote_cliente_quantidade_total_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_pacote_cliente_quantidade_total_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_qunatidade_realizada' + iSeqRow).bind('blur', function() { sc_form_pacote_cliente_qunatidade_realizada_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_pacote_cliente_qunatidade_realizada_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_valor_total' + iSeqRow).bind('blur', function() { sc_form_pacote_cliente_valor_total_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_pacote_cliente_valor_total_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_pago' + iSeqRow).bind('blur', function() { sc_form_pacote_cliente_pago_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_pacote_cliente_pago_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_itens_pacote' + iSeqRow).bind('blur', function() { sc_form_pacote_cliente_itens_pacote_onblur(this, iSeqRow) })
                                          .bind('change', function() { sc_form_pacote_cliente_itens_pacote_onchange(this, iSeqRow) })
...
function sc_form_pacote_cliente_idpacote_cliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pacote_cliente_idcliente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pacote_cliente_quantidade_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pacote_cliente_qunatidade_realizada_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pacote_cliente_valor_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pacote_cliente_pago_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_pacote_cliente_itens_pacote_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_pacote_cliente_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_pacote_cliente')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
