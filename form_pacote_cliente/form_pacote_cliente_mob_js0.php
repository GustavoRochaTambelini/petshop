<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="idpacote_cliente" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idpacote_cliente']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pacote_cliente_mob']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_pacote_cliente_mob']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_pacote_cliente_mob"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_pdv()
{
    if (scEventControl_active("")) {
      setTimeout(function() { sc_btn_pdv(); }, 500);
      return;
    }
    sc_btn_pdv_ok();
}
function sc_btn_pdv_cancel()
{
}
function sc_btn_pdv_ok()
{
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pacote_cliente_mob']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("qunatidade_realizada=disabled", "I");
   nm_field_disabled("idcliente=disabled;idpacote=disabled;valor_total=disabled;pago=disabled", "U");
