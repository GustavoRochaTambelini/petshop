  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pacote_cliente" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pacote_cliente_form();
	}
...
?>
  ...
  function do_ajax_form_pacote_cliente_validate_idpacote_cliente()
  {
    ...
    x_ajax_form_pacote_cliente_validate_idpacote_cliente(var_idpacote_cliente, var_script_case_init, do_ajax_form_pacote_cliente_validate_idpacote_cliente_cb);
  } // do_ajax_form_pacote_cliente_validate_idpacote_cliente

  function do_ajax_form_pacote_cliente_validate_idpacote_cliente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_validate_idpacote_cliente_cb

  // ---------- Validate idcliente
  function do_ajax_form_pacote_cliente_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_pacote_cliente_validate_idcliente_cb);
  } // do_ajax_form_pacote_cliente_validate_idcliente

  function do_ajax_form_pacote_cliente_validate_idcliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_validate_idcliente_cb

  // ---------- Validate idpacote
  function do_ajax_form_pacote_cliente_validate_idpacote()
  {
    var nomeCampo_idpacote = "idpacote";
    var var_idpacote = scAjaxGetFieldSelect(nomeCampo_idpacote);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_validate_idpacote(var_idpacote, var_script_case_init, do_ajax_form_pacote_cliente_validate_idpacote_cb);
  } // do_ajax_form_pacote_cliente_validate_idpacote

  function do_ajax_form_pacote_cliente_validate_idpacote_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_validate_idpacote_cb

  // ---------- Validate quantidade_total
  function do_ajax_form_pacote_cliente_validate_quantidade_total()
  {
    var nomeCampo_quantidade_total = "quantidade_total";
    var var_quantidade_total = scAjaxGetFieldText(nomeCampo_quantidade_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_validate_quantidade_total(var_quantidade_total, var_script_case_init, do_ajax_form_pacote_cliente_validate_quantidade_total_cb);
  } // do_ajax_form_pacote_cliente_validate_quantidade_total

  function do_ajax_form_pacote_cliente_validate_quantidade_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_validate_quantidade_total_cb

  // ---------- Validate valor_total
  function do_ajax_form_pacote_cliente_validate_valor_total()
  {
    var nomeCampo_valor_total = "valor_total";
    var var_valor_total = scAjaxGetFieldText(nomeCampo_valor_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_validate_valor_total(var_valor_total, var_script_case_init, do_ajax_form_pacote_cliente_validate_valor_total_cb);
  } // do_ajax_form_pacote_cliente_validate_valor_total

  function do_ajax_form_pacote_cliente_validate_valor_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_validate_valor_total_cb

  // ---------- Validate pago
  function do_ajax_form_pacote_cliente_validate_pago()
  {
    var nomeCampo_pago = "pago";
    var var_pago = scAjaxGetFieldSelect(nomeCampo_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_validate_pago(var_pago, var_script_case_init, do_ajax_form_pacote_cliente_validate_pago_cb);
  } // do_ajax_form_pacote_cliente_validate_pago

  function do_ajax_form_pacote_cliente_validate_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_validate_pago_cb

  // ---------- Validate qunatidade_realizada
  function do_ajax_form_pacote_cliente_validate_qunatidade_realizada()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_validate_qunatidade_realizada(var_qunatidade_realizada, var_script_case_init, do_ajax_form_pacote_cliente_validate_qunatidade_realizada_cb);
  } // do_ajax_form_pacote_cliente_validate_qunatidade_realizada

  function do_ajax_form_pacote_cliente_validate_qunatidade_realizada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_validate_qunatidade_realizada_cb

  // ---------- Validate itens_pacote
  function do_ajax_form_pacote_cliente_validate_itens_pacote()
  {
    var nomeCampo_itens_pacote = "itens_pacote";
    var var_itens_pacote = scAjaxGetFieldText(nomeCampo_itens_pacote);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_validate_itens_pacote(var_itens_pacote, var_script_case_init, do_ajax_form_pacote_cliente_validate_itens_pacote_cb);
  } // do_ajax_form_pacote_cliente_validate_itens_pacote

  function do_ajax_form_pacote_cliente_validate_itens_pacote_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_validate_itens_pacote_cb

  // ---------- Event onchange idpacote
  function do_ajax_form_pacote_cliente_event_idpacote_onchange()
  {
    var var_idpacote = scAjaxGetFieldSelect("idpacote");
    var var_valor_total = scAjaxGetFieldText("valor_total");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pacote_cliente_event_idpacote_onchange(var_idpacote, var_valor_total, var_script_case_init, do_ajax_form_pacote_cliente_event_idpacote_onchange_cb);
  } // do_ajax_form_pacote_cliente_event_idpacote_onchange

  function do_ajax_form_pacote_cliente_event_idpacote_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idpacote";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pacote_cliente_event_idpacote_onchange_cb_after_alert);
  } // do_ajax_form_pacote_cliente_event_idpacote_onchange_cb
  function do_ajax_form_pacote_cliente_event_idpacote_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pacote_cliente_event_idpacote_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_pdv
  function do_ajax_form_pacote_cliente_event_scajaxbutton_pdv_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pacote_cliente_event_scajaxbutton_pdv_onclick(var_idpacote_cliente, var_quantidade_total, var_qunatidade_realizada, var_idcliente, var_script_case_init, do_ajax_form_pacote_cliente_event_scajaxbutton_pdv_onclick_cb);
  } // do_ajax_form_pacote_cliente_event_scajaxbutton_pdv_onclick

  function do_ajax_form_pacote_cliente_event_scajaxbutton_pdv_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pacote_cliente_event_scajaxbutton_pdv_onclick_cb_after_alert);
  } // do_ajax_form_pacote_cliente_event_scajaxbutton_pdv_onclick_cb
  function do_ajax_form_pacote_cliente_event_scajaxbutton_pdv_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pacote_cliente_event_scajaxbutton_pdv_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pacote_cliente_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pacote_cliente_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpacote_cliente = scAjaxGetFieldHidden("idpacote_cliente");
    ...
    scAjaxProcOn();
    x_ajax_form_pacote_cliente_submit_form(var_idpacote_cliente, var_idcliente, var_idpacote, var_quantidade_total, var_valor_total, var_pago, var_qunatidade_realizada, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pacote_cliente_submit_form_cb);
  } // do_ajax_form_pacote_cliente_submit_form

  function do_ajax_form_pacote_cliente_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pacote_cliente_submit_form_cb_after_alert);
  } // do_ajax_form_pacote_cliente_submit_form_cb
  function do_ajax_form_pacote_cliente_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pacote_cliente_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_pacote_itens"] = "off";

  function do_ajax_form_pacote_cliente_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_pacote_cliente_navigate_form, function() {});
    } else {
      perform_ajax_form_pacote_cliente_navigate_form();
    }
  }

  function perform_ajax_form_pacote_cliente_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_pacote_cliente_navigate_form(var_idpacote_cliente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pacote_cliente_navigate_form_cb);
  } // do_ajax_form_pacote_cliente_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pacote_cliente']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pacote_cliente_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pacote_cliente_navigate_form_cb_after_alert);
  } // do_ajax_form_pacote_cliente_navigate_form_cb
  function do_ajax_form_pacote_cliente_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_pacote_cliente_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_pacote_cliente_navigate_form_cb_after_alert

  function sc_hide_form_pacote_cliente_form()
  {
