  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pacote_cliente_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pacote_cliente_mob_form();
	}
...
?>
  ...
  // ---------- Validate idpacote_cliente
  function do_ajax_form_pacote_cliente_mob_validate_idpacote_cliente()
  {
    var nomeCampo_idpacote_cliente = "idpacote_cliente";
    var var_idpacote_cliente = scAjaxGetFieldHidden(nomeCampo_idpacote_cliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_mob_validate_idpacote_cliente(var_idpacote_cliente, var_script_case_init, do_ajax_form_pacote_cliente_mob_validate_idpacote_cliente_cb);
  } // do_ajax_form_pacote_cliente_mob_validate_idpacote_cliente

  function do_ajax_form_pacote_cliente_mob_validate_idpacote_cliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpacote_cliente";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_mob_validate_idpacote_cliente_cb

  // ---------- Validate idcliente
  function do_ajax_form_pacote_cliente_mob_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_mob_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_pacote_cliente_mob_validate_idcliente_cb);
  } // do_ajax_form_pacote_cliente_mob_validate_idcliente

  function do_ajax_form_pacote_cliente_mob_validate_idcliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_mob_validate_idcliente_cb

  // ---------- Validate idpacote
  function do_ajax_form_pacote_cliente_mob_validate_idpacote()
  {
    var nomeCampo_idpacote = "idpacote";
    var var_idpacote = scAjaxGetFieldSelect(nomeCampo_idpacote);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_mob_validate_idpacote(var_idpacote, var_script_case_init, do_ajax_form_pacote_cliente_mob_validate_idpacote_cb);
  } // do_ajax_form_pacote_cliente_mob_validate_idpacote

  function do_ajax_form_pacote_cliente_mob_validate_idpacote_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpacote";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_mob_validate_idpacote_cb

  // ---------- Validate quantidade_total
  function do_ajax_form_pacote_cliente_mob_validate_quantidade_total()
  {
    var nomeCampo_quantidade_total = "quantidade_total";
    var var_quantidade_total = scAjaxGetFieldText(nomeCampo_quantidade_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_mob_validate_quantidade_total(var_quantidade_total, var_script_case_init, do_ajax_form_pacote_cliente_mob_validate_quantidade_total_cb);
  } // do_ajax_form_pacote_cliente_mob_validate_quantidade_total

  function do_ajax_form_pacote_cliente_mob_validate_quantidade_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "quantidade_total";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_mob_validate_quantidade_total_cb

  // ---------- Validate valor_total
  function do_ajax_form_pacote_cliente_mob_validate_valor_total()
  {
    var nomeCampo_valor_total = "valor_total";
    var var_valor_total = scAjaxGetFieldText(nomeCampo_valor_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_mob_validate_valor_total(var_valor_total, var_script_case_init, do_ajax_form_pacote_cliente_mob_validate_valor_total_cb);
  } // do_ajax_form_pacote_cliente_mob_validate_valor_total

  function do_ajax_form_pacote_cliente_mob_validate_valor_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_mob_validate_valor_total_cb

  // ---------- Validate pago
  function do_ajax_form_pacote_cliente_mob_validate_pago()
  {
    var nomeCampo_pago = "pago";
    var var_pago = scAjaxGetFieldSelect(nomeCampo_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_mob_validate_pago(var_pago, var_script_case_init, do_ajax_form_pacote_cliente_mob_validate_pago_cb);
  } // do_ajax_form_pacote_cliente_mob_validate_pago

  function do_ajax_form_pacote_cliente_mob_validate_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_mob_validate_pago_cb

  // ---------- Validate qunatidade_realizada
  function do_ajax_form_pacote_cliente_mob_validate_qunatidade_realizada()
  {
    var nomeCampo_qunatidade_realizada = "qunatidade_realizada";
    var var_qunatidade_realizada = scAjaxGetFieldRadio(nomeCampo_qunatidade_realizada);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_mob_validate_qunatidade_realizada(var_qunatidade_realizada, var_script_case_init, do_ajax_form_pacote_cliente_mob_validate_qunatidade_realizada_cb);
  } // do_ajax_form_pacote_cliente_mob_validate_qunatidade_realizada

  function do_ajax_form_pacote_cliente_mob_validate_qunatidade_realizada_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "qunatidade_realizada";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_mob_validate_qunatidade_realizada_cb

  // ---------- Validate itens_pacote
  function do_ajax_form_pacote_cliente_mob_validate_itens_pacote()
  {
    var nomeCampo_itens_pacote = "itens_pacote";
    var var_itens_pacote = scAjaxGetFieldText(nomeCampo_itens_pacote);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_cliente_mob_validate_itens_pacote(var_itens_pacote, var_script_case_init, do_ajax_form_pacote_cliente_mob_validate_itens_pacote_cb);
  } // do_ajax_form_pacote_cliente_mob_validate_itens_pacote

  function do_ajax_form_pacote_cliente_mob_validate_itens_pacote_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "itens_pacote";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_cliente_mob_validate_itens_pacote_cb

  // ---------- Event onchange idpacote
  function do_ajax_form_pacote_cliente_mob_event_idpacote_onchange()
  {
    var var_idpacote = scAjaxGetFieldSelect("idpacote");
    var var_valor_total = scAjaxGetFieldText("valor_total");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pacote_cliente_mob_event_idpacote_onchange(var_idpacote, var_valor_total, var_script_case_init, do_ajax_form_pacote_cliente_mob_event_idpacote_onchange_cb);
  } // do_ajax_form_pacote_cliente_mob_event_idpacote_onchange

  function do_ajax_form_pacote_cliente_mob_event_idpacote_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "idpacote";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pacote_cliente_mob_event_idpacote_onchange_cb_after_alert);
  } // do_ajax_form_pacote_cliente_mob_event_idpacote_onchange_cb
  function do_ajax_form_pacote_cliente_mob_event_idpacote_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pacote_cliente_mob_event_idpacote_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_pdv
  function do_ajax_form_pacote_cliente_mob_event_scajaxbutton_pdv_onclick()
  {
    var var_idpacote_cliente = scAjaxGetFieldHidden("idpacote_cliente");
    var var_quantidade_total = scAjaxGetFieldText("quantidade_total");
    var var_qunatidade_realizada = scAjaxGetFieldRadio("qunatidade_realizada");
    var var_idcliente = scAjaxGetFieldSelect("idcliente");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pacote_cliente_mob_event_scajaxbutton_pdv_onclick(var_idpacote_cliente, var_quantidade_total, var_qunatidade_realizada, var_idcliente, var_script_case_init, do_ajax_form_pacote_cliente_mob_event_scajaxbutton_pdv_onclick_cb);
  } // do_ajax_form_pacote_cliente_mob_event_scajaxbutton_pdv_onclick

  function do_ajax_form_pacote_cliente_mob_event_scajaxbutton_pdv_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "scajaxbutton_pdv";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pacote_cliente_mob_event_scajaxbutton_pdv_onclick_cb_after_alert);
  } // do_ajax_form_pacote_cliente_mob_event_scajaxbutton_pdv_onclick_cb
  function do_ajax_form_pacote_cliente_mob_event_scajaxbutton_pdv_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_pacote_cliente_mob_event_scajaxbutton_pdv_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pacote_cliente_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pacote_cliente_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idpacote_cliente = scAjaxGetFieldHidden("idpacote_cliente");
    ...
    scAjaxProcOn();
    x_ajax_form_pacote_cliente_mob_submit_form(var_idpacote_cliente, var_idcliente, var_idpacote, var_quantidade_total, var_valor_total, var_pago, var_qunatidade_realizada, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pacote_cliente_mob_submit_form_cb);
  } // do_ajax_form_pacote_cliente_mob_submit_form

  function do_ajax_form_pacote_cliente_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idpacote_cliente");
      scAjaxHideErrorDisplay("idcliente");
      scAjaxHideErrorDisplay("idpacote");
      scAjaxHideErrorDisplay("quantidade_total");
      scAjaxHideErrorDisplay("valor_total");
      scAjaxHideErrorDisplay("pago");
      scAjaxHideErrorDisplay("qunatidade_realizada");
      scAjaxHideErrorDisplay("itens_pacote");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pacote_cliente_mob_submit_form_cb_after_alert);
  } // do_ajax_form_pacote_cliente_mob_submit_form_cb
  function do_ajax_form_pacote_cliente_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pacote_cliente_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_pacote_itens"] = "off";

  function do_ajax_form_pacote_cliente_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_pacote_cliente_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_pacote_cliente_mob_navigate_form();
    }
  }

  function perform_ajax_form_pacote_cliente_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("qunatidade_realizada");
    scAjaxHideErrorDisplay("itens_pacote");
    var var_idpacote_cliente = document.F2.idpacote_cliente.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["grid_pacote_itens"] = "on";
    x_ajax_form_pacote_cliente_mob_navigate_form(var_idpacote_cliente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pacote_cliente_mob_navigate_form_cb);
  } // do_ajax_form_pacote_cliente_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pacote_cliente_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pacote_cliente_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idpacote_cliente.value = scAjaxGetKeyValue("idpacote_cliente");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_pacote_itens"] && "nmsc_iframe_liga_grid_pacote_itens" != scMasterDetailIframe["nmsc_iframe_liga_grid_pacote_itens"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_pacote_itens"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_pacote_itens').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pacote_cliente_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_pacote_cliente_mob_navigate_form_cb
  function do_ajax_form_pacote_cliente_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_pacote_cliente_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_pacote_cliente_mob_navigate_form_cb_after_alert

  function sc_hide_form_pacote_cliente_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_pacote_itens"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "idpacote_cliente";
  ajax_field_list[1] = "idcliente";
  ajax_field_list[2] = "idpacote";
  ajax_field_list[3] = "quantidade_total";
  ajax_field_list[4] = "valor_total";
  ajax_field_list[5] = "pago";
  ajax_field_list[6] = "qunatidade_realizada";
  ajax_field_list[7] = "itens_pacote";
  ...
  var ajax_error_list = {
    "idpacote_cliente": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "idpacote": {"label": "PACOTE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "quantidade_total": {"label": "QUANTIDADE TOTAL", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "pago": {"label": "PAGAMENTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "qunatidade_realizada": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "itens_pacote": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "idpacote_cliente": new Array(),
    "idcliente": new Array(),
    "idpacote": new Array(),
    "quantidade_total": new Array(),
    "valor_total": new Array(),
    "pago": new Array(),
    "qunatidade_realizada": new Array(),
    "itens_pacote": new Array()
  };
  ajax_field_mult["idpacote_cliente"][1] = "idpacote_cliente";
  ajax_field_mult["idcliente"][1] = "idcliente";
  ajax_field_mult["idpacote"][1] = "idpacote";
  ajax_field_mult["quantidade_total"][1] = "quantidade_total";
  ajax_field_mult["valor_total"][1] = "valor_total";
  ajax_field_mult["pago"][1] = "pago";
  ajax_field_mult["qunatidade_realizada"][1] = "qunatidade_realizada";
  ajax_field_mult["itens_pacote"][1] = "itens_pacote";

  var ajax_field_id = {
    "idpacote_cliente": new Array("hidden_field_label_idpacote_cliente", "hidden_field_data_idpacote_cliente"),
    "idcliente": new Array("hidden_field_label_idcliente", "hidden_field_data_idcliente"),
    "idpacote": new Array("hidden_field_label_idpacote", "hidden_field_data_idpacote"),
    "quantidade_total": new Array("hidden_field_label_quantidade_total", "hidden_field_data_quantidade_total"),
    ...
    "qunatidade_realizada": new Array("hidden_field_label_qunatidade_realizada", "hidden_field_data_qunatidade_realizada"),
    "itens_pacote": new Array("hidden_field_label_itens_pacote", "hidden_field_data_itens_pacote")
  };
  ...
  var ajax_read_only = {
    ...
    "idcliente": "off",
    "idpacote": "off",
    "quantidade_total": "off",
    "valor_total": "off",
    "pago": "off",
    "qunatidade_realizada": "off",
    "itens_pacote": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("qunatidade_realizada" == sIndex)
    {
