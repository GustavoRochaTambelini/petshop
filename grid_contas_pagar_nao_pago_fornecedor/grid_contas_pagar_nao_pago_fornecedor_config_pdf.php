...
*/
    ...
    $SC_cod_proj = "petshop";
    $SC_apl_proc = "grid_contas_pagar_nao_pago_fornecedor";
    $SC_ver_93   = true;
...
// Charts
        ...
        $isMultiSeriesChart = $is_chart_app && (!isset($_SESSION['sc_session'][$script_case_init]['grid_contas_pagar_nao_pago_fornecedor']['summarizing_drill_down']) || !$_SESSION['sc_session'][$script_case_init]['grid_contas_pagar_nao_pago_fornecedor']['summarizing_drill_down']);
        $isAnalitic         = isset($_SESSION['sc_session'][$script_case_init]['grid_contas_pagar_nao_pago_fornecedor']['graf_opc_atual']) && 2 == $_SESSION['sc_session'][$script_case_init]['grid_contas_pagar_nao_pago_fornecedor']['graf_opc_atual'];

if ($ver_93 == "n")
{
          $sDisplay = !isset($_SESSION['sc_session']['grid_contas_pagar_nao_pago_fornecedor']['show_skip_charts_option']) ||
                     !$_SESSION['sc_session']['grid_contas_pagar_nao_pago_fornecedor']['show_skip_charts_option'] ||
                     (isset($_SESSION['sc_session'][$script_case_init]['grid_contas_pagar_nao_pago_fornecedor']['SC_Ind_Groupby']) && '_NM_SC_' == $_SESSION['sc_session'][$script_case_init]['grid_contas_pagar_nao_pago_fornecedor']['SC_Ind_Groupby']) ||
                     $isMultiSeriesChart ||
                     $isAnalitic ||
                     ($opc == 'pdf_det')
                     ? ' style="display: none"' : '';
...
<?php
        ...
        {
         $sDisplay =
//                    !isset($_SESSION['sc_session']['grid_contas_pagar_nao_pago_fornecedor']['show_skip_charts_option']) ||
//                    !$_SESSION['sc_session']['grid_contas_pagar_nao_pago_fornecedor']['show_skip_charts_option'] ||
                    $isMultiSeriesChart ||
                    $isAnalitic ||
