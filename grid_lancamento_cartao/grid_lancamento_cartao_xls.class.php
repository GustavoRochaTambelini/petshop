...
class grid_lancamento_cartao_xls
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_lancamento_cartao/grid_lancamento_cartao_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
          { 
              require_once($this->Ini->path_aplicacao . "grid_lancamento_cartao_res_xls.class.php");
              $this->Res_xls = new grid_lancamento_cartao_res_xls();
              $this->prep_modulos("Res_xls");
          } 
          $this->Arquivo    = "sc_xls";
          $this->Arquivo   .= "_" . date("YmdHis") . "_" . rand(0, 1000);
          $this->Arq_zip    = $this->Arquivo . "_grid_lancamento_cartao.zip";
          $this->Arquivo   .= "_grid_lancamento_cartao" . $this->Xls_tp;
          $this->Tit_doc    = "grid_lancamento_cartao" . $this->Xls_tp;
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['embutida'] && !$this->Ini->sc_export_ajax) {
          ...
          $this->pb->setReturnOption($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_return']);
          if ($this->Tem_xls_res) {
   ...
   function grava_arquivo()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['field_order'] as $Cada_cmp)
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_name'] .= $this->Xls_tp;
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_name'];
          $this->Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_name'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_name'], ".");
          if ($Pos !== false) {
              $this->Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_name'], 0, $Pos);
          }
          $this->Arq_zip .= ".zip";
          $this->Tit_zip  = $this->Arq_zip;
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_name']);
          $this->Xls_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
          $this->Zip_f = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arq_zip;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['embutida_label']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['embutida_label'])
      { 
          $this->count_span = 0;
          $this->Xls_row++;
          $this->proc_label();
     ...
     $nm_houve_quebra = "N";
         ...
         if (isset($this->NM_Row_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['embutida'])
         { 
      ...
      $this->xls_set_style();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['embutida'] && $prim_reg)
      { 
          $this->proc_label();
          $this->xls_sub_cons_copy_label($this->Xls_row);
      ...
      if (isset($this->NM_Col_din) && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['embutida'])
      { 
      ...
      { 
          if ($this->Tem_xls_res)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_res_grid'] = true;
              if (!$this->Ini->sc_export_ajax) {
              ...
              if ($this->Use_phpspreadsheet) {
                  $Xls_res = \PhpOffice\PhpSpreadsheet\IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_res_sheet']);
              }
              else {
                  $Xls_res = PHPExcel_IOFactory::load($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_res_sheet']);
              }
              foreach($Xls_res->getAllSheets() as $sheet)
              {
                  $this->Xls_dados->addExternalSheet($sheet);
              }
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_res_grid']);
              unlink($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_res_sheet']);
          } 
          if (!$this->Ini->sc_export_ajax) {
   ...
   function NM_export_quantidade_parcelas()
   {
         ...
         if (is_numeric($this->quantidade_parcelas))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->quantidade_parcelas);
         $this->Xls_col++;
   }
   //----- numero_parcela
   function NM_export_numero_parcela()
   {
         ...
         if (is_numeric($this->numero_parcela))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->numero_parcela);
         $this->Xls_col++;
   }
   //----- valor_venda
   function NM_export_valor_venda()
   {
         ...
         if (is_numeric($this->valor_venda))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->valor_venda);
         $this->Xls_col++;
   }
   //----- taxa_cartao
   function NM_export_taxa_cartao()
   {
         ...
         if (is_numeric($this->taxa_cartao))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->taxa_cartao);
         $this->Xls_col++;
   }
   ...
   function NM_export_valor_da_taxa_cartao()
   {
         ...
         if (is_numeric($this->valor_da_taxa_cartao))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->valor_da_taxa_cartao);
         $this->Xls_col++;
   }
   ...
   function NM_export_valor_liquido_cartao()
   {
         ...
         if (is_numeric($this->valor_liquido_cartao))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->valor_liquido_cartao);
         $this->Xls_col++;
   }
   //----- taxa_antecipacao
   function NM_export_taxa_antecipacao()
   {
         ...
         if (is_numeric($this->taxa_antecipacao))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->taxa_antecipacao);
         $this->Xls_col++;
   }
   ...
   function NM_export_valor_liquido_antecipacao()
   {
         ...
         if (is_numeric($this->valor_liquido_antecipacao))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->valor_liquido_antecipacao);
         $this->Xls_col++;
   }
   //----- valor_antecipacao
   function NM_export_valor_antecipacao()
   {
         ...
         if (is_numeric($this->valor_antecipacao))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0.00';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->valor_antecipacao);
         $this->Xls_col++;
   }
   //----- dia_recebimento
   function NM_export_dia_recebimento()
   {
         ...
         if (is_numeric($this->dia_recebimento))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->dia_recebimento);
         $this->Xls_col++;
   }
   ...
   function NM_export_data_prevista_recebimento()
   {
         ...
         $this->NM_ctrl_style[$current_cell_ref]['end'] = $this->Xls_row;
         $this->data_prevista_recebimento = substr($this->data_prevista_recebimento, 0, 10);
         if (empty($this->data_prevista_recebimento) || $this->data_prevista_recebimento == "0000-00-00")
         {
             if ($this->Use_phpspreadsheet) {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->data_prevista_recebimento, \PhpOffice\PhpSpreadsheet\Cell\DataType::TYPE_STRING);
             }
             else {
                 $this->Nm_ActiveSheet->setCellValueExplicit($current_cell_ref . $this->Xls_row, $this->data_prevista_recebimento, PHPExcel_Cell_DataType::TYPE_STRING);
             }
         }
         else
         {
             $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->data_prevista_recebimento);
             $this->NM_ctrl_style[$current_cell_ref]['format'] = $this->SC_date_conf_region;
         }
         $this->Xls_col++;
   }
   ...
   function NM_export_idlancamento_cartao()
   {
         ...
         if (is_numeric($this->idlancamento_cartao))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->idlancamento_cartao);
         $this->Xls_col++;
   }
   //----- idcontas_receber
   ...
   //----- quantidade_parcelas
   function NM_sub_cons_quantidade_parcelas()
   {
         $this->quantidade_parcelas = NM_charset_to_utf8($this->quantidade_parcelas);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->quantidade_parcelas;
   ...
   //----- numero_parcela
   function NM_sub_cons_numero_parcela()
   {
         $this->numero_parcela = NM_charset_to_utf8($this->numero_parcela);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->numero_parcela;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- valor_venda
   function NM_sub_cons_valor_venda()
   {
         $this->valor_venda = NM_charset_to_utf8($this->valor_venda);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->valor_venda;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
   ...
   //----- taxa_cartao
   function NM_sub_cons_taxa_cartao()
   {
         $this->taxa_cartao = NM_charset_to_utf8($this->taxa_cartao);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->taxa_cartao;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- valor_da_taxa_cartao
   function NM_sub_cons_valor_da_taxa_cartao()
   {
         $this->valor_da_taxa_cartao = NM_charset_to_utf8($this->valor_da_taxa_cartao);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->valor_da_taxa_cartao;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- valor_liquido_cartao
   function NM_sub_cons_valor_liquido_cartao()
   {
         $this->valor_liquido_cartao = NM_charset_to_utf8($this->valor_liquido_cartao);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->valor_liquido_cartao;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- taxa_antecipacao
   function NM_sub_cons_taxa_antecipacao()
   {
         $this->taxa_antecipacao = NM_charset_to_utf8($this->taxa_antecipacao);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->taxa_antecipacao;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- valor_liquido_antecipacao
   function NM_sub_cons_valor_liquido_antecipacao()
   {
         $this->valor_liquido_antecipacao = NM_charset_to_utf8($this->valor_liquido_antecipacao);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->valor_liquido_antecipacao;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- valor_antecipacao
   function NM_sub_cons_valor_antecipacao()
   {
         $this->valor_antecipacao = NM_charset_to_utf8($this->valor_antecipacao);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->valor_antecipacao;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0.00";
         $this->Xls_col++;
   ...
   //----- dia_recebimento
   function NM_sub_cons_dia_recebimento()
   {
         $this->dia_recebimento = NM_charset_to_utf8($this->dia_recebimento);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->dia_recebimento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- data_prevista_recebimento
   function NM_sub_cons_data_prevista_recebimento()
   {
         $this->data_prevista_recebimento = substr($this->data_prevista_recebimento, 0, 10);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->data_prevista_recebimento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "data";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "center";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = $this->SC_date_conf_region;
         $this->Xls_col++;
   ...
   //----- idlancamento_cartao
   function NM_sub_cons_idlancamento_cartao()
   {
         $this->idlancamento_cartao = NM_charset_to_utf8($this->idlancamento_cartao);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->idlancamento_cartao;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   {
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['nolabel']) || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['nolabel'])
       {
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_file']);
      if (is_file($this->Xls_f))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_file'] = $this->Xls_f;
      }
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> lancamento_cartao :: Excel</TITLE>
...
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="nmgp_opcao" value="<?php echo NM_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['grid_lancamento_cartao']['xls_return']); ?>"> 
</FORM> 
</BODY>
</HTML>
<?php
