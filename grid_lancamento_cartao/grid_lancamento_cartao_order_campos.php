<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_lancamento_cartao']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_lancamento_cartao_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_lancamento_cartao_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["data"] : "DATA";
   $tab_ger_campos['idforma_pagamento'] = "on";
   $tab_def_campos['idforma_pagamento'] = "idforma_pagamento";
   $tab_labels["idforma_pagamento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["idforma_pagamento"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["idforma_pagamento"] : "FORMA DE RECEBIMENTO";
   $tab_ger_campos['quantidade_parcelas'] = "on";
   $tab_def_campos['quantidade_parcelas'] = "quantidade_parcelas";
   $tab_labels["quantidade_parcelas"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["quantidade_parcelas"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["quantidade_parcelas"] : "QUANTIDADE DE PARCELAS";
   $tab_ger_campos['numero_parcela'] = "on";
   $tab_def_campos['numero_parcela'] = "numero_parcela";
   $tab_labels["numero_parcela"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["numero_parcela"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["numero_parcela"] : "NUMERO DE PARCELAS";
   $tab_ger_campos['valor_venda'] = "on";
   $tab_def_campos['valor_venda'] = "valor_venda";
   $tab_labels["valor_venda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["valor_venda"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["valor_venda"] : "VALOR DE VENDA";
   $tab_ger_campos['taxa_cartao'] = "on";
   $tab_def_campos['taxa_cartao'] = "taxa_cartao";
   $tab_labels["taxa_cartao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["taxa_cartao"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["taxa_cartao"] : "TAXA DO CARTÃO";
   $tab_ger_campos['valor_da_taxa_cartao'] = "on";
   $tab_def_campos['valor_da_taxa_cartao'] = "valor_da_taxa_cartao";
   $tab_labels["valor_da_taxa_cartao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["valor_da_taxa_cartao"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["valor_da_taxa_cartao"] : "VALOR COBRADO ";
   $tab_ger_campos['valor_liquido_cartao'] = "on";
   $tab_def_campos['valor_liquido_cartao'] = "valor_liquido_cartao";
   $tab_labels["valor_liquido_cartao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["valor_liquido_cartao"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["valor_liquido_cartao"] : "VALOR LIQUIDO PARCELA";
   $tab_ger_campos['taxa_antecipacao'] = "on";
   $tab_def_campos['taxa_antecipacao'] = "taxa_antecipacao";
   $tab_labels["taxa_antecipacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["taxa_antecipacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["taxa_antecipacao"] : "TAXA DE ANTECIPAÇÃO";
   $tab_ger_campos['valor_liquido_antecipacao'] = "on";
   $tab_def_campos['valor_liquido_antecipacao'] = "valor_liquido_antecipacao";
   $tab_labels["valor_liquido_antecipacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["valor_liquido_antecipacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["valor_liquido_antecipacao"] : "VALOR COBRADO POR ANTECIPAÇÃO";
   $tab_ger_campos['valor_antecipacao'] = "on";
   $tab_def_campos['valor_antecipacao'] = "valor_antecipacao";
   $tab_labels["valor_antecipacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["valor_antecipacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["valor_antecipacao"] : "TOTAL LIQUIDO ANTECIPAÇÃO";
   $tab_ger_campos['dia_recebimento'] = "on";
   $tab_def_campos['dia_recebimento'] = "dia_recebimento";
   $tab_labels["dia_recebimento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["dia_recebimento"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["dia_recebimento"] : "DIA DO RECEBIMENTO";
   $tab_ger_campos['data_prevista_recebimento'] = "on";
   $tab_def_campos['data_prevista_recebimento'] = "data_prevista_recebimento";
   $tab_labels["data_prevista_recebimento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["data_prevista_recebimento"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["data_prevista_recebimento"] : "DATA PREVISTA DE RECEBIEMNTO";
   $tab_ger_campos['observacao'] = "on";
   $tab_def_campos['observacao'] = "observacao";
   $tab_labels["observacao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["observacao"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["observacao"] : "OBSERVAÇÃO";
   $tab_ger_campos['status'] = "on";
   $tab_def_campos['status'] = "status";
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['labels']["status"] : "STATUS";
   $tab_ger_campos['observacao'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> lancamento_cartao</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_lancamento_cartao_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_lancamento_cartao']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
