...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_lancamento_cartao"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_lancamento_cartao"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lancamento_cartao']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_lancamento_cartao']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_lancamento_cartao']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_lancamento_cartao']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_lancamento_cartao']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_lancamento_cartao</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_lancamento_cartao']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_lancamento_cartao']['embutida_filho'] as $ind => $sc_init)
          {
