<?php
@session_start() ;
$_SESSION['scriptcase']['grid_lancamento_cartao']['sc_process_barr'] = true;
require_once('../grid_lancamento_cartao/index.php');
unset($_SESSION['scriptcase']['grid_lancamento_cartao']['sc_process_barr']);
$ExportCtrl = new grid_lancamento_cartao_export_control;
$ExportCtrl->Export_barr();

class grid_lancamento_cartao_export_control
{
