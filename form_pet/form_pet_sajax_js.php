...
?>
  ...
  // ---------- Validate idcliente
  function do_ajax_form_pet_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_pet_validate_idcliente_cb);
  } // do_ajax_form_pet_validate_idcliente

  function do_ajax_form_pet_validate_idcliente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_validate_idcliente_cb

  // ---------- Validate idpet
  function do_ajax_form_pet_validate_idpet()
  {
    var nomeCampo_idpet = "idpet";
    var var_idpet = scAjaxGetFieldHidden(nomeCampo_idpet);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_validate_idpet(var_idpet, var_script_case_init, do_ajax_form_pet_validate_idpet_cb);
  } // do_ajax_form_pet_validate_idpet

  function do_ajax_form_pet_validate_idpet_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpet";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_validate_idpet_cb

  // ---------- Validate nome
  function do_ajax_form_pet_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_validate_nome(var_nome, var_script_case_init, do_ajax_form_pet_validate_nome_cb);
  } // do_ajax_form_pet_validate_nome

  function do_ajax_form_pet_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_validate_nome_cb

  // ---------- Validate sexo
  function do_ajax_form_pet_validate_sexo()
  {
    var nomeCampo_sexo = "sexo";
    var var_sexo = scAjaxGetFieldSelect(nomeCampo_sexo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_validate_sexo(var_sexo, var_script_case_init, do_ajax_form_pet_validate_sexo_cb);
  } // do_ajax_form_pet_validate_sexo

  function do_ajax_form_pet_validate_sexo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sexo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_validate_sexo_cb

  // ---------- Validate idpet_especie
  function do_ajax_form_pet_validate_idpet_especie()
  {
    var nomeCampo_idpet_especie = "idpet_especie";
    var var_idpet_especie = scAjaxGetFieldSelect(nomeCampo_idpet_especie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_validate_idpet_especie(var_idpet_especie, var_script_case_init, do_ajax_form_pet_validate_idpet_especie_cb);
  } // do_ajax_form_pet_validate_idpet_especie

  function do_ajax_form_pet_validate_idpet_especie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_validate_idpet_especie_cb

  // ---------- Validate idpet_pelagem
  function do_ajax_form_pet_validate_idpet_pelagem()
  {
    var nomeCampo_idpet_pelagem = "idpet_pelagem";
    var var_idpet_pelagem = scAjaxGetFieldSelect(nomeCampo_idpet_pelagem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_validate_idpet_pelagem(var_idpet_pelagem, var_script_case_init, do_ajax_form_pet_validate_idpet_pelagem_cb);
  } // do_ajax_form_pet_validate_idpet_pelagem

  function do_ajax_form_pet_validate_idpet_pelagem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_validate_idpet_pelagem_cb

  // ---------- Validate idpet_raca
  function do_ajax_form_pet_validate_idpet_raca()
  {
    var nomeCampo_idpet_raca = "idpet_raca";
    var var_idpet_raca = scAjaxGetFieldSelect(nomeCampo_idpet_raca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_validate_idpet_raca(var_idpet_raca, var_script_case_init, do_ajax_form_pet_validate_idpet_raca_cb);
  } // do_ajax_form_pet_validate_idpet_raca

  function do_ajax_form_pet_validate_idpet_raca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_validate_idpet_raca_cb

  // ---------- Validate data_nascimento
  function do_ajax_form_pet_validate_data_nascimento()
  {
    var nomeCampo_data_nascimento = "data_nascimento";
    var var_data_nascimento = scAjaxGetFieldText(nomeCampo_data_nascimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_validate_data_nascimento(var_data_nascimento, var_script_case_init, do_ajax_form_pet_validate_data_nascimento_cb);
  } // do_ajax_form_pet_validate_data_nascimento

  function do_ajax_form_pet_validate_data_nascimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_validate_data_nascimento_cb

  // ---------- Validate pet_obs
  function do_ajax_form_pet_validate_pet_obs()
  {
    var nomeCampo_pet_obs = "pet_obs";
    var var_pet_obs = scAjaxGetFieldText(nomeCampo_pet_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_validate_pet_obs(var_pet_obs, var_script_case_init, do_ajax_form_pet_validate_pet_obs_cb);
  } // do_ajax_form_pet_validate_pet_obs

  function do_ajax_form_pet_validate_pet_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pet_obs";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_validate_pet_obs_cb

  // ---------- Validate foto_pet
  function do_ajax_form_pet_validate_foto_pet()
  {
    var nomeCampo_foto_pet = "foto_pet";
    var var_foto_pet = scAjaxGetFieldText(nomeCampo_foto_pet);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_validate_foto_pet(var_foto_pet, var_script_case_init, do_ajax_form_pet_validate_foto_pet_cb);
  } // do_ajax_form_pet_validate_foto_pet

  function do_ajax_form_pet_validate_foto_pet_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_validate_foto_pet_cb

  // ---------- Validate foto_carteirinha
  function do_ajax_form_pet_validate_foto_carteirinha()
  {
    var nomeCampo_foto_carteirinha = "foto_carteirinha";
    var var_foto_carteirinha = scAjaxGetFieldText(nomeCampo_foto_carteirinha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_validate_foto_carteirinha(var_foto_carteirinha, var_script_case_init, do_ajax_form_pet_validate_foto_carteirinha_cb);
  } // do_ajax_form_pet_validate_foto_carteirinha

  function do_ajax_form_pet_validate_foto_carteirinha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_validate_foto_carteirinha_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pet_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pet_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_pet_submit_form(var_idcliente, var_idpet, var_nome, var_sexo, var_idpet_especie, var_idpet_pelagem, var_idpet_raca, var_data_nascimento, var_foto_pet, var_foto_carteirinha, var_foto_pet_ul_name, var_foto_pet_ul_type, var_foto_carteirinha_ul_name, var_foto_carteirinha_ul_type, var_foto_pet_limpa, var_foto_carteirinha_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pet_submit_form_cb);
  } // do_ajax_form_pet_submit_form

  function do_ajax_form_pet_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pet_submit_form_cb_after_alert);
  } // do_ajax_form_pet_submit_form_cb
  function do_ajax_form_pet_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pet_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_obs_pet"] = "off";

  function do_ajax_form_pet_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_pet_navigate_form, function() {});
    } else {
      perform_ajax_form_pet_navigate_form();
    }
  }

  function perform_ajax_form_pet_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_obs_pet"] = "on";
    x_ajax_form_pet_navigate_form(var_idpet, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pet_navigate_form_cb);
  } // do_ajax_form_pet_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pet']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pet_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_obs_pet"] && "nmsc_iframe_liga_form_obs_pet" != scMasterDetailIframe["nmsc_iframe_liga_form_obs_pet"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_obs_pet"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_obs_pet').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_obs_pet').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_obs_pet').style.display = "none";
    }
    document.F1.foto_pet_ul_name.value = '';
    document.F1.foto_pet_ul_type.value = '';
    document.F1.foto_carteirinha_ul_name.value = '';
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pet_navigate_form_cb_after_alert);
  } // do_ajax_form_pet_navigate_form_cb
  function do_ajax_form_pet_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_pet_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_pet_navigate_form_cb_after_alert

  function sc_hide_form_pet_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_obs_pet"])
    {
      return true;
    }
    return false;
