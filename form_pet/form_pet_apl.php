...
//----- 
   function ini_controle()
   {
      ...
      $_SESSION['scriptcase']['error_icon']['form_pet']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
...
//---
    ...
    function ValidateField_nome(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pet']['php_cmp_required']['nome']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pet']['php_cmp_required']['nome'] == "on")) 
      { 
          if ($this->nome == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_idpet_raca(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idpet_raca == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_pet']['php_cmp_required']['idpet_raca']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_pet']['php_cmp_required']['idpet_raca'] == "on"))
      {
          $hasError = true;
          $Campos_Falta[] = "RAÇA" ; 
