  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pet_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idcliente
  function do_ajax_form_pet_mob_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_mob_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_pet_mob_validate_idcliente_cb);
  } // do_ajax_form_pet_mob_validate_idcliente

  function do_ajax_form_pet_mob_validate_idcliente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_mob_validate_idcliente_cb

  // ---------- Validate idpet
  function do_ajax_form_pet_mob_validate_idpet()
  {
    var nomeCampo_idpet = "idpet";
    var var_idpet = scAjaxGetFieldHidden(nomeCampo_idpet);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_mob_validate_idpet(var_idpet, var_script_case_init, do_ajax_form_pet_mob_validate_idpet_cb);
  } // do_ajax_form_pet_mob_validate_idpet

  function do_ajax_form_pet_mob_validate_idpet_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpet";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_mob_validate_idpet_cb

  // ---------- Validate nome
  function do_ajax_form_pet_mob_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_mob_validate_nome(var_nome, var_script_case_init, do_ajax_form_pet_mob_validate_nome_cb);
  } // do_ajax_form_pet_mob_validate_nome

  function do_ajax_form_pet_mob_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_mob_validate_nome_cb

  // ---------- Validate sexo
  function do_ajax_form_pet_mob_validate_sexo()
  {
    var nomeCampo_sexo = "sexo";
    var var_sexo = scAjaxGetFieldSelect(nomeCampo_sexo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_mob_validate_sexo(var_sexo, var_script_case_init, do_ajax_form_pet_mob_validate_sexo_cb);
  } // do_ajax_form_pet_mob_validate_sexo

  function do_ajax_form_pet_mob_validate_sexo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sexo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_mob_validate_sexo_cb

  // ---------- Validate idpet_especie
  function do_ajax_form_pet_mob_validate_idpet_especie()
  {
    var nomeCampo_idpet_especie = "idpet_especie";
    var var_idpet_especie = scAjaxGetFieldSelect(nomeCampo_idpet_especie);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_mob_validate_idpet_especie(var_idpet_especie, var_script_case_init, do_ajax_form_pet_mob_validate_idpet_especie_cb);
  } // do_ajax_form_pet_mob_validate_idpet_especie

  function do_ajax_form_pet_mob_validate_idpet_especie_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpet_especie";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_mob_validate_idpet_especie_cb

  // ---------- Validate idpet_pelagem
  function do_ajax_form_pet_mob_validate_idpet_pelagem()
  {
    var nomeCampo_idpet_pelagem = "idpet_pelagem";
    var var_idpet_pelagem = scAjaxGetFieldSelect(nomeCampo_idpet_pelagem);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_mob_validate_idpet_pelagem(var_idpet_pelagem, var_script_case_init, do_ajax_form_pet_mob_validate_idpet_pelagem_cb);
  } // do_ajax_form_pet_mob_validate_idpet_pelagem

  function do_ajax_form_pet_mob_validate_idpet_pelagem_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpet_pelagem";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_mob_validate_idpet_pelagem_cb

  // ---------- Validate idpet_raca
  function do_ajax_form_pet_mob_validate_idpet_raca()
  {
    var nomeCampo_idpet_raca = "idpet_raca";
    var var_idpet_raca = scAjaxGetFieldSelect(nomeCampo_idpet_raca);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_mob_validate_idpet_raca(var_idpet_raca, var_script_case_init, do_ajax_form_pet_mob_validate_idpet_raca_cb);
  } // do_ajax_form_pet_mob_validate_idpet_raca

  function do_ajax_form_pet_mob_validate_idpet_raca_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idpet_raca";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_mob_validate_idpet_raca_cb

  // ---------- Validate data_nascimento
  function do_ajax_form_pet_mob_validate_data_nascimento()
  {
    var nomeCampo_data_nascimento = "data_nascimento";
    var var_data_nascimento = scAjaxGetFieldText(nomeCampo_data_nascimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_mob_validate_data_nascimento(var_data_nascimento, var_script_case_init, do_ajax_form_pet_mob_validate_data_nascimento_cb);
  } // do_ajax_form_pet_mob_validate_data_nascimento

  function do_ajax_form_pet_mob_validate_data_nascimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_mob_validate_data_nascimento_cb

  // ---------- Validate pet_obs
  function do_ajax_form_pet_mob_validate_pet_obs()
  {
    var nomeCampo_pet_obs = "pet_obs";
    var var_pet_obs = scAjaxGetFieldText(nomeCampo_pet_obs);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_mob_validate_pet_obs(var_pet_obs, var_script_case_init, do_ajax_form_pet_mob_validate_pet_obs_cb);
  } // do_ajax_form_pet_mob_validate_pet_obs

  function do_ajax_form_pet_mob_validate_pet_obs_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pet_obs";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_mob_validate_pet_obs_cb

  // ---------- Validate foto_pet
  function do_ajax_form_pet_mob_validate_foto_pet()
  {
    var nomeCampo_foto_pet = "foto_pet";
    var var_foto_pet = scAjaxGetFieldText(nomeCampo_foto_pet);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_mob_validate_foto_pet(var_foto_pet, var_script_case_init, do_ajax_form_pet_mob_validate_foto_pet_cb);
  } // do_ajax_form_pet_mob_validate_foto_pet

  function do_ajax_form_pet_mob_validate_foto_pet_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "foto_pet";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_mob_validate_foto_pet_cb

  // ---------- Validate foto_carteirinha
  function do_ajax_form_pet_mob_validate_foto_carteirinha()
  {
    var nomeCampo_foto_carteirinha = "foto_carteirinha";
    var var_foto_carteirinha = scAjaxGetFieldText(nomeCampo_foto_carteirinha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pet_mob_validate_foto_carteirinha(var_foto_carteirinha, var_script_case_init, do_ajax_form_pet_mob_validate_foto_carteirinha_cb);
  } // do_ajax_form_pet_mob_validate_foto_carteirinha

  function do_ajax_form_pet_mob_validate_foto_carteirinha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "foto_carteirinha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pet_mob_validate_foto_carteirinha_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pet_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pet_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idcliente = scAjaxGetFieldSelect("idcliente");
    var var_idpet = scAjaxGetFieldHidden("idpet");
    var var_nome = scAjaxGetFieldText("nome");
    var var_sexo = scAjaxGetFieldSelect("sexo");
    var var_idpet_especie = scAjaxGetFieldSelect("idpet_especie");
    var var_idpet_pelagem = scAjaxGetFieldSelect("idpet_pelagem");
    var var_idpet_raca = scAjaxGetFieldSelect("idpet_raca");
    var var_data_nascimento = scAjaxGetFieldText("data_nascimento");
    var var_foto_pet = scAjaxGetFieldText("foto_pet");
    var var_foto_carteirinha = scAjaxGetFieldText("foto_carteirinha");
    var var_foto_pet_ul_name = scAjaxSpecCharProtect(document.F1.foto_pet_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_foto_pet_ul_type = document.F1.foto_pet_ul_type.value;
    var var_foto_carteirinha_ul_name = scAjaxSpecCharProtect(document.F1.foto_carteirinha_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_foto_carteirinha_ul_type = document.F1.foto_carteirinha_ul_type.value;
    var var_foto_pet_limpa = document.F1.foto_pet_limpa.checked ? "S" : "N";
    var var_foto_carteirinha_limpa = document.F1.foto_carteirinha_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_pet_mob_submit_form(var_idcliente, var_idpet, var_nome, var_sexo, var_idpet_especie, var_idpet_pelagem, var_idpet_raca, var_data_nascimento, var_foto_pet, var_foto_carteirinha, var_foto_pet_ul_name, var_foto_pet_ul_type, var_foto_carteirinha_ul_name, var_foto_carteirinha_ul_type, var_foto_pet_limpa, var_foto_carteirinha_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pet_mob_submit_form_cb);
  } // do_ajax_form_pet_mob_submit_form

  function do_ajax_form_pet_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("idpet");
      scAjaxHideErrorDisplay("nome");
      scAjaxHideErrorDisplay("sexo");
      scAjaxHideErrorDisplay("idpet_especie");
      scAjaxHideErrorDisplay("idpet_pelagem");
      scAjaxHideErrorDisplay("idpet_raca");
      scAjaxHideErrorDisplay("data_nascimento");
      scAjaxHideErrorDisplay("pet_obs");
      scAjaxHideErrorDisplay("foto_pet");
      scAjaxHideErrorDisplay("foto_carteirinha");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.foto_pet_limpa && document.F1.foto_pet_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("foto_pet", oImgTemp, "", "", "", "N");
      }
      if (document.F1.foto_carteirinha_limpa && document.F1.foto_carteirinha_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("foto_carteirinha", oImgTemp, "", "", "", "N");
      }
    document.F1.foto_pet_ul_name.value = '';
    document.F1.foto_pet_ul_type.value = '';
    document.F1.foto_carteirinha_ul_name.value = '';
    document.F1.foto_carteirinha_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scBtnDisabled();
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pet_mob_submit_form_cb_after_alert);
  } // do_ajax_form_pet_mob_submit_form_cb
  function do_ajax_form_pet_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pet_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_obs_pet_mob"] = "off";

  function do_ajax_form_pet_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_pet_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_pet_mob_navigate_form();
    }
  }

  function perform_ajax_form_pet_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("foto_pet");
    scAjaxHideErrorDisplay("foto_carteirinha");
    var var_idpet = document.F2.idpet.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_obs_pet_mob"] = "on";
    x_ajax_form_pet_mob_navigate_form(var_idpet, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pet_mob_navigate_form_cb);
  } // do_ajax_form_pet_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pet_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pet_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_obs_pet_mob"] && "nmsc_iframe_liga_form_obs_pet_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_obs_pet_mob"]) {
        ...
        document.getElementById('nmsc_iframe_liga_form_obs_pet_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_obs_pet_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_obs_pet_mob').style.display = "none";
    }
    document.F1.foto_pet_ul_name.value = '';
    document.F1.foto_pet_ul_type.value = '';
    document.F1.foto_carteirinha_ul_name.value = '';
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pet_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_pet_mob_navigate_form_cb
  function do_ajax_form_pet_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_pet_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_pet_mob_navigate_form_cb_after_alert

  function sc_hide_form_pet_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_obs_pet_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "idpet";
  ajax_field_list[2] = "nome";
  ajax_field_list[3] = "sexo";
  ajax_field_list[4] = "idpet_especie";
  ajax_field_list[5] = "idpet_pelagem";
  ajax_field_list[6] = "idpet_raca";
  ajax_field_list[7] = "data_nascimento";
  ajax_field_list[8] = "pet_obs";
  ajax_field_list[9] = "foto_pet";
  ajax_field_list[10] = "foto_carteirinha";
  ...
  var ajax_error_list = {
    ...
    "idpet": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "idpet_especie": {"label": "ESPECIE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idpet_pelagem": {"label": "PELAGEM", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idpet_raca": {"label": "RAÇA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "pet_obs": {"label": "OBSERVAÇÃO PET", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "foto_pet": {"label": "FOTO PET", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "foto_carteirinha": {"label": "FOTO CARTEIRINHA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "nome": new Array(),
    "sexo": new Array(),
    "idpet_especie": new Array(),
    "idpet_pelagem": new Array(),
    "idpet_raca": new Array(),
    "data_nascimento": new Array(),
    "pet_obs": new Array(),
    "foto_pet": new Array(),
    "foto_carteirinha": new Array()
  };
  ajax_field_mult["idcliente"][1] = "idcliente";
  ajax_field_mult["idpet"][1] = "idpet";
  ajax_field_mult["nome"][1] = "nome";
  ajax_field_mult["sexo"][1] = "sexo";
  ajax_field_mult["idpet_especie"][1] = "idpet_especie";
  ajax_field_mult["idpet_pelagem"][1] = "idpet_pelagem";
  ajax_field_mult["idpet_raca"][1] = "idpet_raca";
  ajax_field_mult["data_nascimento"][1] = "data_nascimento";
  ajax_field_mult["pet_obs"][1] = "pet_obs";
  ajax_field_mult["foto_pet"][1] = "foto_pet";
  ajax_field_mult["foto_carteirinha"][1] = "foto_carteirinha";

  var ajax_field_id = {
    "idcliente": new Array("hidden_field_label_idcliente", "hidden_field_data_idcliente"),
    "idpet": new Array("hidden_field_label_idpet", "hidden_field_data_idpet"),
    ...
    "idpet_especie": new Array("hidden_field_label_idpet_especie", "hidden_field_data_idpet_especie"),
    "idpet_pelagem": new Array("hidden_field_label_idpet_pelagem", "hidden_field_data_idpet_pelagem"),
    "idpet_raca": new Array("hidden_field_label_idpet_raca", "hidden_field_data_idpet_raca"),
    "data_nascimento": new Array("hidden_field_label_data_nascimento", "hidden_field_data_data_nascimento"),
    "pet_obs": new Array("hidden_field_label_pet_obs", "hidden_field_data_pet_obs"),
    "foto_pet": new Array("hidden_field_label_foto_pet", "hidden_field_data_foto_pet"),
    "foto_carteirinha": new Array("hidden_field_label_foto_carteirinha", "hidden_field_data_foto_carteirinha")
  };
