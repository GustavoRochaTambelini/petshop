...
<?php
   ...
   $Ord_Cmp = new grid_pacote_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_pacote_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["idpacote"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pacote']['labels']["idpacote"])) ? $_SESSION['sc_session'][$sc_init]['grid_pacote']['labels']["idpacote"] : "ID";
   $tab_ger_campos['nome'] = "on";
   $tab_def_campos['nome'] = "nome";
   $tab_labels["nome"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pacote']['labels']["nome"])) ? $_SESSION['sc_session'][$sc_init]['grid_pacote']['labels']["nome"] : "NOME";
   $tab_ger_campos['descricao'] = "on";
   $tab_def_campos['descricao'] = "descricao";
   $tab_labels["descricao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pacote']['labels']["descricao"])) ? $_SESSION['sc_session'][$sc_init]['grid_pacote']['labels']["descricao"] : "DESCRIÇÃO";
   $tab_ger_campos['valor'] = "on";
   $tab_def_campos['valor'] = "valor";
   $tab_labels["valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pacote']['labels']["valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_pacote']['labels']["valor"] : "VALOR";
   $tab_ger_campos['unidade'] = "on";
   $tab_def_campos['unidade'] = "unidade";
   $tab_labels["unidade"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pacote']['labels']["unidade"])) ? $_SESSION['sc_session'][$sc_init]['grid_pacote']['labels']["unidade"] : "UNIDADE";
   $tab_ger_campos['tipo'] = "on";
   $tab_def_campos['tipo'] = "tipo";
   $tab_labels["tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_pacote']['labels']["tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_pacote']['labels']["tipo"] : "TIPO";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_pacote']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_pacote']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_pacote']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_pacote_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_pacote']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
