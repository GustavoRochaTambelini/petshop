  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_conta_corrente_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_conta_corrente_mob_form();
	}
...
?>
  ...
  function do_ajax_form_conta_corrente_mob_validate_idconta_corrente()
  {
    var nomeCampo_idconta_corrente = "idconta_corrente";
    var var_idconta_corrente = scAjaxGetFieldHidden(nomeCampo_idconta_corrente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_mob_validate_idconta_corrente(var_idconta_corrente, var_script_case_init, do_ajax_form_conta_corrente_mob_validate_idconta_corrente_cb);
  } // do_ajax_form_conta_corrente_mob_validate_idconta_corrente

  function do_ajax_form_conta_corrente_mob_validate_idconta_corrente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_mob_validate_idconta_corrente_cb

  // ---------- Validate descricao
  function do_ajax_form_conta_corrente_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_conta_corrente_mob_validate_descricao_cb);
  } // do_ajax_form_conta_corrente_mob_validate_descricao

  function do_ajax_form_conta_corrente_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_mob_validate_descricao_cb

  // ---------- Validate agencia
  function do_ajax_form_conta_corrente_mob_validate_agencia()
  {
    var nomeCampo_agencia = "agencia";
    var var_agencia = scAjaxGetFieldText(nomeCampo_agencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_mob_validate_agencia(var_agencia, var_script_case_init, do_ajax_form_conta_corrente_mob_validate_agencia_cb);
  } // do_ajax_form_conta_corrente_mob_validate_agencia

  function do_ajax_form_conta_corrente_mob_validate_agencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "agencia";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_mob_validate_agencia_cb

  // ---------- Validate conta
  function do_ajax_form_conta_corrente_mob_validate_conta()
  {
    var nomeCampo_conta = "conta";
    var var_conta = scAjaxGetFieldText(nomeCampo_conta);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_mob_validate_conta(var_conta, var_script_case_init, do_ajax_form_conta_corrente_mob_validate_conta_cb);
  } // do_ajax_form_conta_corrente_mob_validate_conta

  function do_ajax_form_conta_corrente_mob_validate_conta_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "conta";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_mob_validate_conta_cb

  // ---------- Validate ativo
  function do_ajax_form_conta_corrente_mob_validate_ativo()
  {
    var nomeCampo_ativo = "ativo";
    var var_ativo = scAjaxGetFieldSelect(nomeCampo_ativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_mob_validate_ativo(var_ativo, var_script_case_init, do_ajax_form_conta_corrente_mob_validate_ativo_cb);
  } // do_ajax_form_conta_corrente_mob_validate_ativo

  function do_ajax_form_conta_corrente_mob_validate_ativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ativo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_mob_validate_ativo_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_conta_corrente_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_conta_corrente_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idconta_corrente = scAjaxGetFieldHidden("idconta_corrente");
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_agencia = scAjaxGetFieldText("agencia");
    ...
    scAjaxProcOn();
    x_ajax_form_conta_corrente_mob_submit_form(var_idconta_corrente, var_descricao, var_agencia, var_conta, var_ativo, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_conta_corrente_mob_submit_form_cb);
  } // do_ajax_form_conta_corrente_mob_submit_form

  function do_ajax_form_conta_corrente_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("agencia");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_conta_corrente_mob_submit_form_cb_after_alert);
  } // do_ajax_form_conta_corrente_mob_submit_form_cb
  function do_ajax_form_conta_corrente_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_conta_corrente_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_conta_corrente_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_conta_corrente_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_conta_corrente_mob_navigate_form();
    }
  }

  function perform_ajax_form_conta_corrente_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_conta_corrente_mob_navigate_form(var_idconta_corrente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_conta_corrente_mob_navigate_form_cb);
  } // do_ajax_form_conta_corrente_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_conta_corrente_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_conta_corrente_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_conta_corrente_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_conta_corrente_mob_navigate_form_cb
  function do_ajax_form_conta_corrente_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_conta_corrente_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_conta_corrente_mob_navigate_form_cb_after_alert

  function sc_hide_form_conta_corrente_mob_form()
  {
  ...
  ajax_field_list[0] = "idconta_corrente";
  ajax_field_list[1] = "descricao";
  ajax_field_list[2] = "agencia";
  ajax_field_list[3] = "conta";
  ...
  var ajax_error_list = {
    "idconta_corrente": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "agencia": {"label": "AGENCIA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "conta": {"label": "CONTA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["agencia"][1] = "agencia";
  ...
  var ajax_field_id = {
    ...
    "agencia": new Array("hidden_field_label_agencia", "hidden_field_data_agencia"),
