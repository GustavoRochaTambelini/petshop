...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_contas_receber']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_contas_receber']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_contas_receber']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_contas_receber']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_contas_receber']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_contas_receber_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_contas_receber']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_contas_receber']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_contas_receber'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_contas_receber']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_contas_receber']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_contas_receber') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_contas_receber']['label'] = "CONTAS A RECEBER";
      ...
      $_SESSION['scriptcase']['error_icon']['form_contas_receber']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_contas_receber'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_contas_receber'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_contas_receber'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_contas_receber/form_contas_receber_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_contas_receber_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_contas_receber_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_contas_receber_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_contas_receber/form_contas_receber_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_contas_receber_erro.class.php"); 
      }
      $this->Erro      = new form_contas_receber_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao']))
         { 
             if ($this->idcontas_receber != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['recebimento_parcial'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['botoes']['recebimento_parcial'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_recebimento_parcial') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_recebimento_parcial') . "/form_recebimento_parcial_apl.php");
          $this->form_recebimento_parcial = new form_recebimento_parcial_apl;
      }
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dados_select']['idcliente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idcliente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dados_select']['idcliente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dados_select']['valor_a_receber']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->valor_a_receber = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dados_select']['valor_a_receber'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dados_select']['sc_field_0']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->sc_field_0 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dados_select']['sc_field_0'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_contas_receber.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_contas_receber_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_contas_receber"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_contas_receber']) || !is_array($this->NM_ajax_info['errList']['geral_form_contas_receber']))
              {
                  $this->NM_ajax_info['errList']['geral_form_contas_receber'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_contas_receber'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
      ...
      if (empty($Campos_Crit) && empty($Campos_Falta) && empty($this->Campos_Mens_erro))
      {
          ...
          {
              $_SESSION['scriptcase']['form_contas_receber']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_contas_receber']['contr_erro'] = 'off'; 
    ...
    function ValidateField_idcliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idcliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_idcliente']) && !in_array($this->idcliente, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_idcliente']))
               {
                   $hasError = true;
    ...
    function ValidateField_idforma_pagamento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idforma_pagamento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_idforma_pagamento']) && !in_array($this->idforma_pagamento, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_idforma_pagamento']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_data_pagamento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['php_cmp_required']['data_pagamento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['php_cmp_required']['data_pagamento'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_juros(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->juros, 13, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "JUROS; " ; 
                  if (!isset($Campos_Erros['juros']))
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idcontas_receber']['keyVal'] = form_contas_receber_pack_protect_string($this->nmgp_dados_form['idcontas_receber']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['foreign_key']['idcontas_receber'] = $this->nmgp_dados_form['idcontas_receber'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['where_filter'] = "idcontas_receber = " . $this->nmgp_dados_form['idcontas_receber'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['where_detal']  = "idcontas_receber = " . $this->nmgp_dados_form['idcontas_receber'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['total']);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_idcliente']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_idcliente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_idcliente']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_idcliente'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_contas_receber_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_contas_receber_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_idcliente'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idcliente']['valList'][$i] = form_contas_receber_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_idforma_pagamento']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_idforma_pagamento'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_idforma_pagamento']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_idforma_pagamento'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_idforma_pagamento'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idforma_pagamento']['valList'][$i] = form_contas_receber_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_contas_receber_pack_protect_string('F') => str_replace('<', '&lt;',form_contas_receber_pack_protect_string("A RECEBER")));
$aLookup[] = array(form_contas_receber_pack_protect_string('T') => str_replace('<', '&lt;',form_contas_receber_pack_protect_string("RECEBIDO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_pago'][] = 'F';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_pago'][] = 'T';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"pago\"";
          ...
          {
              $this->NM_ajax_info['fldList']['pago']['valList'][$i] = form_contas_receber_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_recebimento_parcial($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idcontas_receber)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opcao'] = '';
...
;
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_contas_receber';
...
$_SESSION['scriptcase']['form_contas_receber']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_recebimento_parcial->ini_controle();
              if ($this->form_recebimento_parcial->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
...
$_SESSION['scriptcase']['form_contas_receber']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['parms'] = "idcontas_receber?#?$this->idcontas_receber?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['select'] = ""; 
              } 
          } 
          ...
          { 
              ...
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
  }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_contas_receber_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_contas_receber = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['total'] = $qt_geral_reg_form_contas_receber;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_contas_receber_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_contas_receber_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_contas_receber_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['ordem_ord'] == " desc") {
