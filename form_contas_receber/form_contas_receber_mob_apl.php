<?php
//
class form_contas_receber_mob_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['recebimento_parcial']))
          {
              $this->recebimento_parcial = $this->NM_ajax_info['param']['recebimento_parcial'];
          }
      ...
      $this->sc_conv_var['valor a receber'] = "sc_field_0";
      if (!empty($_FILES))
      {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['total']);
          }
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_contas_receber_mob_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['initialize'];
          if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber']))
          {
              foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber'] as $I_conf => $Conf_opt)
              {
                  $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob'][$I_conf]  = $Conf_opt;
              }
          }
      } 
      else 
      ...
      $_SESSION['sc_session'][$script_case_init]['form_contas_receber_mob']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_contas_receber_mob']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_contas_receber_mob'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_contas_receber_mob']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_contas_receber_mob']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_contas_receber_mob') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_contas_receber_mob']['label'] = "CONTAS A RECEBER";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_contas_receber_mob")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $this->arr_buttons['recebimento_parcial']['hint']             = "";
      $this->arr_buttons['recebimento_parcial']['type']             = "button";
      $this->arr_buttons['recebimento_parcial']['value']            = "Recebimento Parcial";
      $this->arr_buttons['recebimento_parcial']['display']          = "text_fontawesomeicon";
      $this->arr_buttons['recebimento_parcial']['display_position'] = "text_right";
      $this->arr_buttons['recebimento_parcial']['style']            = "default";
      $this->arr_buttons['recebimento_parcial']['image']            = "";
      $this->arr_buttons['recebimento_parcial']['has_fa']            = "true";
      $this->arr_buttons['recebimento_parcial']['fontawesomeicon']            = "fas fa-hand-holding-usd";


      $_SESSION['scriptcase']['error_icon']['form_contas_receber_mob']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_contas_receber_mob'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['goto']      = 'on';
          }
      }
      ...
      $this->nmgp_botoes['recebimento_parcial'] = "on";
      if (isset($this->NM_btn_cancel) && 'N' == $this->NM_btn_cancel)
      {
          $this->nmgp_botoes['cancel'] = "off";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_mob']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_contas_receber_mob'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_contas_receber_mob'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_contas_receber/form_contas_receber_mob_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_contas_receber_mob_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_contas_receber_mob_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_contas_receber_mob_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_contas_receber/form_contas_receber_mob_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_contas_receber_mob_erro.class.php"); 
      }
      $this->Erro      = new form_contas_receber_mob_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao']))
         { 
             if ($this->idcontas_receber != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_mob']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['recebimento_parcial'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['botoes']['recebimento_parcial'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['final'];
      }
      else
      {
      }
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_recebimento_parcial_mob') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_recebimento_parcial_mob') . "/form_recebimento_parcial_mob_apl.php");
          $this->form_recebimento_parcial_mob = new form_recebimento_parcial_mob_apl;
      }
      ...
      if (isset($this->recebimento_parcial)) { $this->nm_limpa_alfa($this->recebimento_parcial); }
      $Campos_Crit       = "";
      $Campos_erro       = "";
      $Campos_Falta      = array();
      $Campos_Erros      = array();
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          if ('validate_recebimento_parcial' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'recebimento_parcial');
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      ...
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dados_select']['idcliente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idcliente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dados_select']['idcliente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dados_select']['valor_a_receber']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->valor_a_receber = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dados_select']['valor_a_receber'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dados_select']['sc_field_0']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->sc_field_0 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dados_select']['sc_field_0'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['recarga'] = $this->nmgp_opcao;
      }
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_contas_receber_mob.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob'][$path_doc_md5][1] = $Zip_name;
?>
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo strip_tags("CONTAS A RECEBER") ?></TITLE>
...
<form name="Fdown" method="get" action="form_contas_receber_mob_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_contas_receber_mob"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<form name="F0" method=post action="form_contas_receber_mob.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_contas_receber_mob']) || !is_array($this->NM_ajax_info['errList']['geral_form_contas_receber_mob']))
              {
                  $this->NM_ajax_info['errList']['geral_form_contas_receber_mob'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_contas_receber_mob'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'recebimento_parcial' == $filtro)) || (is_array($filtro) && in_array('recebimento_parcial', $filtro)))
        $this->ValidateField_recebimento_parcial($Campos_Crit, $Campos_Falta, $Campos_Erros);
//-- converter datas   
          $this->nm_converte_datas();
//---
      ...
      if (empty($Campos_Crit) && empty($Campos_Falta) && empty($this->Campos_Mens_erro))
      {
          ...
          {
              $_SESSION['scriptcase']['form_contas_receber_mob']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_contas_receber_mob']['contr_erro'] = 'off'; 
    ...
    function ValidateField_idcliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idcliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_idcliente']) && !in_array($this->idcliente, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_idcliente']))
               {
                   $hasError = true;
    ...
    function ValidateField_idforma_pagamento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idforma_pagamento) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_idforma_pagamento']) && !in_array($this->idforma_pagamento, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_idforma_pagamento']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_data_pagamento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['php_cmp_required']['data_pagamento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['php_cmp_required']['data_pagamento'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "DATA RECEBIMENTO" ; 
              if (!isset($Campos_Erros['data_pagamento']))
              {
                  $Campos_Erros['data_pagamento'] = array();
              }
              $Campos_Erros['data_pagamento'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
                  if (!isset($this->NM_ajax_info['errList']['data_pagamento']) || !is_array($this->NM_ajax_info['errList']['data_pagamento']))
                  {
                      $this->NM_ajax_info['errList']['data_pagamento'] = array();
                  }
                  $this->NM_ajax_info['errList']['data_pagamento'][] = $this->Ini->Nm_lang['lang_errm_ajax_rqrd'];
           } 
    ...
    function ValidateField_valor_a_receber(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              { 
                  $hasError = true;
                  $Campos_Crit .= "VALOR DA CONTA: " . $this->Ini->Nm_lang['lang_errm_size']; 
    ...
    function ValidateField_sc_field_0(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              elseif ('-' == substr($this->sc_field_0, -1))
              {
                  $iTestSize++;
                  $this->sc_field_0 = '-' . substr($this->sc_field_0, 0, -1);
              }
              ...
              if ($teste_validade->Valor($this->sc_field_0, 18, 2, 0, 0, "S") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_recebimento_parcial(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->nmgp_opcao != "excluir") 
      { 
          if (trim($this->recebimento_parcial) != "")  
          { 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'recebimento_parcial';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_recebimento_parcial
   ...
   function nm_guardar_campos()
   {
    ...
    $this->nmgp_dados_form['recebimento_parcial'] = $this->recebimento_parcial;
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          $this->ajax_return_values_recebimento_parcial();
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              $this->NM_ajax_info['clearUpload']      = 'S';
              $this->NM_ajax_info['navStatus']['ret'] = $this->Nav_permite_ret ? 'S' : 'N';
              $this->NM_ajax_info['navStatus']['ava'] = $this->Nav_permite_ava ? 'S' : 'N';
              $this->NM_ajax_info['fldList']['idcontas_receber']['keyVal'] = form_contas_receber_mob_pack_protect_string($this->nmgp_dados_form['idcontas_receber']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob']['foreign_key']['idcontas_receber'] = $this->nmgp_dados_form['idcontas_receber'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob']['where_filter'] = "idcontas_receber = " . $this->nmgp_dados_form['idcontas_receber'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob']['where_detal']  = "idcontas_receber = " . $this->nmgp_dados_form['idcontas_receber'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob']['total']);
              foreach ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob'] as $i => $v)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial'][$i] = $v;
              }
              if (isset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob']['total']))
              {
                  unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['form_recebimento_parcial_mob_script_case_init'] ]['form_recebimento_parcial_mob']['total']);
              }
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_idcliente']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_idcliente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_idcliente']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_idcliente'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_contas_receber_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_contas_receber_mob_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_idcliente'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idcliente']['valList'][$i] = form_contas_receber_mob_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_idforma_pagamento']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_idforma_pagamento'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_idforma_pagamento']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_idforma_pagamento'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_idforma_pagamento'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idforma_pagamento']['valList'][$i] = form_contas_receber_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_contas_receber_mob_pack_protect_string('F') => str_replace('<', '&lt;',form_contas_receber_mob_pack_protect_string("A RECEBER")));
$aLookup[] = array(form_contas_receber_mob_pack_protect_string('T') => str_replace('<', '&lt;',form_contas_receber_mob_pack_protect_string("RECEBIDO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_pago'][] = 'F';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['Lookup_pago'][] = 'T';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"pago\"";
          ...
          {
              $this->NM_ajax_info['fldList']['pago']['valList'][$i] = form_contas_receber_mob_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
          ...
          //----- recebimento_parcial
   function ajax_return_values_recebimento_parcial($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("recebimento_parcial", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->recebimento_parcial);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['recebimento_parcial'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
   ...
   {
       $this->NM_ajax_info['btnVars']['var_btn_recebimento_parcial_idcontas_receber'] = $this->form_encode_input($this->nmgp_dados_form['idcontas_receber']);
   } // ajax_add_parameters
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
  ...
  $v_valor_a_receber = $this->valor_a_receber ;

$v_valor_recebido = $this->valor_recebido ;


$this->sc_field_0  = ($v_valor_a_receber - $v_valor_recebido);
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
...
$_SESSION['scriptcase']['form_contas_receber_mob']['contr_erro'] = 'off'; 
      ...
      {
          $this->data_emissao_hora = $this->data_emissao;
      }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idcontas_receber)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opcao'] = '';
...
;
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_contas_receber_mob';
...
$_SESSION['scriptcase']['form_contas_receber_mob']['contr_erro'] = 'off'; 
      ...
      $NM_val_form['recebimento_parcial'] = $this->recebimento_parcial;
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar" || $this->nmgp_opcao == "incluir") 
      {
          ...
          $this->recebimento_parcial_before_qstr = $this->recebimento_parcial;
          $this->recebimento_parcial = substr($this->Db->qstr($this->recebimento_parcial), 1, -1); 
          if ($this->recebimento_parcial == "" && in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))  
          { 
              $this->recebimento_parcial = "null"; 
              $NM_val_null[] = "recebimento_parcial";
          } 
      }
      if ($this->nmgp_opcao == "alterar") 
      {
          $SC_fields_update = array(); 
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  ...
                  $SC_fields_update[] = "idcliente = $this->idcliente, idforma_pagamento = $this->idforma_pagamento, data_vencimento = '$this->data_vencimento', valor_a_receber = $this->valor_a_receber, data_pagamento = '$this->data_pagamento', pago = '$this->pago', observacoes = '$this->observacoes', juros = $this->juros"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "idcliente = $this->idcliente, idforma_pagamento = $this->idforma_pagamento, data_vencimento = TO_DATE('$this->data_vencimento', 'yyyy-mm-dd hh24:mi:ss'), valor_a_receber = $this->valor_a_receber, data_pagamento = TO_DATE('$this->data_pagamento', 'yyyy-mm-dd hh24:mi:ss'), pago = '$this->pago', juros = $this->juros"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "idcliente = $this->idcliente, idforma_pagamento = $this->idforma_pagamento, data_vencimento = '$this->data_vencimento', valor_a_receber = $this->valor_a_receber, data_pagamento = '$this->data_pagamento', pago = '$this->pago', juros = $this->juros"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              { 
                  ...
                  { 
                      $SC_fields_update[] = "data_emissao = TO_DATE('$this->data_emissao', 'yyyy-mm-dd hh24:mi:ss')"; 
                  } 
                  else
                  { 
              ...
              $this->recebimento_parcial = $this->recebimento_parcial_before_qstr;
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              if     (isset($NM_val_form) && isset($NM_val_form['recebimento_parcial'])) { $this->recebimento_parcial = $NM_val_form['recebimento_parcial']; }
              elseif (isset($this->recebimento_parcial)) { $this->nm_limpa_alfa($this->recebimento_parcial); }
              ...
              $this->nmgp_refresh_fields = array_diff(array('idcontas_receber', 'idcliente', 'idforma_pagamento', 'data_vencimento', 'data_pagamento', 'valor_a_receber', 'sc_field_0', 'observacoes', 'juros', 'pago', 'recebimento_parcial'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              $sDetailWhere = "idcontas_receber = " . $this->idcontas_receber . "";
              $this->form_recebimento_parcial_mob->ini_controle();
              if ($this->form_recebimento_parcial_mob->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
...
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
  ...
  if($this->pago  == 'T'){
	$check_sql = "SELECT SUM(valor)"
	   ...
	   . " WHERE idcontas_receber = '" . $this->idcontas_receber  . "'";
...
;
	...
	{
		$v_recebimento_parcial = $this->rs[0][0];
	}
			else    
	{
		$v_recebimento_parcial = 0;
	}
		
	
		if($v_recebimento_parcial > 0){
			$v_recebido = ($this->valor_a_receber  - $v_recebimento_parcial);
			
			$insert_table  = 'recebimento_parcial';      
			$insert_fields = array(   
     ...
     $nm_select = $insert_sql; 
      ...
      ;
			...
			$this->inclui_caixa_diario($v_recebido);
		}else {
			$this->inclui_caixa_diario($this->valor_a_receber );
		}
}
if (isset($this->NM_ajax_flag) && $this->NM_ajax_flag)
{
    ...
    if (($original_juros != $this->juros || (isset($bFlagRead_juros) && $bFlagRead_juros)))
    {
        $this->ajax_return_values_juros(true);
    }
    if (($original_observacoes != $this->observacoes || (isset($bFlagRead_observacoes) && $bFlagRead_observacoes)))
    {
...
$_SESSION['scriptcase']['form_contas_receber_mob']['contr_erro'] = 'off'; 
   ...
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['decimal_db'] == ",")
   {
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['parms'] = "idcontas_receber?#?$this->idcontas_receber?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['select'] = ""; 
              } 
          } 
          ...
          { 
              ...
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter']))
              {
                  ...
                  $this->NM_ajax_info['buttonDisplay']['recebimento_parcial'] = $this->nmgp_botoes['recebimento_parcial'] = "off";
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dados_select'] = $this->nmgp_dados_select;
      ...
      { 
          ...
          else
          {
              ...
              $this->nmgp_dados_form["data_emissao"] = $this->data_emissao;
              $this->data_vencimento = "";  
              $this->data_vencimento_hora = "" ;  
              $this->nmgp_dados_form["data_vencimento"] = $this->data_vencimento;
              $this->valor_a_receber = "";  
              $this->nmgp_dados_form["valor_a_receber"] = $this->valor_a_receber;
              $this->data_pagamento =  date('Y') . "-" . date('m')  . "-" . date('d');
              $this->nmgp_dados_form["data_pagamento"] = $this->data_pagamento;
              $this->valor_recebido = "";  
              $this->nmgp_dados_form["valor_recebido"] = $this->valor_recebido;
              $this->pago = "";  
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial_mob']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
  }
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_contas_receber_mob_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        $searchOk = false;
        if ('SC_all_Cmp' == $this->nmgp_fast_search && in_array($field, array("idcontas_receber", "idcliente", "idforma_pagamento", "data_vencimento", "data_pagamento", "valor_a_receber", "observacoes", "juros", "pago", "recebimento_parcial"))) {
            $searchOk = true;
        }
        elseif ($field == $this->nmgp_fast_search && in_array($field, array("idcontas_receber", "idcliente", "idforma_pagamento", "data_vencimento", "data_pagamento", "valor_a_receber", "observacoes", "juros", "pago", "recebimento_parcial"))) {
            $searchOk = true;
        }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_contas_receber_mob = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['total'] = $qt_geral_reg_form_contas_receber_mob;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_contas_receber_mob_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_contas_receber_mob_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_contas_receber_mob_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['link_info']['compact_mode']) {
            return;
        }
?>
...
<div class="scFormHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFormHeaderFont" style="float: left; text-transform: uppercase;"><?php if ($this->nmgp_opcao == "novo") { echo "CONTAS A RECEBER"; } else { echo "CONTAS A RECEBER"; } ?></div>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_mob']['ordem_ord'] == " desc") {
