...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_contas_receber/form_contas_receber_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_contas_receber_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_contas_receber_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['link_info']['remove_border']) {
...
<?php
 include_once("form_contas_receber_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_contas_receber'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_contas_receber'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-2';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idforma_pagamento_line" id="hidden_field_data_idforma_pagamento" style="<?php echo $sStyleHidden_idforma_pagamento; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idforma_pagamento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_vencimento_label" id="hidden_field_label_data_vencimento" style="<?php echo $sStyleHidden_data_vencimento; ?>"><span id="id_label_data_vencimento"><?php echo $this->nm_new_label['data_vencimento']; ?></span></TD>
    <TD class="scFormDataOdd css_data_vencimento_line" id="hidden_field_data_data_vencimento" style="<?php echo $sStyleHidden_data_vencimento; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_data_vencimento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_data_pagamento_label" id="hidden_field_label_data_pagamento" style="<?php echo $sStyleHidden_data_pagamento; ?>"><span id="id_label_data_pagamento"><?php echo $this->nm_new_label['data_pagamento']; ?></span><?php if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['php_cmp_required']['data_pagamento']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['php_cmp_required']['data_pagamento'] == "on") { ?> <span class="scFormRequiredOdd">*</span> <?php }?></TD>
    <TD class="scFormDataOdd css_data_pagamento_line" id="hidden_field_data_data_pagamento" style="<?php echo $sStyleHidden_data_pagamento; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_data_pagamento_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_valor_a_receber_label" id="hidden_field_label_valor_a_receber" style="<?php echo $sStyleHidden_valor_a_receber; ?>"><span id="id_label_valor_a_receber"><?php echo $this->nm_new_label['valor_a_receber']; ?></span></TD>
    <TD class="scFormDataOdd css_valor_a_receber_line" id="hidden_field_data_valor_a_receber" style="<?php echo $sStyleHidden_valor_a_receber; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_valor_a_receber_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_observacoes_label" id="hidden_field_label_observacoes" style="<?php echo $sStyleHidden_observacoes; ?>"><span id="id_label_observacoes"><?php echo $this->nm_new_label['observacoes']; ?></span></TD>
    <TD class="scFormDataOdd css_observacoes_line" id="hidden_field_data_observacoes" style="<?php echo $sStyleHidden_observacoes; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_observacoes_line" style="vertical-align: top;padding: 0px">
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_juros_line" id="hidden_field_data_juros" style="<?php echo $sStyleHidden_juros; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_juros_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_pago'][] = 'F'; ?>
 <option  value="T" <?php  if ($this->pago == "T") { echo " selected" ;} ?>>RECEBIDO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['Lookup_pago'][] = 'T'; ?>
 </select></span>
</span><?php  }?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_recebimento_parcial'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_recebimento_parcial'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_recebimento_parcial'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_liga_form_update'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_recebimento_parcial']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinN*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init'] ]['form_contas_receber']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_contas_receber_empty.htm' : $this->Ini->link_form_recebimento_parcial_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y';
if (isset($this->Ini->sc_lig_target['C_@scinf_recebimento_parcial']) && 'nmsc_iframe_liga_form_recebimento_parcial' != $this->Ini->sc_lig_target['C_@scinf_recebimento_parcial'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_recebimento_parcial'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['form_recebimento_parcial_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_recebimento_parcial"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="100" width="100%" name="nmsc_iframe_liga_form_recebimento_parcial"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_contas_receber");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_contas_receber");
 parent.scAjaxDetailHeight("form_contas_receber", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
