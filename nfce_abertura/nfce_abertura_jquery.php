...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_pdv_livre' + iSeqRow).bind('blur', function() { sc_nfce_abertura_pdv_livre_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_nfce_abertura_pdv_livre_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cpf_na_nota' + iSeqRow).bind('blur', function() { sc_nfce_abertura_cpf_na_nota_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_nfce_abertura_cpf_na_nota_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_com_cpf' + iSeqRow).bind('blur', function() { sc_nfce_abertura_com_cpf_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_nfce_abertura_com_cpf_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_sem_cpf' + iSeqRow).bind('blur', function() { sc_nfce_abertura_sem_cpf_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_nfce_abertura_sem_cpf_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cpf_cnpj' + iSeqRow).bind('blur', function() { sc_nfce_abertura_cpf_cnpj_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_nfce_abertura_cpf_cnpj_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_nome' + iSeqRow).bind('blur', function() { sc_nfce_abertura_nome_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_nfce_abertura_nome_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_email' + iSeqRow).bind('blur', function() { sc_nfce_abertura_email_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_nfce_abertura_email_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_linha1' + iSeqRow).bind('blur', function() { sc_nfce_abertura_linha1_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_nfce_abertura_linha1_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_linha2' + iSeqRow).bind('blur', function() { sc_nfce_abertura_linha2_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_nfce_abertura_linha2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_espaco1' + iSeqRow).bind('blur', function() { sc_nfce_abertura_espaco1_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_nfce_abertura_espaco1_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_espaco2' + iSeqRow).bind('blur', function() { sc_nfce_abertura_espaco2_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_nfce_abertura_espaco2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_espaco3' + iSeqRow).bind('blur', function() { sc_nfce_abertura_espaco3_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_nfce_abertura_espaco3_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_venda_id' + iSeqRow).bind('blur', function() { sc_nfce_abertura_venda_id_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_nfce_abertura_venda_id_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_chk_com_cpf' + iSeqRow).bind('blur', function() { sc_nfce_abertura_chk_com_cpf_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_nfce_abertura_chk_com_cpf_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_chk_sem_cpf' + iSeqRow).bind('blur', function() { sc_nfce_abertura_chk_sem_cpf_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_nfce_abertura_chk_sem_cpf_onchange(this, iSeqRow) })
...
function sc_nfce_abertura_pdv_livre_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_abertura_cpf_na_nota_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_abertura_com_cpf_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_abertura_sem_cpf_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_abertura_cpf_cnpj_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_abertura_nome_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_abertura_email_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_abertura_linha1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_abertura_linha2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_abertura_espaco1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_abertura_espaco2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_abertura_espaco3_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_abertura_venda_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_abertura_chk_com_cpf_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_nfce_abertura_chk_sem_cpf_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_nfce_abertura_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'nfce_abertura')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
