...
$old_error_handler = set_error_handler("nfce_abertura_scriptcase_error_handler");

function nfce_abertura_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['nfce_abertura']['contr_erro']) && $_SESSION['scriptcase']['nfce_abertura']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_nfce_abertura->contr_nfce_abertura->Apl_com_erro = true;
            if ($inicial_nfce_abertura->contr_nfce_abertura->NM_ajax_flag)
            {
                $inicial_nfce_abertura->contr_nfce_abertura->NM_ajax_info['errList']['geral_nfce_abertura'][] = $msg;
                return;
            }
            nfce_abertura_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function nfce_abertura_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['nfce_abertura'])  && '' != $_SESSION['scriptcase']['error_icon']['nfce_abertura'])  ? $_SESSION['scriptcase']['error_icon']['nfce_abertura']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['nfce_abertura']) && '' != $_SESSION['scriptcase']['error_close']['nfce_abertura']) ? $_SESSION['scriptcase']['error_close']['nfce_abertura'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['nfce_abertura']) && '' != $_SESSION['scriptcase']['error_span_title']['nfce_abertura']) ? $_SESSION['scriptcase']['error_span_title']['nfce_abertura'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['nfce_abertura']) && '' != $_SESSION['scriptcase']['error_icon_title']['nfce_abertura']) ? $_SESSION['scriptcase']['error_icon_title']['nfce_abertura'] : '';
?>
