...
.sc-button-image.disabled img {
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>nfce_abertura/nfce_abertura_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("nfce_abertura_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('nfce_abertura_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['nfce_abertura']['error_buffer']) && '' != $_SESSION['scriptcase']['nfce_abertura']['error_buffer'])
{
    echo $_SESSION['scriptcase']['nfce_abertura']['error_buffer'];
}
...
<?php
 include_once("nfce_abertura_mob_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
<?php
$_SESSION['scriptcase']['error_span_title']['nfce_abertura_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['nfce_abertura_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  ...
  {
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['where_filter']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['empty_filter'] = true;
       }
  }
?>
...
<?php $sStyleHidden_linha2_dumb = ('' == $sStyleHidden_linha2) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_linha2_dumb" style="<?php echo $sStyleHidden_linha2_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<span id="id_read_on_chk_com_cpf" class="css_chk_com_cpf_line" style="<?php echo $sStyleReadLab_chk_com_cpf; ?>"><?php echo $this->form_format_readonly("chk_com_cpf", $this->form_encode_input($chk_com_cpf_look)); ?></span><span id="id_read_off_chk_com_cpf" class="css_read_off_chk_com_cpf css_chk_com_cpf_line" style="<?php echo $sStyleReadInp_chk_com_cpf; ?>"><?php echo "<div id=\"idAjaxCheckbox_chk_com_cpf\" style=\"display: inline-block\" class=\"css_chk_com_cpf_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['Lookup_chk_com_cpf'][] = 's'; ?>
<?php  if (in_array("s", $this->chk_com_cpf_1))  { echo " checked" ;} ?> onClick="do_ajax_nfce_abertura_mob_event_chk_com_cpf_onclick();" ><label for="<?php echo $tempOptionId ?>">s</label></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
 </TD>
   <?php }?>
...
<span id="id_read_on_chk_sem_cpf" class="css_chk_sem_cpf_line" style="<?php echo $sStyleReadLab_chk_sem_cpf; ?>"><?php echo $this->form_format_readonly("chk_sem_cpf", $this->form_encode_input($chk_sem_cpf_look)); ?></span><span id="id_read_off_chk_sem_cpf" class="css_read_off_chk_sem_cpf css_chk_sem_cpf_line" style="<?php echo $sStyleReadInp_chk_sem_cpf; ?>"><?php echo "<div id=\"idAjaxCheckbox_chk_sem_cpf\" style=\"display: inline-block\" class=\"css_chk_sem_cpf_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
 ...
 alt="{type: 'checkbox', enterTab: true}"<?php $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['Lookup_chk_sem_cpf'][] = 's'; ?>
<?php  if (in_array("s", $this->chk_sem_cpf_1))  { echo " checked" ;} ?> onClick="do_ajax_nfce_abertura_mob_event_chk_sem_cpf_onclick();" ><label for="<?php echo $tempOptionId ?>">s</label></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
 </TD>
   <?php }?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_disabled']['ok']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_disabled']['ok']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_label']['ok']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_label']['ok']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_label']['ok'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_label']['help'];
        }
?>
...
<?php
    if (($nm_apl_dependente != 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['dashboard_info']['under_dashboard'])) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['nm_run_menu']) || $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['nm_run_menu'] != 1))) {
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['btn_label']['exit'];
        }
?>
...
<?php
    if (($nm_apl_dependente == 1) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['dashboard_info']['under_dashboard']))) {
        $sCondStyle = ($this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
?>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("nfce_abertura_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("nfce_abertura_mob");
 parent.scAjaxDetailHeight("nfce_abertura_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
