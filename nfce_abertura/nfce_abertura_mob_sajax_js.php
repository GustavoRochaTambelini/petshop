  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_nfce_abertura_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_nfce_abertura_mob_form();
	}
...
?>
  ...
  // ---------- Validate pdv_livre
  function do_ajax_nfce_abertura_mob_validate_pdv_livre()
  {
  } // do_ajax_nfce_abertura_mob_validate_pdv_livre

  function do_ajax_nfce_abertura_mob_validate_pdv_livre_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pdv_livre";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_pdv_livre_cb

  // ---------- Validate linha1
  function do_ajax_nfce_abertura_mob_validate_linha1()
  {
  } // do_ajax_nfce_abertura_mob_validate_linha1

  function do_ajax_nfce_abertura_mob_validate_linha1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "linha1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_linha1_cb

  // ---------- Validate cpf_na_nota
  function do_ajax_nfce_abertura_mob_validate_cpf_na_nota()
  {
  } // do_ajax_nfce_abertura_mob_validate_cpf_na_nota

  function do_ajax_nfce_abertura_mob_validate_cpf_na_nota_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cpf_na_nota";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_cpf_na_nota_cb

  // ---------- Validate espaco1
  function do_ajax_nfce_abertura_mob_validate_espaco1()
  {
  } // do_ajax_nfce_abertura_mob_validate_espaco1

  function do_ajax_nfce_abertura_mob_validate_espaco1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "espaco1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_espaco1_cb

  // ---------- Validate com_cpf
  function do_ajax_nfce_abertura_mob_validate_com_cpf()
  {
  } // do_ajax_nfce_abertura_mob_validate_com_cpf

  function do_ajax_nfce_abertura_mob_validate_com_cpf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "com_cpf";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_com_cpf_cb

  // ---------- Validate espaco2
  function do_ajax_nfce_abertura_mob_validate_espaco2()
  {
  } // do_ajax_nfce_abertura_mob_validate_espaco2

  function do_ajax_nfce_abertura_mob_validate_espaco2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "espaco2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_espaco2_cb

  // ---------- Validate sem_cpf
  function do_ajax_nfce_abertura_mob_validate_sem_cpf()
  {
  } // do_ajax_nfce_abertura_mob_validate_sem_cpf

  function do_ajax_nfce_abertura_mob_validate_sem_cpf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "sem_cpf";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_sem_cpf_cb

  // ---------- Validate espaco3
  function do_ajax_nfce_abertura_mob_validate_espaco3()
  {
  } // do_ajax_nfce_abertura_mob_validate_espaco3

  function do_ajax_nfce_abertura_mob_validate_espaco3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "espaco3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_espaco3_cb

  // ---------- Validate linha2
  function do_ajax_nfce_abertura_mob_validate_linha2()
  {
  } // do_ajax_nfce_abertura_mob_validate_linha2

  function do_ajax_nfce_abertura_mob_validate_linha2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "linha2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_linha2_cb

  // ---------- Validate cpf_cnpj
  function do_ajax_nfce_abertura_mob_validate_cpf_cnpj()
  {
    var nomeCampo_cpf_cnpj = "cpf_cnpj";
    var var_cpf_cnpj = scAjaxGetFieldText(nomeCampo_cpf_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_abertura_mob_validate_cpf_cnpj(var_cpf_cnpj, var_script_case_init, do_ajax_nfce_abertura_mob_validate_cpf_cnpj_cb);
  } // do_ajax_nfce_abertura_mob_validate_cpf_cnpj

  function do_ajax_nfce_abertura_mob_validate_cpf_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_cpf_cnpj_cb

  // ---------- Validate nome
  function do_ajax_nfce_abertura_mob_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_abertura_mob_validate_nome(var_nome, var_script_case_init, do_ajax_nfce_abertura_mob_validate_nome_cb);
  } // do_ajax_nfce_abertura_mob_validate_nome

  function do_ajax_nfce_abertura_mob_validate_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_nome_cb

  // ---------- Validate email
  function do_ajax_nfce_abertura_mob_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_abertura_mob_validate_email(var_email, var_script_case_init, do_ajax_nfce_abertura_mob_validate_email_cb);
  } // do_ajax_nfce_abertura_mob_validate_email

  function do_ajax_nfce_abertura_mob_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_email_cb

  // ---------- Validate venda_id
  function do_ajax_nfce_abertura_mob_validate_venda_id()
  {
    var nomeCampo_venda_id = "venda_id";
    var var_venda_id = scAjaxGetFieldText(nomeCampo_venda_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_abertura_mob_validate_venda_id(var_venda_id, var_script_case_init, do_ajax_nfce_abertura_mob_validate_venda_id_cb);
  } // do_ajax_nfce_abertura_mob_validate_venda_id

  function do_ajax_nfce_abertura_mob_validate_venda_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "venda_id";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_venda_id_cb

  // ---------- Validate chk_com_cpf
  function do_ajax_nfce_abertura_mob_validate_chk_com_cpf()
  {
    var nomeCampo_chk_com_cpf = "chk_com_cpf";
    var var_chk_com_cpf = scAjaxGetFieldCheckbox(nomeCampo_chk_com_cpf, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_abertura_mob_validate_chk_com_cpf(var_chk_com_cpf, var_script_case_init, do_ajax_nfce_abertura_mob_validate_chk_com_cpf_cb);
  } // do_ajax_nfce_abertura_mob_validate_chk_com_cpf

  function do_ajax_nfce_abertura_mob_validate_chk_com_cpf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "chk_com_cpf";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_chk_com_cpf_cb

  // ---------- Validate chk_sem_cpf
  function do_ajax_nfce_abertura_mob_validate_chk_sem_cpf()
  {
    var nomeCampo_chk_sem_cpf = "chk_sem_cpf";
    var var_chk_sem_cpf = scAjaxGetFieldCheckbox(nomeCampo_chk_sem_cpf, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_nfce_abertura_mob_validate_chk_sem_cpf(var_chk_sem_cpf, var_script_case_init, do_ajax_nfce_abertura_mob_validate_chk_sem_cpf_cb);
  } // do_ajax_nfce_abertura_mob_validate_chk_sem_cpf

  function do_ajax_nfce_abertura_mob_validate_chk_sem_cpf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "chk_sem_cpf";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sAppErrors = scAjaxListErrors(true);
    if ("" == sAppErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_nfce_abertura_mob_validate_chk_sem_cpf_cb

  // ---------- Event onclick chk_com_cpf
  function do_ajax_nfce_abertura_mob_event_chk_com_cpf_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_nfce_abertura_mob_event_chk_com_cpf_onclick(var_cpf_cnpj, var_nome, var_email, var_script_case_init, do_ajax_nfce_abertura_mob_event_chk_com_cpf_onclick_cb);
  } // do_ajax_nfce_abertura_mob_event_chk_com_cpf_onclick

  function do_ajax_nfce_abertura_mob_event_chk_com_cpf_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "chk_com_cpf";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_nfce_abertura_mob_event_chk_com_cpf_onclick_cb_after_alert);
  } // do_ajax_nfce_abertura_mob_event_chk_com_cpf_onclick_cb
  function do_ajax_nfce_abertura_mob_event_chk_com_cpf_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_nfce_abertura_mob_event_chk_com_cpf_onclick_cb_after_alert

  // ---------- Event onclick chk_sem_cpf
  function do_ajax_nfce_abertura_mob_event_chk_sem_cpf_onclick()
  {
    var var_cpf_cnpj = scAjaxGetFieldText("cpf_cnpj");
    var var_nome = scAjaxGetFieldText("nome");
    var var_email = scAjaxGetFieldText("email");
    var var_venda_id = scAjaxGetFieldText("venda_id");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_nfce_abertura_mob_event_chk_sem_cpf_onclick(var_cpf_cnpj, var_nome, var_email, var_venda_id, var_script_case_init, do_ajax_nfce_abertura_mob_event_chk_sem_cpf_onclick_cb);
  } // do_ajax_nfce_abertura_mob_event_chk_sem_cpf_onclick

  function do_ajax_nfce_abertura_mob_event_chk_sem_cpf_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "chk_sem_cpf";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_nfce_abertura_mob_event_chk_sem_cpf_onclick_cb_after_alert);
  } // do_ajax_nfce_abertura_mob_event_chk_sem_cpf_onclick_cb
  function do_ajax_nfce_abertura_mob_event_chk_sem_cpf_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_nfce_abertura_mob_event_chk_sem_cpf_onclick_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_nfce_abertura_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_nfce_abertura_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pdv_livre = scAjaxGetFieldHidden("pdv_livre");
    var var_linha1 = scAjaxGetFieldHidden("linha1");
    var var_cpf_na_nota = scAjaxGetFieldHidden("cpf_na_nota");
    var var_espaco1 = scAjaxGetFieldHidden("espaco1");
    var var_com_cpf = scAjaxGetFieldHidden("com_cpf");
    var var_espaco2 = scAjaxGetFieldHidden("espaco2");
    var var_sem_cpf = scAjaxGetFieldHidden("sem_cpf");
    var var_espaco3 = scAjaxGetFieldHidden("espaco3");
    var var_linha2 = scAjaxGetFieldHidden("linha2");
    var var_cpf_cnpj = scAjaxGetFieldText("cpf_cnpj");
    var var_nome = scAjaxGetFieldText("nome");
    var var_email = scAjaxGetFieldText("email");
    var var_venda_id = scAjaxGetFieldText("venda_id");
    var var_chk_com_cpf = scAjaxGetFieldCheckbox("chk_com_cpf", ";");
    var var_chk_sem_cpf = scAjaxGetFieldCheckbox("chk_sem_cpf", ";");
    ...
    scAjaxProcOn();
    x_ajax_nfce_abertura_mob_submit_form(var_pdv_livre, var_linha1, var_cpf_na_nota, var_espaco1, var_com_cpf, var_espaco2, var_sem_cpf, var_espaco3, var_linha2, var_cpf_cnpj, var_nome, var_email, var_venda_id, var_chk_com_cpf, var_chk_sem_cpf, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_nfce_abertura_mob_submit_form_cb);
  } // do_ajax_nfce_abertura_mob_submit_form

  function do_ajax_nfce_abertura_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_nfce_abertura_mob_submit_form_cb_after_alert);
  } // do_ajax_nfce_abertura_mob_submit_form_cb
  function do_ajax_nfce_abertura_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_nfce_abertura_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_nfce_abertura_mob_navigate_form()
  {
    perform_ajax_nfce_abertura_mob_navigate_form();
  }

  function perform_ajax_nfce_abertura_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_nfce_abertura_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['nfce_abertura_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_nfce_abertura_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_nfce_abertura_mob_navigate_form_cb_after_alert);
  } // do_ajax_nfce_abertura_mob_navigate_form_cb
  function do_ajax_nfce_abertura_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_nfce_abertura_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_nfce_abertura_mob_navigate_form_cb_after_alert

  function sc_hide_nfce_abertura_mob_form()
  {
  ...
  ajax_field_list[0] = "pdv_livre";
  ajax_field_list[1] = "linha1";
  ajax_field_list[2] = "cpf_na_nota";
  ajax_field_list[3] = "espaco1";
  ajax_field_list[4] = "com_cpf";
  ajax_field_list[5] = "espaco2";
  ajax_field_list[6] = "sem_cpf";
  ajax_field_list[7] = "espaco3";
  ajax_field_list[8] = "linha2";
  ajax_field_list[9] = "cpf_cnpj";
  ajax_field_list[10] = "nome";
  ajax_field_list[11] = "email";
  ajax_field_list[12] = "venda_id";
  ajax_field_list[13] = "chk_com_cpf";
  ajax_field_list[14] = "chk_sem_cpf";
  ...
  var ajax_error_list = {
    "pdv_livre": {"label": "pdv_livre", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "linha1": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "cpf_na_nota": {"label": "cpf_na_nota", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "espaco1": {"label": "espaco1", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "com_cpf": {"label": "com_cpf", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "espaco2": {"label": "espaco2", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sem_cpf": {"label": "sem_cpf", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "espaco3": {"label": "espaco3", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "linha2": {"label": "linha2", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "nome": {"label": "Nome/Razão Social", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "email": {"label": "e-mail", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "venda_id": {"label": "venda_id", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "chk_com_cpf": {"label": "chk_com_cpf", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "chk_sem_cpf": {"label": "chk_sem_cpf", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "email": new Array(),
    "venda_id": new Array(),
    "chk_com_cpf": new Array(),
    "chk_sem_cpf": new Array()
  };
  ajax_field_mult["pdv_livre"][1] = "pdv_livre";
  ajax_field_mult["linha1"][1] = "linha1";
  ajax_field_mult["cpf_na_nota"][1] = "cpf_na_nota";
  ajax_field_mult["espaco1"][1] = "espaco1";
  ajax_field_mult["com_cpf"][1] = "com_cpf";
  ajax_field_mult["espaco2"][1] = "espaco2";
  ajax_field_mult["sem_cpf"][1] = "sem_cpf";
  ajax_field_mult["espaco3"][1] = "espaco3";
  ajax_field_mult["linha2"][1] = "linha2";
  ajax_field_mult["cpf_cnpj"][1] = "cpf_cnpj";
  ajax_field_mult["nome"][1] = "nome";
  ajax_field_mult["email"][1] = "email";
  ajax_field_mult["venda_id"][1] = "venda_id";
  ajax_field_mult["chk_com_cpf"][1] = "chk_com_cpf";
  ajax_field_mult["chk_sem_cpf"][1] = "chk_sem_cpf";

  var ajax_field_id = {
    "pdv_livre": new Array("hidden_field_label_pdv_livre", "hidden_field_data_pdv_livre"),
    "linha1": new Array("hidden_field_label_linha1", "hidden_field_data_linha1"),
    "cpf_na_nota": new Array("hidden_field_label_cpf_na_nota", "hidden_field_data_cpf_na_nota"),
    "espaco1": new Array("hidden_field_label_espaco1", "hidden_field_data_espaco1"),
    "com_cpf": new Array("hidden_field_label_com_cpf", "hidden_field_data_com_cpf"),
    "espaco2": new Array("hidden_field_label_espaco2", "hidden_field_data_espaco2"),
    "sem_cpf": new Array("hidden_field_label_sem_cpf", "hidden_field_data_sem_cpf"),
    "espaco3": new Array("hidden_field_label_espaco3", "hidden_field_data_espaco3"),
    "linha2": new Array("hidden_field_label_linha2", "hidden_field_data_linha2"),
