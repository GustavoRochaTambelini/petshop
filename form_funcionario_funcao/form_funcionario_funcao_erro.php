...
$old_error_handler = set_error_handler("form_funcionario_funcao_scriptcase_error_handler");

function form_funcionario_funcao_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe="")
{
    ...
    if (isset($_SESSION['scriptcase']['form_funcionario_funcao']['contr_erro']) && $_SESSION['scriptcase']['form_funcionario_funcao']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_form_funcionario_funcao->contr_form_funcionario_funcao->Apl_com_erro = true;
            if ($inicial_form_funcionario_funcao->contr_form_funcionario_funcao->NM_ajax_flag)
            {
                $inicial_form_funcionario_funcao->contr_form_funcionario_funcao->NM_ajax_info['errList']['geral_form_funcionario_funcao'][] = $msg;
                return;
            }
            form_funcionario_funcao_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function form_funcionario_funcao_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['form_funcionario_funcao'])  && '' != $_SESSION['scriptcase']['error_icon']['form_funcionario_funcao'])  ? $_SESSION['scriptcase']['error_icon']['form_funcionario_funcao']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['form_funcionario_funcao']) && '' != $_SESSION['scriptcase']['error_close']['form_funcionario_funcao']) ? $_SESSION['scriptcase']['error_close']['form_funcionario_funcao'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['form_funcionario_funcao']) && '' != $_SESSION['scriptcase']['error_span_title']['form_funcionario_funcao']) ? $_SESSION['scriptcase']['error_span_title']['form_funcionario_funcao'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['form_funcionario_funcao']) && '' != $_SESSION['scriptcase']['error_icon_title']['form_funcionario_funcao']) ? $_SESSION['scriptcase']['error_icon_title']['form_funcionario_funcao'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['form_funcionario_funcao']['error_buffer'] .= ob_get_flush();
}
