  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_classificacao_obs_pet_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_classificacao_obs_pet_mob_form();
	}
...
?>
  ...
  // ---------- Validate idclassificacao_obs_pet
  function do_ajax_form_classificacao_obs_pet_mob_validate_idclassificacao_obs_pet()
  {
    var nomeCampo_idclassificacao_obs_pet = "idclassificacao_obs_pet";
    var var_idclassificacao_obs_pet = scAjaxGetFieldHidden(nomeCampo_idclassificacao_obs_pet);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_classificacao_obs_pet_mob_validate_idclassificacao_obs_pet(var_idclassificacao_obs_pet, var_script_case_init, do_ajax_form_classificacao_obs_pet_mob_validate_idclassificacao_obs_pet_cb);
  } // do_ajax_form_classificacao_obs_pet_mob_validate_idclassificacao_obs_pet

  function do_ajax_form_classificacao_obs_pet_mob_validate_idclassificacao_obs_pet_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idclassificacao_obs_pet";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_classificacao_obs_pet_mob_validate_idclassificacao_obs_pet_cb

  // ---------- Validate descricao
  function do_ajax_form_classificacao_obs_pet_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_classificacao_obs_pet_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_classificacao_obs_pet_mob_validate_descricao_cb);
  } // do_ajax_form_classificacao_obs_pet_mob_validate_descricao

  function do_ajax_form_classificacao_obs_pet_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_classificacao_obs_pet_mob_validate_descricao_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_classificacao_obs_pet_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_classificacao_obs_pet_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idclassificacao_obs_pet = scAjaxGetFieldHidden("idclassificacao_obs_pet");
    ...
    scAjaxProcOn();
    x_ajax_form_classificacao_obs_pet_mob_submit_form(var_idclassificacao_obs_pet, var_descricao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_classificacao_obs_pet_mob_submit_form_cb);
  } // do_ajax_form_classificacao_obs_pet_mob_submit_form

  function do_ajax_form_classificacao_obs_pet_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idclassificacao_obs_pet");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_classificacao_obs_pet_mob_submit_form_cb_after_alert);
  } // do_ajax_form_classificacao_obs_pet_mob_submit_form_cb
  function do_ajax_form_classificacao_obs_pet_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_classificacao_obs_pet_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_classificacao_obs_pet_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_classificacao_obs_pet_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_classificacao_obs_pet_mob_navigate_form();
    }
  }

  function perform_ajax_form_classificacao_obs_pet_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("idclassificacao_obs_pet");
    scAjaxHideErrorDisplay("descricao");
    var var_idclassificacao_obs_pet = document.F2.idclassificacao_obs_pet.value;
    ...
    scAjaxProcOn();
    x_ajax_form_classificacao_obs_pet_mob_navigate_form(var_idclassificacao_obs_pet, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_classificacao_obs_pet_mob_navigate_form_cb);
  } // do_ajax_form_classificacao_obs_pet_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_classificacao_obs_pet_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_classificacao_obs_pet_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idclassificacao_obs_pet.value = scAjaxGetKeyValue("idclassificacao_obs_pet");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_classificacao_obs_pet_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_classificacao_obs_pet_mob_navigate_form_cb
  function do_ajax_form_classificacao_obs_pet_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_classificacao_obs_pet_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_classificacao_obs_pet_mob_navigate_form_cb_after_alert

  function sc_hide_form_classificacao_obs_pet_mob_form()
  {
  ...
  ajax_field_list[0] = "idclassificacao_obs_pet";
  ...
  var ajax_error_list = {
    "idclassificacao_obs_pet": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "idclassificacao_obs_pet": new Array(),
    "descricao": new Array()
  };
  ajax_field_mult["idclassificacao_obs_pet"][1] = "idclassificacao_obs_pet";
  ajax_field_mult["descricao"][1] = "descricao";

  var ajax_field_id = {
    "idclassificacao_obs_pet": new Array("hidden_field_label_idclassificacao_obs_pet", "hidden_field_data_idclassificacao_obs_pet"),
    "descricao": new Array("hidden_field_label_descricao", "hidden_field_data_descricao")
  };

  var ajax_read_only = {
    "idclassificacao_obs_pet": "on",
    "descricao": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idclassificacao_obs_pet" == sIndex)
    {
