...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_pacote_itens"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_pacote_itens"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pacote_itens']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_pacote_itens']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_pacote_itens']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_pacote_itens']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_pacote_itens']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_pacote_itens']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_pacote_itens']['embutida_filho'] as $ind => $sc_init)
          {
