<div id="form_cliente_etapas_mob_form3" style='<?php echo (3 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['form_wizard']['actual_step'] ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_indicacao_line" id="hidden_field_data_indicacao" style="<?php echo $sStyleHidden_indicacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_indicacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_indicacao_label" style=""><span id="id_label_indicacao"><?php echo $this->nm_new_label['indicacao']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_uf_line" id="hidden_field_data_uf" style="<?php echo $sStyleHidden_uf; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_uf_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_uf_label" style=""><span id="id_label_uf"><?php echo $this->nm_new_label['uf']; ?></span></span><br>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_disabled']['bstepretorna']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_disabled']['bstepretorna']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['bstepretorna']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['bstepretorna']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['bstepretorna'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_disabled']['bstepavanca']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_disabled']['bstepavanca']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['bstepavanca']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['bstepavanca']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['bstepavanca'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['btn_label']['exit'];
        }
?>
...
$(function() {
    if ('page' == wizardViewMode) {
        scJQWizardGoToPage(<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['form_wizard']['actual_step']; ?>);
        $(".sc-form-page").on("click", function() {
            var thisStepNo = $(this).attr("id").substr(16);
            scJQWizardPageClick(thisStepNo);
        });
    } else {
        scJQWizardGoToStep(<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['form_wizard']['actual_step']; ?>);
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_cliente_etapas_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_cliente_etapas_mob");
 parent.scAjaxDetailHeight("form_cliente_etapas_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_stepret() {
		...
		if ($("#sc_b_stepret_b.sc-unique-btn-6").length && $("#sc_b_stepret_b.sc-unique-btn-6").is(":visible")) {
		    if ($("#sc_b_stepret_b.sc-unique-btn-6").hasClass("disabled")) {
		        return;
		    }
			scJQWizardGoToPreviousStep()
			toggleToolbar(event, true); return;
	...
	function scBtnFn_sys_format_stepava() {
		...
		if ($("#sc_b_stepavc_b.sc-unique-btn-7").length && $("#sc_b_stepavc_b.sc-unique-btn-7").is(":visible")) {
		    if ($("#sc_b_stepavc_b.sc-unique-btn-7").hasClass("disabled")) {
		        return;
		    }
			scJQWizardGoToNextStep()
			toggleToolbar(event, true); return;
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
