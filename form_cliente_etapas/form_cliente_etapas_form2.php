<div id="form_cliente_etapas_form2" style='<?php echo (2 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['form_wizard']['actual_step'] ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
