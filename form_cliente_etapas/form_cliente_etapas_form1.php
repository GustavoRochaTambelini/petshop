<div id="form_cliente_etapas_form1" style='<?php echo (1 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['form_wizard']['actual_step'] ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_logradouro_line" id="hidden_field_data_logradouro" style="<?php echo $sStyleHidden_logradouro; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_logradouro_line" style="vertical-align: top;padding: 0px">
