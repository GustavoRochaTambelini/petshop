...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['parms'])) {echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['parms']);} ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_cliente_etapas"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['where_detal']))
  {
?>  
...
{
    document.getElementById('form_cliente_etapas_form0').style.width='1px';
    document.getElementById('form_cliente_etapas_form0').style.height='0px';
    document.getElementById('form_cliente_etapas_form0').style.display='none';
    document.getElementById('form_cliente_etapas_form0').style.overflow='scroll';
    document.getElementById('form_cliente_etapas_form1').style.width='1px';
    document.getElementById('form_cliente_etapas_form1').style.height='0px';
    document.getElementById('form_cliente_etapas_form1').style.display='none';
    document.getElementById('form_cliente_etapas_form1').style.overflow='scroll';
    document.getElementById('form_cliente_etapas_form2').style.width='1px';
    document.getElementById('form_cliente_etapas_form2').style.height='0px';
    document.getElementById('form_cliente_etapas_form2').style.display='none';
    document.getElementById('form_cliente_etapas_form2').style.overflow='scroll';
    document.getElementById('form_cliente_etapas_form3').style.width='1px';
    document.getElementById('form_cliente_etapas_form3').style.height='0px';
    document.getElementById('form_cliente_etapas_form3').style.display='none';
    document.getElementById('form_cliente_etapas_form3').style.overflow='scroll';
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['pdf_view']) {
?>
