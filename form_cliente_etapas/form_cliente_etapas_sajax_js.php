  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_cliente_etapas" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_cliente_etapas_form();
	}
...
?>
  ...
  // ---------- Validate idcliente
  function do_ajax_form_cliente_etapas_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldHidden(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_etapas_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_cliente_etapas_validate_idcliente_cb);
  } // do_ajax_form_cliente_etapas_validate_idcliente

  function do_ajax_form_cliente_etapas_validate_idcliente_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_etapas_validate_idcliente_cb

  // ---------- Validate cidade_idcidade
  function do_ajax_form_cliente_etapas_validate_cidade_idcidade()
  {
    var nomeCampo_cidade_idcidade = "cidade_idcidade";
    var var_cidade_idcidade = scAjaxGetFieldText(nomeCampo_cidade_idcidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_etapas_validate_cidade_idcidade(var_cidade_idcidade, var_script_case_init, do_ajax_form_cliente_etapas_validate_cidade_idcidade_cb);
  } // do_ajax_form_cliente_etapas_validate_cidade_idcidade

  function do_ajax_form_cliente_etapas_validate_cidade_idcidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_etapas_validate_cidade_idcidade_cb

  // ---------- Validate cpf_cnpj
  function do_ajax_form_cliente_etapas_validate_cpf_cnpj()
  {
    var nomeCampo_cpf_cnpj = "cpf_cnpj";
    var var_cpf_cnpj = scAjaxGetFieldText(nomeCampo_cpf_cnpj);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_etapas_validate_cpf_cnpj(var_cpf_cnpj, var_script_case_init, do_ajax_form_cliente_etapas_validate_cpf_cnpj_cb);
  } // do_ajax_form_cliente_etapas_validate_cpf_cnpj

  function do_ajax_form_cliente_etapas_validate_cpf_cnpj_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_etapas_validate_cpf_cnpj_cb

  // ---------- Validate nome_fantasia
  function do_ajax_form_cliente_etapas_validate_nome_fantasia()
  {
    var nomeCampo_nome_fantasia = "nome_fantasia";
    var var_nome_fantasia = scAjaxGetFieldText(nomeCampo_nome_fantasia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_etapas_validate_nome_fantasia(var_nome_fantasia, var_script_case_init, do_ajax_form_cliente_etapas_validate_nome_fantasia_cb);
  } // do_ajax_form_cliente_etapas_validate_nome_fantasia

  function do_ajax_form_cliente_etapas_validate_nome_fantasia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_etapas_validate_nome_fantasia_cb

  // ---------- Validate razao_social
  function do_ajax_form_cliente_etapas_validate_razao_social()
  {
    var nomeCampo_razao_social = "razao_social";
    var var_razao_social = scAjaxGetFieldText(nomeCampo_razao_social);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_etapas_validate_razao_social(var_razao_social, var_script_case_init, do_ajax_form_cliente_etapas_validate_razao_social_cb);
  } // do_ajax_form_cliente_etapas_validate_razao_social

  function do_ajax_form_cliente_etapas_validate_razao_social_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_etapas_validate_razao_social_cb

  // ---------- Validate data_nascimento
  function do_ajax_form_cliente_etapas_validate_data_nascimento()
  {
    var nomeCampo_data_nascimento = "data_nascimento";
    var var_data_nascimento = scAjaxGetFieldText(nomeCampo_data_nascimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_etapas_validate_data_nascimento(var_data_nascimento, var_script_case_init, do_ajax_form_cliente_etapas_validate_data_nascimento_cb);
  } // do_ajax_form_cliente_etapas_validate_data_nascimento

  function do_ajax_form_cliente_etapas_validate_data_nascimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_etapas_validate_data_nascimento_cb

  // ---------- Validate logradouro
  function do_ajax_form_cliente_etapas_validate_logradouro()
  {
    var nomeCampo_logradouro = "logradouro";
    var var_logradouro = scAjaxGetFieldText(nomeCampo_logradouro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_etapas_validate_logradouro(var_logradouro, var_script_case_init, do_ajax_form_cliente_etapas_validate_logradouro_cb);
  } // do_ajax_form_cliente_etapas_validate_logradouro

  function do_ajax_form_cliente_etapas_validate_logradouro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_etapas_validate_logradouro_cb

  // ---------- Validate numero
  function do_ajax_form_cliente_etapas_validate_numero()
  {
    var nomeCampo_numero = "numero";
    var var_numero = scAjaxGetFieldText(nomeCampo_numero);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_etapas_validate_numero(var_numero, var_script_case_init, do_ajax_form_cliente_etapas_validate_numero_cb);
  } // do_ajax_form_cliente_etapas_validate_numero

  function do_ajax_form_cliente_etapas_validate_numero_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "numero";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_etapas_validate_numero_cb

  // ---------- Validate bairro
  function do_ajax_form_cliente_etapas_validate_bairro()
  {
    var nomeCampo_bairro = "bairro";
    var var_bairro = scAjaxGetFieldText(nomeCampo_bairro);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_etapas_validate_bairro(var_bairro, var_script_case_init, do_ajax_form_cliente_etapas_validate_bairro_cb);
  } // do_ajax_form_cliente_etapas_validate_bairro

  function do_ajax_form_cliente_etapas_validate_bairro_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bairro";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_etapas_validate_bairro_cb

  // ---------- Validate email
  function do_ajax_form_cliente_etapas_validate_email()
  {
    var nomeCampo_email = "email";
    var var_email = scAjaxGetFieldText(nomeCampo_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_etapas_validate_email(var_email, var_script_case_init, do_ajax_form_cliente_etapas_validate_email_cb);
  } // do_ajax_form_cliente_etapas_validate_email

  function do_ajax_form_cliente_etapas_validate_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_etapas_validate_email_cb

  // ---------- Validate indicacao
  function do_ajax_form_cliente_etapas_validate_indicacao()
  {
    var nomeCampo_indicacao = "indicacao";
    var var_indicacao = scAjaxGetFieldText(nomeCampo_indicacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_etapas_validate_indicacao(var_indicacao, var_script_case_init, do_ajax_form_cliente_etapas_validate_indicacao_cb);
  } // do_ajax_form_cliente_etapas_validate_indicacao

  function do_ajax_form_cliente_etapas_validate_indicacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_etapas_validate_indicacao_cb

  // ---------- Validate cep
  function do_ajax_form_cliente_etapas_validate_cep()
  {
    var nomeCampo_cep = "cep";
    var var_cep = scAjaxGetFieldText(nomeCampo_cep);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_etapas_validate_cep(var_cep, var_script_case_init, do_ajax_form_cliente_etapas_validate_cep_cb);
  } // do_ajax_form_cliente_etapas_validate_cep

  function do_ajax_form_cliente_etapas_validate_cep_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cep";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_etapas_validate_cep_cb

  // ---------- Validate uf
  function do_ajax_form_cliente_etapas_validate_uf()
  {
    var nomeCampo_uf = "uf";
    var var_uf = scAjaxGetFieldText(nomeCampo_uf);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_cliente_etapas_validate_uf(var_uf, var_script_case_init, do_ajax_form_cliente_etapas_validate_uf_cb);
  } // do_ajax_form_cliente_etapas_validate_uf

  function do_ajax_form_cliente_etapas_validate_uf_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "uf";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_cliente_etapas_validate_uf_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_cliente_etapas_submit_page_0(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cliente_etapas_submit_page_0(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      url: "form_cliente_etapas.php",
      method: "POST",
      dataType: "json",
      data: {
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_cliente_etapas_submit_page_cb_0(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_cliente_etapas_submit_page_0

  function do_ajax_form_cliente_etapas_submit_page_cb_0(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
  ...
  } // do_ajax_form_cliente_etapas_submit_page_cb_0

  function do_ajax_form_cliente_etapas_submit_page_1(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cliente_etapas_submit_page_1(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_cliente_etapas_submit_page_cb_1(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_cliente_etapas_submit_page_1

  function do_ajax_form_cliente_etapas_submit_page_cb_1(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_cliente_etapas_submit_page_cb_1

  function do_ajax_form_cliente_etapas_submit_page_2(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cliente_etapas_submit_page_2(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_cliente_etapas_submit_page_cb_2(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_cliente_etapas_submit_page_2

  function do_ajax_form_cliente_etapas_submit_page_cb_2(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_cliente_etapas_submit_page_cb_2

  function do_ajax_form_cliente_etapas_submit_page_3(stepGoTo) {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cliente_etapas_submit_page_3(stepGoTo); }, 500);
      return;
    }
    scAjaxHideMessage();
    scAjaxProcOn();
    $.ajax({
      ...
      success: function(data, textStatus, jqXHR) {
        do_ajax_form_cliente_etapas_submit_page_cb_3(data);
      },
      error: function(jqXHR, textStatus, errorThrown) {
      },
    });
  } // do_ajax_form_cliente_etapas_submit_page_3

  function do_ajax_form_cliente_etapas_submit_page_cb_3(data) {
    scAjaxProcOff();
    oResp = data;
    scAjaxClearErrors();
    scAjaxUpdateErrors("valid");
  ...
  } // do_ajax_form_cliente_etapas_submit_page_cb_3

  function do_ajax_form_cliente_etapas_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_cliente_etapas_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_cliente_etapas_submit_form(var_idcliente, var_cidade_idcidade, var_cpf_cnpj, var_nome_fantasia, var_razao_social, var_data_nascimento, var_logradouro, var_numero, var_bairro, var_email, var_indicacao, var_cep, var_uf, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_cliente_etapas_submit_form_cb);
  } // do_ajax_form_cliente_etapas_submit_form

  function do_ajax_form_cliente_etapas_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxUpdateErrors("valid");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_cliente_etapas_submit_form_cb_after_alert);
  } // do_ajax_form_cliente_etapas_submit_form_cb
  function do_ajax_form_cliente_etapas_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_cliente_etapas_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_cliente_etapas_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_cliente_etapas_navigate_form, function() {});
    } else {
      perform_ajax_form_cliente_etapas_navigate_form();
    }
  }

  function perform_ajax_form_cliente_etapas_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_cliente_etapas_navigate_form(var_idcliente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_cliente_etapas_navigate_form_cb);
  } // do_ajax_form_cliente_etapas_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_cliente_etapas_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_cliente_etapas_navigate_form_cb_after_alert);
  } // do_ajax_form_cliente_etapas_navigate_form_cb
  function do_ajax_form_cliente_etapas_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_cliente_etapas_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_cliente_etapas_navigate_form_cb_after_alert

  function sc_hide_form_cliente_etapas_form()
  {
