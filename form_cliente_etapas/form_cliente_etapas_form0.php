...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['embutida_pdf']))
 {
 ?>
 <link rel="stylesheet" type="text/css" href="form_cliente_etapas_wizard.css" />
<?php
if ($_SESSION['scriptcase']['device_mobile'] && $_SESSION['scriptcase']['display_mobile']) {
?>
 <link rel="stylesheet" type="text/css" href="form_cliente_etapas_wizard_mobile.css" />
<?php
}
?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_cliente_etapas/form_cliente_etapas_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_cliente_etapas_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_cliente_etapas_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['link_info']['remove_border']) {
...
<?php
 include_once("form_cliente_etapas_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_cliente_etapas'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_cliente_etapas'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<div id="form_cliente_etapas_form0" style='<?php echo (0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_cliente_etapas']['form_wizard']['actual_step'] ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['idcliente'] = "Idcliente";
    }
?>
<?php
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['cidade_idcidade'] = "Cidade Idcidade";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<input type="hidden" name="cidade_idcidade" value="<?php echo $this->form_encode_input($cidade_idcidade) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormLabelOdd scUiLabelWidthFix css_cidade_idcidade_label" id="hidden_field_label_cidade_idcidade" style="<?php echo $sStyleHidden_cidade_idcidade; ?>"><span id="id_label_cidade_idcidade"><?php echo $this->nm_new_label['cidade_idcidade']; ?></span></TD>
    <TD class="scFormDataOdd css_cidade_idcidade_line" id="hidden_field_data_cidade_idcidade" style="<?php echo $sStyleHidden_cidade_idcidade; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cidade_idcidade_line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["cidade_idcidade"]) &&  $this->nmgp_cmp_readonly["cidade_idcidade"] == "on") { 
 ...
 ?>
<input type="hidden" name="cidade_idcidade" value="<?php echo $this->form_encode_input($cidade_idcidade) . "\">" . $cidade_idcidade . ""; ?>
<?php } else { ?>
<span id="id_read_on_cidade_idcidade" class="sc-ui-readonly-cidade_idcidade css_cidade_idcidade_line" style="<?php echo $sStyleReadLab_cidade_idcidade; ?>"><?php echo $this->form_format_readonly("cidade_idcidade", $this->form_encode_input($this->cidade_idcidade)); ?></span><span id="id_read_off_cidade_idcidade" class="css_read_off_cidade_idcidade<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_cidade_idcidade; ?>">
 <input class="sc-js-input scFormObjectOdd css_cidade_idcidade_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_cidade_idcidade" type=text name="cidade_idcidade" value="<?php echo $this->form_encode_input($cidade_idcidade) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['cidade_idcidade']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['cidade_idcidade']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['cidade_idcidade']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_nome_fantasia_label" id="hidden_field_label_nome_fantasia" style="<?php echo $sStyleHidden_nome_fantasia; ?>"><span id="id_label_nome_fantasia"><?php echo $this->nm_new_label['nome_fantasia']; ?></span></TD>
    <TD class="scFormDataOdd css_nome_fantasia_line" id="hidden_field_data_nome_fantasia" style="<?php echo $sStyleHidden_nome_fantasia; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nome_fantasia_line" style="vertical-align: top;padding: 0px">
