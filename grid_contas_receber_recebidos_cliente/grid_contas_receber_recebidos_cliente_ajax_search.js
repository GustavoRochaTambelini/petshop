...
Table_sv_fil[0] = "data_emissao";
Table_sv_fil[1] = "data_vencimento";
Table_sv_fil[2] = "data_pagamento";
function ajax_select_filter(parm)
{
    ...
    $.ajax({
     ...
     .done(function(json_sel_fil) {
        ...
        if ($("#SC_data_emissao_cond") && search_get_sel_txt("SC_data_emissao_cond").substring(0, 3) == "bi_") {
            formata_bi_data_emissao(search_get_sel_txt("SC_data_emissao_cond"), SC_data_emissao_bi_opc, SC_data_emissao_bi_dt);
        }
        if ($("#SC_data_vencimento_cond") && search_get_sel_txt("SC_data_vencimento_cond").substring(0, 3) == "bi_") {
            formata_bi_data_vencimento(search_get_sel_txt("SC_data_vencimento_cond"), SC_data_vencimento_bi_opc, SC_data_vencimento_bi_dt);
        }
        if ($("#SC_data_pagamento_cond") && search_get_sel_txt("SC_data_pagamento_cond").substring(0, 3) == "bi_") {
            formata_bi_data_pagamento(search_get_sel_txt("SC_data_pagamento_cond"), SC_data_pagamento_bi_opc, SC_data_pagamento_bi_dt);
        }
