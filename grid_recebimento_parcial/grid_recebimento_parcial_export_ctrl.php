<?php
@session_start() ;
$_SESSION['scriptcase']['grid_recebimento_parcial']['sc_process_barr'] = true;
require_once('../grid_recebimento_parcial/index.php');
unset($_SESSION['scriptcase']['grid_recebimento_parcial']['sc_process_barr']);
$ExportCtrl = new grid_recebimento_parcial_export_control;
$ExportCtrl->Export_barr();

class grid_recebimento_parcial_export_control
{
