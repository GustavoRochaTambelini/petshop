...
class grid_recebimento_parcial_rtf
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo   .= ".rtf";
      $this->Tit_doc    = "grid_recebimento_parcial.rtf";
   }
   //---- 
   ...
   function gera_texto_tag()
   {
     global $nm_lang;
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recebimento_parcial']['rtf_name']))
      {
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recebimento_parcial']['rtf_name'], ".");
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recebimento_parcial']['rtf_name'] .= ".rtf";
          }
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recebimento_parcial']['rtf_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recebimento_parcial']['rtf_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recebimento_parcial']['rtf_name']);
      }
   ...
   function NM_export_idrecebimento_parcial()
   {
         ...
         $this->idrecebimento_parcial = str_replace('<', '&lt;', $this->idrecebimento_parcial);
         $this->idrecebimento_parcial = str_replace('>', '&gt;', $this->idrecebimento_parcial);
         $this->Texto_tag .= "<td>" . $this->idrecebimento_parcial . "</td>\r\n";
   }
   //----- idforma_pagamento
   ...
   {
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_recebimento_parcial']['rtf_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_recebimento_parcial']['rtf_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
