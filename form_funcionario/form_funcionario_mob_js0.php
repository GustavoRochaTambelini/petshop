<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="idfuncionario" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idfuncionario']); ?>">
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_mob']['where_detal']))
  {
?>  
