...
//----- 
   function ini_controle()
   {
      ...
      { 
          ...
          if (!isset($_SESSION['sc_session'][$script_case_init]['form_funcionario']['total']))
          {
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_funcionario']['form_funcionario_funcao_script_case_init'] ]['form_funcionario_funcao']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$script_case_init]['form_funcionario']['form_funcionario_funcao_script_case_init'] ]['form_funcionario_funcao']['total']);
          }
      ...
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['sc_outra_jan']))
      {
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_funcionario']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_funcionario']['label'] = "ALTERAR FUNCIONARIO";
      ...
      $_SESSION['scriptcase']['error_icon']['form_funcionario']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
...
//
      if ($this->nmgp_opcao == "excluir")
      {
          ...
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['form_funcionario_funcao_script_case_init'] ]['form_funcionario_funcao']['embutida_form'] = false;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['form_funcionario_funcao_script_case_init'] ]['form_funcionario_funcao']['embutida_proc'] = true;
          $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['form_funcionario_funcao_script_case_init'] ]['form_funcionario_funcao']['reg_start'] = "";
          unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['form_funcionario_funcao_script_case_init'] ]['form_funcionario_funcao']['total']);
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_funcionario_funcao') . "/index.php");
          require_once($this->Ini->root . $this->Ini->path_link  . SC_dir_app_name('form_funcionario_funcao') . "/form_funcionario_funcao_apl.php");
          $this->form_funcionario_funcao = new form_funcionario_funcao_apl;
      }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idfuncionario']['keyVal'] = form_funcionario_pack_protect_string($this->nmgp_dados_form['idfuncionario']);
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['form_funcionario_funcao_script_case_init'] ]['form_funcionario_funcao']['foreign_key']['idfuncionario'] = $this->nmgp_dados_form['idfuncionario'];
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['form_funcionario_funcao_script_case_init'] ]['form_funcionario_funcao']['where_filter'] = "idfuncionario = " . $this->nmgp_dados_form['idfuncionario'] . "";
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['form_funcionario_funcao_script_case_init'] ]['form_funcionario_funcao']['where_detal']  = "idfuncionario = " . $this->nmgp_dados_form['idfuncionario'] . "";
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['total'] < 0)
              {
                  $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['form_funcionario_funcao_script_case_init'] ]['form_funcionario_funcao']['where_filter'] = "1 <> 1";
              }
              $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['form_funcionario_funcao_script_case_init'] ]['form_funcionario_funcao']['reg_start'] = "";
              unset($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['form_funcionario_funcao_script_case_init'] ]['form_funcionario_funcao']['total']);
          }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['total']))
          {
...
;
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_funcionario';
...
$_SESSION['scriptcase']['form_funcionario']['contr_erro'] = 'off'; 
      ...
      { 
          ...
          if ($bDelecaoOk)
          {
              ...
              $this->form_funcionario_funcao->ini_controle();
              if ($this->form_funcionario_funcao->temRegistros($sDetailWhere))
              {
                  $bDelecaoOk = false;
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario']['parms'] = "idfuncionario?#?$this->idfuncionario?@?"; 
      }
      $this->NM_commit_db(); 
...
//-- 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcionario_funcao']['embutida_parms'] = "NM_btn_insert*scinS*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
  }
