...
?>
  ...
  function do_ajax_form_funcionario_validate_idfuncionario()
  {
    var nomeCampo_idfuncionario = "idfuncionario";
    var var_idfuncionario = scAjaxGetFieldHidden(nomeCampo_idfuncionario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_idfuncionario(var_idfuncionario, var_script_case_init, do_ajax_form_funcionario_validate_idfuncionario_cb);
  } // do_ajax_form_funcionario_validate_idfuncionario

  function do_ajax_form_funcionario_validate_idfuncionario_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_idfuncionario_cb
  ...
  // ---------- Validate data_admissao
  function do_ajax_form_funcionario_validate_data_admissao()
  {
    var nomeCampo_data_admissao = "data_admissao";
    var var_data_admissao = scAjaxGetFieldText(nomeCampo_data_admissao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_data_admissao(var_data_admissao, var_script_case_init, do_ajax_form_funcionario_validate_data_admissao_cb);
  } // do_ajax_form_funcionario_validate_data_admissao

  function do_ajax_form_funcionario_validate_data_admissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_admissao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_data_admissao_cb

  // ---------- Validate data_demissao
  function do_ajax_form_funcionario_validate_data_demissao()
  {
    var nomeCampo_data_demissao = "data_demissao";
    var var_data_demissao = scAjaxGetFieldText(nomeCampo_data_demissao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_data_demissao(var_data_demissao, var_script_case_init, do_ajax_form_funcionario_validate_data_demissao_cb);
  } // do_ajax_form_funcionario_validate_data_demissao

  function do_ajax_form_funcionario_validate_data_demissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_demissao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_data_demissao_cb

  // ---------- Validate inf_funcao
  function do_ajax_form_funcionario_validate_inf_funcao()
  {
    var nomeCampo_inf_funcao = "inf_funcao";
    var var_inf_funcao = scAjaxGetFieldText(nomeCampo_inf_funcao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_validate_inf_funcao(var_inf_funcao, var_script_case_init, do_ajax_form_funcionario_validate_inf_funcao_cb);
  } // do_ajax_form_funcionario_validate_inf_funcao

  function do_ajax_form_funcionario_validate_inf_funcao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "inf_funcao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_validate_inf_funcao_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_funcionario_submit_form()
  {
    ...
    scAjaxHideMessage();
    var var_idfuncionario = scAjaxGetFieldHidden("idfuncionario");
    var var_cpf = scAjaxGetFieldText("cpf");
    var var_nome = scAjaxGetFieldText("nome");
    var var_data_admissao = scAjaxGetFieldText("data_admissao");
    var var_data_demissao = scAjaxGetFieldText("data_demissao");
    ...
    scAjaxProcOn();
    x_ajax_form_funcionario_submit_form(var_idfuncionario, var_cpf, var_nome, var_data_admissao, var_data_demissao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_funcionario_submit_form_cb);
  ...
  function do_ajax_form_funcionario_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("data_admissao");
      scAjaxHideErrorDisplay("data_demissao");
      scAjaxHideErrorDisplay("inf_funcao");
      scLigEditLookupCall();
<?php
...
?>
  ...
  var scStatusDetail = {};
  scStatusDetail["form_funcionario_funcao"] = "off";
  ...
  function perform_ajax_form_funcionario_navigate_form()
  {
    ...
    scAjaxHideErrorDisplay("data_demissao");
    scAjaxHideErrorDisplay("inf_funcao");
    var var_idfuncionario = document.F2.idfuncionario.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_funcionario_funcao"] = "on";
    x_ajax_form_funcionario_navigate_form(var_idfuncionario, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_funcionario_navigate_form_cb);
...
?>
  function do_ajax_form_funcionario_navigate_form_cb(sResp)
  {
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_funcionario_funcao"] && "nmsc_iframe_liga_form_funcionario_funcao" != scMasterDetailIframe["nmsc_iframe_liga_form_funcionario_funcao"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_funcionario_funcao"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_funcionario_funcao').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_funcionario_funcao').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_funcionario_funcao').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
...
?>
  ...
  {
    if ("off" == scStatusDetail["form_funcionario_funcao"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "idfuncionario";
  ajax_field_list[1] = "cpf";
  ajax_field_list[2] = "nome";
  ajax_field_list[3] = "data_admissao";
  ajax_field_list[4] = "data_demissao";
  ajax_field_list[5] = "inf_funcao";
  ...
  var ajax_error_list = {
    "idfuncionario": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "data_admissao": {"label": "DATA ADMISSAO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "data_demissao": {"label": "DATA DEMISSAO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "inf_funcao": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "cpf": new Array(),
    "nome": new Array(),
    "data_admissao": new Array(),
    "data_demissao": new Array(),
    "inf_funcao": new Array()
  };
  ajax_field_mult["idfuncionario"][1] = "idfuncionario";
  ajax_field_mult["cpf"][1] = "cpf";
  ajax_field_mult["nome"][1] = "nome";
  ajax_field_mult["data_admissao"][1] = "data_admissao";
  ajax_field_mult["data_demissao"][1] = "data_demissao";
  ajax_field_mult["inf_funcao"][1] = "inf_funcao";
  ...
  var ajax_field_id = {
    ...
    "data_admissao": new Array("hidden_field_label_data_admissao", "hidden_field_data_data_admissao"),
    "data_demissao": new Array("hidden_field_label_data_demissao", "hidden_field_data_data_demissao"),
    "inf_funcao": new Array("hidden_field_label_inf_funcao", "hidden_field_data_inf_funcao")
  };
