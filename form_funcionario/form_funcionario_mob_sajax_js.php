...
?>
  ...
  function do_ajax_form_funcionario_mob_validate_idfuncionario()
  {
    var nomeCampo_idfuncionario = "idfuncionario";
    var var_idfuncionario = scAjaxGetFieldHidden(nomeCampo_idfuncionario);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_mob_validate_idfuncionario(var_idfuncionario, var_script_case_init, do_ajax_form_funcionario_mob_validate_idfuncionario_cb);
  } // do_ajax_form_funcionario_mob_validate_idfuncionario

  function do_ajax_form_funcionario_mob_validate_idfuncionario_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_mob_validate_idfuncionario_cb
  ...
  function do_ajax_form_funcionario_mob_validate_data_admissao()
  {
    var nomeCampo_data_admissao = "data_admissao";
    var var_data_admissao = scAjaxGetFieldText(nomeCampo_data_admissao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_mob_validate_data_admissao(var_data_admissao, var_script_case_init, do_ajax_form_funcionario_mob_validate_data_admissao_cb);
  } // do_ajax_form_funcionario_mob_validate_data_admissao

  function do_ajax_form_funcionario_mob_validate_data_admissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_mob_validate_data_admissao_cb

  // ---------- Validate data_demissao
  function do_ajax_form_funcionario_mob_validate_data_demissao()
  {
    var nomeCampo_data_demissao = "data_demissao";
    var var_data_demissao = scAjaxGetFieldText(nomeCampo_data_demissao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_mob_validate_data_demissao(var_data_demissao, var_script_case_init, do_ajax_form_funcionario_mob_validate_data_demissao_cb);
  } // do_ajax_form_funcionario_mob_validate_data_demissao

  function do_ajax_form_funcionario_mob_validate_data_demissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_mob_validate_data_demissao_cb

  // ---------- Validate inf_funcao
  function do_ajax_form_funcionario_mob_validate_inf_funcao()
  {
    var nomeCampo_inf_funcao = "inf_funcao";
    var var_inf_funcao = scAjaxGetFieldText(nomeCampo_inf_funcao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcionario_mob_validate_inf_funcao(var_inf_funcao, var_script_case_init, do_ajax_form_funcionario_mob_validate_inf_funcao_cb);
  } // do_ajax_form_funcionario_mob_validate_inf_funcao

  function do_ajax_form_funcionario_mob_validate_inf_funcao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcionario_mob_validate_inf_funcao_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_funcionario_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_funcionario_mob_submit_form(var_idfuncionario, var_cpf, var_nome, var_data_admissao, var_data_demissao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_funcionario_mob_submit_form_cb);
...
?>
  ...
  var scStatusDetail = {};
  scStatusDetail["form_funcionario_funcao_mob"] = "off";
  ...
  function perform_ajax_form_funcionario_mob_navigate_form()
  {
    ...
    scAjaxProcOn();
    scStatusDetail["form_funcionario_funcao_mob"] = "on";
    x_ajax_form_funcionario_mob_navigate_form(var_idfuncionario, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_funcionario_mob_navigate_form_cb);
...
?>
  function do_ajax_form_funcionario_mob_navigate_form_cb(sResp)
  {
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_funcionario_funcao_mob"] && "nmsc_iframe_liga_form_funcionario_funcao_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_funcionario_funcao_mob"]) {
        ...
        document.getElementById('nmsc_iframe_liga_form_funcionario_funcao_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_funcionario_funcao_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_funcionario_funcao_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
...
?>
  ...
  {
    if ("off" == scStatusDetail["form_funcionario_funcao_mob"])
    {
      return true;
    }
    return false;
