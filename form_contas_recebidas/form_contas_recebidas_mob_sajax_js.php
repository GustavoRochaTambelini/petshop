  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contas_recebidas_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_contas_recebidas_mob_form();
	}
...
?>
  ...
  function do_ajax_form_contas_recebidas_mob_validate_idcontas_receber()
  {
    ...
    x_ajax_form_contas_recebidas_mob_validate_idcontas_receber(var_idcontas_receber, var_script_case_init, do_ajax_form_contas_recebidas_mob_validate_idcontas_receber_cb);
  } // do_ajax_form_contas_recebidas_mob_validate_idcontas_receber

  function do_ajax_form_contas_recebidas_mob_validate_idcontas_receber_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_recebidas_mob_validate_idcontas_receber_cb

  // ---------- Validate idcliente
  function do_ajax_form_contas_recebidas_mob_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_recebidas_mob_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_contas_recebidas_mob_validate_idcliente_cb);
  } // do_ajax_form_contas_recebidas_mob_validate_idcliente

  function do_ajax_form_contas_recebidas_mob_validate_idcliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_recebidas_mob_validate_idcliente_cb

  // ---------- Validate idforma_pagamento
  function do_ajax_form_contas_recebidas_mob_validate_idforma_pagamento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_recebidas_mob_validate_idforma_pagamento(var_idforma_pagamento, var_script_case_init, do_ajax_form_contas_recebidas_mob_validate_idforma_pagamento_cb);
  } // do_ajax_form_contas_recebidas_mob_validate_idforma_pagamento

  function do_ajax_form_contas_recebidas_mob_validate_idforma_pagamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_recebidas_mob_validate_idforma_pagamento_cb

  // ---------- Validate data_vencimento
  function do_ajax_form_contas_recebidas_mob_validate_data_vencimento()
  {
    var nomeCampo_data_vencimento = "data_vencimento";
    var var_data_vencimento = scAjaxGetFieldText(nomeCampo_data_vencimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_recebidas_mob_validate_data_vencimento(var_data_vencimento, var_script_case_init, do_ajax_form_contas_recebidas_mob_validate_data_vencimento_cb);
  } // do_ajax_form_contas_recebidas_mob_validate_data_vencimento

  function do_ajax_form_contas_recebidas_mob_validate_data_vencimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_recebidas_mob_validate_data_vencimento_cb

  // ---------- Validate valor_a_receber
  function do_ajax_form_contas_recebidas_mob_validate_valor_a_receber()
  {
    var nomeCampo_valor_a_receber = "valor_a_receber";
    var var_valor_a_receber = scAjaxGetFieldText(nomeCampo_valor_a_receber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_recebidas_mob_validate_valor_a_receber(var_valor_a_receber, var_script_case_init, do_ajax_form_contas_recebidas_mob_validate_valor_a_receber_cb);
  } // do_ajax_form_contas_recebidas_mob_validate_valor_a_receber

  function do_ajax_form_contas_recebidas_mob_validate_valor_a_receber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_recebidas_mob_validate_valor_a_receber_cb

  // ---------- Validate data_pagamento
  function do_ajax_form_contas_recebidas_mob_validate_data_pagamento()
  {
    var nomeCampo_data_pagamento = "data_pagamento";
    var var_data_pagamento = scAjaxGetFieldText(nomeCampo_data_pagamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_recebidas_mob_validate_data_pagamento(var_data_pagamento, var_script_case_init, do_ajax_form_contas_recebidas_mob_validate_data_pagamento_cb);
  } // do_ajax_form_contas_recebidas_mob_validate_data_pagamento

  function do_ajax_form_contas_recebidas_mob_validate_data_pagamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_recebidas_mob_validate_data_pagamento_cb

  // ---------- Validate observacoes
  function do_ajax_form_contas_recebidas_mob_validate_observacoes()
  {
    var nomeCampo_observacoes = "observacoes";
    var var_observacoes = scAjaxGetFieldText(nomeCampo_observacoes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_recebidas_mob_validate_observacoes(var_observacoes, var_script_case_init, do_ajax_form_contas_recebidas_mob_validate_observacoes_cb);
  } // do_ajax_form_contas_recebidas_mob_validate_observacoes

  function do_ajax_form_contas_recebidas_mob_validate_observacoes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_recebidas_mob_validate_observacoes_cb

  // ---------- Validate juros
  function do_ajax_form_contas_recebidas_mob_validate_juros()
  {
    var nomeCampo_juros = "juros";
    var var_juros = scAjaxGetFieldText(nomeCampo_juros);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_recebidas_mob_validate_juros(var_juros, var_script_case_init, do_ajax_form_contas_recebidas_mob_validate_juros_cb);
  } // do_ajax_form_contas_recebidas_mob_validate_juros

  function do_ajax_form_contas_recebidas_mob_validate_juros_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "juros";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_recebidas_mob_validate_juros_cb

  // ---------- Validate pago
  function do_ajax_form_contas_recebidas_mob_validate_pago()
  {
    var nomeCampo_pago = "pago";
    var var_pago = scAjaxGetFieldSelect(nomeCampo_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_recebidas_mob_validate_pago(var_pago, var_script_case_init, do_ajax_form_contas_recebidas_mob_validate_pago_cb);
  } // do_ajax_form_contas_recebidas_mob_validate_pago

  function do_ajax_form_contas_recebidas_mob_validate_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_recebidas_mob_validate_pago_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_contas_recebidas_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_contas_recebidas_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_contas_recebidas_mob_submit_form(var_idcontas_receber, var_idcliente, var_idforma_pagamento, var_data_vencimento, var_valor_a_receber, var_data_pagamento, var_observacoes, var_juros, var_pago, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contas_recebidas_mob_submit_form_cb);
  } // do_ajax_form_contas_recebidas_mob_submit_form

  function do_ajax_form_contas_recebidas_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_contas_recebidas_mob_submit_form_cb_after_alert);
  } // do_ajax_form_contas_recebidas_mob_submit_form_cb
  function do_ajax_form_contas_recebidas_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contas_recebidas_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_contas_recebidas_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_contas_recebidas_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_contas_recebidas_mob_navigate_form();
    }
  }

  function perform_ajax_form_contas_recebidas_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_contas_recebidas_mob_navigate_form(var_idcontas_receber, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contas_recebidas_mob_navigate_form_cb);
  } // do_ajax_form_contas_recebidas_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_recebidas_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contas_recebidas_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contas_recebidas_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_contas_recebidas_mob_navigate_form_cb
  function do_ajax_form_contas_recebidas_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_contas_recebidas_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_contas_recebidas_mob_navigate_form_cb_after_alert

  function sc_hide_form_contas_recebidas_mob_form()
  {
  ...
  ajax_field_list[4] = "valor_a_receber";
  ajax_field_list[5] = "data_pagamento";
  ajax_field_list[6] = "observacoes";
