  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pacote_itens" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_pacote_itens_form();
	}
...
?>
  ...
  // ---------- Validate idpacote_itens_
  function do_ajax_form_pacote_itens_validate_idpacote_itens_(iNumLinha)
  {
    var nomeCampo_idpacote_itens_ = "idpacote_itens_" + iNumLinha;
    var var_idpacote_itens_ = scAjaxGetFieldHidden(nomeCampo_idpacote_itens_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_itens_validate_idpacote_itens_(var_idpacote_itens_, iNumLinha, var_script_case_init, do_ajax_form_pacote_itens_validate_idpacote_itens__cb);
  } // do_ajax_form_pacote_itens_validate_idpacote_itens_

  function do_ajax_form_pacote_itens_validate_idpacote_itens__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idpacote_itens_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idpacote_itens_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idpacote_itens_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idpacote_itens_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_itens_validate_idpacote_itens__cb

  // ---------- Validate idproduto_
  function do_ajax_form_pacote_itens_validate_idproduto_(iNumLinha)
  {
    var nomeCampo_idproduto_ = "idproduto_" + iNumLinha;
    var var_idproduto_ = scAjaxGetFieldSelect(nomeCampo_idproduto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_itens_validate_idproduto_(var_idproduto_, iNumLinha, var_script_case_init, do_ajax_form_pacote_itens_validate_idproduto__cb);
  } // do_ajax_form_pacote_itens_validate_idproduto_

  function do_ajax_form_pacote_itens_validate_idproduto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_itens_validate_idproduto__cb

  // ---------- Validate quantidade_produto_
  function do_ajax_form_pacote_itens_validate_quantidade_produto_(iNumLinha)
  {
    var nomeCampo_quantidade_produto_ = "quantidade_produto_" + iNumLinha;
    var var_quantidade_produto_ = scAjaxGetFieldText(nomeCampo_quantidade_produto_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_itens_validate_quantidade_produto_(var_quantidade_produto_, iNumLinha, var_script_case_init, do_ajax_form_pacote_itens_validate_quantidade_produto__cb);
  } // do_ajax_form_pacote_itens_validate_quantidade_produto_

  function do_ajax_form_pacote_itens_validate_quantidade_produto__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "quantidade_produto_" + iLineNumber;
    }
    else
    {
      sFieldValid = "quantidade_produto_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "quantidade_produto_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "quantidade_produto_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_itens_validate_quantidade_produto__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_pacote_itens_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_pacote_itens_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_pacote_itens_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_pacote_itens_add_new_line_cb);
  } // do_ajax_form_pacote_itens_add_new_line

  function do_ajax_form_pacote_itens_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_pacote_itens_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_pacote_itens_backup_line(iNumLinha)
  {
    var var_idpacote_itens_ = scAjaxGetFieldHidden("idpacote_itens_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_itens_backup_line(var_idpacote_itens_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_pacote_itens_backup_line_cb);
  } // do_ajax_form_pacote_itens_backup_line

  function do_ajax_form_pacote_itens_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_pacote_itens_backup_line_cb

  function do_ajax_form_pacote_itens_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_pacote_itens_cancel_insert

  function do_ajax_form_pacote_itens_cancel_update(iSeqVert)
  {
    do_ajax_form_pacote_itens_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_pacote_itens_cancel_update

  function do_ajax_form_pacote_itens_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_pacote_itens_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_pacote_itens_table_refresh()
  {
    var var_idpacote_itens_ = document.F2.idpacote_itens_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_pacote_itens_table_refresh(var_idpacote_itens_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pacote_itens_table_refresh_cb);
  } //  do_ajax_form_pacote_itens_table_refresh

  function do_ajax_form_pacote_itens_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idpacote_itens_.value = scAjaxGetKeyValue("idpacote_itens_");
    ...
    scAjaxAlert(do_ajax_form_pacote_itens_table_refresh_cb_after_alert);
  } // do_ajax_form_pacote_itens_table_refresh_cb
  function do_ajax_form_pacote_itens_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_pacote_itens_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_pacote_itens_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_pacote_itens_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_quantidade_produto_ = scAjaxGetFieldText("quantidade_produto_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_pacote_itens_submit_form(var_idpacote_itens_, var_idproduto_, var_quantidade_produto_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pacote_itens_submit_form_cb);
  } // do_ajax_form_pacote_itens_submit_form

  function do_ajax_form_pacote_itens_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idpacote_itens_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idproduto_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("quantidade_produto_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_pacote_itens_submit_form_cb_after_alert);
  } // do_ajax_form_pacote_itens_submit_form_cb
  function do_ajax_form_pacote_itens_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pacote_itens_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_pacote_itens_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_pacote_itens_navigate_form, function() {});
    } else {
      perform_ajax_form_pacote_itens_navigate_form();
    }
  }

  function perform_ajax_form_pacote_itens_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_pacote_itens_cancel_insert(sc_form_pacote_itens_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idpacote_itens_" + iNavForm);
      scAjaxHideErrorDisplay("idproduto_" + iNavForm);
      scAjaxHideErrorDisplay("quantidade_produto_" + iNavForm);
    }
    var var_idpacote_itens_ = document.F2.idpacote_itens_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_pacote_itens_navigate_form(var_idpacote_itens_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pacote_itens_navigate_form_cb);
  } // do_ajax_form_pacote_itens_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pacote_itens']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pacote_itens_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idpacote_itens_.value = scAjaxGetKeyValue("idpacote_itens_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pacote_itens_navigate_form_cb_after_alert);
  } // do_ajax_form_pacote_itens_navigate_form_cb
  function do_ajax_form_pacote_itens_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_pacote_itens_navigate_form_cb_after_alert

    function sc_form_pacote_itens_get_last_line_number()
    {
    ...
    } //sc_form_pacote_itens_get_last_line_number

  function sc_hide_form_pacote_itens_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idpacote_itens_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idproduto_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "quantidade_produto_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idpacote_itens_" + iNumLinha] = {"label": "ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idproduto_" + iNumLinha] = {"label": "PRODUTO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["quantidade_produto_" + iNumLinha] = {"label": "Quantidade Produto<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idpacote_itens_"][iNumLinha] = "idpacote_itens_" + iNumLinha;
    ajax_field_mult["idproduto_"][iNumLinha] = "idproduto_" + iNumLinha;
    ajax_field_mult["quantidade_produto_"][iNumLinha] = "quantidade_produto_" + iNumLinha;
    ajax_field_id["idpacote_itens_" + iNumLinha] = new Array("hidden_field_label_idpacote_itens_", "hidden_field_data_idpacote_itens_" + iNumLinha);
    ajax_field_id["idproduto_" + iNumLinha] = new Array("hidden_field_label_idproduto_", "hidden_field_data_idproduto_" + iNumLinha);
    ajax_field_id["quantidade_produto_" + iNumLinha] = new Array("hidden_field_label_quantidade_produto_", "hidden_field_data_quantidade_produto_" + iNumLinha);
    ajax_error_count["idpacote_itens_" + iNumLinha] = "off";
    ajax_error_count["idproduto_" + iNumLinha] = "off";
    ajax_error_count["quantidade_produto_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idpacote_itens_" + iNumLinha] = "on";
    ajax_read_only["idproduto_" + iNumLinha] = "off";
    ajax_read_only["quantidade_produto_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["quantidade_produto_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idpacote_itens_" + iNumLinha] = null;
    ajax_error_list["idproduto_" + iNumLinha] = null;
    ajax_error_list["quantidade_produto_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idpacote_itens_": new Array(),
    "idproduto_": new Array(),
    "quantidade_produto_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idpacote_itens_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idpacote_itens_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idpacote_itens_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idpacote_itens_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idpacote_itens_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["quantidade_produto_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["quantidade_produto_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["quantidade_produto_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["quantidade_produto_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["quantidade_produto_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idpacote_itens_'])) ? $this->nmgp_cmp_readonly['idpacote_itens_'] : 'on';
?>
    scAjaxFieldRead("idpacote_itens_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['quantidade_produto_'])) ? $this->nmgp_cmp_readonly['quantidade_produto_'] : 'off';
?>
    scAjaxFieldRead("quantidade_produto_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idpacote_itens_" + iSeq, "on");
    scAjaxFieldRead("idproduto_" + iSeq, "on");
    scAjaxFieldRead("quantidade_produto_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idpacote_itens_" + iRow] || "on" == ajax_error_count["idproduto_" + iRow] || "on" == ajax_error_count["quantidade_produto_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idpacote_itens_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idproduto_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_quantidade_produto_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idpacote_itens_" + iRow] && "off" == ajax_error_count["idproduto_" + iRow] && "off" == ajax_error_count["quantidade_produto_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idpacote_itens_" + iRow] = "off";
        ajax_error_count["idproduto_" + iRow] = "off";
        ajax_error_count["quantidade_produto_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idpacote_itens_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idproduto_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_quantidade_produto_" + iRow).removeClass("scFormErrorLine");
    }
  }
