  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_telefone" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idtelefone_
  function do_ajax_form_telefone_validate_idtelefone_(iNumLinha)
  {
    var nomeCampo_idtelefone_ = "idtelefone_" + iNumLinha;
    var var_idtelefone_ = scAjaxGetFieldHidden(nomeCampo_idtelefone_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_telefone_validate_idtelefone_(var_idtelefone_, iNumLinha, var_script_case_init, do_ajax_form_telefone_validate_idtelefone__cb);
  } // do_ajax_form_telefone_validate_idtelefone_

  function do_ajax_form_telefone_validate_idtelefone__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idtelefone_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idtelefone_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idtelefone_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idtelefone_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_telefone_validate_idtelefone__cb

  // ---------- Validate numero_
  function do_ajax_form_telefone_validate_numero_(iNumLinha)
  {
    var nomeCampo_numero_ = "numero_" + iNumLinha;
    var var_numero_ = scAjaxGetFieldText(nomeCampo_numero_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_telefone_validate_numero_(var_numero_, iNumLinha, var_script_case_init, do_ajax_form_telefone_validate_numero__cb);
  } // do_ajax_form_telefone_validate_numero_

  function do_ajax_form_telefone_validate_numero__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_telefone_validate_numero__cb

  // ---------- Validate tipo_contato_
  function do_ajax_form_telefone_validate_tipo_contato_(iNumLinha)
  {
    var nomeCampo_tipo_contato_ = "tipo_contato_" + iNumLinha;
    var var_tipo_contato_ = scAjaxGetFieldSelect(nomeCampo_tipo_contato_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_telefone_validate_tipo_contato_(var_tipo_contato_, iNumLinha, var_script_case_init, do_ajax_form_telefone_validate_tipo_contato__cb);
  } // do_ajax_form_telefone_validate_tipo_contato_

  function do_ajax_form_telefone_validate_tipo_contato__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "tipo_contato_" + iLineNumber;
    }
    else
    {
      sFieldValid = "tipo_contato_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "tipo_contato_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "tipo_contato_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_telefone_validate_tipo_contato__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_telefone_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_telefone_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_telefone_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_telefone_add_new_line_cb);
  } // do_ajax_form_telefone_add_new_line

  function do_ajax_form_telefone_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_telefone_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_telefone_backup_line(iNumLinha)
  {
    var var_idtelefone_ = scAjaxGetFieldHidden("idtelefone_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_telefone_backup_line(var_idtelefone_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_telefone_backup_line_cb);
  } // do_ajax_form_telefone_backup_line

  function do_ajax_form_telefone_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_telefone_backup_line_cb

  function do_ajax_form_telefone_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_telefone_cancel_insert

  function do_ajax_form_telefone_cancel_update(iSeqVert)
  {
    do_ajax_form_telefone_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_telefone_cancel_update

  function do_ajax_form_telefone_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_telefone_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_telefone_table_refresh()
  {
    var var_idtelefone_ = document.F2.idtelefone_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_telefone_table_refresh(var_idtelefone_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_telefone_table_refresh_cb);
  } //  do_ajax_form_telefone_table_refresh

  function do_ajax_form_telefone_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idtelefone_.value = scAjaxGetKeyValue("idtelefone_");
    ...
    scAjaxAlert(do_ajax_form_telefone_table_refresh_cb_after_alert);
  } // do_ajax_form_telefone_table_refresh_cb
  function do_ajax_form_telefone_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_telefone_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_telefone_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_telefone_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    var var_tipo_contato_ = scAjaxGetFieldSelect("tipo_contato_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_telefone_submit_form(var_idtelefone_, var_numero_, var_tipo_contato_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_telefone_submit_form_cb);
  } // do_ajax_form_telefone_submit_form

  function do_ajax_form_telefone_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idtelefone_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("numero_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("tipo_contato_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_telefone_submit_form_cb_after_alert);
  } // do_ajax_form_telefone_submit_form_cb
  function do_ajax_form_telefone_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_telefone_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_telefone_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_telefone_navigate_form, function() {});
    } else {
      perform_ajax_form_telefone_navigate_form();
    }
  }

  function perform_ajax_form_telefone_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_telefone_cancel_insert(sc_form_telefone_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idtelefone_" + iNavForm);
      scAjaxHideErrorDisplay("numero_" + iNavForm);
      scAjaxHideErrorDisplay("tipo_contato_" + iNavForm);
    }
    var var_idtelefone_ = document.F2.idtelefone_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_telefone_navigate_form(var_idtelefone_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_telefone_navigate_form_cb);
  } // do_ajax_form_telefone_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_telefone']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_telefone_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idtelefone_.value = scAjaxGetKeyValue("idtelefone_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_telefone_navigate_form_cb_after_alert);
  } // do_ajax_form_telefone_navigate_form_cb
  function do_ajax_form_telefone_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_telefone_navigate_form_cb_after_alert

    function sc_form_telefone_get_last_line_number()
    {
    ...
    } //sc_form_telefone_get_last_line_number

  function sc_hide_form_telefone_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idtelefone_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "numero_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "tipo_contato_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idtelefone_" + iNumLinha] = {"label": "ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_error_list["tipo_contato_" + iNumLinha] = {"label": "TIPO DO CONTATO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idtelefone_"][iNumLinha] = "idtelefone_" + iNumLinha;
    ajax_field_mult["numero_"][iNumLinha] = "numero_" + iNumLinha;
    ajax_field_mult["tipo_contato_"][iNumLinha] = "tipo_contato_" + iNumLinha;
    ajax_field_id["idtelefone_" + iNumLinha] = new Array("hidden_field_label_idtelefone_", "hidden_field_data_idtelefone_" + iNumLinha);
    ajax_field_id["numero_" + iNumLinha] = new Array("hidden_field_label_numero_", "hidden_field_data_numero_" + iNumLinha);
    ajax_field_id["tipo_contato_" + iNumLinha] = new Array("hidden_field_label_tipo_contato_", "hidden_field_data_tipo_contato_" + iNumLinha);
    ajax_error_count["idtelefone_" + iNumLinha] = "off";
    ajax_error_count["numero_" + iNumLinha] = "off";
    ajax_error_count["tipo_contato_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idtelefone_" + iNumLinha] = "on";
    ajax_read_only["numero_" + iNumLinha] = "off";
    ajax_read_only["tipo_contato_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["tipo_contato_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idtelefone_" + iNumLinha] = null;
    ajax_error_list["numero_" + iNumLinha] = null;
    ajax_error_list["tipo_contato_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idtelefone_": new Array(),
    "numero_": new Array(),
    "tipo_contato_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idtelefone_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idtelefone_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idtelefone_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idtelefone_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idtelefone_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["tipo_contato_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["tipo_contato_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["tipo_contato_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["tipo_contato_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["tipo_contato_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idtelefone_'])) ? $this->nmgp_cmp_readonly['idtelefone_'] : 'on';
?>
    scAjaxFieldRead("idtelefone_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['tipo_contato_'])) ? $this->nmgp_cmp_readonly['tipo_contato_'] : 'off';
?>
    scAjaxFieldRead("tipo_contato_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idtelefone_" + iSeq, "on");
    scAjaxFieldRead("numero_" + iSeq, "on");
    scAjaxFieldRead("tipo_contato_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idtelefone_" + iRow] || "on" == ajax_error_count["numero_" + iRow] || "on" == ajax_error_count["tipo_contato_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idtelefone_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_numero_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_tipo_contato_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idtelefone_" + iRow] && "off" == ajax_error_count["numero_" + iRow] && "off" == ajax_error_count["tipo_contato_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idtelefone_" + iRow] = "off";
        ajax_error_count["numero_" + iRow] = "off";
        ajax_error_count["tipo_contato_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idtelefone_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_numero_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_tipo_contato_" + iRow).removeClass("scFormErrorLine");
    }
  }
