...
$bg_line_degrade[0] = '#bdbdbd';
$bg_line_degrade[1] = '#bdbdbd';
$bg_line_degrade[2] = '#bdbdbd';
$bg_line_degrade[3] = '#bdbdbd';
...
$str_item_bar_background_color = '#BDC3C7';
$str_item_bar_border_color = '#455c72';
$str_item_sel_background_color = '';
$str_pagina_icon_bg = '#bdbdbd';
