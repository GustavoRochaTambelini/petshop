...
$str_menu_bar_background_color = '#336699';
$str_menu_sel_background_color = '';
$str_item_bar_background_color = '#e5e5e5';
$str_item_bar_border_color = '#e5e5e5';
$str_item_sel_background_color = '';
$str_pagina_icon_bg = '#e5e5e5';
