...
$bg_line_degrade[0] = '#EEEEEE';
$bg_line_degrade[1] = '#EEEEEE';
$bg_line_degrade[2] = '#EEEEEE';
$bg_line_degrade[3] = '#EEEEEE';
$str_arrow_up = 'scriptcase__NM__arrow_out_new.gif';
$str_arrow_down = 'scriptcase__NM__arrow_in_new.gif';
$str_menu_bar_background_color = '#2F2F2F';
