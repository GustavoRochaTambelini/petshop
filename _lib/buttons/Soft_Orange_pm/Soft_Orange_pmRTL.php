<?php
  ...
  $this->arr_buttons['bcalendario']['image'] = 'new__NM__nm_btn1410380071_bcalendario.gif';
  ...
  $this->arr_buttons['bcalculadora']['image'] = 'sys__NM__nm_Soft_Orange_pm_bcalculadora.gif';
