<?php
  ...
  $this->arr_buttons['balterar']['value']            = 'Update';
  ...
  $this->arr_buttons['balterar']['image'] = 'sys__NM__nm_txt_Office2003Olive_balterar.gif';

  $this->arr_buttons['bavanca']['hint']             = $Nm_lang['lang_btns_next_hint'];
  $this->arr_buttons['bavanca']['type']             = 'button';
  $this->arr_buttons['bavanca']['value']            = 'Next';
  ...
  $this->arr_buttons['bavanca']['image'] = 'sys__NM__nm_txt_Office2003Olive_bavanca.gif';

  $this->arr_buttons['bcancelar']['hint']             = $Nm_lang['lang_btns_cncl_hint'];
  $this->arr_buttons['bcancelar']['type']             = 'button';
  $this->arr_buttons['bcancelar']['value']            = 'Cancel';
  ...
  $this->arr_buttons['bcancelar']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcancelar.gif';

  $this->arr_buttons['bcolumns']['hint']             = $Nm_lang['lang_btns_clmn_hint'];
  $this->arr_buttons['bcolumns']['type']             = 'button';
  $this->arr_buttons['bcolumns']['value']            = 'Columns';
  ...
  $this->arr_buttons['bcolumns']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcolumns.gif';

  $this->arr_buttons['bconf_graf']['hint']             = $Nm_lang['lang_btns_chrt_stng_hint'];
  $this->arr_buttons['bconf_graf']['type']             = 'button';
  $this->arr_buttons['bconf_graf']['value']            = 'Graph Settings';
  ...
  $this->arr_buttons['bconf_graf']['image'] = 'sys__NM__nm_txt_Office2003Olive_bconf_graf.gif';

  $this->arr_buttons['bcsv']['hint']             = $Nm_lang['lang_btns_csvf_hint'];
  $this->arr_buttons['bcsv']['type']             = 'button';
  $this->arr_buttons['bcsv']['value']            = 'CSV';
  ...
  $this->arr_buttons['bcsv']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcsv.gif';

  $this->arr_buttons['bedit_filter']['hint']             = $Nm_lang['lang_btns_srch_edit_hint'];
  $this->arr_buttons['bedit_filter']['type']             = 'button';
  $this->arr_buttons['bedit_filter']['value']            = 'Edit';
  ...
  $this->arr_buttons['bedit_filter']['image'] = 'sys__NM__nm_txt_Office2003Olive_bedit_filter.gif';

  $this->arr_buttons['bexcel']['hint']             = $Nm_lang['lang_btns_xlsf_hint'];
  $this->arr_buttons['bexcel']['type']             = 'button';
  $this->arr_buttons['bexcel']['value']            = 'XLS';
  ...
  $this->arr_buttons['bexcel']['image'] = 'sys__NM__nm_txt_Office2003Olive_bexcel.gif';

  $this->arr_buttons['bexcluir']['hint']             = $Nm_lang['lang_btns_dele_hint'];
  $this->arr_buttons['bexcluir']['type']             = 'button';
  $this->arr_buttons['bexcluir']['value']            = 'Delete';
  ...
  $this->arr_buttons['bexcluir']['image'] = 'sys__NM__nm_txt_Office2003Olive_bexcluir.gif';

  $this->arr_buttons['bfinal']['hint']             = $Nm_lang['lang_btns_last_hint'];
  $this->arr_buttons['bfinal']['type']             = 'button';
  $this->arr_buttons['bfinal']['value']            = 'Last';
  ...
  $this->arr_buttons['bfinal']['image'] = 'sys__NM__nm_txt_Office2003Olive_bfinal.gif';

  $this->arr_buttons['bfonte']['hint']             = '';
  $this->arr_buttons['bfonte']['type']             = 'button';
  $this->arr_buttons['bfonte']['value']            = 'Source';
  $this->arr_buttons['bfonte']['display']          = '';
  $this->arr_buttons['bfonte']['display_position'] = '';
  $this->arr_buttons['bfonte']['fontawesomeicon']  = '';
  $this->arr_buttons['bfonte']['style'] = '';
  $this->arr_buttons['bfonte']['image'] = 'sys__NM__nm_txt_Office2003Olive_bfonte.gif';

  $this->arr_buttons['bgraf']['hint']             = $Nm_lang['lang_btns_chrt_hint'];
  $this->arr_buttons['bgraf']['type']             = 'button';
  $this->arr_buttons['bgraf']['value']            = 'Graph';
  ...
  $this->arr_buttons['bgraf']['image'] = 'sys__NM__nm_txt_Office2003Olive_bgraf.gif';

  $this->arr_buttons['bhelp']['hint']             = $Nm_lang['lang_btns_help_hint'];
  $this->arr_buttons['bhelp']['type']             = 'button';
  $this->arr_buttons['bhelp']['value']            = 'Help';
  ...
  $this->arr_buttons['bhelp']['image'] = 'sys__NM__nm_txt_Office2003Olive_bhelp.gif';

  $this->arr_buttons['bincluir']['hint']             = $Nm_lang['lang_btns_inst_hint'];
  $this->arr_buttons['bincluir']['type']             = 'button';
  $this->arr_buttons['bincluir']['value']            = 'Add';
  ...
  $this->arr_buttons['bincluir']['image'] = 'sys__NM__nm_txt_Office2003Olive_bincluir.gif';

  $this->arr_buttons['binicio']['hint']             = $Nm_lang['lang_btns_frst_hint'];
  $this->arr_buttons['binicio']['type']             = 'button';
  $this->arr_buttons['binicio']['value']            = 'Fisrt';
  ...
  $this->arr_buttons['binicio']['image'] = 'sys__NM__nm_txt_Office2003Olive_binicio.gif';

  $this->arr_buttons['birpara']['hint']             = $Nm_lang['lang_btns_jump_hint'];
  $this->arr_buttons['birpara']['type']             = 'button';
  $this->arr_buttons['birpara']['value']            = 'Jump to';
  ...
  $this->arr_buttons['birpara']['image'] = 'sys__NM__nm_txt_Office2003Olive_birpara.gif';

  $this->arr_buttons['blimpar']['hint']             = $Nm_lang['lang_btns_clea_hint'];
  $this->arr_buttons['blimpar']['type']             = 'button';
  $this->arr_buttons['blimpar']['value']            = 'Clean';
  ...
  $this->arr_buttons['blimpar']['image'] = 'sys__NM__nm_txt_Office2003Olive_blimpar.gif';

  $this->arr_buttons['bmd_alterar']['hint']             = $Nm_lang['lang_btns_mdtl_updt_hint'];
  $this->arr_buttons['bmd_alterar']['type']             = 'image';
  $this->arr_buttons['bmd_alterar']['value']            = 'Update';
  ...
  $this->arr_buttons['bmd_alterar']['image'] = 'sys__NM__nm_txt_Office2003Olive_bmd_alterar.gif';

  $this->arr_buttons['bmd_cancelar']['hint']             = $Nm_lang['lang_btns_mdtl_cncl_hint'];
  $this->arr_buttons['bmd_cancelar']['type']             = 'image';
  $this->arr_buttons['bmd_cancelar']['value']            = 'Cancel';
  ...
  $this->arr_buttons['bmd_cancelar']['image'] = 'sys__NM__nm_txt_Office2003Olive_bmd_cancelar.gif';

  $this->arr_buttons['bmd_edit']['hint']             = $Nm_lang['lang_btns_mdtl_edit_hint'];
  $this->arr_buttons['bmd_edit']['type']             = 'image';
  $this->arr_buttons['bmd_edit']['value']            = 'Edit';
  ...
  $this->arr_buttons['bmd_edit']['image'] = 'sys__NM__nm_txt_Office2003Olive_bmd_edit.gif';

  $this->arr_buttons['bmd_excluir']['hint']             = $Nm_lang['lang_btns_mdtl_dele_hint'];
  $this->arr_buttons['bmd_excluir']['type']             = 'image';
  $this->arr_buttons['bmd_excluir']['value']            = 'Delete';
  ...
  $this->arr_buttons['bmd_excluir']['image'] = 'sys__NM__nm_txt_Office2003Olive_bmd_excluir.gif';

  $this->arr_buttons['bmd_incluir']['hint']             = $Nm_lang['lang_btns_mdtl_inst_hint'];
  $this->arr_buttons['bmd_incluir']['type']             = 'image';
  $this->arr_buttons['bmd_incluir']['value']            = 'Add';
  ...
  $this->arr_buttons['bmd_incluir']['image'] = 'sys__NM__nm_txt_Office2003Olive_bmd_incluir.gif';

  $this->arr_buttons['bmd_novo']['hint']             = $Nm_lang['lang_btns_mdtl_neww_hint'];
  $this->arr_buttons['bmd_novo']['type']             = 'image';
  $this->arr_buttons['bmd_novo']['value']            = 'New';
  ...
  $this->arr_buttons['bmd_novo']['image'] = 'sys__NM__nm_txt_Office2003Olive_bmd_novo.gif';

  $this->arr_buttons['bnovo']['hint']             = $Nm_lang['lang_btns_neww_hint'];
  $this->arr_buttons['bnovo']['type']             = 'button';
  $this->arr_buttons['bnovo']['value']            = 'New';
  ...
  $this->arr_buttons['bnovo']['image'] = 'sys__NM__nm_txt_Office2003Olive_bnovo.gif';

  $this->arr_buttons['bok']['hint']             = $Nm_lang['lang_btns_cfrm_hint'];
  $this->arr_buttons['bok']['type']             = 'button';
  $this->arr_buttons['bok']['value']            = 'OK';
  ...
  $this->arr_buttons['bok']['image'] = 'sys__NM__nm_txt_Office2003Olive_bok.gif';

  $this->arr_buttons['bpdf']['hint']             = $Nm_lang['lang_btns_pdfc_hint'];
  $this->arr_buttons['bpdf']['type']             = 'button';
  $this->arr_buttons['bpdf']['value']            = 'PDF';
  ...
  $this->arr_buttons['bpdf']['image'] = 'sys__NM__nm_txt_Office2003Olive_bpdf.gif';

  $this->arr_buttons['bpdf_pb']['hint']             = '';
  $this->arr_buttons['bpdf_pb']['type']             = 'button';
  $this->arr_buttons['bpdf_pb']['value']            = 'PDF';
  $this->arr_buttons['bpdf_pb']['display']          = '';
  $this->arr_buttons['bpdf_pb']['display_position'] = '';
  $this->arr_buttons['bpdf_pb']['fontawesomeicon']  = '';
  $this->arr_buttons['bpdf_pb']['style'] = '';
  $this->arr_buttons['bpdf_pb']['image'] = 'sys__NM__nm_txt_Office2003Olive_bpdf_pb.gif';

  $this->arr_buttons['bpesquisa']['hint']             = $Nm_lang['lang_btns_srch_hint'];
  $this->arr_buttons['bpesquisa']['type']             = 'button';
  $this->arr_buttons['bpesquisa']['value']            = 'Filter';
  ...
  $this->arr_buttons['bpesquisa']['image'] = 'sys__NM__nm_txt_Office2003Olive_bpesquisa.gif';

  $this->arr_buttons['bprint']['hint']             = $Nm_lang['lang_btns_prnt_hint'];
  $this->arr_buttons['bprint']['type']             = 'button';
  $this->arr_buttons['bprint']['value']            = 'Print';
  ...
  $this->arr_buttons['bprint']['image'] = 'sys__NM__nm_txt_Office2003Olive_bprint.gif';

  $this->arr_buttons['bqt_linhas']['hint']             = $Nm_lang['lang_btns_rows_hint'];
  $this->arr_buttons['bqt_linhas']['type']             = 'button';
  $this->arr_buttons['bqt_linhas']['value']            = 'Records per page';
  ...
  $this->arr_buttons['bqt_linhas']['image'] = 'sys__NM__nm_txt_Office2003Olive_bqt_linhas.gif';

  $this->arr_buttons['bqtd_bytes']['hint']             = '';
  $this->arr_buttons['bqtd_bytes']['type']             = 'button';
  $this->arr_buttons['bqtd_bytes']['value']            = '...';
  ...
  $this->arr_buttons['bqtd_bytes']['image'] = 'sys__NM__nm_txt_Office2003Olive_bqtd_bytes.gif';

  $this->arr_buttons['bresumo']['hint']             = $Nm_lang['lang_btns_smry_hint'];
  $this->arr_buttons['bresumo']['type']             = 'button';
  $this->arr_buttons['bresumo']['value']            = 'Summary';
  ...
  $this->arr_buttons['bresumo']['image'] = 'sys__NM__nm_txt_Office2003Olive_bresumo.gif';

  $this->arr_buttons['bretorna']['hint']             = $Nm_lang['lang_btns_prev_hint'];
  $this->arr_buttons['bretorna']['type']             = 'button';
  $this->arr_buttons['bretorna']['value']            = 'Previous';
  ...
  $this->arr_buttons['bretorna']['image'] = 'sys__NM__nm_txt_Office2003Olive_bretorna.gif';

  $this->arr_buttons['brtf']['hint']             = $Nm_lang['lang_btns_rtff_hint'];
  $this->arr_buttons['brtf']['type']             = 'button';
  $this->arr_buttons['brtf']['value']            = 'RTF';
  ...
  $this->arr_buttons['brtf']['image'] = 'sys__NM__nm_txt_Office2003Olive_brtf.gif';

  $this->arr_buttons['bsair']['hint']             = $Nm_lang['lang_btns_exit_hint'];
  $this->arr_buttons['bsair']['type']             = 'button';
  $this->arr_buttons['bsair']['value']            = 'Exit';
  ...
  $this->arr_buttons['bsair']['image'] = 'sys__NM__nm_txt_Office2003Olive_bsair.gif';

  $this->arr_buttons['bsalvar']['hint']             = $Nm_lang['lang_btns_save_hint'];
  $this->arr_buttons['bsalvar']['type']             = 'button';
  $this->arr_buttons['bsalvar']['value']            = 'OK';
  ...
  $this->arr_buttons['bsalvar']['image'] = 'sys__NM__nm_txt_Office2003Olive_bsalvar.gif';

  $this->arr_buttons['bsort']['hint']             = $Nm_lang['lang_btns_sort_hint'];
  $this->arr_buttons['bsort']['type']             = 'button';
  $this->arr_buttons['bsort']['value']            = 'Sortining';
  ...
  $this->arr_buttons['bsort']['image'] = 'sys__NM__nm_txt_Office2003Olive_bsort.gif';

  $this->arr_buttons['bvoltar']['hint']             = $Nm_lang['lang_btns_back_hint'];
  $this->arr_buttons['bvoltar']['type']             = 'button';
  $this->arr_buttons['bvoltar']['value']            = 'Back';
  ...
  $this->arr_buttons['bvoltar']['image'] = 'sys__NM__nm_txt_Office2003Olive_bvoltar.gif';

  $this->arr_buttons['bxml']['hint']             = $Nm_lang['lang_btns_xmlf_hint'];
  $this->arr_buttons['bxml']['type']             = 'button';
  $this->arr_buttons['bxml']['value']            = 'XML';
  ...
  $this->arr_buttons['bxml']['image'] = 'sys__NM__nm_txt_Office2003Olive_bxml.gif';

  $this->arr_buttons['bcons_inicio']['hint']             = $Nm_lang['lang_btns_frst_hint'];
  $this->arr_buttons['bcons_inicio']['type']             = 'button';
  $this->arr_buttons['bcons_inicio']['value']            = 'Fisrt';
  ...
  $this->arr_buttons['bcons_inicio']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcons_inicio.gif';

  $this->arr_buttons['bcons_retorna']['hint']             = $Nm_lang['lang_btns_prev_hint'];
  $this->arr_buttons['bcons_retorna']['type']             = 'button';
  $this->arr_buttons['bcons_retorna']['value']            = 'Previous';
  ...
  $this->arr_buttons['bcons_retorna']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcons_retorna.gif';

  $this->arr_buttons['bcons_avanca']['hint']             = $Nm_lang['lang_btns_next_hint'];
  $this->arr_buttons['bcons_avanca']['type']             = 'button';
  $this->arr_buttons['bcons_avanca']['value']            = 'Next';
  ...
  $this->arr_buttons['bcons_avanca']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcons_avanca.gif';

  $this->arr_buttons['bcons_final']['hint']             = $Nm_lang['lang_btns_last_hint'];
  $this->arr_buttons['bcons_final']['type']             = 'button';
  $this->arr_buttons['bcons_final']['value']            = 'Last';
  ...
  $this->arr_buttons['bcons_final']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcons_final.gif';
  ...
  $this->arr_buttons['bform_editar']['image'] = 'sys__NM__nm_txt_Office2003Olive_bform_editar.gif';
  ...
  $this->arr_buttons['bform_captura']['image'] = 'sys__NM__nm_txt_Office2003Olive_bform_captura.gif';
  ...
  $this->arr_buttons['bform_lookuplink']['image'] = 'sys__NM__nm_txt_Office2003Olive_bform_lookuplink.gif';
  ...
  $this->arr_buttons['bcons_detalhes']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcons_detalhes.gif';
  ...
  $this->arr_buttons['bcalendario']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcalendario.gif';
  ...
  $this->arr_buttons['bcalculadora']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcalculadora.gif';
  ...
  $this->arr_buttons['bzipcode']['image'] = 'sys__NM__nm_txt_Office2003Olive_bzipcode.gif';
  ...
  $this->arr_buttons['blink']['image'] = 'sys__NM__nm_txt_Office2003Olive_blink.gif';
  ...
  $this->arr_buttons['bfieldhelp']['image'] = 'sys__NM__nm_txt_Office2003Olive_bfieldhelp.gif';
  ...
  $this->arr_buttons['bcons_inicio_off']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcons_inicio_off.gif';
  ...
  $this->arr_buttons['bcons_retorna_off']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcons_retorna_off.gif';
  ...
  $this->arr_buttons['bcons_avanca_off']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcons_avanca_off.gif';
  ...
  $this->arr_buttons['bcons_final_off']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcons_final_off.gif';
  ...
  $this->arr_buttons['bexport']['image'] = 'sys__NM__nm_txt_Office2003Olive_bexport.gif';
  ...
  $this->arr_buttons['bajaxcapt']['image'] = 'sys__NM__nm_txt_Office2003Olive_bajaxcapt.gif';
  ...
  $this->arr_buttons['bajaxclose']['image'] = 'sys__NM__nm_txt_Office2003Olive_bajaxclose.gif';
  ...
  $this->arr_buttons['binicio_off']['image'] = 'sys__NM__nm_txt_Office2003Olive_binicio_off.gif';
  ...
  $this->arr_buttons['bretorna_off']['image'] = 'sys__NM__nm_txt_Office2003Olive_bretorna_off.gif';
  ...
  $this->arr_buttons['bavanca_off']['image'] = 'sys__NM__nm_txt_Office2003Olive_bavanca_off.gif';
  ...
  $this->arr_buttons['bfinal_off']['image'] = 'sys__NM__nm_txt_Office2003Olive_bfinal_off.gif';
  ...
  $this->arr_buttons['blanguage']['image'] = 'sys__NM__nm_txt_Office2003Olive_blanguage.gif';
  ...
  $this->arr_buttons['bsrgb']['image'] = 'sys__NM__nm_txt_Office2003Olive_bsrgb.gif';
  ...
  $this->arr_buttons['blink_resumogrid']['image'] = 'sys__NM__nm_txt_Office2003Olive_blink_resumogrid.gif';
  ...
  $this->arr_buttons['brot_resumo']['image'] = 'sys__NM__nm_txt_Office2003Olive_brot_resumo.gif';
  ...
  $this->arr_buttons['smry_conf']['image'] = 'sys__NM__nm_txt_Office2003Olive_smry_conf.gif';
  ...
  $this->arr_buttons['bexportview']['image'] = 'sys__NM__nm_txt_Office2003Olive_bexportview.gif';
  ...
  $this->arr_buttons['bdownload']['image'] = 'sys__NM__nm_txt_Office2003Olive_bdownload.gif';
  ...
  $this->arr_buttons['bcaptchareload']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcaptchareload.gif';
  ...
  $this->arr_buttons['bsrch_mtmf']['image'] = 'sys__NM__nm_txt_Office2003Olive_bsrch_mtmf.gif';
  ...
  $this->arr_buttons['bquick_search']['image'] = 'sys__NM__nm_txt_Office2003Olive_bquick_search.gif';
  ...
  $this->arr_buttons['berrm_clse']['image'] = 'sys__NM__nm_txt_Office2003Olive_berrm_clse.gif';
  ...
  $this->arr_buttons['bemail']['image'] = 'sys__NM__nm_txt_Office2003Olive_bemail.gif';
  ...
  $this->arr_buttons['bcapture']['image'] = 'sys__NM__nm_txt_Office2003Olive_bcapture.gif';
  ...
  $this->arr_buttons['bmessageclose']['image'] = 'sys__NM__nm_txt_Office2003Olive_bmessageclose.gif';
  ...
  $this->arr_buttons['bgooglemaps']['image'] = 'sys__NM__nm_txt_Office2003Olive_bgooglemaps.gif';
  ...
  $this->arr_buttons['byoutube']['image'] = 'sys__NM__nm_txt_Office2003Olive_byoutube.gif';
  ...
  $this->arr_buttons['bstepretorna']['image'] = 'sys__NM__nm_txt_Office2003Olive_bstepretorna.gif';
  ...
  $this->arr_buttons['bstepavanca']['image'] = 'sys__NM__nm_txt_Office2003Olive_bstepavanca.gif';
  ...
  $this->arr_buttons['bfilref_apply']['image'] = 'sys__NM__nm_txt_Office2003Olive_bfilref_apply.gif';
  ...
  $this->arr_buttons['bfilref_limpar']['image'] = 'sys__NM__nm_txt_Office2003Olive_bfilref_limpar.gif';
  ...
  $this->arr_buttons['bfilref_close']['image'] = 'sys__NM__nm_txt_Office2003Olive_bfilref_close.gif';
  ...
  $this->arr_buttons['bjson']['image'] = 'sys__NM__nm_txt_Office2003Olive_bjson.gif';
