<?php
  ...
  $this->arr_buttons['bcons_inicio']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-first (1).ico';
  ...
  $this->arr_buttons['bcons_retorna']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-previous.ico';
  ...
  $this->arr_buttons['bcons_avanca']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-next.ico';
  ...
  $this->arr_buttons['bcons_final']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-last (1).ico';
  ...
  $this->arr_buttons['birpara']['image'] = 'new__NM__nm_btn1447424830_birpara.gif';
  ...
  $this->arr_buttons['bprint']['image'] = 'sys__NM__imprimir-agt-icono-9402-16.png';
  ...
  $this->arr_buttons['bresumo']['image'] = 'new__NM__nm_btn1447424830_bresumo.gif';
  ...
  $this->arr_buttons['bsort']['image'] = 'new__NM__nm_btn1447424830_bsort.gif';
  ...
  $this->arr_buttons['bcolumns']['image'] = 'new__NM__nm_btn1447424830_bcolumns.gif';
  ...
  $this->arr_buttons['bdynamicsearch']['image'] = 'new__NM__nm_btn1447424830_bdynamicsearch.gif';
  ...
  $this->arr_buttons['bgridsave']['image'] = 'new__NM__nm_btn1447424830_bgridsave.gif';
  ...
  $this->arr_buttons['bgroupby']['image'] = 'new__NM__nm_btn1447424830_bgroupby.gif';
  ...
  $this->arr_buttons['bcons_detalhes']['image'] = 'sys__NM__buscar-buscar-ampliar-icono-6234-16.png';
  ...
  $this->arr_buttons['bqt_linhas']['image'] = 'new__NM__nm_btn1447424830_bqt_linhas.gif';
  ...
  $this->arr_buttons['bgraf']['image'] = 'sys__NM__graficos-de-barras-de-los-graficos-de-estadisticas-icono-8554-16.png';
  ...
  $this->arr_buttons['bconf_graf']['image'] = 'new__NM__nm_btn1447424830_bconf_graf.gif';
  ...
  $this->arr_buttons['bqtd_bytes']['display']          = 'only_img';
  ...
  $this->arr_buttons['bqtd_bytes']['image'] = 'sys__NM__bullet_go.png';
  ...
  $this->arr_buttons['blink_resumogrid']['image'] = 'new__NM__nm_btn1447424830_blink_resumogrid.gif';
  ...
  $this->arr_buttons['brot_resumo']['image'] = 'new__NM__nm_btn1447424830_brot_resumo.gif';
  ...
  $this->arr_buttons['smry_conf']['display']          = 'text_img';
  ...
  $this->arr_buttons['smry_conf']['image'] = 'sys__NM__configuracion-de-la-aplicacion-por-defecto-icono-6595-16.png';
  ...
  $this->arr_buttons['gantt_chart']['image'] = 'new__NM__nm_btn1447424830_gantt_chart.gif';
  ...
  $this->arr_buttons['bcons_apply']['image'] = 'new__NM__nm_btn1447424830_bcons_apply.gif';
  ...
  $this->arr_buttons['bcons_cancel']['image'] = 'new__NM__nm_btn1447424830_bcons_cancel.gif';
  ...
  $this->arr_buttons['bmultiselect']['image'] = 'new__NM__nm_btn1447424830_bmultiselect.gif';
  ...
  $this->arr_buttons['bcons_inicio_off']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-first.ico';
  ...
  $this->arr_buttons['bcons_retorna_off']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-previous (1).ico';
  ...
  $this->arr_buttons['bcons_avanca_off']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-next (1).ico';
  ...
  $this->arr_buttons['bcons_final_off']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-last.ico';

  $this->arr_buttons['bpdf']['hint']             = $Nm_lang['lang_btns_pdfc_hint'];
  $this->arr_buttons['bpdf']['type']             = 'button';
  $this->arr_buttons['bpdf']['value']            = 'Hoja PDF';
  ...
  $this->arr_buttons['bpdf']['image'] = 'sys__NM__pdf-icono-4481-16.png';
  ...
  $this->arr_buttons['brtf']['image'] = 'new__NM__nm_btn1447424830_brtf.gif';

  $this->arr_buttons['bexcel']['hint']             = 'Hoja de Excel';
  $this->arr_buttons['bexcel']['type']             = 'button';
  $this->arr_buttons['bexcel']['value']            = 'Hoja de Excel';
  ...
  $this->arr_buttons['bexcel']['image'] = 'sys__NM__en-blanco-de-excel-icono-9347-16.png';
  ...
  $this->arr_buttons['bxml']['image'] = 'new__NM__nm_btn1447424830_bxml.gif';
  ...
  $this->arr_buttons['bcsv']['image'] = 'new__NM__nm_btn1447424830_bcsv.gif';

  $this->arr_buttons['bword']['hint']             = $Nm_lang['lang_btns_word_hint'];
  $this->arr_buttons['bword']['type']             = 'button';
  $this->arr_buttons['bword']['value']            = 'Hoja de Word';
  ...
  $this->arr_buttons['bword']['image'] = 'new__NM__nm_btn1447424830_bword.gif';
  ...
  $this->arr_buttons['bexport']['image'] = 'new__NM__nm_btn1447424830_bexport.gif';
  ...
  $this->arr_buttons['bexportview']['image'] = 'new__NM__nm_btn1447424830_bexportview.gif';
  ...
  $this->arr_buttons['bdownload']['image'] = 'sys__NM__descargar-caja-de-madera-icono-5941-16.png';
  ...
  $this->arr_buttons['binicio']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-first (2).ico';
  ...
  $this->arr_buttons['bretorna']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-previous (1).ico';
  ...
  $this->arr_buttons['bavanca']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-next (1).ico';
  ...
  $this->arr_buttons['bfinal']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-last (2).ico';
  ...
  $this->arr_buttons['bincluir']['image'] = 'sys__NM__guardar-documento-icono-9312-16.png';
  ...
  $this->arr_buttons['bexcluir']['image'] = 'sys__NM__delete-edit-icono-4269-16.png';
  ...
  $this->arr_buttons['balterar']['image'] = 'sys__NM__actualizar-pagina-icono-4711-16.png';
  ...
  $this->arr_buttons['bexcluirsel']['image'] = 'sys__NM__table_delete (1).png';
  ...
  $this->arr_buttons['balterarsel']['image'] = 'sys__NM__actualizar-pagina-icono-4711-16.png';
  ...
  $this->arr_buttons['bnovo']['image'] = 'sys__NM__agregar-nuevo-documento-de-archivo-mas-icono-6249-16.png';
  ...
  $this->arr_buttons['bform_editar']['image'] = 'sys__NM__edit (1).ico';

  $this->arr_buttons['bform_captura']['hint']             = 'Buscar Registros';
  $this->arr_buttons['bform_captura']['type']             = 'button';
  $this->arr_buttons['bform_captura']['value']            = 'Buscar';
  ...
  $this->arr_buttons['bform_captura']['image'] = 'sys__NM__buscar-buscar-ampliar-icono-6234-16.png';
  ...
  $this->arr_buttons['bform_lookuplink']['image'] = 'sys__NM__edit (4).ico';
  ...
  $this->arr_buttons['bok']['image'] = 'sys__NM__aceptar-verde-ok-si-icono-8925-16.png';
  ...
  $this->arr_buttons['bcalendario']['image'] = 'sys__NM__Fasticon-Essential-Toolbar-Calendar.ico';
  ...
  $this->arr_buttons['bcalculadora']['image'] = 'sys__NM__calculator.png';
  ...
  $this->arr_buttons['bajaxcapt']['image'] = 'sys__NM__buscar-buscar-ampliar-icono-6234-16.png';
  ...
  $this->arr_buttons['bajaxclose']['image'] = 'new__NM__nm_btn1447424830_bajaxclose.gif';
  ...
  $this->arr_buttons['bcaptchareload']['image'] = 'new__NM__nm_btn1447424830_bcaptchareload.gif';
  ...
  $this->arr_buttons['bsrch_mtmf']['image'] = 'new__NM__nm_btn1447424830_bsrch_mtmf.gif';
  ...
  $this->arr_buttons['bcopy']['image'] = 'new__NM__nm_btn1447424830_bcopy.gif';
  ...
  $this->arr_buttons['binicio_off']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-first (3).ico';
  ...
  $this->arr_buttons['bretorna_off']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-previous (2).ico';
  ...
  $this->arr_buttons['bavanca_off']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-next (2).ico';
  ...
  $this->arr_buttons['bfinal_off']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-last (3).ico';
  ...
  $this->arr_buttons['bcresumo']['image'] = 'new__NM__nm_btn1447424830_bcresumo.gif';
  ...
  $this->arr_buttons['bcsort']['image'] = 'new__NM__nm_btn1447424830_bcsort.gif';
  ...
  $this->arr_buttons['bctype']['image'] = 'new__NM__nm_btn1447424830_bctype.gif';
  ...
  $this->arr_buttons['bcpersonalite']['image'] = 'new__NM__nm_btn1447424830_bcpersonalite.gif';
  ...
  $this->arr_buttons['bchart_bar']['image'] = 'sys__NM__graficos-de-barras-de-los-graficos-de-estadisticas-icono-8554-16.png';
  ...
  $this->arr_buttons['bchart_line']['image'] = 'new__NM__nm_btn1447424830_bchart_line.gif';
  ...
  $this->arr_buttons['bchart_area']['image'] = 'new__NM__nm_btn1447424830_bchart_area.gif';
  ...
  $this->arr_buttons['bchart_pizza']['image'] = 'new__NM__nm_btn1447424830_bchart_pizza.gif';
  ...
  $this->arr_buttons['bchart_combo']['image'] = 'new__NM__nm_btn1447424830_bchart_combo.gif';
  ...
  $this->arr_buttons['bchart_stack']['image'] = 'new__NM__nm_btn1447424830_bchart_stack.gif';
  ...
  $this->arr_buttons['bcsort_on']['image'] = 'new__NM__nm_btn1447424830_bcsort_on.gif';
  ...
  $this->arr_buttons['bchart_bar_on']['image'] = 'sys__NM__graficos-de-barras-de-los-graficos-de-estadisticas-icono-8554-16.png';
  ...
  $this->arr_buttons['bchart_line_on']['image'] = 'new__NM__nm_btn1447424830_bchart_line_on.gif';
  ...
  $this->arr_buttons['bchart_area_on']['image'] = 'new__NM__nm_btn1447424830_bchart_area_on.gif';
  ...
  $this->arr_buttons['bchart_pizza_on']['image'] = 'new__NM__nm_btn1447424830_bchart_pizza_on.gif';
  ...
  $this->arr_buttons['bchart_combo_on']['image'] = 'new__NM__nm_btn1447424830_bchart_combo_on.gif';
  ...
  $this->arr_buttons['bchart_stack_on']['image'] = 'new__NM__nm_btn1447424830_bchart_stack_on.gif';
  ...
  $this->arr_buttons['bcsort_off']['image'] = 'new__NM__nm_btn1447424830_bcsort_off.gif';
  ...
  $this->arr_buttons['bchart_bar_off']['image'] = 'sys__NM__graficos-de-barras-de-los-graficos-de-estadisticas-icono-8554-16.png';
  ...
  $this->arr_buttons['bchart_line_off']['image'] = 'new__NM__nm_btn1447424830_bchart_line_off.gif';
  ...
  $this->arr_buttons['bchart_area_off']['image'] = 'new__NM__nm_btn1447424830_bchart_area_off.gif';
  ...
  $this->arr_buttons['bchart_pizza_off']['image'] = 'new__NM__nm_btn1447424830_bchart_pizza_off.gif';
  ...
  $this->arr_buttons['bchart_combo_off']['image'] = 'new__NM__nm_btn1447424830_bchart_combo_off.gif';
  ...
  $this->arr_buttons['bchart_stack_off']['image'] = 'new__NM__nm_btn1447424830_bchart_stack_off.gif';
  ...
  $this->arr_buttons['bpesquisa']['image'] = 'new__NM__nm_btn1447424830_bpesquisa.gif';
  ...
  $this->arr_buttons['blimpar']['image'] = 'new__NM__nm_btn1447424830_blimpar.gif';
  ...
  $this->arr_buttons['bsalvar']['image'] = 'new__NM__nm_btn1447424830_bsalvar.gif';
  ...
  $this->arr_buttons['bedit_filter']['image'] = 'new__NM__nm_btn1447424830_bedit_filter.gif';
  ...
  $this->arr_buttons['bquick_search']['image'] = 'new__NM__nm_btn1447424830_bquick_search.gif';
  ...
  $this->arr_buttons['bmd_incluir']['image'] = 'sys__NM__guardar-documento-icono-9312-16.png';
  ...
  $this->arr_buttons['bmd_excluir']['image'] = 'sys__NM__delete-edit-icono-4269-16.png';
  ...
  $this->arr_buttons['bmd_alterar']['image'] = 'sys__NM__actualizar-pagina-icono-4711-16.png';
  ...
  $this->arr_buttons['bmd_novo']['image'] = 'sys__NM__pagina-copiar-icono-4625-16.png';
  ...
  $this->arr_buttons['bmd_cancelar']['image'] = 'sys__NM__cancelar-icono-4839-16.png';
  ...
  $this->arr_buttons['bmd_edit']['image'] = 'sys__NM__edit (4).ico';
  ...
  $this->arr_buttons['bfacebook']['display']          = 'only_img';
  ...
  $this->arr_buttons['bfacebook']['image'] = 'sys__NM__facebook-icono-8488-32.png';
  ...
  $this->arr_buttons['bgoogle']['image'] = 'sys__NM__google-icono-9299-32.png';
  ...
  $this->arr_buttons['bpaypal']['image'] = 'sys__NM__de-pago-con-tarjeta-de-credito-o-paypal-icono-5288-32.png';
  ...
  $this->arr_buttons['btwitter']['image'] = 'new__NM__nm_btn1447424830_btwitter.gif';
  ...
  $this->arr_buttons['bhelp']['image'] = 'sys__NM__ayuda-icono-8441-32.png';
  ...
  $this->arr_buttons['bsair']['image'] = 'sys__NM__deshacer-icono-5993-16.png';
  ...
  $this->arr_buttons['bvoltar']['image'] = 'sys__NM__deshacer-icono-5993-16.png';
  ...
  $this->arr_buttons['bcancelar']['image'] = 'sys__NM__cancelar-icono-4839-16.png';
  ...
  $this->arr_buttons['bapply']['image'] = 'new__NM__nm_btn1447424830_bapply.gif';
  ...
  $this->arr_buttons['brestore']['image'] = 'new__NM__nm_btn1447424830_brestore.gif';
  ...
  $this->arr_buttons['blink']['image'] = 'new__NM__nm_btn1447424830_blink.gif';
  ...
  $this->arr_buttons['blanguage']['image'] = 'new__NM__nm_btn1447424830_blanguage.gif';
  ...
  $this->arr_buttons['bfieldhelp']['image'] = 'sys__NM__ayuda-icono-8441-32.png';
  ...
  $this->arr_buttons['bsrgb']['image'] = 'new__NM__nm_btn1447424830_bsrgb.gif';
  ...
  $this->arr_buttons['berrm_clse']['image'] = 'sys__NM__cerrar-icono-6397-16.png';
  ...
  $this->arr_buttons['bemail']['image'] = 'sys__NM__e-mail-icono-5793-32.png';

  $this->arr_buttons['bcapture']['hint']             = $Nm_lang['lang_btns_pick_hint'];
  $this->arr_buttons['bcapture']['type']             = 'image';
  ...
  $this->arr_buttons['bcapture']['style'] = 'disabledSCImage';
  $this->arr_buttons['bcapture']['image'] = 'sys__NM__arrow_left.png';
  ...
  $this->arr_buttons['bmessageclose']['image'] = 'new__NM__nm_btn1447424830_bmessageclose.gif';
  ...
  $this->arr_buttons['bgooglemaps']['image'] = 'new__NM__nm_btn1447424830_bgooglemaps.gif';
  ...
  $this->arr_buttons['byoutube']['image'] = 'new__NM__nm_btn1447424830_byoutube.gif';
  ...
  $this->arr_buttons['breload']['image'] = 'new__NM__nm_btn1447424830_brestore.gif';
  ...
  $this->arr_buttons['bgridsavesession']['image'] = 'new__NM__nm_btn1447424830_bgridsave.gif';
  ...
  $this->arr_buttons['bstepretorna']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-previous (1).ico';
  ...
  $this->arr_buttons['bstepavanca']['image'] = 'sys__NM__Fatcow-Farm-Fresh-Resultset-next (1).ico';
  ...
  $this->arr_buttons['bfilref_apply']['image'] = 'new__NM__nm_btn1447424830_bpesquisa.gif';
  ...
  $this->arr_buttons['bfilref_limpar']['image'] = 'new__NM__nm_btn1447424830_blimpar.gif';
  ...
  $this->arr_buttons['bfilref_close']['image'] = 'new__NM__nm_btn1447424830_bajaxclose.gif';
  ...
  $this->arr_buttons['bjson']['image'] = 'new__NM__nm_btn1447424830_bxml.gif';
