<?php
  ...
  $this->arr_buttons['balterar']['value']            = '';
  ...
  $this->arr_buttons['balterar']['image'] = 'sys__NM__nm_new_botoes_01_balterar.gif';

  $this->arr_buttons['bavanca']['hint']             = $Nm_lang['lang_btns_next_hint'];
  $this->arr_buttons['bavanca']['type']             = 'image';
  $this->arr_buttons['bavanca']['value']            = '';
  ...
  $this->arr_buttons['bavanca']['image'] = 'sys__NM__nm_new_botoes_01_bavanca.gif';

  $this->arr_buttons['bavanca_off']['hint']             = $Nm_lang['lang_btns_next_hint'];
  $this->arr_buttons['bavanca_off']['type']             = 'image';
  $this->arr_buttons['bavanca_off']['value']            = '';
  ...
  $this->arr_buttons['bavanca_off']['image'] = 'sys__NM__nm_new_botoes_01_bavanca_off.gif';

  $this->arr_buttons['bcancelar']['hint']             = $Nm_lang['lang_btns_cncl_hint'];
  $this->arr_buttons['bcancelar']['type']             = 'image';
  $this->arr_buttons['bcancelar']['value']            = '';
  ...
  $this->arr_buttons['bcancelar']['image'] = 'sys__NM__nm_new_botoes_01_bcancelar.gif';

  $this->arr_buttons['bcolumns']['hint']             = $Nm_lang['lang_btns_clmn_hint'];
  $this->arr_buttons['bcolumns']['type']             = 'image';
  $this->arr_buttons['bcolumns']['value']            = '';
  ...
  $this->arr_buttons['bcolumns']['image'] = 'sys__NM__nm_new_botoes_01_bcolumns.gif';

  $this->arr_buttons['bconf_graf']['hint']             = $Nm_lang['lang_btns_chrt_stng_hint'];
  $this->arr_buttons['bconf_graf']['type']             = 'image';
  $this->arr_buttons['bconf_graf']['value']            = '';
  ...
  $this->arr_buttons['bconf_graf']['image'] = 'sys__NM__nm_new_botoes_01_bconf_graf.gif';

  $this->arr_buttons['bcsv']['hint']             = $Nm_lang['lang_btns_csvf_hint'];
  $this->arr_buttons['bcsv']['type']             = 'image';
  $this->arr_buttons['bcsv']['value']            = '';
  ...
  $this->arr_buttons['bedit_filter']['image'] = 'sys__NM__nm_new_botoes_01_bedit_filter.gif';

  $this->arr_buttons['bexcel']['hint']             = $Nm_lang['lang_btns_xlsf_hint'];
  $this->arr_buttons['bexcel']['type']             = 'image';
  $this->arr_buttons['bexcel']['value']            = '';
  ...
  $this->arr_buttons['bexcel']['image'] = 'sys__NM__nm_new_botoes_01_bexcel.gif';

  $this->arr_buttons['bexcluir']['hint']             = $Nm_lang['lang_btns_dele_hint'];
  $this->arr_buttons['bexcluir']['type']             = 'image';
  $this->arr_buttons['bexcluir']['value']            = '';
  ...
  $this->arr_buttons['bexcluir']['image'] = 'sys__NM__nm_new_botoes_01_bexcluir.gif';

  $this->arr_buttons['bfinal']['hint']             = $Nm_lang['lang_btns_last_hint'];
  $this->arr_buttons['bfinal']['type']             = 'image';
  $this->arr_buttons['bfinal']['value']            = '';
  ...
  $this->arr_buttons['bfinal']['image'] = 'sys__NM__nm_new_botoes_01_bfinal.gif';

  $this->arr_buttons['bfinal_off']['hint']             = $Nm_lang['lang_btns_last_hint'];
  $this->arr_buttons['bfinal_off']['type']             = 'image';
  $this->arr_buttons['bfinal_off']['value']            = '';
  ...
  $this->arr_buttons['bfinal_off']['image'] = 'sys__NM__nm_new_botoes_01_bfinal_off.gif';

  $this->arr_buttons['bgraf']['hint']             = $Nm_lang['lang_btns_chrt_hint'];
  $this->arr_buttons['bgraf']['type']             = 'image';
  $this->arr_buttons['bgraf']['value']            = '';
  ...
  $this->arr_buttons['bgraf']['image'] = 'sys__NM__nm_new_botoes_01_bgraf.gif';

  $this->arr_buttons['bhelp']['hint']             = $Nm_lang['lang_btns_help_hint'];
  $this->arr_buttons['bhelp']['type']             = 'image';
  $this->arr_buttons['bhelp']['value']            = '';
  ...
  $this->arr_buttons['bhelp']['image'] = 'sys__NM__nm_new_botoes_01_bhelp.gif';

  $this->arr_buttons['bincluir']['hint']             = $Nm_lang['lang_btns_inst_hint'];
  $this->arr_buttons['bincluir']['type']             = 'image';
  $this->arr_buttons['bincluir']['value']            = '';
  ...
  $this->arr_buttons['bincluir']['image'] = 'sys__NM__nm_new_botoes_01_bincluir.gif';

  $this->arr_buttons['binicio']['hint']             = $Nm_lang['lang_btns_frst_hint'];
  $this->arr_buttons['binicio']['type']             = 'image';
  $this->arr_buttons['binicio']['value']            = '';
  ...
  $this->arr_buttons['binicio']['image'] = 'sys__NM__nm_new_botoes_01_binicio.gif';

  $this->arr_buttons['binicio_off']['hint']             = $Nm_lang['lang_btns_frst_hint'];
  $this->arr_buttons['binicio_off']['type']             = 'image';
  $this->arr_buttons['binicio_off']['value']            = '';
  ...
  $this->arr_buttons['binicio_off']['image'] = 'sys__NM__nm_new_botoes_01_binicio_off.gif';

  $this->arr_buttons['birpara']['hint']             = $Nm_lang['lang_btns_jump_hint'];
  $this->arr_buttons['birpara']['type']             = 'image';
  $this->arr_buttons['birpara']['value']            = '';
  ...
  $this->arr_buttons['birpara']['image'] = 'sys__NM__nm_new_botoes_01_birpara.gif';

  $this->arr_buttons['blimpar']['hint']             = $Nm_lang['lang_btns_clea_hint'];
  $this->arr_buttons['blimpar']['type']             = 'image';
  $this->arr_buttons['blimpar']['value']            = '';
  ...
  $this->arr_buttons['blimpar']['image'] = 'sys__NM__nm_new_botoes_01_blimpar.gif';
  ...
  $this->arr_buttons['bmd_alterar']['image'] = 'sys__NM__nm_new_botoes_01_bmd_alterar.gif';
  ...
  $this->arr_buttons['bmd_cancelar']['image'] = 'sys__NM__nm_new_botoes_01_bmd_cancelar.gif';
  ...
  $this->arr_buttons['bmd_edit']['image'] = 'sys__NM__nm_new_botoes_01_bmd_edit.gif';
  ...
  $this->arr_buttons['bmd_excluir']['image'] = 'sys__NM__nm_new_botoes_01_bmd_excluir.gif';
  ...
  $this->arr_buttons['bmd_incluir']['image'] = 'sys__NM__nm_new_botoes_01_bmd_incluir.gif';
  ...
  $this->arr_buttons['bmd_novo']['image'] = 'sys__NM__nm_new_botoes_01_bmd_novo.gif';

  $this->arr_buttons['bnovo']['hint']             = $Nm_lang['lang_btns_neww_hint'];
  $this->arr_buttons['bnovo']['type']             = 'image';
  $this->arr_buttons['bnovo']['value']            = '';
  ...
  $this->arr_buttons['bnovo']['image'] = 'sys__NM__nm_new_botoes_01_bnovo.gif';

  $this->arr_buttons['bok']['hint']             = $Nm_lang['lang_btns_cfrm_hint'];
  $this->arr_buttons['bok']['type']             = 'image';
  $this->arr_buttons['bok']['value']            = '';
  ...
  $this->arr_buttons['bok']['image'] = 'sys__NM__nm_new_botoes_01_bok.gif';

  $this->arr_buttons['bpdf']['hint']             = $Nm_lang['lang_btns_pdfc_hint'];
  $this->arr_buttons['bpdf']['type']             = 'image';
  $this->arr_buttons['bpdf']['value']            = '';
  ...
  $this->arr_buttons['bpesquisa']['image'] = 'sys__NM__nm_new_botoes_01_bpesquisa.gif';

  $this->arr_buttons['bprint']['hint']             = $Nm_lang['lang_btns_prnt_hint'];
  $this->arr_buttons['bprint']['type']             = 'image';
  $this->arr_buttons['bprint']['value']            = '';
  ...
  $this->arr_buttons['bprint']['image'] = 'sys__NM__nm_new_botoes_01_bprint.gif';
  ...
  $this->arr_buttons['bqtd_bytes']['image'] = 'sys__NM__nm_new_botoes_01_bqtd_bytes.gif';

  $this->arr_buttons['bqt_linhas']['hint']             = $Nm_lang['lang_btns_rows_hint'];
  $this->arr_buttons['bqt_linhas']['type']             = 'image';
  $this->arr_buttons['bqt_linhas']['value']            = '';
  ...
  $this->arr_buttons['bqt_linhas']['image'] = 'sys__NM__nm_new_botoes_01_bqt_linhas.gif';

  $this->arr_buttons['bresumo']['hint']             = $Nm_lang['lang_btns_smry_hint'];
  $this->arr_buttons['bresumo']['type']             = 'image';
  $this->arr_buttons['bresumo']['value']            = '';
  ...
  $this->arr_buttons['bresumo']['image'] = 'sys__NM__nm_new_botoes_01_bresumo.gif';

  $this->arr_buttons['bretorna']['hint']             = $Nm_lang['lang_btns_prev_hint'];
  $this->arr_buttons['bretorna']['type']             = 'image';
  $this->arr_buttons['bretorna']['value']            = '';
  ...
  $this->arr_buttons['bretorna']['image'] = 'sys__NM__nm_new_botoes_01_bretorna.gif';

  $this->arr_buttons['bretorna_off']['hint']             = $Nm_lang['lang_btns_prev_hint'];
  $this->arr_buttons['bretorna_off']['type']             = 'image';
  $this->arr_buttons['bretorna_off']['value']            = '';
  ...
  $this->arr_buttons['bretorna_off']['image'] = 'sys__NM__nm_new_botoes_01_bretorna_off.gif';

  $this->arr_buttons['brtf']['hint']             = $Nm_lang['lang_btns_rtff_hint'];
  $this->arr_buttons['brtf']['type']             = 'image';
  $this->arr_buttons['brtf']['value']            = '';
  ...
  $this->arr_buttons['brtf']['image'] = 'sys__NM__nm_new_botoes_01_brtf.gif';

  $this->arr_buttons['bsair']['hint']             = $Nm_lang['lang_btns_exit_hint'];
  $this->arr_buttons['bsair']['type']             = 'image';
  $this->arr_buttons['bsair']['value']            = '';
  ...
  $this->arr_buttons['bsair']['image'] = 'sys__NM__nm_new_botoes_01_bsair.gif';

  $this->arr_buttons['bsalvar']['hint']             = $Nm_lang['lang_btns_save_hint'];
  $this->arr_buttons['bsalvar']['type']             = 'image';
  $this->arr_buttons['bsalvar']['value']            = '';
  ...
  $this->arr_buttons['bsalvar']['image'] = 'sys__NM__nm_new_botoes_01_bsalvar.gif';

  $this->arr_buttons['bsort']['hint']             = $Nm_lang['lang_btns_sort_hint'];
  $this->arr_buttons['bsort']['type']             = 'image';
  $this->arr_buttons['bsort']['value']            = '';
  ...
  $this->arr_buttons['bsort']['image'] = 'sys__NM__nm_new_botoes_01_bsort.gif';

  $this->arr_buttons['bvoltar']['hint']             = $Nm_lang['lang_btns_back_hint'];
  $this->arr_buttons['bvoltar']['type']             = 'image';
  $this->arr_buttons['bvoltar']['value']            = '';
  ...
  $this->arr_buttons['bvoltar']['image'] = 'sys__NM__nm_new_botoes_01_bvoltar.gif';

  $this->arr_buttons['bxml']['hint']             = $Nm_lang['lang_btns_xmlf_hint'];
  $this->arr_buttons['bxml']['type']             = 'image';
  $this->arr_buttons['bxml']['value']            = '';
  ...
  $this->arr_buttons['bcons_inicio']['image'] = 'sys__NM__nm_new_botoes_01_bcons_inicio.gif';

  $this->arr_buttons['bcons_retorna']['hint']             = $Nm_lang['lang_btns_prev_hint'];
  $this->arr_buttons['bcons_retorna']['type']             = 'image';
  $this->arr_buttons['bcons_retorna']['value']            = '';
  ...
  $this->arr_buttons['bcons_retorna']['image'] = 'sys__NM__nm_new_botoes_01_bcons_retorna.gif';

  $this->arr_buttons['bcons_avanca']['hint']             = $Nm_lang['lang_btns_next_hint'];
  $this->arr_buttons['bcons_avanca']['type']             = 'image';
  $this->arr_buttons['bcons_avanca']['value']            = '';
  ...
  $this->arr_buttons['bcons_avanca']['image'] = 'sys__NM__nm_new_botoes_01_bcons_avanca.gif';

  $this->arr_buttons['bcons_final']['hint']             = $Nm_lang['lang_btns_last_hint'];
  $this->arr_buttons['bcons_final']['type']             = 'image';
  $this->arr_buttons['bcons_final']['value']            = '';
  ...
  $this->arr_buttons['bcons_final']['image'] = 'sys__NM__nm_new_botoes_01_bcons_final.gif';

  $this->arr_buttons['bcons_inicio_off']['hint']             = $Nm_lang['lang_btns_frst_hint'];
  $this->arr_buttons['bcons_inicio_off']['type']             = 'image';
  $this->arr_buttons['bcons_inicio_off']['value']            = '';
  ...
  $this->arr_buttons['bcons_inicio_off']['image'] = 'sys__NM__nm_new_botoes_01_bcons_inicio_off.gif';

  $this->arr_buttons['bcons_retorna_off']['hint']             = $Nm_lang['lang_btns_prev_hint'];
  $this->arr_buttons['bcons_retorna_off']['type']             = 'image';
  $this->arr_buttons['bcons_retorna_off']['value']            = '';
  ...
  $this->arr_buttons['bcons_retorna_off']['image'] = 'sys__NM__nm_new_botoes_01_bcons_retorna_off.gif';

  $this->arr_buttons['bcons_avanca_off']['hint']             = $Nm_lang['lang_btns_next_hint'];
  $this->arr_buttons['bcons_avanca_off']['type']             = 'image';
  $this->arr_buttons['bcons_avanca_off']['value']            = '';
  ...
  $this->arr_buttons['bcons_avanca_off']['image'] = 'sys__NM__nm_new_botoes_01_bcons_avanca_off.gif';

  $this->arr_buttons['bcons_final_off']['hint']             = $Nm_lang['lang_btns_last_hint'];
  $this->arr_buttons['bcons_final_off']['type']             = 'image';
  $this->arr_buttons['bcons_final_off']['value']            = '';
  ...
  $this->arr_buttons['bcons_final_off']['image'] = 'sys__NM__nm_new_botoes_01_bcons_final_off.gif';
  ...
  $this->arr_buttons['bform_editar']['image'] = 'sys__NM__nm_new_botoes_01_bform_editar.gif';
  ...
  $this->arr_buttons['bform_captura']['image'] = 'sys__NM__nm_new_botoes_01_bform_captura.gif';
  ...
  $this->arr_buttons['bform_lookuplink']['image'] = 'sys__NM__nm_new_botoes_01_bform_lookuplink.gif';
  ...
  $this->arr_buttons['bcons_detalhes']['image'] = 'sys__NM__nm_new_botoes_01_bcons_detalhes.gif';
  ...
  $this->arr_buttons['bcalendario']['image'] = 'sys__NM__nm_new_botoes_01_bcalendario.gif';
  ...
  $this->arr_buttons['bcalculadora']['image'] = 'sys__NM__nm_new_botoes_01_bcalculadora.gif';
  ...
  $this->arr_buttons['bzipcode']['image'] = 'sys__NM__nm_new_botoes_01_bzipcode.gif';
  ...
  $this->arr_buttons['blink']['image'] = 'sys__NM__nm_new_botoes_01_blink.gif';
  ...
  $this->arr_buttons['bfieldhelp']['image'] = 'sys__NM__nm_new_botoes_01_bfieldhelp.gif';
  ...
  $this->arr_buttons['bsrch_mtmf']['image'] = 'sys__NM__nm_new_botoes_01_bsrch_mtmf.gif';
  ...
  $this->arr_buttons['bexport']['image'] = 'sys__NM__nm_new_botoes_01_bexport.gif';
  ...
  $this->arr_buttons['bajaxcapt']['image'] = 'sys__NM__nm_new_botoes_01_bajaxcapt.gif';
  ...
  $this->arr_buttons['bajaxclose']['image'] = 'sys__NM__nm_new_botoes_01_bajaxclose.gif';
  ...
  $this->arr_buttons['bcaptchareload']['image'] = 'sys__NM__nm_new_botoes_01_bcaptchareload.gif';
  ...
  $this->arr_buttons['blanguage']['image'] = 'sys__NM__nm_new_botoes_01_blanguage.gif';
  ...
  $this->arr_buttons['bsrgb']['image'] = 'sys__NM__nm_new_botoes_01_bsrgb.gif';
  ...
  $this->arr_buttons['berrm_clse']['image'] = 'sys__NM__nm_new_botoes_01_berrm_clse.gif';
  ...
  $this->arr_buttons['blink_resumogrid']['image'] = 'sys__NM__nm_new_botoes_01_blink_resumogrid.gif';
  ...
  $this->arr_buttons['brot_resumo']['image'] = 'sys__NM__nm_new_botoes_01_brot_resumo.gif';
  ...
  $this->arr_buttons['smry_conf']['image'] = 'sys__NM__nm_new_botoes_01_smry_conf.gif';
  ...
  $this->arr_buttons['bexportview']['image'] = 'sys__NM__nm_new_botoes_01_bexportview.gif';
  ...
  $this->arr_buttons['bdownload']['image'] = 'sys__NM__nm_new_botoes_01_bdownload.gif';
  ...
  $this->arr_buttons['bquick_search']['image'] = 'sys__NM__nm_new_botoes_01_bquick_search.gif';
  ...
  $this->arr_buttons['bemail']['image'] = 'sys__NM__nm_new_botoes_01_bemail.gif';
  ...
  $this->arr_buttons['bcapture']['image'] = 'sys__NM__nm_new_botoes_01_bcapture.gif';
  ...
  $this->arr_buttons['bmessageclose']['image'] = 'sys__NM__nm_new_botoes_01_bmessageclose.gif';
  ...
  $this->arr_buttons['bgooglemaps']['image'] = 'sys__NM__nm_new_botoes_01_bgooglemaps.gif';
  ...
  $this->arr_buttons['byoutube']['image'] = 'sys__NM__nm_new_botoes_01_byoutube.gif';
  ...
  $this->arr_buttons['bstepretorna']['image'] = 'sys__NM__nm_new_botoes_01_bstepretorna.gif';
  ...
  $this->arr_buttons['bstepavanca']['image'] = 'sys__NM__nm_new_botoes_01_bstepavanca.gif';
  ...
  $this->arr_buttons['bfilref_apply']['image'] = 'sys__NM__nm_new_botoes_01_bfilref_apply.gif';
  ...
  $this->arr_buttons['bfilref_limpar']['image'] = 'sys__NM__nm_new_botoes_01_bfilref_limpar.gif';
  ...
  $this->arr_buttons['bfilref_close']['image'] = 'sys__NM__nm_new_botoes_01_bfilref_close.gif';
  ...
  $this->arr_buttons['bjson']['image'] = 'sys__NM__nm_new_botoes_01_bjson.gif';
