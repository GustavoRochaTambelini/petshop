<?php
  ...
  $this->arr_buttons['bform_editar']['image'] = 'sys__NM__nm_ScriptCase6_BlueOcean_bmd_edit.gif';
  ...
  $this->arr_buttons['bajaxclose']['image'] = 'scriptcase__NM__nm_Scriptcase7_BlueSky_berrm_clse.gif';
  ...
  $this->arr_buttons['bmd_edit']['image'] = 'sys__NM__nm_ScriptCase6_BlueOcean_bmd_edit.gif';
  ...
  $this->arr_buttons['bzipcode']['image'] = 'sys__NM__nm_Ceropegia2_bzipcode.gif';
  ...
  $this->arr_buttons['bfilref_close']['image'] = 'scriptcase__NM__nm_Scriptcase7_BlueSky_berrm_clse.gif';
