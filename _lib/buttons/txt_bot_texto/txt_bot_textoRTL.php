<?php
  ...
  $this->arr_buttons['bcons_inicio']['image'] = 'sys__NM__nm_txt_bot_texto_bcons_inicio.gif';
  ...
  $this->arr_buttons['bcons_retorna']['image'] = 'sys__NM__nm_txt_bot_texto_bcons_retorna.gif';
  ...
  $this->arr_buttons['bcons_avanca']['image'] = 'sys__NM__nm_txt_bot_texto_bcons_avanca.gif';
  ...
  $this->arr_buttons['bcons_final']['image'] = 'sys__NM__nm_txt_bot_texto_bcons_final.gif';

  $this->arr_buttons['bform_editar']['hint']             = $Nm_lang['lang_btns_pncl_hint'];
  $this->arr_buttons['bform_editar']['type']             = 'image';
  $this->arr_buttons['bform_editar']['value']            = '';
  ...
  $this->arr_buttons['bform_editar']['image'] = 'sys__NM__nm_txt_bot_texto_bform_editar.gif';

  $this->arr_buttons['bform_captura']['hint']             = $Nm_lang['lang_btns_rtrv_grid_hint'];
  $this->arr_buttons['bform_captura']['type']             = 'image';
  $this->arr_buttons['bform_captura']['value']            = '';
  ...
  $this->arr_buttons['bform_captura']['image'] = 'sys__NM__nm_txt_bot_texto_bform_captura.gif';

  $this->arr_buttons['bform_lookuplink']['hint']             = $Nm_lang['lang_btns_rtrv_form_hint'];
  $this->arr_buttons['bform_lookuplink']['type']             = 'image';
  $this->arr_buttons['bform_lookuplink']['value']            = '';
  ...
  $this->arr_buttons['bform_lookuplink']['image'] = 'sys__NM__nm_txt_bot_texto_bform_lookuplink.gif';

  $this->arr_buttons['bcons_detalhes']['hint']             = $Nm_lang['lang_btns_lens_hint'];
  $this->arr_buttons['bcons_detalhes']['type']             = 'image';
  $this->arr_buttons['bcons_detalhes']['value']            = '';
  ...
  $this->arr_buttons['bcons_detalhes']['image'] = 'sys__NM__nm_txt_bot_texto_bcons_detalhes.gif';

  $this->arr_buttons['bcalendario']['hint']             = $Nm_lang['lang_btns_cldr_hint'];
  $this->arr_buttons['bcalendario']['type']             = 'image';
  $this->arr_buttons['bcalendario']['value']            = '';
  ...
  $this->arr_buttons['bcalendario']['image'] = 'sys__NM__nm_txt_bot_texto_bcalendario.gif';

  $this->arr_buttons['bcalculadora']['hint']             = $Nm_lang['lang_btns_calc_hint'];
  $this->arr_buttons['bcalculadora']['type']             = 'image';
  $this->arr_buttons['bcalculadora']['value']            = '';
  ...
  $this->arr_buttons['bcalculadora']['image'] = 'sys__NM__nm_txt_bot_texto_bcalculadora.gif';

  $this->arr_buttons['bzipcode']['hint']             = $Nm_lang['lang_btns_zpcd_hint'];
  $this->arr_buttons['bzipcode']['type']             = 'image';
  $this->arr_buttons['bzipcode']['value']            = '';
  ...
  $this->arr_buttons['bzipcode']['image'] = 'sys__NM__nm_txt_bot_texto_bzipcode.gif';

  $this->arr_buttons['blink']['hint']             = $Nm_lang['lang_btns_iurl_hint'];
  $this->arr_buttons['blink']['type']             = 'image';
  $this->arr_buttons['blink']['value']            = '';
  ...
  $this->arr_buttons['bfieldhelp']['image'] = 'sys__NM__nm_txt_bot_texto_bfieldhelp.gif';

  $this->arr_buttons['bmd_cancelar']['hint']             = $Nm_lang['lang_btns_mdtl_cncl_hint'];
  $this->arr_buttons['bmd_cancelar']['type']             = 'image';
  $this->arr_buttons['bmd_cancelar']['value']            = '';
  ...
  $this->arr_buttons['bmd_cancelar']['image'] = 'sys__NM__nm_txt_bot_texto_bmd_cancelar.gif';

  $this->arr_buttons['bmd_excluir']['hint']             = $Nm_lang['lang_btns_mdtl_dele_hint'];
  $this->arr_buttons['bmd_excluir']['type']             = 'image';
  $this->arr_buttons['bmd_excluir']['value']            = '';
  ...
  $this->arr_buttons['bmd_excluir']['image'] = 'sys__NM__nm_txt_bot_texto_bmd_excluir.gif';

  $this->arr_buttons['bmd_alterar']['hint']             = $Nm_lang['lang_btns_mdtl_updt_hint'];
  $this->arr_buttons['bmd_alterar']['type']             = 'image';
  $this->arr_buttons['bmd_alterar']['value']            = '';
  ...
  $this->arr_buttons['bmd_alterar']['image'] = 'sys__NM__nm_txt_bot_texto_bmd_alterar.gif';

  $this->arr_buttons['bmd_incluir']['hint']             = $Nm_lang['lang_btns_mdtl_inst_hint'];
  $this->arr_buttons['bmd_incluir']['type']             = 'image';
  $this->arr_buttons['bmd_incluir']['value']            = '';
  ...
  $this->arr_buttons['bmd_incluir']['image'] = 'sys__NM__nm_txt_bot_texto_bmd_incluir.gif';

  $this->arr_buttons['bmd_novo']['hint']             = $Nm_lang['lang_btns_mdtl_neww_hint'];
  $this->arr_buttons['bmd_novo']['type']             = 'image';
  $this->arr_buttons['bmd_novo']['value']            = '';
  ...
  $this->arr_buttons['bmd_novo']['image'] = 'sys__NM__nm_txt_bot_texto_bmd_novo.gif';

  $this->arr_buttons['bmd_edit']['hint']             = $Nm_lang['lang_btns_mdtl_edit_hint'];
  $this->arr_buttons['bmd_edit']['type']             = 'image';
  $this->arr_buttons['bmd_edit']['value']            = '';
  ...
  $this->arr_buttons['bmd_edit']['image'] = 'sys__NM__nm_txt_bot_texto_bmd_edit.gif';

  $this->arr_buttons['bsrch_mtmf']['hint']             = $Nm_lang['lang_btns_srch_mtmf_hint'];
  $this->arr_buttons['bsrch_mtmf']['type']             = 'image';
  $this->arr_buttons['bsrch_mtmf']['value']            = '';
  ...
  $this->arr_buttons['bsrch_mtmf']['image'] = 'sys__NM__nm_txt_bot_texto_bsrch_mtmf.gif';

  $this->arr_buttons['bemail']['hint']             = $Nm_lang['lang_btns_emai_hint'];
  $this->arr_buttons['bemail']['type']             = 'image';
  $this->arr_buttons['bemail']['value']            = '';
  ...
  $this->arr_buttons['bemail']['image'] = 'sys__NM__nm_txt_bot_texto_bemail.gif';

  $this->arr_buttons['bgooglemaps']['hint']             = $Nm_lang['lang_btns_maps_hint'];
  $this->arr_buttons['bgooglemaps']['type']             = 'image';
  $this->arr_buttons['bgooglemaps']['value']            = '';
  ...
  $this->arr_buttons['bgooglemaps']['image'] = 'sys__NM__nm_txt_bot_texto_bgooglemaps.gif';

  $this->arr_buttons['byoutube']['hint']             = $Nm_lang['lang_btns_yutb_hint'];
  $this->arr_buttons['byoutube']['type']             = 'image';
  $this->arr_buttons['byoutube']['value']            = '';
  ...
  $this->arr_buttons['byoutube']['image'] = 'sys__NM__nm_txt_bot_texto_byoutube.gif';
  ...
  $this->arr_buttons['birpara']['image'] = 'sys__NM__nm_txt_bot_texto_birpara.gif';
  ...
  $this->arr_buttons['bprint']['image'] = 'sys__NM__nm_txt_bot_texto_bprint.gif';
  ...
  $this->arr_buttons['bresumo']['image'] = 'sys__NM__nm_txt_bot_texto_bresumo.gif';
  ...
  $this->arr_buttons['bsort']['image'] = 'sys__NM__nm_txt_bot_texto_bsort.gif';
  ...
  $this->arr_buttons['bcolumns']['image'] = 'sys__NM__nm_txt_bot_texto_bcolumns.gif';
  ...
  $this->arr_buttons['bqt_linhas']['image'] = 'sys__NM__nm_txt_bot_texto_bqt_linhas.gif';
  ...
  $this->arr_buttons['bgraf']['image'] = 'sys__NM__nm_txt_bot_texto_bgraf.gif';
  ...
  $this->arr_buttons['bconf_graf']['image'] = 'sys__NM__nm_txt_bot_texto_bconf_graf.gif';
  ...
  $this->arr_buttons['bqtd_bytes']['image'] = 'sys__NM__nm_txt_bot_texto_bqtd_bytes.gif';
  ...
  $this->arr_buttons['blink_resumogrid']['image'] = 'sys__NM__nm_txt_bot_texto_blink_resumogrid.gif';
  ...
  $this->arr_buttons['brot_resumo']['image'] = 'sys__NM__nm_txt_bot_texto_brot_resumo.gif';
  ...
  $this->arr_buttons['smry_conf']['image'] = 'sys__NM__nm_txt_bot_texto_smry_conf.gif';
  ...
  $this->arr_buttons['bcons_inicio_off']['image'] = 'sys__NM__nm_txt_bot_texto_bcons_inicio_off.gif';
  ...
  $this->arr_buttons['bcons_retorna_off']['image'] = 'sys__NM__nm_txt_bot_texto_bcons_retorna_off.gif';
  ...
  $this->arr_buttons['bcons_avanca_off']['image'] = 'sys__NM__nm_txt_bot_texto_bcons_avanca_off.gif';
  ...
  $this->arr_buttons['bcons_final_off']['image'] = 'sys__NM__nm_txt_bot_texto_bcons_final_off.gif';
  ...
  $this->arr_buttons['bpdf']['image'] = 'sys__NM__nm_txt_bot_texto_bpdf.gif';
  ...
  $this->arr_buttons['brtf']['image'] = 'sys__NM__nm_txt_bot_texto_brtf.gif';
  ...
  $this->arr_buttons['bexcel']['image'] = 'sys__NM__nm_txt_bot_texto_bexcel.gif';
  ...
  $this->arr_buttons['bxml']['image'] = 'sys__NM__nm_txt_bot_texto_bxml.gif';
  ...
  $this->arr_buttons['bcsv']['image'] = 'sys__NM__nm_txt_bot_texto_bcsv.gif';
  ...
  $this->arr_buttons['bexport']['image'] = 'sys__NM__nm_txt_bot_texto_bexport.gif';
  ...
  $this->arr_buttons['bexportview']['image'] = 'sys__NM__nm_txt_bot_texto_bexportview.gif';
  ...
  $this->arr_buttons['bdownload']['image'] = 'sys__NM__nm_txt_bot_texto_bdownload.gif';
  ...
  $this->arr_buttons['binicio']['image'] = 'sys__NM__nm_txt_bot_texto_binicio.gif';
  ...
  $this->arr_buttons['bretorna']['image'] = 'sys__NM__nm_txt_bot_texto_bretorna.gif';
  ...
  $this->arr_buttons['bavanca']['image'] = 'sys__NM__nm_txt_bot_texto_bavanca.gif';
  ...
  $this->arr_buttons['bfinal']['image'] = 'sys__NM__nm_txt_bot_texto_bfinal.gif';
  ...
  $this->arr_buttons['bincluir']['image'] = 'sys__NM__nm_txt_bot_texto_bincluir.gif';
  ...
  $this->arr_buttons['bexcluir']['image'] = 'sys__NM__nm_txt_bot_texto_bexcluir.gif';
  ...
  $this->arr_buttons['balterar']['image'] = 'sys__NM__nm_txt_bot_texto_balterar.gif';
  ...
  $this->arr_buttons['bnovo']['image'] = 'sys__NM__nm_txt_bot_texto_bnovo.gif';
  ...
  $this->arr_buttons['bok']['image'] = 'sys__NM__nm_txt_bot_texto_bok.gif';
  ...
  $this->arr_buttons['bajaxcapt']['image'] = 'sys__NM__nm_txt_bot_texto_bajaxcapt.gif';
  ...
  $this->arr_buttons['bajaxclose']['image'] = 'sys__NM__nm_txt_bot_texto_bajaxclose.gif';
  ...
  $this->arr_buttons['bcaptchareload']['image'] = 'sys__NM__nm_txt_bot_texto_bcaptchareload.gif';
  ...
  $this->arr_buttons['binicio_off']['image'] = 'sys__NM__nm_txt_bot_texto_binicio_off.gif';
  ...
  $this->arr_buttons['bretorna_off']['image'] = 'sys__NM__nm_txt_bot_texto_bretorna_off.gif';
  ...
  $this->arr_buttons['bavanca_off']['image'] = 'sys__NM__nm_txt_bot_texto_bavanca_off.gif';
  ...
  $this->arr_buttons['bfinal_off']['image'] = 'sys__NM__nm_txt_bot_texto_bfinal_off.gif';
  ...
  $this->arr_buttons['bpesquisa']['image'] = 'sys__NM__nm_txt_bot_texto_bpesquisa.gif';
  ...
  $this->arr_buttons['blimpar']['image'] = 'sys__NM__nm_txt_bot_texto_blimpar.gif';
  ...
  $this->arr_buttons['bsalvar']['image'] = 'sys__NM__nm_txt_bot_texto_bsalvar.gif';
  ...
  $this->arr_buttons['bedit_filter']['image'] = 'sys__NM__nm_txt_bot_texto_bedit_filter.gif';
  ...
  $this->arr_buttons['bquick_search']['image'] = 'sys__NM__nm_txt_bot_texto_bquick_search.gif';
  ...
  $this->arr_buttons['bhelp']['image'] = 'sys__NM__nm_txt_bot_texto_bhelp.gif';
  ...
  $this->arr_buttons['bsair']['image'] = 'sys__NM__nm_txt_bot_texto_bsair.gif';
  ...
  $this->arr_buttons['bvoltar']['image'] = 'sys__NM__nm_txt_bot_texto_bvoltar.gif';
  ...
  $this->arr_buttons['bcancelar']['image'] = 'sys__NM__nm_txt_bot_texto_bcancelar.gif';
  ...
  $this->arr_buttons['blanguage']['image'] = 'sys__NM__nm_txt_bot_texto_blanguage.gif';
  ...
  $this->arr_buttons['bsrgb']['image'] = 'sys__NM__nm_txt_bot_texto_bsrgb.gif';
  ...
  $this->arr_buttons['berrm_clse']['image'] = 'sys__NM__nm_txt_bot_texto_berrm_clse.gif';
  ...
  $this->arr_buttons['bcapture']['image'] = 'sys__NM__nm_txt_bot_texto_bcapture.gif';
  ...
  $this->arr_buttons['bmessageclose']['image'] = 'sys__NM__nm_txt_bot_texto_bmessageclose.gif';
  ...
  $this->arr_buttons['gantt_chart']['display']          = '';
  $this->arr_buttons['gantt_chart']['display_position'] = '';
  $this->arr_buttons['gantt_chart']['fontawesomeicon']  = '';
  $this->arr_buttons['gantt_chart']['style'] = 'default';
  $this->arr_buttons['gantt_chart']['image'] = 'sys__NM__nm_txt_bot_texto_gantt_chart.gif';
  ...
  $this->arr_buttons['bcons_apply']['display']          = '';
  $this->arr_buttons['bcons_apply']['display_position'] = '';
  $this->arr_buttons['bcons_apply']['fontawesomeicon']  = '';
  $this->arr_buttons['bcons_apply']['style'] = 'default';
  $this->arr_buttons['bcons_apply']['image'] = 'sys__NM__nm_txt_bot_texto_bcons_apply.gif';
  ...
  $this->arr_buttons['bcons_cancel']['display']          = '';
  $this->arr_buttons['bcons_cancel']['display_position'] = '';
  $this->arr_buttons['bcons_cancel']['fontawesomeicon']  = '';
  $this->arr_buttons['bcons_cancel']['style'] = 'default';
  $this->arr_buttons['bcons_cancel']['image'] = 'sys__NM__nm_txt_bot_texto_bcons_cancel.gif';
  ...
  $this->arr_buttons['bmultiselect']['display']          = '';
  $this->arr_buttons['bmultiselect']['display_position'] = '';
  $this->arr_buttons['bmultiselect']['fontawesomeicon']  = '';
  $this->arr_buttons['bmultiselect']['style'] = 'default';
  $this->arr_buttons['bmultiselect']['image'] = 'sys__NM__nm_txt_bot_texto_bmultiselect.gif';
  ...
  $this->arr_buttons['bcresumo']['display']          = '';
  $this->arr_buttons['bcresumo']['display_position'] = '';
  $this->arr_buttons['bcresumo']['fontawesomeicon']  = '';
  $this->arr_buttons['bcresumo']['style'] = 'default';
  $this->arr_buttons['bcresumo']['image'] = 'sys__NM__nm_txt_bot_texto_bcresumo.gif';
  ...
  $this->arr_buttons['bcsort']['image'] = 'sys__NM__nm_txt_bot_texto_bcsort.gif';
  ...
  $this->arr_buttons['bctype']['display']          = '';
  $this->arr_buttons['bctype']['display_position'] = '';
  $this->arr_buttons['bctype']['fontawesomeicon']  = '';
  $this->arr_buttons['bctype']['style'] = 'default';
  $this->arr_buttons['bctype']['image'] = 'sys__NM__nm_txt_bot_texto_bctype.gif';
  ...
  $this->arr_buttons['bcpersonalite']['display']          = '';
  $this->arr_buttons['bcpersonalite']['display_position'] = '';
  $this->arr_buttons['bcpersonalite']['fontawesomeicon']  = '';
  $this->arr_buttons['bcpersonalite']['style'] = 'default';
  $this->arr_buttons['bcpersonalite']['image'] = 'sys__NM__nm_txt_bot_texto_bcpersonalite.gif';
  ...
  $this->arr_buttons['bchart_bar']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_bar.gif';
  ...
  $this->arr_buttons['bchart_line']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_line.gif';
  ...
  $this->arr_buttons['bchart_area']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_area.gif';
  ...
  $this->arr_buttons['bchart_pizza']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_pizza.gif';
  ...
  $this->arr_buttons['bchart_combo']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_combo.gif';
  ...
  $this->arr_buttons['bchart_stack']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_stack.gif';
  ...
  $this->arr_buttons['bcsort_on']['display']          = '';
  $this->arr_buttons['bcsort_on']['display_position'] = '';
  $this->arr_buttons['bcsort_on']['fontawesomeicon']  = '';
  $this->arr_buttons['bcsort_on']['style'] = 'default';
  $this->arr_buttons['bcsort_on']['image'] = 'sys__NM__nm_txt_bot_texto_bcsort_on.gif';
  ...
  $this->arr_buttons['bchart_bar_on']['display']          = '';
  $this->arr_buttons['bchart_bar_on']['display_position'] = '';
  $this->arr_buttons['bchart_bar_on']['fontawesomeicon']  = '';
  $this->arr_buttons['bchart_bar_on']['style'] = 'default';
  $this->arr_buttons['bchart_bar_on']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_bar_on.gif';
  ...
  $this->arr_buttons['bchart_line_on']['display']          = '';
  $this->arr_buttons['bchart_line_on']['display_position'] = '';
  $this->arr_buttons['bchart_line_on']['fontawesomeicon']  = '';
  $this->arr_buttons['bchart_line_on']['style'] = 'default';
  $this->arr_buttons['bchart_line_on']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_line_on.gif';
  ...
  $this->arr_buttons['bchart_area_on']['display']          = '';
  $this->arr_buttons['bchart_area_on']['display_position'] = '';
  $this->arr_buttons['bchart_area_on']['fontawesomeicon']  = '';
  $this->arr_buttons['bchart_area_on']['style'] = 'default';
  $this->arr_buttons['bchart_area_on']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_area_on.gif';
  ...
  $this->arr_buttons['bchart_pizza_on']['display']          = '';
  $this->arr_buttons['bchart_pizza_on']['display_position'] = '';
  $this->arr_buttons['bchart_pizza_on']['fontawesomeicon']  = '';
  $this->arr_buttons['bchart_pizza_on']['style'] = 'default';
  $this->arr_buttons['bchart_pizza_on']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_pizza_on.gif';
  ...
  $this->arr_buttons['bchart_combo_on']['display']          = '';
  $this->arr_buttons['bchart_combo_on']['display_position'] = '';
  $this->arr_buttons['bchart_combo_on']['fontawesomeicon']  = '';
  $this->arr_buttons['bchart_combo_on']['style'] = 'default';
  $this->arr_buttons['bchart_combo_on']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_combo_on.gif';
  ...
  $this->arr_buttons['bchart_stack_on']['display']          = '';
  $this->arr_buttons['bchart_stack_on']['display_position'] = '';
  $this->arr_buttons['bchart_stack_on']['fontawesomeicon']  = '';
  $this->arr_buttons['bchart_stack_on']['style'] = 'default';
  $this->arr_buttons['bchart_stack_on']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_stack_on.gif';
  ...
  $this->arr_buttons['bcsort_off']['display']          = '';
  $this->arr_buttons['bcsort_off']['display_position'] = '';
  $this->arr_buttons['bcsort_off']['fontawesomeicon']  = '';
  $this->arr_buttons['bcsort_off']['style'] = 'disabled';
  $this->arr_buttons['bcsort_off']['image'] = 'sys__NM__nm_txt_bot_texto_bcsort_off.gif';
  ...
  $this->arr_buttons['bchart_bar_off']['display']          = '';
  $this->arr_buttons['bchart_bar_off']['display_position'] = '';
  $this->arr_buttons['bchart_bar_off']['fontawesomeicon']  = '';
  $this->arr_buttons['bchart_bar_off']['style'] = 'disabled';
  $this->arr_buttons['bchart_bar_off']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_bar_off.gif';
  ...
  $this->arr_buttons['bchart_line_off']['display']          = '';
  $this->arr_buttons['bchart_line_off']['display_position'] = '';
  $this->arr_buttons['bchart_line_off']['fontawesomeicon']  = '';
  $this->arr_buttons['bchart_line_off']['style'] = 'disabled';
  $this->arr_buttons['bchart_line_off']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_line_off.gif';
  ...
  $this->arr_buttons['bchart_area_off']['display']          = '';
  $this->arr_buttons['bchart_area_off']['display_position'] = '';
  $this->arr_buttons['bchart_area_off']['fontawesomeicon']  = '';
  $this->arr_buttons['bchart_area_off']['style'] = 'disabled';
  $this->arr_buttons['bchart_area_off']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_area_off.gif';
  ...
  $this->arr_buttons['bchart_pizza_off']['display']          = '';
  $this->arr_buttons['bchart_pizza_off']['display_position'] = '';
  $this->arr_buttons['bchart_pizza_off']['fontawesomeicon']  = '';
  $this->arr_buttons['bchart_pizza_off']['style'] = 'disabled';
  $this->arr_buttons['bchart_pizza_off']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_pizza_off.gif';
  ...
  $this->arr_buttons['bchart_combo_off']['display']          = '';
  $this->arr_buttons['bchart_combo_off']['display_position'] = '';
  $this->arr_buttons['bchart_combo_off']['fontawesomeicon']  = '';
  $this->arr_buttons['bchart_combo_off']['style'] = 'disabled';
  $this->arr_buttons['bchart_combo_off']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_combo_off.gif';
  ...
  $this->arr_buttons['bchart_stack_off']['display']          = '';
  $this->arr_buttons['bchart_stack_off']['display_position'] = '';
  $this->arr_buttons['bchart_stack_off']['fontawesomeicon']  = '';
  $this->arr_buttons['bchart_stack_off']['style'] = 'disabled';
  $this->arr_buttons['bchart_stack_off']['image'] = 'sys__NM__nm_txt_bot_texto_bchart_stack_off.gif';
  ...
  $this->arr_buttons['bstepretorna']['image'] = 'sys__NM__nm_txt_bot_texto_bstepretorna.gif';
  ...
  $this->arr_buttons['bstepavanca']['image'] = 'sys__NM__nm_txt_bot_texto_bstepavanca.gif';
  ...
  $this->arr_buttons['bfilref_apply']['image'] = 'sys__NM__nm_txt_bot_texto_bfilref_apply.gif';
  ...
  $this->arr_buttons['bfilref_limpar']['image'] = 'sys__NM__nm_txt_bot_texto_bfilref_limpar.gif';
  ...
  $this->arr_buttons['bfilref_close']['image'] = 'sys__NM__nm_txt_bot_texto_bfilref_close.gif';
  ...
  $this->arr_buttons['bjson']['image'] = 'sys__NM__nm_txt_bot_texto_bjson.gif';
