<?php
@session_start() ;
$_SESSION['scriptcase']['grid_funcao']['sc_process_barr'] = true;
require_once('../grid_funcao/index.php');
unset($_SESSION['scriptcase']['grid_funcao']['sc_process_barr']);
$ExportCtrl = new grid_funcao_export_control;
$ExportCtrl->Export_barr();

class grid_funcao_export_control
{
