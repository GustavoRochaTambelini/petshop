...
class grid_caixa_diario_totalizador_total
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function __construct($sc_page)
   {
      ...
      if (isset($_SESSION['sc_session'][$this->sc_page]['grid_caixa_diario_totalizador']['campos_busca']) && !empty($_SESSION['sc_session'][$this->sc_page]['grid_caixa_diario_totalizador']['campos_busca']))
      { 
