...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_caixa_diario_totalizador"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_caixa_diario_totalizador"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario_totalizador']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_caixa_diario_totalizador']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario_totalizador']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_caixa_diario_totalizador']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario_totalizador']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_caixa_diario_totalizador</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario_totalizador']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario_totalizador']['embutida_filho'] as $ind => $sc_init)
          {
