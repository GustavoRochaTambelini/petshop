<?php
@session_start() ;
$_SESSION['scriptcase']['grid_caixa_diario_totalizador']['sc_process_barr'] = true;
require_once('../grid_caixa_diario_totalizador/index.php');
unset($_SESSION['scriptcase']['grid_caixa_diario_totalizador']['sc_process_barr']);
$ExportCtrl = new grid_caixa_diario_totalizador_export_control;
$ExportCtrl->Export_barr();

class grid_caixa_diario_totalizador_export_control
{
