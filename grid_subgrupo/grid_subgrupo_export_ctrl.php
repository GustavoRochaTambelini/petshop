<?php
@session_start() ;
$_SESSION['scriptcase']['grid_subgrupo']['sc_process_barr'] = true;
require_once('../grid_subgrupo/index.php');
unset($_SESSION['scriptcase']['grid_subgrupo']['sc_process_barr']);
$ExportCtrl = new grid_subgrupo_export_control;
$ExportCtrl->Export_barr();

class grid_subgrupo_export_control
{
