  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contas_pagar_criar_titulo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_contas_pagar_criar_titulo_mob_form();
	}
...
?>
  ...
  // ---------- Validate idcontas_pagar
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_idcontas_pagar()
  {
    var nomeCampo_idcontas_pagar = "idcontas_pagar";
    var var_idcontas_pagar = scAjaxGetFieldHidden(nomeCampo_idcontas_pagar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_idcontas_pagar(var_idcontas_pagar, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_idcontas_pagar_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_idcontas_pagar

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_idcontas_pagar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcontas_pagar";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_idcontas_pagar_cb

  // ---------- Validate idcliente
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_idcliente_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_idcliente

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_idcliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_idcliente_cb

  // ---------- Validate competencia
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_competencia()
  {
    ...
    setTimeout(function() {
      var var_competencia = scAjaxGetFieldText(nomeCampo_competencia);
      x_ajax_form_contas_pagar_criar_titulo_mob_validate_competencia(var_competencia, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_competencia_cb);
    }, 200);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_competencia

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_competencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_competencia_cb

  // ---------- Validate valor_a_pagar
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_valor_a_pagar()
  {
    var nomeCampo_valor_a_pagar = "valor_a_pagar";
    var var_valor_a_pagar = scAjaxGetFieldText(nomeCampo_valor_a_pagar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_valor_a_pagar(var_valor_a_pagar, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_valor_a_pagar_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_valor_a_pagar

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_valor_a_pagar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_valor_a_pagar_cb

  // ---------- Validate idforma_pagamento_prevista
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_idforma_pagamento_prevista()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_idforma_pagamento_prevista(var_idforma_pagamento_prevista, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_idforma_pagamento_prevista_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_idforma_pagamento_prevista

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_idforma_pagamento_prevista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_idforma_pagamento_prevista_cb

  // ---------- Validate idgrupo_contas
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_idgrupo_contas()
  {
    var nomeCampo_idgrupo_contas = "idgrupo_contas";
    var var_idgrupo_contas = scAjaxGetFieldSelect(nomeCampo_idgrupo_contas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_idgrupo_contas(var_idgrupo_contas, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_idgrupo_contas_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_idgrupo_contas

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_idgrupo_contas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_idgrupo_contas_cb

  // ---------- Validate idtipo_contas
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_idtipo_contas()
  {
    var nomeCampo_idtipo_contas = "idtipo_contas";
    var var_idtipo_contas = scAjaxGetFieldSelect(nomeCampo_idtipo_contas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_idtipo_contas(var_idtipo_contas, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_idtipo_contas_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_idtipo_contas

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_idtipo_contas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idtipo_contas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_idtipo_contas_cb

  // ---------- Validate nota_fiscal
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_nota_fiscal()
  {
    var nomeCampo_nota_fiscal = "nota_fiscal";
    var var_nota_fiscal = scAjaxGetFieldText(nomeCampo_nota_fiscal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_nota_fiscal(var_nota_fiscal, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_nota_fiscal_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_nota_fiscal

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_nota_fiscal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "nota_fiscal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_nota_fiscal_cb

  // ---------- Validate data_emissao
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_data_emissao()
  {
    var nomeCampo_data_emissao = "data_emissao";
    var var_data_emissao = scAjaxGetFieldText(nomeCampo_data_emissao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_data_emissao(var_data_emissao, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_data_emissao_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_data_emissao

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_data_emissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_data_emissao_cb

  // ---------- Validate data_vencimanto
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_data_vencimanto()
  {
    var nomeCampo_data_vencimanto = "data_vencimanto";
    var var_data_vencimanto = scAjaxGetFieldText(nomeCampo_data_vencimanto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_data_vencimanto(var_data_vencimanto, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_data_vencimanto_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_data_vencimanto

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_data_vencimanto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_vencimanto";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_data_vencimanto_cb

  // ---------- Validate sc_field_3
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_3()
  {
    var nomeCampo_sc_field_3 = "sc_field_3";
    var var_sc_field_3 = scAjaxGetFieldText(nomeCampo_sc_field_3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_3(var_sc_field_3, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_3_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_3

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_3_cb

  // ---------- Validate sc_field_2
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_2()
  {
    var nomeCampo_sc_field_2 = "sc_field_2";
    var var_sc_field_2 = scAjaxGetFieldText(nomeCampo_sc_field_2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_2(var_sc_field_2, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_2_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_2

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_2_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldCheckbox(nomeCampo_sc_field_0, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_0_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_0

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_0_cb

  // ---------- Validate sc_field_4
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_4()
  {
    var nomeCampo_sc_field_4 = "sc_field_4";
    var var_sc_field_4 = scAjaxGetFieldCheckbox(nomeCampo_sc_field_4, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_4(var_sc_field_4, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_4_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_4

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_4_cb

  // ---------- Validate sc_field_1
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldCheckbox(nomeCampo_sc_field_1, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_1_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_1

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_sc_field_1_cb

  // ---------- Validate pago
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_pago()
  {
    var nomeCampo_pago = "pago";
    var var_pago = scAjaxGetFieldSelect(nomeCampo_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_pago(var_pago, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_pago_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_pago

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_pago_cb

  // ---------- Validate observacao
  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_observacao()
  {
    var nomeCampo_observacao = "observacao";
    var var_observacao = scAjaxGetFieldText(nomeCampo_observacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_criar_titulo_mob_validate_observacao(var_observacao, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_validate_observacao_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_observacao

  function do_ajax_form_contas_pagar_criar_titulo_mob_validate_observacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_validate_observacao_cb

  // ---------- Refresh idgrupo_contas
  function do_ajax_form_contas_pagar_criar_titulo_mob_refresh_idgrupo_contas()
  {
    var var_idgrupo_contas = scAjaxGetFieldSelect("idgrupo_contas");
    var var_nmgp_refresh_fields = "idtipo_contas";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_contas_pagar_criar_titulo_mob_refresh_idgrupo_contas(var_idgrupo_contas, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_refresh_idgrupo_contas_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_refresh_idgrupo_contas

  function do_ajax_form_contas_pagar_criar_titulo_mob_refresh_idgrupo_contas_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_refresh_idgrupo_contas_cb

  // ---------- Event onchange pago
  function do_ajax_form_contas_pagar_criar_titulo_mob_event_pago_onchange()
  {
    var var_pago = scAjaxGetFieldSelect("pago");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_contas_pagar_criar_titulo_mob_event_pago_onchange(var_pago, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_event_pago_onchange_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_event_pago_onchange

  function do_ajax_form_contas_pagar_criar_titulo_mob_event_pago_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pago";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contas_pagar_criar_titulo_mob_event_pago_onchange_cb_after_alert);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_event_pago_onchange_cb
  function do_ajax_form_contas_pagar_criar_titulo_mob_event_pago_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_event_pago_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_salvar
  function do_ajax_form_contas_pagar_criar_titulo_mob_event_scajaxbutton_salvar_onclick()
  {
    ...
    var var_data_vencimanto = scAjaxGetFieldText("data_vencimanto");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_contas_pagar_criar_titulo_mob_event_scajaxbutton_salvar_onclick(var_idcliente, var_competencia, var_valor_a_pagar, var_idgrupo_contas, var_pago, var_sc_field_0, var_sc_field_3, var_data_vencimanto, var_idforma_pagamento_prevista, var_idtipo_contas, var_data_emissao, var_nota_fiscal, var_observacao, var_sc_field_4, var_sc_field_2, var_sc_field_1, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_event_scajaxbutton_salvar_onclick_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_event_scajaxbutton_salvar_onclick

  function do_ajax_form_contas_pagar_criar_titulo_mob_event_scajaxbutton_salvar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contas_pagar_criar_titulo_mob_event_scajaxbutton_salvar_onclick_cb_after_alert);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_event_scajaxbutton_salvar_onclick_cb
  function do_ajax_form_contas_pagar_criar_titulo_mob_event_scajaxbutton_salvar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_contas_pagar_criar_titulo_mob_event_scajaxbutton_salvar_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_contas_pagar_criar_titulo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_contas_pagar_criar_titulo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idcontas_pagar = scAjaxGetFieldHidden("idcontas_pagar");
    var var_idcliente = scAjaxGetFieldSelect("idcliente");
    var var_competencia = scAjaxGetFieldText("competencia");
    var var_valor_a_pagar = scAjaxGetFieldText("valor_a_pagar");
    var var_idforma_pagamento_prevista = scAjaxGetFieldSelect("idforma_pagamento_prevista");
    ...
    scAjaxProcOn();
    x_ajax_form_contas_pagar_criar_titulo_mob_submit_form(var_idcontas_pagar, var_idcliente, var_competencia, var_valor_a_pagar, var_idforma_pagamento_prevista, var_idgrupo_contas, var_idtipo_contas, var_nota_fiscal, var_data_emissao, var_data_vencimanto, var_sc_field_3, var_sc_field_2, var_sc_field_0, var_sc_field_4, var_sc_field_1, var_pago, var_observacao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contas_pagar_criar_titulo_mob_submit_form_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_submit_form

  function do_ajax_form_contas_pagar_criar_titulo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idcontas_pagar");
      ...
      scAjaxHideErrorDisplay("data_vencimanto");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_contas_pagar_criar_titulo_mob_submit_form_cb_after_alert);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_submit_form_cb
  function do_ajax_form_contas_pagar_criar_titulo_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contas_pagar_criar_titulo_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_contas_pagar_criar_titulo_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_contas_pagar_criar_titulo_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_contas_pagar_criar_titulo_mob_navigate_form();
    }
  }

  function perform_ajax_form_contas_pagar_criar_titulo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("pago");
    scAjaxHideErrorDisplay("observacao");
    var var_idcontas_pagar = document.F2.idcontas_pagar.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_contas_pagar_criar_titulo_mob_navigate_form(var_idcontas_pagar, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contas_pagar_criar_titulo_mob_navigate_form_cb);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contas_pagar_criar_titulo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contas_pagar_criar_titulo_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_contas_pagar_criar_titulo_mob_navigate_form_cb
  function do_ajax_form_contas_pagar_criar_titulo_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_contas_pagar_criar_titulo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_contas_pagar_criar_titulo_mob_navigate_form_cb_after_alert

  function sc_hide_form_contas_pagar_criar_titulo_mob_form()
  {
  ...
  ajax_field_list[0] = "idcontas_pagar";
  ...
  var ajax_error_list = {
    "idcontas_pagar": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "data_vencimanto": {"label": "DATA DE VENCIMENTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_3": {"label": "PARCELAS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_2": {"label": "INTERVALO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "observacao": {"label": "OBSERVAÇÕES", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["idcontas_pagar"][1] = "idcontas_pagar";
  ...
  ajax_field_mult["data_vencimanto"][1] = "data_vencimanto";
  ...
  var ajax_field_id = {
    "idcontas_pagar": new Array("hidden_field_label_idcontas_pagar", "hidden_field_data_idcontas_pagar"),
    ...
    "data_vencimanto": new Array("hidden_field_label_data_vencimanto", "hidden_field_data_data_vencimanto"),
