...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_contas_pagar_criar_titulo_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_contas_pagar_criar_titulo_mob_submit_form(var_idcontas_pagar, var_idcliente, var_competencia, var_valor_a_pagar, var_idforma_pagamento_prevista, var_idtipo_contas, var_nota_fiscal, var_data_emissao, var_data_vencimanto, var_sc_field_3, var_sc_field_2, var_sc_field_0, var_sc_field_4, var_sc_field_1, var_pago, var_observacao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contas_pagar_criar_titulo_mob_submit_form_cb);
