...
function scHidePage(pageNo) {
	$("#id_form_contas_pagar_criar_titulo_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_competencia" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_form_contas_pagar_criar_titulo_mob_validate_competencia(iSeqRow); }, 200);
    },
    numberOfMonths: 1,
    changeMonth: true,
    changeYear: true,
...
?>
  ...
  $("#id_sc_field_data_emissao" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contas_pagar_criar_titulo_mob_validate_data_emissao(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_data_vencimanto" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contas_pagar_criar_titulo_mob_validate_data_vencimanto(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_data_insercao" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contas_pagar_criar_titulo_mob_validate_data_insercao(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_data_alteracao" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_contas_pagar_criar_titulo_mob_validate_data_alteracao(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_contas_pagar_criar_titulo_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
