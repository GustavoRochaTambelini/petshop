...
<HEAD>
 <TITLE><?php if ('novo' == $this->nmgp_opcao) { echo strip_tags("NOVO REGISTRO DE CONTAS PAGAR"); } else { echo strip_tags("CONTAS PAGAR"); } ?></TITLE>
...
?>
<style type="text/css">
.css_read_off_competencia button {
...
.css_read_off_data_vencimanto button {
	background-color: transparent;
	border: 0;
	padding: 0
}
...
?>
 <style type="text/css">
  .scSpin_sc_field_3_obj {
   border: 0 !important;
   margin: 0 20px 0 0 !important;
  }
  .scSpin_sc_field_2_obj {
   border: 0 !important;
   margin: 0 20px 0 0 !important;
  }
 </style>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_contas_pagar_criar_titulo/form_contas_pagar_criar_titulo_mob_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_contas_pagar_criar_titulo_mob_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_contas_pagar_criar_titulo_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['link_info']['remove_border']) {
...
if (isset($_SESSION['scriptcase']['form_contas_pagar_criar_titulo']['error_buffer']) && '' != $_SESSION['scriptcase']['form_contas_pagar_criar_titulo']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_contas_pagar_criar_titulo']['error_buffer'];
}
...
<?php
 include_once("form_contas_pagar_criar_titulo_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_contas_pagar_criar_titulo_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_contas_pagar_criar_titulo_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_contas_pagar_criar_titulo_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['salvar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['salvar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['salvar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['salvar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['salvar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-8';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['idcontas_pagar'] = "ID";
    }
?>
<?php
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>
    ...
    <TD class="scFormDataOdd css_idcontas_pagar_line" id="hidden_field_data_idcontas_pagar" style="<?php echo $sStyleHidden_idcontas_pagar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idcontas_pagar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idcontas_pagar_label" style=""><span id="id_label_idcontas_pagar"><?php echo $this->nm_new_label['idcontas_pagar']; ?></span></span><br><span id="id_read_on_idcontas_pagar" class="css_idcontas_pagar_line" style="<?php echo $sStyleReadLab_idcontas_pagar; ?>"><?php echo $this->form_format_readonly("idcontas_pagar", $this->form_encode_input($this->idcontas_pagar)); ?></span><span id="id_read_off_idcontas_pagar" class="css_read_off_idcontas_pagar" style="<?php echo $sStyleReadInp_idcontas_pagar; ?>"><input type="hidden" name="idcontas_pagar" value="<?php echo $this->form_encode_input($idcontas_pagar) . "\">"?><span id="id_ajax_label_idcontas_pagar"><?php echo nl2br($idcontas_pagar); ?></span>
</span></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_idcontas_pagar_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_idcontas_pagar_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }
      else
      {
         $sc_hidden_no--;
...
<?php $sStyleHidden_valor_a_pagar_dumb = ('' == $sStyleHidden_valor_a_pagar) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_valor_a_pagar_dumb" style="<?php echo $sStyleHidden_valor_a_pagar_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
else
{
   ...
   while (!empty($todo[$x])) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          if (isset($this->Embutida_ronly) && $this->Embutida_ronly && isset($this->idtipo_contas_1))
          {
              foreach ($this->idtipo_contas_1 as $tmp_idtipo_contas)
              {
                  if (trim($tmp_idtipo_contas) === trim($cadaselect[1])) { $idtipo_contas_look .= $cadaselect[0] . '__SC_BREAK_LINE__'; }
              }
          }
          elseif (trim($this->idtipo_contas) === trim($cadaselect[1])) { $idtipo_contas_look .= $cadaselect[0]; } 
          $x++; 
   }

?>
<input type="hidden" name="idtipo_contas" value="<?php echo $this->form_encode_input($idtipo_contas) . "\">" . $idtipo_contas_look . ""; ?>
<?php } else { ?>
<?php
   $todo = $this->Form_lookup_idtipo_contas();
   $x = 0 ; 
   $idtipo_contas_look = ""; 
   while (!empty($todo[$x])) 
   {
          ...
          if (empty($idtipo_contas_look))
          {
              $idtipo_contas_look = $this->idtipo_contas;
          }
   $x = 0; 
   echo "<span id=\"id_read_on_idtipo_contas\" class=\"css_idtipo_contas_line\" style=\"" .  $sStyleReadLab_idtipo_contas . "\">" . $this->form_format_readonly("idtipo_contas", $this->form_encode_input($idtipo_contas_look)) . "</span><span id=\"id_read_off_idtipo_contas\" class=\"css_read_off_idtipo_contas" . $this->classes_100perc_fields['span_input'] . "\" style=\"white-space: nowrap; " . $sStyleReadInp_idtipo_contas . "\">";
   echo " <span id=\"idAjaxSelect_idtipo_contas\" class=\"" . $this->classes_100perc_fields['span_select'] . "\"><select class=\"sc-js-input scFormObjectOdd css_idtipo_contas_obj" . $this->classes_100perc_fields['input'] . "\" style=\"\" id=\"id_sc_field_idtipo_contas\" name=\"idtipo_contas\" size=\"1\" alt=\"{type: 'select', enterTab: false}\">" ; 
   echo "\r" ; 
   while (!empty($todo[$x]) && !$nm_nao_carga) 
   {
          $cadaselect = explode("?#?", $todo[$x]) ; 
          if ($cadaselect[1] == "@ ") {$cadaselect[1]= trim($cadaselect[1]); } ; 
          echo "  <option value=\"$cadaselect[1]\"" ; 
          if (trim($this->idtipo_contas) === trim($cadaselect[1])) 
          {
              echo " selected" ; 
          }
          if (strtoupper($cadaselect[2]) == "S") 
          {
              if (empty($this->idtipo_contas)) 
              {
                  echo " selected" ;
              } 
           } 
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['nota_fiscal'] = "NOTA FISCAL VINCULADA";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_nota_fiscal_line" id="hidden_field_data_nota_fiscal" style="<?php echo $sStyleHidden_nota_fiscal; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_nota_fiscal_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_nota_fiscal_label" style=""><span id="id_label_nota_fiscal"><?php echo $this->nm_new_label['nota_fiscal']; ?></span></span><br>
...
<?php $sStyleHidden_nota_fiscal_dumb = ('' == $sStyleHidden_nota_fiscal) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_nota_fiscal_dumb" style="<?php echo $sStyleHidden_nota_fiscal_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['data_vencimanto'] = "DATA DE VENCIMENTO";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_data_vencimanto_line" id="hidden_field_data_data_vencimanto" style="<?php echo $sStyleHidden_data_vencimanto; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_data_vencimanto_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_data_vencimanto_label" style=""><span id="id_label_data_vencimanto"><?php echo $this->nm_new_label['data_vencimanto']; ?></span></span><br>
...
<?php $sStyleHidden_data_vencimanto_dumb = ('' == $sStyleHidden_data_vencimanto) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_data_vencimanto_dumb" style="<?php echo $sStyleHidden_data_vencimanto_dumb; ?>"></TD>
   </tr>
<?php $sc_hidden_no = 1; ?>
</TABLE></div><!-- bloco_f -->
   </td>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['sc_field_3'] = "PARCELAS";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { ?>
<span id="id_read_on_sc_field_3" class="sc-ui-readonly-sc_field_3 css_sc_field_3_line" style="<?php echo $sStyleReadLab_sc_field_3; ?>"><?php echo $this->form_format_readonly("sc_field_3", $this->form_encode_input($this->sc_field_3)); ?></span><span id="id_read_off_sc_field_3" class="css_read_off_sc_field_3<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_sc_field_3; ?>">
 <input class="sc-js-input scFormObjectOdd scFormObjectOddSpin scSpin_sc_field_3_obj css_sc_field_3_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_sc_field_3" type=text name="sc_field_3" value="<?php echo $this->form_encode_input($sc_field_3) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['sc_field_3']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['sc_field_3']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['sc_field_3']['format_neg'] ? "'suffix'" : "'prefix'") ?>, enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ ', alignment: 'left'}" ></span><?php } ?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['sc_field_2'] = "INTERVALO";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<span id="id_read_on_sc_field_2" class="sc-ui-readonly-sc_field_2 css_sc_field_2_line" style="<?php echo $sStyleReadLab_sc_field_2; ?>"><?php echo $this->form_format_readonly("sc_field_2", $this->form_encode_input($this->sc_field_2)); ?></span><span id="id_read_off_sc_field_2" class="css_read_off_sc_field_2<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_sc_field_2; ?>">
 <input class="sc-js-input scFormObjectOdd scFormObjectOddSpin scSpin_sc_field_2_obj css_sc_field_2_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_sc_field_2" type=text name="sc_field_2" value="<?php echo $this->form_encode_input($sc_field_2) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=10"; } ?> alt="{datatype: 'integer', maxLength: 20, thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['sc_field_2']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['sc_field_2']['symbol_fmt']; ?>, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['sc_field_2']['format_neg'] ? "'suffix'" : "'prefix'") ?>, enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ ', alignment: 'left'}" ></span><?php } ?>
...
<?php 
  ...
  {
      $this->sc_field_0_1 = explode(";", trim($this->sc_field_0));
  } 
  else
  {
      if (empty($this->sc_field_0))
      ...
      else
      {
          ...
          $this->sc_field_0= ""; 
          foreach ($this->sc_field_0_1 as $cada_sc_field_0)
          {
             if (!empty($sc_field_0))
             {
                 $this->sc_field_0.= ";"; 
             } 
             $this->sc_field_0.= $cada_sc_field_0; 
          } 
      } 
  } 
?> 
...
$sc_field_0_look = "";
 if ($this->sc_field_0 == "T") { $sc_field_0_look .= "DIVIDIR O VALOR NAS PARCELAS" ;} 
...
$sc_field_0_look = "";
 ...
 if (empty($sc_field_0_look)) { $sc_field_0_look = $this->sc_field_0; }
?>
<span id="id_read_on_sc_field_0" class="css_sc_field_0_line" style="<?php echo $sStyleReadLab_sc_field_0; ?>"><?php echo $this->form_format_readonly("sc_field_0", $this->form_encode_input($sc_field_0_look)); ?></span><span id="id_read_off_sc_field_0" class="css_read_off_sc_field_0 css_sc_field_0_line" style="<?php echo $sStyleReadInp_sc_field_0; ?>"><?php echo "<div id=\"idAjaxCheckbox_sc_field_0\" style=\"display: inline-block\" class=\"css_sc_field_0_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_sc_field_0_line"><?php $tempOptionId = "id-opt-sc_field_0" . $sc_seq_vert . "-1"; ?>
 <input type=checkbox id="<?php echo $tempOptionId ?>" class="sc-ui-checkbox-sc_field_0 sc-ui-checkbox-sc_field_0" name="sc_field_0[]" value="T"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['Lookup_sc_field_0'][] = 'T'; ?>
<?php  if (in_array("T", $this->sc_field_0_1))  { echo " checked" ;} ?> onClick="" ><label for="<?php echo $tempOptionId ?>">DIVIDIR O VALOR NAS PARCELAS</label></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
$sc_field_4_look = "";
 if ($this->sc_field_4 == "T") { $sc_field_4_look .= "VENCIMENTO FIXO " ;} 
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['Lookup_sc_field_4'][] = 'T'; ?>
<?php  if (in_array("T", $this->sc_field_4_1))  { echo " checked" ;} ?> onClick="" ><label for="<?php echo $tempOptionId ?>">VENCIMENTO FIXO </label></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
<?php 
  if ($this->nmgp_opcao != "recarga") 
  {
      $this->sc_field_1_1 = explode(";", trim($this->sc_field_1));
  } 
  else
  {
      if (empty($this->sc_field_1))
      ...
      else
      {
          ...
          $this->sc_field_1= ""; 
          foreach ($this->sc_field_1_1 as $cada_sc_field_1)
          {
             if (!empty($sc_field_1))
             {
                 $this->sc_field_1.= ";"; 
             } 
             $this->sc_field_1.= $cada_sc_field_1; 
          } 
      } 
  } 
?> 
...
$sc_field_1_look = "";
 if ($this->sc_field_1 == "T") { $sc_field_1_look .= "ALTERAR COMPETENCIA" ;} 
 if (empty($sc_field_1_look)) { $sc_field_1_look = $this->sc_field_1; }
?>
...
$sc_field_1_look = "";
 ...
 if (empty($sc_field_1_look)) { $sc_field_1_look = $this->sc_field_1; }
?>
<span id="id_read_on_sc_field_1" class="css_sc_field_1_line" style="<?php echo $sStyleReadLab_sc_field_1; ?>"><?php echo $this->form_format_readonly("sc_field_1", $this->form_encode_input($sc_field_1_look)); ?></span><span id="id_read_off_sc_field_1" class="css_read_off_sc_field_1 css_sc_field_1_line" style="<?php echo $sStyleReadInp_sc_field_1; ?>"><?php echo "<div id=\"idAjaxCheckbox_sc_field_1\" style=\"display: inline-block\" class=\"css_sc_field_1_line\">\r\n"; ?><TABLE cellspacing=0 cellpadding=0 border=0><TR>
  <TD class="scFormDataFontOdd css_sc_field_1_line"><?php $tempOptionId = "id-opt-sc_field_1" . $sc_seq_vert . "-1"; ?>
 <input type=checkbox id="<?php echo $tempOptionId ?>" class="sc-ui-checkbox-sc_field_1 sc-ui-checkbox-sc_field_1" name="sc_field_1[]" value="T"
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['Lookup_sc_field_1'][] = 'T'; ?>
<?php  if (in_array("T", $this->sc_field_1_1))  { echo " checked" ;} ?> onClick="" ><label for="<?php echo $tempOptionId ?>">ALTERAR COMPETENCIA</label></TD>
</TR></TABLE>
<?php echo "</div>\r\n"; ?></span><?php  }?>
...
$pago_look = "";
 if ($this->pago == "F") { $pago_look .= "A PAGAR" ;} 
...
<span id="id_read_on_pago" class="css_pago_line"  style="<?php echo $sStyleReadLab_pago; ?>"><?php echo $this->form_format_readonly("pago", $this->form_encode_input($pago_look)); ?></span><span id="id_read_off_pago" class="css_read_off_pago<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap; <?php echo $sStyleReadInp_pago; ?>">
 ...
 <option  value="F" <?php  if ($this->pago == "F") { echo " selected" ;} ?>>A PAGAR</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['Lookup_pago'][] = 'F'; ?>
 <option  value="T" <?php  if ($this->pago == "T") { echo " selected" ;} ?>>PAGO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['Lookup_pago'][] = 'T'; ?>
 </select></span>
</span><?php  }?>
...
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
   ...
   <?php
    ...
    {
        $this->nm_new_label['observacao'] = "OBSERVAÇÕES";
    }
?>
<?php
   $nm_cor_fun_cel  = (isset($nm_cor_fun_cel) && $nm_cor_fun_cel  == $this->Ini->cor_grid_impar ? $this->Ini->cor_grid_par : $this->Ini->cor_grid_impar);
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_observacao_line" id="hidden_field_data_observacao" style="<?php echo $sStyleHidden_observacao; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_observacao_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_observacao_label" style=""><span id="id_label_observacao"><?php echo $this->nm_new_label['observacao']; ?></span></span><br>
<?php
...
<span id="id_read_on_observacao" class="sc-ui-readonly-observacao css_observacao_line" style="<?php echo $sStyleReadLab_observacao; ?>"><?php echo $this->form_format_readonly("observacao", $this->form_encode_input($observacao_val)); ?></span><span id="id_read_off_observacao" class="css_read_off_observacao<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_observacao; ?>">
 <textarea class="sc-js-input scFormObjectOdd css_observacao_obj<?php echo $this->classes_100perc_fields['input'] ?>" style="white-space: pre-wrap;" name="observacao" id="id_sc_field_observacao" rows="2" cols="50"
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['first']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['first']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['first']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['first']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['first'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['back']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['back']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['back']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['back']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['back'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['forward']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['forward']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['forward']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['forward']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['forward'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['last']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_disabled']['last']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['last']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['last']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['btn_label']['last'];
        }
?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_contas_pagar_criar_titulo_mob");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_contas_pagar_criar_titulo_mob");
 parent.scAjaxDetailHeight("form_contas_pagar_criar_titulo_mob", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo_mob']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
