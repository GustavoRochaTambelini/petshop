...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_contas_pagar_criar_titulo/form_contas_pagar_criar_titulo_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_contas_pagar_criar_titulo_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_contas_pagar_criar_titulo_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['link_info']['remove_border']) {
...
<?php
 include_once("form_contas_pagar_criar_titulo_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_contas_pagar_criar_titulo'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_contas_pagar_criar_titulo'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['salvar']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['salvar']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['salvar']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['salvar']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['salvar'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-3';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_idcontas_pagar_line" id="hidden_field_data_idcontas_pagar" style="<?php echo $sStyleHidden_idcontas_pagar; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_idcontas_pagar_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_idcontas_pagar_label" style=""><span id="id_label_idcontas_pagar"><?php echo $this->nm_new_label['idcontas_pagar']; ?></span></span><br>
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { 
 ?>
<span id="id_read_on_idcontas_pagar" css_idcontas_pagar_line" style="<?php echo $sStyleReadLab_idcontas_pagar; ?>"><?php echo $this->form_format_readonly("idcontas_pagar", $this->form_encode_input($this->idcontas_pagar)); ?></span><span id="id_read_off_idcontas_pagar" class="css_read_off_idcontas_pagar" style="<?php echo $sStyleReadInp_idcontas_pagar; ?>"><input type="hidden" name="idcontas_pagar" value="<?php echo $this->form_encode_input($idcontas_pagar) . "\">"?><span id="id_ajax_label_idcontas_pagar"><?php echo nl2br($idcontas_pagar); ?></span>
</span><?php } else { ?>
&nbsp;
<?php } ?>
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_idcontas_pagar_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_idcontas_pagar_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } 
?> 
<?php $sStyleHidden_idcontas_pagar_dumb = ('' == $sStyleHidden_idcontas_pagar) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_idcontas_pagar_dumb" style="<?php echo $sStyleHidden_idcontas_pagar_dumb; ?>"></TD>
...
<?php $sStyleHidden_competencia_dumb = ('' == $sStyleHidden_competencia) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_competencia_dumb" style="<?php echo $sStyleHidden_competencia_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $sStyleHidden_idgrupo_contas_dumb = ('' == $sStyleHidden_idgrupo_contas) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_idgrupo_contas_dumb" style="<?php echo $sStyleHidden_idgrupo_contas_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr>"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php $sStyleHidden_idtipo_contas_dumb = ('' == $sStyleHidden_idtipo_contas) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_idtipo_contas_dumb" style="<?php echo $sStyleHidden_idtipo_contas_dumb; ?>"></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['Lookup_sc_field_0'][] = 'T'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['Lookup_sc_field_4'][] = 'T'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['Lookup_sc_field_1'][] = 'T'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['Lookup_pago'][] = 'F'; ?>
 <option  value="T" <?php  if ($this->pago == "T") { echo " selected" ;} ?>>PAGO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['Lookup_pago'][] = 'T'; ?>
 </select></span>
</span><?php  }?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_contas_pagar_criar_titulo");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_contas_pagar_criar_titulo");
 parent.scAjaxDetailHeight("form_contas_pagar_criar_titulo", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar_criar_titulo']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
