...
function Sel_cmp_process()
{
   ...
   function Sel_cmp_init_fields()
   {
      ...
      $tab_blk_campos[] = "produto_idproduto";
      $tab_ger_campos['produto_referencia'] = "on";
      $tab_blk_campos[] = "produto_referencia";
      $tab_ger_campos['produto_descricao'] = "on";
      $tab_blk_campos[] = "produto_descricao";
      $tab_ger_campos['produto_codigo_de_barras'] = "on";
      $tab_blk_campos[] = "produto_codigo_de_barras";
      $tab_ger_campos['produto_custo'] = "on";
      $tab_blk_campos[] = "produto_custo";
      $tab_ger_campos['produto_valor'] = "on";
      $tab_blk_campos[] = "produto_valor";
      $tab_ger_campos['estoque_valor'] = "on";
      $tab_blk_campos[] = "estoque_valor";
      $tab_ger_campos['produto_tipo'] = "on";
      $tab_blk_campos[] = "produto_tipo";
