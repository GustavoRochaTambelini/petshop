<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_produto']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['produto_idproduto'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['produto_idproduto'] = "produto_idproduto";
   }
   else
   {
       $tab_def_campos['produto_idproduto'] = "produto.idproduto";
   }
   $tab_labels["produto_idproduto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto_idproduto"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto_idproduto"] : "ID";
   $tab_ger_campos['produto_referencia'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['produto_referencia'] = "produto_referencia";
   }
   else
   {
       $tab_def_campos['produto_referencia'] = "produto.referencia";
   }
   $tab_labels["produto_referencia"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto_referencia"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto_referencia"] : "REFERENCIA";
   $tab_ger_campos['produto_descricao'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['produto_descricao'] = "produto_descricao";
   }
   else
   {
       $tab_def_campos['produto_descricao'] = "produto.descricao";
   }
   $tab_labels["produto_descricao"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto_descricao"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto_descricao"] : "DESCRIÇÃO";
   $tab_ger_campos['produto_codigo_de_barras'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['produto_codigo_de_barras'] = "produto_codigo_de_barras";
   }
   else
   {
       $tab_def_campos['produto_codigo_de_barras'] = "produto.codigo_de_barras";
   }
   $tab_labels["produto_codigo_de_barras"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto_codigo_de_barras"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto_codigo_de_barras"] : "CODIGO DE BARRAS";
   $tab_ger_campos['produto_custo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['produto_custo'] = "produto_custo";
   }
   else
   {
       $tab_def_campos['produto_custo'] = "produto.custo";
   }
   $tab_labels["produto_custo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto_custo"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto_custo"] : "CUSTO";
   $tab_ger_campos['produto_valor'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['produto_valor'] = "produto_valor";
   }
   else
   {
       $tab_def_campos['produto_valor'] = "produto.valor";
   }
   $tab_labels["produto_valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto_valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto_valor"] : "VALOR DE VENDA";
   $tab_ger_campos['estoque_valor'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['estoque_valor'] = "estoque_valor";
   }
   else
   {
       $tab_def_campos['estoque_valor'] = "estoque.valor";
   }
   $tab_labels["estoque_valor"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["estoque_valor"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["estoque_valor"] : "ESTOQUE ATUAL";
   $tab_ger_campos['produto_tipo'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['produto_tipo'] = "produto_tipo";
   }
   else
   {
       $tab_def_campos['produto_tipo'] = "produto.tipo";
   }
   $tab_labels["produto_tipo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto_tipo"])) ? $_SESSION['sc_session'][$sc_init]['grid_produto']['labels']["produto_tipo"] : "TIPO PRODUTO";
