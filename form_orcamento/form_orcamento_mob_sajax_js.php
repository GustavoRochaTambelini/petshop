  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_orcamento_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_orcamento_mob_form();
	}
...
?>
  ...
  // ---------- Validate idorcamento
  function do_ajax_form_orcamento_mob_validate_idorcamento()
  {
    var nomeCampo_idorcamento = "idorcamento";
    var var_idorcamento = scAjaxGetFieldHidden(nomeCampo_idorcamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_mob_validate_idorcamento(var_idorcamento, var_script_case_init, do_ajax_form_orcamento_mob_validate_idorcamento_cb);
  } // do_ajax_form_orcamento_mob_validate_idorcamento

  function do_ajax_form_orcamento_mob_validate_idorcamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idorcamento";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_mob_validate_idorcamento_cb

  // ---------- Validate idcliente
  function do_ajax_form_orcamento_mob_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_mob_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_orcamento_mob_validate_idcliente_cb);
  } // do_ajax_form_orcamento_mob_validate_idcliente

  function do_ajax_form_orcamento_mob_validate_idcliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_mob_validate_idcliente_cb

  // ---------- Validate produto
  function do_ajax_form_orcamento_mob_validate_produto()
  {
  } // do_ajax_form_orcamento_mob_validate_produto

  function do_ajax_form_orcamento_mob_validate_produto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "produto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_mob_validate_produto_cb

  // ---------- Validate grid_itens
  function do_ajax_form_orcamento_mob_validate_grid_itens()
  {
    var nomeCampo_grid_itens = "grid_itens";
    var var_grid_itens = scAjaxGetFieldText(nomeCampo_grid_itens);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_mob_validate_grid_itens(var_grid_itens, var_script_case_init, do_ajax_form_orcamento_mob_validate_grid_itens_cb);
  } // do_ajax_form_orcamento_mob_validate_grid_itens

  function do_ajax_form_orcamento_mob_validate_grid_itens_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "grid_itens";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_mob_validate_grid_itens_cb

  // ---------- Validate valor_total
  function do_ajax_form_orcamento_mob_validate_valor_total()
  {
    var nomeCampo_valor_total = "valor_total";
    var var_valor_total = scAjaxGetFieldHidden(nomeCampo_valor_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_mob_validate_valor_total(var_valor_total, var_script_case_init, do_ajax_form_orcamento_mob_validate_valor_total_cb);
  } // do_ajax_form_orcamento_mob_validate_valor_total

  function do_ajax_form_orcamento_mob_validate_valor_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_mob_validate_valor_total_cb

  // ---------- Validate observacao
  function do_ajax_form_orcamento_mob_validate_observacao()
  {
    var nomeCampo_observacao = "observacao";
    var var_observacao = scAjaxGetFieldText(nomeCampo_observacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_mob_validate_observacao(var_observacao, var_script_case_init, do_ajax_form_orcamento_mob_validate_observacao_cb);
  } // do_ajax_form_orcamento_mob_validate_observacao

  function do_ajax_form_orcamento_mob_validate_observacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_mob_validate_observacao_cb

  // ---------- Event onblur produto
  function do_ajax_form_orcamento_mob_event_produto_onblur()
  {
    var var_produto = scAjaxGetFieldText("produto");
    var var_idorcamento = scAjaxGetFieldHidden("idorcamento");
    var var_valor_total = scAjaxGetFieldHidden("valor_total");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_orcamento_mob_event_produto_onblur(var_produto, var_idorcamento, var_valor_total, var_script_case_init, do_ajax_form_orcamento_mob_event_produto_onblur_cb);
  } // do_ajax_form_orcamento_mob_event_produto_onblur

  function do_ajax_form_orcamento_mob_event_produto_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "produto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_orcamento_mob_event_produto_onblur_cb_after_alert);
  } // do_ajax_form_orcamento_mob_event_produto_onblur_cb
  function do_ajax_form_orcamento_mob_event_produto_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_orcamento_mob_event_produto_onblur_cb_after_alert

  // ---------- Event onclick scajaxbutton_cancelar_venda
  function do_ajax_form_orcamento_mob_event_scajaxbutton_cancelar_venda_onclick()
  {
    var var_idorcamento = scAjaxGetFieldHidden("idorcamento");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_orcamento_mob_event_scajaxbutton_cancelar_venda_onclick(var_idorcamento, var_script_case_init, do_ajax_form_orcamento_mob_event_scajaxbutton_cancelar_venda_onclick_cb);
  } // do_ajax_form_orcamento_mob_event_scajaxbutton_cancelar_venda_onclick

  function do_ajax_form_orcamento_mob_event_scajaxbutton_cancelar_venda_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "scajaxbutton_cancelar_venda";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_orcamento_mob_event_scajaxbutton_cancelar_venda_onclick_cb_after_alert);
  } // do_ajax_form_orcamento_mob_event_scajaxbutton_cancelar_venda_onclick_cb
  function do_ajax_form_orcamento_mob_event_scajaxbutton_cancelar_venda_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_orcamento_mob_event_scajaxbutton_cancelar_venda_onclick_cb_after_alert

  // ---------- Event onclick scajaxbutton_concluir_venda
  function do_ajax_form_orcamento_mob_event_scajaxbutton_concluir_venda_onclick()
  {
    var var_idorcamento = scAjaxGetFieldHidden("idorcamento");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_orcamento_mob_event_scajaxbutton_concluir_venda_onclick(var_idorcamento, var_observacao, var_valor_total, var_idcliente, var_script_case_init, do_ajax_form_orcamento_mob_event_scajaxbutton_concluir_venda_onclick_cb);
  } // do_ajax_form_orcamento_mob_event_scajaxbutton_concluir_venda_onclick

  function do_ajax_form_orcamento_mob_event_scajaxbutton_concluir_venda_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "scajaxbutton_concluir_venda";
    scAjaxUpdateFieldErrors(sFieldValid, "onclick");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_orcamento_mob_event_scajaxbutton_concluir_venda_onclick_cb_after_alert);
  } // do_ajax_form_orcamento_mob_event_scajaxbutton_concluir_venda_onclick_cb
  function do_ajax_form_orcamento_mob_event_scajaxbutton_concluir_venda_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_orcamento_mob_event_scajaxbutton_concluir_venda_onclick_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_orcamento_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_orcamento_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idorcamento = scAjaxGetFieldHidden("idorcamento");
    ...
    scAjaxProcOn();
    x_ajax_form_orcamento_mob_submit_form(var_idorcamento, var_idcliente, var_produto, var_valor_total, var_observacao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_orcamento_mob_submit_form_cb);
  } // do_ajax_form_orcamento_mob_submit_form

  function do_ajax_form_orcamento_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idorcamento");
      scAjaxHideErrorDisplay("idcliente");
      scAjaxHideErrorDisplay("produto");
      scAjaxHideErrorDisplay("grid_itens");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_orcamento_mob_submit_form_cb_after_alert);
  } // do_ajax_form_orcamento_mob_submit_form_cb
  function do_ajax_form_orcamento_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_orcamento_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_itens_orcamento_mob"] = "off";

  function do_ajax_form_orcamento_mob_navigate_form()
  {
    perform_ajax_form_orcamento_mob_navigate_form();
  }

  function perform_ajax_form_orcamento_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_itens_orcamento_mob"] = "on";
    x_ajax_form_orcamento_mob_navigate_form(var_idorcamento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_orcamento_mob_navigate_form_cb);
  } // do_ajax_form_orcamento_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_orcamento_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_itens_orcamento_mob"] && "nmsc_iframe_liga_form_itens_orcamento_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_itens_orcamento_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_itens_orcamento_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_itens_orcamento_mob').contentWindow.nm_move('apl_detalhe', true, '320');
        document.getElementById('nmsc_iframe_liga_form_itens_orcamento_mob').style.height = "320";
        document.getElementById('nmsc_iframe_liga_form_itens_orcamento_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_orcamento_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_orcamento_mob_navigate_form_cb
  function do_ajax_form_orcamento_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_orcamento_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_orcamento_mob_navigate_form_cb_after_alert

  function sc_hide_form_orcamento_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_itens_orcamento_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "idorcamento";
  ajax_field_list[1] = "idcliente";
  ajax_field_list[2] = "produto";
  ajax_field_list[3] = "grid_itens";
  ajax_field_list[4] = "valor_total";
  ajax_field_list[5] = "observacao";
  ...
  var ajax_error_list = {
    "idorcamento": {"label": "ORCAMENTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "produto": {"label": "PRODUTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "grid_itens": {"label": "grid_itens", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "valor_total": {"label": "VALOR TOTAL R$", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "idorcamento": new Array(),
    "idcliente": new Array(),
    "produto": new Array(),
    "grid_itens": new Array(),
    "valor_total": new Array(),
    "observacao": new Array()
  };
  ajax_field_mult["idorcamento"][1] = "idorcamento";
  ajax_field_mult["idcliente"][1] = "idcliente";
  ajax_field_mult["produto"][1] = "produto";
  ajax_field_mult["grid_itens"][1] = "grid_itens";
  ajax_field_mult["valor_total"][1] = "valor_total";
  ajax_field_mult["observacao"][1] = "observacao";

  var ajax_field_id = {
    "idorcamento": new Array("hidden_field_label_idorcamento", "hidden_field_data_idorcamento"),
    ...
    "grid_itens": new Array("hidden_field_label_grid_itens", "hidden_field_data_grid_itens"),
