...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_orcamento/form_orcamento_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_orcamento_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_orcamento_jquery.php');
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-produto", elem).on("focus", function() {
   ...
   if ("" == $(this).val()) {
    ...
    if (hasChanged) {
     if ('function' == typeof do_ajax_form_orcamento_event_produto_onchange) { do_ajax_form_orcamento_event_produto_onchange(sRow); }
    }
   }
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['link_info']['remove_border']) {
...
<?php
 include_once("form_orcamento_js0.php");
?>
<script type="text/javascript"> 
nmdg_enter_tab = true;
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_orcamento'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_orcamento'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_disabled']['cancelar_venda']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_disabled']['cancelar_venda']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_label']['cancelar_venda']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_label']['cancelar_venda']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_label']['cancelar_venda'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_disabled']['concluir_venda']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_disabled']['concluir_venda']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_label']['concluir_venda']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_label']['concluir_venda']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_label']['concluir_venda'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['btn_label']['exit'];
        }
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_grid_itens'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_grid_itens'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_grid_itens'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] ]['form_itens_orcamento']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] ]['form_itens_orcamento']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] ]['form_itens_orcamento']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] ]['form_itens_orcamento']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] ]['form_itens_orcamento']['embutida_liga_form_insert'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] ]['form_itens_orcamento']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] ]['form_itens_orcamento']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] ]['form_itens_orcamento']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] ]['form_itens_orcamento']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] ]['form_itens_orcamento']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] ]['form_itens_orcamento']['embutida_liga_qtd_reg'] = '11';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] ]['form_itens_orcamento']['embutida_liga_tp_pag'] = 'parcial';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] ]['form_itens_orcamento']['embutida_parms'] = "NM_btn_insert*scinN*scoutNM_btn_update*scinS*scoutNM_btn_delete*scinS*scoutNM_btn_navega*scinN*scout";
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init'] ]['form_orcamento']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_orcamento_empty.htm' : $this->Ini->link_form_itens_orcamento_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=320';
if (isset($this->Ini->sc_lig_target['C_@scinf_grid_itens']) && 'nmsc_iframe_liga_form_itens_orcamento' != $this->Ini->sc_lig_target['C_@scinf_grid_itens'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_grid_itens'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['form_itens_orcamento_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_itens_orcamento"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="320" width="770" name="nmsc_iframe_liga_form_itens_orcamento"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
?>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_orcamento");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_orcamento");
 parent.scAjaxDetailHeight("form_orcamento", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
