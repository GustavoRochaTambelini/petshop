  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_orcamento" == sTestField)
        {
...
?>
  ...
  function do_ajax_form_orcamento_validate_idorcamento()
  {
    var nomeCampo_idorcamento = "idorcamento";
    var var_idorcamento = scAjaxGetFieldHidden(nomeCampo_idorcamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_validate_idorcamento(var_idorcamento, var_script_case_init, do_ajax_form_orcamento_validate_idorcamento_cb);
  } // do_ajax_form_orcamento_validate_idorcamento

  function do_ajax_form_orcamento_validate_idorcamento_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_validate_idorcamento_cb

  // ---------- Validate idcliente
  function do_ajax_form_orcamento_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_orcamento_validate_idcliente_cb);
  } // do_ajax_form_orcamento_validate_idcliente

  function do_ajax_form_orcamento_validate_idcliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_validate_idcliente_cb

  // ---------- Validate produto
  function do_ajax_form_orcamento_validate_produto()
  {
  } // do_ajax_form_orcamento_validate_produto

  function do_ajax_form_orcamento_validate_produto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "produto";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_validate_produto_cb

  // ---------- Validate grid_itens
  function do_ajax_form_orcamento_validate_grid_itens()
  {
    var nomeCampo_grid_itens = "grid_itens";
    var var_grid_itens = scAjaxGetFieldText(nomeCampo_grid_itens);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_validate_grid_itens(var_grid_itens, var_script_case_init, do_ajax_form_orcamento_validate_grid_itens_cb);
  } // do_ajax_form_orcamento_validate_grid_itens

  function do_ajax_form_orcamento_validate_grid_itens_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_validate_grid_itens_cb

  // ---------- Validate valor_total
  function do_ajax_form_orcamento_validate_valor_total()
  {
    var nomeCampo_valor_total = "valor_total";
    var var_valor_total = scAjaxGetFieldHidden(nomeCampo_valor_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_validate_valor_total(var_valor_total, var_script_case_init, do_ajax_form_orcamento_validate_valor_total_cb);
  } // do_ajax_form_orcamento_validate_valor_total

  function do_ajax_form_orcamento_validate_valor_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_validate_valor_total_cb

  // ---------- Validate observacao
  function do_ajax_form_orcamento_validate_observacao()
  {
    var nomeCampo_observacao = "observacao";
    var var_observacao = scAjaxGetFieldText(nomeCampo_observacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_orcamento_validate_observacao(var_observacao, var_script_case_init, do_ajax_form_orcamento_validate_observacao_cb);
  } // do_ajax_form_orcamento_validate_observacao

  function do_ajax_form_orcamento_validate_observacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_orcamento_validate_observacao_cb

  // ---------- Event onblur produto
  function do_ajax_form_orcamento_event_produto_onblur()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_orcamento_event_produto_onblur(var_produto, var_idorcamento, var_valor_total, var_script_case_init, do_ajax_form_orcamento_event_produto_onblur_cb);
  } // do_ajax_form_orcamento_event_produto_onblur

  function do_ajax_form_orcamento_event_produto_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "produto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_orcamento_event_produto_onblur_cb_after_alert);
  } // do_ajax_form_orcamento_event_produto_onblur_cb
  function do_ajax_form_orcamento_event_produto_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_orcamento_event_produto_onblur_cb_after_alert

  // ---------- Event onclick scajaxbutton_cancelar_venda
  function do_ajax_form_orcamento_event_scajaxbutton_cancelar_venda_onclick()
  {
    var var_idorcamento = scAjaxGetFieldHidden("idorcamento");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_orcamento_event_scajaxbutton_cancelar_venda_onclick(var_idorcamento, var_script_case_init, do_ajax_form_orcamento_event_scajaxbutton_cancelar_venda_onclick_cb);
  } // do_ajax_form_orcamento_event_scajaxbutton_cancelar_venda_onclick

  function do_ajax_form_orcamento_event_scajaxbutton_cancelar_venda_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_orcamento_event_scajaxbutton_cancelar_venda_onclick_cb_after_alert);
  } // do_ajax_form_orcamento_event_scajaxbutton_cancelar_venda_onclick_cb
  function do_ajax_form_orcamento_event_scajaxbutton_cancelar_venda_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_orcamento_event_scajaxbutton_cancelar_venda_onclick_cb_after_alert

  // ---------- Event onclick scajaxbutton_concluir_venda
  function do_ajax_form_orcamento_event_scajaxbutton_concluir_venda_onclick()
  {
    var var_idorcamento = scAjaxGetFieldHidden("idorcamento");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_orcamento_event_scajaxbutton_concluir_venda_onclick(var_idorcamento, var_observacao, var_valor_total, var_idcliente, var_script_case_init, do_ajax_form_orcamento_event_scajaxbutton_concluir_venda_onclick_cb);
  } // do_ajax_form_orcamento_event_scajaxbutton_concluir_venda_onclick

  function do_ajax_form_orcamento_event_scajaxbutton_concluir_venda_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_orcamento_event_scajaxbutton_concluir_venda_onclick_cb_after_alert);
  } // do_ajax_form_orcamento_event_scajaxbutton_concluir_venda_onclick_cb
  function do_ajax_form_orcamento_event_scajaxbutton_concluir_venda_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_orcamento_event_scajaxbutton_concluir_venda_onclick_cb_after_alert
...
function scJs_confirm(message, callbackOk, callbackCancel) {
  ...
  // ---------- Form
  function do_ajax_form_orcamento_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_orcamento_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idorcamento = scAjaxGetFieldHidden("idorcamento");
    ...
    scAjaxProcOn();
    x_ajax_form_orcamento_submit_form(var_idorcamento, var_idcliente, var_produto, var_valor_total, var_observacao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_orcamento_submit_form_cb);
  } // do_ajax_form_orcamento_submit_form

  function do_ajax_form_orcamento_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_orcamento_submit_form_cb_after_alert);
  } // do_ajax_form_orcamento_submit_form_cb
  function do_ajax_form_orcamento_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_orcamento_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_itens_orcamento"] = "off";

  function do_ajax_form_orcamento_navigate_form()
  {
    perform_ajax_form_orcamento_navigate_form();
  }

  function perform_ajax_form_orcamento_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_itens_orcamento"] = "on";
    x_ajax_form_orcamento_navigate_form(var_idorcamento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_orcamento_navigate_form_cb);
  } // do_ajax_form_orcamento_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_orcamento']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_orcamento_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_itens_orcamento"] && "nmsc_iframe_liga_form_itens_orcamento" != scMasterDetailIframe["nmsc_iframe_liga_form_itens_orcamento"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_itens_orcamento"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_itens_orcamento').contentWindow.nm_move('apl_detalhe', true, '320');
        document.getElementById('nmsc_iframe_liga_form_itens_orcamento').style.height = "320";
        document.getElementById('nmsc_iframe_liga_form_itens_orcamento').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_orcamento_navigate_form_cb_after_alert);
  } // do_ajax_form_orcamento_navigate_form_cb
  function do_ajax_form_orcamento_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_orcamento_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_orcamento_navigate_form_cb_after_alert

  function sc_hide_form_orcamento_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_itens_orcamento"])
    {
      return true;
    }
    return false;
