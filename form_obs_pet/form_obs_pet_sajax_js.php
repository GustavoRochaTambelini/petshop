  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_obs_pet" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idobs_pet_
  function do_ajax_form_obs_pet_validate_idobs_pet_(iNumLinha)
  {
    var nomeCampo_idobs_pet_ = "idobs_pet_" + iNumLinha;
    var var_idobs_pet_ = scAjaxGetFieldHidden(nomeCampo_idobs_pet_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_obs_pet_validate_idobs_pet_(var_idobs_pet_, iNumLinha, var_script_case_init, do_ajax_form_obs_pet_validate_idobs_pet__cb);
  } // do_ajax_form_obs_pet_validate_idobs_pet_

  function do_ajax_form_obs_pet_validate_idobs_pet__cb(sResp)
  {
    ...
    if ("" != iLineNumber)
    {
      sFieldValid = "idobs_pet_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idobs_pet_";
    }
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "idobs_pet_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idobs_pet_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_obs_pet_validate_idobs_pet__cb

  // ---------- Validate idclassificacao_obs_pet_
  function do_ajax_form_obs_pet_validate_idclassificacao_obs_pet_(iNumLinha)
  {
    var nomeCampo_idclassificacao_obs_pet_ = "idclassificacao_obs_pet_" + iNumLinha;
    var var_idclassificacao_obs_pet_ = scAjaxGetFieldSelect(nomeCampo_idclassificacao_obs_pet_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_obs_pet_validate_idclassificacao_obs_pet_(var_idclassificacao_obs_pet_, iNumLinha, var_script_case_init, do_ajax_form_obs_pet_validate_idclassificacao_obs_pet__cb);
  } // do_ajax_form_obs_pet_validate_idclassificacao_obs_pet_

  function do_ajax_form_obs_pet_validate_idclassificacao_obs_pet__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "idclassificacao_obs_pet_" + iLineNumber;
    }
    else
    {
      sFieldValid = "idclassificacao_obs_pet_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "idclassificacao_obs_pet_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "idclassificacao_obs_pet_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_obs_pet_validate_idclassificacao_obs_pet__cb

  // ---------- Validate obs_pet_
  function do_ajax_form_obs_pet_validate_obs_pet_(iNumLinha)
  {
    var nomeCampo_obs_pet_ = "obs_pet_" + iNumLinha;
    var var_obs_pet_ = scAjaxGetFieldText(nomeCampo_obs_pet_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_obs_pet_validate_obs_pet_(var_obs_pet_, iNumLinha, var_script_case_init, do_ajax_form_obs_pet_validate_obs_pet__cb);
  } // do_ajax_form_obs_pet_validate_obs_pet_

  function do_ajax_form_obs_pet_validate_obs_pet__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "obs_pet_" + iLineNumber;
    }
    else
    {
      sFieldValid = "obs_pet_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "obs_pet_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "obs_pet_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_obs_pet_validate_obs_pet__cb

  // ---------- Validate data_registro_
  function do_ajax_form_obs_pet_validate_data_registro_(iNumLinha)
  {
    var nomeCampo_data_registro_ = "data_registro_" + iNumLinha;
    var var_data_registro_ = scAjaxGetFieldText(nomeCampo_data_registro_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_obs_pet_validate_data_registro_(var_data_registro_, iNumLinha, var_script_case_init, do_ajax_form_obs_pet_validate_data_registro__cb);
  } // do_ajax_form_obs_pet_validate_data_registro_

  function do_ajax_form_obs_pet_validate_data_registro__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "data_registro_" + iLineNumber;
    }
    else
    {
      sFieldValid = "data_registro_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "data_registro_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "data_registro_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_obs_pet_validate_data_registro__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_obs_pet_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_obs_pet_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_obs_pet_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_obs_pet_add_new_line_cb);
  } // do_ajax_form_obs_pet_add_new_line

  function do_ajax_form_obs_pet_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_obs_pet_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_obs_pet_backup_line(iNumLinha)
  {
    var var_idobs_pet_ = scAjaxGetFieldHidden("idobs_pet_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_obs_pet_backup_line(var_idobs_pet_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_obs_pet_backup_line_cb);
  } // do_ajax_form_obs_pet_backup_line

  function do_ajax_form_obs_pet_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_obs_pet_backup_line_cb

  function do_ajax_form_obs_pet_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_obs_pet_cancel_insert

  function do_ajax_form_obs_pet_cancel_update(iSeqVert)
  {
    do_ajax_form_obs_pet_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_obs_pet_cancel_update

  function do_ajax_form_obs_pet_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_obs_pet_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_obs_pet_table_refresh()
  {
    var var_idobs_pet_ = document.F2.idobs_pet_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_obs_pet_table_refresh(var_idobs_pet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_obs_pet_table_refresh_cb);
  } //  do_ajax_form_obs_pet_table_refresh

  function do_ajax_form_obs_pet_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    document.F2.idobs_pet_.value = scAjaxGetKeyValue("idobs_pet_");
    ...
    scAjaxAlert(do_ajax_form_obs_pet_table_refresh_cb_after_alert);
  } // do_ajax_form_obs_pet_table_refresh_cb
  function do_ajax_form_obs_pet_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxSetNavStatus("t");
    sc_insert_open = false;
  } // do_ajax_form_obs_pet_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_obs_pet_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_obs_pet_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_idobs_pet_ = scAjaxGetFieldHidden("idobs_pet_" + iNumLinha);
    var var_idclassificacao_obs_pet_ = scAjaxGetFieldSelect("idclassificacao_obs_pet_" + iNumLinha);
    var var_obs_pet_ = scAjaxGetFieldText("obs_pet_" + iNumLinha);
    var var_data_registro_ = scAjaxGetFieldText("data_registro_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_obs_pet_submit_form(var_idobs_pet_, var_idclassificacao_obs_pet_, var_obs_pet_, var_data_registro_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_obs_pet_submit_form_cb);
  } // do_ajax_form_obs_pet_submit_form

  function do_ajax_form_obs_pet_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idobs_pet_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("idclassificacao_obs_pet_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("obs_pet_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("data_registro_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_obs_pet_submit_form_cb_after_alert);
  } // do_ajax_form_obs_pet_submit_form_cb
  function do_ajax_form_obs_pet_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_obs_pet_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_obs_pet_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_obs_pet_navigate_form, function() {});
    } else {
      perform_ajax_form_obs_pet_navigate_form();
    }
  }

  function perform_ajax_form_obs_pet_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_obs_pet_cancel_insert(sc_form_obs_pet_get_last_line_number());
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("idobs_pet_" + iNavForm);
      scAjaxHideErrorDisplay("idclassificacao_obs_pet_" + iNavForm);
      scAjaxHideErrorDisplay("obs_pet_" + iNavForm);
      scAjaxHideErrorDisplay("data_registro_" + iNavForm);
    }
    var var_idobs_pet_ = document.F2.idobs_pet_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_obs_pet_navigate_form(var_idobs_pet_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_obs_pet_navigate_form_cb);
  } // do_ajax_form_obs_pet_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_obs_pet']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_obs_pet_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idobs_pet_.value = scAjaxGetKeyValue("idobs_pet_" + var_last_index);
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_obs_pet_navigate_form_cb_after_alert);
  } // do_ajax_form_obs_pet_navigate_form_cb
  function do_ajax_form_obs_pet_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_obs_pet_navigate_form_cb_after_alert

    function sc_form_obs_pet_get_last_line_number()
    {
    ...
    } //sc_form_obs_pet_get_last_line_number

  function sc_hide_form_obs_pet_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "idobs_pet_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "idclassificacao_obs_pet_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "obs_pet_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "data_registro_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["idobs_pet_" + iNumLinha] = {"label": "ID<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["idclassificacao_obs_pet_" + iNumLinha] = {"label": "CLASSIFICAÇÃO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["obs_pet_" + iNumLinha] = {"label": "DESCRIÇÃO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["data_registro_" + iNumLinha] = {"label": "DATA REGISTRO<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["idobs_pet_"][iNumLinha] = "idobs_pet_" + iNumLinha;
    ajax_field_mult["idclassificacao_obs_pet_"][iNumLinha] = "idclassificacao_obs_pet_" + iNumLinha;
    ajax_field_mult["obs_pet_"][iNumLinha] = "obs_pet_" + iNumLinha;
    ajax_field_mult["data_registro_"][iNumLinha] = "data_registro_" + iNumLinha;
    ajax_field_id["idobs_pet_" + iNumLinha] = new Array("hidden_field_label_idobs_pet_", "hidden_field_data_idobs_pet_" + iNumLinha);
    ajax_field_id["idclassificacao_obs_pet_" + iNumLinha] = new Array("hidden_field_label_idclassificacao_obs_pet_", "hidden_field_data_idclassificacao_obs_pet_" + iNumLinha);
    ajax_field_id["obs_pet_" + iNumLinha] = new Array("hidden_field_label_obs_pet_", "hidden_field_data_obs_pet_" + iNumLinha);
    ajax_field_id["data_registro_" + iNumLinha] = new Array("hidden_field_label_data_registro_", "hidden_field_data_data_registro_" + iNumLinha);
    ajax_error_count["idobs_pet_" + iNumLinha] = "off";
    ajax_error_count["idclassificacao_obs_pet_" + iNumLinha] = "off";
    ajax_error_count["obs_pet_" + iNumLinha] = "off";
    ajax_error_count["data_registro_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["idobs_pet_" + iNumLinha] = "on";
    ajax_read_only["idclassificacao_obs_pet_" + iNumLinha] = "off";
    ajax_read_only["obs_pet_" + iNumLinha] = "off";
    ajax_read_only["data_registro_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["idobs_pet_" + iNumLinha] = "on";
    ajax_read_only["idclassificacao_obs_pet_" + iNumLinha] = "on";
    ajax_read_only["obs_pet_" + iNumLinha] = "on";
    ajax_read_only["data_registro_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["idobs_pet_" + iNumLinha] = null;
    ajax_error_list["idclassificacao_obs_pet_" + iNumLinha] = null;
    ajax_error_list["obs_pet_" + iNumLinha] = null;
    ajax_error_list["data_registro_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "idobs_pet_": new Array(),
    "idclassificacao_obs_pet_": new Array(),
    "obs_pet_": new Array(),
    "data_registro_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["idobs_pet_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idobs_pet_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idobs_pet_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idobs_pet_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idobs_pet_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["idclassificacao_obs_pet_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["idclassificacao_obs_pet_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["idclassificacao_obs_pet_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["idclassificacao_obs_pet_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["idclassificacao_obs_pet_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["obs_pet_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["obs_pet_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["obs_pet_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["obs_pet_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["obs_pet_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["data_registro_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["data_registro_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["data_registro_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["data_registro_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["data_registro_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idobs_pet_'])) ? $this->nmgp_cmp_readonly['idobs_pet_'] : 'on';
?>
    scAjaxFieldRead("idobs_pet_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['idclassificacao_obs_pet_'])) ? $this->nmgp_cmp_readonly['idclassificacao_obs_pet_'] : 'off';
?>
    scAjaxFieldRead("idclassificacao_obs_pet_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['obs_pet_'])) ? $this->nmgp_cmp_readonly['obs_pet_'] : 'off';
?>
    scAjaxFieldRead("obs_pet_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['data_registro_'])) ? $this->nmgp_cmp_readonly['data_registro_'] : 'off';
?>
    scAjaxFieldRead("data_registro_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("idobs_pet_" + iSeq, "on");
    scAjaxFieldRead("idclassificacao_obs_pet_" + iSeq, "on");
    scAjaxFieldRead("obs_pet_" + iSeq, "on");
    scAjaxFieldRead("data_registro_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["idobs_pet_" + iRow] || "on" == ajax_error_count["idclassificacao_obs_pet_" + iRow] || "on" == ajax_error_count["obs_pet_" + iRow] || "on" == ajax_error_count["data_registro_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idobs_pet_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_idclassificacao_obs_pet_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_obs_pet_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_data_registro_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["idobs_pet_" + iRow] && "off" == ajax_error_count["idclassificacao_obs_pet_" + iRow] && "off" == ajax_error_count["obs_pet_" + iRow] && "off" == ajax_error_count["data_registro_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["idobs_pet_" + iRow] = "off";
        ajax_error_count["idclassificacao_obs_pet_" + iRow] = "off";
        ajax_error_count["obs_pet_" + iRow] = "off";
        ajax_error_count["data_registro_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_idobs_pet_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_idclassificacao_obs_pet_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_obs_pet_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_data_registro_" + iRow).removeClass("scFormErrorLine");
    }
  }
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("idclassificacao_obs_pet_" == sIndex)
    {
