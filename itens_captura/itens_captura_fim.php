...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____itens_captura"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____itens_captura"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['itens_captura']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['itens_captura']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['itens_captura']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['itens_captura']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['itens_captura']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['itens_captura']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['itens_captura']['embutida_filho'] as $ind => $sc_init)
          {
