<?php
@session_start() ;
$_SESSION['scriptcase']['itens_captura']['sc_process_barr'] = true;
require_once('../itens_captura/index.php');
unset($_SESSION['scriptcase']['itens_captura']['sc_process_barr']);
$ExportCtrl = new itens_captura_export_control;
$ExportCtrl->Export_barr();

class itens_captura_export_control
{
