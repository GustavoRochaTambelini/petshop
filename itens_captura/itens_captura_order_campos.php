...
<?php
   ...
   $Ord_Cmp = new itens_captura_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class itens_captura_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['codigo_barras'] = "codigo_barras";
   $tab_labels["codigo_barras"]   = (isset($_SESSION['sc_session'][$sc_init]['itens_captura']['labels']["codigo_barras"])) ? $_SESSION['sc_session'][$sc_init]['itens_captura']['labels']["codigo_barras"] : "Código";
   $tab_ger_campos['descricao'] = "on";
   $tab_def_campos['descricao'] = "descricao";
   $tab_labels["descricao"]   = (isset($_SESSION['sc_session'][$sc_init]['itens_captura']['labels']["descricao"])) ? $_SESSION['sc_session'][$sc_init]['itens_captura']['labels']["descricao"] : "Descrição";
   $tab_ger_campos['und_comercial'] = "on";
   $tab_def_campos['und_comercial'] = "und_comercial";
   $tab_labels["und_comercial"]   = (isset($_SESSION['sc_session'][$sc_init]['itens_captura']['labels']["und_comercial"])) ? $_SESSION['sc_session'][$sc_init]['itens_captura']['labels']["und_comercial"] : "Und Comercial";
   $tab_ger_campos['valor_venda'] = "on";
   $tab_def_campos['valor_venda'] = "valor_venda";
   $tab_labels["valor_venda"]   = (isset($_SESSION['sc_session'][$sc_init]['itens_captura']['labels']["valor_venda"])) ? $_SESSION['sc_session'][$sc_init]['itens_captura']['labels']["valor_venda"] : "Valor Venda";
   $tab_ger_campos['imagem'] = "on";
   $tab_def_campos['imagem'] = "imagem";
   $tab_labels["imagem"]   = (isset($_SESSION['sc_session'][$sc_init]['itens_captura']['labels']["imagem"])) ? $_SESSION['sc_session'][$sc_init]['itens_captura']['labels']["imagem"] : "Imagem";
   $tab_ger_campos['imagem'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['itens_captura']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['itens_captura']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['itens_captura']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "itens_captura_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['itens_captura']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
