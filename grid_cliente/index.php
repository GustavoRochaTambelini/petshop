<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_cliente']['glo_nm_perfil']          = "conn_amazonrds_mysql";
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_cliente']['glo_nm_conexao'], $this->root . $this->path_prod, 'petshop', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
   ...
   function controle($linhas = 0)
   {
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_cliente']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_cliente']['label'] = "CADASTRO DE CLIENTES";
      ...
      { 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['field_order'][] = "cpf_cnpj";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['field_order'][] = "nome_fantasia";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['field_order'][] = "razao_social";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['field_order'][] = "email";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['field_order'][] = "logradouro";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['field_order'][] = "numero";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['field_order'][] = "bairro";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_cliente']['field_order'][] = "cidade_idcidade";
...
<HEAD>
 <TITLE>CADASTRO DE CLIENTES :: Doc</TITLE>
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_cliente']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_cliente']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_petshop'])) {
               $_SESSION['scriptcase']['grid_cliente']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_petshop'];
           }
       }
   }
