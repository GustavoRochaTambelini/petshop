<?php
   ...
   if(!$bol_sel_campos_include)
   {
     ...
     if (!isset($_SESSION['sc_session']))
     {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_cliente']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt"))
       {
?>
