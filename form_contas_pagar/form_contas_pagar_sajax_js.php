  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contas_pagar" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_contas_pagar_form();
	}
...
?>
  ...
  function do_ajax_form_contas_pagar_validate_idcontas_pagar()
  {
    var nomeCampo_idcontas_pagar = "idcontas_pagar";
    var var_idcontas_pagar = scAjaxGetFieldText(nomeCampo_idcontas_pagar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_validate_idcontas_pagar(var_idcontas_pagar, var_script_case_init, do_ajax_form_contas_pagar_validate_idcontas_pagar_cb);
  } // do_ajax_form_contas_pagar_validate_idcontas_pagar

  function do_ajax_form_contas_pagar_validate_idcontas_pagar_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_validate_idcontas_pagar_cb

  // ---------- Validate idcliente
  function do_ajax_form_contas_pagar_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_contas_pagar_validate_idcliente_cb);
  } // do_ajax_form_contas_pagar_validate_idcliente

  function do_ajax_form_contas_pagar_validate_idcliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_validate_idcliente_cb

  // ---------- Validate idforma_pagamento
  function do_ajax_form_contas_pagar_validate_idforma_pagamento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_validate_idforma_pagamento(var_idforma_pagamento, var_script_case_init, do_ajax_form_contas_pagar_validate_idforma_pagamento_cb);
  } // do_ajax_form_contas_pagar_validate_idforma_pagamento

  function do_ajax_form_contas_pagar_validate_idforma_pagamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_validate_idforma_pagamento_cb

  // ---------- Validate data_vencimanto
  function do_ajax_form_contas_pagar_validate_data_vencimanto()
  {
    var nomeCampo_data_vencimanto = "data_vencimanto";
    var var_data_vencimanto = scAjaxGetFieldText(nomeCampo_data_vencimanto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_validate_data_vencimanto(var_data_vencimanto, var_script_case_init, do_ajax_form_contas_pagar_validate_data_vencimanto_cb);
  } // do_ajax_form_contas_pagar_validate_data_vencimanto

  function do_ajax_form_contas_pagar_validate_data_vencimanto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_validate_data_vencimanto_cb

  // ---------- Validate data_pagamento
  function do_ajax_form_contas_pagar_validate_data_pagamento()
  {
    var nomeCampo_data_pagamento = "data_pagamento";
    var var_data_pagamento = scAjaxGetFieldText(nomeCampo_data_pagamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_validate_data_pagamento(var_data_pagamento, var_script_case_init, do_ajax_form_contas_pagar_validate_data_pagamento_cb);
  } // do_ajax_form_contas_pagar_validate_data_pagamento

  function do_ajax_form_contas_pagar_validate_data_pagamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_validate_data_pagamento_cb

  // ---------- Validate valor_a_pagar
  function do_ajax_form_contas_pagar_validate_valor_a_pagar()
  {
    var nomeCampo_valor_a_pagar = "valor_a_pagar";
    var var_valor_a_pagar = scAjaxGetFieldText(nomeCampo_valor_a_pagar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_validate_valor_a_pagar(var_valor_a_pagar, var_script_case_init, do_ajax_form_contas_pagar_validate_valor_a_pagar_cb);
  } // do_ajax_form_contas_pagar_validate_valor_a_pagar

  function do_ajax_form_contas_pagar_validate_valor_a_pagar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_validate_valor_a_pagar_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_contas_pagar_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_contas_pagar_validate_sc_field_0_cb);
  } // do_ajax_form_contas_pagar_validate_sc_field_0

  function do_ajax_form_contas_pagar_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_validate_sc_field_0_cb

  // ---------- Validate juros
  function do_ajax_form_contas_pagar_validate_juros()
  {
    var nomeCampo_juros = "juros";
    var var_juros = scAjaxGetFieldText(nomeCampo_juros);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_validate_juros(var_juros, var_script_case_init, do_ajax_form_contas_pagar_validate_juros_cb);
  } // do_ajax_form_contas_pagar_validate_juros

  function do_ajax_form_contas_pagar_validate_juros_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "juros";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_validate_juros_cb

  // ---------- Validate pago
  function do_ajax_form_contas_pagar_validate_pago()
  {
    var nomeCampo_pago = "pago";
    var var_pago = scAjaxGetFieldSelect(nomeCampo_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_validate_pago(var_pago, var_script_case_init, do_ajax_form_contas_pagar_validate_pago_cb);
  } // do_ajax_form_contas_pagar_validate_pago

  function do_ajax_form_contas_pagar_validate_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_validate_pago_cb

  // ---------- Validate pagamento_parcial
  function do_ajax_form_contas_pagar_validate_pagamento_parcial()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_pagar_validate_pagamento_parcial(var_pagamento_parcial, var_script_case_init, do_ajax_form_contas_pagar_validate_pagamento_parcial_cb);
  } // do_ajax_form_contas_pagar_validate_pagamento_parcial

  function do_ajax_form_contas_pagar_validate_pagamento_parcial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_pagar_validate_pagamento_parcial_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_contas_pagar_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_contas_pagar_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_contas_pagar_submit_form(var_idcontas_pagar, var_idcliente, var_idforma_pagamento, var_data_vencimanto, var_data_pagamento, var_valor_a_pagar, var_sc_field_0, var_juros, var_pago, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contas_pagar_submit_form_cb);
  } // do_ajax_form_contas_pagar_submit_form

  function do_ajax_form_contas_pagar_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_contas_pagar_submit_form_cb_after_alert);
  } // do_ajax_form_contas_pagar_submit_form_cb
  function do_ajax_form_contas_pagar_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contas_pagar_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_pagamento_parcial"] = "off";

  function do_ajax_form_contas_pagar_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_contas_pagar_navigate_form, function() {});
    } else {
      perform_ajax_form_contas_pagar_navigate_form();
    }
  }

  function perform_ajax_form_contas_pagar_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_pagamento_parcial"] = "on";
    x_ajax_form_contas_pagar_navigate_form(var_idcontas_pagar, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contas_pagar_navigate_form_cb);
  } // do_ajax_form_contas_pagar_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_pagar']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contas_pagar_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_pagamento_parcial"] && "nmsc_iframe_liga_form_pagamento_parcial" != scMasterDetailIframe["nmsc_iframe_liga_form_pagamento_parcial"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_pagamento_parcial"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_pagamento_parcial').contentWindow.nm_move('apl_detalhe', true, '0');
        document.getElementById('nmsc_iframe_liga_form_pagamento_parcial').style.height = "0";
        document.getElementById('nmsc_iframe_liga_form_pagamento_parcial').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contas_pagar_navigate_form_cb_after_alert);
  } // do_ajax_form_contas_pagar_navigate_form_cb
  function do_ajax_form_contas_pagar_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_contas_pagar_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_contas_pagar_navigate_form_cb_after_alert

  function sc_hide_form_contas_pagar_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_pagamento_parcial"])
    {
      return true;
    }
    return false;
