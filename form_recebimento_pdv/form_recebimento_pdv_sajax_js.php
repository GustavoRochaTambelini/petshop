  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_recebimento_pdv" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_recebimento_pdv_form();
	}
...
?>
  ...
  function do_ajax_form_recebimento_pdv_validate_idcontas_receber()
  {
    ...
    x_ajax_form_recebimento_pdv_validate_idcontas_receber(var_idcontas_receber, var_script_case_init, do_ajax_form_recebimento_pdv_validate_idcontas_receber_cb);
  } // do_ajax_form_recebimento_pdv_validate_idcontas_receber

  function do_ajax_form_recebimento_pdv_validate_idcontas_receber_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_idcontas_receber_cb

  // ---------- Validate idcliente
  function do_ajax_form_recebimento_pdv_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recebimento_pdv_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_recebimento_pdv_validate_idcliente_cb);
  } // do_ajax_form_recebimento_pdv_validate_idcliente

  function do_ajax_form_recebimento_pdv_validate_idcliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_idcliente_cb

  // ---------- Validate valor_a_receber
  function do_ajax_form_recebimento_pdv_validate_valor_a_receber()
  {
    var nomeCampo_valor_a_receber = "valor_a_receber";
    var var_valor_a_receber = scAjaxGetFieldText(nomeCampo_valor_a_receber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recebimento_pdv_validate_valor_a_receber(var_valor_a_receber, var_script_case_init, do_ajax_form_recebimento_pdv_validate_valor_a_receber_cb);
  } // do_ajax_form_recebimento_pdv_validate_valor_a_receber

  function do_ajax_form_recebimento_pdv_validate_valor_a_receber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_valor_a_receber_cb

  // ---------- Validate desconto
  function do_ajax_form_recebimento_pdv_validate_desconto()
  {
    var nomeCampo_desconto = "desconto";
    var var_desconto = scAjaxGetFieldText(nomeCampo_desconto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recebimento_pdv_validate_desconto(var_desconto, var_script_case_init, do_ajax_form_recebimento_pdv_validate_desconto_cb);
  } // do_ajax_form_recebimento_pdv_validate_desconto

  function do_ajax_form_recebimento_pdv_validate_desconto_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_desconto_cb

  // ---------- Validate desconto_porcento
  function do_ajax_form_recebimento_pdv_validate_desconto_porcento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recebimento_pdv_validate_desconto_porcento(var_desconto_porcento, var_script_case_init, do_ajax_form_recebimento_pdv_validate_desconto_porcento_cb);
  } // do_ajax_form_recebimento_pdv_validate_desconto_porcento

  function do_ajax_form_recebimento_pdv_validate_desconto_porcento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_desconto_porcento_cb

  // ---------- Validate idforma_pagamento_prevista
  function do_ajax_form_recebimento_pdv_validate_idforma_pagamento_prevista()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recebimento_pdv_validate_idforma_pagamento_prevista(var_idforma_pagamento_prevista, var_script_case_init, do_ajax_form_recebimento_pdv_validate_idforma_pagamento_prevista_cb);
  } // do_ajax_form_recebimento_pdv_validate_idforma_pagamento_prevista

  function do_ajax_form_recebimento_pdv_validate_idforma_pagamento_prevista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_idforma_pagamento_prevista_cb

  // ---------- Validate data_emissao
  function do_ajax_form_recebimento_pdv_validate_data_emissao()
  {
    var nomeCampo_data_emissao = "data_emissao";
    var var_data_emissao = scAjaxGetFieldText(nomeCampo_data_emissao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recebimento_pdv_validate_data_emissao(var_data_emissao, var_script_case_init, do_ajax_form_recebimento_pdv_validate_data_emissao_cb);
  } // do_ajax_form_recebimento_pdv_validate_data_emissao

  function do_ajax_form_recebimento_pdv_validate_data_emissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_data_emissao_cb

  // ---------- Validate data_vencimento
  function do_ajax_form_recebimento_pdv_validate_data_vencimento()
  {
    var nomeCampo_data_vencimento = "data_vencimento";
    var var_data_vencimento = scAjaxGetFieldText(nomeCampo_data_vencimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recebimento_pdv_validate_data_vencimento(var_data_vencimento, var_script_case_init, do_ajax_form_recebimento_pdv_validate_data_vencimento_cb);
  } // do_ajax_form_recebimento_pdv_validate_data_vencimento

  function do_ajax_form_recebimento_pdv_validate_data_vencimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_data_vencimento_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_recebimento_pdv_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recebimento_pdv_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_recebimento_pdv_validate_sc_field_0_cb);
  } // do_ajax_form_recebimento_pdv_validate_sc_field_0

  function do_ajax_form_recebimento_pdv_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_sc_field_0_cb

  // ---------- Validate sc_field_1
  function do_ajax_form_recebimento_pdv_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recebimento_pdv_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_form_recebimento_pdv_validate_sc_field_1_cb);
  } // do_ajax_form_recebimento_pdv_validate_sc_field_1

  function do_ajax_form_recebimento_pdv_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_sc_field_1_cb

  // ---------- Validate sc_field_3
  function do_ajax_form_recebimento_pdv_validate_sc_field_3()
  {
    var nomeCampo_sc_field_3 = "sc_field_3";
    var var_sc_field_3 = scAjaxGetFieldCheckbox(nomeCampo_sc_field_3, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recebimento_pdv_validate_sc_field_3(var_sc_field_3, var_script_case_init, do_ajax_form_recebimento_pdv_validate_sc_field_3_cb);
  } // do_ajax_form_recebimento_pdv_validate_sc_field_3

  function do_ajax_form_recebimento_pdv_validate_sc_field_3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_sc_field_3_cb

  // ---------- Validate valor_parcelas
  function do_ajax_form_recebimento_pdv_validate_valor_parcelas()
  {
    var nomeCampo_valor_parcelas = "valor_parcelas";
    var var_valor_parcelas = scAjaxGetFieldText(nomeCampo_valor_parcelas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recebimento_pdv_validate_valor_parcelas(var_valor_parcelas, var_script_case_init, do_ajax_form_recebimento_pdv_validate_valor_parcelas_cb);
  } // do_ajax_form_recebimento_pdv_validate_valor_parcelas

  function do_ajax_form_recebimento_pdv_validate_valor_parcelas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_valor_parcelas_cb

  // ---------- Validate pago
  function do_ajax_form_recebimento_pdv_validate_pago()
  {
    var nomeCampo_pago = "pago";
    var var_pago = scAjaxGetFieldSelect(nomeCampo_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recebimento_pdv_validate_pago(var_pago, var_script_case_init, do_ajax_form_recebimento_pdv_validate_pago_cb);
  } // do_ajax_form_recebimento_pdv_validate_pago

  function do_ajax_form_recebimento_pdv_validate_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_pago_cb

  // ---------- Validate data_pagamento
  function do_ajax_form_recebimento_pdv_validate_data_pagamento()
  {
    var nomeCampo_data_pagamento = "data_pagamento";
    var var_data_pagamento = scAjaxGetFieldText(nomeCampo_data_pagamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recebimento_pdv_validate_data_pagamento(var_data_pagamento, var_script_case_init, do_ajax_form_recebimento_pdv_validate_data_pagamento_cb);
  } // do_ajax_form_recebimento_pdv_validate_data_pagamento

  function do_ajax_form_recebimento_pdv_validate_data_pagamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_data_pagamento_cb

  // ---------- Validate observacoes
  function do_ajax_form_recebimento_pdv_validate_observacoes()
  {
    var nomeCampo_observacoes = "observacoes";
    var var_observacoes = scAjaxGetFieldText(nomeCampo_observacoes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_recebimento_pdv_validate_observacoes(var_observacoes, var_script_case_init, do_ajax_form_recebimento_pdv_validate_observacoes_cb);
  } // do_ajax_form_recebimento_pdv_validate_observacoes

  function do_ajax_form_recebimento_pdv_validate_observacoes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_recebimento_pdv_validate_observacoes_cb

  // ---------- Event onblur desconto_porcento
  function do_ajax_form_recebimento_pdv_event_desconto_porcento_onblur()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_recebimento_pdv_event_desconto_porcento_onblur(var_desconto_porcento, var_desconto, var_valor_a_receber, var_sc_field_0, var_valor_parcelas, var_script_case_init, do_ajax_form_recebimento_pdv_event_desconto_porcento_onblur_cb);
  } // do_ajax_form_recebimento_pdv_event_desconto_porcento_onblur

  function do_ajax_form_recebimento_pdv_event_desconto_porcento_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "desconto_porcento";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recebimento_pdv_event_desconto_porcento_onblur_cb_after_alert);
  } // do_ajax_form_recebimento_pdv_event_desconto_porcento_onblur_cb
  function do_ajax_form_recebimento_pdv_event_desconto_porcento_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recebimento_pdv_event_desconto_porcento_onblur_cb_after_alert

  // ---------- Event onblur desconto
  function do_ajax_form_recebimento_pdv_event_desconto_onblur()
  {
    var var_desconto_porcento = scAjaxGetFieldText("desconto_porcento");
    var var_desconto = scAjaxGetFieldText("desconto");
    var var_valor_a_receber = scAjaxGetFieldText("valor_a_receber");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recebimento_pdv_event_desconto_onblur(var_desconto_porcento, var_desconto, var_valor_a_receber, var_sc_field_0, var_valor_parcelas, var_script_case_init, do_ajax_form_recebimento_pdv_event_desconto_onblur_cb);
  } // do_ajax_form_recebimento_pdv_event_desconto_onblur

  function do_ajax_form_recebimento_pdv_event_desconto_onblur_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "desconto";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recebimento_pdv_event_desconto_onblur_cb_after_alert);
  } // do_ajax_form_recebimento_pdv_event_desconto_onblur_cb
  function do_ajax_form_recebimento_pdv_event_desconto_onblur_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recebimento_pdv_event_desconto_onblur_cb_after_alert

  // ---------- Event onchange sc_field_0
  function do_ajax_form_recebimento_pdv_event_sc_field_0_onchange()
  {
    var var_valor_a_receber = scAjaxGetFieldText("valor_a_receber");
    var var_sc_field_0 = scAjaxGetFieldText("sc_field_0");
    var var_valor_parcelas = scAjaxGetFieldText("valor_parcelas");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recebimento_pdv_event_sc_field_0_onchange(var_valor_a_receber, var_sc_field_0, var_valor_parcelas, var_script_case_init, do_ajax_form_recebimento_pdv_event_sc_field_0_onchange_cb);
  } // do_ajax_form_recebimento_pdv_event_sc_field_0_onchange

  function do_ajax_form_recebimento_pdv_event_sc_field_0_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "sc_field_0";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recebimento_pdv_event_sc_field_0_onchange_cb_after_alert);
  } // do_ajax_form_recebimento_pdv_event_sc_field_0_onchange_cb
  function do_ajax_form_recebimento_pdv_event_sc_field_0_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recebimento_pdv_event_sc_field_0_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_salvar
  function do_ajax_form_recebimento_pdv_event_scajaxbutton_salvar_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_recebimento_pdv_event_scajaxbutton_salvar_onclick(var_idcliente, var_valor_a_receber, var_pago, var_data_pagamento, var_sc_field_0, var_data_vencimento, var_idforma_pagamento_prevista, var_data_emissao, var_observacoes, var_sc_field_3, var_sc_field_1, var_script_case_init, do_ajax_form_recebimento_pdv_event_scajaxbutton_salvar_onclick_cb);
  } // do_ajax_form_recebimento_pdv_event_scajaxbutton_salvar_onclick

  function do_ajax_form_recebimento_pdv_event_scajaxbutton_salvar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_recebimento_pdv_event_scajaxbutton_salvar_onclick_cb_after_alert);
  } // do_ajax_form_recebimento_pdv_event_scajaxbutton_salvar_onclick_cb
  function do_ajax_form_recebimento_pdv_event_scajaxbutton_salvar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_recebimento_pdv_event_scajaxbutton_salvar_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_recebimento_pdv_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_recebimento_pdv_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_recebimento_pdv_submit_form(var_idcontas_receber, var_idcliente, var_valor_a_receber, var_desconto, var_desconto_porcento, var_idforma_pagamento_prevista, var_data_emissao, var_data_vencimento, var_sc_field_0, var_sc_field_1, var_sc_field_3, var_valor_parcelas, var_pago, var_data_pagamento, var_observacoes, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_recebimento_pdv_submit_form_cb);
  } // do_ajax_form_recebimento_pdv_submit_form

  function do_ajax_form_recebimento_pdv_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_recebimento_pdv_submit_form_cb_after_alert);
  } // do_ajax_form_recebimento_pdv_submit_form_cb
  function do_ajax_form_recebimento_pdv_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_recebimento_pdv_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_recebimento_pdv_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_recebimento_pdv_navigate_form, function() {});
    } else {
      perform_ajax_form_recebimento_pdv_navigate_form();
    }
  }

  function perform_ajax_form_recebimento_pdv_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_recebimento_pdv_navigate_form(var_idcontas_receber, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_recebimento_pdv_navigate_form_cb);
  } // do_ajax_form_recebimento_pdv_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_recebimento_pdv_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_recebimento_pdv_navigate_form_cb_after_alert);
  } // do_ajax_form_recebimento_pdv_navigate_form_cb
  function do_ajax_form_recebimento_pdv_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_recebimento_pdv_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_recebimento_pdv_navigate_form_cb_after_alert

  function sc_hide_form_recebimento_pdv_form()
  {
