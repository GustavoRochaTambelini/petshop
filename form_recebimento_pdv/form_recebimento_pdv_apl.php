<?php
//
class form_recebimento_pdv_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->v_valor_a_receber)) 
          {
              $_SESSION['v_valor_a_receber'] = $this->v_valor_a_receber;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_recebimento_pdv_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_recebimento_pdv']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_recebimento_pdv']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_recebimento_pdv'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recebimento_pdv']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recebimento_pdv']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_recebimento_pdv') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_recebimento_pdv']['label'] = "CONTAS RECEBER";
      ...
      $_SESSION['scriptcase']['error_icon']['form_recebimento_pdv']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_recebimento_pdv'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_recebimento_pdv']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_recebimento_pdv'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_recebimento_pdv'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_recebimento_pdv/form_recebimento_pdv_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_recebimento_pdv_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_recebimento_pdv_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_recebimento_pdv_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_recebimento_pdv/form_recebimento_pdv_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_recebimento_pdv_erro.class.php"); 
      }
      $this->Erro      = new form_recebimento_pdv_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao']))
         { 
             if ($this->idcontas_receber != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_recebimento_pdv']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['Salvar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['botoes']['Salvar'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['final'];
      }
      else
      {
      }
...
//
      ...
      {
      $_SESSION['scriptcase']['form_recebimento_pdv']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_recebimento_pdv']['contr_erro'] = 'off'; 
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dados_select']['idcliente']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->idcliente = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dados_select']['idcliente'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dados_select']['valor_a_receber']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->valor_a_receber = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dados_select']['valor_a_receber'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dados_select']['valor_parcelas']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->valor_parcelas = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dados_select']['valor_parcelas'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dados_select']['data_pagamento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->data_pagamento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dados_select']['data_pagamento'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_recebimento_pdv.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_recebimento_pdv_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_recebimento_pdv"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_recebimento_pdv']) || !is_array($this->NM_ajax_info['errList']['geral_form_recebimento_pdv']))
              {
                  $this->NM_ajax_info['errList']['geral_form_recebimento_pdv'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_recebimento_pdv'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
$_SESSION['scriptcase']['form_recebimento_pdv']['contr_erro'] = 'off'; 
    ...
    function ValidateField_idcliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idcliente == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['php_cmp_required']['idcliente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['php_cmp_required']['idcliente'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idcliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['Lookup_idcliente']) && !in_array($this->idcliente, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['Lookup_idcliente']))
          {
              $hasError = true;
    ...
    function ValidateField_valor_a_receber(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['php_cmp_required']['valor_a_receber']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['php_cmp_required']['valor_a_receber'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_idforma_pagamento_prevista(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idforma_pagamento_prevista) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['Lookup_idforma_pagamento_prevista']) && !in_array($this->idforma_pagamento_prevista, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['Lookup_idforma_pagamento_prevista']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idcontas_receber']['keyVal'] = form_recebimento_pdv_pack_protect_string($this->nmgp_dados_form['idcontas_receber']);
          }
   } // ajax_return_values
...
$aLookup[] = array(form_recebimento_pdv_pack_protect_string('') => str_replace('<', '&lt;',form_recebimento_pdv_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['Lookup_idcliente'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_recebimento_pdv_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_recebimento_pdv_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idcliente']['valList'][$i] = form_recebimento_pdv_pack_protect_string($v);
          }
...
else
{
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idforma_pagamento_prevista']['valList'][$i] = form_recebimento_pdv_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_recebimento_pdv_pack_protect_string('T') => str_replace('<', '&lt;',form_recebimento_pdv_pack_protect_string("VENCIMENTO FIXO ")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['Lookup_sc_field_3'][] = 'T';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['sc_field_3']['valList'][$i] = form_recebimento_pdv_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_recebimento_pdv_pack_protect_string('F') => str_replace('<', '&lt;',form_recebimento_pdv_pack_protect_string("A RECEBER")));
$aLookup[] = array(form_recebimento_pdv_pack_protect_string('T') => str_replace('<', '&lt;',form_recebimento_pdv_pack_protect_string("RECEBIDO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['Lookup_pago'][] = 'F';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['Lookup_pago'][] = 'T';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"pago\"";
          ...
          {
              $this->NM_ajax_info['fldList']['pago']['valList'][$i] = form_recebimento_pdv_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_observacoes($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idcontas_receber)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao'] = '';
...
;
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_recebimento_pdv';
...
$_SESSION['scriptcase']['form_recebimento_pdv']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "idcliente = $this->idcliente, idforma_pagamento_prevista = $this->idforma_pagamento_prevista, data_emissao = TO_DATE('$this->data_emissao', 'yyyy-mm-dd hh24:mi:ss'), data_vencimento = TO_DATE('$this->data_vencimento', 'yyyy-mm-dd hh24:mi:ss'), valor_a_receber = $this->valor_a_receber, data_pagamento = TO_DATE('$this->data_pagamento', 'yyyy-mm-dd hh24:mi:ss'), pago = '$this->pago'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['parms'] = "idcontas_receber?#?$this->idcontas_receber?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['select'] = ""; 
              } 
          } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dados_select'] = $this->nmgp_dados_select;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_recebimento_pdv_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_recebimento_pdv = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['total'] = $qt_geral_reg_form_recebimento_pdv;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_recebimento_pdv_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_recebimento_pdv_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_recebimento_pdv_fim.php";
   }
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['masterValue']))
{
...
function nmgp_redireciona_form($nm_apl_dest, $nm_apl_retorno, $nm_apl_parms, $nm_target="", $opc="", $alt_modal=430, $larg_modal=630)
{
   ...
   if (is_array($nm_apl_parms))
   {
       ...
       foreach ($nm_apl_parms as $par => $val)
       {
           ...
           elseif (substr($val, 0, 1) == "[")
           {
               $tmp_parms .= $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv'][substr($val, 1, -1)];
           }
           else
           {
               $tmp_parms .= $val;
   ...
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opcao'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['opc_ant'] = "";
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['retorno_edit'] = "";
   }
...
<?php
   if ($nm_target_form != "_blank" && $nm_target_form != "modal")
   {
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_pdv']['ordem_ord'] == " desc") {
