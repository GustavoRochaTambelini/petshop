  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_funcao_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate idfuncao
  function do_ajax_form_funcao_mob_validate_idfuncao()
  {
    var nomeCampo_idfuncao = "idfuncao";
    var var_idfuncao = scAjaxGetFieldHidden(nomeCampo_idfuncao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcao_mob_validate_idfuncao(var_idfuncao, var_script_case_init, do_ajax_form_funcao_mob_validate_idfuncao_cb);
  } // do_ajax_form_funcao_mob_validate_idfuncao

  function do_ajax_form_funcao_mob_validate_idfuncao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idfuncao";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcao_mob_validate_idfuncao_cb

  // ---------- Validate descricao
  function do_ajax_form_funcao_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_funcao_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_funcao_mob_validate_descricao_cb);
  } // do_ajax_form_funcao_mob_validate_descricao

  function do_ajax_form_funcao_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_funcao_mob_validate_descricao_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_funcao_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_funcao_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idfuncao = scAjaxGetFieldHidden("idfuncao");
    ...
    scAjaxProcOn();
    x_ajax_form_funcao_mob_submit_form(var_idfuncao, var_descricao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_funcao_mob_submit_form_cb);
  } // do_ajax_form_funcao_mob_submit_form

  function do_ajax_form_funcao_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idfuncao");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_funcao_mob_submit_form_cb_after_alert);
  } // do_ajax_form_funcao_mob_submit_form_cb
  function do_ajax_form_funcao_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_funcao_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_funcao_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_funcao_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_funcao_mob_navigate_form();
    }
  }

  function perform_ajax_form_funcao_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("idfuncao");
    scAjaxHideErrorDisplay("descricao");
    var var_idfuncao = document.F2.idfuncao.value;
    ...
    scAjaxProcOn();
    x_ajax_form_funcao_mob_navigate_form(var_idfuncao, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_funcao_mob_navigate_form_cb);
  } // do_ajax_form_funcao_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_funcao_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_funcao_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idfuncao.value = scAjaxGetKeyValue("idfuncao");
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_funcao_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_funcao_mob_navigate_form_cb
  function do_ajax_form_funcao_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_funcao_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_funcao_mob_navigate_form_cb_after_alert

  function sc_hide_form_funcao_mob_form()
  {
  ...
  var ajax_error_list = {
    "idfuncao": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  ajax_field_mult["idfuncao"][1] = "idfuncao";
  ajax_field_mult["descricao"][1] = "descricao";

  var ajax_field_id = {
    "idfuncao": new Array("hidden_field_label_idfuncao", "hidden_field_data_idfuncao"),
