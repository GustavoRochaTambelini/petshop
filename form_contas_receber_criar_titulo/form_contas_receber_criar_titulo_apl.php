...
$_SESSION['scriptcase']['form_contas_receber_criar_titulo']['contr_erro'] = 'off'; 
    ...
    function ValidateField_competencia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['php_cmp_required']['competencia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['php_cmp_required']['competencia'] == "on")) 
      { 
          if ($this->competencia == "")  
          { 
              $hasError = true;
