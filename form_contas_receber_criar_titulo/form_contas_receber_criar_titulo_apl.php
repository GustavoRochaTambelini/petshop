<?php
//
class form_contas_receber_criar_titulo_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if ($this->NM_ajax_flag)
      {
          ...
          if (isset($this->NM_ajax_info['param']['idtipos_receitas']))
          {
              $this->idtipos_receitas = $this->NM_ajax_info['param']['idtipos_receitas'];
          }
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_contas_receber_criar_titulo_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_contas_receber_criar_titulo']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_contas_receber_criar_titulo']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_contas_receber_criar_titulo'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_contas_receber_criar_titulo']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_contas_receber_criar_titulo']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_contas_receber_criar_titulo') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_contas_receber_criar_titulo']['label'] = "CONTAS RECEBER";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_contas_receber_criar_titulo")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_contas_receber_criar_titulo']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_contas_receber_criar_titulo'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_contas_receber_criar_titulo']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_contas_receber_criar_titulo'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_contas_receber_criar_titulo'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dados_form'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_contas_receber_criar_titulo/form_contas_receber_criar_titulo_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_contas_receber_criar_titulo_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_contas_receber_criar_titulo_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_contas_receber_criar_titulo_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_contas_receber_criar_titulo/form_contas_receber_criar_titulo_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_contas_receber_criar_titulo_erro.class.php"); 
      }
      $this->Erro      = new form_contas_receber_criar_titulo_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao']))
         { 
             if ($this->idcontas_receber != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_contas_receber_criar_titulo']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opc_ant'] : "";
      } 
      ...
      {
          $this->nmgp_botoes['Salvar'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['botoes']['Salvar'];
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['final'];
      }
      else
      {
      }
...
//
      ...
      {
      $_SESSION['scriptcase']['form_contas_receber_criar_titulo']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_contas_receber_criar_titulo']['contr_erro'] = 'off'; 
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dados_select'];
     }
   }
...
//
      if ($this->NM_ajax_flag && 'validate_' == substr($this->NM_ajax_opcao, 0, 9))
      {
          ...
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'idtipos_receitas');
          }
          if ('validate_idnota_fiscal' == $this->NM_ajax_opcao)
          {
              $this->Valida_campos($Campos_Crit, $Campos_Falta, $Campos_Erros, 'idnota_fiscal');
          }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          ...
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dados_select']['data_pagamento']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->data_pagamento = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dados_select']['data_pagamento'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_contas_receber_criar_titulo.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_contas_receber_criar_titulo_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_contas_receber_criar_titulo"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_contas_receber_criar_titulo']) || !is_array($this->NM_ajax_info['errList']['geral_form_contas_receber_criar_titulo']))
              {
                  $this->NM_ajax_info['errList']['geral_form_contas_receber_criar_titulo'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_contas_receber_criar_titulo'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
      ...
      if ((!is_array($filtro) && ('' == $filtro || 'idnota_fiscal' == $filtro)) || (is_array($filtro) && in_array('idnota_fiscal', $filtro)))
        $this->ValidateField_idnota_fiscal($Campos_Crit, $Campos_Falta, $Campos_Erros);
...
$_SESSION['scriptcase']['form_contas_receber_criar_titulo']['contr_erro'] = 'off'; 
    ...
    function ValidateField_idcliente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idcliente == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['php_cmp_required']['idcliente']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['php_cmp_required']['idcliente'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idcliente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idcliente']) && !in_array($this->idcliente, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idcliente']))
          {
              $hasError = true;
    ...
    function ValidateField_competencia(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['php_cmp_required']['competencia']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['php_cmp_required']['competencia'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_valor_a_receber(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->valor_a_receber, 13, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['php_cmp_required']['valor_a_receber']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['php_cmp_required']['valor_a_receber'] == "on") 
           { 
              $hasError = true;
    ...
    function ValidateField_idforma_pagamento_prevista(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idforma_pagamento_prevista) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idforma_pagamento_prevista']) && !in_array($this->idforma_pagamento_prevista, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idforma_pagamento_prevista']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idgrupos_receitas(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->idgrupos_receitas == "" && $this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['php_cmp_required']['idgrupos_receitas']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['php_cmp_required']['idgrupos_receitas'] == "on"))
      {
          $hasError = true;
          ...
          if (!empty($this->idgrupos_receitas) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idgrupos_receitas']) && !in_array($this->idgrupos_receitas, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idgrupos_receitas']))
          {
              $hasError = true;
              $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
              if (!isset($Campos_Erros['idgrupos_receitas']))
    ...
    function ValidateField_idtipos_receitas(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idtipos_receitas) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idtipos_receitas']) && !in_array($this->idtipos_receitas, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idtipos_receitas']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($Campos_Erros['idtipos_receitas']))
                   {
                       $Campos_Erros['idtipos_receitas'] = array();
                   }
                   $Campos_Erros['idtipos_receitas'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
                   if (!isset($this->NM_ajax_info['errList']['idtipos_receitas']) || !is_array($this->NM_ajax_info['errList']['idtipos_receitas']))
                   {
                       $this->NM_ajax_info['errList']['idtipos_receitas'] = array();
                   }
                   $this->NM_ajax_info['errList']['idtipos_receitas'][] = $this->Ini->Nm_lang['lang_errm_ajax_data'];
               }
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'idtipos_receitas';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_idtipos_receitas

    function ValidateField_idnota_fiscal(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      ...
      if ($this->nmgp_opcao != "excluir") 
      { 
          if ($this->idnota_fiscal != '')  
          { 
              $iTestSize = 10;
              if (strlen($this->idnota_fiscal) > $iTestSize)  
              { 
                  $hasError = true;
                  $Campos_Crit .= "NOTA FISCAL VINCULADA: " . $this->Ini->Nm_lang['lang_errm_size']; 
                  if (!isset($Campos_Erros['idnota_fiscal']))
                  {
                      $Campos_Erros['idnota_fiscal'] = array();
                  }
                  $Campos_Erros['idnota_fiscal'][] = $this->Ini->Nm_lang['lang_errm_size'];
                  if (!isset($this->NM_ajax_info['errList']['idnota_fiscal']) || !is_array($this->NM_ajax_info['errList']['idnota_fiscal']))
                  {
                      $this->NM_ajax_info['errList']['idnota_fiscal'] = array();
                  }
                  $this->NM_ajax_info['errList']['idnota_fiscal'][] = $this->Ini->Nm_lang['lang_errm_size'];
              } 
              if ($teste_validade->Valor($this->idnota_fiscal, 10, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
                  ...
                  $Campos_Erros['idnota_fiscal'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
                  if (!isset($this->NM_ajax_info['errList']['idnota_fiscal']) || !is_array($this->NM_ajax_info['errList']['idnota_fiscal']))
                  {
                      $this->NM_ajax_info['errList']['idnota_fiscal'] = array();
                  }
                  $this->NM_ajax_info['errList']['idnota_fiscal'][] = "" . $this->Ini->Nm_lang['lang_errm_ajax_data'] . "";
              } 
          } 
      } 
        if ($hasError) {
            global $sc_seq_vert;
            $fieldName = 'idnota_fiscal';
            if (isset($sc_seq_vert) && '' != $sc_seq_vert) {
                $fieldName .= $sc_seq_vert;
            }
            $this->NM_ajax_info['fieldsWithErrors'][] = $fieldName;
        }
    } // ValidateField_idnota_fiscal
    ...
    function ValidateField_sc_field_2(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
      if ($this->sc_field_2 == "" && $this->nmgp_opcao != "excluir")
      { 
          $this->sc_field_2 = "F";
      } 
      else 
      { 
          if (is_array($this->sc_field_2))
          {
              ...
              foreach ($this->sc_field_2 as $ind => $dados_sc_field_2_1 ) 
              {
                  if ($dados_sc_field_2_1 != "") 
                  {
                      $this->sc_field_2_1[] = $dados_sc_field_2_1;
                  } 
              } 
              $this->sc_field_2 = ""; 
              foreach ($this->sc_field_2_1 as $dados_sc_field_2_1 ) 
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dados_form'] = $this->nmgp_dados_form;
   }
   ...
   function nm_formatar_campos($format_fields = array())
   {
     ...
     $this->formatado = true;
      ...
      if ('' !== $this->idnota_fiscal || (!empty($format_fields) && isset($format_fields['idnota_fiscal'])))
      {
          nmgp_Form_Num_Val($this->idnota_fiscal, $this->field_config['idnota_fiscal']['symbol_grp'], $this->field_config['idnota_fiscal']['symbol_dec'], "0", "S", $this->field_config['idnota_fiscal']['format_neg'], "", "", "-", $this->field_config['idnota_fiscal']['symbol_fmt']) ; 
      }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idcontas_receber']['keyVal'] = form_contas_receber_criar_titulo_pack_protect_string($this->nmgp_dados_form['idcontas_receber']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idcliente']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idcliente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idcliente']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idcliente'] = array(); 
}
$aLookup[] = array(form_contas_receber_criar_titulo_pack_protect_string('') => str_replace('<', '&lt;',form_contas_receber_criar_titulo_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idcliente'][] = '';
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_contas_receber_criar_titulo_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_contas_receber_criar_titulo_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idcliente'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idcliente']['valList'][$i] = form_contas_receber_criar_titulo_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idforma_pagamento_prevista']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idforma_pagamento_prevista'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idforma_pagamento_prevista']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idforma_pagamento_prevista'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idforma_pagamento_prevista'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idforma_pagamento_prevista']['valList'][$i] = form_contas_receber_criar_titulo_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idgrupos_receitas'][] = '';
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idgrupos_receitas']['valList'][$i] = form_contas_receber_criar_titulo_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
{ 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_idtipos_receitas'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $sSelComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['idtipos_receitas']);
          }
          $sLookup = '';
          if (empty($aLookup))
          {
          ...
          foreach ($aLookup as $aOption)
          {
              foreach ($aOption as $sValue => $sLabel)
              {
                  ...
                  if ($this->idtipos_receitas == $sValue)
                  {
                      $this->_tmp_lookup_idtipos_receitas = $sLabel;
                  }
          ...
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['idtipos_receitas']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['idtipos_receitas']['valList'][$i] = form_contas_receber_criar_titulo_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
              if (in_array(key($aValData), $this->NM_ajax_info['fldList']['idtipos_receitas']['valList']))
              {
                  $aLabelTemp[key($aValData)] = current($aValData);
              }
          }
          foreach ($this->NM_ajax_info['fldList']['idtipos_receitas']['valList'] as $iIndex => $sValue)
          {
              $aLabel[$iIndex] = (isset($aLabelTemp[$sValue])) ? $aLabelTemp[$sValue] : $sValue;
          }
          $this->NM_ajax_info['fldList']['idtipos_receitas']['labList'] = $aLabel;
          }
   }

          //----- idnota_fiscal
   function ajax_return_values_idnota_fiscal($bForce = false)
   {
          if ('navigate_form' == $this->NM_ajax_opcao || 'backup_line' == $this->NM_ajax_opcao || (isset($this->nmgp_refresh_fields) && in_array("idnota_fiscal", $this->nmgp_refresh_fields)) || $bForce)
          {
              $sTmpValue = NM_charset_to_utf8($this->idnota_fiscal);
              $aLookup = array();
          $aLookupOrig = $aLookup;
          $this->NM_ajax_info['fldList']['idnota_fiscal'] = array(
                       'row'    => '',
               'type'    => 'text',
               'valList' => array($sTmpValue),
              );
...
$aLookup[] = array(form_contas_receber_criar_titulo_pack_protect_string('T') => str_replace('<', '&lt;',form_contas_receber_criar_titulo_pack_protect_string("DIVIDIR O VALOR NAS PARCELAS")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_sc_field_2'][] = 'T';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          if (isset($this->NM_ajax_info['select_html']['sc_field_2']) && !empty($this->NM_ajax_info['select_html']['sc_field_2']))
          {
              $sOptComp = str_replace('{SC_100PERC_CLASS_INPUT}', $this->classes_100perc_fields['input'], $this->NM_ajax_info['select_html']['sc_field_2']);
          }
          $this->NM_ajax_info['fldList']['sc_field_2'] = array(
               ...
               'colNum'  => 1,
               'optComp'  => $sOptComp,
               'optClass' => 'sc-ui-checkbox-sc_field_2',
              );
          $aLabel     = array();
          $aLabelTemp = array();
          foreach ($this->NM_ajax_info['fldList']['sc_field_2']['valList'] as $i => $v)
          {
              $this->NM_ajax_info['fldList']['sc_field_2']['valList'][$i] = form_contas_receber_criar_titulo_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_contas_receber_criar_titulo_pack_protect_string('T') => str_replace('<', '&lt;',form_contas_receber_criar_titulo_pack_protect_string("VENCIMENTO FIXO ")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_sc_field_3'][] = 'T';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['sc_field_3']['valList'][$i] = form_contas_receber_criar_titulo_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_contas_receber_criar_titulo_pack_protect_string('T') => str_replace('<', '&lt;',form_contas_receber_criar_titulo_pack_protect_string("ALTERAR COMPETENCIA")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_sc_field_4'][] = 'T';
          $aLookupOrig = $aLookup;
          $sOptComp = "";
          ...
          {
              $this->NM_ajax_info['fldList']['sc_field_4']['valList'][$i] = form_contas_receber_criar_titulo_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_contas_receber_criar_titulo_pack_protect_string('F') => str_replace('<', '&lt;',form_contas_receber_criar_titulo_pack_protect_string("A RECEBER")));
$aLookup[] = array(form_contas_receber_criar_titulo_pack_protect_string('T') => str_replace('<', '&lt;',form_contas_receber_criar_titulo_pack_protect_string("RECEBIDO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_pago'][] = 'F';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['Lookup_pago'][] = 'T';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"pago\"";
          ...
          {
              $this->NM_ajax_info['fldList']['pago']['valList'][$i] = form_contas_receber_criar_titulo_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_observacoes($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['total']))
          {
               $sc_where_pos = " WHERE ((idcontas_receber < $this->idcontas_receber))";
               if ('' != $sc_where)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idcontas_receber)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opcao'] = '';
...
;
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_contas_receber_criar_titulo';
...
$_SESSION['scriptcase']['form_contas_receber_criar_titulo']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
                  $SC_fields_update[] = "idcliente = $this->idcliente, idforma_pagamento_prevista = $this->idforma_pagamento_prevista, idgrupos_receitas = $this->idgrupos_receitas, idtipos_receitas = $this->idtipos_receitas, idnota_fiscal = $this->idnota_fiscal, data_emissao = TO_DATE('$this->data_emissao', 'yyyy-mm-dd hh24:mi:ss'), data_vencimento = TO_DATE('$this->data_vencimento', 'yyyy-mm-dd hh24:mi:ss'), valor_a_receber = $this->valor_a_receber, data_pagamento = TO_DATE('$this->data_pagamento', 'yyyy-mm-dd hh24:mi:ss'), pago = '$this->pago', competencia = '$this->competencia'"; 
              } 
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              { 
                  $comando = "UPDATE " . $this->Ini->nm_tabela . " SET ";  
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
              ...
              elseif (isset($this->idnota_fiscal)) { $this->nm_limpa_alfa($this->idnota_fiscal); }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
              {
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "idcliente, idforma_pagamento_prevista, idforma_pagamento, idgrupos_receitas, idtipos_receitas, idorcamento, idnota_fiscal, numero_conta, data_emissao, data_vencimento, valor_a_receber, data_pagamento, valor_recebido, pago, observacoes, situacao, juros, competencia, data_alteracao, taxa_administrativa, troco $compl_insert) VALUES (" . $NM_seq_auto . "$this->idcliente, $this->idforma_pagamento_prevista, $this->idforma_pagamento, $this->idgrupos_receitas, $this->idtipos_receitas, $this->idorcamento, $this->idnota_fiscal, '$this->numero_conta', TO_DATE('$this->data_emissao', 'yyyy-mm-dd hh24:mi:ss'), TO_DATE('$this->data_vencimento', 'yyyy-mm-dd hh24:mi:ss'), $this->valor_a_receber, TO_DATE('$this->data_pagamento', 'yyyy-mm-dd hh24:mi:ss'), $this->valor_recebido, '$this->pago', EMPTY_BLOB(), '$this->situacao', $this->juros, '$this->competencia', TO_DATE('$this->data_alteracao', 'yyyy-mm-dd hh24:mi:ss'), $this->taxa_administrativa, $this->troco $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
              {
                  $compl_insert     = ""; 
                  ...
                  $comando = "INSERT INTO " . $this->Ini->nm_tabela . " (" . $NM_cmp_auto . "idcliente, idforma_pagamento_prevista, idforma_pagamento, idgrupos_receitas, idtipos_receitas, idorcamento, idnota_fiscal, numero_conta, data_emissao, data_vencimento, valor_a_receber, data_pagamento, valor_recebido, pago, observacoes, situacao, juros, competencia, data_alteracao, taxa_administrativa, troco $compl_insert) VALUES (" . $NM_seq_auto . "$this->idcliente, $this->idforma_pagamento_prevista, $this->idforma_pagamento, $this->idgrupos_receitas, $this->idtipos_receitas, $this->idorcamento, $this->idnota_fiscal, '$this->numero_conta', '$this->data_emissao', '$this->data_vencimento', $this->valor_a_receber, '$this->data_pagamento', $this->valor_recebido, '$this->pago', null, '$this->situacao', $this->juros, '$this->competencia', '$this->data_alteracao', $this->taxa_administrativa, $this->troco $compl_insert_val)"; 
              }
              elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
              {
                  $compl_insert     = ""; 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['parms'] = "idcontas_receber?#?$this->idcontas_receber?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
          { 
              $nmgp_select = "SELECT idcontas_receber, idcliente, idforma_pagamento_prevista, idforma_pagamento, idgrupos_receitas, idtipos_receitas, idorcamento, idnota_fiscal, numero_conta, TO_DATE(TO_CHAR(data_emissao, 'yyyy-mm-dd hh24:mi:ss'), 'yyyy-mm-dd hh24:mi:ss'), TO_DATE(TO_CHAR(data_vencimento, 'yyyy-mm-dd hh24:mi:ss'), 'yyyy-mm-dd hh24:mi:ss'), valor_a_receber, TO_DATE(TO_CHAR(data_pagamento, 'yyyy-mm-dd hh24:mi:ss'), 'yyyy-mm-dd hh24:mi:ss'), valor_recebido, pago, observacoes, situacao, juros, competencia, TO_DATE(TO_CHAR(data_insercao, 'yyyy-mm-dd hh24:mi:ss'), 'yyyy-mm-dd hh24:mi:ss'), TO_DATE(TO_CHAR(data_alteracao, 'yyyy-mm-dd hh24:mi:ss'), 'yyyy-mm-dd hh24:mi:ss'), taxa_administrativa, troco from " . $this->Ini->nm_tabela ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_informix))
          { 
              $nmgp_select = "SELECT idcontas_receber, idcliente, idforma_pagamento_prevista, idforma_pagamento, idgrupos_receitas, idtipos_receitas, idorcamento, idnota_fiscal, numero_conta, data_emissao, data_vencimento, valor_a_receber, data_pagamento, valor_recebido, pago, LOTOFILE(observacoes, '" . $this->Ini->root . $this->Ini->path_imag_temp . "/sc_blob_observacoes', 'client'), situacao, juros, competencia, data_insercao, data_alteracao, taxa_administrativa, troco from " . $this->Ini->nm_tabela ; 
          } 
          else 
          { 
              $nmgp_select = "SELECT idcontas_receber, idcliente, idforma_pagamento_prevista, idforma_pagamento, idgrupos_receitas, idtipos_receitas, idorcamento, idnota_fiscal, numero_conta, data_emissao, data_vencimento, valor_a_receber, data_pagamento, valor_recebido, pago, observacoes, situacao, juros, competencia, data_insercao, data_alteracao, taxa_administrativa, troco from " . $this->Ini->nm_tabela ; 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['empty_filter'] = true;
                  return; 
              }
          ...
          { 
              ...
              { 
                  ...
                  { 
                     $this->observacoes = file_get_contents($rs->fields[15]);
                  }else 
                  { 
                     $this->observacoes = ''; 
                  } 
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dados_select'] = $this->nmgp_dados_select;
...
//-- 
      ...
      { 
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
$procedure_fields = array(  
	 ...
	 "'".$this->idorcamento ."'",
	 "'".$this->idnota_fiscal ."'",
	 "'A".sprintf("%06s",$v_idcontas_receber)."-".$i."'",
	 "'".$this->data_emissao ."'",
	 "'".$v_vencimento."'",
...
; 
	$this->data_pagamento  = date('Ymd');
}

$modificado_pago = $this->pago;
$modificado_data_pagamento = $this->data_pagamento;
$this->nm_formatar_campos('pago', 'data_pagamento');
...
{
    $this->ajax_return_values_idnota_fiscal(true);
}
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_contas_receber_criar_titulo_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['csrf_token'];
    }
...
{ 
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['empty_filter']);
      ...
      foreach ($fields as $field) {
          ...
          {
              $data_lookup = $this->SC_lookup_idtipos_receitas($arg_search, $data_search);
              if (is_array($data_lookup) && !empty($data_lookup)) 
              {
                  $this->SC_monta_condicao($comando, "idtipos_receitas", $arg_search, $data_lookup, "INT", false);
              }
          }
          if ($field == "SC_all_Cmp" || $field == "idnota_fiscal") 
          {
              $this->SC_monta_condicao($comando, "idnota_fiscal", $arg_search, str_replace(",", ".", $data_search), "INT", false);
          }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_contas_receber_criar_titulo = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['total'] = $qt_geral_reg_form_contas_receber_criar_titulo;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_contas_receber_criar_titulo_pack_ajax_response();
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_contas_receber_criar_titulo_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_contas_receber_criar_titulo_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['mostra_cab']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['mostra_cab'] == "N") {
            return;
        }
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo']['ordem_ord'] == " desc") {
