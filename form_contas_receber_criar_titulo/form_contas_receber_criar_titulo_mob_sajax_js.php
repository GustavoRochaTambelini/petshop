  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_contas_receber_criar_titulo_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_contas_receber_criar_titulo_mob_form();
	}
...
?>
  ...
  // ---------- Validate idcontas_receber
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_idcontas_receber()
  {
    var nomeCampo_idcontas_receber = "idcontas_receber";
    var var_idcontas_receber = scAjaxGetFieldHidden(nomeCampo_idcontas_receber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_idcontas_receber(var_idcontas_receber, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_idcontas_receber_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_idcontas_receber

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_idcontas_receber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idcontas_receber";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_idcontas_receber_cb

  // ---------- Validate idcliente
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_idcliente()
  {
    var nomeCampo_idcliente = "idcliente";
    var var_idcliente = scAjaxGetFieldSelect(nomeCampo_idcliente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_idcliente(var_idcliente, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_idcliente_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_idcliente

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_idcliente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_idcliente_cb

  // ---------- Validate competencia
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_competencia()
  {
    var nomeCampo_competencia = "competencia";
    var var_competencia = scAjaxGetFieldText(nomeCampo_competencia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_competencia(var_competencia, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_competencia_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_competencia

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_competencia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "competencia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_competencia_cb

  // ---------- Validate valor_a_receber
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_valor_a_receber()
  {
    var nomeCampo_valor_a_receber = "valor_a_receber";
    var var_valor_a_receber = scAjaxGetFieldText(nomeCampo_valor_a_receber);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_valor_a_receber(var_valor_a_receber, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_valor_a_receber_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_valor_a_receber

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_valor_a_receber_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor_a_receber";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_valor_a_receber_cb

  // ---------- Validate idforma_pagamento_prevista
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_idforma_pagamento_prevista()
  {
    var nomeCampo_idforma_pagamento_prevista = "idforma_pagamento_prevista";
    var var_idforma_pagamento_prevista = scAjaxGetFieldSelect(nomeCampo_idforma_pagamento_prevista);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_idforma_pagamento_prevista(var_idforma_pagamento_prevista, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_idforma_pagamento_prevista_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_idforma_pagamento_prevista

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_idforma_pagamento_prevista_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idforma_pagamento_prevista";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_idforma_pagamento_prevista_cb

  // ---------- Validate idgrupos_receitas
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_idgrupos_receitas()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_idgrupos_receitas(var_idgrupos_receitas, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_idgrupos_receitas_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_idgrupos_receitas

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_idgrupos_receitas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_idgrupos_receitas_cb

  // ---------- Validate idtipos_receitas
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_idtipos_receitas()
  {
    var nomeCampo_idtipos_receitas = "idtipos_receitas";
    var var_idtipos_receitas = scAjaxGetFieldSelect(nomeCampo_idtipos_receitas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_idtipos_receitas(var_idtipos_receitas, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_idtipos_receitas_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_idtipos_receitas

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_idtipos_receitas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idtipos_receitas";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_idtipos_receitas_cb

  // ---------- Validate idnota_fiscal
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_idnota_fiscal()
  {
    var nomeCampo_idnota_fiscal = "idnota_fiscal";
    var var_idnota_fiscal = scAjaxGetFieldText(nomeCampo_idnota_fiscal);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_idnota_fiscal(var_idnota_fiscal, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_idnota_fiscal_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_idnota_fiscal

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_idnota_fiscal_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idnota_fiscal";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_idnota_fiscal_cb

  // ---------- Validate data_emissao
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_data_emissao()
  {
    var nomeCampo_data_emissao = "data_emissao";
    var var_data_emissao = scAjaxGetFieldText(nomeCampo_data_emissao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_data_emissao(var_data_emissao, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_data_emissao_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_data_emissao

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_data_emissao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_emissao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_data_emissao_cb

  // ---------- Validate data_vencimento
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_data_vencimento()
  {
    var nomeCampo_data_vencimento = "data_vencimento";
    var var_data_vencimento = scAjaxGetFieldText(nomeCampo_data_vencimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_data_vencimento(var_data_vencimento, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_data_vencimento_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_data_vencimento

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_data_vencimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_vencimento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_data_vencimento_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_0_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_0

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_0_cb

  // ---------- Validate sc_field_1
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_1()
  {
    var nomeCampo_sc_field_1 = "sc_field_1";
    var var_sc_field_1 = scAjaxGetFieldText(nomeCampo_sc_field_1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_1(var_sc_field_1, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_1_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_1

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_1_cb

  // ---------- Validate sc_field_2
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_2()
  {
    var nomeCampo_sc_field_2 = "sc_field_2";
    var var_sc_field_2 = scAjaxGetFieldCheckbox(nomeCampo_sc_field_2, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_2(var_sc_field_2, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_2_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_2

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_2_cb

  // ---------- Validate sc_field_3
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_3()
  {
    var nomeCampo_sc_field_3 = "sc_field_3";
    var var_sc_field_3 = scAjaxGetFieldCheckbox(nomeCampo_sc_field_3, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_3(var_sc_field_3, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_3_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_3

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_3_cb

  // ---------- Validate sc_field_4
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_4()
  {
    var nomeCampo_sc_field_4 = "sc_field_4";
    var var_sc_field_4 = scAjaxGetFieldCheckbox(nomeCampo_sc_field_4, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_4(var_sc_field_4, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_4_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_4

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_4_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_sc_field_4_cb

  // ---------- Validate pago
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_pago()
  {
    var nomeCampo_pago = "pago";
    var var_pago = scAjaxGetFieldSelect(nomeCampo_pago);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_pago(var_pago, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_pago_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_pago

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_pago_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pago";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_pago_cb

  // ---------- Validate data_pagamento
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_data_pagamento()
  {
    var nomeCampo_data_pagamento = "data_pagamento";
    var var_data_pagamento = scAjaxGetFieldText(nomeCampo_data_pagamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_data_pagamento(var_data_pagamento, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_data_pagamento_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_data_pagamento

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_data_pagamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "data_pagamento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_data_pagamento_cb

  // ---------- Validate observacoes
  function do_ajax_form_contas_receber_criar_titulo_mob_validate_observacoes()
  {
    var nomeCampo_observacoes = "observacoes";
    var var_observacoes = scAjaxGetFieldText(nomeCampo_observacoes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_contas_receber_criar_titulo_mob_validate_observacoes(var_observacoes, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_validate_observacoes_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_observacoes

  function do_ajax_form_contas_receber_criar_titulo_mob_validate_observacoes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_validate_observacoes_cb

  // ---------- Refresh idgrupos_receitas
  function do_ajax_form_contas_receber_criar_titulo_mob_refresh_idgrupos_receitas()
  {
    var var_idgrupos_receitas = scAjaxGetFieldSelect("idgrupos_receitas");
    var var_nmgp_refresh_fields = "idtipos_receitas";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_contas_receber_criar_titulo_mob_refresh_idgrupos_receitas(var_idgrupos_receitas, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_refresh_idgrupos_receitas_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_refresh_idgrupos_receitas

  function do_ajax_form_contas_receber_criar_titulo_mob_refresh_idgrupos_receitas_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_contas_receber_criar_titulo_mob_refresh_idgrupos_receitas_cb

  // ---------- Event onchange pago
  function do_ajax_form_contas_receber_criar_titulo_mob_event_pago_onchange()
  {
    var var_pago = scAjaxGetFieldSelect("pago");
    var var_data_pagamento = scAjaxGetFieldText("data_pagamento");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_contas_receber_criar_titulo_mob_event_pago_onchange(var_pago, var_data_pagamento, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_event_pago_onchange_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_event_pago_onchange

  function do_ajax_form_contas_receber_criar_titulo_mob_event_pago_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "pago";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contas_receber_criar_titulo_mob_event_pago_onchange_cb_after_alert);
  } // do_ajax_form_contas_receber_criar_titulo_mob_event_pago_onchange_cb
  function do_ajax_form_contas_receber_criar_titulo_mob_event_pago_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_contas_receber_criar_titulo_mob_event_pago_onchange_cb_after_alert

  // ---------- Event onclick scajaxbutton_salvar
  function do_ajax_form_contas_receber_criar_titulo_mob_event_scajaxbutton_salvar_onclick()
  {
    ...
    var var_sc_field_3 = scAjaxGetFieldCheckbox("sc_field_3", ";");
    var var_sc_field_1 = scAjaxGetFieldText("sc_field_1");
    var var_sc_field_4 = scAjaxGetFieldCheckbox("sc_field_4", ";");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_contas_receber_criar_titulo_mob_event_scajaxbutton_salvar_onclick(var_idcliente, var_competencia, var_valor_a_receber, var_idgrupos_receitas, var_pago, var_data_pagamento, var_sc_field_2, var_sc_field_0, var_data_vencimento, var_idforma_pagamento_prevista, var_idtipos_receitas, var_idnota_fiscal, var_data_emissao, var_observacoes, var_sc_field_3, var_sc_field_1, var_sc_field_4, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_event_scajaxbutton_salvar_onclick_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_event_scajaxbutton_salvar_onclick

  function do_ajax_form_contas_receber_criar_titulo_mob_event_scajaxbutton_salvar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "scajaxbutton_salvar";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_contas_receber_criar_titulo_mob_event_scajaxbutton_salvar_onclick_cb_after_alert);
  } // do_ajax_form_contas_receber_criar_titulo_mob_event_scajaxbutton_salvar_onclick_cb
  function do_ajax_form_contas_receber_criar_titulo_mob_event_scajaxbutton_salvar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_contas_receber_criar_titulo_mob_event_scajaxbutton_salvar_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_contas_receber_criar_titulo_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_contas_receber_criar_titulo_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idcontas_receber = scAjaxGetFieldHidden("idcontas_receber");
    var var_idcliente = scAjaxGetFieldSelect("idcliente");
    var var_competencia = scAjaxGetFieldText("competencia");
    var var_valor_a_receber = scAjaxGetFieldText("valor_a_receber");
    var var_idforma_pagamento_prevista = scAjaxGetFieldSelect("idforma_pagamento_prevista");
    ...
    scAjaxProcOn();
    x_ajax_form_contas_receber_criar_titulo_mob_submit_form(var_idcontas_receber, var_idcliente, var_competencia, var_valor_a_receber, var_idforma_pagamento_prevista, var_idgrupos_receitas, var_idtipos_receitas, var_idnota_fiscal, var_data_emissao, var_data_vencimento, var_sc_field_0, var_sc_field_1, var_sc_field_2, var_sc_field_3, var_sc_field_4, var_pago, var_data_pagamento, var_observacoes, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contas_receber_criar_titulo_mob_submit_form_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_submit_form

  function do_ajax_form_contas_receber_criar_titulo_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("idcontas_receber");
      ...
      scAjaxHideErrorDisplay("data_vencimento");
      ...
      scAjaxHideErrorDisplay("pago");
      scAjaxHideErrorDisplay("data_pagamento");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_contas_receber_criar_titulo_mob_submit_form_cb_after_alert);
  } // do_ajax_form_contas_receber_criar_titulo_mob_submit_form_cb
  function do_ajax_form_contas_receber_criar_titulo_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_contas_receber_criar_titulo_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_contas_receber_criar_titulo_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_contas_receber_criar_titulo_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_contas_receber_criar_titulo_mob_navigate_form();
    }
  }

  function perform_ajax_form_contas_receber_criar_titulo_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("data_pagamento");
    scAjaxHideErrorDisplay("observacoes");
    var var_idcontas_receber = document.F2.idcontas_receber.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_contas_receber_criar_titulo_mob_navigate_form(var_idcontas_receber, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_navigate_form_cb);
  } // do_ajax_form_contas_receber_criar_titulo_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_contas_receber_criar_titulo_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_contas_receber_criar_titulo_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idcontas_receber.value = scAjaxGetKeyValue("idcontas_receber");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_contas_receber_criar_titulo_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_contas_receber_criar_titulo_mob_navigate_form_cb
  function do_ajax_form_contas_receber_criar_titulo_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_contas_receber_criar_titulo_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_contas_receber_criar_titulo_mob_navigate_form_cb_after_alert

  function sc_hide_form_contas_receber_criar_titulo_mob_form()
  {
  ...
  ajax_field_list[0] = "idcontas_receber";
  ...
  var ajax_error_list = {
    "idcontas_receber": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "data_vencimento": {"label": "DATA DE VENCIMENTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_0": {"label": "PARCELAS", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_1": {"label": "INTERVALO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "pago": {"label": "STATUS PAGAMENTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "data_pagamento": {"label": "DATA RECEBIMENTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "pago": new Array(),
    "data_pagamento": new Array(),
    "observacoes": new Array()
  };
  ajax_field_mult["idcontas_receber"][1] = "idcontas_receber";
  ...
  ajax_field_mult["data_vencimento"][1] = "data_vencimento";
  ...
  ajax_field_mult["pago"][1] = "pago";
  ajax_field_mult["data_pagamento"][1] = "data_pagamento";
  ajax_field_mult["observacoes"][1] = "observacoes";

  var ajax_field_id = {
    "idcontas_receber": new Array("hidden_field_label_idcontas_receber", "hidden_field_data_idcontas_receber"),
    ...
    "data_vencimento": new Array("hidden_field_label_data_vencimento", "hidden_field_data_data_vencimento"),
    ...
    "pago": new Array("hidden_field_label_pago", "hidden_field_data_pago"),
    "data_pagamento": new Array("hidden_field_label_data_pagamento", "hidden_field_data_data_pagamento"),
