...
?>
  ...
  function do_ajax_form_contas_receber_criar_titulo_mob_event_scajaxbutton_salvar_onclick()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_contas_receber_criar_titulo_mob_event_scajaxbutton_salvar_onclick(var_idcliente, var_competencia, var_valor_a_receber, var_pago, var_data_pagamento, var_idtipos_receitas, var_sc_field_2, var_sc_field_0, var_data_vencimento, var_idforma_pagamento_prevista, var_idnota_fiscal, var_data_emissao, var_observacoes, var_sc_field_3, var_sc_field_1, var_sc_field_4, var_script_case_init, do_ajax_form_contas_receber_criar_titulo_mob_event_scajaxbutton_salvar_onclick_cb);
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_form_contas_receber_criar_titulo_mob_submit_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_contas_receber_criar_titulo_mob_submit_form(var_idcontas_receber, var_idcliente, var_competencia, var_valor_a_receber, var_idforma_pagamento_prevista, var_idtipos_receitas, var_idnota_fiscal, var_data_emissao, var_data_vencimento, var_sc_field_0, var_sc_field_1, var_sc_field_2, var_sc_field_3, var_sc_field_4, var_pago, var_data_pagamento, var_observacoes, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_contas_receber_criar_titulo_mob_submit_form_cb);
