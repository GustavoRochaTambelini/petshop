<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt"))
       {
?>
...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['idfinanceiro'] = "on";
   $tab_def_campos['idfinanceiro'] = "idfinanceiro";
   $tab_labels["idfinanceiro"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["idfinanceiro"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["idfinanceiro"] : "Idfinanceiro";
   $tab_ger_campos['idorcamento'] = "on";
   $tab_def_campos['idorcamento'] = "idorcamento";
   $tab_labels["idorcamento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["idorcamento"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["idorcamento"] : "Idorcamento";
   $tab_ger_campos['idcompra_venda'] = "on";
   $tab_def_campos['idcompra_venda'] = "idcompra_venda";
   $tab_labels["idcompra_venda"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["idcompra_venda"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["idcompra_venda"] : "Idcompra Venda";
   $tab_ger_campos['forma_pagamento'] = "on";
   $tab_def_campos['forma_pagamento'] = "forma_pagamento";
   $tab_labels["forma_pagamento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["forma_pagamento"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["forma_pagamento"] : "Forma Pagamento";
   ...
   $tab_labels["data_vencimento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["data_vencimento"])) ? $_SESSION['sc_session'][$sc_init]['grid_financeiro']['labels']["data_vencimento"] : "Data Vencimento";
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_financeiro']['ordem_quebra'] as $campo_quebra => $resto) 
               {
