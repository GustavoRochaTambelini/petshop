<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_financeiro']['glo_nm_perfil']          = "conn_amazonrds_mysql";
   $_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_prod']       = "";
   $_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_conf']       = "";
   $_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_imagens']    = "";
   $_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_imag_temp']  = "";
   $_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_cache']      = "";
   $_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_doc']        = "";
    ...
    //check cache
    if(empty($_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
...
// 
      ...
      $this->path_cache  = $_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_cache'];
      ...
      if (!isset($_SESSION['scriptcase']['grid_financeiro']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['grid_financeiro']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['grid_financeiro']['save_session']['data'] = '';
      } 
      ...
      $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
    ...
    $out1_img_cache = $_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if (!$_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['embutida'])
    {
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['grid_search_add']['cmp'] = $_POST['parm'];
          $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['grid_search_add']['seq'] = $_POST['seq'];
          $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['opcao'] = $_POST['origem'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['dashboard_info']['under_dashboard']))
      {
          ...
          $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              ...
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              ...
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      ...
      if ($_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['dashboard_info']['under_dashboard'])
      {
        ...
        if (isset($link_compact_mode) && 'ok' == $link_compact_mode) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['link_info']['compact_mode'] = true;
        }
        if (isset($link_remove_margin) && 'ok' == $link_remove_margin) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['link_info']['remove_margin'] = true;
        }
        if (isset($link_remove_border) && 'ok' == $link_remove_border) {
            if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['link_info'])) {
                $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['link_info'] = array();
            }
            $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['link_info']['remove_border'] = true;
        }

      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['responsive_chart']))
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['responsive_chart'] = array(
              'enabled' => false,
              'active'  => false,
          );
      }
      if ($_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['responsive_chart']['enabled'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['responsive_chart']['active'] = true;
      }
      elseif ($_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['dashboard_info']['maximized'])
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['responsive_chart']['active'] = true;
      }
      else
      {
          $_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['responsive_chart']['active'] = false;
      }
      if ($Tp_init == "Path_sub")
      {
          return;
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_financeiro']['glo_nm_conexao'], $this->root . $this->path_prod, 'petshop', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['embutida']) || !$_SESSION['sc_session'][$this->sc_page]['grid_financeiro']['embutida'])
      {
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['embutida_ibase'])) 
      { 
          $this->Ini = new grid_financeiro_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['embutida_ibase'] = true;
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'])) {
      ...
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['sc_modal']))
      {
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_financeiro']))
          {
               ...
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_financeiro']['label'] = "FINANCEIRO";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              ...
              if (($_POST['opc'] == "igual" || $_POST['opc'] == "resumo") && isset($_POST['parm']) && ($_POST['parm'] == "reload" || $_POST['parm'] == "breload"))
              {
                  ...
                  $_SESSION['sc_session'][$script_case_init]['grid_financeiro']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['pivot_tabular']);
              }
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['pdf_det'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] = 'pdf';
          $_SESSION['sc_session'][$script_case_init]['grid_financeiro']['opc_pdf']['pdf_zip'] = (isset($Det_pdf_zip) && !empty($Det_pdf_zip)) ? $Det_pdf_zip : "N";
          if ($Det_use_pass_pdf != "__APL__")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['use_pass_pdf'] = $Det_use_pass_pdf;
          } 
          $nmgp_opcao = 'pdf';
      }
      if ($nmgp_opcao == 'pdf')
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['pdf_res'] = false;
      if ($nmgp_opcao == 'pdf_res')
      {
          ...
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['pdf_res'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] = 'pdf';
              $nmgp_opcao = 'pdf';
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['field_order'][] = "idfinanceiro";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['field_order'][] = "idorcamento";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['field_order'][] = "idcompra_venda";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['field_order'][] = "forma_pagamento";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['field_order'][] = "valor";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['field_order'][] = "data_vencimento";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_orig'])))
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['det_print'] = "";
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "det_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao']     = "detalhe";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['det_print'] = "print";
          if (!empty($nmgp_password)) {
          ...
          {
              $this->Ini->Export_img_zip = true;
              $nm_arquivo_html = "/sc_grid_financeiro_det_" . session_id() . ".html";
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_html);
          }
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "grid_search" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "grid_search_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "grid_search")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "grid_search_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['orig_pesq'] = 'res';
          } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "grid_search_change_fil" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "grid_search_change_fil_res")
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "grid_search_change_fil")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['orig_pesq'] = 'grid';
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "grid_search_change_fil_res")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['orig_pesq'] = 'res';
          } 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
...
//
      ...
      { 
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_pesq_grid']   = "";
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_pesq_lookup'] = "";
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_grid_financeiro.pdf";
...
//----------------------------------->
      ...
      { 
          ...
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['word_name'] .= ".doc";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "xls_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_financeiro/grid_financeiro_res_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_financeiro_res_xls.class.php"); 
          } 
          $this->xls  = new grid_financeiro_res_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "xml_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_financeiro/grid_financeiro_res_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_financeiro_res_xml.class.php"); 
          } 
          $this->xml  = new grid_financeiro_res_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "json_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_financeiro/grid_financeiro_res_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_financeiro_res_json.class.php"); 
          } 
          $this->json  = new grid_financeiro_res_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "csv_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_financeiro/grid_financeiro_res_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_financeiro_res_csv.class.php"); 
          } 
          $this->csv  = new grid_financeiro_res_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "rtf_res")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "grid_financeiro/grid_financeiro_res_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "grid_financeiro_res_rtf.class.php"); 
          } 
          $this->rtf  = new grid_financeiro_res_rtf();
          $this->prep_modulos("rtf");
          $this->rtf->monta_rtf();
      }
      else
      ...
      { 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['opcao'] == "detalhe" || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['pdf_det'])  
          { 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['embutida'])
              { 
                  require_once($this->Ini->path_embutida . "grid_financeiro/grid_financeiro_det.class.php"); 
              } 
              else 
              { 
                  require_once($this->Ini->path_aplicacao . "grid_financeiro_det.class.php"); 
              } 
              $this->det  = new grid_financeiro_det();
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if (!$this->Ini->sc_export_ajax && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    grid_financeiro_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . $this->grid->progress_tot . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
            ...
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['pdf_name'], 1);
                }
            ...
            if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['pdf_det'])
            {
                if (-1 < $this->grid->progress_grid && $this->grid->progress_fp)
                {
                    ...
                    if ($this->grid->progress_fp)
                    {
                        ...
                        grid_financeiro_pdf_progress_call($this->grid->progress_tot . "_#NM#_" . ($this->grid->progress_now + 1 + $this->grid->progress_pdf) . "_#NM#_" . $lang_protect . "...\n", $this->Ini->Nm_lang);
                        grid_financeiro_pdf_progress_call("off\n", $this->Ini->Nm_lang);
...
$NM_volta  = "volta_grid";
$NM_target = "_parent";
if ($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['pdf_res'])
{
  $NM_volta  = "resumo";
  $NM_target = "_self";
?>
...
<?php
                    ...
                    fwrite($rRFP, "off\n");
                    fclose($rRFP);
$downloadFileName = "grid_financeiro.pdf";
if ($this->pdf_zip == 'S') {
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro'][md5("newpdf_" . $downloadFileName)][0] = $nm_arquivo_pdf_url;
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro'][md5("newpdf_" . $downloadFileName)][1] = $downloadFileName;
}
  ...
  function close_emb()
  {
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      foreach ($fields as $field) {
          if ($field == "SC_all_Cmp" || $field == "idfinanceiro") 
          {
              $this->SC_monta_condicao($comando, "idfinanceiro", $arg_search, str_replace(",", ".", $data_search));
          }
          if ($field == "SC_all_Cmp" || $field == "idorcamento") 
          {
              $this->SC_monta_condicao($comando, "idorcamento", $arg_search, str_replace(",", ".", $data_search));
          }
          if ($field == "SC_all_Cmp" || $field == "idcompra_venda") 
          {
              $this->SC_monta_condicao($comando, "idcompra_venda", $arg_search, str_replace(",", ".", $data_search));
          }
          if ($field == "SC_all_Cmp" || $field == "forma_pagamento") 
          {
              $this->SC_monta_condicao($comando, "forma_pagamento", $arg_search, str_replace(",", ".", $data_search));
          }
          ...
          {
              $this->SC_monta_condicao($comando, "data_vencimento", $arg_search, $data_search, "DATE", false);
          }
      }
      if (empty($comando)) 
      {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['fast_search'][0] = $in_fields;
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas['data_vencimento'] = "date";$Nm_datas['data_pagamento'] = "date";
   ...
   function SC_proc_grid_search($Parms)
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['tmp_busca'] = array();
       foreach ($tmp as $cada_f)
       {
           $dats = explode("_DYN_", $cada_f);
           if ($dats[1] == "del_grid_search_all")
           {
               foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'] as $ind => $dados)
               {
                   $this->proc_del_grid_search($ind, true);
               }
               unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq']);
               continue;
           }
           ...
           {
               $busca[$dats[0]] = $dats[1];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['tmp_busca'][$dats[0]] = (isset($fields[$ix]['vls'][0])) ? $fields[$ix]['vls'][0][0] : "";
               if (isset($fields[$ix]['vls'][1]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['tmp_busca'][$dats[0] . '_input_2'] = $fields[$ix]['vls'][1][0];
               }
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['tmp_busca'][$dats[0] . '_cond'] = $dats[1];
           }
           $ix++;
      }
      if ($_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['tmp_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['tmp_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['tmp_busca'] as $ind => $dados)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca'][$ind] = $dados;
      }
      if (!$_SESSION['scriptcase']['proc_mobile']) 
      { 
          require_once($this->Ini->path_aplicacao . "grid_financeiro_pesq.class.php"); 
   ...
   {
      if (is_array($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca'][$cmp_del]))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca'][$cmp_del] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca'][$cmp_del . "_input_2"] = array();
      }
      else
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca'][$cmp_del] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca'][$cmp_del . "_input_2"] = "";
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca'][$cmp_del . "_cond"] = "";
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$cmp_del]);
   }
...
<?php
 ...
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro'][$path_doc_md5][0] = $nm_arquivo_pdf_det;
 $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro'][$path_doc_md5][1] = "grid_financeiro_det.pdf";
?>
 <link rel="shortcut icon" href="../_lib/img/scriptcase__NM__ico__NM__favicon.ico">
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export.css" /> 
  <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_all ?>_export<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
...
//======= =========================
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['grid_financeiro']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt"));
       }
       if (isset($apl_def)) {
           ...
           if (isset($_COOKIE['sc_actual_lang_petshop'])) {
               $_SESSION['scriptcase']['grid_financeiro']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_petshop'];
           }
       }
   }
   ...
   if (isset($_SESSION['scriptcase']['grid_financeiro']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['grid_financeiro']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc8_BlueWood/Sc8_BlueWood";
   ...
   { 
       ...
       if ($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['opcao'] == "detalhe" && isset($nmgp_chave_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_financeiro']['chave_det'] = $nmgp_chave_det;
           $_SESSION['sc_session'][$script_case_init]['grid_financeiro']['cmp_acum']  = $nmgp_parm_acum;
       }   
       if (isset($Sc_seq_det))  
       { 
           $_SESSION['sc_session'][$script_case_init]['grid_financeiro']['Sc_seq_det'] = $Sc_seq_det;
       } 
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['mostra_edit'])) 
       {
           $_SESSION['sc_session'][$script_case_init]['grid_financeiro']['mostra_edit'] = "S";
       }
       ...
       $nm_saida = "";
       if (!isset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['sc_modal']))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_financeiro']['sc_modal'] = false;
       }
...
// 
       ...
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['grid_financeiro']['psq_edit'] = 'N';   
           if (isset($nmgp_perm_edit)) {
               $_SESSION['sc_session'][$script_case_init]['grid_financeiro']['psq_edit'] = $nmgp_perm_edit;
           }
       } 
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['grid_financeiro']['opc_psq'] && !isset($_SESSION['scriptcase']['grid_financeiro']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['grid_financeiro']) || $_SESSION['scriptcase']['sc_apl_seg']['grid_financeiro'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['iframe_menu']) ? false : true;
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['embutida']) && $_SESSION['sc_session'][$script_case_init]['grid_financeiro']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['grid_financeiro']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['grid_financeiro']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
?>
...
//
   ...
   function nm_protect_num_grid_financeiro($name, &$val)
   {
       ...
       $Nm_numeric = array();
       $Nm_numeric[] = "idfinanceiro";
       $Nm_numeric[] = "idorcamento";
       $Nm_numeric[] = "idcompra_venda";
       $Nm_numeric[] = "forma_pagamento";
       $Nm_numeric[] = "valor";
   ...
   function grid_financeiro_pack_protect_string($sString)
   {
    ...
    function grid_financeiro_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
...
<?php
        global $script_case_init;
        if ($flushBuffer && $_SESSION['sc_session'][$script_case_init]['grid_financeiro']['opcao'] != 'print') {
            $bufferSize = @ini_get('output_buffering');
            if ('' != $bufferSize) {
