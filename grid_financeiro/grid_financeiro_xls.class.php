...
class grid_financeiro_xls
{
   ...
   function inicializa_vars()
   {
      ...
      { 
          ...
          if (!is_file($this->Ini->root . $this->Ini->path_link . "grid_financeiro/grid_financeiro_res_xls.class.php"))
          {
              $this->Tem_xls_res  = false;
          }
          if ($this->Tem_xls_res)
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['xls_name']))
      {
          ...
          if ($Pos === false) {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['xls_name'] .= $this->Xls_tp;
          }
   ...
   function NM_export_idfinanceiro()
   {
         ...
         if (is_numeric($this->idfinanceiro))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->idfinanceiro);
         $this->Xls_col++;
   }
   //----- idorcamento
   ...
   function NM_export_idcompra_venda()
   {
         ...
         if (is_numeric($this->idcompra_venda))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->idcompra_venda);
         $this->Xls_col++;
   }
   //----- forma_pagamento
   function NM_export_forma_pagamento()
   {
         ...
         if (is_numeric($this->forma_pagamento))
         {
             $this->NM_ctrl_style[$current_cell_ref]['format'] = '#,##0';
         }
         $this->Nm_ActiveSheet->setCellValue($current_cell_ref . $this->Xls_row, $this->forma_pagamento);
         $this->Xls_col++;
   }
   //----- valor
   ...
   //----- idfinanceiro
   function NM_sub_cons_idfinanceiro()
   {
         $this->idfinanceiro = NM_charset_to_utf8($this->idfinanceiro);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->idfinanceiro;
   ...
   //----- idcompra_venda
   function NM_sub_cons_idcompra_venda()
   {
         $this->idcompra_venda = NM_charset_to_utf8($this->idcompra_venda);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->idcompra_venda;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
   ...
   //----- forma_pagamento
   function NM_sub_cons_forma_pagamento()
   {
         $this->forma_pagamento = NM_charset_to_utf8($this->forma_pagamento);
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['data']   = $this->forma_pagamento;
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['align']  = "right";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['type']   = "num";
         $this->arr_export['lines'][$this->Xls_row][$this->Xls_col]['format'] = "#,##0";
         $this->Xls_col++;
