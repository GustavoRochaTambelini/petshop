...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_datas[] = "data_vencimento";$Nm_datas[] = "data_pagamento";$Nm_numeric[] = "idfinanceiro";$Nm_numeric[] = "idorcamento";$Nm_numeric[] = "idcompra_venda";$Nm_numeric[] = "forma_pagamento";$Nm_numeric[] = "valor";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idfinanceiro_cond" name="idfinanceiro_cond" onChange="nm_campos_between(document.getElementById('id_vis_idfinanceiro'), this, 'idfinanceiro')">
      ...
      <br><span id="id_hide_idfinanceiro"  <?php echo $str_hide_idfinanceiro?>><INPUT  type="text" id="SC_idfinanceiro" name="idfinanceiro" value="<?php echo NM_encode_input($idfinanceiro) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_idorcamento_cond" name="idorcamento_cond" onChange="nm_campos_between(document.getElementById('id_vis_idorcamento'), this, 'idorcamento')">
      ...
      <br><span id="id_hide_idorcamento"  <?php echo $str_hide_idorcamento?>><INPUT  type="text" id="SC_idorcamento" name="idorcamento" value="<?php echo NM_encode_input($idorcamento) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_idcompra_venda_cond" name="idcompra_venda_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcompra_venda'), this, 'idcompra_venda')">
      ...
      <br><span id="id_hide_idcompra_venda"  <?php echo $str_hide_idcompra_venda?>><INPUT  type="text" id="SC_idcompra_venda" name="idcompra_venda" value="<?php echo NM_encode_input($idcompra_venda) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_forma_pagamento_cond" name="forma_pagamento_cond" onChange="nm_campos_between(document.getElementById('id_vis_forma_pagamento'), this, 'forma_pagamento')">
      ...
      <br><span id="id_hide_forma_pagamento"  <?php echo $str_hide_forma_pagamento?>><INPUT  type="text" id="SC_forma_pagamento" name="forma_pagamento" value="<?php echo NM_encode_input($forma_pagamento) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
