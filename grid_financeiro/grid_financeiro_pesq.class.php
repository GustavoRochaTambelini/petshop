          ...
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="", $tp_unaccent=false)
   {
      ...
      $Nm_numeric[] = "idfinanceiro";$Nm_numeric[] = "idorcamento";$Nm_numeric[] = "idcompra_venda";$Nm_numeric[] = "forma_pagamento";$Nm_numeric[] = "valor";
      $campo_join = strtolower(str_replace(".", "_", $nome));
      if (in_array($campo_join, $Nm_numeric))
      {
          if ($condicao == "EP" || $condicao == "NE")
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "data_vencimento";$Nm_datas[] = "data_pagamento";
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_idfinanceiro_cond#NMF#' + search_get_sel_txt('SC_idfinanceiro_cond') + '@NMF@';
  str_out += 'SC_idfinanceiro#NMF#' + search_get_text('SC_idfinanceiro') + '@NMF@';
  str_out += 'SC_idorcamento_cond#NMF#' + search_get_sel_txt('SC_idorcamento_cond') + '@NMF@';
  str_out += 'SC_idorcamento#NMF#' + search_get_text('SC_idorcamento') + '@NMF@';
  str_out += 'SC_idcompra_venda_cond#NMF#' + search_get_sel_txt('SC_idcompra_venda_cond') + '@NMF@';
  str_out += 'SC_idcompra_venda#NMF#' + search_get_text('SC_idcompra_venda') + '@NMF@';
  str_out += 'SC_forma_pagamento_cond#NMF#' + search_get_sel_txt('SC_forma_pagamento_cond') + '@NMF@';
  str_out += 'SC_forma_pagamento#NMF#' + search_get_text('SC_forma_pagamento') + '@NMF@';
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;">FINANCEIRO</div>
...
<?php
   ...
   {
      global 
             $idfinanceiro_cond, $idfinanceiro,
             $idorcamento_cond, $idorcamento,
             $idcompra_venda_cond, $idcompra_venda,
             $forma_pagamento_cond, $forma_pagamento,
      ...
      { 
          ...
          $idfinanceiro = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['idfinanceiro']; 
          $idfinanceiro_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['idfinanceiro_cond']; 
          $idorcamento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['idorcamento']; 
          $idorcamento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['idorcamento_cond']; 
          $idcompra_venda = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['idcompra_venda']; 
          $idcompra_venda_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['idcompra_venda_cond']; 
          $forma_pagamento = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['forma_pagamento']; 
          $forma_pagamento_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['forma_pagamento_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['NM_operador']; 
          if (strtoupper($idfinanceiro_cond) != "II" && strtoupper($idfinanceiro_cond) != "QP" && strtoupper($idfinanceiro_cond) != "NP" && strtoupper($idfinanceiro_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idfinanceiro, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($idorcamento_cond) != "II" && strtoupper($idorcamento_cond) != "QP" && strtoupper($idorcamento_cond) != "NP" && strtoupper($idorcamento_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idorcamento, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($idcompra_venda_cond) != "II" && strtoupper($idcompra_venda_cond) != "QP" && strtoupper($idcompra_venda_cond) != "NP" && strtoupper($idcompra_venda_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($idcompra_venda, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          if (strtoupper($forma_pagamento_cond) != "II" && strtoupper($forma_pagamento_cond) != "QP" && strtoupper($forma_pagamento_cond) != "NP" && strtoupper($forma_pagamento_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($forma_pagamento, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($idfinanceiro_cond) || empty($idfinanceiro_cond))
      {
         $idfinanceiro_cond = "gt";
      }
      if (!isset($idorcamento_cond) || empty($idorcamento_cond))
      {
         $idorcamento_cond = "gt";
      }
      if (!isset($idcompra_venda_cond) || empty($idcompra_venda_cond))
      {
         $idcompra_venda_cond = "gt";
      }
      if (!isset($forma_pagamento_cond) || empty($forma_pagamento_cond))
      {
         $forma_pagamento_cond = "gt";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_idfinanceiro = (in_array($idfinanceiro_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idorcamento = (in_array($idorcamento_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_idcompra_venda = (in_array($idcompra_venda_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_forma_pagamento = (in_array($forma_pagamento_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($idfinanceiro) || $idfinanceiro == "")
      {
          $idfinanceiro = "";
      }
      if (isset($idfinanceiro) && !empty($idfinanceiro))
      {
         $tmp_pos = (is_string($idfinanceiro)) ? strpos($idfinanceiro, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $idfinanceiro = substr($idfinanceiro, 0, $tmp_pos);
         }
      }
      if (!isset($idorcamento) || $idorcamento == "")
      {
          $idorcamento = "";
      }
      if (isset($idorcamento) && !empty($idorcamento))
      {
         $tmp_pos = (is_string($idorcamento)) ? strpos($idorcamento, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $idorcamento = substr($idorcamento, 0, $tmp_pos);
         }
      }
      if (!isset($idcompra_venda) || $idcompra_venda == "")
      {
          $idcompra_venda = "";
      }
      if (isset($idcompra_venda) && !empty($idcompra_venda))
      {
         $tmp_pos = (is_string($idcompra_venda)) ? strpos($idcompra_venda, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $idcompra_venda = substr($idcompra_venda, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = (is_string($forma_pagamento)) ? strpos($forma_pagamento, "##@@") : false;
         if ($tmp_pos === false)
         { }
         else
         {
         $forma_pagamento = substr($forma_pagamento, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_idfinanceiro_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idfinanceiro'])) ? $this->New_label['idfinanceiro'] : "Idfinanceiro"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idfinanceiro_cond" name="idfinanceiro_cond" onChange="nm_campos_between(document.getElementById('id_vis_idfinanceiro'), this, 'idfinanceiro')">
       <OPTION value="gt" <?php if ("gt" == $idfinanceiro_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idfinanceiro_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idfinanceiro_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idfinanceiro" <?php echo $str_hide_idfinanceiro?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idfinanceiro'])) ? $this->New_label['idfinanceiro'] : "Idfinanceiro";
 $nmgp_tab_label .= "idfinanceiro?#?" . $SC_Label . "?@?";
...
?>
<INPUT  type="text" id="SC_idfinanceiro" name="idfinanceiro" value="<?php echo NM_encode_input($idfinanceiro) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_idorcamento_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['idorcamento'])) ? $this->New_label['idorcamento'] : "Idorcamento"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_idorcamento_cond" name="idorcamento_cond" onChange="nm_campos_between(document.getElementById('id_vis_idorcamento'), this, 'idorcamento')">
       <OPTION value="gt" <?php if ("gt" == $idorcamento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idorcamento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idorcamento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idorcamento" <?php echo $str_hide_idorcamento?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['idorcamento'])) ? $this->New_label['idorcamento'] : "Idorcamento";
 $nmgp_tab_label .= "idorcamento?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_idorcamento" name="idorcamento" value="<?php echo NM_encode_input($idorcamento) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_idcompra_venda_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['idcompra_venda'])) ? $this->New_label['idcompra_venda'] : "Idcompra Venda"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_idcompra_venda_cond" name="idcompra_venda_cond" onChange="nm_campos_between(document.getElementById('id_vis_idcompra_venda'), this, 'idcompra_venda')">
       <OPTION value="gt" <?php if ("gt" == $idcompra_venda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $idcompra_venda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $idcompra_venda_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_idcompra_venda" <?php echo $str_hide_idcompra_venda?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['idcompra_venda'])) ? $this->New_label['idcompra_venda'] : "Idcompra Venda";
 $nmgp_tab_label .= "idcompra_venda?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_idcompra_venda" name="idcompra_venda" value="<?php echo NM_encode_input($idcompra_venda) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_forma_pagamento_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['forma_pagamento'])) ? $this->New_label['forma_pagamento'] : "Forma Pagamento"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_forma_pagamento_cond" name="forma_pagamento_cond" onChange="nm_campos_between(document.getElementById('id_vis_forma_pagamento'), this, 'forma_pagamento')">
       <OPTION value="gt" <?php if ("gt" == $forma_pagamento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $forma_pagamento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $forma_pagamento_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_forma_pagamento" <?php echo $str_hide_forma_pagamento?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['forma_pagamento'])) ? $this->New_label['forma_pagamento'] : "Forma Pagamento";
 $nmgp_tab_label .= "forma_pagamento?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_forma_pagamento" name="forma_pagamento" value="<?php echo NM_encode_input($forma_pagamento) ?>" size=10 alt="{datatype: 'integer', maxLength: 10, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['grid_financeiro']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['grid_financeiro']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['orig_pesq']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.idfinanceiro_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idfinanceiro'), document.F1.idfinanceiro_cond, 'idfinanceiro');
   document.F1.idfinanceiro.value = "";
   document.F1.idorcamento_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idorcamento'), document.F1.idorcamento_cond, 'idorcamento');
   document.F1.idorcamento.value = "";
   document.F1.idcompra_venda_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_idcompra_venda'), document.F1.idcompra_venda_cond, 'idcompra_venda');
   document.F1.idcompra_venda.value = "";
   document.F1.forma_pagamento_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_forma_pagamento'), document.F1.forma_pagamento_cond, 'forma_pagamento');
   document.F1.forma_pagamento.value = "";
 }
...
<?php
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_idfinanceiro_cond'] = 'cond';
      $tp_fields['SC_idfinanceiro'] = 'text';
      $tp_fields['SC_idorcamento_cond'] = 'cond';
      $tp_fields['SC_idorcamento'] = 'text';
      $tp_fields['SC_idcompra_venda_cond'] = 'cond';
      $tp_fields['SC_idcompra_venda'] = 'text';
      $tp_fields['SC_forma_pagamento_cond'] = 'cond';
      $tp_fields['SC_forma_pagamento'] = 'text';
   ...
   {
      global $idfinanceiro_cond, $idfinanceiro,
             $idorcamento_cond, $idorcamento,
             $idcompra_venda_cond, $idcompra_venda,
             $forma_pagamento_cond, $forma_pagamento, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $idfinanceiro_cond_salva = $idfinanceiro_cond; 
      if (!isset($idfinanceiro_input_2) || $idfinanceiro_input_2 == "")
      {
          $idfinanceiro_input_2 = $idfinanceiro;
      }
      $idorcamento_cond_salva = $idorcamento_cond; 
      if (!isset($idorcamento_input_2) || $idorcamento_input_2 == "")
      {
          $idorcamento_input_2 = $idorcamento;
      }
      $idcompra_venda_cond_salva = $idcompra_venda_cond; 
      if (!isset($idcompra_venda_input_2) || $idcompra_venda_input_2 == "")
      {
          $idcompra_venda_input_2 = $idcompra_venda;
      }
      $forma_pagamento_cond_salva = $forma_pagamento_cond; 
      if (!isset($forma_pagamento_input_2) || $forma_pagamento_input_2 == "")
      {
          $forma_pagamento_input_2 = $forma_pagamento;
      }
      if ($idfinanceiro_cond != "in")
      {
          nm_limpa_numero($idfinanceiro, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idorcamento_cond != "in")
      {
          nm_limpa_numero($idorcamento, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($idcompra_venda_cond != "in")
      {
          nm_limpa_numero($idcompra_venda, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($forma_pagamento_cond != "in")
      {
          nm_limpa_numero($forma_pagamento, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['idfinanceiro'] = $idfinanceiro; 
      if (is_array($idfinanceiro) && !empty($idfinanceiro))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['val'][0] = $idfinanceiro;
      }
      elseif ($idfinanceiro_cond_salva == "nu" || $idfinanceiro_cond_salva == "nn" || $idfinanceiro_cond_salva == "ep" || $idfinanceiro_cond_salva == "ne" || !empty($idfinanceiro))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['val'][0][0] = $idfinanceiro;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['idfinanceiro_cond'] = $idfinanceiro_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['cmp'] = "idfinanceiro"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['opc'] = $idfinanceiro_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq']['idfinanceiro'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['idorcamento'] = $idorcamento; 
      if (is_array($idorcamento) && !empty($idorcamento))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['val'][0] = $idorcamento;
      }
      elseif ($idorcamento_cond_salva == "nu" || $idorcamento_cond_salva == "nn" || $idorcamento_cond_salva == "ep" || $idorcamento_cond_salva == "ne" || !empty($idorcamento))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['val'][0][0] = $idorcamento;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['idorcamento_cond'] = $idorcamento_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['cmp'] = "idorcamento"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['opc'] = $idorcamento_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq']['idorcamento'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['idcompra_venda'] = $idcompra_venda; 
      if (is_array($idcompra_venda) && !empty($idcompra_venda))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['val'][0] = $idcompra_venda;
      }
      elseif ($idcompra_venda_cond_salva == "nu" || $idcompra_venda_cond_salva == "nn" || $idcompra_venda_cond_salva == "ep" || $idcompra_venda_cond_salva == "ne" || !empty($idcompra_venda))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['val'][0][0] = $idcompra_venda;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['idcompra_venda_cond'] = $idcompra_venda_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['cmp'] = "idcompra_venda"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['opc'] = $idcompra_venda_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq']['idcompra_venda'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['forma_pagamento'] = $forma_pagamento; 
      if (is_array($forma_pagamento) && !empty($forma_pagamento))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['val'][0] = $forma_pagamento;
      }
      elseif ($forma_pagamento_cond_salva == "nu" || $forma_pagamento_cond_salva == "nn" || $forma_pagamento_cond_salva == "ep" || $forma_pagamento_cond_salva == "ne" || !empty($forma_pagamento))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['val'][0][0] = $forma_pagamento;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['campos_busca']['forma_pagamento_cond'] = $forma_pagamento_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['cmp'] = "forma_pagamento"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid]['opc'] = $forma_pagamento_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['grid_pesq']['forma_pagamento'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      ...
      $this->cmp_formatado['idfinanceiro'] = $Conteudo;
      $Conteudo = $idorcamento;
      if (strtoupper($idorcamento_cond) != "II" && strtoupper($idorcamento_cond) != "QP" && strtoupper($idorcamento_cond) != "NP" && strtoupper($idorcamento_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idorcamento'] = $Conteudo;
      $Conteudo = $idcompra_venda;
      if (strtoupper($idcompra_venda_cond) != "II" && strtoupper($idcompra_venda_cond) != "QP" && strtoupper($idcompra_venda_cond) != "NP" && strtoupper($idcompra_venda_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['idcompra_venda'] = $Conteudo;
      $Conteudo = $forma_pagamento;
      if (strtoupper($forma_pagamento_cond) != "II" && strtoupper($forma_pagamento_cond) != "QP" && strtoupper($forma_pagamento_cond) != "NP" && strtoupper($forma_pagamento_cond) != "IN") 
      { 
          nmgp_Form_Num_Val($Conteudo, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
      } 
      $this->cmp_formatado['forma_pagamento'] = $Conteudo;

      //----- $idfinanceiro
      $this->Date_part = false;
      if (isset($idfinanceiro) || $idfinanceiro_cond == "nu" || $idfinanceiro_cond == "nn" || $idfinanceiro_cond == "ep" || $idfinanceiro_cond == "ne")
      {
         $this->monta_condicao("idfinanceiro", $idfinanceiro_cond, $idfinanceiro, "", "idfinanceiro", "INT", false);
      }

      //----- $idorcamento
      $this->Date_part = false;
      if (isset($idorcamento) || $idorcamento_cond == "nu" || $idorcamento_cond == "nn" || $idorcamento_cond == "ep" || $idorcamento_cond == "ne")
      {
         $this->monta_condicao("idorcamento", $idorcamento_cond, $idorcamento, "", "idorcamento", "INT", false);
      }

      //----- $idcompra_venda
      $this->Date_part = false;
      if (isset($idcompra_venda) || $idcompra_venda_cond == "nu" || $idcompra_venda_cond == "nn" || $idcompra_venda_cond == "ep" || $idcompra_venda_cond == "ne")
      {
         $this->monta_condicao("idcompra_venda", $idcompra_venda_cond, $idcompra_venda, "", "idcompra_venda", "INT", false);
      }

      //----- $forma_pagamento
      $this->Date_part = false;
      if (isset($forma_pagamento) || $forma_pagamento_cond == "nu" || $forma_pagamento_cond == "nn" || $forma_pagamento_cond == "ep" || $forma_pagamento_cond == "ne")
      {
         $this->monta_condicao("forma_pagamento", $forma_pagamento_cond, $forma_pagamento, "", "forma_pagamento", "INT", false);
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['cond_dyn_search'] = "";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_financeiro']['where_pesq_grid']    = $this->comando_filtro;
