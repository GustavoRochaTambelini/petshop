...
<?php
   ...
   $Ord_Cmp = new grid_caixa_diario_vendas_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_caixa_diario_vendas_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["data"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['labels']["data"])) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['labels']["data"] : "DATA";
   $tab_ger_campos['idcliente'] = "on";
   $tab_def_campos['idcliente'] = "idcliente";
   $tab_labels["idcliente"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['labels']["idcliente"])) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['labels']["idcliente"] : "CLIENTE";
   $tab_ger_campos['idforma_pagamento'] = "on";
   $tab_def_campos['idforma_pagamento'] = "idforma_pagamento";
   $tab_labels["idforma_pagamento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['labels']["idforma_pagamento"])) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['labels']["idforma_pagamento"] : "TIPO";
   $tab_ger_campos['entrada'] = "on";
   $tab_def_campos['entrada'] = "entrada";
   $tab_labels["entrada"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['labels']["entrada"])) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['labels']["entrada"] : "ENTRADA";
   $tab_ger_campos['saida'] = "on";
   $tab_def_campos['saida'] = "saida";
   $tab_labels["saida"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['labels']["saida"])) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['labels']["saida"] : "SAÍDA";
   ...
   {
       $tab_def_campos['saldo'] = "";
   }
   $tab_labels["saldo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['labels']["saldo"])) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['labels']["saldo"] : "SALDO";
   $tab_ger_campos['saldo'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_caixa_diario_vendas_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_caixa_diario_vendas']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
