...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_caixa_diario_vendas"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_caixa_diario_vendas"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario_vendas']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_caixa_diario_vendas']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario_vendas']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_caixa_diario_vendas']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario_vendas']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_caixa_diario_vendas</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario_vendas']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_caixa_diario_vendas']['embutida_filho'] as $ind => $sc_init)
          {
