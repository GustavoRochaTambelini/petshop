<?php
@session_start() ;
$_SESSION['scriptcase']['grid_caixa_diario_vendas']['sc_process_barr'] = true;
require_once('../grid_caixa_diario_vendas/index.php');
unset($_SESSION['scriptcase']['grid_caixa_diario_vendas']['sc_process_barr']);
$ExportCtrl = new grid_caixa_diario_vendas_export_control;
$ExportCtrl->Export_barr();

class grid_caixa_diario_vendas_export_control
{
