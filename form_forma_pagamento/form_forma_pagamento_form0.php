...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_forma_pagamento/form_forma_pagamento_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_forma_pagamento_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_forma_pagamento_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['link_info']['remove_border']) {
...
<?php
 include_once("form_forma_pagamento_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_forma_pagamento'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_forma_pagamento'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['update']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['update']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['update']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['update']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['update'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['delete']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['delete']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['delete']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['delete']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['delete'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-5';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { 
 ?>
<span id="id_read_on_idforma_pagamento" css_idforma_pagamento_line" style="<?php echo $sStyleReadLab_idforma_pagamento; ?>"><?php echo $this->form_format_readonly("idforma_pagamento", $this->form_encode_input($this->idforma_pagamento)); ?></span><span id="id_read_off_idforma_pagamento" class="css_read_off_idforma_pagamento" style="<?php echo $sStyleReadInp_idforma_pagamento; ?>"><input type="hidden" name="idforma_pagamento" value="<?php echo $this->form_encode_input($idforma_pagamento) . "\">"?><span id="id_ajax_label_idforma_pagamento"><?php echo nl2br($idforma_pagamento); ?></span>
</span><?php } else { ?>
&nbsp;
<?php } ?>
</span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_idforma_pagamento_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_idforma_pagamento_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php } 
?> 
<?php $sStyleHidden_idforma_pagamento_dumb = ('' == $sStyleHidden_idforma_pagamento) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_idforma_pagamento_dumb" style="<?php echo $sStyleHidden_idforma_pagamento_dumb; ?>"></TD>
<?php $sStyleHidden_idconta_corrente_dumb = ('' == $sStyleHidden_idconta_corrente) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_idconta_corrente_dumb" style="<?php echo $sStyleHidden_idconta_corrente_dumb; ?>"></TD>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_ativo'][] = 'T'; ?>
 <option  value="F" <?php  if ($this->ativo == "F") { echo " selected" ;} ?>>INATIVO</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_ativo'][] = 'F'; ?>
 </select></span>
</span><?php  }?>
...
<?php } 
?> 
<?php $sStyleHidden_idbandeira_cartao_dumb = ('' == $sStyleHidden_idbandeira_cartao) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_idbandeira_cartao_dumb" style="<?php echo $sStyleHidden_idbandeira_cartao_dumb; ?>"></TD>
<?php $sStyleHidden_idtipo_cartao_dumb = ('' == $sStyleHidden_idtipo_cartao) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_idtipo_cartao_dumb" style="<?php echo $sStyleHidden_idtipo_cartao_dumb; ?>"></TD>
<?php $sStyleHidden_taxa_de_administracao_dumb = ('' == $sStyleHidden_taxa_de_administracao) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_taxa_de_administracao_dumb" style="<?php echo $sStyleHidden_taxa_de_administracao_dumb; ?>"></TD>
<?php if ($sc_hidden_no > 0) { echo "<tr style=\"display: none;\">"; }; 
      $sc_hidden_yes = 0; $sc_hidden_no = 0; ?>
...
<?php } ?>
<?php $sStyleHidden_taxa_de_antecipacao_dumb = ('' == $sStyleHidden_taxa_de_antecipacao) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_taxa_de_antecipacao_dumb" style="<?php echo $sStyleHidden_taxa_de_antecipacao_dumb; ?>"></TD>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_forma_pagamento");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_forma_pagamento");
 parent.scAjaxDetailHeight("form_forma_pagamento", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
