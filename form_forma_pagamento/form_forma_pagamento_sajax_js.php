  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_forma_pagamento" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_forma_pagamento_form();
	}
...
?>
  ...
  function do_ajax_form_forma_pagamento_validate_idforma_pagamento()
  {
    ...
    x_ajax_form_forma_pagamento_validate_idforma_pagamento(var_idforma_pagamento, var_script_case_init, do_ajax_form_forma_pagamento_validate_idforma_pagamento_cb);
  } // do_ajax_form_forma_pagamento_validate_idforma_pagamento

  function do_ajax_form_forma_pagamento_validate_idforma_pagamento_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_validate_idforma_pagamento_cb

  // ---------- Validate idconta_corrente
  function do_ajax_form_forma_pagamento_validate_idconta_corrente()
  {
    var nomeCampo_idconta_corrente = "idconta_corrente";
    var var_idconta_corrente = scAjaxGetFieldSelect(nomeCampo_idconta_corrente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_validate_idconta_corrente(var_idconta_corrente, var_script_case_init, do_ajax_form_forma_pagamento_validate_idconta_corrente_cb);
  } // do_ajax_form_forma_pagamento_validate_idconta_corrente

  function do_ajax_form_forma_pagamento_validate_idconta_corrente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_validate_idconta_corrente_cb

  // ---------- Validate descricao
  function do_ajax_form_forma_pagamento_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_forma_pagamento_validate_descricao_cb);
  } // do_ajax_form_forma_pagamento_validate_descricao

  function do_ajax_form_forma_pagamento_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_validate_descricao_cb

  // ---------- Validate ativo
  function do_ajax_form_forma_pagamento_validate_ativo()
  {
    var nomeCampo_ativo = "ativo";
    var var_ativo = scAjaxGetFieldSelect(nomeCampo_ativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_validate_ativo(var_ativo, var_script_case_init, do_ajax_form_forma_pagamento_validate_ativo_cb);
  } // do_ajax_form_forma_pagamento_validate_ativo

  function do_ajax_form_forma_pagamento_validate_ativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ativo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_validate_ativo_cb

  // ---------- Validate idbandeira_cartao
  function do_ajax_form_forma_pagamento_validate_idbandeira_cartao()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_validate_idbandeira_cartao(var_idbandeira_cartao, var_script_case_init, do_ajax_form_forma_pagamento_validate_idbandeira_cartao_cb);
  } // do_ajax_form_forma_pagamento_validate_idbandeira_cartao

  function do_ajax_form_forma_pagamento_validate_idbandeira_cartao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_validate_idbandeira_cartao_cb

  // ---------- Validate idtipo_cartao
  function do_ajax_form_forma_pagamento_validate_idtipo_cartao()
  {
    var nomeCampo_idtipo_cartao = "idtipo_cartao";
    var var_idtipo_cartao = scAjaxGetFieldSelect(nomeCampo_idtipo_cartao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_validate_idtipo_cartao(var_idtipo_cartao, var_script_case_init, do_ajax_form_forma_pagamento_validate_idtipo_cartao_cb);
  } // do_ajax_form_forma_pagamento_validate_idtipo_cartao

  function do_ajax_form_forma_pagamento_validate_idtipo_cartao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_validate_idtipo_cartao_cb

  // ---------- Validate taxa_de_administracao
  function do_ajax_form_forma_pagamento_validate_taxa_de_administracao()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_validate_taxa_de_administracao(var_taxa_de_administracao, var_script_case_init, do_ajax_form_forma_pagamento_validate_taxa_de_administracao_cb);
  } // do_ajax_form_forma_pagamento_validate_taxa_de_administracao

  function do_ajax_form_forma_pagamento_validate_taxa_de_administracao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_validate_taxa_de_administracao_cb

  // ---------- Validate taxa_de_antecipacao
  function do_ajax_form_forma_pagamento_validate_taxa_de_antecipacao()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_validate_taxa_de_antecipacao(var_taxa_de_antecipacao, var_script_case_init, do_ajax_form_forma_pagamento_validate_taxa_de_antecipacao_cb);
  } // do_ajax_form_forma_pagamento_validate_taxa_de_antecipacao

  function do_ajax_form_forma_pagamento_validate_taxa_de_antecipacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_validate_taxa_de_antecipacao_cb

  // ---------- Validate prazo_de_recebimento
  function do_ajax_form_forma_pagamento_validate_prazo_de_recebimento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_validate_prazo_de_recebimento(var_prazo_de_recebimento, var_script_case_init, do_ajax_form_forma_pagamento_validate_prazo_de_recebimento_cb);
  } // do_ajax_form_forma_pagamento_validate_prazo_de_recebimento

  function do_ajax_form_forma_pagamento_validate_prazo_de_recebimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_validate_prazo_de_recebimento_cb

  // ---------- Validate contato
  function do_ajax_form_forma_pagamento_validate_contato()
  {
    var nomeCampo_contato = "contato";
    var var_contato = scAjaxGetFieldText(nomeCampo_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_validate_contato(var_contato, var_script_case_init, do_ajax_form_forma_pagamento_validate_contato_cb);
  } // do_ajax_form_forma_pagamento_validate_contato

  function do_ajax_form_forma_pagamento_validate_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "contato";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_validate_contato_cb

  // ---------- Validate telefone_contato
  function do_ajax_form_forma_pagamento_validate_telefone_contato()
  {
    var nomeCampo_telefone_contato = "telefone_contato";
    var var_telefone_contato = scAjaxGetFieldText(nomeCampo_telefone_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_validate_telefone_contato(var_telefone_contato, var_script_case_init, do_ajax_form_forma_pagamento_validate_telefone_contato_cb);
  } // do_ajax_form_forma_pagamento_validate_telefone_contato

  function do_ajax_form_forma_pagamento_validate_telefone_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_validate_telefone_contato_cb

  // ---------- Validate email_contato
  function do_ajax_form_forma_pagamento_validate_email_contato()
  {
    var nomeCampo_email_contato = "email_contato";
    var var_email_contato = scAjaxGetFieldText(nomeCampo_email_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_validate_email_contato(var_email_contato, var_script_case_init, do_ajax_form_forma_pagamento_validate_email_contato_cb);
  } // do_ajax_form_forma_pagamento_validate_email_contato

  function do_ajax_form_forma_pagamento_validate_email_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_validate_email_contato_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_forma_pagamento_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_forma_pagamento_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_forma_pagamento_submit_form(var_idforma_pagamento, var_idconta_corrente, var_descricao, var_ativo, var_idbandeira_cartao, var_idtipo_cartao, var_taxa_de_administracao, var_taxa_de_antecipacao, var_prazo_de_recebimento, var_contato, var_telefone_contato, var_email_contato, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_forma_pagamento_submit_form_cb);
  } // do_ajax_form_forma_pagamento_submit_form

  function do_ajax_form_forma_pagamento_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_forma_pagamento_submit_form_cb_after_alert);
  } // do_ajax_form_forma_pagamento_submit_form_cb
  function do_ajax_form_forma_pagamento_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_forma_pagamento_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_forma_pagamento_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_forma_pagamento_navigate_form, function() {});
    } else {
      perform_ajax_form_forma_pagamento_navigate_form();
    }
  }

  function perform_ajax_form_forma_pagamento_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_forma_pagamento_navigate_form(var_idforma_pagamento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_forma_pagamento_navigate_form_cb);
  } // do_ajax_form_forma_pagamento_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_forma_pagamento_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_forma_pagamento_navigate_form_cb_after_alert);
  } // do_ajax_form_forma_pagamento_navigate_form_cb
  function do_ajax_form_forma_pagamento_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_forma_pagamento_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_forma_pagamento_navigate_form_cb_after_alert

  function sc_hide_form_forma_pagamento_form()
  {
