<?php
//
class form_forma_pagamento_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($this->nmgp_opcao) && $this->nmgp_opcao == "reload_novo") {
          ...
          $_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['opcao']   = "novo";
          $_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['opc_ant'] = "inicio";
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_forma_pagamento_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("pt_br");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("pt_br");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_forma_pagamento']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_forma_pagamento']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_forma_pagamento'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_forma_pagamento']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_forma_pagamento']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_forma_pagamento') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_forma_pagamento']['label'] = "FORMA DE PAGAMENTO";
      ...
      $_SESSION['scriptcase']['error_icon']['form_forma_pagamento']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__icnMensagemAlerta.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_forma_pagamento'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_forma_pagamento']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_forma_pagamento'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_forma_pagamento'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dados_form'];
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_forma_pagamento_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_forma_pagamento_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_forma_pagamento/form_forma_pagamento_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_forma_pagamento_erro.class.php"); 
      }
      $this->Erro      = new form_forma_pagamento_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ((!isset($nm_opc_lookup) || $nm_opc_lookup != "lookup") && (!isset($nm_opc_php) || $nm_opc_php != "formphp"))
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao']))
         { 
             if ($this->idforma_pagamento != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_forma_pagamento']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opc_ant'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opc_ant'] : "";
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_forma_pagamento.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_forma_pagamento_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_forma_pagamento"> 
...
//---------------------------------------------------------
     ...
     if (!is_array($filtro) && '' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_forma_pagamento']) || !is_array($this->NM_ajax_info['errList']['geral_form_forma_pagamento']))
              {
                  $this->NM_ajax_info['errList']['geral_form_forma_pagamento'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_forma_pagamento'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_idconta_corrente(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idconta_corrente) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idconta_corrente']) && !in_array($this->idconta_corrente, $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idconta_corrente']))
               {
                   $hasError = true;
    ...
    function ValidateField_idbandeira_cartao(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idbandeira_cartao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idbandeira_cartao']) && !in_array($this->idbandeira_cartao, $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idbandeira_cartao']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_idtipo_cartao(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->idtipo_cartao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idtipo_cartao']) && !in_array($this->idtipo_cartao, $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idtipo_cartao']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_taxa_de_administracao(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->taxa_de_administracao, 13, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_taxa_de_antecipacao(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->taxa_de_antecipacao, 13, 2, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_prazo_de_recebimento(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->prazo_de_recebimento, 10, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['idforma_pagamento']['keyVal'] = form_forma_pagamento_pack_protect_string($this->nmgp_dados_form['idforma_pagamento']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idconta_corrente']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idconta_corrente'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idconta_corrente']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idconta_corrente'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_forma_pagamento_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_forma_pagamento_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idconta_corrente'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idconta_corrente']['valList'][$i] = form_forma_pagamento_pack_protect_string($v);
          }
...
$aLookup[] = array(form_forma_pagamento_pack_protect_string('T') => str_replace('<', '&lt;',form_forma_pagamento_pack_protect_string("ATIVO")));
$aLookup[] = array(form_forma_pagamento_pack_protect_string('F') => str_replace('<', '&lt;',form_forma_pagamento_pack_protect_string("INATIVO")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_ativo'][] = 'T';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_ativo'][] = 'F';
          $aLookupOrig = $aLookup;
          $sSelComp = "name=\"ativo\"";
          ...
          {
              $this->NM_ajax_info['fldList']['ativo']['valList'][$i] = form_forma_pagamento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idbandeira_cartao']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idbandeira_cartao'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idbandeira_cartao']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idbandeira_cartao'] = array(); 
}
$aLookup[] = array(form_forma_pagamento_pack_protect_string('') => str_replace('<', '&lt;',form_forma_pagamento_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idbandeira_cartao'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idbandeira_cartao'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idbandeira_cartao']['valList'][$i] = form_forma_pagamento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idtipo_cartao']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idtipo_cartao'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idtipo_cartao']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idtipo_cartao'] = array(); 
}
$aLookup[] = array(form_forma_pagamento_pack_protect_string('') => str_replace('<', '&lt;',form_forma_pagamento_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idtipo_cartao'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['Lookup_idtipo_cartao'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['idtipo_cartao']['valList'][$i] = form_forma_pagamento_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_email_contato($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function controle_navegacao()
   {
      global $sc_where;
          ...
          if (false && !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['total']))
          {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['total'] = $rsc->fields[0];
               $rsc->Close(); 
               if ('' != $this->idforma_pagamento)
               {
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'] = $rsc->fields[0];
               if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'] < 0)
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'] = 0;
               }
               $rsc->Close(); 
               }
               else
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['qt_reg_grid'] = 1;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'] = 0;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['final']  = 0;
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao'] = $this->NM_ajax_info['param']['nmgp_opcao'];
          if (in_array($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao'], array('incluir', 'alterar', 'excluir')))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao'] = '';
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao'] == 'inicio')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'] = 0;
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao'] == 'retorna')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'] = 0 ;
              }
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao'] == 'avanca' && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['total']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['total'] > $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['final']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['final'];
          }
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao'] == 'final')
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['total'] - $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['qt_reg_grid'];
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'] = 0;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['final'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'] + $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['qt_reg_grid'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['final'];
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opcao'] = '';
   ...
   { 
    ...
    if ("excluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['form_forma_pagamento']['contr_erro'] = 'on';
...
;
 ...
 if ('submit_form' == $this->NM_ajax_opcao || 'event_' == substr($this->NM_ajax_opcao, 0, 6) || (isset($this->wizard_action) && 'change_step' == $this->wizard_action))
 {
  if (isset($this->wizard_action) && 'change_step' == $this->wizard_action) {
   $sErrorIndex = 'geral_form_forma_pagamento';
...
$_SESSION['scriptcase']['form_forma_pagamento']['contr_erro'] = 'off'; 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['decimal_db'] == ",") 
      {
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['parms'] = "idforma_pagamento?#?$this->idforma_pagamento?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter'] . ")";
          }
      }
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($this->nmgp_opcao == "igual" || (($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] == "R") && ($this->sc_evento == "insert" || $this->sc_evento == "update")) )
          { 
              if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
              {
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['select'] = ""; 
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dados_select'] = $this->nmgp_dados_select;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_forma_pagamento_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_forma_pagamento = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['total'] = $qt_geral_reg_form_forma_pagamento;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_forma_pagamento_pack_ajax_response();
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_forma_pagamento_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_forma_pagamento_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['masterValue'] as $cmp_master => $val_master)
        {
?>
...
<?php
  exit;
    ...
    function displayAppHeader()
    {
        ...
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['under_dashboard'] && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['compact_mode'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['dashboard_info']['maximized']) {
            return;
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['link_info']['compact_mode']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['link_info']['compact_mode']) {
            return;
        }
?>
...
<?php
    ...
    {
        if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['run_iframe'] != "R") {
        } else {
            return false;
        }
        return true;
    ...
    {
        $sortRule = 'nosort';
        if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['ordem_cmp'] == $fieldName) {
            $orderColName = $fieldName;
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento']['ordem_ord'] == " desc") {
