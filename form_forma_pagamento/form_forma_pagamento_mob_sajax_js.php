  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_forma_pagamento_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_forma_pagamento_mob_form();
	}
...
?>
  ...
  function do_ajax_form_forma_pagamento_mob_validate_idforma_pagamento()
  {
    var nomeCampo_idforma_pagamento = "idforma_pagamento";
    var var_idforma_pagamento = scAjaxGetFieldHidden(nomeCampo_idforma_pagamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_mob_validate_idforma_pagamento(var_idforma_pagamento, var_script_case_init, do_ajax_form_forma_pagamento_mob_validate_idforma_pagamento_cb);
  } // do_ajax_form_forma_pagamento_mob_validate_idforma_pagamento

  function do_ajax_form_forma_pagamento_mob_validate_idforma_pagamento_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_mob_validate_idforma_pagamento_cb

  // ---------- Validate idconta_corrente
  function do_ajax_form_forma_pagamento_mob_validate_idconta_corrente()
  {
    var nomeCampo_idconta_corrente = "idconta_corrente";
    var var_idconta_corrente = scAjaxGetFieldSelect(nomeCampo_idconta_corrente);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_mob_validate_idconta_corrente(var_idconta_corrente, var_script_case_init, do_ajax_form_forma_pagamento_mob_validate_idconta_corrente_cb);
  } // do_ajax_form_forma_pagamento_mob_validate_idconta_corrente

  function do_ajax_form_forma_pagamento_mob_validate_idconta_corrente_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idconta_corrente";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_mob_validate_idconta_corrente_cb

  // ---------- Validate descricao
  function do_ajax_form_forma_pagamento_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_forma_pagamento_mob_validate_descricao_cb);
  } // do_ajax_form_forma_pagamento_mob_validate_descricao

  function do_ajax_form_forma_pagamento_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_mob_validate_descricao_cb

  // ---------- Validate ativo
  function do_ajax_form_forma_pagamento_mob_validate_ativo()
  {
    var nomeCampo_ativo = "ativo";
    var var_ativo = scAjaxGetFieldSelect(nomeCampo_ativo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_mob_validate_ativo(var_ativo, var_script_case_init, do_ajax_form_forma_pagamento_mob_validate_ativo_cb);
  } // do_ajax_form_forma_pagamento_mob_validate_ativo

  function do_ajax_form_forma_pagamento_mob_validate_ativo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "ativo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_mob_validate_ativo_cb

  // ---------- Validate idbandeira_cartao
  function do_ajax_form_forma_pagamento_mob_validate_idbandeira_cartao()
  {
    var nomeCampo_idbandeira_cartao = "idbandeira_cartao";
    var var_idbandeira_cartao = scAjaxGetFieldSelect(nomeCampo_idbandeira_cartao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_mob_validate_idbandeira_cartao(var_idbandeira_cartao, var_script_case_init, do_ajax_form_forma_pagamento_mob_validate_idbandeira_cartao_cb);
  } // do_ajax_form_forma_pagamento_mob_validate_idbandeira_cartao

  function do_ajax_form_forma_pagamento_mob_validate_idbandeira_cartao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idbandeira_cartao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_mob_validate_idbandeira_cartao_cb

  // ---------- Validate idtipo_cartao
  function do_ajax_form_forma_pagamento_mob_validate_idtipo_cartao()
  {
    var nomeCampo_idtipo_cartao = "idtipo_cartao";
    var var_idtipo_cartao = scAjaxGetFieldSelect(nomeCampo_idtipo_cartao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_mob_validate_idtipo_cartao(var_idtipo_cartao, var_script_case_init, do_ajax_form_forma_pagamento_mob_validate_idtipo_cartao_cb);
  } // do_ajax_form_forma_pagamento_mob_validate_idtipo_cartao

  function do_ajax_form_forma_pagamento_mob_validate_idtipo_cartao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "idtipo_cartao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_mob_validate_idtipo_cartao_cb

  // ---------- Validate taxa_de_administracao
  function do_ajax_form_forma_pagamento_mob_validate_taxa_de_administracao()
  {
    var nomeCampo_taxa_de_administracao = "taxa_de_administracao";
    var var_taxa_de_administracao = scAjaxGetFieldText(nomeCampo_taxa_de_administracao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_mob_validate_taxa_de_administracao(var_taxa_de_administracao, var_script_case_init, do_ajax_form_forma_pagamento_mob_validate_taxa_de_administracao_cb);
  } // do_ajax_form_forma_pagamento_mob_validate_taxa_de_administracao

  function do_ajax_form_forma_pagamento_mob_validate_taxa_de_administracao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "taxa_de_administracao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_mob_validate_taxa_de_administracao_cb

  // ---------- Validate taxa_de_antecipacao
  function do_ajax_form_forma_pagamento_mob_validate_taxa_de_antecipacao()
  {
    var nomeCampo_taxa_de_antecipacao = "taxa_de_antecipacao";
    var var_taxa_de_antecipacao = scAjaxGetFieldText(nomeCampo_taxa_de_antecipacao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_mob_validate_taxa_de_antecipacao(var_taxa_de_antecipacao, var_script_case_init, do_ajax_form_forma_pagamento_mob_validate_taxa_de_antecipacao_cb);
  } // do_ajax_form_forma_pagamento_mob_validate_taxa_de_antecipacao

  function do_ajax_form_forma_pagamento_mob_validate_taxa_de_antecipacao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "taxa_de_antecipacao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_mob_validate_taxa_de_antecipacao_cb

  // ---------- Validate prazo_de_recebimento
  function do_ajax_form_forma_pagamento_mob_validate_prazo_de_recebimento()
  {
    var nomeCampo_prazo_de_recebimento = "prazo_de_recebimento";
    var var_prazo_de_recebimento = scAjaxGetFieldText(nomeCampo_prazo_de_recebimento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_mob_validate_prazo_de_recebimento(var_prazo_de_recebimento, var_script_case_init, do_ajax_form_forma_pagamento_mob_validate_prazo_de_recebimento_cb);
  } // do_ajax_form_forma_pagamento_mob_validate_prazo_de_recebimento

  function do_ajax_form_forma_pagamento_mob_validate_prazo_de_recebimento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "prazo_de_recebimento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_mob_validate_prazo_de_recebimento_cb

  // ---------- Validate contato
  function do_ajax_form_forma_pagamento_mob_validate_contato()
  {
    var nomeCampo_contato = "contato";
    var var_contato = scAjaxGetFieldText(nomeCampo_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_mob_validate_contato(var_contato, var_script_case_init, do_ajax_form_forma_pagamento_mob_validate_contato_cb);
  } // do_ajax_form_forma_pagamento_mob_validate_contato

  function do_ajax_form_forma_pagamento_mob_validate_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "contato";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_mob_validate_contato_cb

  // ---------- Validate telefone_contato
  function do_ajax_form_forma_pagamento_mob_validate_telefone_contato()
  {
    var nomeCampo_telefone_contato = "telefone_contato";
    var var_telefone_contato = scAjaxGetFieldText(nomeCampo_telefone_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_mob_validate_telefone_contato(var_telefone_contato, var_script_case_init, do_ajax_form_forma_pagamento_mob_validate_telefone_contato_cb);
  } // do_ajax_form_forma_pagamento_mob_validate_telefone_contato

  function do_ajax_form_forma_pagamento_mob_validate_telefone_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_mob_validate_telefone_contato_cb

  // ---------- Validate email_contato
  function do_ajax_form_forma_pagamento_mob_validate_email_contato()
  {
    var nomeCampo_email_contato = "email_contato";
    var var_email_contato = scAjaxGetFieldText(nomeCampo_email_contato);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_forma_pagamento_mob_validate_email_contato(var_email_contato, var_script_case_init, do_ajax_form_forma_pagamento_mob_validate_email_contato_cb);
  } // do_ajax_form_forma_pagamento_mob_validate_email_contato

  function do_ajax_form_forma_pagamento_mob_validate_email_contato_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "email_contato";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_forma_pagamento_mob_validate_email_contato_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_forma_pagamento_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_forma_pagamento_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_idforma_pagamento = scAjaxGetFieldHidden("idforma_pagamento");
    var var_idconta_corrente = scAjaxGetFieldSelect("idconta_corrente");
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_ativo = scAjaxGetFieldSelect("ativo");
    var var_idbandeira_cartao = scAjaxGetFieldSelect("idbandeira_cartao");
    var var_idtipo_cartao = scAjaxGetFieldSelect("idtipo_cartao");
    var var_taxa_de_administracao = scAjaxGetFieldText("taxa_de_administracao");
    var var_taxa_de_antecipacao = scAjaxGetFieldText("taxa_de_antecipacao");
    var var_prazo_de_recebimento = scAjaxGetFieldText("prazo_de_recebimento");
    var var_contato = scAjaxGetFieldText("contato");
    var var_telefone_contato = scAjaxGetFieldText("telefone_contato");
    var var_email_contato = scAjaxGetFieldText("email_contato");
    ...
    scAjaxProcOn();
    x_ajax_form_forma_pagamento_mob_submit_form(var_idforma_pagamento, var_idconta_corrente, var_descricao, var_ativo, var_idbandeira_cartao, var_idtipo_cartao, var_taxa_de_administracao, var_taxa_de_antecipacao, var_prazo_de_recebimento, var_contato, var_telefone_contato, var_email_contato, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_forma_pagamento_mob_submit_form_cb);
  } // do_ajax_form_forma_pagamento_mob_submit_form

  function do_ajax_form_forma_pagamento_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("idconta_corrente");
      scAjaxHideErrorDisplay("descricao");
      scAjaxHideErrorDisplay("ativo");
      scAjaxHideErrorDisplay("idbandeira_cartao");
      scAjaxHideErrorDisplay("idtipo_cartao");
      scAjaxHideErrorDisplay("taxa_de_administracao");
      scAjaxHideErrorDisplay("taxa_de_antecipacao");
      scAjaxHideErrorDisplay("prazo_de_recebimento");
      scAjaxHideErrorDisplay("contato");
      scAjaxHideErrorDisplay("telefone_contato");
      scAjaxHideErrorDisplay("email_contato");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_forma_pagamento_mob_submit_form_cb_after_alert);
  } // do_ajax_form_forma_pagamento_mob_submit_form_cb
  function do_ajax_form_forma_pagamento_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_forma_pagamento_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_forma_pagamento_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_forma_pagamento_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_forma_pagamento_mob_navigate_form();
    }
  }

  function perform_ajax_form_forma_pagamento_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("telefone_contato");
    scAjaxHideErrorDisplay("email_contato");
    var var_idforma_pagamento = document.F2.idforma_pagamento.value;
    ...
    scAjaxProcOn();
    x_ajax_form_forma_pagamento_mob_navigate_form(var_idforma_pagamento, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_forma_pagamento_mob_navigate_form_cb);
  } // do_ajax_form_forma_pagamento_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_forma_pagamento_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_forma_pagamento_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.idforma_pagamento.value = scAjaxGetKeyValue("idforma_pagamento");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_forma_pagamento_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_forma_pagamento_mob_navigate_form_cb
  function do_ajax_form_forma_pagamento_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_forma_pagamento_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_forma_pagamento_mob_navigate_form_cb_after_alert

  function sc_hide_form_forma_pagamento_mob_form()
  {
  ...
  ajax_field_list[0] = "idforma_pagamento";
  ajax_field_list[1] = "idconta_corrente";
  ajax_field_list[2] = "descricao";
  ajax_field_list[3] = "ativo";
  ajax_field_list[4] = "idbandeira_cartao";
  ajax_field_list[5] = "idtipo_cartao";
  ajax_field_list[6] = "taxa_de_administracao";
  ajax_field_list[7] = "taxa_de_antecipacao";
  ajax_field_list[8] = "prazo_de_recebimento";
  ajax_field_list[9] = "contato";
  ajax_field_list[10] = "telefone_contato";
  ajax_field_list[11] = "email_contato";
  ...
  var ajax_error_list = {
    "idforma_pagamento": {"label": "ID", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idconta_corrente": {"label": "CONTA CORRENTE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "idbandeira_cartao": {"label": "BANDEIRA CARTÃO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "idtipo_cartao": {"label": "TIPO CARTÃO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "taxa_de_administracao": {"label": "TAXA ADMINISTRATIVA(%)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "taxa_de_antecipacao": {"label": "TAXA DE ANTECIPAÇÃO(%)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "prazo_de_recebimento": {"label": "DIAS PARA RECEBIMENTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "email_contato": {"label": "E-MAIL CONTATO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "idconta_corrente": new Array(),
    "descricao": new Array(),
    "ativo": new Array(),
    "idbandeira_cartao": new Array(),
    "idtipo_cartao": new Array(),
    "taxa_de_administracao": new Array(),
    "taxa_de_antecipacao": new Array(),
    "prazo_de_recebimento": new Array(),
    "contato": new Array(),
    "telefone_contato": new Array(),
    "email_contato": new Array()
  };
  ajax_field_mult["idforma_pagamento"][1] = "idforma_pagamento";
  ajax_field_mult["idconta_corrente"][1] = "idconta_corrente";
  ajax_field_mult["descricao"][1] = "descricao";
  ajax_field_mult["ativo"][1] = "ativo";
  ajax_field_mult["idbandeira_cartao"][1] = "idbandeira_cartao";
  ajax_field_mult["idtipo_cartao"][1] = "idtipo_cartao";
  ajax_field_mult["taxa_de_administracao"][1] = "taxa_de_administracao";
  ajax_field_mult["taxa_de_antecipacao"][1] = "taxa_de_antecipacao";
  ajax_field_mult["prazo_de_recebimento"][1] = "prazo_de_recebimento";
  ajax_field_mult["contato"][1] = "contato";
  ajax_field_mult["telefone_contato"][1] = "telefone_contato";
  ajax_field_mult["email_contato"][1] = "email_contato";

  var ajax_field_id = {
    "idforma_pagamento": new Array("hidden_field_label_idforma_pagamento", "hidden_field_data_idforma_pagamento"),
    "idconta_corrente": new Array("hidden_field_label_idconta_corrente", "hidden_field_data_idconta_corrente"),
    ...
    "idbandeira_cartao": new Array("hidden_field_label_idbandeira_cartao", "hidden_field_data_idbandeira_cartao"),
    "idtipo_cartao": new Array("hidden_field_label_idtipo_cartao", "hidden_field_data_idtipo_cartao"),
    "taxa_de_administracao": new Array("hidden_field_label_taxa_de_administracao", "hidden_field_data_taxa_de_administracao"),
    "taxa_de_antecipacao": new Array("hidden_field_label_taxa_de_antecipacao", "hidden_field_data_taxa_de_antecipacao"),
    "prazo_de_recebimento": new Array("hidden_field_label_prazo_de_recebimento", "hidden_field_data_prazo_de_recebimento"),
    ...
    "email_contato": new Array("hidden_field_label_email_contato", "hidden_field_data_email_contato")
  };

  var ajax_read_only = {
    "idforma_pagamento": "on",
    "idconta_corrente": "off",
    "descricao": "off",
    "ativo": "off",
    "idbandeira_cartao": "off",
    "idtipo_cartao": "off",
    "taxa_de_administracao": "off",
    "taxa_de_antecipacao": "off",
    "prazo_de_recebimento": "off",
    "contato": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("taxa_de_administracao" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
    ...
    if ("prazo_de_recebimento" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
