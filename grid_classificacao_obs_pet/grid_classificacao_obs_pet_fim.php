...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_classificacao_obs_pet"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_classificacao_obs_pet"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_classificacao_obs_pet'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_classificacao_obs_pet']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_classificacao_obs_pet']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_classificacao_obs_pet']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_classificacao_obs_pet']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_classificacao_obs_pet']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_classificacao_obs_pet</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_classificacao_obs_pet']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_classificacao_obs_pet']['embutida_filho'] as $ind => $sc_init)
          {
