<?php
@session_start() ;
$_SESSION['scriptcase']['grid_classificacao_obs_pet']['sc_process_barr'] = true;
require_once('../grid_classificacao_obs_pet/index.php');
unset($_SESSION['scriptcase']['grid_classificacao_obs_pet']['sc_process_barr']);
$ExportCtrl = new grid_classificacao_obs_pet_export_control;
$ExportCtrl->Export_barr();

class grid_classificacao_obs_pet_export_control
{
