...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_idconta_corrente' + iSeqRow).bind('change', function() { sc_form_conta_corrente_detalhe_idconta_corrente_onchange(this, iSeqRow) });
  $('#id_sc_field_descricao' + iSeqRow).bind('blur', function() { sc_form_conta_corrente_detalhe_descricao_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_conta_corrente_detalhe_descricao_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_conta_corrente_detalhe_descricao_onfocus(this, iSeqRow) });
  $('#id_sc_field_agencia' + iSeqRow).bind('change', function() { sc_form_conta_corrente_detalhe_agencia_onchange(this, iSeqRow) });
  $('#id_sc_field_conta' + iSeqRow).bind('change', function() { sc_form_conta_corrente_detalhe_conta_onchange(this, iSeqRow) });
  $('#id_sc_field_carteira' + iSeqRow).bind('change', function() { sc_form_conta_corrente_detalhe_carteira_onchange(this, iSeqRow) });
  $('#id_sc_field_mora_juros' + iSeqRow).bind('change', function() { sc_form_conta_corrente_detalhe_mora_juros_onchange(this, iSeqRow) });
  $('#id_sc_field_multa' + iSeqRow).bind('change', function() { sc_form_conta_corrente_detalhe_multa_onchange(this, iSeqRow) });
  $('#id_sc_field_especie_doc' + iSeqRow).bind('change', function() { sc_form_conta_corrente_detalhe_especie_doc_onchange(this, iSeqRow) });
  $('#id_sc_field_ativo' + iSeqRow).bind('change', function() { sc_form_conta_corrente_detalhe_ativo_onchange(this, iSeqRow) });
  $('#id_sc_field_lancamento_caixa' + iSeqRow).bind('blur', function() { sc_form_conta_corrente_detalhe_lancamento_caixa_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_conta_corrente_detalhe_lancamento_caixa_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_saldo_total' + iSeqRow).bind('blur', function() { sc_form_conta_corrente_detalhe_saldo_total_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_conta_corrente_detalhe_saldo_total_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_data' + iSeqRow).bind('blur', function() { sc_form_conta_corrente_detalhe_data_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_conta_corrente_detalhe_data_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_descricao_lancamento' + iSeqRow).bind('blur', function() { sc_form_conta_corrente_detalhe_descricao_lancamento_onblur(this, iSeqRow) })
                                                  .bind('change', function() { sc_form_conta_corrente_detalhe_descricao_lancamento_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_valor' + iSeqRow).bind('blur', function() { sc_form_conta_corrente_detalhe_valor_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_conta_corrente_detalhe_valor_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_tipo_moeda' + iSeqRow).bind('blur', function() { sc_form_conta_corrente_detalhe_tipo_moeda_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_conta_corrente_detalhe_tipo_moeda_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_entrada_saida' + iSeqRow).bind('blur', function() { sc_form_conta_corrente_detalhe_entrada_saida_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_conta_corrente_detalhe_entrada_saida_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_btn_gravar_mov' + iSeqRow).bind('blur', function() { sc_form_conta_corrente_detalhe_btn_gravar_mov_onblur(this, iSeqRow) })
                                            .bind('change', function() { sc_form_conta_corrente_detalhe_btn_gravar_mov_onchange(this, iSeqRow) })
...
function sc_form_conta_corrente_detalhe_idconta_corrente_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_conta_corrente_detalhe_descricao_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_conta_corrente_detalhe_agencia_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_conta_corrente_detalhe_conta_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_conta_corrente_detalhe_carteira_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_conta_corrente_detalhe_mora_juros_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_conta_corrente_detalhe_multa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_conta_corrente_detalhe_especie_doc_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_conta_corrente_detalhe_ativo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_conta_corrente_detalhe_lancamento_caixa_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_conta_corrente_detalhe_saldo_total_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_conta_corrente_detalhe_data_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_conta_corrente_detalhe_descricao_lancamento_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_conta_corrente_detalhe_valor_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_conta_corrente_detalhe_tipo_moeda_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_conta_corrente_detalhe_entrada_saida_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_conta_corrente_detalhe_btn_gravar_mov_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_conta_corrente_detalhe_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_data" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_conta_corrente_detalhe_validate_data(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_conta_corrente_detalhe')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
