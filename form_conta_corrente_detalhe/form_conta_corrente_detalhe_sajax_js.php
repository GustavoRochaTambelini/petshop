  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_conta_corrente_detalhe" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_conta_corrente_detalhe_form();
	}
...
?>
  ...
  // ---------- Validate data
  function do_ajax_form_conta_corrente_detalhe_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_validate_data(var_data, var_script_case_init, do_ajax_form_conta_corrente_detalhe_validate_data_cb);
  } // do_ajax_form_conta_corrente_detalhe_validate_data

  function do_ajax_form_conta_corrente_detalhe_validate_data_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_validate_data_cb

  // ---------- Validate descricao_lancamento
  function do_ajax_form_conta_corrente_detalhe_validate_descricao_lancamento()
  {
    var nomeCampo_descricao_lancamento = "descricao_lancamento";
    var var_descricao_lancamento = scAjaxGetFieldSelect(nomeCampo_descricao_lancamento);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_validate_descricao_lancamento(var_descricao_lancamento, var_script_case_init, do_ajax_form_conta_corrente_detalhe_validate_descricao_lancamento_cb);
  } // do_ajax_form_conta_corrente_detalhe_validate_descricao_lancamento

  function do_ajax_form_conta_corrente_detalhe_validate_descricao_lancamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "descricao_lancamento";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_validate_descricao_lancamento_cb

  // ---------- Validate valor
  function do_ajax_form_conta_corrente_detalhe_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_validate_valor(var_valor, var_script_case_init, do_ajax_form_conta_corrente_detalhe_validate_valor_cb);
  } // do_ajax_form_conta_corrente_detalhe_validate_valor

  function do_ajax_form_conta_corrente_detalhe_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_validate_valor_cb

  // ---------- Validate tipo_moeda
  function do_ajax_form_conta_corrente_detalhe_validate_tipo_moeda()
  {
    var nomeCampo_tipo_moeda = "tipo_moeda";
    var var_tipo_moeda = scAjaxGetFieldSelect(nomeCampo_tipo_moeda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_validate_tipo_moeda(var_tipo_moeda, var_script_case_init, do_ajax_form_conta_corrente_detalhe_validate_tipo_moeda_cb);
  } // do_ajax_form_conta_corrente_detalhe_validate_tipo_moeda

  function do_ajax_form_conta_corrente_detalhe_validate_tipo_moeda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo_moeda";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_validate_tipo_moeda_cb

  // ---------- Validate entrada_saida
  function do_ajax_form_conta_corrente_detalhe_validate_entrada_saida()
  {
    var nomeCampo_entrada_saida = "entrada_saida";
    var var_entrada_saida = scAjaxGetFieldRadio(nomeCampo_entrada_saida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_validate_entrada_saida(var_entrada_saida, var_script_case_init, do_ajax_form_conta_corrente_detalhe_validate_entrada_saida_cb);
  } // do_ajax_form_conta_corrente_detalhe_validate_entrada_saida

  function do_ajax_form_conta_corrente_detalhe_validate_entrada_saida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "entrada_saida";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_validate_entrada_saida_cb

  // ---------- Validate btn_gravar_mov
  function do_ajax_form_conta_corrente_detalhe_validate_btn_gravar_mov()
  {
  } // do_ajax_form_conta_corrente_detalhe_validate_btn_gravar_mov

  function do_ajax_form_conta_corrente_detalhe_validate_btn_gravar_mov_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "btn_gravar_mov";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_validate_btn_gravar_mov_cb

  // ---------- Validate descricao
  function do_ajax_form_conta_corrente_detalhe_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_conta_corrente_detalhe_validate_descricao_cb);
  } // do_ajax_form_conta_corrente_detalhe_validate_descricao

  function do_ajax_form_conta_corrente_detalhe_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_validate_descricao_cb

  // ---------- Validate saldo_total
  function do_ajax_form_conta_corrente_detalhe_validate_saldo_total()
  {
    var nomeCampo_saldo_total = "saldo_total";
    var var_saldo_total = scAjaxGetFieldText(nomeCampo_saldo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_validate_saldo_total(var_saldo_total, var_script_case_init, do_ajax_form_conta_corrente_detalhe_validate_saldo_total_cb);
  } // do_ajax_form_conta_corrente_detalhe_validate_saldo_total

  function do_ajax_form_conta_corrente_detalhe_validate_saldo_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "saldo_total";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_validate_saldo_total_cb

  // ---------- Validate lancamento_caixa
  function do_ajax_form_conta_corrente_detalhe_validate_lancamento_caixa()
  {
    var nomeCampo_lancamento_caixa = "lancamento_caixa";
    var var_lancamento_caixa = scAjaxGetFieldText(nomeCampo_lancamento_caixa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_validate_lancamento_caixa(var_lancamento_caixa, var_script_case_init, do_ajax_form_conta_corrente_detalhe_validate_lancamento_caixa_cb);
  } // do_ajax_form_conta_corrente_detalhe_validate_lancamento_caixa

  function do_ajax_form_conta_corrente_detalhe_validate_lancamento_caixa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lancamento_caixa";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_validate_lancamento_caixa_cb

  // ---------- Event onclick scajaxbutton_btn_gravar
  function do_ajax_form_conta_corrente_detalhe_event_scajaxbutton_btn_gravar_onclick()
  {
    var var_data = scAjaxGetFieldText("data");
    var var_descricao_lancamento = scAjaxGetFieldSelect("descricao_lancamento");
    var var_valor = scAjaxGetFieldText("valor");
    var var_tipo_moeda = scAjaxGetFieldSelect("tipo_moeda");
    var var_entrada_saida = scAjaxGetFieldRadio("entrada_saida");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_conta_corrente_detalhe_event_scajaxbutton_btn_gravar_onclick(var_data, var_descricao_lancamento, var_valor, var_tipo_moeda, var_entrada_saida, var_script_case_init, do_ajax_form_conta_corrente_detalhe_event_scajaxbutton_btn_gravar_onclick_cb);
  } // do_ajax_form_conta_corrente_detalhe_event_scajaxbutton_btn_gravar_onclick

  function do_ajax_form_conta_corrente_detalhe_event_scajaxbutton_btn_gravar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "scajaxbutton_btn_gravar";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_conta_corrente_detalhe_event_scajaxbutton_btn_gravar_onclick_cb_after_alert);
  } // do_ajax_form_conta_corrente_detalhe_event_scajaxbutton_btn_gravar_onclick_cb
  function do_ajax_form_conta_corrente_detalhe_event_scajaxbutton_btn_gravar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_conta_corrente_detalhe_event_scajaxbutton_btn_gravar_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_conta_corrente_detalhe_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_conta_corrente_detalhe_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_data = scAjaxGetFieldText("data");
    ...
    var var_tipo_moeda = scAjaxGetFieldSelect("tipo_moeda");
    var var_entrada_saida = scAjaxGetFieldRadio("entrada_saida");
    var var_btn_gravar_mov = scAjaxGetFieldHidden("btn_gravar_mov");
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_saldo_total = scAjaxGetFieldText("saldo_total");
    ...
    scAjaxProcOn();
    x_ajax_form_conta_corrente_detalhe_submit_form(var_data, var_descricao_lancamento, var_valor, var_tipo_moeda, var_entrada_saida, var_btn_gravar_mov, var_descricao, var_saldo_total, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_conta_corrente_detalhe_submit_form_cb);
  } // do_ajax_form_conta_corrente_detalhe_submit_form

  function do_ajax_form_conta_corrente_detalhe_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("descricao_lancamento");
      scAjaxHideErrorDisplay("valor");
      scAjaxHideErrorDisplay("tipo_moeda");
      scAjaxHideErrorDisplay("entrada_saida");
      scAjaxHideErrorDisplay("btn_gravar_mov");
      scAjaxHideErrorDisplay("descricao");
      scAjaxHideErrorDisplay("saldo_total");
      scAjaxHideErrorDisplay("lancamento_caixa");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_conta_corrente_detalhe_submit_form_cb_after_alert);
  } // do_ajax_form_conta_corrente_detalhe_submit_form_cb
  function do_ajax_form_conta_corrente_detalhe_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_conta_corrente_detalhe_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_caixa_diario"] = "off";

  function do_ajax_form_conta_corrente_detalhe_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_conta_corrente_detalhe_navigate_form, function() {});
    } else {
      perform_ajax_form_conta_corrente_detalhe_navigate_form();
    }
  }

  function perform_ajax_form_conta_corrente_detalhe_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("saldo_total");
    scAjaxHideErrorDisplay("lancamento_caixa");
    var var_idconta_corrente = document.F2.idconta_corrente.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["grid_caixa_diario"] = "on";
    x_ajax_form_conta_corrente_detalhe_navigate_form(var_idconta_corrente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_conta_corrente_detalhe_navigate_form_cb);
  } // do_ajax_form_conta_corrente_detalhe_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_conta_corrente_detalhe']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_conta_corrente_detalhe_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_caixa_diario"] && "nmsc_iframe_liga_grid_caixa_diario" != scMasterDetailIframe["nmsc_iframe_liga_grid_caixa_diario"]) {
        ...
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_caixa_diario').contentWindow.nm_move('apl_detalhe', true);
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_conta_corrente_detalhe_navigate_form_cb_after_alert);
  } // do_ajax_form_conta_corrente_detalhe_navigate_form_cb
  function do_ajax_form_conta_corrente_detalhe_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_conta_corrente_detalhe_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_conta_corrente_detalhe_navigate_form_cb_after_alert

  function sc_hide_form_conta_corrente_detalhe_form()
  {
  ...
  {
    if ("off" == scStatusDetail["grid_caixa_diario"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[1] = "descricao_lancamento";
  ajax_field_list[2] = "valor";
  ajax_field_list[3] = "tipo_moeda";
  ajax_field_list[4] = "entrada_saida";
  ajax_field_list[5] = "btn_gravar_mov";
  ajax_field_list[6] = "descricao";
  ajax_field_list[7] = "saldo_total";
  ajax_field_list[8] = "lancamento_caixa";
  ...
  var ajax_error_list = {
    ...
    "descricao_lancamento": {"label": "CLIENTE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "valor": {"label": "VALOR", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "tipo_moeda": {"label": "PAGAMENTO", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "entrada_saida": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "btn_gravar_mov": {"label": "", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "saldo_total": {"label": "SALDO DA CONTA", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lancamento_caixa": {"label": "lancamento_caixa", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "data": new Array(),
    "descricao_lancamento": new Array(),
    "valor": new Array(),
    "tipo_moeda": new Array(),
    "entrada_saida": new Array(),
    "btn_gravar_mov": new Array(),
    "descricao": new Array(),
    "saldo_total": new Array(),
    "lancamento_caixa": new Array()
  };
  ajax_field_mult["data"][1] = "data";
  ajax_field_mult["descricao_lancamento"][1] = "descricao_lancamento";
  ajax_field_mult["valor"][1] = "valor";
  ajax_field_mult["tipo_moeda"][1] = "tipo_moeda";
  ajax_field_mult["entrada_saida"][1] = "entrada_saida";
  ajax_field_mult["btn_gravar_mov"][1] = "btn_gravar_mov";
  ajax_field_mult["descricao"][1] = "descricao";
  ajax_field_mult["saldo_total"][1] = "saldo_total";
  ajax_field_mult["lancamento_caixa"][1] = "lancamento_caixa";

  var ajax_field_id = {
    "data": new Array("hidden_field_label_data", "hidden_field_data_data"),
    "descricao_lancamento": new Array("hidden_field_label_descricao_lancamento", "hidden_field_data_descricao_lancamento"),
    "valor": new Array("hidden_field_label_valor", "hidden_field_data_valor"),
    "tipo_moeda": new Array("hidden_field_label_tipo_moeda", "hidden_field_data_tipo_moeda"),
    "entrada_saida": new Array("hidden_field_label_entrada_saida", "hidden_field_data_entrada_saida"),
    "btn_gravar_mov": new Array("hidden_field_label_btn_gravar_mov", "hidden_field_data_btn_gravar_mov"),
    "descricao": new Array("hidden_field_label_descricao", "hidden_field_data_descricao"),
    "saldo_total": new Array("hidden_field_label_saldo_total", "hidden_field_data_saldo_total"),
    "lancamento_caixa": new Array("hidden_field_label_lancamento_caixa", "hidden_field_data_lancamento_caixa")
  };

  var ajax_read_only = {
    "data": "off",
    "descricao_lancamento": "off",
    "valor": "off",
    "tipo_moeda": "off",
    "entrada_saida": "off",
    "btn_gravar_mov": "off",
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("descricao_lancamento" == sIndex)
    {
