  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_conta_corrente_detalhe_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_conta_corrente_detalhe_mob_form();
	}
...
?>
  ...
  // ---------- Validate data
  function do_ajax_form_conta_corrente_detalhe_mob_validate_data()
  {
    var nomeCampo_data = "data";
    var var_data = scAjaxGetFieldText(nomeCampo_data);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_mob_validate_data(var_data, var_script_case_init, do_ajax_form_conta_corrente_detalhe_mob_validate_data_cb);
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_data

  function do_ajax_form_conta_corrente_detalhe_mob_validate_data_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_data_cb

  // ---------- Validate descricao_lancamento
  function do_ajax_form_conta_corrente_detalhe_mob_validate_descricao_lancamento()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_mob_validate_descricao_lancamento(var_descricao_lancamento, var_script_case_init, do_ajax_form_conta_corrente_detalhe_mob_validate_descricao_lancamento_cb);
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_descricao_lancamento

  function do_ajax_form_conta_corrente_detalhe_mob_validate_descricao_lancamento_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_descricao_lancamento_cb

  // ---------- Validate valor
  function do_ajax_form_conta_corrente_detalhe_mob_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_mob_validate_valor(var_valor, var_script_case_init, do_ajax_form_conta_corrente_detalhe_mob_validate_valor_cb);
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_valor

  function do_ajax_form_conta_corrente_detalhe_mob_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_valor_cb

  // ---------- Validate tipo_moeda
  function do_ajax_form_conta_corrente_detalhe_mob_validate_tipo_moeda()
  {
    var nomeCampo_tipo_moeda = "tipo_moeda";
    var var_tipo_moeda = scAjaxGetFieldSelect(nomeCampo_tipo_moeda);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_mob_validate_tipo_moeda(var_tipo_moeda, var_script_case_init, do_ajax_form_conta_corrente_detalhe_mob_validate_tipo_moeda_cb);
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_tipo_moeda

  function do_ajax_form_conta_corrente_detalhe_mob_validate_tipo_moeda_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_tipo_moeda_cb

  // ---------- Validate entrada_saida
  function do_ajax_form_conta_corrente_detalhe_mob_validate_entrada_saida()
  {
    var nomeCampo_entrada_saida = "entrada_saida";
    var var_entrada_saida = scAjaxGetFieldRadio(nomeCampo_entrada_saida);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_mob_validate_entrada_saida(var_entrada_saida, var_script_case_init, do_ajax_form_conta_corrente_detalhe_mob_validate_entrada_saida_cb);
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_entrada_saida

  function do_ajax_form_conta_corrente_detalhe_mob_validate_entrada_saida_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_entrada_saida_cb

  // ---------- Validate btn_gravar_mov
  function do_ajax_form_conta_corrente_detalhe_mob_validate_btn_gravar_mov()
  {
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_btn_gravar_mov

  function do_ajax_form_conta_corrente_detalhe_mob_validate_btn_gravar_mov_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_btn_gravar_mov_cb

  // ---------- Validate descricao
  function do_ajax_form_conta_corrente_detalhe_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_conta_corrente_detalhe_mob_validate_descricao_cb);
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_descricao

  function do_ajax_form_conta_corrente_detalhe_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_descricao_cb

  // ---------- Validate saldo_total
  function do_ajax_form_conta_corrente_detalhe_mob_validate_saldo_total()
  {
    var nomeCampo_saldo_total = "saldo_total";
    var var_saldo_total = scAjaxGetFieldText(nomeCampo_saldo_total);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_mob_validate_saldo_total(var_saldo_total, var_script_case_init, do_ajax_form_conta_corrente_detalhe_mob_validate_saldo_total_cb);
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_saldo_total

  function do_ajax_form_conta_corrente_detalhe_mob_validate_saldo_total_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_saldo_total_cb

  // ---------- Validate lancamento_caixa
  function do_ajax_form_conta_corrente_detalhe_mob_validate_lancamento_caixa()
  {
    var nomeCampo_lancamento_caixa = "lancamento_caixa";
    var var_lancamento_caixa = scAjaxGetFieldText(nomeCampo_lancamento_caixa);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_conta_corrente_detalhe_mob_validate_lancamento_caixa(var_lancamento_caixa, var_script_case_init, do_ajax_form_conta_corrente_detalhe_mob_validate_lancamento_caixa_cb);
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_lancamento_caixa

  function do_ajax_form_conta_corrente_detalhe_mob_validate_lancamento_caixa_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_conta_corrente_detalhe_mob_validate_lancamento_caixa_cb

  // ---------- Event onclick scajaxbutton_btn_gravar
  function do_ajax_form_conta_corrente_detalhe_mob_event_scajaxbutton_btn_gravar_onclick()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_conta_corrente_detalhe_mob_event_scajaxbutton_btn_gravar_onclick(var_data, var_descricao_lancamento, var_valor, var_tipo_moeda, var_entrada_saida, var_script_case_init, do_ajax_form_conta_corrente_detalhe_mob_event_scajaxbutton_btn_gravar_onclick_cb);
  } // do_ajax_form_conta_corrente_detalhe_mob_event_scajaxbutton_btn_gravar_onclick

  function do_ajax_form_conta_corrente_detalhe_mob_event_scajaxbutton_btn_gravar_onclick_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_conta_corrente_detalhe_mob_event_scajaxbutton_btn_gravar_onclick_cb_after_alert);
  } // do_ajax_form_conta_corrente_detalhe_mob_event_scajaxbutton_btn_gravar_onclick_cb
  function do_ajax_form_conta_corrente_detalhe_mob_event_scajaxbutton_btn_gravar_onclick_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_conta_corrente_detalhe_mob_event_scajaxbutton_btn_gravar_onclick_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_conta_corrente_detalhe_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_conta_corrente_detalhe_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_data = scAjaxGetFieldText("data");
    ...
    var var_idconta_corrente = scAjaxGetFieldText("idconta_corrente");
    ...
    scAjaxProcOn();
    x_ajax_form_conta_corrente_detalhe_mob_submit_form(var_data, var_descricao_lancamento, var_valor, var_tipo_moeda, var_entrada_saida, var_btn_gravar_mov, var_descricao, var_saldo_total, var_idconta_corrente, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_conta_corrente_detalhe_mob_submit_form_cb);
  } // do_ajax_form_conta_corrente_detalhe_mob_submit_form

  function do_ajax_form_conta_corrente_detalhe_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_conta_corrente_detalhe_mob_submit_form_cb_after_alert);
  } // do_ajax_form_conta_corrente_detalhe_mob_submit_form_cb
  function do_ajax_form_conta_corrente_detalhe_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_conta_corrente_detalhe_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_caixa_diario"] = "off";

  function do_ajax_form_conta_corrente_detalhe_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_conta_corrente_detalhe_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_conta_corrente_detalhe_mob_navigate_form();
    }
  }

  function perform_ajax_form_conta_corrente_detalhe_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_conta_corrente_detalhe_mob_navigate_form(var_idconta_corrente, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_conta_corrente_detalhe_mob_navigate_form_cb);
  } // do_ajax_form_conta_corrente_detalhe_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_conta_corrente_detalhe_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_conta_corrente_detalhe_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_conta_corrente_detalhe_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_conta_corrente_detalhe_mob_navigate_form_cb
  function do_ajax_form_conta_corrente_detalhe_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_conta_corrente_detalhe_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_conta_corrente_detalhe_mob_navigate_form_cb_after_alert

  function sc_hide_form_conta_corrente_detalhe_mob_form()
  {
