<form name="F2" method=post 
               action="./" 
               target="_self"> 
<input type="hidden" name="idrecebimento_parcial_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['idrecebimento_parcial_']); ?>">
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_recebimento_parcial"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function scForm_inline_submit(y, z) {
	Nm_Proc_Atualiz = true;
	do_ajax_form_recebimento_parcial_submit_form(y, z);
