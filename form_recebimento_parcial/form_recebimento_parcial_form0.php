<?php
class form_recebimento_parcial_form extends form_recebimento_parcial_apl
{
function Form_Init()
{
...
<?php
if ($this->Embutida_form && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['sc_modal'] && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['sc_redir_atualiz'] == 'ok')
{
?>
...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_recebimento_parcial/form_recebimento_parcial_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
<?php
include_once("form_recebimento_parcial_sajax_js.php");
?>
<script type="text/javascript">
...
var Nav_binicio_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['first']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['first'] : 'off'); ?>";
var Nav_bavanca_macro_disabled  = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['forward']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['forward'] : 'off'); ?>";
var Nav_bretorna_macro_disabled = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['back']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['back'] : 'off'); ?>";
var Nav_bfinal_macro_disabled   = "<?php echo (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['last']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['last'] : 'off'); ?>";
...
include_once('form_recebimento_parcial_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['recarga'];
}
if ('novo' == $opcao_botoes && $this->Embutida_form)
{
    $opcao_botoes = 'inicio';
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['link_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['link_info']['remove_margin']) {
        $remove_margin = 'margin: 0; ';
    }
    if ('' != $remove_margin && isset($str_iframe_body) && '' != $str_iframe_body) {
        $str_iframe_body = '';
    }
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['link_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['link_info']['remove_border']) {
...
<?php
 include_once("form_recebimento_parcial_js0.php");
?>
<script type="text/javascript"> 
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_recebimento_parcial'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_recebimento_parcial'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['new']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['new']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_label']['new']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_label']['new']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_label']['new'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['insert']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['insert']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_label']['insert']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_label']['insert']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_label']['insert'];
        }
?>
...
<?php
        ...
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['help']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['help']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_label']['help']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_label']['help']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_label']['help'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
        $buttonMacroDisabled = 'sc-unique-btn-4';
        $buttonMacroLabel = "";

        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['exit']) && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_disabled']['exit']) {
            $buttonMacroDisabled .= ' disabled';
        }
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_label']['exit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_label']['exit']) {
            $buttonMacroLabel = $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['btn_label']['exit'];
        }
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
<?php
...
<?php
 ...
 ?>
   ...
   <?php if ($this->Embutida_form && $this->nmgp_botoes['insert'] != "on") {?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult sc-col-title"  width="10"> &nbsp; </TD>
   <?php }?>
   <?php if ((!isset($this->nmgp_cmp_hidden['idrecebimento_parcial_']) || $this->nmgp_cmp_hidden['idrecebimento_parcial_'] == 'on') && ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir"))) { 
      if (!isset($this->nm_new_label['idrecebimento_parcial_'])) {
          $this->nm_new_label['idrecebimento_parcial_'] = "ID"; } ?>
<?php
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;

        // label
        $label_labelContent = $this->nm_new_label['idrecebimento_parcial_'];
...
?>
    ...
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_idrecebimento_parcial__label sc-col-title" id="hidden_field_label_idrecebimento_parcial_" style="<?php echo $sStyleHidden_idrecebimento_parcial_; ?>" > <?php echo $label_final ?> </TD>
   ...
   <?php
    ...
    if (1 || !isset($this->nmgp_cmp_hidden['observacao_']) || $this->nmgp_cmp_hidden['observacao_'] == 'on') {
        if (!isset($this->nm_new_label['observacao_'])) {
            $this->nm_new_label['observacao_'] = "OBSERVAÇÕES";
        }
...
?>
   ...
   <?php
    $sStyleHidden_multa_ = '';
    if (isset($this->nmgp_cmp_hidden['multa_']) && $this->nmgp_cmp_hidden['multa_'] == 'off') {
        $sStyleHidden_multa_ = 'display: none';
    }
    if (1 || !isset($this->nmgp_cmp_hidden['multa_']) || $this->nmgp_cmp_hidden['multa_'] == 'on') {
        if (!isset($this->nm_new_label['multa_'])) {
            $this->nm_new_label['multa_'] = "MULTA";
        }
        $SC_Label = "" . $this->nm_new_label['multa_']  . "";
        $label_fieldName = nl2br($SC_Label);

        // label & order
        $divLabelStyle = '; justify-content: left';
        $fieldSortRule = $this->scGetColumnOrderRule("multa", $orderColName, $orderColOrient, $orderColRule);
        ...
        $label_labelContent = "<a href=\"javascript:nm_move('ordem', 'multa')\" class=\"scFormLabelLink scFormLabelLinkOddMult\">" . $label_labelContent . "</a>";
        $label_divLabel = "<div style=\"flex-grow: 1\">". $label_labelContent . "</div>";
        ...
        $classColFld = " sc-col-fld sc-col-fld-" . $this->form_fixed_column_no;
?>
    <TD class="<?php echo $this->css_inherit_bg . ' ' ?>scFormLabelOddMult css_multa__label sc-col-title" id="hidden_field_label_multa_" style="<?php echo $sStyleHidden_multa_; ?>" > <?php echo $label_final ?> </TD>
   <?php
        $this->form_fixed_column_no++;
    }
?>
...
{ 
   ...
   { 
       ob_start();
       $iStart = sizeof($this->form_vert_form_recebimento_parcial);
       $guarda_nmgp_opcao = $this->nmgp_opcao;
       $guarda_form_vert_form_recebimento_parcial = $this->form_vert_form_recebimento_parcial;
       $this->nmgp_opcao = 'novo';
   } 
   if ($this->Embutida_form && empty($this->form_vert_form_recebimento_parcial))
   {
       $sc_seq_vert = 0;
   }
           if ('novo' != $this->nmgp_opcao && !isset($this->nmgp_cmp_readonly['idrecebimento_parcial_']))
           {
               $this->nmgp_cmp_readonly['idrecebimento_parcial_'] = 'on';
           }
   foreach ($this->form_vert_form_recebimento_parcial as $sc_seq_vert => $sc_lixo)
   {
       $this->form_fixed_column_no = 0;
       $this->loadRecordState($sc_seq_vert);
       $this->idcontas_receber_ = $this->form_vert_form_recebimento_parcial[$sc_seq_vert]['idcontas_receber_'];
       if (isset($this->Embutida_ronly) && $this->Embutida_ronly && !$Line_Add)
       {
           $this->nmgp_cmp_readonly['idrecebimento_parcial_'] = true;
           ...
           $this->nmgp_cmp_readonly['multa_'] = true;
           $this->nmgp_cmp_readonly['juros_'] = true;
       }
       elseif ($Line_Add)
       {
           if (!isset($this->nmgp_cmp_readonly['idrecebimento_parcial_']) || $this->nmgp_cmp_readonly['idrecebimento_parcial_'] != "on") {$this->nmgp_cmp_readonly['idrecebimento_parcial_'] = false;}
           ...
           if (!isset($this->nmgp_cmp_readonly['multa_']) || $this->nmgp_cmp_readonly['multa_'] != "on") {$this->nmgp_cmp_readonly['multa_'] = false;}
        ...
        $this->idrecebimento_parcial_ = $this->form_vert_form_recebimento_parcial[$sc_seq_vert]['idrecebimento_parcial_']; 
       $idrecebimento_parcial_ = $this->idrecebimento_parcial_; 
       $sStyleHidden_idrecebimento_parcial_ = '';
       if (isset($sCheckRead_idrecebimento_parcial_))
       {
           unset($sCheckRead_idrecebimento_parcial_);
       }
       if (isset($this->nmgp_cmp_readonly['idrecebimento_parcial_']))
       {
           $sCheckRead_idrecebimento_parcial_ = $this->nmgp_cmp_readonly['idrecebimento_parcial_'];
       }
       if (isset($this->nmgp_cmp_hidden['idrecebimento_parcial_']) && $this->nmgp_cmp_hidden['idrecebimento_parcial_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['idrecebimento_parcial_']);
           $sStyleHidden_idrecebimento_parcial_ = 'display: none;';
       }
       $bTestReadOnly_idrecebimento_parcial_ = true;
       $sStyleReadLab_idrecebimento_parcial_ = 'display: none;';
       $sStyleReadInp_idrecebimento_parcial_ = '';
       if (/*($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir") || */(isset($this->nmgp_cmp_readonly["idrecebimento_parcial_"]) &&  $this->nmgp_cmp_readonly["idrecebimento_parcial_"] == "on"))
       {
           $bTestReadOnly_idrecebimento_parcial_ = false;
           unset($this->nmgp_cmp_readonly['idrecebimento_parcial_']);
           $sStyleReadLab_idrecebimento_parcial_ = '';
           $sStyleReadInp_idrecebimento_parcial_ = 'display: none;';
       }
       $this->idforma_pagamento_ = $this->form_vert_form_recebimento_parcial[$sc_seq_vert]['idforma_pagamento_']; 
       ...
       $this->data_ = $this->form_vert_form_recebimento_parcial[$sc_seq_vert]['data_']; 
       $data_ = $this->data_; 
       $sStyleHidden_data_ = '';
       ...
       $this->valor_ = $this->form_vert_form_recebimento_parcial[$sc_seq_vert]['valor_']; 
       $valor_ = $this->valor_; 
       $sStyleHidden_valor_ = '';
       ...
       $this->observacao_ = $this->form_vert_form_recebimento_parcial[$sc_seq_vert]['observacao_']; 
       ...
       $this->multa_ = $this->form_vert_form_recebimento_parcial[$sc_seq_vert]['multa_']; 
       $multa_ = $this->multa_; 
       $sStyleHidden_multa_ = '';
       if (isset($sCheckRead_multa_))
       {
           unset($sCheckRead_multa_);
       }
       if (isset($this->nmgp_cmp_readonly['multa_']))
       {
           $sCheckRead_multa_ = $this->nmgp_cmp_readonly['multa_'];
       }
       if (isset($this->nmgp_cmp_hidden['multa_']) && $this->nmgp_cmp_hidden['multa_'] == 'off')
       {
           unset($this->nmgp_cmp_hidden['multa_']);
           $sStyleHidden_multa_ = 'display: none;';
       }
       $bTestReadOnly_multa_ = true;
       $sStyleReadLab_multa_ = 'display: none;';
       $sStyleReadInp_multa_ = '';
       if (isset($this->nmgp_cmp_readonly['multa_']) && $this->nmgp_cmp_readonly['multa_'] == 'on')
       {
           $bTestReadOnly_multa_ = false;
           unset($this->nmgp_cmp_readonly['multa_']);
           $sStyleReadLab_multa_ = '';
           $sStyleReadInp_multa_ = 'display: none;';
       }
       $this->juros_ = $this->form_vert_form_recebimento_parcial[$sc_seq_vert]['juros_']; 
       $juros_ = $this->juros_; 
       $sStyleHidden_juros_ = '';
...
<?php echo nmButtonOutput($this->arr_buttons, "bmd_novo", "do_ajax_form_recebimento_parcial_add_new_line(" . $sc_seq_vert . ")", "do_ajax_form_recebimento_parcial_add_new_line(" . $sc_seq_vert . ")", "sc_new_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php }?>
<?php
  $Style_add_line = (!$Line_Add) ? "display: none" : "";
?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_recebimento_parcial_cancel_insert(" . $sc_seq_vert . ")", "do_ajax_form_recebimento_parcial_cancel_insert(" . $sc_seq_vert . ")", "sc_canceli_line_" . $sc_seq_vert . "", "", "", "" . $Style_add_line . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
<?php echo nmButtonOutput($this->arr_buttons, "bmd_cancelar", "do_ajax_form_recebimento_parcial_cancel_update(" . $sc_seq_vert . ")", "do_ajax_form_recebimento_parcial_cancel_update(" . $sc_seq_vert . ")", "sc_cancelu_line_" . $sc_seq_vert . "", "", "", "display: none", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
 </TD>
   <?php }?>
   <?php if (isset($this->nmgp_cmp_hidden['idrecebimento_parcial_']) && $this->nmgp_cmp_hidden['idrecebimento_parcial_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="idrecebimento_parcial_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($idrecebimento_parcial_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>
<?php if ((isset($this->Embutida_form) && $this->Embutida_form) || ($this->nmgp_opcao != "novo" && $this->nmgp_opc_ant != "incluir")) { ?>

    <TD class="scFormDataOddMult css_idrecebimento_parcial__line" id="hidden_field_data_idrecebimento_parcial_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_idrecebimento_parcial_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_idrecebimento_parcial__line" style="vertical-align: top;padding: 0px"><span id="id_read_on_idrecebimento_parcial_<?php echo $sc_seq_vert ?>" class="css_idrecebimento_parcial__line" style="<?php echo $sStyleReadLab_idrecebimento_parcial_; ?>"><?php echo $this->form_format_readonly("idrecebimento_parcial_", $this->form_encode_input($this->idrecebimento_parcial_)); ?></span><span id="id_read_off_idrecebimento_parcial_<?php echo $sc_seq_vert ?>" class="css_read_off_idrecebimento_parcial_" style="<?php echo $sStyleReadInp_idrecebimento_parcial_; ?>"><input type="hidden" id="id_sc_field_idrecebimento_parcial_<?php echo $sc_seq_vert ?>" name="idrecebimento_parcial_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($idrecebimento_parcial_) . "\">"?>
<span id="id_ajax_label_idrecebimento_parcial_<?php echo $sc_seq_vert; ?>"><?php echo nl2br($idrecebimento_parcial_); ?></span>
</span></span></td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_idrecebimento_parcial_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_idrecebimento_parcial_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
<?php }?>
...
<?php echo $observacao_; ?>
   ...
   <?php if (isset($this->nmgp_cmp_hidden['multa_']) && $this->nmgp_cmp_hidden['multa_'] == 'off') { $sc_hidden_yes++;  ?>
<input type="hidden" name="multa_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($multa_) . "\">"; ?>
<?php } else { $sc_hidden_no++; ?>

    <TD class="scFormDataOddMult css_multa__line" id="hidden_field_data_multa_<?php echo $sc_seq_vert; ?>" style="<?php echo $sStyleHidden_multa_; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOddMult css_multa__line" style="vertical-align: top;padding: 0px">
<?php if ($bTestReadOnly_multa_ && $this->nmgp_opcao != "novo" && isset($this->nmgp_cmp_readonly["multa_"]) &&  $this->nmgp_cmp_readonly["multa_"] == "on") { 

 ?>
<input type="hidden" name="multa_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($multa_) . "\">" . $multa_ . ""; ?>
<?php } else { ?>
<span id="id_read_on_multa_<?php echo $sc_seq_vert ?>" class="sc-ui-readonly-multa_<?php echo $sc_seq_vert ?> css_multa__line" style="<?php echo $sStyleReadLab_multa_; ?>"><?php echo $this->form_format_readonly("multa_", $this->form_encode_input($this->multa_)); ?></span><span id="id_read_off_multa_<?php echo $sc_seq_vert ?>" class="css_read_off_multa_<?php echo $this->classes_100perc_fields['span_input'] ?>" style="white-space: nowrap;<?php echo $sStyleReadInp_multa_; ?>">
 <input class="sc-js-input scFormObjectOddMult css_multa__obj<?php echo $this->classes_100perc_fields['input'] ?>" style="" id="id_sc_field_multa_<?php echo $sc_seq_vert ?>" type=text name="multa_<?php echo $sc_seq_vert ?>" value="<?php echo $this->form_encode_input($multa_) ?>"
 <?php if ($this->classes_100perc_fields['keep_field_size']) { echo "size=15"; } ?> alt="{datatype: 'currency', currencySymbol: '<?php echo $this->field_config['multa_']['symbol_mon']; ?>', currencyPosition: '<?php echo ((1 == $this->field_config['multa_']['format_pos'] || 3 == $this->field_config['multa_']['format_pos']) ? 'left' : 'right'); ?>', maxLength: 15, precision: 2, decimalSep: '<?php echo str_replace("'", "\'", $this->field_config['multa_']['symbol_dec']); ?>', thousandsSep: '<?php echo str_replace("'", "\'", $this->field_config['multa_']['symbol_grp']); ?>', thousandsFormat: <?php echo $this->field_config['multa_']['symbol_fmt']; ?>, manualDecimals: false, allowNegative: false, onlyNegative: false, negativePos: <?php echo (4 == $this->field_config['multa_']['format_neg'] ? "'suffix'" : "'prefix'") ?>, alignment: 'left', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddMultWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php } ?>
</td></tr><tr><td style="vertical-align: top; padding: 0"><table class="scFormFieldErrorTable" style="display: none" id="id_error_display_multa_<?php echo $sc_seq_vert; ?>_frame"><tr><td class="scFormFieldErrorMessage"><span id="id_error_display_multa_<?php echo $sc_seq_vert; ?>_text"></span></td></tr></table></td></tr></table> </TD>
   <?php }?>
...
<?php   
        if (isset($sCheckRead_idrecebimento_parcial_))
       {
           $this->nmgp_cmp_readonly['idrecebimento_parcial_'] = $sCheckRead_idrecebimento_parcial_;
       }
       if ('display: none;' == $sStyleHidden_idrecebimento_parcial_)
       {
           $this->nmgp_cmp_hidden['idrecebimento_parcial_'] = 'off';
       }
       if (isset($sCheckRead_idforma_pagamento_))
       {
       ...
       if (isset($sCheckRead_multa_))
       {
           $this->nmgp_cmp_readonly['multa_'] = $sCheckRead_multa_;
       }
       if ('display: none;' == $sStyleHidden_multa_)
       {
           $this->nmgp_cmp_hidden['multa_'] = 'off';
       }
       if (isset($sCheckRead_juros_))
       {
   ...
   { 
       ...
       $this->form_vert_form_recebimento_parcial = $guarda_form_vert_form_recebimento_parcial;
   } 
   if ($Table_refresh) 
   { 
...
<?php
if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['run_modal']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['run_modal'])
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_recebimento_parcial");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_recebimento_parcial");
 parent.scAjaxDetailHeight("form_recebimento_parcial", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
<script type="text/javascript">
	function scBtnFn_sys_format_inc() {
		if ($("#sc_b_new_t.sc-unique-btn-1").length && $("#sc_b_new_t.sc-unique-btn-1").is(":visible")) {
			...
			do_ajax_form_recebimento_parcial_add_new_line(); return false;
			 return;
		}
...
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_recebimento_parcial']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
