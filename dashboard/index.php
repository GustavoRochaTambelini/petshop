...
$_SESSION['scriptcase']['dashboard']['glo_nm_perfil']          = "conn_amazonrds_mysql";
...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_petshop.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_petshop'])) {
            $_SESSION['scriptcase']['dashboard']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_petshop'];
        }
    }
}
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'], $this->root . $this->path_prod, 'petshop', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dashboard']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'], $this->root . $this->path_prod, 'petshop', 1, $this->force_db_utf8);
    }
    else {
...
class dashboard_control {
    ...
    function init()
    {
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['chart_fluxo_caixa_sete_dias'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
...
<div class='grid-stack'>
                <div  class="grid-stack-item" data-gs-x="2" data-gs-y="3" data-gs-width="8" data-gs-height="7"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-0">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-0">
                        <div class="widget-head" style="display:">
                            <h3 class="scContainerTitle">Fluxo de caixa dos últimos 7 dias.</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-' id="id-div-iframe-0"><iframe id="id-iframe-0" name="dbifrm_widget6" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_fluxo_caixa_sete_dias'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget6"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget6&compact_mode=1&remove_margin=0&remove_border=0" alt="60"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="2" data-gs-y="0" data-gs-width="4" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-1">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-1">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('1');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="A receber nos próximos 7 dias" /></a>
                            <h3 class="scContainerTitle">A receber nos próximos 7 dias</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none scContainerIndexMoldura scContainerIndexMoldura_widget8' style="height: 100%" id="id-div-iframe-1"><?php echo $this->getIndexContent_widget8(); ?></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="6" data-gs-y="0" data-gs-width="4" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-2">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-2">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('2');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="A pagar nos próximos 7 dias" /></a>
                            <h3 class="scContainerTitle">A pagar nos próximos 7 dias</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none scContainerIndexMoldura scContainerIndexMoldura_widget9' style="height: 100%" id="id-div-iframe-2"><?php echo $this->getIndexContent_widget9(); ?></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="2" data-gs-y="10" data-gs-width="4" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-3">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-3">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('3');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Recebimentos em atraso" /></a>
                            <h3 class="scContainerTitle">Recebimentos em atraso</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                ...
                <div  class="grid-stack-item" data-gs-x="6" data-gs-y="10" data-gs-width="4" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-4">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-4">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('4');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="Pagamentos em atraso" /></a>
                            <h3 class="scContainerTitle">Pagamentos em atraso</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="; float: left" class="scContainerIndexTitle scContainerIndexTitle_widget8">A receber nos próximos 7 dias</span></div>
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget9">A pagar nos próximos 7 dias</span></div>
        <div class="clearfix"><span class="{$this->indexData['index_class']}Size {$this->indexData['index_class']}Size_widget9"><span class="{$this->indexData['index_class']} {$this->indexData['index_class']}_widget9">{$this->indexData['new_metric_formatted']}</span> {$this->indexData['icon']}</span></div>
    </div>
</div>
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget10">Recebimentos em atraso</span></div>
        <div class="clearfix"><span class="{$this->indexData['index_class']}Size {$this->indexData['index_class']}Size_widget10"><span class="{$this->indexData['index_class']} {$this->indexData['index_class']}_widget10">{$this->indexData['new_metric_formatted']}</span> {$this->indexData['icon']}</span></div>
    </div>
</div>
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget11">Pagamentos em atraso</span></div>
        <div class="clearfix"><span class="{$this->indexData['index_class']}Size {$this->indexData['index_class']}Size_widget11"><span class="{$this->indexData['index_class']} {$this->indexData['index_class']}_widget11">{$this->indexData['new_metric_formatted']}</span> {$this->indexData['icon']}</span></div>
    </div>
</div>
