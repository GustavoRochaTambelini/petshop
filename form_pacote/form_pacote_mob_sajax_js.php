  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_pacote_mob" == sTestField)
        {
...
?>
  ...
  // ---------- Validate nome
  function do_ajax_form_pacote_mob_validate_nome()
  {
    var nomeCampo_nome = "nome";
    var var_nome = scAjaxGetFieldText(nomeCampo_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_mob_validate_nome(var_nome, var_script_case_init, do_ajax_form_pacote_mob_validate_nome_cb);
  } // do_ajax_form_pacote_mob_validate_nome

  function do_ajax_form_pacote_mob_validate_nome_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_mob_validate_nome_cb

  // ---------- Validate valor
  function do_ajax_form_pacote_mob_validate_valor()
  {
    var nomeCampo_valor = "valor";
    var var_valor = scAjaxGetFieldText(nomeCampo_valor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_mob_validate_valor(var_valor, var_script_case_init, do_ajax_form_pacote_mob_validate_valor_cb);
  } // do_ajax_form_pacote_mob_validate_valor

  function do_ajax_form_pacote_mob_validate_valor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_mob_validate_valor_cb

  // ---------- Validate unidade
  function do_ajax_form_pacote_mob_validate_unidade()
  {
    var nomeCampo_unidade = "unidade";
    var var_unidade = scAjaxGetFieldSelect(nomeCampo_unidade);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_mob_validate_unidade(var_unidade, var_script_case_init, do_ajax_form_pacote_mob_validate_unidade_cb);
  } // do_ajax_form_pacote_mob_validate_unidade

  function do_ajax_form_pacote_mob_validate_unidade_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "unidade";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_mob_validate_unidade_cb

  // ---------- Validate tipo
  function do_ajax_form_pacote_mob_validate_tipo()
  {
    var nomeCampo_tipo = "tipo";
    var var_tipo = scAjaxGetFieldText(nomeCampo_tipo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_mob_validate_tipo(var_tipo, var_script_case_init, do_ajax_form_pacote_mob_validate_tipo_cb);
  } // do_ajax_form_pacote_mob_validate_tipo

  function do_ajax_form_pacote_mob_validate_tipo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "tipo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_mob_validate_tipo_cb

  // ---------- Validate descricao
  function do_ajax_form_pacote_mob_validate_descricao()
  {
    var nomeCampo_descricao = "descricao";
    var var_descricao = scAjaxGetFieldText(nomeCampo_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_mob_validate_descricao(var_descricao, var_script_case_init, do_ajax_form_pacote_mob_validate_descricao_cb);
  } // do_ajax_form_pacote_mob_validate_descricao

  function do_ajax_form_pacote_mob_validate_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_mob_validate_descricao_cb

  // ---------- Validate valor_produtos
  function do_ajax_form_pacote_mob_validate_valor_produtos()
  {
    var nomeCampo_valor_produtos = "valor_produtos";
    var var_valor_produtos = scAjaxGetFieldText(nomeCampo_valor_produtos);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_mob_validate_valor_produtos(var_valor_produtos, var_script_case_init, do_ajax_form_pacote_mob_validate_valor_produtos_cb);
  } // do_ajax_form_pacote_mob_validate_valor_produtos

  function do_ajax_form_pacote_mob_validate_valor_produtos_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "valor_produtos";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_mob_validate_valor_produtos_cb

  // ---------- Validate itens_pacote
  function do_ajax_form_pacote_mob_validate_itens_pacote()
  {
    var nomeCampo_itens_pacote = "itens_pacote";
    var var_itens_pacote = scAjaxGetFieldText(nomeCampo_itens_pacote);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_pacote_mob_validate_itens_pacote(var_itens_pacote, var_script_case_init, do_ajax_form_pacote_mob_validate_itens_pacote_cb);
  } // do_ajax_form_pacote_mob_validate_itens_pacote

  function do_ajax_form_pacote_mob_validate_itens_pacote_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_pacote_mob_validate_itens_pacote_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_pacote_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_pacote_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_nome = scAjaxGetFieldText("nome");
    var var_valor = scAjaxGetFieldText("valor");
    var var_unidade = scAjaxGetFieldSelect("unidade");
    var var_tipo = scAjaxGetFieldText("tipo");
    var var_descricao = scAjaxGetFieldText("descricao");
    var var_valor_produtos = scAjaxGetFieldText("valor_produtos");
    var var_idpacote = scAjaxGetFieldText("idpacote");
    ...
    scAjaxProcOn();
    x_ajax_form_pacote_mob_submit_form(var_nome, var_valor, var_unidade, var_tipo, var_descricao, var_valor_produtos, var_idpacote, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_pacote_mob_submit_form_cb);
  } // do_ajax_form_pacote_mob_submit_form

  function do_ajax_form_pacote_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("unidade");
      scAjaxHideErrorDisplay("tipo");
      scAjaxHideErrorDisplay("descricao");
      scAjaxHideErrorDisplay("valor_produtos");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_pacote_mob_submit_form_cb_after_alert);
  } // do_ajax_form_pacote_mob_submit_form_cb
  function do_ajax_form_pacote_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_pacote_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_pacote_itens_mob"] = "off";

  function do_ajax_form_pacote_mob_navigate_form()
  {
    if (scFormHasChanged) {
      scJs_confirm('<?php echo html_entity_decode($this->Ini->Nm_lang['lang_reload_confirm']) ?>', perform_ajax_form_pacote_mob_navigate_form, function() {});
    } else {
      perform_ajax_form_pacote_mob_navigate_form();
    }
  }

  function perform_ajax_form_pacote_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("valor_produtos");
    scAjaxHideErrorDisplay("itens_pacote");
    var var_idpacote = document.F2.idpacote.value;
    ...
    scAjaxProcOn();
    scStatusDetail["form_pacote_itens_mob"] = "on";
    x_ajax_form_pacote_mob_navigate_form(var_idpacote, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_pacote_mob_navigate_form_cb);
  } // do_ajax_form_pacote_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_pacote_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_pacote_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_pacote_itens_mob"] && "nmsc_iframe_liga_form_pacote_itens_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_pacote_itens_mob"]) {
        ...
        document.getElementById('nmsc_iframe_liga_form_pacote_itens_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_pacote_itens_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_pacote_itens_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_pacote_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_pacote_mob_navigate_form_cb
  function do_ajax_form_pacote_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_form_pacote_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_pacote_mob_navigate_form_cb_after_alert

  function sc_hide_form_pacote_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_pacote_itens_mob"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[2] = "unidade";
  ajax_field_list[3] = "tipo";
  ajax_field_list[4] = "descricao";
  ajax_field_list[5] = "valor_produtos";
  ajax_field_list[6] = "itens_pacote";
  ...
  var ajax_error_list = {
    ...
    "valor": {"label": "VALOR R$", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "unidade": {"label": "UNIDADE", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "valor_produtos": {"label": "Valor Produtos", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_id = {
    ...
    "unidade": new Array("hidden_field_label_unidade", "hidden_field_data_unidade"),
    ...
    "valor_produtos": new Array("hidden_field_label_valor_produtos", "hidden_field_data_valor_produtos"),
