...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["petshop_____grid_contas_receber_1"]))
   {
      unset($_SESSION['session_sec_aplicacao']["petshop_____grid_contas_receber_1"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contas_receber_1']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_contas_receber_1']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_contas_receber_1']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_contas_receber_1']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_contas_receber_1']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_contas_receber_1</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_contas_receber_1']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_contas_receber_1']['embutida_filho'] as $ind => $sc_init)
          {
