...
<?php
   ...
   $Ord_Cmp = new grid_contas_receber_1_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_contas_receber_1_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["numero_conta"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['labels']["numero_conta"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['labels']["numero_conta"] : "NUMERO CONTA";
   $tab_ger_campos['idforma_pagamento_prevista'] = "on";
   $tab_def_campos['idforma_pagamento_prevista'] = "idforma_pagamento_prevista";
   $tab_labels["idforma_pagamento_prevista"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['labels']["idforma_pagamento_prevista"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['labels']["idforma_pagamento_prevista"] : "FORMA PREVISTA";
   $tab_ger_campos['idforma_pagamento'] = "on";
   $tab_def_campos['idforma_pagamento'] = "idforma_pagamento";
   $tab_labels["idforma_pagamento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['labels']["idforma_pagamento"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['labels']["idforma_pagamento"] : "FORMA PAGA";
   $tab_ger_campos['data_vencimento'] = "on";
   $tab_def_campos['data_vencimento'] = "data_vencimento";
   $tab_labels["data_vencimento"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['labels']["data_vencimento"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['labels']["data_vencimento"] : "DATA VENCIMENTO";
   $tab_ger_campos['valor_a_receber'] = "on";
   $tab_def_campos['valor_a_receber'] = "valor_a_receber";
   $tab_labels["valor_a_receber"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['labels']["valor_a_receber"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['labels']["valor_a_receber"] : "VALOR A RECEBER";
   $tab_ger_campos['valor_recebido'] = "on";
   $tab_def_campos['valor_recebido'] = "valor_recebido";
   $tab_labels["valor_recebido"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['labels']["valor_recebido"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['labels']["valor_recebido"] : "VALOR RECEBIDO";
   $tab_ger_campos['pago'] = "on";
   $tab_def_campos['pago'] = "pago";
   $tab_labels["pago"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['labels']["pago"])) ? $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['labels']["pago"] : "PAGAMENTO";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_contas_receber_1_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_select'];
...
<?php
  if (isset($_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_contas_receber_1']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
